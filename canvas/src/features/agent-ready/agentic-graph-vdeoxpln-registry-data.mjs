export const buildRawAgenticGraphVdeoxplnRegistry = ({
  ...
  {
    id: AGENTIC_OS_VDEOXPLN_IDS.sourceFiles,
    ...
    tools: {
      ...
      browserLocal: [AGENTIC_OS_AGENT_READY_TOOL_IDS.inspectLocalSourceFilesSnapshot],
      local: [
        AGENTIC_OS_LOCAL_MCP_TOOL_NAMES.search,
        AGENTIC_OS_LOCAL_MCP_TOOL_NAMES.fetch,
        AGENTIC_OS_LOCAL_MCP_TOOL_NAMES.vdeoxplnList,
      ],
    },
    workflow: [
  ...
  {
    id: AGENTIC_OS_VDEOXPLN_IDS.agentReady,
    title: "agentic-graph Agent Ready",
    purpose: "Inspect agentic-graph health, MCP, WebMCP, A2A, OpenAPI, commerce, and browser-local readiness without claiming deployed mutation.",
    ...
    tools: {
      published: [AGENTIC_OS_AGENT_READY_TOOL_IDS.inspectAgentSurface],
      browserLocal: buildReadOnlyBrowserToolNames(),
      local: [AGENTIC_OS_LOCAL_MCP_TOOL_NAMES.vdeoxplnList],
    },
    workflow: [
  ...
  {
    id: AGENTIC_OS_VDEOXPLN_IDS.localMcp,
    title: "agentic-graph Local MCP",
    purpose: "Expose agentic-graph-owned local Source Files, Agentic Canvas OS docs invocation, deterministic repository packing, managed implementation runs, UI, pipeline, SuperAgent, video-remix, browser bridge, SEA-LION, HTML video, visual annotation, memory, probe-tree, showrunner, OS status, and vdeoxpln tools through the stdio MCP server.",
    scope: "local-stdio",
    mutation: "local-confirmed",
    triggers: ["local mcp", "agentic canvas os docs", "repository pack", "/repository.pack", "#repository-packing", "@repository-root", "@runtime-proof", "managed implementation run", "/implementation.run", "#managed-implementation-run", "@work-item", "@implementation-run", "/", "#", "@", "launch canvas", "run pipeline", "graphrag", "superagent", "video remix", "browser api", "sealion sidecar", "html video", "visual annotation", "memory layer", "probe tree", "showrunner", "os status", "list vdeoxpln"],
    inputs: ["local root", "repository pack bounds", "agentic canvas os invocation token", "workspace file", "graph data", "pipeline config", "reference URL", "source cards", "browser API runtime", "Southeast Asian language text", "render spec", "annotation asset", "memory scope", "probe branch", "creative brief"],
    outputs: ["local tool result", "content-addressed repository pack metadata", "Agentic Canvas OS docs invocation result", "durable implementation-run state", "review-ready pull-request handoff", "pipeline artifact", "superagent report", "video remix run manifest", "SEA-LION sidecar result", "render manifest", "annotation result", "memory result", "probe checkpoint", "showrunner artifact", "OS status snapshot", "vdeoxpln registry snapshot"],
    owners: [
    ...
    tools: {
      published: [],
      browserLocal: [],
      local: buildAgenticGraphLocalMcpToolNameList(),
    },
    workflow: [
  ...
  {
    id: AGENTIC_OS_VDEOXPLN_IDS.chatToCanvas,
    title: "agentic-graph Chat To Canvas",
    purpose: "Route AI-assisted graph generation through FloatingPanel Chat, AGENTIC_OS validation, Workspace FS, Source Files, and Canvas apply owners.",
    scope: "browser-local-ai-assisted",
    mutation: "browser-local-user-mediated",
    triggers: ["chat to canvas", "generate graph", "agenticOs markdown", "flow.subgraphs", "apply to canvas"],
    inputs: ["chat request", "workspace context", "selection context", "source evidence", "model settings"],
    outputs: ["validated AGENTIC_OS Markdown", "workspace artifact", "GraphData", "canvas topology snapshot"],
    owners: [
    ...
    tools: {
      published: [],
      browserLocal: [
        AGENTIC_OS_AGENT_READY_TOOL_IDS.inspectLocalChatPipelineState,
        AGENTIC_OS_AGENT_READY_TOOL_IDS.inspectLocalMainPanelChatCanvasPipeline,
        AGENTIC_OS_AGENT_READY_TOOL_IDS.inspectLocalWorkspaceDocument,
        AGENTIC_OS_AGENT_READY_TOOL_IDS.inspectLocalCanvasTopology,
        AGENTIC_OS_AGENT_READY_TOOL_IDS.inspectLocalCanvasSnapshot,
      ],
      local: [AGENTIC_OS_LOCAL_MCP_TOOL_NAMES.vdeoxplnList],
    },
    workflow: [
  ...
  {
    id: AGENTIC_OS_VDEOXPLN_IDS.strybldr,
    title: "agentic-graph Strybldr",
    ...
    tools: {
      published: [],
      browserLocal: [
        AGENTIC_OS_AGENT_READY_TOOL_IDS.inspectLocalSourceFilesSnapshot,
        AGENTIC_OS_AGENT_READY_TOOL_IDS.inspectLocalCanvasTopology,
        AGENTIC_OS_AGENT_READY_TOOL_IDS.inspectLocalCanvasSnapshot,
      ],
      local: [AGENTIC_OS_LOCAL_MCP_TOOL_NAMES.vdeoxplnList],
  ...
  {
    id: AGENTIC_OS_VDEOXPLN_IDS.researchVisual,
    title: "agentic-graph Research Visual",
    purpose: "Create file-backed research visual workflows from source material using agentic-graph parsing, Source Files, Storyboard, renderer, and chat owners.",
    scope: "browser-local-ai-assisted",
    mutation: "browser-local-user-mediated",
    ...
    outputs: ["mechanism brief", "storyboard", "renderer-neutral scene plan", "validated AGENTIC_OS Markdown"],
    owners: [
  ...
  {
    id: AGENTIC_OS_VDEOXPLN_IDS.memoryLayer,
    title: "agentic-graph Memory Layer",
    purpose: "Persist, retrieve, safely compact, hard-redact, and revision-freeze host-authorized exact-scope agent memory through a durable local runtime while preserving the legacy provider-neutral prompt harness.",
    scope: "local-stdio-and-browser-local",
    mutation: "local-scoped-memory",
    triggers: ["memory layer", "long-term memory", "cross-session context", "persistent memory", "personalization", "prompt memory", "procedural memory", "harness replay", "user model", "profile markdown"],
    inputs: ["user or agent message", "exact runtime scope", "memory query", "source evidence", "host authorization token", "Agentic Canvas OS invocation tuple", "harness output dir"],
    outputs: ["durable authorization-bound memory receipt", "ranked cited memory results", "frozen or explicitly redacted revision snapshot", "bounded prompt context", "zero-model cost evidence", "procedural AGENTIC_OS markdown", "USER_MODEL markdown"],
    owners: [
    ...
    tools: {
      ...
      browserLocal: [],
      local: [
        AGENTIC_OS_LOCAL_MCP_TOOL_NAMES.memoryAdd,
        AGENTIC_OS_LOCAL_MCP_TOOL_NAMES.memoryWrite,
        AGENTIC_OS_LOCAL_MCP_TOOL_NAMES.memoryCompact,
        AGENTIC_OS_LOCAL_MCP_TOOL_NAMES.memorySearch,
        AGENTIC_OS_LOCAL_MCP_TOOL_NAMES.sessionSearch,
        AGENTIC_OS_LOCAL_MCP_TOOL_NAMES.userProfile,
        AGENTIC_OS_LOCAL_MCP_TOOL_NAMES.memoryInvoke,
        AGENTIC_OS_LOCAL_MCP_TOOL_NAMES.memoryAssemblePrompt,
        AGENTIC_OS_LOCAL_MCP_TOOL_NAMES.memoryExtractProcedural,
        AGENTIC_OS_LOCAL_MCP_TOOL_NAMES.memoryMaterializeUserModel,
        AGENTIC_OS_LOCAL_MCP_TOOL_NAMES.vdeoxplnList,
      ],
    },
    workflow: [
...
{ id: AGENTIC_OS_VDEOXPLN_IDS.visualAnnotationEngine, title: "agentic-graph Visual Annotation Engine", purpose: "Run browser-local image and video-frame annotation into LLM-ready structured JSON plus native visual datasets materialised through existing artifact owners.", scope: "browser-local", mutation: "local-approval-gated", triggers: ["annotate image", "annotate video", "visual annotation", "object detection", "image caption", "florence2", "semantic labels", "llm-ready annotation", "annotation dataset", "zone counting"], inputs: ["image url", "video asset url", "annotation tasks", "model hint", "frame timestamp"], outputs: ["annotation result json", "visual annotation dataset", "zone counting timeline", "llm-ready payload", "annotation canvas node", "markdown summary"], owners: ["canvas/src/features/visual-annotation-engine/annotationEngineSsot.ts", "canvas/src/features/visual-annotation-engine/annotationDataset.ts", "canvas/src/features/visual-annotation-engine/annotationWorker.ts", "canvas/src/features/visual-annotation-engine/annotationOrchestrator.ts", "canvas/src/features/visual-annotation-engine/annotationSerializers.ts", "canvas/src/features/visual-annotation-engine/annotationFlowNode.ts", "canvas/src/features/visual-annotation-engine/annotationMcpTools.ts", "canvas/src/features/visual-annotation-engine/annotationWidget.ts", "canvas/src/features/chat/richMediaRun.ts", "canvas/src/features/source-files", "canvas/src/lib/graph/semanticKey.ts", "canvas/src/lib/config.storyboard-widget.ts", "mcp/local-tool-contract.js", "canvas/src/features/agent-ready/agentic-graph-vdeoxpln-contract.mjs"], tools: { published: [], browserLocal: [], local: [AGENTIC_OS_LOCAL_MCP_TOOL_NAMES.annotateImage, AGENTIC_OS_LOCAL_MCP_TOOL_NAMES.annotateVideoFrame, AGENTIC_OS_LOCAL_MCP_TOOL_NAMES.vdeoxplnList] }, workflow: ["Validate the Annotation_Spec before model resolution or inference.", "Resolve model identifier from modelHint, AGENTIC_OS_ANNOTATION_MODEL, or the registered default.", "Dispatch through the Annotation_Worker boundary; Dev emits dependency-free heuristic annotations while model adapters remain runtime-owned.", "Build annotationId with buildScopedGraphSemanticKey using assetUrl, modelId, and sorted tasks.", "Load Annotation_Result or frame-box arrays into the native dataset owner for split, merge, save, and frame-ordered zone counting.", "Route JSON output through writeRichMediaWidgetRunOutputArtifact exactly once.", "Return annotationId, assetUrl, modelId, tasks, outputPath, and outputManifestPath."], aiPolicy: { mode: "none", maxAttempts: 0, tokenBudget: 0, fallback: "Return runtime-local heuristic annotation JSON or a structured validation/runtime error without model call." }, artifactPolicy: { persistence: "browser-local", graphMaterialization: "annotation-canvas-node", semanticKeyInputs: ["annotationId", "assetUrl", "modelId", "sortedTasks", "visualDataset", "zoneCounting"] }, validation: ["vdeoxpln:check", "mcpLocalToolContract", "visualAnnotationEngine", "visualAnnotationDataset"], publish: ["local-mcp-docs", "mainpanel-mcp"] },
  {
    ...
    artifactPolicy: { persistence: "session-only-browser-manifest-or-host-owned-artifact", graphMaterialization: "none", semanticKeyInputs: ["operation", "idempotencyKey", "sourceDigests", "profileRevision", "rightsReceipts"] },
    validation: ["voice-studio:check", "vdeoxpln:check", "mcpLocalToolContract"],
    publish: ["local-mcp-docs", "mainpanel-mcp"],
  },
  buildAgenticGraphApplicationCompositionVdeoxpln({ ids: AGENTIC_OS_VDEOXPLN_IDS, toolNames: AGENTIC_OS_LOCAL_MCP_TOOL_NAMES }),
  {
    id: AGENTIC_OS_VDEOXPLN_IDS.commerceReadiness,
    title: "agentic-graph Commerce Readiness",
    ...
    tools: {
      published: [AGENTIC_OS_AGENT_READY_TOOL_IDS.inspectAgentSurface],
      browserLocal: [
        AGENTIC_OS_AGENT_READY_TOOL_IDS.inspectLocalSettingsChatReadiness,
        AGENTIC_OS_AGENT_READY_TOOL_IDS.inspectLocalMainPanelState,
      ],
      local: [AGENTIC_OS_LOCAL_MCP_TOOL_NAMES.vdeoxplnList],
    },
    workflow: [
