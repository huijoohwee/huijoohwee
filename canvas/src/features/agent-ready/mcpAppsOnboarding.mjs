...
export const MCP_ONBOARDING_GRAMMAR_TOOL_NAME = 'agentic-graph.agentic_canvas_os.docs.invoke'
...
export const resolveMcpOnboardingUrls = ({ baseUrl, transportUrl, surfaceRoles } = {}) => {
  ...
  return {
    ...
    controlPlaneMcpUrl: clean(surfaceRoles?.controlPlaneMcpUrl) || resolveAgenticOsControlPlaneMcpUrl(base),
  }
}
...
export const buildMcpOnboarding = ({ publicReadMcpUrl, controlPlaneMcpUrl } = {}) => ({
  ...
  cheapestProofPath: 'Use the source-side README.md quick start or docs/documents/agentic-graph-superagent-harness.md in the agentic-graph repo before hosted setup.',
  steps: [
    {
      order: 1,
      label: 'Map intent',
