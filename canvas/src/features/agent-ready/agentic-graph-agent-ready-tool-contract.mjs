...
import { buildSemanticSpaceAgentReadyToolContracts } from './semanticSpaceAgentReadyContract.mjs'
...
export const buildAgenticGraphWebMcpToolName = (
  toolName,
  namespace = AGENTIC_OS_AGENT_READY_WEB_MCP_NAMESPACE,
  ...
  const contracts = [
    {
      ...
      description: 'Use this when an MCP host needs to search published agentic-graph Source Files and return stable document IDs for the `fetch` tool. Call this first for OpenAI Deep Research-style retrieval, Claude, Qwen Code, Kimi CLI, BytePlus ModelArk, and generic MCP clients.',
      inputSchema: {
        type: 'object',
        additionalProperties: false,
        required: ['query'],
    ...
    {
      name: AGENTIC_OS_AGENT_READY_TOOL_IDS.fetch,
      webName: buildAgenticGraphWebMcpToolName(AGENTIC_OS_AGENT_READY_TOOL_IDS.fetch),
      title: 'Fetch agentic-graph Source File',
      description: 'Use this when an MCP host needs the complete published agentic-graph Source File for an ID returned by `search`. Returns markdown as both `content` and `text` for OpenAI, Claude, Qwen Code, Kimi CLI, BytePlus ModelArk, and generic MCP clients.',
      inputSchema: {
        type: 'object',
        additionalProperties: false,
        required: ['id'],
    ...
    {
      name: AGENTIC_OS_AGENT_READY_TOOL_IDS.listSourceFiles,
      webName: buildAgenticGraphWebMcpToolName(AGENTIC_OS_AGENT_READY_TOOL_IDS.listSourceFiles),
      title: 'List Source Files',
      description: 'Use this when an MCP host needs the published agentic-graph Source Files index as markdown.',
      inputSchema: { type: 'object', additionalProperties: false, properties: {} },
      annotations: READ_ONLY_TOOL_ANNOTATIONS,
    },
    {
      name: AGENTIC_OS_AGENT_READY_TOOL_IDS.readSourceFile,
      webName: buildAgenticGraphWebMcpToolName(AGENTIC_OS_AGENT_READY_TOOL_IDS.readSourceFile),
      title: 'Read Source File',
      description: 'Use this when an MCP host knows a published agentic-graph canonical path and needs that Editor Workspace markdown content. Defaults to the canonical docs workspace when workspaceId is omitted.',
      inputSchema: {
        type: 'object',
        additionalProperties: false,
    ...
    {
      name: AGENTIC_OS_AGENT_READY_TOOL_IDS.readSharedDocument,
      webName: buildAgenticGraphWebMcpToolName(AGENTIC_OS_AGENT_READY_TOOL_IDS.readSharedDocument),
      title: 'Read Shared Document',
      description: 'Use this when an MCP host has a agentic-graph share token or public agentic-graph share/document URL and needs the published markdown content.',
      inputSchema: {
        type: 'object',
        additionalProperties: false,
        properties: {
    ...
    {
      name: AGENTIC_OS_AGENT_READY_TOOL_IDS.inspectSharedDocumentStructure,
      webName: buildAgenticGraphWebMcpToolName(AGENTIC_OS_AGENT_READY_TOOL_IDS.inspectSharedDocumentStructure),
      title: 'Inspect Shared Document Structure',
      description: 'Use this when an MCP host has a agentic-graph share token or public agentic-graph share/document URL and needs frontmatter/body structure without mutating the document.',
      inputSchema: {
        type: 'object',
        additionalProperties: false,
        properties: {
    ...
    ...(includeBrowserOnlyTools
      ? [...buildPythonLearningToolContracts({ buildWebName: buildAgenticGraphWebMcpToolName }), {
          ...
          description: 'Inspect the active browser-local agentic-graph SettingsView chat readiness state for MainPanel MCP, Integrations, and Commerce, including provider, routing, and model discovery status.',
          inputSchema: { type: 'object', additionalProperties: false, properties: {} },
          annotations: READ_ONLY_TOOL_ANNOTATIONS,
        }, {
          name: AGENTIC_OS_AGENT_READY_TOOL_IDS.inspectLocalMainPanelState,
          webName: buildAgenticGraphWebMcpToolName(AGENTIC_OS_AGENT_READY_TOOL_IDS.inspectLocalMainPanelState),
          title: 'Inspect Local MainPanel State',
          description: 'Inspect the active browser-local agentic-graph MainPanel tab, search, and shared action state for MCP, Integrations, and Commerce readiness.',
          inputSchema: { type: 'object', additionalProperties: false, properties: {} },
          annotations: READ_ONLY_TOOL_ANNOTATIONS,
        }, {
          name: AGENTIC_OS_AGENT_READY_TOOL_IDS.inspectLocalEditorWorkspaceState,
          webName: buildAgenticGraphWebMcpToolName(AGENTIC_OS_AGENT_READY_TOOL_IDS.inspectLocalEditorWorkspaceState),
          title: 'Inspect Local Editor Workspace State',
          description: 'Inspect the active browser-local agentic-graph Editor Workspace and Markdown pane state, including pane visibility and live draft/frontmatter structure.',
          inputSchema: { type: 'object', additionalProperties: false, properties: {} },
          annotations: READ_ONLY_TOOL_ANNOTATIONS,
        }, {
          name: AGENTIC_OS_AGENT_READY_TOOL_IDS.inspectLocalChatPipelineState,
          webName: buildAgenticGraphWebMcpToolName(AGENTIC_OS_AGENT_READY_TOOL_IDS.inspectLocalChatPipelineState),
          title: 'Inspect Local Chat Pipeline State',
          description: 'Inspect the active browser-local agentic-graph FloatingPanel chat runtime, including streaming, workspace follow path, LLM-to-workspace pipeline state, and promotion retry recovery for already-saved local artifacts.',
          inputSchema: { type: 'object', additionalProperties: false, properties: {} },
          annotations: READ_ONLY_TOOL_ANNOTATIONS,
        }, {
          name: AGENTIC_OS_AGENT_READY_TOOL_IDS.inspectLocalMainPanelChatCanvasPipeline,
          webName: buildAgenticGraphWebMcpToolName(AGENTIC_OS_AGENT_READY_TOOL_IDS.inspectLocalMainPanelChatCanvasPipeline),
          title: 'Inspect Local MainPanel Chat Canvas Pipeline',
          description: 'Inspect the active browser-local agentic-graph E2E readiness path from MainPanel MCP, Integrations, and Commerce through FloatingPanel Chat, workspace markdown/frontmatter, and canvas topology.',
          inputSchema: { type: 'object', additionalProperties: false, properties: {} },
          annotations: READ_ONLY_TOOL_ANNOTATIONS,
        }, {
          name: AGENTIC_OS_AGENT_READY_TOOL_IDS.inspectLocalWorkspaceDocument,
          webName: buildAgenticGraphWebMcpToolName(AGENTIC_OS_AGENT_READY_TOOL_IDS.inspectLocalWorkspaceDocument),
          ...
          webName: buildAgenticGraphWebMcpToolName(AGENTIC_OS_AGENT_READY_TOOL_IDS.inspectLocalCanvasSnapshot),
          title: 'Inspect Local Canvas Snapshot',
          description: 'Inspect the active browser-local agentic-graph canvas SVG snapshot from the app runtime without calling published storage or Pages MCP routes.',
          inputSchema: { type: 'object', additionalProperties: false, properties: {} },
          annotations: READ_ONLY_TOOL_ANNOTATIONS,
        }, {
          name: AGENTIC_OS_AGENT_READY_TOOL_IDS.inspectLocal3dCameraPose,
          webName: buildAgenticGraphWebMcpToolName(AGENTIC_OS_AGENT_READY_TOOL_IDS.inspectLocal3dCameraPose),
          title: 'Inspect Local 3D Camera Pose',
          description: 'Inspect the active browser-local agentic-graph 3D camera pose from the app runtime without calling published storage or Pages MCP routes.',
          inputSchema: { type: 'object', additionalProperties: false, properties: {} },
          annotations: READ_ONLY_TOOL_ANNOTATIONS,
        }, {
          name: AGENTIC_OS_AGENT_READY_TOOL_IDS.inspectLocalCamera,
          webName: buildAgenticGraphWebMcpToolName(AGENTIC_OS_AGENT_READY_TOOL_IDS.inspectLocalCamera),
          ...
          name: AGENTIC_OS_AGENT_READY_TOOL_IDS.controlLocalCamera,
          webName: buildAgenticGraphWebMcpToolName(AGENTIC_OS_AGENT_READY_TOOL_IDS.controlLocalCamera),
          ...
          name: AGENTIC_OS_AGENT_READY_TOOL_IDS.controlLocalAnimation,
          webName: buildAgenticGraphWebMcpToolName(AGENTIC_OS_AGENT_READY_TOOL_IDS.controlLocalAnimation),
          ...
          description: 'Inspect the active browser-local agentic-graph 3D layout positions from the app runtime without calling published storage or Pages MCP routes.',
          inputSchema: { type: 'object', additionalProperties: false, properties: {} },
          annotations: READ_ONLY_TOOL_ANNOTATIONS,
        }, {
          name: AGENTIC_OS_AGENT_READY_TOOL_IDS.inspectLocalXrSceneAssets,
          webName: buildAgenticGraphWebMcpToolName(AGENTIC_OS_AGENT_READY_TOOL_IDS.inspectLocalXrSceneAssets),
          ...
          description: 'Inspect the active browser-local agentic-graph 2D zoom and viewport state from the app runtime without calling published storage or Pages MCP routes.',
          inputSchema: { type: 'object', additionalProperties: false, properties: {} },
          annotations: READ_ONLY_TOOL_ANNOTATIONS,
        }, {
          name: AGENTIC_OS_AGENT_READY_TOOL_IDS.inspectLocalSourceFilesSnapshot,
          webName: buildAgenticGraphWebMcpToolName(AGENTIC_OS_AGENT_READY_TOOL_IDS.inspectLocalSourceFilesSnapshot),
          title: 'Inspect Local Source Files Snapshot',
          description: 'Inspect the active browser-local agentic-graph Source Files runtime snapshot from the app runtime without calling published storage or Pages MCP routes.',
          inputSchema: { type: 'object', additionalProperties: false, properties: {} },
          annotations: READ_ONLY_TOOL_ANNOTATIONS,
        }, {
          name: AGENTIC_OS_AGENT_READY_TOOL_IDS.readLocalRuntimeIdentity,
          webName: buildAgenticGraphWebMcpToolName(AGENTIC_OS_AGENT_READY_TOOL_IDS.readLocalRuntimeIdentity),
          title: 'Read Local Runtime Identity',
          description: 'Read the application-global canonical agentic-graph runtime identity and automatic cross-device verification status without refreshing catalogs, rebuilding identity, copying clipboard data, or mutating source.',
          inputSchema: { type: 'object', additionalProperties: false, properties: {} },
      ...
      : []),
    {
      name: AGENTIC_OS_AGENT_READY_TOOL_IDS.inspectAgentSurface,
      webName: buildAgenticGraphWebMcpToolName(AGENTIC_OS_AGENT_READY_TOOL_IDS.inspectAgentSurface),
      title: 'Inspect Agent Surface',
      description: 'Use this when an MCP Apps-capable host or generic MCP client needs to inspect agentic-graph agent-ready discovery, MCP Apps readiness, OpenAPI, and skill metadata.',
      inputSchema: { type: 'object', additionalProperties: false, properties: {} },
      outputSchema: AGENTIC_OS_AGENT_SURFACE_OUTPUT_SCHEMA,
      annotations: READ_ONLY_TOOL_ANNOTATIONS,
