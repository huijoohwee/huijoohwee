export const buildRawAgenticGraphVdeoxplnRegistry = ({
  ...
  {
    id: AGENTICGRAPH_VDEOXPLN_IDS.sourceFiles,
    title: "AgenticGraph Source Files",
    ...
    tools: {
      ...
      browserLocal: [AGENTICGRAPH_AGENT_READY_TOOL_IDS.inspectLocalSourceFilesSnapshot],
      local: [
        AGENTICGRAPH_LOCAL_MCP_TOOL_NAMES.search,
        AGENTICGRAPH_LOCAL_MCP_TOOL_NAMES.fetch,
        AGENTICGRAPH_LOCAL_MCP_TOOL_NAMES.vdeoxplnList,
      ],
    },
    workflow: [
  ...
  {
    id: AGENTICGRAPH_VDEOXPLN_IDS.agentReady,
    title: "AgenticGraph Agent Ready",
    purpose: "Inspect AgenticGraph health, MCP, WebMCP, A2A, OpenAPI, commerce, and browser-local readiness without claiming deployed mutation.",
    ...
    tools: {
      published: [AGENTICGRAPH_AGENT_READY_TOOL_IDS.inspectAgentSurface],
      browserLocal: buildReadOnlyBrowserToolNames(),
      local: [AGENTICGRAPH_LOCAL_MCP_TOOL_NAMES.vdeoxplnList],
    },
    workflow: [
  ...
  {
    id: AGENTICGRAPH_VDEOXPLN_IDS.chatToCanvas,
    title: "AgenticGraph Chat To Canvas",
    ...
    tools: {
      published: [],
      browserLocal: [
        AGENTICGRAPH_AGENT_READY_TOOL_IDS.inspectLocalChatPipelineState,
        AGENTICGRAPH_AGENT_READY_TOOL_IDS.inspectLocalMainPanelChatCanvasPipeline,
        AGENTICGRAPH_AGENT_READY_TOOL_IDS.inspectLocalWorkspaceDocument,
        AGENTICGRAPH_AGENT_READY_TOOL_IDS.inspectLocalCanvasTopology,
        AGENTICGRAPH_AGENT_READY_TOOL_IDS.inspectLocalCanvasSnapshot,
      ],
      local: [AGENTICGRAPH_LOCAL_MCP_TOOL_NAMES.vdeoxplnList],
    },
    workflow: [
  ...
  {
    id: AGENTICGRAPH_VDEOXPLN_IDS.strybldr,
    title: "AgenticGraph Strybldr",
    ...
    tools: {
      published: [],
      browserLocal: [
        AGENTICGRAPH_AGENT_READY_TOOL_IDS.inspectLocalSourceFilesSnapshot,
        AGENTICGRAPH_AGENT_READY_TOOL_IDS.inspectLocalCanvasTopology,
        AGENTICGRAPH_AGENT_READY_TOOL_IDS.inspectLocalCanvasSnapshot,
      ],
      local: [AGENTICGRAPH_LOCAL_MCP_TOOL_NAMES.vdeoxplnList],
  ...
  {
    id: AGENTICGRAPH_VDEOXPLN_IDS.researchVisual,
    title: "AgenticGraph Research Visual",
    purpose: "Create file-backed research visual workflows from source material using AgenticGraph parsing, Source Files, Storyboard, renderer, and chat owners.",
    scope: "browser-local-ai-assisted",
    mutation: "browser-local-user-mediated",
  ...
  {
    id: AGENTICGRAPH_VDEOXPLN_IDS.memoryLayer,
    title: "AgenticGraph Memory Layer",
    ...
    outputs: ["durable authorization-bound memory receipt", "ranked cited memory results", "frozen or explicitly redacted revision snapshot", "bounded prompt context", "zero-model cost evidence", "procedural KGC markdown", "USER_MODEL markdown"],
    owners: [
    ...
    tools: {
      ...
      browserLocal: [],
      local: [
        AGENTICGRAPH_LOCAL_MCP_TOOL_NAMES.memoryAdd,
        AGENTICGRAPH_LOCAL_MCP_TOOL_NAMES.memoryWrite,
        AGENTICGRAPH_LOCAL_MCP_TOOL_NAMES.memoryCompact,
        AGENTICGRAPH_LOCAL_MCP_TOOL_NAMES.memorySearch,
        AGENTICGRAPH_LOCAL_MCP_TOOL_NAMES.sessionSearch,
        AGENTICGRAPH_LOCAL_MCP_TOOL_NAMES.userProfile,
        AGENTICGRAPH_LOCAL_MCP_TOOL_NAMES.memoryInvoke,
        AGENTICGRAPH_LOCAL_MCP_TOOL_NAMES.memoryAssemblePrompt,
        AGENTICGRAPH_LOCAL_MCP_TOOL_NAMES.memoryExtractProcedural,
        AGENTICGRAPH_LOCAL_MCP_TOOL_NAMES.memoryMaterializeUserModel,
        AGENTICGRAPH_LOCAL_MCP_TOOL_NAMES.vdeoxplnList,
      ],
    },
    workflow: [
...
{ id: AGENTICGRAPH_VDEOXPLN_IDS.visualAnnotationEngine, title: "AgenticGraph Visual Annotation Engine", purpose: "Run browser-local image and video-frame annotation into LLM-ready structured JSON plus native visual datasets materialised through existing artifact owners.", scope: "browser-local", mutation: "local-approval-gated", triggers: ["annotate image", "annotate video", "visual annotation", "object detection", "image caption", "florence2", "semantic labels", "llm-ready annotation", "annotation dataset", "zone counting"], inputs: ["image url", "video asset url", "annotation tasks", "model hint", "frame timestamp"], outputs: ["annotation result json", "visual annotation dataset", "zone counting timeline", "llm-ready payload", "annotation canvas node", "markdown summary"], owners: ["canvas/src/features/visual-annotation-engine/annotationEngineSsot.ts", "canvas/src/features/visual-annotation-engine/annotationDataset.ts", "canvas/src/features/visual-annotation-engine/annotationWorker.ts", "canvas/src/features/visual-annotation-engine/annotationOrchestrator.ts", "canvas/src/features/visual-annotation-engine/annotationSerializers.ts", "canvas/src/features/visual-annotation-engine/annotationFlowNode.ts", "canvas/src/features/visual-annotation-engine/annotationMcpTools.ts", "canvas/src/features/visual-annotation-engine/annotationWidget.ts", "canvas/src/features/chat/richMediaRun.ts", "canvas/src/features/source-files", "canvas/src/lib/graph/semanticKey.ts", "canvas/src/lib/config.storyboard-widget.ts", "mcp/local-tool-contract.js", "canvas/src/features/agent-ready/agenticgraphVdeoxplnContract.mjs"], tools: { published: [], browserLocal: [], local: [AGENTICGRAPH_LOCAL_MCP_TOOL_NAMES.annotateImage, AGENTICGRAPH_LOCAL_MCP_TOOL_NAMES.annotateVideoFrame, AGENTICGRAPH_LOCAL_MCP_TOOL_NAMES.vdeoxplnList] }, workflow: ["Validate the Annotation_Spec before model resolution or inference.", "Resolve model identifier from modelHint, AGENTICGRAPH_ANNOTATION_MODEL, or the registered default.", "Dispatch through the Annotation_Worker boundary; Dev emits dependency-free heuristic annotations while model adapters remain runtime-owned.", "Build annotationId with buildScopedGraphSemanticKey using assetUrl, modelId, and sorted tasks.", "Load Annotation_Result or frame-box arrays into the native dataset owner for split, merge, save, and frame-ordered zone counting.", "Route JSON output through writeRichMediaWidgetRunOutputArtifact exactly once.", "Return annotationId, assetUrl, modelId, tasks, outputPath, and outputManifestPath."], aiPolicy: { mode: "none", maxAttempts: 0, tokenBudget: 0, fallback: "Return runtime-local heuristic annotation JSON or a structured validation/runtime error without model call." }, artifactPolicy: { persistence: "browser-local", graphMaterialization: "annotation-canvas-node", semanticKeyInputs: ["annotationId", "assetUrl", "modelId", "sortedTasks", "visualDataset", "zoneCounting"] }, validation: ["vdeoxpln:check", "mcpLocalToolContract", "visualAnnotationEngine", "visualAnnotationDataset"], publish: ["local-mcp-docs", "mainpanel-mcp"] },
  {
    ...
    owners: ["contracts/voice-studio.schema.js", "mcp/voice-studio-tool-contract.js", "mcp/voice-studio-runtime.js", "canvas/src/features/voice-studio", "docs/documents/agenticgraph-ai-voice-studio-prd-tad.md"],
    tools: { published: [], browserLocal: [], local: [AGENTICGRAPH_LOCAL_MCP_TOOL_NAMES.voiceStudio, AGENTICGRAPH_LOCAL_MCP_TOOL_NAMES.vdeoxplnList] },
  ...
  buildAgenticGraphApplicationCompositionVdeoxpln({ ids: AGENTICGRAPH_VDEOXPLN_IDS, toolNames: AGENTICGRAPH_LOCAL_MCP_TOOL_NAMES }),
  {
    id: AGENTICGRAPH_VDEOXPLN_IDS.commerceReadiness,
    title: "AgenticGraph Commerce Readiness",
    ...
    tools: {
      published: [AGENTICGRAPH_AGENT_READY_TOOL_IDS.inspectAgentSurface],
      browserLocal: [
        AGENTICGRAPH_AGENT_READY_TOOL_IDS.inspectLocalSettingsChatReadiness,
        AGENTICGRAPH_AGENT_READY_TOOL_IDS.inspectLocalMainPanelState,
      ],
      local: [AGENTICGRAPH_LOCAL_MCP_TOOL_NAMES.vdeoxplnList],
    },
    workflow: [
