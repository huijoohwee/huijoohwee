...
// .wrangler/tmp/pages-Ylyn6G/functionsWorker-0.9858272525533036.mjs
...
__name(isHttpUrl2, "isHttpUrl2");
__name2(isHttpUrl2, "isHttpUrl");
...
__name2(stripActiveContent, "stripActiveContent");
...
__name(buildWrapper, "buildWrapper");
__name2(buildWrapper, "buildWrapper");
async function onRequestGet2(context) {
  const reqUrl = new URL(context.request.url);
  const target = reqUrl.searchParams.get("url") || "";
  if (!isHttpUrl2(target)) {
...
// .wrangler/tmp/bundle-Z6TJWQ/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-Z6TJWQ/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.9858272525533036.js.map
