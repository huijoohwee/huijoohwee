...
posture:
  ...
  - Frontmatter SSOT
  - Approval-gated
enter_href: /agentic-graph/
markdown_route: /agentic-graph-live-canvas-hero.md
...
- [Enter agentic-graph](/agentic-graph/)
- [Read this discovery markdown](/agentic-graph-live-canvas-hero.md)
...
- The apex Home hero retains viewport ownership during persisted workspace document bootstrap; the switching-document placeholder remains exclusive to `/agentic-graph` workspace routes.
...
- Production JavaScript, CSS, and generated assets are emitted under the exact 40-character agentic-graph source revision. A new protected release therefore uses a new asset namespace and cannot reuse an HTML-poisoned browser cache entry from an older deployment.
