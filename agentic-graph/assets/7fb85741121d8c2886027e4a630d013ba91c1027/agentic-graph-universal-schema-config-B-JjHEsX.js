const e=`{
  ...
  "metadata": {
    ...
    "generatedBy": "data/config/schema/agentic-graph-universal-schema-config.jsonld",
    "fixtures": {
      "graphFieldSettings": {
        "graphRAGPath": {
          "@context": {
          ...
          "kg:raciCatalog": "docs/agentic-graph-raci-document.md",
      ...
      "roleActionOutcomes": {
        ...
        "graph-fields-table-mapping-role-action-outcome": {
          ...
          "outcome": "see docs/agentic-graph-schema-document.md for AgenticRAG JSON-LD table mapping examples."
        },
