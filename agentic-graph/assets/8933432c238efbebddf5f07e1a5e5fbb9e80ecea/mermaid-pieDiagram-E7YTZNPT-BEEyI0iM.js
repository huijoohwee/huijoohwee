import{p as et}from"./mermaid-chunk-JWPE2WC7-5uJYJH5B.js";import{s as at}from"./mermaid-chunk-CLGD4ZFX-BSy9mqyx.js";import{a as rt,p as it}from"./mermaid-chunk-75Z2AOVW-DC04irdX.js";import{L as ot,K as nt,M as st,N as lt,R as ct,Q as dt,g as pt,E as gt,S as ht,k as ft}from"./mermaid-chunk-DU6HZSFF-BSRMVxYd.js";import{l as z}from"./mermaid-chunk-X3CZISLH-BCYoWsLM.js";import{_ as l}from"./mermaid-chunk-Y2CYZVJY-DM6BcmAw.js";import{p as mt}from"./mermaid-gitGraphDiagram-WWUBYQGX-Ds81qqlN.js";import{R as U,S as ut,T as vt}from"./d3-DuXkZ2Jo.js";import"./monaco-iF10uszh.js";import"./react-BhUDf-ol.js";import"./mermaid-chunk-2Q5K7J3B-BacGNAi0.js";var St=ft.pie,R={sections:new Map,showData:!1},T=R.sections,L=R.showData,xt=structuredClone(St),wt=l(()=>structuredClone(xt),"getConfig"),Ct=l(()=>{T=new Map,L=R.showData,ht()},"clear"),$t=l(({label:t,value:a})=>{if(a<0)throw new Error(`"${t}" has invalid value: ${a}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);T.has(t)||(T.set(t,a),z.debug(`added new section: ${t}, with value: ${a}`))},"addSection"),Dt=l(()=>T,"getSections"),yt=l(t=>{L=t},"setShowData"),Tt=l(()=>L,"getShowData"),K={getConfig:wt,clear:Ct,setDiagramTitle:dt,getDiagramTitle:ct,setAccTitle:lt,getAccTitle:st,setAccDescription:nt,getAccDescription:ot,addSection:$t,getSections:Dt,setShowData:yt,getShowData:Tt},bt=l((t,a)=>{et(t,a),a.setShowData(t.showData),t.sections.map(a.addSection)},"populateDb"),At={parse:l(async t=>{const a=await mt("pie",t);z.debug(a),bt(a,K)},"parse")},kt=l(t=>`
  .pieCircle{
