---
title: "AgenticGraph Vdeoxpln Demo - Interactive Visual Explanation"
schema: "kgc-computing-flow/v1"
graphId: "md:agenticgraph-vdeoxpln-demo-interactive-visual-explanation"
doc_type: "AgenticGraph Vdeoxpln Demo"
date: "2026-05-31"
lang: "en-US"
implementation_contract: "../../agenticgraph/docs/documents/agenticgraph-vdeoxpln-prd-tad.md"
source_truth: "canvas/src/features/agent-ready/agenticgraphVdeoxplnContract.mjs"
...
local_file_import_contract:
  ...
  - "Storyboard Widget exposes a dependency-free video-agent Render_Spec for operator-supplied validation input without persisting URL fixtures in repo source"
  ...
  - "Toolbar -> Launch -> Import URL exposes user-configurable video-agent validation document path, validation URL controls, and per-URL selection"
...
aiShowrunnerRuntimeContract:
  schema: "agenticgraph-showrunner-brief/v1"
  localMcpTool: "agenticgraph.showrunner.start_run"
  mode: "dry-run"
  paidCallCount: 0
  sourceTruth:
...
htmlVideoRendererRuntimeContract:
  schema: "agenticgraph-html-video-renderer/v1"
  nodeTypeId: "HtmlVideoRenderer"
  formId: "htmlVideoRenderer"
  localMcpTool: "agenticgraph.html_video.render"
...
videoAgentRuntimeContract:
  ...
  inspiration: "Roboflow/supervision-inspired visual annotation, dataset, and zone-counting workflow"
  operatorConfig:
    ...
    storageKey: "agenticgraph:video-agent:validation-config:v1"
    envDocPathKey: "VITE_AGENTICGRAPH_VIDEO_AGENT_VALIDATION_DOC_PATH"
    envUrlsKey: "VITE_AGENTICGRAPH_VIDEO_AGENT_VALIDATION_URLS"
  referenceBoundary:
  ...
  dependencyPolicy:
    ...
    - "no copied external annotation code"
    - "no Roboflow/supervision runtime dependency"
    - "no external API key requirement"
    - "validation URLs stay operator-supplied outside repo source"
  capabilities:
    - "ingest"
    - "parse"
    - "annotate"
  ...
  frameBoundingBoxes:
    ...
    - {frameIndex: 1, timestampMs: 700, label: "context object", bbox: [0.15, 0.23, 0.334, 0.304], confidence: 0.83}
    - {frameIndex: 2, timestampMs: 1400, label: "tracked subject", bbox: [0.17, 0.18, 0.329, 0.309], confidence: 0.84}
    - {frameIndex: 3, timestampMs: 2100, label: "context object", bbox: [0.19, 0.23, 0.323, 0.313], confidence: 0.85}
    - {frameIndex: 4, timestampMs: 2800, label: "tracked subject", bbox: [0.21, 0.18, 0.318, 0.318], confidence: 0.86}
    - {frameIndex: 5, timestampMs: 3500, label: "context object", bbox: [0.23, 0.23, 0.312, 0.322], confidence: 0.86}
    - {frameIndex: 6, timestampMs: 4200, label: "tracked subject", bbox: [0.25, 0.18, 0.307, 0.327], confidence: 0.87}
    - {frameIndex: 7, timestampMs: 4900, label: "context object", bbox: [0.27, 0.23, 0.301, 0.331], confidence: 0.88}
    - {frameIndex: 8, timestampMs: 5600, label: "tracked subject", bbox: [0.29, 0.18, 0.296, 0.336], confidence: 0.89}
    - {frameIndex: 9, timestampMs: 6300, label: "context object", bbox: [0.31, 0.23, 0.29, 0.34], confidence: 0.90}
  sourceTruth:
  ...
  outputBoundary:
    ...
    - "sourcePlaybackUrl, sourceTranscript, and frameByFrameTranscript are runtime-derived parse outputs, not persisted validation URL fixtures"
    ...
    - "visualDataset, mergedVisualDataset, datasetSplitSummary, datasetOperationSummary, savedDatasetArtifact, and zoneCounting are Render_Spec data outputs derived from frameBoundingBoxes"
...
visualAnnotationRuntimeContract:
  schema: "agenticgraph-annotation/v1"
  ...
  runtimeBoundary:
    ...
    - "modelHint overrides AGENTICGRAPH_ANNOTATION_MODEL only when it resolves to ANNOTATION_MODEL_IDS"
...
designAgentVideoWorkspaceContract:
  schema: "agenticgraph-design-agent-video/v1"
  floatingPanel:
    - "Workspace files"
    - "Compositions"
    - "Assets"
...
flow:
  ...
  nodes:
    - id: {key: id, type: string, value: "html_video_source_spec"}
      ...
      data_json: {key: data_json, type: json, value: "{\"title\":\"AgenticGraph Video Agent Demo\",\"engine\":\"canvas-2d\",\"rasterizer\":\"html2canvas\",\"output\":\"video/mp4\",\"referencePattern\":\"visual-annotation-inspired video workflow; no copied code and no external dependency\",\"composition\":{\"id\":\"agenticgraph-video-agent-youtube-demo\",\"durationMs\":7000,\"fps\":24,\"width\":1280,\"height\":720},\"sourceVideo\":{\"sourceKey\":\"operator-supplied-video-agent-validation-source\",\"ingestMode\":\"operator-supplied-validation-config\",\"externalDependency\":false,\"playbackEmbedUrl\":\"operator-supplied validation source\",\"label\":\"operator-supplied validation source\"},\"agentIntent\":\"reason through complex video tasks: search, editing, compilation, generation, and streaming\",\"capabilities\":[\"ingest\",\"parse\",\"annotate\",\"dataset\",\"zone_count\",\"search\",\"edit\",\"compile\",\"generate\",\"stream\"],\"agents\":[{\"id\":\"source_intake\",\"role\":\"ingest\",\"output\":\"source key and media manifest\"},{\"id\":\"video_parser\",\"role\":\"parse\",\"output\":\"transcript, frame labels, annotation tasks\"},{\"id\":\"moment_searcher\",\"role\":\"search\",\"output\":\"ranked evidence windows\"},{\"id\":\"edit_planner\",\"role\":\"edit\",\"output\":\"clip ranges, overlays, subtitles, pacing\"},{\"id\":\"timeline_compiler\",\"role\":\"compile\",\"output\":\"timeline manifest and render spec\"},{\"id\":\"generation_router\",\"role\":\"generate\",\"output\":\"generated overlay or narration placeholders\"},{\"id\":\"stream_publisher\",\"role\":\"stream\",\"output\":\"videoUrl or outputSrcDoc rich-media payload\"},{\"id\":\"frame_annotator\",\"role\":\"annotate\",\"output\":\"frame bounding boxes and annotation tasks\"},{\"id\":\"dataset_builder\",\"role\":\"dataset\",\"output\":\"visual dataset load split merge save summary\"},{\"id\":\"zone_counter\",\"role\":\"zone_count\",\"output\":\"frame-ordered zone counts and cumulative counts\"}],\"reasoningArtifacts\":[{\"capability\":\"search\",\"task\":\"Search transcript, frame, and annotation evidence\",\"decision\":\"Rank reusable evidence windows without a provider-specific search API\",\"outputArtifact\":\"video-agent/moments.json\",\"streamSignal\":\"moments-ready\"},{\"capability\":\"edit\",\"task\":\"Plan clips, overlays, subtitles, and pacing\",\"decision\":\"Store edit decisions as timeline data\",\"outputArtifact\":\"video-agent/edit-plan.json\",\"streamSignal\":\"edit-ready\"},{\"capability\":\"compile\",\"task\":\"Compile the selected moments into Render_Spec output\",\"decision\":\"Reuse the existing HTML Video Renderer path\",\"outputArtifact\":\"video-agent/render.html\",\"streamSignal\":\"render-spec-ready\"},{\"capability\":\"generate\",\"task\":\"Plan generated overlays and narration placeholders\",\"decision\":\"Defer live generation to optional local tools\",\"outputArtifact\":\"video-agent/generated-assets.json\",\"streamSignal\":\"generation-plan-ready\"},{\"capability\":\"stream\",\"task\":\"Publish the compiled result immediately\",\"decision\":\"Prefer video/mp4 and preserve outputSrcDoc fallback\",\"outputArtifact\":\"video-agent/stream-manifest.json\",\"streamSignal\":\"stream-ready\"}],\"workspaceFiles\":[{\"path\":\"video-agent/source.json\",\"kind\":\"json\",\"role\":\"source-manifest\"},{\"path\":\"video-agent/parse.json\",\"kind\":\"json\",\"role\":\"parse-output\"},{\"path\":\"video-agent/moments.json\",\"kind\":\"json\",\"role\":\"search-index\"},{\"path\":\"video-agent/timeline.json\",\"kind\":\"json\",\"role\":\"edit-plan\"},{\"path\":\"video-agent/generated-assets.json\",\"kind\":\"json\",\"role\":\"generation-plan\"},{\"path\":\"video-agent/frame-boxes.json\",\"kind\":\"json\",\"role\":\"frame-bounding-boxes\"},{\"path\":\"video-agent/render.html\",\"kind\":\"html\",\"role\":\"composition\"},{\"path\":\"video-agent/stream-manifest.json\",\"kind\":\"json\",\"role\":\"stream-output\"}],\"timelineTracks\":[{\"id\":\"video_agent_source_video\",\"label\":\"Source video\",\"trackIndex\":0,\"startMs\":0,\"durationMs\":7000,\"phase\":\"ingestion\",\"output\":\"audio-capable source frames\",\"timelineLane\":\"video\",\"source\":\"source-video\",\"frameSamples\":[{\"frameIndex\":0,\"timestampMs\":0,\"frameImageUrl\":\"/__video_frame?source=operator-supplied-video-agent-validation-source&time=0&format=png\"},{\"frameIndex\":1,\"timestampMs\":700,\"frameImageUrl\":\"/__video_frame?source=operator-supplied-video-agent-validation-source&time=0.7&format=png\"},{\"frameIndex\":2,\"timestampMs\":1400,\"frameImageUrl\":\"/__video_frame?source=operator-supplied-video-agent-validation-source&time=1.4&format=png\"},{\"frameIndex\":3,\"timestampMs\":2100,\"frameImageUrl\":\"/__video_frame?source=operator-supplied-video-agent-validation-source&time=2.1&format=png\"},{\"frameIndex\":4,\"timestampMs\":2800,\"frameImageUrl\":\"/__video_frame?source=operator-supplied-video-agent-validation-source&time=2.8&format=png\"},{\"frameIndex\":5,\"timestampMs\":3500,\"frameImageUrl\":\"/__video_frame?source=operator-supplied-video-agent-validation-source&time=3.5&format=png\"}],\"frameSampleCount\":10},{\"id\":\"video_agent_frame_by_frame_boxes\",\"label\":\"Frame-by-frame annotation samples (10)\",\"trackIndex\":1,\"startMs\":0,\"durationMs\":7000,\"phase\":\"parsing\",\"output\":\"source frame-by-frame annotations and bounding boxes\",\"timelineLane\":\"fbf\",\"source\":\"frame-bounding-boxes\",\"frameSamples\":[{\"frameIndex\":0,\"timestampMs\":0,\"frameImageUrl\":\"/__video_frame?source=operator-supplied-video-agent-validation-source&time=0&format=png\"},{\"frameIndex\":1,\"timestampMs\":700,\"frameImageUrl\":\"/__video_frame?source=operator-supplied-video-agent-validation-source&time=0.7&format=png\"},{\"frameIndex\":2,\"timestampMs\":1400,\"frameImageUrl\":\"/__video_frame?source=operator-supplied-video-agent-validation-source&time=1.4&format=png\"},{\"frameIndex\":3,\"timestampMs\":2100,\"frameImageUrl\":\"/__video_frame?source=operator-supplied-video-agent-validation-source&time=2.1&format=png\"},{\"frameIndex\":4,\"timestampMs\":2800,\"frameImageUrl\":\"/__video_frame?source=operator-supplied-video-agent-validation-source&time=2.8&format=png\"},{\"frameIndex\":5,\"timestampMs\":3500,\"frameImageUrl\":\"/__video_frame?source=operator-supplied-video-agent-validation-source&time=3.5&format=png\"}],\"frameSampleCount\":10},{\"id\":\"video_agent_source_audio\",\"label\":\"Source audio waveform\",\"trackIndex\":0,\"startMs\":0,\"durationMs\":7000,\"phase\":\"rendering\",\"output\":\"audio-capable source playback waveform and mix\",\"timelineLane\":\"audio\",\"source\":\"source-audio\"}],\"streaming\":{\"primary\":\"video/mp4\",\"fallback\":\"outputSrcDoc\",\"panel\":\"RichMediaPanel\",\"panels\":[\"RichMediaPanel:stream\",\"RichMediaPanel:frame-analysis\",\"RichMediaPanel:floatingpanel-annotation\"]},\"safeguards\":[\"no copied external annotation code\",\"no Roboflow/supervision runtime dependency\",\"no API key requirement\",\"source document stores no generated blob URLs\"],\"frameBoundingBoxes\":[{\"frameIndex\":0,\"timestampMs\":0,\"label\":\"tracked subject\",\"bbox\":[0.13,0.18,0.34,0.3],\"confidence\":0.82},{\"frameIndex\":1,\"timestampMs\":700,\"label\":\"context object\",\"bbox\":[0.15,0.23,0.334,0.304],\"confidence\":0.83},{\"frameIndex\":2,\"timestampMs\":1400,\"label\":\"tracked subject\",\"bbox\":[0.17,0.18,0.329,0.309],\"confidence\":0.84},{\"frameIndex\":3,\"timestampMs\":2100,\"label\":\"context object\",\"bbox\":[0.19,0.23,0.323,0.313],\"confidence\":0.85},{\"frameIndex\":4,\"timestampMs\":2800,\"label\":\"tracked subject\",\"bbox\":[0.21,0.18,0.318,0.318],\"confidence\":0.86},{\"frameIndex\":5,\"timestampMs\":3500,\"label\":\"context object\",\"bbox\":[0.23,0.23,0.312,0.322],\"confidence\":0.86},{\"frameIndex\":6,\"timestampMs\":4200,\"label\":\"tracked subject\",\"bbox\":[0.25,0.18,0.307,0.327],\"confidence\":0.87},{\"frameIndex\":7,\"timestampMs\":4900,\"label\":\"context object\",\"bbox\":[0.27,0.23,0.301,0.331],\"confidence\":0.88},{\"frameIndex\":8,\"timestampMs\":5600,\"label\":\"tracked subject\",\"bbox\":[0.29,0.18,0.296,0.336],\"confidence\":0.89},{\"frameIndex\":9,\"timestampMs\":6300,\"label\":\"context object\",\"bbox\":[0.31,0.23,0.29,0.34],\"confidence\":0.9}],\"frameBoundingBoxTimelineTracks\":[{\"id\":\"frame_box_0_fbf\",\"label\":\"Frame-by-frame bbox 0.0s tracked subject\",\"trackIndex\":0,\"startMs\":0,\"durationMs\":700,\"phase\":\"parsing\",\"output\":\"tracked subject 0.82 [0.13, 0.18, 0.34, 0.3]\",\"timelineLane\":\"fbf\",\"source\":\"frameBoundingBox\",\"bbox\":[0.13,0.18,0.34,0.3],\"confidence\":0.82,\"frameIndex\":0},{\"id\":\"frame_box_1_fbf\",\"label\":\"Frame-by-frame bbox 0.7s context object\",\"trackIndex\":1,\"startMs\":700,\"durationMs\":700,\"phase\":\"parsing\",\"output\":\"context object 0.83 [0.15, 0.23, 0.334, 0.304]\",\"timelineLane\":\"fbf\",\"source\":\"frameBoundingBox\",\"bbox\":[0.15,0.23,0.334,0.304],\"confidence\":0.83,\"frameIndex\":1},{\"id\":\"frame_box_2_fbf\",\"label\":\"Frame-by-frame bbox 1.4s tracked subject\",\"trackIndex\":2,\"startMs\":1400,\"durationMs\":700,\"phase\":\"parsing\",\"output\":\"tracked subject 0.84 [0.17, 0.18, 0.329, 0.309]\",\"timelineLane\":\"fbf\",\"source\":\"frameBoundingBox\",\"bbox\":[0.17,0.18,0.329,0.309],\"confidence\":0.84,\"frameIndex\":2},{\"id\":\"frame_box_3_fbf\",\"label\":\"Frame-by-frame bbox 2.1s context object\",\"trackIndex\":3,\"startMs\":2100,\"durationMs\":700,\"phase\":\"parsing\",\"output\":\"context object 0.85 [0.19, 0.23, 0.323, 0.313]\",\"timelineLane\":\"fbf\",\"source\":\"frameBoundingBox\",\"bbox\":[0.19,0.23,0.323,0.313],\"confidence\":0.85,\"frameIndex\":3},{\"id\":\"frame_box_4_fbf\",\"label\":\"Frame-by-frame bbox 2.8s tracked subject\",\"trackIndex\":4,\"startMs\":2800,\"durationMs\":700,\"phase\":\"parsing\",\"output\":\"tracked subject 0.86 [0.21, 0.18, 0.318, 0.318]\",\"timelineLane\":\"fbf\",\"source\":\"frameBoundingBox\",\"bbox\":[0.21,0.18,0.318,0.318],\"confidence\":0.86,\"frameIndex\":4},{\"id\":\"frame_box_5_fbf\",\"label\":\"Frame-by-frame bbox 3.5s context object\",\"trackIndex\":5,\"startMs\":3500,\"durationMs\":700,\"phase\":\"parsing\",\"output\":\"context object 0.86 [0.23, 0.23, 0.312, 0.322]\",\"timelineLane\":\"fbf\",\"source\":\"frameBoundingBox\",\"bbox\":[0.23,0.23,0.312,0.322],\"confidence\":0.86,\"frameIndex\":5},{\"id\":\"frame_box_6_fbf\",\"label\":\"Frame-by-frame bbox 4.2s tracked subject\",\"trackIndex\":6,\"startMs\":4200,\"durationMs\":700,\"phase\":\"parsing\",\"output\":\"tracked subject 0.87 [0.25, 0.18, 0.307, 0.327]\",\"timelineLane\":\"fbf\",\"source\":\"frameBoundingBox\",\"bbox\":[0.25,0.18,0.307,0.327],\"confidence\":0.87,\"frameIndex\":6},{\"id\":\"frame_box_7_fbf\",\"label\":\"Frame-by-frame bbox 4.9s context object\",\"trackIndex\":7,\"startMs\":4900,\"durationMs\":700,\"phase\":\"parsing\",\"output\":\"context object 0.88 [0.27, 0.23, 0.301, 0.331]\",\"timelineLane\":\"fbf\",\"source\":\"frameBoundingBox\",\"bbox\":[0.27,0.23,0.301,0.331],\"confidence\":0.88,\"frameIndex\":7},{\"id\":\"frame_box_8_fbf\",\"label\":\"Frame-by-frame bbox 5.6s tracked subject\",\"trackIndex\":8,\"startMs\":5600,\"durationMs\":700,\"phase\":\"parsing\",\"output\":\"tracked subject 0.89 [0.29, 0.18, 0.296, 0.336]\",\"timelineLane\":\"fbf\",\"source\":\"frameBoundingBox\",\"bbox\":[0.29,0.18,0.296,0.336],\"confidence\":0.89,\"frameIndex\":8},{\"id\":\"frame_box_9_fbf\",\"label\":\"Frame-by-frame bbox 6.3s context object\",\"trackIndex\":9,\"startMs\":6300,\"durationMs\":700,\"phase\":\"parsing\",\"output\":\"context object 0.90 [0.31, 0.23, 0.29, 0.34]\",\"timelineLane\":\"fbf\",\"source\":\"frameBoundingBox\",\"bbox\":[0.31,0.23,0.29,0.34],\"confidence\":0.9,\"frameIndex\":9}],\"timelineLanes\":[{\"id\":\"source-video\",\"label\":\"Source video\",\"tracks\":[\"video_agent_source_video\"]},{\"id\":\"frame-by-frame-boxes\",\"label\":\"Frame-by-frame boxes\",\"tracks\":[\"video_agent_frame_by_frame_boxes\"]},{\"id\":\"source-audio\",\"label\":\"Source audio\",\"tracks\":[\"video_agent_source_audio\"]}],\"bottomPanelTimelineSync\":{\"surface\":\"BottomPanel Timeline\",\"source\":\"video+fbf+audio\",\"lane\":\"video-fbf-audio\",\"thumbnailMode\":\"semantic-frame-samples\",\"trackIds\":[\"video_agent_source_video\",\"video_agent_frame_by_frame_boxes\",\"video_agent_source_audio\"]},\"frameByFrameSamples\":[{\"frameIndex\":0,\"timestampMs\":0,\"label\":\"tracked subject\",\"confidence\":0.82,\"bbox\":[0.13,0.18,0.34,0.3],\"sampleId\":\"frame-sample-0\",\"annotationCount\":1,\"zoneCounts\":{\"zone-a\":1},\"cumulativeZoneCounts\":{\"zone-a\":1,\"zone-b\":0,\"zone-c\":0}},{\"frameIndex\":1,\"timestampMs\":700,\"label\":\"context object\",\"confidence\":0.83,\"bbox\":[0.15,0.23,0.334,0.304],\"sampleId\":\"frame-sample-1\",\"annotationCount\":1,\"zoneCounts\":{\"zone-a\":1},\"cumulativeZoneCounts\":{\"zone-a\":2,\"zone-b\":0,\"zone-c\":0}},{\"frameIndex\":2,\"timestampMs\":1400,\"label\":\"tracked subject\",\"confidence\":0.84,\"bbox\":[0.17,0.18,0.329,0.309],\"sampleId\":\"frame-sample-2\",\"annotationCount\":1,\"zoneCounts\":{\"zone-b\":1},\"cumulativeZoneCounts\":{\"zone-a\":2,\"zone-b\":1,\"zone-c\":0}},{\"frameIndex\":3,\"timestampMs\":2100,\"label\":\"context object\",\"confidence\":0.85,\"bbox\":[0.19,0.23,0.323,0.313],\"sampleId\":\"frame-sample-3\",\"annotationCount\":1,\"zoneCounts\":{\"zone-b\":1},\"cumulativeZoneCounts\":{\"zone-a\":2,\"zone-b\":2,\"zone-c\":0}},{\"frameIndex\":4,\"timestampMs\":2800,\"label\":\"tracked subject\",\"confidence\":0.86,\"bbox\":[0.21,0.18,0.318,0.318],\"sampleId\":\"frame-sample-4\",\"annotationCount\":1,\"zoneCounts\":{\"zone-b\":1},\"cumulativeZoneCounts\":{\"zone-a\":2,\"zone-b\":3,\"zone-c\":0}},{\"frameIndex\":5,\"timestampMs\":3500,\"label\":\"context object\",\"confidence\":0.86,\"bbox\":[0.23,0.23,0.312,0.322],\"sampleId\":\"frame-sample-5\",\"annotationCount\":1,\"zoneCounts\":{\"zone-b\":1},\"cumulativeZoneCounts\":{\"zone-a\":2,\"zone-b\":4,\"zone-c\":0}},{\"frameIndex\":6,\"timestampMs\":4200,\"label\":\"tracked subject\",\"confidence\":0.87,\"bbox\":[0.25,0.18,0.307,0.327],\"sampleId\":\"frame-sample-6\",\"annotationCount\":1,\"zoneCounts\":{\"zone-b\":1},\"cumulativeZoneCounts\":{\"zone-a\":2,\"zone-b\":5,\"zone-c\":0}},{\"frameIndex\":7,\"timestampMs\":4900,\"label\":\"context object\",\"confidence\":0.88,\"bbox\":[0.27,0.23,0.301,0.331],\"sampleId\":\"frame-sample-7\",\"annotationCount\":1,\"zoneCounts\":{\"zone-b\":1},\"cumulativeZoneCounts\":{\"zone-a\":2,\"zone-b\":6,\"zone-c\":0}},{\"frameIndex\":8,\"timestampMs\":5600,\"label\":\"tracked subject\",\"confidence\":0.89,\"bbox\":[0.29,0.18,0.296,0.336],\"sampleId\":\"frame-sample-8\",\"annotationCount\":1,\"zoneCounts\":{\"zone-b\":1},\"cumulativeZoneCounts\":{\"zone-a\":2,\"zone-b\":7,\"zone-c\":0}},{\"frameIndex\":9,\"timestampMs\":6300,\"label\":\"context object\",\"confidence\":0.9,\"bbox\":[0.31,0.23,0.29,0.34],\"sampleId\":\"frame-sample-9\",\"annotationCount\":1,\"zoneCounts\":{\"zone-b\":1},\"cumulativeZoneCounts\":{\"zone-a\":2,\"zone-b\":8,\"zone-c\":0}}],\"richMediaPanels\":[{\"route\":\"RichMediaPanel:stream\",\"timelineSync\":\"agenticgraph:render-frame\",\"role\":\"stream-output\",\"inputs\":[\"videoUrl\",\"outputSrcDoc\",\"frameBoundingBoxes\"]},{\"route\":\"RichMediaPanel:frame-analysis\",\"timelineSync\":\"agenticgraph:render-frame\",\"role\":\"frame-analysis\",\"inputs\":[\"outputSrcDoc\",\"frameBoundingBoxes\",\"zoneCounting\"]},{\"route\":\"RichMediaPanel:floatingpanel-annotation\",\"timelineSync\":\"agenticgraph:render-frame\",\"role\":\"visual-annotation-dataset\",\"inputs\":[\"visualDataset\",\"mergedVisualDataset\",\"zoneCounting\"]}],\"datasetOperationSummary\":{\"loadedSamples\":10,\"mergedSamples\":10,\"savedSamples\":10,\"zoneCountedFrames\":10},\"validationInput\":{\"source\":\"operator-supplied\",\"storageKey\":\"agenticgraph:video-agent:validation-config:v1\",\"hardcodePolicy\":\"forbid-repo-url-fixtures\"}}"}
      ...
      frameBoundingBoxes: {key: frameBoundingBoxes, type: json, value: "[{\"frameIndex\":0,\"timestampMs\":0,\"label\":\"tracked subject\",\"bbox\":[0.13,0.18,0.34,0.3],\"confidence\":0.82},{\"frameIndex\":1,\"timestampMs\":700,\"label\":\"context object\",\"bbox\":[0.15,0.23,0.334,0.304],\"confidence\":0.83},{\"frameIndex\":2,\"timestampMs\":1400,\"label\":\"tracked subject\",\"bbox\":[0.17,0.18,0.329,0.309],\"confidence\":0.84},{\"frameIndex\":3,\"timestampMs\":2100,\"label\":\"context object\",\"bbox\":[0.19,0.23,0.323,0.313],\"confidence\":0.85},{\"frameIndex\":4,\"timestampMs\":2800,\"label\":\"tracked subject\",\"bbox\":[0.21,0.18,0.318,0.318],\"confidence\":0.86},{\"frameIndex\":5,\"timestampMs\":3500,\"label\":\"context object\",\"bbox\":[0.23,0.23,0.312,0.322],\"confidence\":0.86},{\"frameIndex\":6,\"timestampMs\":4200,\"label\":\"tracked subject\",\"bbox\":[0.25,0.18,0.307,0.327],\"confidence\":0.87},{\"frameIndex\":7,\"timestampMs\":4900,\"label\":\"context object\",\"bbox\":[0.27,0.23,0.301,0.331],\"confidence\":0.88},{\"frameIndex\":8,\"timestampMs\":5600,\"label\":\"tracked subject\",\"bbox\":[0.29,0.18,0.296,0.336],\"confidence\":0.89},{\"frameIndex\":9,\"timestampMs\":6300,\"label\":\"context object\",\"bbox\":[0.31,0.23,0.29,0.34],\"confidence\":0.9}]"}
    ...
    - id: {key: id, type: string, value: "html_video_renderer_node"}
      ...
      data_json: {key: data_json, type: textarea, value: "{\"title\":\"AgenticGraph Video Agent Demo\",\"engine\":\"canvas-2d\",\"rasterizer\":\"html2canvas\",\"output\":\"video/mp4\",\"referencePattern\":\"visual-annotation-inspired video workflow; no copied code and no external dependency\",\"composition\":{\"id\":\"agenticgraph-video-agent-youtube-demo\",\"durationMs\":7000,\"fps\":24,\"width\":1280,\"height\":720},\"sourceVideo\":{\"sourceKey\":\"operator-supplied-video-agent-validation-source\",\"ingestMode\":\"operator-supplied-validation-config\",\"externalDependency\":false,\"playbackEmbedUrl\":\"operator-supplied validation source\",\"label\":\"operator-supplied validation source\"},\"agentIntent\":\"reason through complex video tasks: search, editing, compilation, generation, and streaming\",\"capabilities\":[\"ingest\",\"parse\",\"annotate\",\"dataset\",\"zone_count\",\"search\",\"edit\",\"compile\",\"generate\",\"stream\"],\"agents\":[{\"id\":\"source_intake\",\"role\":\"ingest\",\"output\":\"source key and media manifest\"},{\"id\":\"video_parser\",\"role\":\"parse\",\"output\":\"transcript, frame labels, annotation tasks\"},{\"id\":\"moment_searcher\",\"role\":\"search\",\"output\":\"ranked evidence windows\"},{\"id\":\"edit_planner\",\"role\":\"edit\",\"output\":\"clip ranges, overlays, subtitles, pacing\"},{\"id\":\"timeline_compiler\",\"role\":\"compile\",\"output\":\"timeline manifest and render spec\"},{\"id\":\"generation_router\",\"role\":\"generate\",\"output\":\"generated overlay or narration placeholders\"},{\"id\":\"stream_publisher\",\"role\":\"stream\",\"output\":\"videoUrl or outputSrcDoc rich-media payload\"},{\"id\":\"frame_annotator\",\"role\":\"annotate\",\"output\":\"frame bounding boxes and annotation tasks\"},{\"id\":\"dataset_builder\",\"role\":\"dataset\",\"output\":\"visual dataset load split merge save summary\"},{\"id\":\"zone_counter\",\"role\":\"zone_count\",\"output\":\"frame-ordered zone counts and cumulative counts\"}],\"reasoningArtifacts\":[{\"capability\":\"search\",\"task\":\"Search transcript, frame, and annotation evidence\",\"decision\":\"Rank reusable evidence windows without a provider-specific search API\",\"outputArtifact\":\"video-agent/moments.json\",\"streamSignal\":\"moments-ready\"},{\"capability\":\"edit\",\"task\":\"Plan clips, overlays, subtitles, and pacing\",\"decision\":\"Store edit decisions as timeline data\",\"outputArtifact\":\"video-agent/edit-plan.json\",\"streamSignal\":\"edit-ready\"},{\"capability\":\"compile\",\"task\":\"Compile the selected moments into Render_Spec output\",\"decision\":\"Reuse the existing HTML Video Renderer path\",\"outputArtifact\":\"video-agent/render.html\",\"streamSignal\":\"render-spec-ready\"},{\"capability\":\"generate\",\"task\":\"Plan generated overlays and narration placeholders\",\"decision\":\"Defer live generation to optional local tools\",\"outputArtifact\":\"video-agent/generated-assets.json\",\"streamSignal\":\"generation-plan-ready\"},{\"capability\":\"stream\",\"task\":\"Publish the compiled result immediately\",\"decision\":\"Prefer video/mp4 and preserve outputSrcDoc fallback\",\"outputArtifact\":\"video-agent/stream-manifest.json\",\"streamSignal\":\"stream-ready\"}],\"workspaceFiles\":[{\"path\":\"video-agent/source.json\",\"kind\":\"json\",\"role\":\"source-manifest\"},{\"path\":\"video-agent/parse.json\",\"kind\":\"json\",\"role\":\"parse-output\"},{\"path\":\"video-agent/moments.json\",\"kind\":\"json\",\"role\":\"search-index\"},{\"path\":\"video-agent/timeline.json\",\"kind\":\"json\",\"role\":\"edit-plan\"},{\"path\":\"video-agent/generated-assets.json\",\"kind\":\"json\",\"role\":\"generation-plan\"},{\"path\":\"video-agent/frame-boxes.json\",\"kind\":\"json\",\"role\":\"frame-bounding-boxes\"},{\"path\":\"video-agent/render.html\",\"kind\":\"html\",\"role\":\"composition\"},{\"path\":\"video-agent/stream-manifest.json\",\"kind\":\"json\",\"role\":\"stream-output\"}],\"timelineTracks\":[{\"id\":\"video_agent_source_video\",\"label\":\"Source video\",\"trackIndex\":0,\"startMs\":0,\"durationMs\":7000,\"phase\":\"ingestion\",\"output\":\"audio-capable source frames\",\"timelineLane\":\"video\",\"source\":\"source-video\",\"frameSamples\":[{\"frameIndex\":0,\"timestampMs\":0,\"frameImageUrl\":\"/__video_frame?source=operator-supplied-video-agent-validation-source&time=0&format=png\"},{\"frameIndex\":1,\"timestampMs\":700,\"frameImageUrl\":\"/__video_frame?source=operator-supplied-video-agent-validation-source&time=0.7&format=png\"},{\"frameIndex\":2,\"timestampMs\":1400,\"frameImageUrl\":\"/__video_frame?source=operator-supplied-video-agent-validation-source&time=1.4&format=png\"},{\"frameIndex\":3,\"timestampMs\":2100,\"frameImageUrl\":\"/__video_frame?source=operator-supplied-video-agent-validation-source&time=2.1&format=png\"},{\"frameIndex\":4,\"timestampMs\":2800,\"frameImageUrl\":\"/__video_frame?source=operator-supplied-video-agent-validation-source&time=2.8&format=png\"},{\"frameIndex\":5,\"timestampMs\":3500,\"frameImageUrl\":\"/__video_frame?source=operator-supplied-video-agent-validation-source&time=3.5&format=png\"}],\"frameSampleCount\":10},{\"id\":\"video_agent_frame_by_frame_boxes\",\"label\":\"Frame-by-frame annotation samples (10)\",\"trackIndex\":1,\"startMs\":0,\"durationMs\":7000,\"phase\":\"parsing\",\"output\":\"source frame-by-frame annotations and bounding boxes\",\"timelineLane\":\"fbf\",\"source\":\"frame-bounding-boxes\",\"frameSamples\":[{\"frameIndex\":0,\"timestampMs\":0,\"frameImageUrl\":\"/__video_frame?source=operator-supplied-video-agent-validation-source&time=0&format=png\"},{\"frameIndex\":1,\"timestampMs\":700,\"frameImageUrl\":\"/__video_frame?source=operator-supplied-video-agent-validation-source&time=0.7&format=png\"},{\"frameIndex\":2,\"timestampMs\":1400,\"frameImageUrl\":\"/__video_frame?source=operator-supplied-video-agent-validation-source&time=1.4&format=png\"},{\"frameIndex\":3,\"timestampMs\":2100,\"frameImageUrl\":\"/__video_frame?source=operator-supplied-video-agent-validation-source&time=2.1&format=png\"},{\"frameIndex\":4,\"timestampMs\":2800,\"frameImageUrl\":\"/__video_frame?source=operator-supplied-video-agent-validation-source&time=2.8&format=png\"},{\"frameIndex\":5,\"timestampMs\":3500,\"frameImageUrl\":\"/__video_frame?source=operator-supplied-video-agent-validation-source&time=3.5&format=png\"}],\"frameSampleCount\":10},{\"id\":\"video_agent_source_audio\",\"label\":\"Source audio waveform\",\"trackIndex\":0,\"startMs\":0,\"durationMs\":7000,\"phase\":\"rendering\",\"output\":\"audio-capable source playback waveform and mix\",\"timelineLane\":\"audio\",\"source\":\"source-audio\"}],\"streaming\":{\"primary\":\"video/mp4\",\"fallback\":\"outputSrcDoc\",\"panel\":\"RichMediaPanel\",\"panels\":[\"RichMediaPanel:stream\",\"RichMediaPanel:frame-analysis\",\"RichMediaPanel:floatingpanel-annotation\"]},\"safeguards\":[\"no copied external annotation code\",\"no Roboflow/supervision runtime dependency\",\"no API key requirement\",\"source document stores no generated blob URLs\"],\"frameBoundingBoxes\":[{\"frameIndex\":0,\"timestampMs\":0,\"label\":\"tracked subject\",\"bbox\":[0.13,0.18,0.34,0.3],\"confidence\":0.82},{\"frameIndex\":1,\"timestampMs\":700,\"label\":\"context object\",\"bbox\":[0.15,0.23,0.334,0.304],\"confidence\":0.83},{\"frameIndex\":2,\"timestampMs\":1400,\"label\":\"tracked subject\",\"bbox\":[0.17,0.18,0.329,0.309],\"confidence\":0.84},{\"frameIndex\":3,\"timestampMs\":2100,\"label\":\"context object\",\"bbox\":[0.19,0.23,0.323,0.313],\"confidence\":0.85},{\"frameIndex\":4,\"timestampMs\":2800,\"label\":\"tracked subject\",\"bbox\":[0.21,0.18,0.318,0.318],\"confidence\":0.86},{\"frameIndex\":5,\"timestampMs\":3500,\"label\":\"context object\",\"bbox\":[0.23,0.23,0.312,0.322],\"confidence\":0.86},{\"frameIndex\":6,\"timestampMs\":4200,\"label\":\"tracked subject\",\"bbox\":[0.25,0.18,0.307,0.327],\"confidence\":0.87},{\"frameIndex\":7,\"timestampMs\":4900,\"label\":\"context object\",\"bbox\":[0.27,0.23,0.301,0.331],\"confidence\":0.88},{\"frameIndex\":8,\"timestampMs\":5600,\"label\":\"tracked subject\",\"bbox\":[0.29,0.18,0.296,0.336],\"confidence\":0.89},{\"frameIndex\":9,\"timestampMs\":6300,\"label\":\"context object\",\"bbox\":[0.31,0.23,0.29,0.34],\"confidence\":0.9}],\"frameBoundingBoxTimelineTracks\":[{\"id\":\"frame_box_0_fbf\",\"label\":\"Frame-by-frame bbox 0.0s tracked subject\",\"trackIndex\":0,\"startMs\":0,\"durationMs\":700,\"phase\":\"parsing\",\"output\":\"tracked subject 0.82 [0.13, 0.18, 0.34, 0.3]\",\"timelineLane\":\"fbf\",\"source\":\"frameBoundingBox\",\"bbox\":[0.13,0.18,0.34,0.3],\"confidence\":0.82,\"frameIndex\":0},{\"id\":\"frame_box_1_fbf\",\"label\":\"Frame-by-frame bbox 0.7s context object\",\"trackIndex\":1,\"startMs\":700,\"durationMs\":700,\"phase\":\"parsing\",\"output\":\"context object 0.83 [0.15, 0.23, 0.334, 0.304]\",\"timelineLane\":\"fbf\",\"source\":\"frameBoundingBox\",\"bbox\":[0.15,0.23,0.334,0.304],\"confidence\":0.83,\"frameIndex\":1},{\"id\":\"frame_box_2_fbf\",\"label\":\"Frame-by-frame bbox 1.4s tracked subject\",\"trackIndex\":2,\"startMs\":1400,\"durationMs\":700,\"phase\":\"parsing\",\"output\":\"tracked subject 0.84 [0.17, 0.18, 0.329, 0.309]\",\"timelineLane\":\"fbf\",\"source\":\"frameBoundingBox\",\"bbox\":[0.17,0.18,0.329,0.309],\"confidence\":0.84,\"frameIndex\":2},{\"id\":\"frame_box_3_fbf\",\"label\":\"Frame-by-frame bbox 2.1s context object\",\"trackIndex\":3,\"startMs\":2100,\"durationMs\":700,\"phase\":\"parsing\",\"output\":\"context object 0.85 [0.19, 0.23, 0.323, 0.313]\",\"timelineLane\":\"fbf\",\"source\":\"frameBoundingBox\",\"bbox\":[0.19,0.23,0.323,0.313],\"confidence\":0.85,\"frameIndex\":3},{\"id\":\"frame_box_4_fbf\",\"label\":\"Frame-by-frame bbox 2.8s tracked subject\",\"trackIndex\":4,\"startMs\":2800,\"durationMs\":700,\"phase\":\"parsing\",\"output\":\"tracked subject 0.86 [0.21, 0.18, 0.318, 0.318]\",\"timelineLane\":\"fbf\",\"source\":\"frameBoundingBox\",\"bbox\":[0.21,0.18,0.318,0.318],\"confidence\":0.86,\"frameIndex\":4},{\"id\":\"frame_box_5_fbf\",\"label\":\"Frame-by-frame bbox 3.5s context object\",\"trackIndex\":5,\"startMs\":3500,\"durationMs\":700,\"phase\":\"parsing\",\"output\":\"context object 0.86 [0.23, 0.23, 0.312, 0.322]\",\"timelineLane\":\"fbf\",\"source\":\"frameBoundingBox\",\"bbox\":[0.23,0.23,0.312,0.322],\"confidence\":0.86,\"frameIndex\":5},{\"id\":\"frame_box_6_fbf\",\"label\":\"Frame-by-frame bbox 4.2s tracked subject\",\"trackIndex\":6,\"startMs\":4200,\"durationMs\":700,\"phase\":\"parsing\",\"output\":\"tracked subject 0.87 [0.25, 0.18, 0.307, 0.327]\",\"timelineLane\":\"fbf\",\"source\":\"frameBoundingBox\",\"bbox\":[0.25,0.18,0.307,0.327],\"confidence\":0.87,\"frameIndex\":6},{\"id\":\"frame_box_7_fbf\",\"label\":\"Frame-by-frame bbox 4.9s context object\",\"trackIndex\":7,\"startMs\":4900,\"durationMs\":700,\"phase\":\"parsing\",\"output\":\"context object 0.88 [0.27, 0.23, 0.301, 0.331]\",\"timelineLane\":\"fbf\",\"source\":\"frameBoundingBox\",\"bbox\":[0.27,0.23,0.301,0.331],\"confidence\":0.88,\"frameIndex\":7},{\"id\":\"frame_box_8_fbf\",\"label\":\"Frame-by-frame bbox 5.6s tracked subject\",\"trackIndex\":8,\"startMs\":5600,\"durationMs\":700,\"phase\":\"parsing\",\"output\":\"tracked subject 0.89 [0.29, 0.18, 0.296, 0.336]\",\"timelineLane\":\"fbf\",\"source\":\"frameBoundingBox\",\"bbox\":[0.29,0.18,0.296,0.336],\"confidence\":0.89,\"frameIndex\":8},{\"id\":\"frame_box_9_fbf\",\"label\":\"Frame-by-frame bbox 6.3s context object\",\"trackIndex\":9,\"startMs\":6300,\"durationMs\":700,\"phase\":\"parsing\",\"output\":\"context object 0.90 [0.31, 0.23, 0.29, 0.34]\",\"timelineLane\":\"fbf\",\"source\":\"frameBoundingBox\",\"bbox\":[0.31,0.23,0.29,0.34],\"confidence\":0.9,\"frameIndex\":9}],\"timelineLanes\":[{\"id\":\"source-video\",\"label\":\"Source video\",\"tracks\":[\"video_agent_source_video\"]},{\"id\":\"frame-by-frame-boxes\",\"label\":\"Frame-by-frame boxes\",\"tracks\":[\"video_agent_frame_by_frame_boxes\"]},{\"id\":\"source-audio\",\"label\":\"Source audio\",\"tracks\":[\"video_agent_source_audio\"]}],\"bottomPanelTimelineSync\":{\"surface\":\"BottomPanel Timeline\",\"source\":\"video+fbf+audio\",\"lane\":\"video-fbf-audio\",\"thumbnailMode\":\"semantic-frame-samples\",\"trackIds\":[\"video_agent_source_video\",\"video_agent_frame_by_frame_boxes\",\"video_agent_source_audio\"]},\"frameByFrameSamples\":[{\"frameIndex\":0,\"timestampMs\":0,\"label\":\"tracked subject\",\"confidence\":0.82,\"bbox\":[0.13,0.18,0.34,0.3],\"sampleId\":\"frame-sample-0\",\"annotationCount\":1,\"zoneCounts\":{\"zone-a\":1},\"cumulativeZoneCounts\":{\"zone-a\":1,\"zone-b\":0,\"zone-c\":0}},{\"frameIndex\":1,\"timestampMs\":700,\"label\":\"context object\",\"confidence\":0.83,\"bbox\":[0.15,0.23,0.334,0.304],\"sampleId\":\"frame-sample-1\",\"annotationCount\":1,\"zoneCounts\":{\"zone-a\":1},\"cumulativeZoneCounts\":{\"zone-a\":2,\"zone-b\":0,\"zone-c\":0}},{\"frameIndex\":2,\"timestampMs\":1400,\"label\":\"tracked subject\",\"confidence\":0.84,\"bbox\":[0.17,0.18,0.329,0.309],\"sampleId\":\"frame-sample-2\",\"annotationCount\":1,\"zoneCounts\":{\"zone-b\":1},\"cumulativeZoneCounts\":{\"zone-a\":2,\"zone-b\":1,\"zone-c\":0}},{\"frameIndex\":3,\"timestampMs\":2100,\"label\":\"context object\",\"confidence\":0.85,\"bbox\":[0.19,0.23,0.323,0.313],\"sampleId\":\"frame-sample-3\",\"annotationCount\":1,\"zoneCounts\":{\"zone-b\":1},\"cumulativeZoneCounts\":{\"zone-a\":2,\"zone-b\":2,\"zone-c\":0}},{\"frameIndex\":4,\"timestampMs\":2800,\"label\":\"tracked subject\",\"confidence\":0.86,\"bbox\":[0.21,0.18,0.318,0.318],\"sampleId\":\"frame-sample-4\",\"annotationCount\":1,\"zoneCounts\":{\"zone-b\":1},\"cumulativeZoneCounts\":{\"zone-a\":2,\"zone-b\":3,\"zone-c\":0}},{\"frameIndex\":5,\"timestampMs\":3500,\"label\":\"context object\",\"confidence\":0.86,\"bbox\":[0.23,0.23,0.312,0.322],\"sampleId\":\"frame-sample-5\",\"annotationCount\":1,\"zoneCounts\":{\"zone-b\":1},\"cumulativeZoneCounts\":{\"zone-a\":2,\"zone-b\":4,\"zone-c\":0}},{\"frameIndex\":6,\"timestampMs\":4200,\"label\":\"tracked subject\",\"confidence\":0.87,\"bbox\":[0.25,0.18,0.307,0.327],\"sampleId\":\"frame-sample-6\",\"annotationCount\":1,\"zoneCounts\":{\"zone-b\":1},\"cumulativeZoneCounts\":{\"zone-a\":2,\"zone-b\":5,\"zone-c\":0}},{\"frameIndex\":7,\"timestampMs\":4900,\"label\":\"context object\",\"confidence\":0.88,\"bbox\":[0.27,0.23,0.301,0.331],\"sampleId\":\"frame-sample-7\",\"annotationCount\":1,\"zoneCounts\":{\"zone-b\":1},\"cumulativeZoneCounts\":{\"zone-a\":2,\"zone-b\":6,\"zone-c\":0}},{\"frameIndex\":8,\"timestampMs\":5600,\"label\":\"tracked subject\",\"confidence\":0.89,\"bbox\":[0.29,0.18,0.296,0.336],\"sampleId\":\"frame-sample-8\",\"annotationCount\":1,\"zoneCounts\":{\"zone-b\":1},\"cumulativeZoneCounts\":{\"zone-a\":2,\"zone-b\":7,\"zone-c\":0}},{\"frameIndex\":9,\"timestampMs\":6300,\"label\":\"context object\",\"confidence\":0.9,\"bbox\":[0.31,0.23,0.29,0.34],\"sampleId\":\"frame-sample-9\",\"annotationCount\":1,\"zoneCounts\":{\"zone-b\":1},\"cumulativeZoneCounts\":{\"zone-a\":2,\"zone-b\":8,\"zone-c\":0}}],\"richMediaPanels\":[{\"route\":\"RichMediaPanel:stream\",\"timelineSync\":\"agenticgraph:render-frame\",\"role\":\"stream-output\",\"inputs\":[\"videoUrl\",\"outputSrcDoc\",\"frameBoundingBoxes\"]},{\"route\":\"RichMediaPanel:frame-analysis\",\"timelineSync\":\"agenticgraph:render-frame\",\"role\":\"frame-analysis\",\"inputs\":[\"outputSrcDoc\",\"frameBoundingBoxes\",\"zoneCounting\"]},{\"route\":\"RichMediaPanel:floatingpanel-annotation\",\"timelineSync\":\"agenticgraph:render-frame\",\"role\":\"visual-annotation-dataset\",\"inputs\":[\"visualDataset\",\"mergedVisualDataset\",\"zoneCounting\"]}],\"datasetOperationSummary\":{\"loadedSamples\":10,\"mergedSamples\":10,\"savedSamples\":10,\"zoneCountedFrames\":10},\"validationInput\":{\"source\":\"operator-supplied\",\"storageKey\":\"agenticgraph:video-agent:validation-config:v1\",\"hardcodePolicy\":\"forbid-repo-url-fixtures\"}}"}
      ...
      frameBoundingBoxes: {key: frameBoundingBoxes, type: string, value: "[{\"frameIndex\":0,\"timestampMs\":0,\"label\":\"tracked subject\",\"bbox\":[0.13,0.18,0.34,0.3],\"confidence\":0.82},{\"frameIndex\":1,\"timestampMs\":700,\"label\":\"context object\",\"bbox\":[0.15,0.23,0.334,0.304],\"confidence\":0.83},{\"frameIndex\":2,\"timestampMs\":1400,\"label\":\"tracked subject\",\"bbox\":[0.17,0.18,0.329,0.309],\"confidence\":0.84},{\"frameIndex\":3,\"timestampMs\":2100,\"label\":\"context object\",\"bbox\":[0.19,0.23,0.323,0.313],\"confidence\":0.85},{\"frameIndex\":4,\"timestampMs\":2800,\"label\":\"tracked subject\",\"bbox\":[0.21,0.18,0.318,0.318],\"confidence\":0.86},{\"frameIndex\":5,\"timestampMs\":3500,\"label\":\"context object\",\"bbox\":[0.23,0.23,0.312,0.322],\"confidence\":0.86},{\"frameIndex\":6,\"timestampMs\":4200,\"label\":\"tracked subject\",\"bbox\":[0.25,0.18,0.307,0.327],\"confidence\":0.87},{\"frameIndex\":7,\"timestampMs\":4900,\"label\":\"context object\",\"bbox\":[0.27,0.23,0.301,0.331],\"confidence\":0.88},{\"frameIndex\":8,\"timestampMs\":5600,\"label\":\"tracked subject\",\"bbox\":[0.29,0.18,0.296,0.336],\"confidence\":0.89},{\"frameIndex\":9,\"timestampMs\":6300,\"label\":\"context object\",\"bbox\":[0.31,0.23,0.29,0.34],\"confidence\":0.9}]"}
      "frontmatter:primitive": {key: "frontmatter:primitive", type: string, value: "node"}
    ...
    - id: {key: id, type: string, value: "html_video_mp4_panel"}
      ...
      srcDoc:
        ...
        type: string
        value: |
          <style>body{margin:0;background:#07111f}main{box-sizing:border-box;width:100%;min-height:100%;display:grid;gap:12px;padding:14px;font-family:Inter,system-ui,sans-serif;background:#07111f;color:#f8fafc}p,h1,h2,h3{margin:0}.eyebrow{color:#5eead4;font-size:11px;font-weight:800;text-transform:uppercase;letter-spacing:.08em}header{display:grid;gap:5px}.lede{color:#cbd5e1;font-size:12px;line-height:1.45}.analysis-layout{display:grid;grid-template-columns:minmax(260px,1.2fr) minmax(220px,.8fr);gap:12px}.preview{margin:0}.thumbnail{position:relative;aspect-ratio:16/9;border:1px solid #334155;border-radius:8px;background:linear-gradient(135deg,#123456,#0b1220 55%,#0f766e);overflow:hidden}.thumbnail::before{content:"";position:absolute;inset:14% 18%;border:2px solid rgba(94,234,212,.72);border-radius:8px}.thumbnail-source{position:absolute;inset:0;width:100%;height:100%;object-fit:cover;opacity:.72}.frame-boxes{position:absolute;inset:0;pointer-events:none}.frame-box{position:absolute;border:2px solid #fbbf24;border-radius:6px;background:rgba(251,191,36,.1);box-shadow:0 0 0 1px rgba(15,23,42,.7)}.frame-box span{position:absolute;left:0;top:-18px;border-radius:4px;background:#fbbf24;color:#1f2937;padding:2px 5px;font:10px ui-monospace,SFMono-Regular,Menlo,monospace;white-space:nowrap}figcaption{margin-top:8px;color:#cbd5e1;font-size:11px;line-height:1.35}.frame-list{display:grid;gap:7px;margin:0;padding:0}.frame-list li{list-style:none;display:grid;grid-template-columns:auto 1fr;gap:7px;border:1px solid #334155;border-radius:8px;background:#0f172a;padding:8px}.frame-list strong{color:#5eead4;font-size:12px}.frame-list span{font-size:12px}.frame-list output{grid-column:1/-1;color:#93c5fd;font:10px ui-monospace,SFMono-Regular,Menlo,monospace}footer{display:grid;grid-template-columns:repeat(5,1fr);gap:6px}.phase{border:1px solid #334155;border-radius:8px;background:#111827;color:#e2e8f0;padding:7px;text-align:center;font-size:11px}</style><main data-composition-id="agenticgraph-video-agent-frame-analysis" aria-label="Video agent frame-by-frame bounding box analysis"><header><p class="eyebrow">Frame-by-frame bounding box analysis</p><h2>Video agent analysis for operator-supplied validation source</h2><p class="lede">The same parsed frame evidence is streamed as a Rich Media preview and as an inspection panel, so search, editing, compilation, generation, and stream decisions stay visible.</p></header><section class="analysis-layout" aria-label="Frame evidence and coordinates"><figure class="preview"><section class="thumbnail" aria-label="Frame-by-frame bounding box preview"><img class="thumbnail-source" src="/__video_frame?url=operator-supplied-video-agent-validation-source&amp;time=0&amp;format=png" alt="" loading="lazy" decoding="async"><section class="frame-boxes" aria-label="Frame-by-frame bounding boxes"><mark class="frame-box" style="left:13%;top:18%;width:34%;height:30%"><span>0.0s tracked subject</span></mark><mark class="frame-box" style="left:15%;top:23%;width:33.4%;height:30.4%"><span>0.7s context object</span></mark><mark class="frame-box" style="left:17%;top:18%;width:32.9%;height:30.9%"><span>1.4s tracked subject</span></mark><mark class="frame-box" style="left:19%;top:23%;width:32.300000000000004%;height:31.3%"><span>2.1s context object</span></mark><mark class="frame-box" style="left:21%;top:18%;width:31.8%;height:31.8%"><span>2.8s tracked subject</span></mark><mark class="frame-box" style="left:23%;top:23%;width:31.2%;height:32.2%"><span>3.5s context object</span></mark><mark class="frame-box" style="left:25%;top:18%;width:30.7%;height:32.7%"><span>4.2s tracked subject</span></mark><mark class="frame-box" style="left:27%;top:23%;width:30.099999999999998%;height:33.1%"><span>4.9s context object</span></mark><mark class="frame-box" style="left:28.999999999999996%;top:18%;width:29.599999999999998%;height:33.6%"><span>5.6s tracked subject</span></mark><mark class="frame-box" style="left:31%;top:23%;width:28.999999999999996%;height:34%"><span>6.3s context object</span></mark></section></section><figcaption>Normalized xywh boxes are projected against the preview frame; the source URL remains validation input rather than repo source code.</figcaption></figure><ol class="frame-list" aria-label="Frame bounding box coordinates"><li><strong>0.0s</strong><span>tracked subject confidence 0.82</span><output>[0.13, 0.18, 0.34, 0.3]</output></li><li><strong>0.7s</strong><span>context object confidence 0.83</span><output>[0.15, 0.23, 0.334, 0.304]</output></li><li><strong>1.4s</strong><span>tracked subject confidence 0.84</span><output>[0.17, 0.18, 0.329, 0.309]</output></li><li><strong>2.1s</strong><span>context object confidence 0.85</span><output>[0.19, 0.23, 0.323, 0.313]</output></li><li><strong>2.8s</strong><span>tracked subject confidence 0.86</span><output>[0.21, 0.18, 0.318, 0.318]</output></li><li><strong>3.5s</strong><span>context object confidence 0.86</span><output>[0.23, 0.23, 0.312, 0.322]</output></li><li><strong>4.2s</strong><span>tracked subject confidence 0.87</span><output>[0.25, 0.18, 0.307, 0.327]</output></li><li><strong>4.9s</strong><span>context object confidence 0.88</span><output>[0.27, 0.23, 0.301, 0.331]</output></li><li><strong>5.6s</strong><span>tracked subject confidence 0.89</span><output>[0.29, 0.18, 0.296, 0.336]</output></li><li><strong>6.3s</strong><span>context object confidence 0.90</span><output>[0.31, 0.23, 0.29, 0.34]</output></li></ol></section><footer aria-label="Video agent reasoning phases"><span class="phase">search</span><span class="phase">edit</span><span class="phase">compile</span><span class="phase">generate</span><span class="phase">stream</span></footer></main>
    ...
    - id: {key: id, type: string, value: "video_agent_frame_analysis_panel"}
      ...
      position: {key: position, type: object, value: {"x":1626.230414778138,"y":-287.4117267459968}}
    ...
    - id: {key: id, type: string, value: "floating_media_ingestion_source"}
      ...
      "graph:structuralDegree": {key: "graph:structuralDegree", type: number, value: 0}
      image_asset_url: {key: image_asset_url, type: string, value: "/image/agenticgraph/video-frame/frame-c0a158fe-t0.png"}
      ...
      video_frame_asset_url: {key: video_frame_asset_url, type: string, value: "/image/agenticgraph/video-frame/frame-c0a158fe-t0.png"}
    ...
    - id: {key: id, type: string, value: "image_annotation_engine_node"}
      ...
      asset_url: {key: asset_url, type: string, value: "/image/agenticgraph/video-frame/frame-c0a158fe-t0.png"}
    ...
    - id: {key: id, type: string, value: "video_frame_annotation_engine_node"}
      ...
      position: {key: position, type: object, value: {"x":631.6607201899412,"y":622.8419998787502}}
      ...
      "visual:height": {key: "visual:height", type: number, value: 346}
      "visual:importance": {key: "visual:importance", type: number, value: 23}
      "visual:nodeSize": {key: "visual:nodeSize", type: number, value: 17}
      "visual:width": {key: "visual:width", type: number, value: 475}
      "visual:xIndex": {key: "visual:xIndex", type: number, value: 1}
    ...
    - id: {key: id, type: string, value: "floating_panel_media_annotation_panel"}
      ...
      annotationSchemaVersion: {key: annotationSchemaVersion, type: string, value: "agenticgraph-annotation/v1"}
      ...
      srcDoc:
        ...
        type: string
        value: |
          <style>body{margin:0;background:#07111f}main{box-sizing:border-box;width:100%;min-height:100%;display:grid;gap:12px;padding:14px;font-family:Inter,system-ui,sans-serif;background:#07111f;color:#f8fafc}p,h1,h2,h3{margin:0}.eyebrow{color:#5eead4;font-size:11px;font-weight:800;text-transform:uppercase;letter-spacing:.08em}header{display:grid;gap:5px}.lede{color:#cbd5e1;font-size:12px;line-height:1.45}.analysis-layout{display:grid;grid-template-columns:minmax(260px,1.2fr) minmax(220px,.8fr);gap:12px}.preview{margin:0}.thumbnail{position:relative;aspect-ratio:16/9;border:1px solid #334155;border-radius:8px;background:linear-gradient(135deg,#123456,#0b1220 55%,#0f766e);overflow:hidden}.thumbnail::before{content:"";position:absolute;inset:14% 18%;border:2px solid rgba(94,234,212,.72);border-radius:8px}.thumbnail-source{position:absolute;inset:0;width:100%;height:100%;object-fit:cover;opacity:.72}.frame-boxes{position:absolute;inset:0;pointer-events:none}.frame-box{position:absolute;border:2px solid #fbbf24;border-radius:6px;background:rgba(251,191,36,.1);box-shadow:0 0 0 1px rgba(15,23,42,.7)}.frame-box span{position:absolute;left:0;top:-18px;border-radius:4px;background:#fbbf24;color:#1f2937;padding:2px 5px;font:10px ui-monospace,SFMono-Regular,Menlo,monospace;white-space:nowrap}figcaption{margin-top:8px;color:#cbd5e1;font-size:11px;line-height:1.35}.frame-list{display:grid;gap:7px;margin:0;padding:0}.frame-list li{list-style:none;display:grid;grid-template-columns:auto 1fr;gap:7px;border:1px solid #334155;border-radius:8px;background:#0f172a;padding:8px}.frame-list strong{color:#5eead4;font-size:12px}.frame-list span{font-size:12px}.frame-list output{grid-column:1/-1;color:#93c5fd;font:10px ui-monospace,SFMono-Regular,Menlo,monospace}footer{display:grid;grid-template-columns:repeat(5,1fr);gap:6px}.phase{border:1px solid #334155;border-radius:8px;background:#111827;color:#e2e8f0;padding:7px;text-align:center;font-size:11px}</style><main data-composition-id="agenticgraph-video-agent-floatingpanel-frame-analysis" aria-label="FloatingPanel video frame-by-frame bounding box analysis"><header><p class="eyebrow">FloatingPanel frame-by-frame bounding box analysis</p><h2>FloatingPanel analysis for operator-supplied validation source</h2><p class="lede">The FloatingPanel Media output renders the same frame evidence as the stream and analysis panels, keeping search, editing, compilation, generation, and stream reasoning visible without waiting for a runtime artifact.</p></header><section class="analysis-layout" aria-label="FloatingPanel frame evidence and coordinates"><figure class="preview"><section class="thumbnail" aria-label="FloatingPanel frame-by-frame bounding box preview"><img class="thumbnail-source" src="/__video_frame?url=operator-supplied-video-agent-validation-source&amp;time=0&amp;format=png" alt="" loading="lazy" decoding="async"><section class="frame-boxes" aria-label="Frame-by-frame bounding boxes"><mark class="frame-box" style="left:13%;top:18%;width:34%;height:30%"><span>0.0s tracked subject</span></mark><mark class="frame-box" style="left:15%;top:23%;width:33.4%;height:30.4%"><span>0.7s context object</span></mark><mark class="frame-box" style="left:17%;top:18%;width:32.9%;height:30.9%"><span>1.4s tracked subject</span></mark><mark class="frame-box" style="left:19%;top:23%;width:32.300000000000004%;height:31.3%"><span>2.1s context object</span></mark><mark class="frame-box" style="left:21%;top:18%;width:31.8%;height:31.8%"><span>2.8s tracked subject</span></mark><mark class="frame-box" style="left:23%;top:23%;width:31.2%;height:32.2%"><span>3.5s context object</span></mark><mark class="frame-box" style="left:25%;top:18%;width:30.7%;height:32.7%"><span>4.2s tracked subject</span></mark><mark class="frame-box" style="left:27%;top:23%;width:30.099999999999998%;height:33.1%"><span>4.9s context object</span></mark><mark class="frame-box" style="left:28.999999999999996%;top:18%;width:29.599999999999998%;height:33.6%"><span>5.6s tracked subject</span></mark><mark class="frame-box" style="left:31%;top:23%;width:28.999999999999996%;height:34%"><span>6.3s context object</span></mark></section></section><figcaption>Normalized xywh boxes are projected against the preview frame; the source URL remains validation input rather than repo source code.</figcaption></figure><ol class="frame-list" aria-label="FloatingPanel frame bounding box coordinates"><li><strong>0.0s</strong><span>tracked subject confidence 0.82</span><output>[0.13, 0.18, 0.34, 0.3]</output></li><li><strong>0.7s</strong><span>context object confidence 0.83</span><output>[0.15, 0.23, 0.334, 0.304]</output></li><li><strong>1.4s</strong><span>tracked subject confidence 0.84</span><output>[0.17, 0.18, 0.329, 0.309]</output></li><li><strong>2.1s</strong><span>context object confidence 0.85</span><output>[0.19, 0.23, 0.323, 0.313]</output></li><li><strong>2.8s</strong><span>tracked subject confidence 0.86</span><output>[0.21, 0.18, 0.318, 0.318]</output></li><li><strong>3.5s</strong><span>context object confidence 0.86</span><output>[0.23, 0.23, 0.312, 0.322]</output></li><li><strong>4.2s</strong><span>tracked subject confidence 0.87</span><output>[0.25, 0.18, 0.307, 0.327]</output></li><li><strong>4.9s</strong><span>context object confidence 0.88</span><output>[0.27, 0.23, 0.301, 0.331]</output></li><li><strong>5.6s</strong><span>tracked subject confidence 0.89</span><output>[0.29, 0.18, 0.296, 0.336]</output></li><li><strong>6.3s</strong><span>context object confidence 0.90</span><output>[0.31, 0.23, 0.29, 0.34]</output></li></ol></section><footer aria-label="FloatingPanel video agent reasoning phases"><span class="phase">search</span><span class="phase">edit</span><span class="phase">compile</span><span class="phase">generate</span><span class="phase">stream</span></footer></main>
          <aside data-kg-frame-sequence-strip="floating-panel" class="frame-sequence-strip" aria-label="FloatingPanel visible frame-by-frame sequence"><strong>FRAME-BY-FRAME</strong><output>0.0s | 0.7s | 1.4s | 2.1s | 2.8s | 3.5s | 4.2s | 4.9s | 5.6s | 6.3s</output><span>operator-supplied validation source</span></aside><style>main[data-composition-id="agenticgraph-video-agent-floatingpanel-frame-analysis"]{padding-top:46px}.frame-sequence-strip{position:fixed;z-index:5;left:8px;right:8px;top:28px;display:grid;grid-template-columns:auto 1fr auto;gap:8px;align-items:center;border:1px solid #334155;border-radius:8px;background:rgba(15,23,42,.94);color:#e2e8f0;padding:6px 8px;font:11px ui-monospace,SFMono-Regular,Menlo,monospace;box-shadow:0 10px 24px rgba(0,0,0,.28)}.frame-sequence-strip strong{color:#5eead4}.frame-sequence-strip output{color:#fbbf24}.frame-sequence-strip span{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:#93c5fd}</style>
...
# AgenticGraph Vdeoxpln Demo - Interactive Visual Explanation

This validation input turns the vdeoxpln contract into an inspectable visual
explanation. Import it into AgenticGraph to verify that semantic HTML, CSS, and
...
1. `Programmatic Video Agent Render Spec` provides semantic HTML, CSS, and JSON
   data for the operator-supplied validation source set, with `operator-supplied validation source`
   as the primary rendered validation source and `operator-supplied validation source`
   covered by the shared Import URL validation path at runtime.
...
the same `agenticgraph:render-frame` clock; it does not recalculate annotations.
...
ingest, parse, annotate, dataset load/split/merge/save, real-time zone counting,
search, edit, compile, generate, and stream stages as typed Render_Spec data. It
does not copy external annotation code, import Roboflow/supervision, require
external service credentials, or treat the YouTube URL as a runtime dependency.
The URL is validation input; runtime owners decide how to resolve, annotate,
count, render, or stream it.
...
- Run the image annotation node, the video-frame annotation node, or Toolbar Run
  all.
- Verify that successful outputs are LLM-ready `agenticgraph-annotation/v1` JSON
...
The embedded Creative_Brief is a valid `agenticgraph-showrunner-brief/v1` document.
...
```yaml agenticgraph-showrunner-brief
---
schema: "agenticgraph-showrunner-brief/v1"
run_type: "podcast"
...
acceptance_criteria:
  ...
  - "script_draft conforms to agenticgraph-script/v1"
...
```json mcp-call
{
  "tool": "agenticgraph.showrunner.start_run",
  "arguments": {
    "dry_run": true,
...
- one dependency-free `agenticgraph-video-agent/v1` branch for the validation source set
  (`operator-supplied validation source`, `operator-supplied validation source`)
...
- one Annotation Engine result path using `agenticgraph-annotation/v1`, sorted task semantic-key inputs, and the shared rich-media artifact writer
