...
strybldr_storyboard:
  ...
  cards:
    - nodeId: strybldr:source:3725310941
      ...
      action: 1920 年代南洋风光 ![strybldr-starter-source.png](http://localhost:5173/api/storage/media/airvio/runs/upload-017d1e965528642f/image/strybldr-starter-source-017d1e965528642f.png?kg_media_token=eyJydW5JZCI6InVwbG9hZC0wMTdkMWU5NjU1Mjg2NDJmIiwiZXhwaXJlc0F0IjoxNzgxODMwMTEzMjgyfQ)
      prompt: 1920 年代南洋风光
      ...
      renderUrl: http://localhost:5178/api/storage/media/airvio/runs/upload-017d1e965528642f/image/strybldr-starter-source-017d1e965528642f.png?kg_media_token=eyJydW5JZCI6InVwbG9hZC0wMTdkMWU5NjU1Mjg2NDJmIiwiZXhwaXJlc0F0IjoxNzgxNzgzMjk1NTkxfQ
    - nodeId: starter-source-brief-card
      output: |-
        Generated Strybldr local animatic handoff.
        Artifact: /strybldr-video-mqjco5w6.md
      outputSrcDoc: '<!doctype html><html lang="en"><head><meta charset="utf-8" /><meta name="viewport" content="width=device-width,initial-scale=1" /><title>Strybldr Local Generated Video</title><style>:root{color-scheme:light;--ink:#172033;--muted:#5f6675;--line:#d7dde8;--paper:#f8fafc;--accent:#0f766e;--warm:#f59e0b}*{box-sizing:border-box}body{margin:0;background:#e5e7eb;font-family:Inter,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;color:var(--ink)}.kg-stage{position:relative;display:grid;grid-template-columns:minmax(0,1fr) 34%;gap:28px;min-height:100vh;padding:34px;background:linear-gradient(135deg,#f8fafc 0%,#eef2ff 48%,#ecfdf5 100%);overflow:hidden}.kg-slides{position:relative;min-height:520px;border:1px solid var(--line);background:rgba(255,255,255,.82);box-shadow:0 18px 42px rgba(15,23,42,.14);overflow:hidden}.kg-slide{position:absolute;inset:0;display:flex;flex-direction:column;justify-content:center;gap:18px;padding:56px;opacity:0;transform:translateX(5%) scale(.98);animation:kgSlide var(--duration) linear infinite}.kg-slide:before{content:"";position:absolute;inset:24px;border:1px solid rgba(15,118,110,.2);pointer-events:none}.kg-kicker{margin:0;font-size:13px;text-transform:uppercase;color:var(--accent);font-weight:800;letter-spacing:0}h1{margin:0;max-width:840px;font-size:44px;line-height:1.02;letter-spacing:0}p{margin:0;max-width:760px;font-size:20px;line-height:1.45;color:var(--muted)}.kg-action{color:#7c2d12;font-weight:700}.kg-side{display:flex;min-width:0;flex-direction:column;justify-content:space-between;gap:18px}.kg-poster{width:100%;aspect-ratio:16/9;object-fit:cover;border:1px solid var(--line);background:#111827}.kg-meter{height:8px;background:#dbe4ef;overflow:hidden}.kg-meter:before{content:"";display:block;height:100%;width:100%;background:linear-gradient(90deg,var(--accent),var(--warm));transform-origin:left;animation:kgMeter var(--duration) linear infinite}.kg-meta{display:grid;gap:12px}.kg-label{font-size:12px;text-transform:uppercase;color:var(--muted);font-weight:800;letter-spacing:0}.kg-value{font-size:16px;font-weight:800}.kg-source{color:#0f766e;text-decoration:none;font-weight:800;overflow-wrap:anywhere}.kg-chapters{display:grid;gap:8px;margin:0;padding:0;list-style:none}.kg-chapters li{display:grid;grid-template-columns:64px minmax(0,1fr);gap:8px;align-items:center;border-top:1px solid var(--line);padding-top:8px}.kg-chapters span{font-size:12px;color:var(--muted);font-weight:800}.kg-chapters strong{font-size:13px;line-height:1.3}@keyframes kgMeter{from{transform:scaleX(0)}to{transform:scaleX(1)}}@keyframes kgSlide{0%,100%{opacity:0;transform:translateX(5%) scale(.98)}4%,22%{opacity:1;transform:translateX(0) scale(1)}26%{opacity:0;transform:translateX(-5%) scale(.98)}}.kg-slide:nth-child(1){animation-delay:calc(var(--duration) * 0 * -1)}.kg-slide:nth-child(2){animation-delay:calc(var(--duration) * 0.125 * -1)}.kg-slide:nth-child(3){animation-delay:calc(var(--duration) * 0.25 * -1)}.kg-slide:nth-child(4){animation-delay:calc(var(--duration) * 0.375 * -1)}.kg-slide:nth-child(5){animation-delay:calc(var(--duration) * 0.5 * -1)}.kg-slide:nth-child(6){animation-delay:calc(var(--duration) * 0.625 * -1)}.kg-slide:nth-child(7){animation-delay:calc(var(--duration) * 0.75 * -1)}.kg-slide:nth-child(8){animation-delay:calc(var(--duration) * 0.875 * -1)}@media(max-width:860px){.kg-stage{grid-template-columns:1fr;padding:18px}.kg-slides{min-height:480px}.kg-slide{padding:34px}h1{font-size:34px}p{font-size:17px}}</style></head><body style="--duration:32s"><main class="kg-stage" aria-label="Strybldr local generated video"><section class="kg-slides"><section class="kg-slide" style="--i:0;--start:0%;--end:12.5%"><p class="kg-kicker">Source / Beat 1</p><h1>Strybldr Starter Source</h1><p>Imported document source unit: Strybldr starter source.</p><p class="kg-action">Review the source evidence into editable storyboard elements.</p></section><section class="kg-slide" style="--i:1;--start:12.5%;--end:25%"><p class="kg-kicker">Elements / Beat 2</p><h1>Source brief</h1><p>Capture the operator-owned source URL, title, author, constraints, and notes.</p><p class="kg-action">Fill source fields before approving storyboard cards.</p></section><section class="kg-slide" style="--i:2;--start:25%;--end:37.5%"><p class="kg-kicker">Storyboard / Beat 3</p><h1>Strybldr Starter Source Frame</h1><p>Frame-level storyboard card generated from the imported source.</p><p class="kg-action">Review element cards, revise prompts, then send the approved sequence to video generation.</p></section><section class="kg-slide" style="--i:3;--start:37.5%;--end:50%"><p class="kg-kicker">Elements / Beat 4</p><h1>Storyboard beats</h1><p>Draft setup, turn, proof, and close beats as editable cards.</p><p class="kg-action">Approve only paraphrased, source-backed beats.</p></section><section class="kg-slide" style="--i:4;--start:50%;--end:62.5%"><p class="kg-kicker">Elements / Beat 5</p><h1>Reusable elements</h1><p>List reusable characters, locations, props, evidence cards, UI states, or shots.</p><p class="kg-action">Keep generated media URLs blank until real outputs exist.</p></section><section class="kg-slide" style="--i:5;--start:62.5%;--end:75%"><p class="kg-kicker">Runtime / Beat 6</p><h1>Runtime gate</h1><p>Default runtime is local animatic generation with zero paid calls and blank live provider fields.</p><p class="kg-action">Generate locally first; require human approval before VideoDB, SenseNova, or other paid provider calls.</p></section><section class="kg-slide" style="--i:6;--start:75%;--end:87.5%"><p class="kg-kicker">Review / Beat 7</p><h1>Review packet</h1><p>Review provenance, approval state, cost, provider evidence, and local playback.</p><p class="kg-action">Reject fabricated provider IDs, stream URLs, transcripts, or generated asset URLs.</p></section><section class="kg-slide" style="--i:7;--start:87.5%;--end:100%"><p class="kg-kicker">Publish / Beat 8</p><h1>Local publish packet</h1><p>Final output is a local packet path and approval state, not a public deployment claim.</p><p class="kg-action">Keep publish scope local-only until the operator explicitly authorizes Prod or Cloudflare.</p></section></section><aside class="kg-side"><section class="kg-meta"><section><div class="kg-label">Generator</div><div class="kg-value">knowgrph local animatic</div></section><section><div class="kg-label">Chapter clips</div><ol class="kg-chapters"><li><span>0s-4s</span><strong>Strybldr Starter Source</strong></li><li><span>4s-8s</span><strong>Source brief</strong></li><li><span>8s-12s</span><strong>Strybldr Starter Source Frame</strong></li><li><span>12s-16s</span><strong>Storyboard beats</strong></li><li><span>16s-20s</span><strong>Reusable elements</strong></li><li><span>20s-24s</span><strong>Runtime gate</strong></li><li><span>24s-28s</span><strong>Review packet</strong></li><li><span>28s-32s</span><strong>Local publish packet</strong></li></ol></section><section><div class="kg-label">Approved cards</div><div class="kg-value">8</div></section><section><div class="kg-label">Runtime</div><div class="kg-meter"></div></section></section></aside></main></body></html>'
      mediaKind: iframe
      mediaUrl: /strybldr-video-mqjco5w6.md
    - nodeId: strybldr:frame:3595615238
      mediaKind: image
      mediaUrl: http://localhost:5173/api/storage/media/airvio/runs/upload-017d1e965528642f/image/strybldr-starter-source-017d1e965528642f.png?kg_media_token=eyJydW5JZCI6InVwbG9hZC0wMTdkMWU5NjU1Mjg2NDJmIiwiZXhwaXJlc0F0IjoxNzgxODQxMTE5MjE3fQ
---
