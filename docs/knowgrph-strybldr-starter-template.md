...
flow:
  nodes:
    ...
    - id: {key: id, type: string, value: "starter-local-publish-packet-card"}
      ...
      "visual:importance": {key: "visual:importance", type: number, value: 20}
      "visual:nodeSize": {key: "visual:nodeSize", type: number, value: 15.65685424949238}
    - id: {key: id, type: string, value: "storyboard-card-1"}
      type: {key: type, type: string, value: "Storyboard"}
      label: {key: label, type: string, value: "New storyboard card"}
      position: {key: position, type: object, value: {"x":48,"y":48}}
      lane: {key: lane, type: string, value: "Source"}
      order: {key: order, type: number, value: 7}
    - id: {key: id, type: string, value: "storyboard-card-2"}
      type: {key: type, type: string, value: "Storyboard"}
      label: {key: label, type: string, value: "New storyboard card"}
      position: {key: position, type: object, value: {"x":48,"y":48}}
      lane: {key: lane, type: string, value: "Source"}
      order: {key: order, type: number, value: 7}
    - id: {key: id, type: string, value: "storyboard-card-3"}
      type: {key: type, type: string, value: "Storyboard"}
      label: {key: label, type: string, value: "New storyboard card"}
      position: {key: position, type: object, value: {"x":48,"y":48}}
      lane: {key: lane, type: string, value: "Elements"}
      order: {key: order, type: number, value: 7}
    - id: {key: id, type: string, value: "storyboard-card-4"}
      type: {key: type, type: string, value: "Storyboard"}
      label: {key: label, type: string, value: "New storyboard card"}
      position: {key: position, type: object, value: {"x":48,"y":48}}
      lane: {key: lane, type: string, value: "Source"}
...
strybldr_storyboard:
  ...
  cards:
    - nodeId: storyboard-card-2
      title: New storyboard card
      type: Storyboard
      lane: Elements
      order: 8
    - nodeId: strybldr:source:3725310941
      action: '![buddydrone.jpg](http://localhost:5173/api/storage/media/airvio/runs/upload-730fe6850f0fc26f/image/buddydrone-730fe6850f0fc26f.jpg?kg_media_token=eyJydW5JZCI6InVwbG9hZC03MzBmZTY4NTBmMGZjMjZmIiwiZXhwaXJlc0F0IjoxNzgxNzUzODEyNDU3fQ) Review #image the source evidence into editable storyboard elements.'
    - nodeId: starter-runtime-gate-card
      action: Generate locally first; require human approval before VideoDB, SenseNova, or other paid provider calls.
    - nodeId: strybldr:frame:3595615238
      summary: |-
        Frame-level storyboard card generated from the imported source.
        ![空武.jpg](http://localhost:5173/api/storage/media/airvio/runs/upload-088c7665f3bdba06/image/image-088c7665f3bdba06.jpg?kg_media_token=eyJydW5JZCI6InVwbG9hZC0wODhjNzY2NWYzYmRiYTA2IiwiZXhwaXJlc0F0IjoxNzgxNzU0NjI4Nzg0fQ)
      prompt: |-
        Create a short video storyboard beat from Strybldr starter source. ![buddydrone.jpg](http://localhost:5173/api/storage/media/airvio/runs/upload-730fe6850f0fc26f/image/buddydrone-730fe6850f0fc26f.jpg?kg_media_token=eyJydW5JZCI6InVwbG9hZC03MzBmZTY4NTBmMGZjMjZmIiwiZXhwaXJlc0F0IjoxNzgxNzU0NjQwNDkzfQ) ![airvio_.JPEG](http://localhost:5173/api/storage/media/airvio/runs/upload-3b2fe39beaef6787/image/airvio_-3b2fe39beaef6787.jpeg?kg_media_token=eyJydW5JZCI6InVwbG9hZC0zYjJmZTM5YmVhZWY2Nzg3IiwiZXhwaXJlc0F0IjoxNzgxNzU0NjQwNDkzfQ) ![buddydrone.jpg](http://localhost:5173/api/storage/media/airvio/runs/upload-730fe6850f0fc26f/image/buddydrone-730fe6850f0fc26f.jpg?kg_media_token=eyJydW5JZCI6InVwbG9hZC03MzBmZTY4NTBmMGZjMjZmIiwiZXhwaXJlc0F0IjoxNzgxNzU0NjQwNDkzfQ)
        ![buddydrone.jpg](http://localhost:5173/api/storage/media/airvio/runs/upload-730fe6850f0fc26f/image/buddydrone-730fe6850f0fc26f.jpg?kg_media_token=eyJydW5JZCI6InVwbG9hZC03MzBmZTY4NTBmMGZjMjZmIiwiZXhwaXJlc0F0IjoxNzgxNzU0NjQwNDkzfQ)
      action: 'Review #image element cards, revise prompts, then send the approved sequence to video generation. ![airvio_.JPEG](http://localhost:5173/api/storage/media/airvio/runs/upload-3b2fe39beaef6787/image/airvio_-3b2fe39beaef6787.jpeg?kg_media_token=eyJydW5JZCI6InVwbG9hZC0zYjJmZTM5YmVhZWY2Nzg3IiwiZXhwaXJlc0F0IjoxNzgxNzYxNDczMTg2fQ) ![airvio_.JPEG](http://localhost:5173/api/storage/media/airvio/runs/upload-3b2fe39beaef6787/image/airvio_-3b2fe39beaef6787.jpeg?kg_media_token=eyJydW5JZCI6InVwbG9hZC0zYjJmZTM5YmVhZWY2Nzg3IiwiZXhwaXJlc0F0IjoxNzgxNzYxNDczMTg2fQ) ![airvio_.JPEG](http://localhost:5173/api/storage/media/airvio/runs/upload-3b2fe39beaef6787/image/airvio_-3b2fe39beaef6787.jpeg?kg_media_token=eyJydW5JZCI6InVwbG9hZC0zYjJmZTM5YmVhZWY2Nzg3IiwiZXhwaXJlc0F0IjoxNzgxNzYxNDczMTg2fQ) ![airvio_.JPEG](http://localhost:5173/api/storage/media/airvio/runs/upload-3b2fe39beaef6787/image/airvio_-3b2fe39beaef6787.jpeg?kg_media_token=eyJydW5JZCI6InVwbG9hZC0zYjJmZTM5YmVhZWY2Nzg3IiwiZXhwaXJlc0F0IjoxNzgxNzYxNDczMTg2fQ) ![buddydrone.jpg](http://localhost:5173/api/storage/media/airvio/runs/upload-730fe6850f0fc26f/image/buddydrone-730fe6850f0fc26f.jpg?kg_media_token=eyJydW5JZCI6InVwbG9hZC03MzBmZTY4NTBmMGZjMjZmIiwiZXhwaXJlc0F0IjoxNzgxNzYxNDczMTg2fQ) ![buddydrone.jpg](http://localhost:5173/api/storage/media/airvio/runs/upload-730fe6850f0fc26f/image/buddydrone-730fe6850f0fc26f.jpg?kg_media_token=eyJydW5JZCI6InVwbG9hZC03MzBmZTY4NTBmMGZjMjZmIiwiZXhwaXJlc0F0IjoxNzgxNzYxNDczMTg2fQ) ![airvio_.JPEG](http://localhost:5173/api/storage/media/airvio/runs/upload-3b2fe39beaef6787/image/airvio_-3b2fe39beaef6787.jpeg?kg_media_token=eyJydW5JZCI6InVwbG9hZC0zYjJmZTM5YmVhZWY2Nzg3IiwiZXhwaXJlc0F0IjoxNzgxNzYxNDczMTg2fQ) ![airvio_.JPEG](http://localhost:5173/api/storage/media/airvio/runs/upload-3b2fe39beaef6787/image/airvio_-3b2fe39beaef6787.jpeg?kg_media_token=eyJydW5JZCI6InVwbG9hZC0zYjJmZTM5YmVhZWY2Nzg3IiwiZXhwaXJlc0F0IjoxNzgxNzYxNDczMTg2fQ) ![airvio_.JPEG](http://localhost:5173/api/storage/media/airvio/runs/upload-3b2fe39beaef6787/image/airvio_-3b2fe39beaef6787.jpeg?kg_media_token=eyJydW5JZCI6InVwbG9hZC0zYjJmZTM5YmVhZWY2Nzg3IiwiZXhwaXJlc0F0IjoxNzgxNzYxNDczMTg2fQ) ![airvio_.JPEG](http://localhost:5173/api/storage/media/airvio/runs/upload-3b2fe39beaef6787/image/airvio_-3b2fe39beaef6787.jpeg?kg_media_token=eyJydW5JZCI6InVwbG9hZC0zYjJmZTM5YmVhZWY2Nzg3IiwiZXhwaXJlc0F0IjoxNzgxNzYxNDczMTg2fQ) ![airvio_.JPEG](http://localhost:5173/api/storage/media/airvio/runs/upload-3b2fe39beaef6787/image/airvio_-3b2fe39beaef6787.jpeg?kg_media_token=eyJydW5JZCI6InVwbG9hZC0zYjJmZTM5YmVhZWY2Nzg3IiwiZXhwaXJlc0F0IjoxNzgxNzYxNDczMTg2fQ) ![airvio_.JPEG](http://localhost:5173/api/storage/media/airvio/runs/upload-3b2fe39beaef6787/image/airvio_-3b2fe39beaef6787.jpeg?kg_media_token=eyJydW5JZCI6InVwbG9hZC0zYjJmZTM5YmVhZWY2Nzg3IiwiZXhwaXJlc0F0IjoxNzgxNzYxNDczMTg2fQ) ![buddydrone.jpg](http://localhost:5173/api/storage/media/airvio/runs/upload-730fe6850f0fc26f/image/buddydrone-730fe6850f0fc26f.jpg?kg_media_token=eyJydW5JZCI6InVwbG9hZC03MzBmZTY4NTBmMGZjMjZmIiwiZXhwaXJlc0F0IjoxNzgxNzYxNDczMTg2fQ)'
---
