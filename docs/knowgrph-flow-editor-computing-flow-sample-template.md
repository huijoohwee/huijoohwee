flow:
  ...
  nodes:
    - id: {key: id, type: string, value: "source_input"}
      ...
      input_initial_revenue: {key: input_initial_revenue, type: number, value: 52000}
      input_investment_amount: {key: input_investment_amount, type: number, value: 150000}
    ...
    - id: {key: id, type: string, value: "compute_summary"}
      ...
      output:
        ...
        value: |
          ...
          **Base risk-adjusted NPV:** -$74,344
          **Downside risk-adjusted NPV:** -$55,657
      ...
      compute:
        ...
        value: |
          ...
          const rev0 = rn('input_initial_revenue', 42);
