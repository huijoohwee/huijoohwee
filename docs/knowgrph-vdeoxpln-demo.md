...
local_file_import_contract:
  ...
  - "Toolbar -> Launch -> Import URL exposes user-configurable video-agent validation document path, test URL set controls, and per-URL selection"
