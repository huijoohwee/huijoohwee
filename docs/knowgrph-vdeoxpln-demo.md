...
flow:
  ...
  nodes:
    ...
    - id: {key: id, type: string, value: "html_video_mp4_panel"}
      ...
      lastRunAt: {key: lastRunAt, type: string, value: "2026-06-26T06:36:44.844Z"}
