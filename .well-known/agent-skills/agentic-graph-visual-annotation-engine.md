# agentic-graph Visual Annotation Engine Skill
...
- Vdeoxpln id: `agentic-graph-visual-annotation-engine`
- Contract version: `agentic-graph-vdeoxpln/v0.1`
- Semantic key: `kgvx_bf53a515`
- Scope: `browser-local`
...
- Resolve model identifier from modelHint, AGENTIC_OS_ANNOTATION_MODEL, or the registered default.
