# agentic-graph HTML Video Renderer Skill
...
- Vdeoxpln id: `agentic-graph-html-video-renderer`
- Contract version: `agentic-graph-vdeoxpln/v0.1`
- Semantic key: `kgvx_76fc3458`
...
- Resolve active engine from AGENTIC_OS_HTML_VIDEO_ENGINE or engineHint at invocation time.
