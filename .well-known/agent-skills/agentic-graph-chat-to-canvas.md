# agentic-graph Chat To Canvas Skill

Use this skill when: Route AI-assisted graph generation through FloatingPanel Chat, AGENTIC_OS validation, Workspace FS, Source Files, and Canvas apply owners.

## Contract

- Vdeoxpln id: `agentic-graph-chat-to-canvas`
- Contract version: `agentic-graph-vdeoxpln/v0.1`
- Semantic key: `kgvx_49c4868c`
