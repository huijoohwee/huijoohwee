# agentic-graph Video Agent Skill

Use this skill when: Reason over operator-supplied video sources through native agentic-graph ingestion, parsing, annotation, dataset operations, zone counting, search planning, edit planning, timeline compilation, generation placeholders, and streamable rich-media output.

## Contract

- Vdeoxpln id: `agentic-graph-video-agent`
- Contract version: `agentic-graph-vdeoxpln/v0.1`
- Semantic key: `kgvx_53ebc5d6`
