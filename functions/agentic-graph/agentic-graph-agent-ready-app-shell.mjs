...
const unavailableStaticAssetResponse = (request) =>
  new Response(request.method === "HEAD" ? null : "agentic-graph asset is temporarily unavailable. Retry shortly.\n", {
    status: 503,
    headers: {
      ...
      "x-agentic-graph-asset-status": "temporarily-unavailable",
    },
  });
