var La=Object.defineProperty;var n=(e,t)=>La(e,"name",{value:t,configurable:!0});var Ka="https://api.openai.com/v1";var er=Object.freeze(["gpt-5.4-nano","gpt-4o-mini"]);function tr(e){return String(e||"").trim()}n(tr,"normalizeOrigin");function $a(e){let t=tr(e);return t?t.startsWith("http://localhost:")||t.startsWith("http://127.0.0.1:")||t.startsWith("http://0.0.0.0:"):!1}n($a,"isAllowedOrigin");function Qr(e){let t=tr(e);return $a(t)?{"access-control-allow-origin":t,vary:"Origin","access-control-allow-methods":"GET, POST, OPTIONS","access-control-allow-headers":"content-type, x-flowinfish-session","access-control-max-age":"86400"}:{}}n(Qr,"corsHeaders");function _e(e,{status:t=200,origin:r=""}={}){return new Response(JSON.stringify(e),{status:t,headers:{"content-type":"application/json; charset=utf-8","cache-control":"no-store",...Qr(r)}})}n(_e,"json");async function bt(e,{maxBytes:t=1e6}={}){let r=await e.arrayBuffer();if(r.byteLength>t)throw new Error("Request too large");let o=new TextDecoder().decode(r);try{return o?JSON.parse(o):{}}catch{throw new Error("Invalid JSON body")}}n(bt,"readJsonBody");function Da(e){let t=String(e?.model||"").trim();if(!t)throw new Error("Missing model");if(!er.includes(t))throw new Error(`Model not allowed: ${t}`);return t}n(Da,"enforceAllowedModel");function Ha(e){let t=String(e.OPENAI_API_KEY||"").trim();if(!t)throw new Error("Missing server OPENAI_API_KEY");return t}n(Ha,"requireOpenAiKey");async function Rt({request:e,env:t,pathname:r,payload:o}){let a=Ha(t);Da(o);let i=`${tr(t.OPENAI_API_BASE)||Ka}${r}`,c=await fetch(i,{method:"POST",headers:{authorization:`Bearer ${a}`,"content-type":"application/json"},body:JSON.stringify(o)}),l=new Headers(c.headers);return l.delete("content-length"),l.set("cache-control","no-store"),new Response(c.body,{status:c.status,headers:l})}n(Rt,"proxyToOpenAi");function Xe(e){let t=e.headers.get("origin")||"";return new Response(null,{status:204,headers:{...Qr(t)}})}n(Xe,"handleOptions");async function Zr(e){let{request:t,env:r}=e,o=String(t.method||"GET").toUpperCase(),a=t.headers.get("origin")||"";if(o==="OPTIONS")return Xe(t);if(o!=="POST")return _e({ok:!1,error:"Method not allowed"},{status:405,origin:a});try{if(!String(t.headers.get("content-type")||"").toLowerCase().includes("application/json"))return _e({ok:!1,error:"Expected application/json"},{status:415,origin:a});let i=await bt(t);return await Rt({request:t,env:r,pathname:"/chat/completions",payload:i})}catch(s){let i=s instanceof Error?s.message:String(s||"Unknown error");return _e({ok:!1,error:i},{status:400,origin:a})}}n(Zr,"onRequest");var At={checkoutSession:"/api/payments/stripe/checkout/session",webhook:"/api/payments/stripe/webhook"};var fe={restrictedKey:"STRIPE_RESTRICTED_KEY",secretKey:"STRIPE_SECRET_KEY",webhookSecret:"STRIPE_WEBHOOK_SECRET",checkoutPriceId:"STRIPE_CHECKOUT_PRICE_ID",checkoutCurrency:"STRIPE_CHECKOUT_CURRENCY",checkoutUnitAmount:"STRIPE_CHECKOUT_UNIT_AMOUNT",checkoutProductName:"STRIPE_CHECKOUT_PRODUCT_NAME",checkoutMode:"STRIPE_CHECKOUT_MODE",checkoutReturnOrigin:"STRIPE_CHECKOUT_RETURN_ORIGIN"},wl=[fe.restrictedKey,fe.secretKey,fe.webhookSecret];var at={configure:"npm run payment:stripe:configure",d1MigrateRemote:"npm run payment:d1:migrate:remote",readiness:"npm run payment:stripe:readiness",x402Configure:"npm run payment:x402:configure",x402Readiness:"npm run payment:x402:readiness",paymentReadiness:"npm run payment:readiness",applyConfirmation:"apply-stripe-payment-worker-config",writeVisibleVarsFlag:"--write-visible-vars",deployVisibleVarsFlag:"--deploy-visible-vars"};var Sl=[`Configure Stripe secrets on the server runtime that owns ${At.checkoutSession}.`,"Cloudflare Pages project variables are available to Pages builds/functions, but they are not read by separate Worker routes.","Stripe Projects can provision and sync credentials locally; copy only required server secret names into the payment server runtime."].join(" "),_l=[`Payment server runtime for ${At.checkoutSession}`,"not Cloudflare Pages project variables"].join("; "),ja=[fe.restrictedKey,fe.secretKey].join(" or "),bl=[fe.checkoutPriceId,`${fe.checkoutCurrency} + ${fe.checkoutUnitAmount} + ${fe.checkoutProductName}`].join(" or "),Rl=[`${fe.checkoutMode}=payment`,`${fe.checkoutMode}=subscription with ${fe.checkoutPriceId}`].join(" or "),Al=["Worker secret names","visible Worker [vars]","remote D1 payment tables","required webhook-processing columns/constraints","bounded optional hosted Checkout create-and-expire smoke"].join(" + "),Pl=[at.configure,`write visible Worker [vars] with ${at.writeVisibleVarsFlag}`,`deploy visible Worker [vars] with ${at.deployVisibleVarsFlag}`,`apply with -- --apply --yes --confirm=${at.applyConfirmation}`,at.readiness].join(" -> "),kl=[`Missing server-managed Stripe key. Set ${ja} on the payment server runtime.`,"Pages project variables alone do not satisfy separate Worker routes."].join(" ");var Ga=n(e=>{let t=2166136261;for(let r=0;r<e.length;r+=1)t^=e.charCodeAt(r),t=Math.imul(t,16777619);return t>>>0},"fnv1a32");function eo(e){return Ga(String(e??""))}n(eo,"hashString32");function st(e){return eo(e).toString(16).padStart(8,"0")}n(st,"hashStringToHex");var Ba=n(e=>e==null?"":typeof e=="boolean"?e?"1":"0":typeof e=="number"?Number.isFinite(e)?String(e):"":String(e),"normalizePrimitive"),Wa=n(e=>e.map(Ba).join("|"),"buildSignatureText"),Pt=n(e=>st(Wa(e)),"hashSignatureParts");var xe=n((e,t)=>Pt(["agentic-commerce",e,...t]),"buildAgenticCommerceSemanticKey");var to="solana_pay",ro="/api/payments/commerce/solana-pay/settle";var Ke={recipient:"SOLANA_PAY_RECIPIENT",splToken:"SOLANA_PAY_SPL_TOKEN",label:"SOLANA_PAY_LABEL",rpcUrl:"SOLANA_PAY_RPC_URL",amountScale:"SOLANA_PAY_AMOUNT_SCALE",network:"SOLANA_PAY_NETWORK",commitment:"SOLANA_PAY_COMMITMENT"};var it="2026-01-30",no="1000",ao="USDC",rr="https://x402.org/facilitator",so="eip155:84532",Fa="$0.001",io="x402-payment-required",za="0x0000000000000000000000000000000000000000",Qe="2026-04-08",oo="https://ucp.dev/2026-04-08/specification/overview/",qa=["checkout"],Va=["rest"];var I={acpDiscovery:"/.well-known/acp.json",acpConfig:"/.well-known/acp-config",ucpProfile:"/.well-known/ucp",mppOpenApi:"/openapi.json",x402ApiRoot:"/api",x402ApiV1:"/api/v1",checkoutSessions:"/checkout/sessions",x402PaymentRequired:"/api/payments/commerce/x402",commerceWebhook:"/api/payments/commerce/webhook",commerceProofArtifact:"/api/payments/commerce/harness-proof.json",commerceTraceArtifact:"/api/payments/commerce/trace.jsonl",openboxIngest:"/api/payments/commerce/openbox/ingest",web3Settle:"/api/payments/commerce/web3/settle",solanaPaySettle:ro},ql=[I.x402ApiRoot,I.x402ApiV1,I.x402PaymentRequired],B={sellerId:"SELLER_ID",checkoutBaseUrl:"CHECKOUT_BASE_URL",web3Enabled:"WEB3_ENABLED",web3DepositAddress:"WEB3_DEPOSIT_ADDRESS",baseRpcUrl:"BASE_RPC_URL",baseConfirmationBlocks:"BASE_CONFIRMATION_BLOCKS",easAttestUrl:"EAS_ATTEST_URL",openboxApiUrl:"OPENBOX_API_URL",openboxIngestUrl:"OPENBOX_INGEST_URL",openboxApiKey:"OPENBOX_API_KEY",stripeDelegatePaymentUrl:"STRIPE_DELEGATE_PAYMENT_URL",acpBearerToken:"ACP_BEARER_TOKEN",x402PayToAddress:"X402_PAY_TO_ADDRESS",x402Network:"X402_NETWORK",x402Asset:"X402_ASSET",x402Amount:"X402_AMOUNT",x402FacilitatorUrl:"X402_FACILITATOR_URL",x402Price:"X402_PRICE"},Vl=[B.sellerId,B.checkoutBaseUrl,B.web3Enabled,B.web3DepositAddress,B.baseRpcUrl,B.baseConfirmationBlocks,B.easAttestUrl,B.openboxApiUrl,B.openboxIngestUrl,B.stripeDelegatePaymentUrl,B.x402Network,B.x402Asset,B.x402Amount,B.x402FacilitatorUrl,B.x402Price,Ke.recipient,Ke.rpcUrl],Yl=[Ke.splToken,Ke.label,Ke.amountScale,Ke.network,Ke.commitment],Jl=[B.acpBearerToken,B.openboxApiKey],Xl=["Visible Worker [vars] for ACP, Web3, x402, OpenBOX, and Solana Pay.","Worker secrets for ACP bearer auth and OpenBOX API access."].join(" "),$e=n((e,t)=>String(e[t]||"").trim(),"readEnvString"),co=n((e,t)=>{let r=$e(e,B.sellerId);if(r)return r;try{return new URL(t).host}catch{return"knowgrph-seller"}},"readAgenticCommerceSellerId");var lo=n(e=>{let t=$e(e,B.web3Enabled).toLowerCase();return t?t==="0"||t==="false"||t==="no"?!1:t==="1"||t==="true"||t==="yes":!0},"isAgenticCommerceWeb3Enabled");var ct=n(e=>String(e||"").trim().replace(/\/+$/g,""),"normalizeAgenticCommerceBaseUrl"),de=n((e,t)=>`${ct(e)}${t}`,"buildAgenticCommerceUrl"),oe=n((e,t,r,o,a=o.startsWith("/")?o:null)=>({id:t,label:r,value:o,path:a,semanticKey:xe("mainpanel-commerce-readiness-row",[e,t,r,o,a||""])}),"buildAgenticCommerceMainPanelReadinessRow"),Ze=n((e,t,r)=>({id:e,title:t,rows:r}),"buildAgenticCommerceMainPanelReadinessSection"),Ya=n(()=>{let e=[Ze("overview","Overview",[oe("overview","acp-discovery","ACP discovery",`GET ${I.acpDiscovery}`,I.acpDiscovery),oe("overview","acp-config","ACP config",`GET ${I.acpConfig}`,I.acpConfig),oe("overview","api-version","API version",it,null)]),Ze("discovery","Discovery",[oe("discovery","ucp-profile","UCP profile",I.ucpProfile),oe("discovery","mpp-openapi","MPP OpenAPI",I.mppOpenApi),oe("discovery","x402-payment-required","x402 payment required",I.x402PaymentRequired),oe("discovery","x402-api-root","x402 API root",I.x402ApiRoot)]),Ze("sessions","Sessions",[oe("sessions","checkout-sessions","Checkout sessions",I.checkoutSessions),oe("sessions","stripe-webhook","Stripe webhook",At.webhook)]),Ze("web3","Web3",[oe("web3","settle","Settle",I.web3Settle),oe("web3","solana-pay-settle","Solana Pay settle",I.solanaPaySettle),oe("web3","signals","Signals","Base RPC + Solana RPC confirmation",null)]),Ze("governance","Governance",[oe("governance","openbox-ingest","OpenBOX ingest",I.openboxIngest),oe("governance","risk-source","Risk source","OpenBOX risk signal",null)]),Ze("proofs","Proofs",[oe("proofs","harness-proof","Harness proof",I.commerceProofArtifact),oe("proofs","trace-artifact","Trace artifact",I.commerceTraceArtifact)])],t=e.flatMap(a=>a.rows),r=t.map(a=>a.path||"").filter(a=>a.length>0),o=t.filter(a=>!a.path).map(a=>`${a.label}: ${a.value}`);return{surface:"mainpanel-commerce",semanticKey:xe("mainpanel-commerce-readiness",[it,...t.map(a=>a.semanticKey)]),sections:e,routePaths:r,routeCount:r.length,signals:o}},"buildAgenticCommerceMainPanelReadiness"),Ql=Ya(),po=n((e,t)=>{let r=$e(e,B.web3DepositAddress);if(/^0x[0-9a-fA-F]{40}$/.test(r))return r;let o=xe("deposit-address",[t,"0"]),a=xe("deposit-address",[t,"1"]),s=xe("deposit-address",[t,"2"]),i=xe("deposit-address",[t,"3"]),c=xe("deposit-address",[t,"4"]);return`0x${o}${a}${s}${i}${c}`.slice(0,42)},"buildAgenticCommerceDepositAddress");var uo=n((e,t=io)=>{let r=$e(e,B.x402PayToAddress);return/^0x[0-9a-fA-F]{40}$/.test(r)&&r.toLowerCase()!==za?r:po(e,t)},"readAgenticCommerceX402PayToAddress"),Zl=po({},io),Ja=/^[a-z0-9]{3,8}:[-_a-zA-Z0-9]{1,64}$/,mo=n(e=>{let t=$e(e,B.x402Network);return Ja.test(t)?t:so},"readAgenticCommerceX402Network"),ho=n(e=>$e(e,B.x402Asset)||ao,"readAgenticCommerceX402Asset"),go=n(e=>{let t=$e(e,B.x402Amount);return/^[1-9][0-9]*$/.test(t)?t:no},"readAgenticCommerceX402Amount");var fo=n(e=>{let t=$e(e,B.x402FacilitatorUrl);try{let r=new URL(t||rr);return r.protocol==="https:"||r.protocol==="http:"?r.toString().replace(/\/+$/g,""):rr}catch{return rr}},"readAgenticCommerceX402FacilitatorUrl"),yo=n(e=>{let t=ct(e.baseUrl);return{protocol:{name:"acp",version:it,supported_versions:[it],documentation_url:"https://agenticcommerce.dev"},api_base_url:t,transports:[...Va],capabilities:{services:[...qa],...e.web3Enabled?{extensions:[{name:"x-web3"}]}:{}},links:{config:de(t,I.acpConfig),ucp:de(t,I.ucpProfile),mpp:de(t,I.mppOpenApi),x402:de(t,I.x402PaymentRequired)}}},"buildAgenticCommerceAcpDiscovery"),wo=n(e=>{let t=ct(e.baseUrl),r={acp:de(t,I.acpDiscovery),api:de(t,I.x402ApiRoot),checkout_sessions:de(t,I.checkoutSessions),mpp_openapi:de(t,I.mppOpenApi),proof:de(t,I.commerceProofArtifact),trace:de(t,I.commerceTraceArtifact),x402_payment_required:de(t,I.x402PaymentRequired),solana_pay_settle:de(t,I.solanaPaySettle)},o={checkout_sessions:!0,content_payments:!0,proof_artifacts:!0,risk_signals:!0,web3_settlement:e.web3Enabled,solana_pay:e.web3Enabled},a={"dev.ucp.shopping":[{version:Qe,spec:oo,transport:"rest",endpoint:r.api,schema:"https://ucp.dev/2026-04-08/services/shopping/rest.openapi.json"}]};return{ucp:{version:Qe,protocol_version:Qe,services:a,capabilities:{"dev.ucp.shopping.checkout":[{version:Qe,spec:"https://ucp.dev/2026-04-08/specification/checkout/",schema:"https://ucp.dev/2026-04-08/schemas/shopping/checkout.json"}]},payment_handlers:{},endpoints:r},protocol_version:Qe,protocol:{name:"ucp",version:Qe},seller:{id:e.sellerId},services:[{id:"knowgrph-content-payments",type:"content-payments",endpoints:{x402:r.x402_payment_required,checkout_sessions:r.checkout_sessions,solana_pay_settle:r.solana_pay_settle,proof:r.proof,trace:r.trace}}],capabilities:o,endpoints:r,spec_urls:[oo],schema_urls:["https://ucp.dev/2026-04-08/services/shopping/rest.openapi.json","https://ucp.dev/2026-04-08/schemas/shopping/checkout.json"]}},"buildAgenticCommerceUcpProfile"),So=n(e=>{let t=ct(e.baseUrl);return{openapi:"3.1.0",info:{title:"Knowgrph Machine Payment Protocol",version:it,description:"Machine-readable payable-operation discovery for Knowgrph commerce routes."},servers:[{url:t}],paths:{[I.x402PaymentRequired]:{get:{operationId:"getKnowgrphX402PaymentRequirement",summary:"Return x402 payment requirements for an agent-readable paid resource.","x-payment-info":{intent:"charge",method:"x402",amount:Fa,currency:"usdc"},responses:{402:{description:"Payment Required"}}}},[I.checkoutSessions]:{post:{operationId:"createKnowgrphCommerceCheckoutSession",summary:"Create an agentic commerce checkout session.","x-payment-info":{intent:"session",method:"stripe",amount:"dynamic",currency:"request.currency"},responses:{201:{description:"Checkout session created"}}}},[I.solanaPaySettle]:{post:{operationId:"settleKnowgrphSolanaPayCheckoutSession",summary:"Settle an agentic commerce checkout session from a verified Solana Pay transaction signature.","x-payment-info":{intent:"settlement",method:to,amount:"dynamic",currency:"request.currency"},responses:{200:{description:"Solana Pay session settled"},409:{description:"Solana Pay transaction is not confirmed yet"},422:{description:"Solana Pay transaction does not match the session"}}}}}}},"buildAgenticCommerceMppOpenApi"),_o=n(e=>{let t=ct(e.baseUrl),r=de(t,I.x402PaymentRequired),o=String(e.amount||no);return{x402Version:2,error:"Payment required",resource:{url:r,description:"Knowgrph agentic commerce paid-resource readiness probe",mimeType:"application/json"},accepts:[{scheme:"exact",network:String(e.network||so),amount:o,maxAmountRequired:o,asset:String(e.asset||ao),resource:r,mimeType:"application/json",payTo:e.payTo,maxTimeoutSeconds:300,extra:{name:"USDC",version:"2",resourceUrl:r,...e.facilitatorUrl?{facilitatorUrl:e.facilitatorUrl}:{}}}]}},"buildAgenticCommerceX402PaymentRequired");var Xa=n(e=>JSON.stringify(e,null,2),"jsonBody"),Qa=n(e=>String(e||"").trim().replace(/\/+$/g,""),"trimOrigin"),Za=n(e=>typeof btoa=="function"?btoa(e):typeof Buffer<"u"?Buffer.from(e).toString("base64"):"","encodeBase64"),es=n((e,t)=>{try{return new URL(e).origin}catch{return Qa(t)}},"rootOriginFromRequest"),or=n((e={})=>{let t=es(e.requestUrl,e.origin),r=e.env||{},o=co(r,`${t}/`),a=lo(r),s=_o({baseUrl:t,payTo:uo(r),network:mo(r),asset:ho(r),amount:go(r),facilitatorUrl:fo(r)});return{acpDiscovery:yo({sellerId:o,baseUrl:t,web3Enabled:a}),ucpProfile:wo({sellerId:o,baseUrl:t,web3Enabled:a}),mppOpenApi:So({baseUrl:t}),x402PaymentRequired:s}},"buildKnowgrphCommerceDiscovery");var bo=n((e,t={})=>{let r=or({requestUrl:e?.url,env:t}).x402PaymentRequired,o=Za(JSON.stringify(r));return new Response(Xa(r),{status:402,headers:{"content-type":"application/json; charset=utf-8","cache-control":"no-store","access-control-allow-origin":"*",...o?{"payment-required":o}:{}}})},"buildKnowgrphX402PaymentRequiredResponse");async function Ro(e){return bo(e.request,e.env||{})}n(Ro,"onRequest");async function Ao(e){let{request:t}=e,r=String(t.method||"GET").toUpperCase(),o=t.headers.get("origin")||"";return r==="OPTIONS"?Xe(t):r!=="GET"&&r!=="HEAD"?_e({ok:!1,error:"Method not allowed"},{status:405,origin:o}):_e({ok:!0,models:er.map(a=>({model:a,display_name:a}))},{status:200,origin:o})}n(Ao,"onRequest");async function Po(e){let{request:t,env:r}=e,o=String(t.method||"GET").toUpperCase(),a=t.headers.get("origin")||"";if(o==="OPTIONS")return Xe(t);if(o!=="POST")return _e({ok:!1,error:"Method not allowed"},{status:405,origin:a});try{if(!String(t.headers.get("content-type")||"").toLowerCase().includes("application/json"))return _e({ok:!1,error:"Expected application/json"},{status:415,origin:a});let i=await bt(t);return await Rt({request:t,env:r,pathname:"/responses",payload:i})}catch(s){let i=s instanceof Error?s.message:String(s||"Unknown error");return _e({ok:!1,error:i},{status:400,origin:a})}}n(Po,"onRequest");var et=Object.freeze({researchSourceFiles:"knowgrph_research_source_files",inspectAgentSurface:"knowgrph_inspect_agent_surface"}),nr=n(e=>String(e||"").trim(),"normalizeString"),ts=n(e=>({...e,arguments:Array.isArray(e.arguments)?e.arguments.map(t=>({...t})):void 0,_meta:e._meta&&typeof e._meta=="object"?{...e._meta,tools:Array.isArray(e._meta.tools)?[...e._meta.tools]:void 0}:void 0}),"clonePrompt"),xo=Object.freeze([Object.freeze({name:et.researchSourceFiles,title:"Research Knowgrph Source Files",description:"Guide an MCP host through read-only Knowgrph Source Files research using search and fetch with citation-ready URLs.",arguments:Object.freeze([Object.freeze({name:"query",description:"Research question or topic to pass to the read-only search tool.",required:!0}),Object.freeze({name:"limit",description:"Optional decimal string for the maximum search results to inspect.",required:!1}),Object.freeze({name:"focus",description:"Optional aspect to prioritize when reading fetched Source Files.",required:!1})]),_meta:Object.freeze({readOnly:!0,tools:Object.freeze(["search","fetch"])})}),Object.freeze({name:et.inspectAgentSurface,title:"Inspect Knowgrph Agent Surface",description:"Guide an MCP host through read-only inspection of Knowgrph agent, MCP, and MCP Apps readiness metadata.",arguments:Object.freeze([Object.freeze({name:"focus",description:"Optional readiness area to emphasize, such as transport, tools, resources, prompts, retrieval, or app metadata.",required:!1})]),_meta:Object.freeze({readOnly:!0,tools:Object.freeze(["inspect_agent_surface"])})})]),Eo=n(()=>xo.map(ts),"buildKnowgrphAgentReadyPromptContracts"),rs=n(e=>xo.find(t=>t.name===nr(e))||null,"findPromptContract"),kt=n((e,t)=>!e||typeof e!="object"?"":nr(e[t]),"readPromptArg"),os=n((e,t)=>{let r=kt(e,t);if(!r)throw new Error(`Missing required prompt argument: ${t}`);return r},"readRequiredPromptArg"),ko=n(e=>({role:"user",content:{type:"text",text:e}}),"buildPromptMessage"),ns=n((e={})=>{let t=os(e,"query"),r=kt(e,"limit"),o=kt(e,"focus");return[`Research Knowgrph Source Files for: ${t}`,"","Use the MCP server read-only retrieval path:",`1. Call search with query=${JSON.stringify(t)}${r?` and limit=${JSON.stringify(r)}`:""}.`,"2. Select the most relevant returned ids and call fetch for each id before answering.","3. Ground the answer in fetched markdown content and cite the returned result URLs when summarizing.",o?`4. Prioritize this focus: ${o}.`:"","","Do not mutate graph, canvas, workspace, storage, or browser-local state for this research prompt."].filter(Boolean).join(`
`)},"buildSourceFilesResearchPromptText"),as=n((e={})=>{let t=kt(e,"focus");return["Inspect the Knowgrph agent-ready surface through the read-only inspect_agent_surface tool.","","Review health, API catalog, MCP server card, A2A card, agent skills, commerce discovery, and mcpAppsServerReadiness.","For MCP Apps readiness, verify tool/resource linkage, output schema, text fallback, structured content, sandbox/security metadata, no-auth security-scheme mirroring, widget accessibility, prompts, search/fetch retrieval, Streamable HTTP, and local stdio support.",t?`Emphasize this readiness area: ${t}.`:"","","Report checklist ids and evidence from structuredContent. Do not infer readiness from prose alone."].filter(Boolean).join(`
`)},"buildAgentSurfaceInspectionPromptText"),Co=n((e,t={})=>{let r=rs(e);if(!r)throw new Error(`Unknown Knowgrph MCP prompt: ${nr(e)}`);if(r.name===et.researchSourceFiles)return{description:r.description,messages:[ko(ns(t))]};if(r.name===et.inspectAgentSurface)return{description:r.description,messages:[ko(as(t))]};throw new Error(`Unhandled Knowgrph MCP prompt: ${r.name}`)},"getKnowgrphAgentReadyPrompt");var ss=Object.freeze({sourceFileById:"knowgrph_source_file_by_id"}),xt="kgdoc://source-file/{id}",To="kgdoc://source-file/",vo="text/markdown",lt=n(e=>String(e||"").trim(),"normalizeString"),Oo=n(()=>[{uriTemplate:xt,name:ss.sourceFileById,title:"Knowgrph Source File By ID",description:"Read a complete published Knowgrph Source File markdown document using a stable kgdoc id returned by search.",mimeType:vo,annotations:{audience:["user","assistant"],priority:.8},_meta:{readOnly:!0,source:"knowgrph-source-files",tool:"fetch"}}],"buildKnowgrphAgentReadyResourceTemplateContracts");var Io=n(e=>{let t=lt(e);if(!t.startsWith(To))return"";let r=t.slice(To.length);if(!r)return"";try{return decodeURIComponent(r)}catch{return r}},"parseKnowgrphSourceFileResourceUri"),Mo=n(({uri:e,sourceFile:t}={})=>{let r=typeof t?.content=="string"?t.content:String(t?.text||"");return{contents:[{uri:lt(e),mimeType:vo,text:r,_meta:{id:lt(t?.id),title:lt(t?.title),url:lt(t?.url),metadata:t?.metadata&&typeof t.metadata=="object"?{...t.metadata}:{}}}]}},"buildKnowgrphSourceFileResourceReadResult");var Te=n(e=>String(e||"").trim(),"normalizeString"),tt=n(e=>Te(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),"escapeHtml");var ar="Map intent. Orchestrate agents. Prove outcomes.",sr="A source-backed canvas where / routes work, # sets meaning, and @ binds context.",ve="knowgrph.agentic_canvas_os.docs.invoke",Et=Object.freeze(["/mcp.capabilities","#mcp","@mcp-gateway"]);var ir=n(({publicReadMcpUrl:e,controlPlaneMcpUrl:t}={})=>({promise:ar,grammarSummary:sr,publicReadMcpUrl:Te(e),controlPlaneMcpUrl:Te(t),controlPlaneCondition:"Add the control plane only when the host can preserve MCP session state and needs live /, #, @ grammar lookup.",grammarToolName:ve,grammarExamples:Et.map(r=>Te(r)),grammarExecutionBoundary:"Keep install on the public discovery endpoint and execute live grammar on the approval-gated control plane.",cheapestProofPath:"Use the source-side README.md quick start or docs/documents/knowgrph-superagent-harness.md in the knowgrph repo before hosted setup.",steps:[{order:1,label:"Map intent",action:e?`Map intent: install ${Te(e)} first for public discovery, retrieval, and inspection.`:"Map intent: install the public MCP endpoint first for discovery, retrieval, and inspection."},{order:2,label:"Orchestrate agents",action:t?`Orchestrate agents: add ${Te(t)} only when the host can preserve MCP session state and needs live /, #, @ grammar lookup through ${ve}.`:`Orchestrate agents: add the control plane only when the host can preserve MCP session state and needs live /, #, @ grammar lookup through ${ve}.`},{order:3,label:"Prove outcomes",action:"Prove outcomes: for zero-spend evaluation, run the source-side README.md quick start or docs/documents/knowgrph-superagent-harness.md first."}]}),"buildMcpOnboarding"),No=n(({publicReadMcpUrl:e,controlPlaneMcpUrl:t}={})=>`<section aria-label="Fastest path">
  <section id="onboarding" class="readiness">
    <strong>Fastest Path</strong>
    <p>${tt(ar)}</p>
    <p>${tt(sr)}</p>
    <p>${tt(`Live grammar executes through ${ve} on the control plane. Try ${Et.join(", ")}.`)}</p>
    <ol>
  ...
  appendText(
    ...
    onboarding && onboarding.grammarToolName
      ...
      : 'Live grammar executes through ${ve} on the control plane. Try ${Et.join(", ")}.',
  );
...
}`;var Mt={push:"/api/storage/push",pull:"/api/storage/pull",collabSave:"/api/storage/collab/save",canvasRoomPrefix:"/api/storage/canvas-room/",chatSession:"/api/storage/chat/session",chatRelay:"/api/storage/chat/relay",chatPoliciesPrefix:"/api/storage/chat/policies/",chatAuditPrefix:"/api/storage/chat/audit/",exportPrefix:"/api/storage/export/",docPrefix:"/api/storage/doc/",defaultDocPrefix:"/api/storage/doc-default/",blobPrefix:"/api/storage/blob/",mediaAssetPersist:"/api/storage/media/assets",mediaAssetPrefix:"/api/storage/media/assets/",mediaPrefix:"/api/storage/media/",sourceFilesIndex:"/api/storage/source-files",sourceFilesIndexPrefix:"/api/storage/source-files/",sourceFilesLlms:"/api/storage/llms.txt"};var fn=n((e,t)=>`${Mt.docPrefix}${encodeURIComponent(String(e||"").trim())}/${encodeURIComponent(String(t||"").trim())}`,"buildKnowgrphStorageDocPath"),yn=n(e=>`${Mt.defaultDocPrefix}${encodeURIComponent(String(e||"").trim())}`,"buildKnowgrphStorageDefaultDocPath");var wn=n(e=>{let t=String(e||"").trim();return t?`${Mt.sourceFilesIndexPrefix}${encodeURIComponent(t)}`:Mt.sourceFilesIndex},"buildKnowgrphStorageSourceFilesIndexPath");var F="https://airvio.co",Nt="https://knowgrph-storage.huijoohwee.workers.dev",C="/knowgrph",k=`${F}${C}/`,Pr=`${F}/`,ut="kgws:canonical-docs",Ie="2026-06-05",ot=`${C}/health`,rt=`${F}${ot}`,Sn="/.well-known/agent-card.json",kr=`${C}/.well-known/agent-card.json`,Ut=`${F}${Sn}`,xr=`${F}/api/storage/source-files`,Ms=`${F}/api/storage/doc-default/{canonicalPath}`,Ns=`${F}/api/storage/doc/{workspaceId}/{canonicalPath}`,Us=`${F}/api/storage/blob/{workspaceId}/{canonicalPath}`,_n="knowgrph-agent-ready-pages";var bn=['</.well-known/api-catalog>; rel="api-catalog"; type="application/linkset+json"',`<${C}/.well-known/openapi.json>; rel="service-desc"; type="application/vnd.oai.openapi+json;version=3.1"`,`<${C}/llms.txt>; rel="service-doc"; type="text/plain"`,'</auth.md>; rel="service-doc"; type="text/markdown"',`<${ot}>; rel="status"; type="application/health+json"`,`<${C}/.well-known/mcp/server-card.json>; rel="mcp-server-card"; type="application/json"`,`<${Sn}>; rel="describedby"; type="application/json"`].join(", "),Rn=`# Knowgrph
...
- Auth.md registration instructions: ${Pr}auth.md
- Health: ${rt}
...
- Live Canvas Hero discovery markdown: ${Pr}knowgrph-live-canvas-hero.md

## APIs

- Agent-ready status: ${rt}
- HTTP MCP: ${k}mcp
- Storage API: ${F}/api/storage/
- Source Files index: ${xr}
- Default Source File documents: ${Ms}
- Workspace Source File documents: ${Ns}
- Workspace binary artifacts: ${Us}
...
`,An=n(e=>new Response(e,{status:200,headers:{"content-type":"text/markdown; charset=utf-8","cache-control":"public, max-age=3600","access-control-allow-origin":"*",vary:"Accept","x-markdown-tokens":String(Math.ceil(String(e||"").length/4))}}),"markdownResponse"),dt=n(e=>(e.headers.get("accept")||"").toLowerCase().split(",").some(r=>r.trim().startsWith("text/markdown")),"wantsMarkdown"),Pn=n((e,t)=>{let r=new Response(e.body,e),o=String(t?.owner||"").trim(),a=String(t?.tag||"").trim();return o&&r.headers.set("x-knowgrph-route-owner",o),a&&r.headers.set("x-knowgrph-route-tag",a),r},"withAgentReadyRouteHeaders");var Kt=gr({defaultWorkspaceId:ut}),On=Eo(),In=Oo(),Mn=n((e,t="")=>{let r=String(e||"").trim(),o=String(t||"").trim();return o?fn(o,r):yn(r)},"buildStorageDocPath"),gt=n(e=>String(e||"").trim(),"normalizeToolString");var Ae=n((e,t="application/json; charset=utf-8")=>new Response(JSON.stringify(e,null,2),{status:200,headers:{"content-type":t,"cache-control":"public, max-age=3600","access-control-allow-origin":"*"}}),"jsonResponse"),he=n((e,t)=>new Response(JSON.stringify(t,null,2),{status:e,headers:{"content-type":"application/json; charset=utf-8","cache-control":"no-store","access-control-allow-origin":"*"}}),"jsonStatusResponse"),kn=n((e,t={})=>new Response(null,{status:e,headers:{"cache-control":"no-store","access-control-allow-origin":"*",...t}}),"emptyStatusResponse"),mt=n((e,t)=>new Response(e,{status:200,headers:{"content-type":t,"cache-control":"public, max-age=3600","access-control-allow-origin":"*"}}),"textResponse"),Ls=n(e=>mt(e,"text/html;profile=mcp-app; charset=utf-8"),"mcpAppsHtmlResponse"),Ks=n(e=>new Response(JSON.stringify(e,null,2),{status:200,headers:{"content-type":"application/health+json; charset=utf-8","cache-control":"no-store","access-control-allow-origin":"*"}}),"healthResponse"),$s=`${C}/api/workspace/github/write`,Ds="/api/workspace/github/write",xn=12,En=9e5,Hs=new Set(["css","html","js","json","md","mdx","mjs","svg","ts","tsx","txt","yaml","yml"]),Er=n((e,t)=>String(e?.[t]||"").trim(),"readEnvString"),js=n(e=>{let t=Er(e,"KNOWGRPH_GITHUB_WRITE_REPOSITORY"),r=Er(e,"KNOWGRPH_GITHUB_WRITE_TOKEN"),o=Er(e,"KNOWGRPH_GITHUB_WRITE_BRANCH"),a=[];t||a.push("KNOWGRPH_GITHUB_WRITE_REPOSITORY"),r||a.push("KNOWGRPH_GITHUB_WRITE_TOKEN");let s=t.split("/").map(i=>i.trim()).filter(Boolean);return t&&s.length!==2&&a.push("KNOWGRPH_GITHUB_WRITE_REPOSITORY:owner/repo"),a.length>0?{ok:!1,missing:a}:{ok:!0,owner:s[0],repo:s[1],branch:o,token:r}},"readGitHubWriteConfig"),Gs=n(e=>{let t=String(e||"").trim().replace(/^workspace:/i,"").replace(/\\/g,"/").replace(/^\/+/,"");if(!t)return{ok:!1,error:"missing_workspace_path"};if(/[\u0000-\u001f\u007f]/.test(t))return{ok:!1,error:"invalid_workspace_path"};let r=t.split("/").filter(Boolean);if(r.some(s=>s==="."||s===".."))return{ok:!1,error:"path_traversal_forbidden"};if(r[0]!=="chat-log")return{ok:!1,error:"unsupported_workspace_root"};if(r.length<3)return{ok:!1,error:"chat_log_session_file_required"};let o=r[r.length-1]||"",a=o.includes(".")?o.split(".").pop().toLowerCase():"";return!a||!Hs.has(a)?{ok:!1,error:"unsupported_text_extension"}:{ok:!0,path:r.join("/")}},"normalizeGitHubWriteWorkspacePath"),Bs=n(e=>{let t=new TextEncoder().encode(String(e||"")),r=32768,o="";for(let a=0;a<t.length;a+=r)o+=String.fromCharCode(...t.slice(a,a+r));return btoa(o)},"encodeBase64Utf8"),nt=class extends Error{static{n(this,"GitHubWorkspaceWriteError")}constructor(t,r,o){super(t),this.name="GitHubWorkspaceWriteError",this.code=t,this.upstreamStatus=r,this.upstreamMessage=o}},Nn=n(e=>String(e||"unknown").replace(/[\u0000-\u001f\u007f]/g," ").replace(/\s+/g," ").trim().slice(0,240),"sanitizeGitHubApiMessage"),Un=n((e,t)=>{let r=String(t||"").split("/").map(a=>encodeURIComponent(a)).join("/"),o=new URL(`https://api.github.com/repos/${encodeURIComponent(e.owner)}/${encodeURIComponent(e.repo)}/contents/${r}`);return e.branch&&o.searchParams.set("ref",e.branch),o},"buildGitHubContentsApiUrl"),Ln=n(e=>({accept:"application/vnd.github+json",authorization:`Bearer ${e.token}`,"user-agent":"knowgrph-cloudflare-pages","x-github-api-version":"2022-11-28"}),"gitHubApiHeaders"),Kn=n(e=>{let t=String(e||"").replace(/\/+$/,"")||"/";return t===$s||t===Ds},"isGitHubWorkspaceWriteRoutePath"),Ws=n(async(e,t)=>{let r=await fetch(Un(e,t),{method:"GET",headers:Ln(e)});if(r.status===404)return null;let o=await r.json().catch(()=>null);if(!r.ok)throw new nt("github_read_failed",r.status,Nn(o?.message||r.statusText));if(o?.type&&o.type!=="file")throw new nt("github_path_not_file",409,t);return String(o?.sha||"").trim()||null},"fetchGitHubExistingFileSha"),Fs=n(async(e,t,r)=>{let o=await Ws(e,t.repositoryPath),a={message:r,content:Bs(t.text),...e.branch?{branch:e.branch}:{},...o?{sha:o}:{}},s=await fetch(Un(e,t.repositoryPath),{method:"PUT",headers:{...Ln(e),"content-type":"application/json; charset=utf-8"},body:JSON.stringify(a)}),i=await s.json().catch(()=>null);if(!s.ok)throw new nt("github_write_failed",s.status,Nn(i?.message||s.statusText));return{workspacePath:t.workspacePath,repositoryPath:t.repositoryPath,action:o?"updated":"created",commitSha:String(i?.commit?.sha||""),contentSha:String(i?.content?.sha||""),htmlUrl:String(i?.content?.html_url||"")}},"putGitHubWorkspaceFile"),zs=n(async(e,t)=>{let r=js(t);if(!r.ok)return he(503,{ok:!1,status:"skipped",error:"github_write_not_configured",missing:r.missing});let o=await e.json().catch(()=>null),a=Array.isArray(o?.files)?o.files:[];if(a.length<1)return he(400,{ok:!1,status:"failed",error:"files_required"});if(a.length>xn)return he(413,{ok:!1,status:"failed",error:"too_many_files",maxFiles:xn});let s=[],i=new Set;for(let p of a){let m=Gs(p?.workspacePath||p?.path);if(!m.ok)return he(400,{ok:!1,status:"failed",error:m.error,workspacePath:String(p?.workspacePath||p?.path||"")});if(i.has(m.path))continue;i.add(m.path);let f=String(p?.text??"");if(new TextEncoder().encode(f).length>En)return he(413,{ok:!1,status:"failed",error:"file_too_large",workspacePath:`/${m.path}`,maxTextBytes:En});s.push({workspacePath:`/${m.path}`,repositoryPath:m.path,text:f})}if(s.length<1)return he(400,{ok:!1,status:"failed",error:"files_required"});let c=String(o?.message||"").trim(),l=c&&c.length<=160?c:`Knowgrph chat artifact ${s[0].repositoryPath}`;if(o?.dryRun===!0)return he(200,{ok:!0,status:"dry_run",repository:`${r.owner}/${r.repo}`,branch:r.branch||null,files:s.map(p=>({workspacePath:p.workspacePath,repositoryPath:p.repositoryPath,textBytes:new TextEncoder().encode(p.text).length}))});try{let p=[];for(let m of s)p.push(await Fs(r,m,l));return he(200,{ok:!0,status:"applied",repository:`${r.owner}/${r.repo}`,branch:r.branch||null,files:p})}catch(p){let m=p instanceof nt;return he(m?424:500,{ok:!1,status:"failed",error:m?p.code:p instanceof Error?p.message:String(p||"github_write_failed"),...m?{upstreamStatus:p.upstreamStatus,upstreamMessage:p.upstreamMessage}:{}})}},"handleGitHubWorkspaceWrite"),qs=n(e=>`User-agent: *
Allow: /knowgrph/
...
Sitemap: ${e}
`,"buildRobotsTxt"),Vs=n(e=>`<?xml version="1.0" encoding="UTF-8"?>
...
`,"buildSitemapXml"),Ys=qs(`${k}sitemap.xml`),Js=Vs(k),$n={linkset:[{anchor:k,"service-desc":[{href:`${k}.well-known/openapi.json`,type:"application/vnd.oai.openapi+json;version=3.1"}],"service-doc":[{href:`${k}llms.txt`,type:"text/plain"}],status:[{href:rt,type:"application/health+json"}],"service-meta":[{href:`${k}.well-known/mcp/server-card.json`,type:"application/json"},{href:Ut,type:"application/json"}]}]},Dn={openapi:"3.1.0",info:{title:"Knowgrph API",version:"0.1.0",description:"Agent discovery surface for the Knowgrph Cloudflare deployment."},servers:[{url:F,description:"Knowgrph Cloudflare deployment"}],paths:sn({appBasePath:C,appA2aAgentCardPath:kr,healthPath:ot})},ht={resource:k,resource_name:"Knowgrph",authorization_servers:[F],scopes_supported:["knowgrph:read","knowgrph:source-files:read"],bearer_methods_supported:["header"],resource_documentation:`${k}llms.txt`},Cr=`${F}/cdn-cgi/access`,Ne={skill:`${F}/auth.md`,register_uri:`${k}agent/auth`,claim_uri:`${k}agent/auth/claim`,revocation_uri:`${k}agent/auth/revoke`,identity_types_supported:["anonymous","identity_assertion"],anonymous:{credential_types_supported:["api_key"]},identity_assertion:{assertion_types_supported:["urn:ietf:params:oauth:token-type:id-jag","verified_email"],credential_types_supported:["access_token","api_key"]},events_supported:["https://schemas.workos.com/events/agent/auth/identity/assertion/revoked"],registration_status:"metadata_published_runtime_user_mediated"},Cn={issuer:F,resource:ht.resource,resource_name:ht.resource_name,authorization_servers:ht.authorization_servers,cloudflare_access_issuer:Cr,authorization_endpoint:`${Cr}/login`,token_endpoint:`${Cr}/token`,jwks_uri:`${k}.well-known/http-message-signatures-directory`,response_types_supported:["code"],grant_types_supported:["authorization_code","client_credentials"],token_endpoint_auth_methods_supported:["client_secret_basic","private_key_jwt"],scopes_supported:ht.scopes_supported,agent_auth:Ne},Xs=`# Knowgrph auth.md

Knowgrph publishes agent registration metadata for the read-only agent surface at ${k}. Agents should first fetch ${F}/.well-known/oauth-protected-resource, follow its authorization_servers entry to ${F}/.well-known/oauth-authorization-server, and read the agent_auth block.
...
- Pipeline rule: agents must not bypass MainPanel -> FloatingPanel Chat -> KGC -> Canvas for user-mediated graph work; published HTTP MCP tools remain read-only until mutation auth and conflict semantics are implemented.`,Hn={name:"Knowgrph Agent",description:"Agent-readable discovery, published-document retrieval, and WebMCP-ready metadata surface for Knowgrph.",version:"0.1.0",provider:{organization:"airvio / joohwee",url:k},url:`${k}mcp`,preferredTransport:"JSONRPC",supportedInterfaces:[{url:`${k}mcp`,protocolBinding:"JSONRPC",transportProtocol:"JSONRPC",description:"Primary machine interface for read-only discovery and source-file document access."},{url:xr,protocolBinding:"HTTP+JSON/REST",transportProtocol:"HTTP+JSON/REST",description:"Published source-files index and storage-backed document read surface."}],capabilities:{streaming:!1,pushNotifications:!1,stateTransitionHistory:!1,extendedAgentCard:!1},defaultInputModes:["text/plain","text/markdown","application/json"],defaultOutputModes:["text/plain","text/markdown","application/json"],skills:nn(Kt)},Ce={serverInfo:{name:"knowgrph",version:"0.1.0"},transport:{type:Oe,url:`${k}mcp`,stateless:!0},capabilities:{tools:Kt.map(e=>({name:e.name,title:e.title,description:e.description,inputSchema:e.inputSchema,outputSchema:e.outputSchema,securitySchemes:e.securitySchemes,annotations:e.annotations,_meta:e._meta})),resources:{listChanged:!1},prompts:{listChanged:!1},...ur()},prompts:On,resourceTemplates:In,clientSetups:mr({baseUrl:k,mcpUrl:`${k}mcp`,serverName:"knowgrph"}),surfaceRoles:{publicReadMcpUrl:`${k}mcp`,publicReadMcpScope:"Canonical public install and discovery endpoint for read-only retrieval, prompt discovery, resource discovery, and inspection.",controlPlaneMcpUrl:`${k}control-plane/mcp`,controlPlaneMcpScope:"Approval-gated orchestration endpoint for control-plane tools, remote Agentic Canvas OS docs invocation, and spend-bearing workflows where deployed.",remoteGrammarInvokePublic:!0,remoteGrammarInvokeToolName:"knowgrph.agentic_canvas_os.docs.invoke",remoteGrammarInvokeStatus:"live-control-plane"},links:{apiCatalog:`${k}.well-known/api-catalog`,skills:`${k}.well-known/agent-skills/index.json`,status:rt,agentCard:Ut,controlPlaneMcp:`${k}control-plane/mcp`}},Qs=Tt({appUrl:k,updatedAt:Ie}),vr=Kt.map(e=>({name:e.webName,title:e.title,description:e.description,inputSchema:e.inputSchema,outputSchema:e.outputSchema,securitySchemes:e.securitySchemes,annotations:e.annotations,_meta:e._meta})),ze=n(e=>gt(Kt.find(t=>t.name===e)?.webName),"findWebMcpToolName"),Zs=ze(u.search),ei=ze(u.fetch),ti=ze(u.listSourceFiles),ri=ze(u.readSourceFile),oi=ze(u.readSharedDocument),ni=ze(u.inspectSharedDocumentStructure),ai=ze(u.inspectAgentSurface),si=`(() => {
  const root = globalThis;
  const siteOrigin = ${JSON.stringify(F)};
  ...
  const createPublishedDocIdentityResolver = ${gn};
  ...
  const toolExecutors = createPublishedAgentReadyToolExecutors({
    toolNames: {
      search: ${JSON.stringify(Zs)},
      fetch: ${JSON.stringify(ei)},
      listSourceFiles: ${JSON.stringify(ti)},
      readSourceFile: ${JSON.stringify(ri)},
      readSharedDocument: ${JSON.stringify(oi)},
      inspectSharedDocumentStructure: ${JSON.stringify(ni)},
      inspectAgentSurface: ${JSON.stringify(ai)},
    },
    defaultWorkspaceId,
...
})();`,ii=n(async e=>{if(!(e.headers.get("content-type")||"").toLowerCase().includes("text/html"))return e;let r=await e.text();if(vr.every(i=>r.includes(i.name)))return new Response(r,e);let o=`<script>${si}<\/script>`,a=r.includes("</head>")?r.replace("</head>",`${o}</head>`):`${r}${o}`,s=new Response(a,e);return s.headers.delete("content-length"),s},"injectWebMcpScript"),ci={search:u.search,fetch:u.fetch,listSourceFiles:u.listSourceFiles,readSourceFile:u.readSourceFile,readSharedDocument:u.readSharedDocument,inspectSharedDocumentStructure:u.inspectSharedDocumentStructure,inspectAgentSurface:u.inspectAgentSurface},li=n(async e=>{let t=new TextEncoder().encode(e),r=await crypto.subtle.digest("SHA-256",t);return[...new Uint8Array(r)].map(o=>o.toString(16).padStart(2,"0")).join("")},"sha256Hex"),jn=on(),pi=Object.fromEntries(pt.map(e=>[e.name,li(jn[e.name]||"")])),Tn=new Map(pt.map(e=>[`${C}${e.path}`.replace(/\/+$/,""),jn[e.name]||""]));var Gn=n(async()=>an({appUrl:k,updatedAt:Ie,sha256ByName:pi}),"agentSkillsIndex"),ui={keys:[{kty:"OKP",crv:"Ed25519",kid:"knowgrph-agent-ready-2026-05-21",use:"sig",alg:"EdDSA",x:"11qYAYdkVKxA4G0wV47IxPtYfFVH_H7zmC2Di2PcvLU"}]},di={protocolVersion:"2025-06-18",capabilities:{tools:{},resources:{},prompts:{listChanged:!1},...ur()},serverInfo:Ce.serverInfo},Or=Ce.capabilities.tools,mi=[Qs],hi=On,gi=In,Bn=n(()=>({status:"pass",service:"knowgrph-agent-ready-pages",homepage:k,health:rt,updatedAt:Ie,checks:{linkHeaders:!0,markdownNegotiation:!0,httpMcp:!0,webMcp:!0,mcpApps:!0,commerce:{acp:!0,ucp:!0,mpp:!0,x402:!0},defaultWorkspaceId:ut}}),"buildHealthStatusBody"),fi=n(async()=>qo({baseUrl:k,health:Bn(),apiCatalog:$n,openApi:Dn,mcpServerCard:Ce,agentCard:Hn,agentSkills:await Gn(),commerce:or({origin:F})}),"buildAgentSurfaceInspection"),yi=fr({toolNames:ci,defaultWorkspaceId:ut,publicBaseUrl:F,buildStorageDocPath:Mn,fetchSourceFilesIndexResponse:n(()=>fetch(`${Nt}${wn()}`,{headers:{accept:"text/markdown"}}),"fetchSourceFilesIndexResponse"),fetchStorageMarkdownResponse:n(e=>fetch(`${Nt}${e}`,{headers:{accept:"text/markdown"}}),"fetchStorageMarkdownResponse"),resolveSharedDocumentInput:n((e={})=>It({shareToken:e?.shareToken,shareUrl:e?.shareUrl,appBasePath:C,baseUrl:F}),"resolveSharedDocumentInput"),inspectSharedDocumentStructure:Yo,buildAgentSurfaceInspection:fi}),Ir=n(e=>{try{let t=new URL(e,F);return It({shareUrl:`${t.pathname}${t.search}`,baseUrl:F,appBasePath:C})}catch{return null}},"resolvePublishedDocRequestIdentity"),wi=n(e=>It({shareUrl:String(e||""),baseUrl:F,appBasePath:C}),"resolvePublishedDocPathIdentity"),Si=n(async(e,t)=>{let r=new URL(Mn(t.canonicalPath,t.workspaceId),Nt),o=await fetch(r,{method:"GET",headers:{accept:"text/markdown, text/plain;q=0.9, */*;q=0.1"}}),a=new Headers(o.headers),s=String(a.get("vary")||"");return a.set("vary",s?`${s}, Accept`:"Accept"),new Response(String(e.method||"").toUpperCase()==="HEAD"?null:o.body,{status:o.status,statusText:o.statusText,headers:a})},"proxyPublishedDocMarkdownResponse"),_i=n(async e=>{try{let t=await e.json();return t&&typeof t=="object"?t:null}catch{return null}},"readJsonRpcRequest"),Me=n((e,t)=>he(200,{jsonrpc:"2.0",id:e??null,result:t}),"jsonRpcResult"),De=n((e,t,r)=>he(200,{jsonrpc:"2.0",id:e??null,error:{code:t,message:r}}),"jsonRpcError"),bi=n(e=>String(e.headers.get("accept")||"").toLowerCase().split(",").some(t=>t.trim().startsWith("text/event-stream")),"requestAcceptsEventStream"),Tr=n((e,t)=>Object.prototype.hasOwnProperty.call(e,t),"hasOwnProperty"),Wn=n(e=>{if(Array.isArray(e))return e.length>0&&e.every(Wn);if(!e||typeof e!="object"||String(e.jsonrpc||"")!=="2.0")return!1;let t=typeof e.method=="string"&&e.method.length>0,r=Tr(e,"id"),o=Tr(e,"result")||Tr(e,"error");return t&&!r||!t&&o},"isJsonRpcNotificationOrResponse"),Fn=n(async(e,t)=>{let r=yi[e];if(typeof r!="function")throw new Error(`unknown tool: ${e}`);return r(t)},"executeMcpTool"),Ri=n(async e=>{let t=gt(e);if(t===me)return hr({appUrl:k,updatedAt:Ie,toolNames:Or.map(o=>o.name)});let r=Io(t);if(r){let o=await Fn(u.fetch,{id:r});return Mo({uri:t,sourceFile:o})}throw new Error(`unknown resource: ${e}`)},"readMcpResource"),Ai=n(async e=>{let t=String(e.method||"GET").toUpperCase();if(t==="GET"||t==="HEAD")return bi(e)?kn(405,{allow:"POST"}):Ae({ok:!0,transport:Ce.transport,serverInfo:Ce.serverInfo,capabilities:Ce.capabilities,links:Ce.links,surfaceRoles:Ce.surfaceRoles});if(t!=="POST")return he(405,{ok:!1,error:"unsupported_method"});let r=await _i(e);if(!r)return De(null,-32700,"Parse error");if(Wn(r))return kn(202);if(Array.isArray(r))return De(null,-32600,"Batch JSON-RPC requests are not supported");switch(r.method){case"initialize":return Me(r.id,di);case"tools/list":return Me(r.id,{tools:Or});case"prompts/list":return Me(r.id,{prompts:hi});case"resources/templates/list":return Me(r.id,{resourceTemplates:gi});case"prompts/get":{let o=gt(r.params?.name),a=r.params?.arguments&&typeof r.params.arguments=="object"?r.params.arguments:{};if(!o)return De(r.id,-32602,"Prompt name is required");try{return Me(r.id,Co(o,a))}catch(s){return De(r.id,-32602,s instanceof Error?s.message:String(s))}}case"resources/list":return Me(r.id,{resources:mi});case"resources/read":{let o=gt(r.params?.uri);if(!o)return De(r.id,-32602,"Resource URI is required");try{return Me(r.id,await Ri(o))}catch(a){return De(r.id,-32602,a instanceof Error?a.message:String(a))}}case"tools/call":{let o=gt(r.params?.name),a=r.params?.arguments&&typeof r.params.arguments=="object"?r.params.arguments:{};if(!o)return De(r.id,-32602,"Tool name is required");try{let s=await Fn(o,a);return Me(r.id,{content:[{type:"text",text:typeof s?.markdown=="string"?s.markdown:JSON.stringify(s,null,2)}],structuredContent:s,isError:!1})}catch(s){return Me(r.id,{content:[{type:"text",text:s instanceof Error?s.message:String(s)}],isError:!0})}}default:return De(r.id,-32601,"Method not found")}},"handleMcpTransport"),Pi=n(()=>hr({appUrl:k,updatedAt:Ie,toolNames:Or.map(e=>e.name)}).contents[0].text,"buildKnowgrphMcpAppHtmlBody");var $t=n(e=>e===C||e===`${C}/`,"handlesKnowgrphRoot"),ki=n(e=>$t(e)||!!wi(e),"handlesKnowgrphHtmlSurface"),xi=n(e=>e.startsWith(`${C}/assets/`),"handlesKnowgrphStaticAsset"),Ei=n(async e=>{let t=new Headers(e.request.headers);t.delete("origin");let r=new Request(e.request.url,{method:e.request.method,headers:t});return typeof e.env?.ASSETS?.fetch=="function"?e.env.ASSETS.fetch(r):e.next(r)},"fetchKnowgrphStaticAsset"),Ci=n(e=>{let t=new URL(e.url),r=t.pathname.replace(/\/+$/,"")||"/",o=Ir(e.url);return r===ot?"health":r===`${C}/mcp`?"mcp":Kn(r)?"github-workspace-write":r===`${C}/robots.txt`?"robots":r===`${C}/sitemap.xml`?"sitemap":r===`${C}/auth.md`||r==="/auth.md"?"auth-md":r.startsWith(`${C}/.well-known/`)?"well-known":o?dt(e)?"shared-doc-markdown":"shared-doc-html":$t(t.pathname)?dt(e)?"homepage-markdown":"homepage-html":"app-surface"},"resolveAgentReadyRouteTag"),Lt=n((e,t)=>Pn(t,{owner:_n,tag:Ci(e)}),"withKnowgrphRouteHeaders"),vn=n(async e=>{let t=new URL(e.url),r=t.pathname.replace(/\/+$/,"")||"/",o=Ir(e.url);if(o&&dt(e))return Si(e,o);if($t(t.pathname)&&dt(e))return An(Rn);switch(r){case ot:return Ks(Bn());case`${C}/mcp`:return Ai(e);case`${C}/robots.txt`:return mt(Ys,"text/plain; charset=utf-8");case`${C}/sitemap.xml`:return mt(Js,"application/xml; charset=utf-8");case`${C}/auth.md`:case"/auth.md":return mt(Xs,"text/markdown; charset=utf-8");case`${C}/.well-known/api-catalog`:return Ae($n,"application/linkset+json; charset=utf-8");case`${C}/.well-known/openapi.json`:return Ae(Dn,"application/vnd.oai.openapi+json; charset=utf-8");case kr:return Ae(Hn);case`${C}/.well-known/oauth-protected-resource`:return Ae(ht);case`${C}/.well-known/oauth-authorization-server`:return Ae(Cn);case`${C}/.well-known/openid-configuration`:return Ae(Cn);case`${C}/.well-known/mcp/server-card.json`:return Ae(Ce);case`${C}/.well-known/mcp/apps/knowgrph-agent-ready.html`:return Ls(Pi());case`${C}/.well-known/mcp.json`:return Ae(Ce);case`${C}/.well-known/agent-skills/index.json`:return Ae(await Gn());case`${C}/.well-known/http-message-signatures-directory`:return Ae(ui);default:return Tn.has(r)?mt(Tn.get(r),"text/markdown; charset=utf-8"):null}},"routeResponse");async function He(e){let{env:t,request:r}=e,o=String(r.method||"GET").toUpperCase(),a=new URL(r.url);if(o==="OPTIONS")return new Response(null,{status:204,headers:{"access-control-allow-origin":"*","access-control-allow-methods":"GET, HEAD, POST, OPTIONS","access-control-allow-headers":"*","access-control-max-age":"86400"}});if(o==="POST"&&a.pathname.replace(/\/+$/,"")===`${C}/mcp`)return Lt(r,await vn(r));if(o==="POST"&&Kn(a.pathname))return Lt(r,await zs(r,t));if(o!=="GET"&&o!=="HEAD")return he(405,{ok:!1,error:"unsupported_method"});if(xi(a.pathname))return Ei(e);let s=await vn(r);if(s){let m=Lt(r,s);return o==="HEAD"?new Response(null,m):m}let i=Ir(r.url),c=i?await cn(e,C):await e.next();if(!ki(a.pathname))return c;let l=o==="HEAD"?c:await ii(c),p=new Response(o==="HEAD"?null:l.body,l);return p.headers.set("link",bn),($t(a.pathname)||i)&&(p.headers.delete("x-frame-options"),p.headers.delete("content-security-policy-report-only"),p.headers.set("content-security-policy","frame-ancestors *")),Lt(r,p)}n(He,"onRequest");async function zn(e){return He(e)}n(zn,"onRequest");async function qn(e){return He(e)}n(qn,"onRequest");async function Vn(e){return He(e)}n(Vn,"onRequest");var Ti=Object.freeze(new Set(["","80","443"])),vi=Object.freeze([".local",".localhost",".internal"]),Oi=Object.freeze(new Set(["localhost"]));function qe(e){return String(e||"").trim().toLowerCase()}n(qe,"normalizeHostname");function Ii(e){let t=qe(e);if(!/^\d{1,3}(\.\d{1,3}){3}$/.test(t))return!1;let r=t.split(".").map(o=>Number(o));return r.length!==4?!1:r.every(o=>Number.isInteger(o)&&o>=0&&o<=255)}n(Ii,"isIpv4Literal");function Yn(e){let[t,r,o,a]=e.split(".").map(s=>Number(s));return(t<<24|r<<16|o<<8|a)>>>0}n(Yn,"ipv4ToInt");function Mi(e,t,r){if(!Number.isInteger(r)||r<0||r>32)return!1;if(r===0)return!0;let o=4294967295<<32-r>>>0;return(e&o)===(t&o)}n(Mi,"inIpv4Cidr");function Ni(e){let t=qe(e);return!t||!t.includes(":")?!1:/^[0-9a-f:]+$/i.test(t)}n(Ni,"isIpv6Literal");function Ui(e){let t=qe(e);return!!(!t||t==="::1"||t==="0:0:0:0:0:0:0:1"||t.startsWith("fc")||t.startsWith("fd")||/^fe[89ab]/i.test(t))}n(Ui,"isBlockedIpv6");function Li(e,{blockedExact:t,blockedSuffixes:r}={}){let o=qe(e);if(!o)return!0;let a=t||Oi;if(a instanceof Set&&a.has(o))return!0;let s=r||vi;if(Array.isArray(s))for(let i of s){let c=qe(i);if(c&&(o===c||o.endsWith(c)))return!0}return!1}n(Li,"isBlockedHostname");function Ki(e){let t=qe(e);if(!t)return!0;if(Ii(t)){let r=Yn(t),o=[{base:"0.0.0.0",bits:8},{base:"10.0.0.0",bits:8},{base:"127.0.0.0",bits:8},{base:"169.254.0.0",bits:16},{base:"172.16.0.0",bits:12},{base:"192.168.0.0",bits:16},{base:"100.64.0.0",bits:10}];for(let a of o){let s=Yn(a.base);if(Mi(r,s,a.bits))return!0}return!1}return Ni(t)?Ui(t):!1}n(Ki,"isBlockedIpLiteral");function Dt(e,{allowedPorts:t}={}){let r=String(e||"").trim();if(!r)throw new Error("invalid_url");let o;try{o=new URL(r)}catch{throw new Error("invalid_url")}if(o.protocol!=="http:"&&o.protocol!=="https:")throw new Error("invalid_url");if(o.username||o.password)throw new Error("invalid_url");let a=t||Ti,s=String(o.port||"");if(a instanceof Set&&!a.has(s))throw new Error("port_not_allowed");let i=qe(o.hostname);if(!i)throw new Error("invalid_url");if(Li(i))throw new Error("blocked_host");if(Ki(i))throw new Error("blocked_host");return o}n(Dt,"parseAndValidateExternalUrl");function Ht(e){return String(e.headers.get("sec-fetch-site")||"").trim().toLowerCase()==="cross-site"}n(Ht,"shouldRejectCrossSiteFetch");var $i={"content-type":"application/json; charset=utf-8","cache-control":"public, max-age=600"};function Ve(e,t={}){return new Response(JSON.stringify(e),{...t,headers:{...$i,...t.headers||{}}})}n(Ve,"json");function jt(...e){for(let t of e){if(!t)continue;let r=String(t).trim();if(r)return r}return null}n(jt,"pickFirst");function Di(e){let t=e.slice(0,8e4),r=t.match(/<title[^>]*>([^<]*)<\/title>/i),o=t.match(/<meta[^>]+property=["']og:title["'][^>]*content=["']([^"']+)["'][^>]*>/i),a=t.match(/<meta[^>]+property=["']og:description["'][^>]*content=["']([^"']+)["'][^>]*>/i),s=t.match(/<meta[^>]+name=["']description["'][^>]*content=["']([^"']+)["'][^>]*>/i),i=t.match(/<meta[^>]+property=["']og:image["'][^>]*content=["']([^"']+)["'][^>]*>/i),c=t.match(/<meta[^>]+property=["']og:site_name["'][^>]*content=["']([^"']+)["'][^>]*>/i);return{title:jt(o?.[1],r?.[1]),description:jt(a?.[1],s?.[1]),image:jt(i?.[1]),siteName:jt(c?.[1])}}n(Di,"extractMeta");async function Jn(e){let t=e.request.url,r=new URL(t);if(r.searchParams.get("ping")==="1")return Ve({ok:!0,ping:!0});let o=r.searchParams.get("url")||"";if(Ht(e.request))return Ve({ok:!1,error:"forbidden"},{status:403,headers:{"cache-control":"no-store"}});let a;try{a=Dt(o)}catch{return Ve({ok:!1,error:"invalid_url"},{status:400,headers:{"cache-control":"no-store"}})}try{let s=await fetch(a.toString(),{headers:{"user-agent":"Mozilla/5.0 (compatible; HackaMapLinkPreview/1.0)",accept:"text/html,application/xhtml+xml"},redirect:"follow",cf:{cacheTtl:600,cacheEverything:!0}}),i=s.headers.get("content-type")||"";if(!s.ok)return Ve({ok:!1,error:"fetch_failed",status:s.status,url:a.toString()},{status:200,headers:{"cache-control":"no-store"}});if(!i.includes("text/html"))return Ve({ok:!0,url:a.toString(),domain:a.host,contentType:i,title:null,description:null,image:null,siteName:null});let c=await s.text(),l=Di(c);return Ve({ok:!0,url:a.toString(),domain:a.host,contentType:i,...l})}catch(s){return Ve({ok:!1,error:"exception",message:s?.message||String(s),url:a.toString()},{status:200,headers:{"cache-control":"no-store"}})}}n(Jn,"onRequestGet");var Xn=35e4;function Hi(e){let t=e;return t=t.replace(/<script\b[\s\S]*?<\/script>/gi,""),t=t.replace(/<iframe\b[\s\S]*?<\/iframe>/gi,""),t=t.replace(/<object\b[\s\S]*?<\/object>/gi,""),t=t.replace(/<embed\b[\s\S]*?>/gi,""),t=t.replace(/<noscript\b[\s\S]*?<\/noscript>/gi,""),t=t.replace(/\son[a-z]+\s*=\s*"[^"]*"/gi,""),t=t.replace(/\son[a-z]+\s*=\s*'[^']*'/gi,""),t}n(Hi,"stripActiveContent");function ji({url:e,title:t,innerHtml:r}){let o=t?String(t).slice(0,140):"Preview",a=String(e).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;");return`<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
...
</html>`}n(ji,"buildWrapper");async function Qn(e){let r=new URL(e.request.url).searchParams.get("url")||"";if(Ht(e.request))return new Response("Forbidden",{status:403,headers:{"cache-control":"no-store"}});let o;try{o=Dt(r)}catch(a){let s=a instanceof Error?a.message:"invalid_url";return new Response(s,{status:400,headers:{"cache-control":"no-store"}})}try{let a=await fetch(o.toString(),{headers:{"user-agent":"Mozilla/5.0 (compatible; HackaMapLinkProxy/1.0)",accept:"text/html,application/xhtml+xml"},redirect:"follow",cf:{cacheTtl:600,cacheEverything:!0}}),s=a.headers.get("content-type")||"";if(!a.ok)return new Response(`Fetch failed (${a.status})`,{status:200,headers:{"content-type":"text/plain; charset=utf-8","cache-control":"no-store"}});if(!s.includes("text/html"))return new Response(`Unsupported content-type: ${s}`,{status:200,headers:{"content-type":"text/plain; charset=utf-8","cache-control":"public, max-age=600"}});let i=await a.text();i.length>Xn&&(i=i.slice(0,Xn));let l=i.match(/<title[^>]*>([^<]*)<\/title>/i)?.[1]?.trim()||o.host;i=Hi(i),/<base\s/i.test(i)||(i=i.replace(/<head([^>]*)>/i,`<head$1><base href="${o.origin}/">`));let m=ji({url:o.toString(),title:l,innerHtml:i});return new Response(m,{status:200,headers:{"content-type":"text/html; charset=utf-8","cache-control":"public, max-age=600","content-security-policy":"default-src 'none'; img-src https: data:; style-src 'unsafe-inline' https:; font-src https: data:; frame-ancestors 'self';"}})}catch(a){return new Response(`Exception: ${a?.message||String(a)}`,{status:200,headers:{"content-type":"text/plain; charset=utf-8","cache-control":"no-store"}})}}n(Qn,"onRequestGet");var Mr="api.openai.com",Nr="gateway.ai.cloudflare.com",Ur="api.cloudflare.com",Gt="api.miromind.ai",Bt="apihub.agnes-ai.com",Wt="ark.ap-southeast.bytepluses.com",Lr="ark.eu-west.bytepluses.com",ea=new Set(["localhost","127.0.0.1","0.0.0.0"]),Pe=n(e=>String(e||"").trim().toLowerCase(),"normalizeHost"),pe=n((e,t)=>String(e.get(t)||"").trim(),"readHeader"),ta=n(e=>ea.has(Pe(e)),"isLocalHost"),Zn=n(e=>{let t=String(e||"").trim();if(!t)return new Set;let r=new Set;return t.split(",").map(o=>Pe(o)).filter(Boolean).forEach(o=>r.add(o)),r},"parseCsvSet"),ra=n((e,{includeOpenAi:t=!1,includeAiGateway:r=!1,includeMiroMind:o=!1,includeAgnes:a=!1,includeBytePlus:s=!1}={})=>{let i=Zn(e.KNOWGRPH_INTEGRATION_ALLOWED_HOSTS),c=Zn(e.KNOWGRPH_CHAT_PROXY_ALLOWED_HOSTS),l=i.size?i:c,p=l.size?l:new Set([...ea]);return t&&p.add(Mr),r&&(p.add(Nr),p.add(Ur)),o&&p.add(Gt),a&&p.add(Bt),s&&(p.add(Wt),p.add(Lr)),p},"parseAllowedHosts"),ce=n(e=>{let t=pe(e.headers,"origin");if(!t)return{};let r="";try{r=Pe(new URL(t).host)}catch{return{}}let o=Pe(new URL(e.url).host);return r===o||r.startsWith("localhost:")||r.startsWith("127.0.0.1:")?{"access-control-allow-origin":t,vary:"Origin"}:{}},"corsHeaders"),ge=n((e,t,r)=>new Response(JSON.stringify(t),{status:r,headers:{"content-type":"application/json; charset=utf-8","cache-control":"no-store",...ce(e)}}),"jsonResponse");var Ft={"content-type":"application/json; charset=utf-8","cache-control":"no-store"};function ft(e,t,r=200){return new Response(JSON.stringify(t),{status:r,headers:{...Ft,...ce(e)}})}n(ft,"jsonResponse");async function Gi(e){let t=new URL("/knowgrph/imports/hackamap/hackamap-graph.json",e.url),r=await fetch(t.toString(),{redirect:"follow"});return r.ok?await r.json():null}n(Gi,"fetchHackamapGraphJson");async function Ye(e,t){let r=new URL(t,e.url),o=await fetch(r.toString(),{redirect:"follow"});return o.ok?await o.json():null}n(Ye,"fetchHackamapJson");async function Bi(e){let t=await Ye(e,"/knowgrph/imports/hackamap/hackamap_api_graph.json");return sa(t)?t:null}n(Bi,"fetchHackamapApiGraphJson");async function Wi(e){let t=await Ye(e,"/knowgrph/imports/hackamap/hackamap_pipeline.json");return t&&typeof t=="object"&&!Array.isArray(t)?t:{}}n(Wi,"fetchHackamapPipelineJson");async function na(e){let t=await Ye(e,"/knowgrph/imports/hackamap/hackamap_query_presets.json");return Array.isArray(t)?t.filter(Boolean):[]}n(na,"fetchHackamapQueryPresetsJson");async function aa(e){let t=await Ye(e,"/knowgrph/imports/hackamap/query-outputs/query-runs.manifest.json");return t&&typeof t=="object"&&!Array.isArray(t)?t:{}}n(aa,"fetchHackamapQueryRunsManifestJson");function sa(e){return!e||typeof e!="object"||Array.isArray(e)?!1:Array.isArray(e.nodes)&&Array.isArray(e.edges)}n(sa,"isApiGraphPayload");function ia(e,t){let r=String(e&&e.output&&e.output.per_table_prefix||e?.id||t?.preset||"").trim(),o=String(t?.output_suffix||"").trim();return o?`${r}-${o}`:r}n(ia,"buildHackamapTablePrefix");function Kr(e,t){if(!Array.isArray(e))return[];let r=[];for(let o of e){if(!o||typeof o!="object"||Array.isArray(o))continue;let a=String(o[t]||"").trim();a&&r.push(a)}return r}n(Kr,"collectRowIds");async function Fi(e,t){let r=await Ye(e,t);return Array.isArray(r)?r.length:0}n(Fi,"countHackamapQueryRows");async function zi(e,t,r){let o=ia(t,r);if(!o)return{};let a=["events","demos","sources","organizer","team","techstack"],s=await Promise.all(a.map(async i=>[i,await Fi(e,`/knowgrph/imports/hackamap/query-outputs/${i}.${o}.query.json`)]));return Object.fromEntries(s.filter(([,i])=>i>0))}n(zi,"readHackamapRunTableCounts");function $r(e){return Array.isArray(e)?e.map($r):!e||typeof e!="object"?e:Object.fromEntries(Object.entries(e).sort(([t],[r])=>String(t).localeCompare(String(r))).map(([t,r])=>[t,$r(r)]))}n($r,"sortObjectKeys");function qi(e){try{return JSON.stringify($r(e))}catch{return""}}n(qi,"stableParamSignature");function Vi(e){return typeof e=="string"?{value:e,label:e}:{value:e,label:JSON.stringify(e)}}n(Vi,"toBuilderOption");function Yi(e,t){return e.map(r=>{let o=String(r?.id||"").trim();if(!o)return null;let a=r?.params&&typeof r.params=="object"&&!Array.isArray(r.params)?r.params:{},s=t.filter(l=>String(l?.preset||"").trim()===o),i=Array.from(new Set([...Object.keys(a),...s.flatMap(l=>l?.params&&typeof l.params=="object"&&!Array.isArray(l.params)?Object.keys(l.params):[])])).sort((l,p)=>String(l).localeCompare(String(p))),c=Object.fromEntries(i.map(l=>{let p=new Set,m=[],f=[a[l],...s.map(A=>A?.params&&typeof A.params=="object"&&!Array.isArray(A.params)?A.params[l]:void 0)];for(let A of f){if(typeof A>"u")continue;let S=qi(A);!S||p.has(S)||(p.add(S),m.push(Vi(A)))}return[l,m]}));return{id:o,title:String(r?.title||o).trim(),params:a,param_keys:i,published_param_options:c}}).filter(Boolean)}n(Yi,"buildHackamapPresetRuntimeEntries");async function Ji(e){let[t,r,o]=await Promise.all([Wi(e),na(e),aa(e)]),a=t&&typeof t=="object"?t.runtime||{}:{},s=String(a?.query_selection?.default_run_id||"").trim()||"enhanced",i=Array.isArray(o?.runs)?o.runs:[],c=(await Promise.all(i.map(async l=>{let p=String(l?.id||"").trim(),m=String(l?.preset||"").trim();if(!p)return null;let f=r.find(S=>String(S?.id||"").trim()===m),A=await zi(e,f,l);return{id:p,preset:m,title:String(l?.title||l?.id||"").trim(),params:l?.params&&typeof l.params=="object"&&!Array.isArray(l.params)?l.params:{},output_suffix:String(l?.output_suffix||"").trim(),is_default:p===s,table_counts:A}}))).filter(l=>l?.id);return{ok:!0,runtime:{...a&&typeof a=="object"?a:{},presets:Yi(r,c),runs:c}}}n(Ji,"buildHackamapRuntimeMeta");async function Xi(e,t){let r=String(t||"").trim();if(!r)return null;let[o,a]=await Promise.all([na(e),aa(e)]),i=(Array.isArray(a?.runs)?a.runs:[]).find(O=>String(O?.id||"").trim()===r);if(!i)return null;let c=o.find(O=>String(O?.id||"").trim()===String(i?.preset||"").trim()),l=ia(c,i);if(!l)return null;let[p,m]=await Promise.all([Ye(e,`/knowgrph/imports/hackamap/query-outputs/events.${l}.query.json`),Ye(e,`/knowgrph/imports/hackamap/query-outputs/demos.${l}.query.json`)]),f=new Set(Kr(p,"id")),A=new Set(Kr(m,"id")),S=Kr(m,"event_id");for(let O of S)f.add(O);return{eventIds:f,demoIds:A}}n(Xi,"readHackamapQueryRunSelection");function oa(e,t,r){if(!r||!sa(e))return e;if(r.eventIds.size===0&&r.demoIds.size===0)return{...e,meta:{...e?.meta&&typeof e.meta=="object"?e.meta:{},selected_run_id:t,selected_run_filter_skipped:"no-event-demo-rows"}};let o=new Set;r.eventIds.forEach(c=>o.add(`Event:${c}`)),r.demoIds.forEach(c=>o.add(`Demo:${c}`));let a=Array.isArray(e.nodes)?e.nodes.filter(c=>o.has(String(c?.id||"").trim())):[],s=new Set(a.map(c=>String(c?.id||"").trim()).filter(Boolean)),i=Array.isArray(e.edges)?e.edges.filter(c=>s.has(String(c?.source||"").trim())&&s.has(String(c?.target||"").trim())):[];return{...e,nodes:a,edges:i,meta:{...e?.meta&&typeof e.meta=="object"?e.meta:{},selected_run_id:t,selected_event_count:r.eventIds.size,selected_demo_count:r.demoIds.size,total_problems:a.filter(c=>String(c?.type||"").trim()==="problem").length,total_solutions:a.filter(c=>String(c?.type||"").trim()==="solution").length}}}n(oa,"filterHackamapApiGraphPayloadByRun");function Qi(e){let t=Array.isArray(e?.nodes)?e.nodes:[],r=Array.isArray(e?.links)?e.links:[],o=[],a=new Set;for(let i of t){let c=String(i?.id||"").trim(),l=String(i?.type||"").trim(),p=String(i?.label||"").trim();if(!(!c||!l||!p)){if(l==="Event"){o.push({id:c,type:"problem",label:p,cluster:"Event"}),a.add(c);continue}l==="Demo"&&(o.push({id:c,type:"solution",label:p,cluster:"Demo"}),a.add(c))}}let s=[];for(let i of r){let c=String(i?.source||"").trim(),l=String(i?.target||"").trim(),p=String(i?.type||"").trim();!c||!l||p==="has_demo"&&(!a.has(c)||!a.has(l)||s.push({source:c,target:l,type:"has_demo",strength:.35}))}return{nodes:o,edges:s,meta:{source:"hackamap-graph.json:fallback",total_problems:o.filter(i=>i.type==="problem").length,total_solutions:o.filter(i=>i.type==="solution").length,...e?.content_signature?{content_signature:String(e.content_signature)}:{}}}}n(Qi,"toBipartiteApiPayload");async function ca(e){let{request:t}=e,r=String(t.method||"GET").toUpperCase(),o=new URL(t.url);if(r==="OPTIONS")return new Response(null,{status:204,headers:{...ce(t),"access-control-allow-methods":"GET, HEAD, OPTIONS","access-control-allow-headers":"*","access-control-max-age":"86400"}});if(r!=="GET"&&r!=="HEAD")return ft(t,{ok:!1,error:"unsupported_method"},405);if(String(o.searchParams.get("view")||"").trim().toLowerCase()==="meta"){let m=await Ji(t);return r==="HEAD"?new Response(null,{status:200,headers:{...Ft,...ce(t)}}):ft(t,m,200)}let a=String(o.searchParams.get("run")||"").trim(),s=await Xi(t,a),i=await Bi(t);if(i){let m=oa(i,a,s);return r==="HEAD"?new Response(null,{status:200,headers:{...Ft,...ce(t)}}):ft(t,m,200)}let c=await Gi(t);if(!c)return ft(t,{ok:!1,error:"missing_hackamap_graph",hint:"/knowgrph/imports/hackamap/{hackamap_api_graph.json,hackamap-graph.json} not found"},404);let l=Qi(c),p=oa(l,a,s);return r==="HEAD"?new Response(null,{status:200,headers:{...Ft,...ce(t)}}):ft(t,p,200)}n(ca,"onRequest");var Zi=!0,la=600,pa={"content-type":"application/json; charset=utf-8","cache-control":`public, max-age=${la}`};function Je(e,t,r={}){return new Response(JSON.stringify(t),{...r,headers:{...pa,...r.headers||{},...ce(e)}})}n(Je,"jsonResponse");function ec(e){try{let t=new URL(String(e));return t.protocol==="http:"||t.protocol==="https:"}catch{return!1}}n(ec,"isHttpUrl");function yt(e){return String(e||"").trim().toLowerCase()}n(yt,"normalizeHost");function Dr(e,{exact:t,suffixes:r}){let o=yt(e);return o?!!(Array.isArray(t)&&t.some(a=>o===yt(a))||Array.isArray(r)&&r.some(a=>o===yt(a)||o.endsWith(`.${yt(a)}`))):!1}n(Dr,"isHostMatch");function tc(e){let t=yt(e.hostname),r=e.toString();return Dr(t,{suffixes:["linkedin.com"]})?new URL(`https://www.linkedin.com/embeds/oembed.json?url=${encodeURIComponent(r)}`):Dr(t,{exact:["twitter.com","x.com"],suffixes:["twitter.com","x.com"]})?new URL(`https://publish.twitter.com/oembed?omit_script=1&url=${encodeURIComponent(r)}`):Dr(t,{exact:["reddit.com"],suffixes:["reddit.com"]})?new URL(`https://www.reddit.com/oembed?url=${encodeURIComponent(r)}`):null}n(tc,"buildOembedUpstreamUrl");async function rc({upstreamUrl:e}){return await fetch(e.toString(),{headers:{"user-agent":"Mozilla/5.0 (compatible; OEmbedProxy/1.0)",accept:"application/json,text/json;q=0.9,*/*;q=0.1"},redirect:"follow",cf:{cacheTtl:la,cacheEverything:!0}})}n(rc,"fetchJsonUpstream");async function ua(e){let{request:t}=e,r=String(t.method||"GET").toUpperCase(),o=new URL(t.url);if(r==="OPTIONS")return new Response(null,{status:204,headers:{...ce(t),"access-control-allow-methods":"GET, HEAD, OPTIONS","access-control-allow-headers":"*","access-control-max-age":"86400"}});if(!["GET","HEAD"].includes(r))return Je(t,{ok:!1,error:"unsupported_method"},{status:405});if(o.searchParams.get("ping")==="1")return Je(t,{ok:!0,ping:!0});if(Zi)return Je(t,{ok:!1,error:"disabled_by_policy"},{status:200,headers:{"cache-control":"no-store"}});let a=o.searchParams.get("url")||"";if(!ec(a))return Je(t,{ok:!1,error:"invalid_url"},{status:400,headers:{"cache-control":"no-store"}});let s;try{s=new URL(a)}catch{return Je(t,{ok:!1,error:"invalid_url"},{status:400,headers:{"cache-control":"no-store"}})}let i=tc(s);if(!i)return Je(t,{ok:!1,error:"unsupported_provider"},{status:400,headers:{"cache-control":"no-store"}});let c=await rc({upstreamUrl:i}),l=new Headers(c.headers);l.delete("content-length"),l.set("cache-control",c.ok?pa["cache-control"]:"no-store");for(let[m,f]of Object.entries(ce(t)))l.set(m,f);if(r==="HEAD")return new Response(null,{status:c.status,headers:l});let p=await c.text();try{JSON.parse(p)}catch{return Je(t,{ok:!1,error:"invalid_upstream_json",status:c.status},{status:502,headers:{"cache-control":"no-store"}})}return l.set("content-type","application/json; charset=utf-8"),new Response(p,{status:c.status,headers:l})}n(ua,"onRequest");var da="/__chat_proxy",zt="agnes-ai",qt="byteplus-modelark",Vt="miromind",oc="x-kg-ai-gateway-route",nc="x-kg-ai-gateway-metadata",ac="x-kg-ai-gateway-cache-ttl",sc=n(e=>{let t=Pe(e);return t==="openai"?"openai":t===qt||t==="byteplus"?qt:t===Vt||t==="miromind-api"?Vt:t===zt||t==="agnes"||t==="agnes-ai-api"?zt:t},"normalizeProviderId"),ic=n(e=>Pe(e)===Bt,"isAgnesHost"),cc=n(e=>{let t=Pe(e);return t===Wt||t===Lr},"isBytePlusHost"),lc=n(e=>Pe(e)===Gt,"isMiroMindHost"),pc=n(e=>{let t=Pe(e);return t===Nr||t===Ur},"isAiGatewayHost"),uc=n(e=>{let t=String(e||"").trim();return/^dynamic\/[a-z0-9._/-]+$/i.test(t)?t.slice(0,128):""},"sanitizeAiGatewayRoute"),dc=n(e=>{let t=String(e||"").trim();if(!t)return"";try{let r=JSON.parse(t),o=Object.entries(r||{}).filter(([,a])=>typeof a=="string"||typeof a=="number"||typeof a=="boolean").slice(0,5).map(([a,s])=>[String(a||"").trim().slice(0,64),typeof s=="string"?s.trim().slice(0,160):s]).filter(([a])=>a);return o.length?JSON.stringify(Object.fromEntries(o)):""}catch{return""}},"sanitizeAiGatewayMetadata"),mc=n(e=>{let t=Number(String(e||"").trim());return Number.isFinite(t)?String(Math.max(1,Math.min(86400,Math.floor(t)))):""},"sanitizeAiGatewayCacheTtl"),hc=n((e,t,r)=>{let a=`${e.pathname==="/"?"":String(e.pathname||"").replace(/\/+$/g,"")}${t.startsWith("/")?t:`/${t}`}`;return new URL(`${a}${r||""}`,`${e.protocol}//${e.host}`)},"buildUpstreamUrl"),gc=n(({provider:e,requestedUpstream:t,env:r})=>e==="openai"?t||"https://api.openai.com":e===Vt?t||`https://${Gt}`:e===zt?t||`https://${Bt}`:e===qt?t||String(r.KNOWGRPH_CHAT_PROXY_UPSTREAM||"").trim()||`https://${Wt}`:t||String(r.KNOWGRPH_CHAT_PROXY_UPSTREAM||"").trim(),"pickUpstreamBase");async function ma(e){let{request:t,env:r}=e,o=String(t.method||"GET").toUpperCase(),a=new URL(t.url);if(o==="OPTIONS")return new Response(null,{status:204,headers:{"access-control-allow-origin":pe(t.headers,"origin")||"*","access-control-allow-methods":"GET, HEAD, POST, OPTIONS","access-control-allow-headers":"*","access-control-max-age":"86400"}});if(!["GET","HEAD","POST"].includes(o))return ge(t,{ok:!1,error:"Unsupported method"},405);let s=sc(pe(t.headers,"x-kg-chat-provider")),i=uc(pe(t.headers,oc)),c=dc(pe(t.headers,nc)),l=mc(pe(t.headers,ac)),p=String(r.KNOWGRPH_CHAT_PROXY_AI_GATEWAY_BASE_URL||"").trim(),m=String(r.KNOWGRPH_CHAT_PROXY_AI_GATEWAY_GATEWAY_ID||"").trim(),f=s==="openai"&&!!p&&!!i,A=gc({provider:s,requestedUpstream:f?p:pe(t.headers,"x-kg-chat-upstream"),env:r});if(!A)return ge(t,{ok:!1,error:"Missing chat proxy upstream configuration"},500);let S;try{S=new URL(A)}catch{return ge(t,{ok:!1,error:"Invalid chat proxy upstream configuration"},500)}let O=ra(r,{includeOpenAi:!0,includeAiGateway:!0,includeMiroMind:!0,includeAgnes:!0,includeBytePlus:!0}),$=Pe(S.hostname);if(!O.has($))return ge(t,{ok:!1,error:"Chat proxy upstream host is not allowed"},403);if(!ta($)&&S.protocol!=="https:")return ge(t,{ok:!1,error:"Chat proxy requires HTTPS for non-local upstream hosts"},403);let N=f||pc($),W=!N&&(s==="openai"||$===Mr),Q=s===Vt||lc($),z=s===zt||ic($),x=s===qt||cc($),T=pe(t.headers,"x-kg-chat-api-key"),te=String(r.KNOWGRPH_CHAT_PROXY_AI_GATEWAY_TOKEN||r.AI_GATEWAY_TOKEN||r.CLOUDFLARE_API_TOKEN||"").trim(),G=String(r.KNOWGRPH_CHAT_PROXY_OPENAI_API_KEY||r.OPENAI_API_KEY||"").trim(),le=String(r.KNOWGRPH_CHAT_PROXY_MIROMIND_API_KEY||r.MIROMIND_API_KEY||"").trim(),U=String(r.KNOWGRPH_CHAT_PROXY_AGNES_API_KEY||r.AGNES_API_KEY||"").trim(),L=String(r.KNOWGRPH_CHAT_PROXY_BYTEPLUS_API_KEY||r.BYTEPLUS_API_KEY||"").trim(),V=(T||te).slice(0,512),se=(T||G).slice(0,512),Se=(T||le).slice(0,512),ke=(T||U).slice(0,512),P=(T||L).slice(0,512),w=x?P:N?V:z?ke:Q?Se:se;if(N&&!w)return ge(t,{ok:!1,error:"Missing Cloudflare AI Gateway token for chat proxy upstream (set KNOWGRPH_CHAT_PROXY_AI_GATEWAY_TOKEN or AI_GATEWAY_TOKEN)"},401);if(W&&!se)return ge(t,{ok:!1,error:"Missing OpenAI API key for chat proxy upstream (set KNOWGRPH_CHAT_PROXY_OPENAI_API_KEY or OPENAI_API_KEY)"},401);if(Q&&!w)return ge(t,{ok:!1,error:"Missing MiroMind API key for chat proxy upstream (set KNOWGRPH_CHAT_PROXY_MIROMIND_API_KEY or MIROMIND_API_KEY)"},401);if(z&&!w)return ge(t,{ok:!1,error:"Missing Agnes API key for chat proxy upstream (set KNOWGRPH_CHAT_PROXY_AGNES_API_KEY or AGNES_API_KEY)"},401);if(x&&!w)return ge(t,{ok:!1,error:"Missing BytePlus API key for chat proxy upstream (set KNOWGRPH_CHAT_PROXY_BYTEPLUS_API_KEY or BYTEPLUS_API_KEY)"},401);if(o==="POST"&&!pe(t.headers,"content-type").toLowerCase().includes("application/json"))return ge(t,{ok:!1,error:"Chat proxy expects application/json payloads"},415);let y=a.pathname.startsWith(da)&&a.pathname.slice(da.length)||"/v1/chat/completions",d=y.startsWith("/")?y:`/${y}`,g=hc(S,d,a.search||""),h=new Headers,R=pe(t.headers,"content-type"),E=pe(t.headers,"accept");R&&h.set("content-type",R),E&&h.set("accept",E),(W||N||Q||z||x)&&h.set("authorization",`Bearer ${w}`);let q=pe(t.headers,"x-client-request-id").slice(0,512);q&&h.set("x-client-request-id",q),N&&m&&h.set("cf-aig-gateway-id",m),c&&h.set("cf-aig-metadata",c),l&&h.set("cf-aig-cache-ttl",l);let D=new AbortController,K=Number(r.KNOWGRPH_CHAT_PROXY_TIMEOUT_MS),Y=Number.isFinite(K)?Math.max(5e3,Math.min(18e4,Math.floor(K))):9e4,b=setTimeout(()=>D.abort(),Y);try{let j=o==="GET"||o==="HEAD"?void 0:t.body;if(f&&o==="POST"){let Ge=await t.clone().text();try{let Be=JSON.parse(Ge||"{}");Be.model=i,j=JSON.stringify(Be)}catch{j=Ge}}let ue=await fetch(g.toString(),{method:o,headers:h,body:j,signal:D.signal,redirect:"follow"}),v=new Headers(ue.headers);v.delete("content-length"),v.delete("www-authenticate"),v.set("cache-control","no-store");let J=pe(t.headers,"origin");return J&&(v.set("access-control-allow-origin",J),v.set("vary","Origin")),o==="HEAD"?new Response(null,{status:ue.status,statusText:ue.statusText,headers:v}):new Response(ue.body,{status:ue.status,statusText:ue.statusText,headers:v})}catch(j){let ue=j&&typeof j=="object"&&"message"in j?String(j.message||""):"",v=D.signal.aborted||/aborted|timeout/i.test(ue);return ge(t,{ok:!1,error:ue||"Failed to reach chat upstream"},v?504:502)}finally{clearTimeout(b)}}n(ma,"onRequest");function fc(e){let t=e.map(r=>r==null?"":typeof r=="boolean"?r?"1":"0":typeof r=="number"?Number.isFinite(r)?String(r):"":String(r)).join("|");return`rich-media-preview:${st(t)}`}n(fc,"buildRichMediaPreviewSemanticKey");var ga="png";function wt(e){let t=typeof e=="number"?e:Number(String(e??"").trim());if(!Number.isFinite(t))return null;let r=Math.max(0,Number(t.toFixed(3)));return Number.isFinite(r)?r:null}n(wt,"normalizeRemoteVideoFrameSeconds");function yc(e){return String(wt(e)??0).replace(/\./g,"_")}n(yc,"formatRemoteVideoFrameSecondsForFileName");function Jt(e){let t=String(e||"").trim().toLowerCase();return t==="jpg"||t==="jpeg"?"jpg":"png"}n(Jt,"normalizeRemoteVideoFrameFormat");function Hr(e){let t=String(e.sourceUrl||"").trim(),r=wt(e.timeSeconds)??0,o=Jt(e.format||ga);return fc(["remote-video-frame",t,r,o])}n(Hr,"buildRemoteVideoFrameSemanticKey");function fa(e){let t=wt(e.timeSeconds)??0,r=Jt(e.format||ga),o=Hr({...e,timeSeconds:t,format:r});return`frame-${o.split(":").pop()||st(o)}-t${yc(t)}.${r}`}n(fa,"buildRemoteVideoFrameFileName");var Yt=n(e=>{let t=String(e||"").trim();return t&&/^[A-Za-z0-9_-]{6,128}$/.test(t)?t:null},"normalizeYouTubeIdLikeValue"),ha=n(e=>{try{let t=new URL(String(e||"").trim()),r=String(t.hostname||"").toLowerCase();if(r==="youtu.be"||r.endsWith(".youtu.be")){let o=t.pathname.replace(/^\/+/,"").split("/")[0]?.trim()||"";return Yt(o)}if(r==="youtube.com"||r.endsWith(".youtube.com")||r==="youtube-nocookie.com"||r.endsWith(".youtube-nocookie.com")){let o=String(t.searchParams.get("v")||"").trim();if(o)return Yt(o);let a=t.pathname.split("/").filter(Boolean),s=a[0]||"",i=a[1]||"";if((s==="embed"||s==="shorts"||s==="live")&&i)return Yt(i);if(s==="watch"){let c=String(t.searchParams.get("v")||"").trim();return Yt(c)}}}catch{return null}return null},"readYouTubeIdFromUrl");function wc(e){let t=String(e||"").trim().replace(/^<|>$/g,"").trim();for(;/[),.;:!?]$/.test(t);){let r=t.slice(0,-1).trim();if(!r)break;let o=ha(t),a=ha(r);if(!a||o&&o!==a)break;t=r}return t}n(wc,"stripYouTubeUrlTrailingPunctuation");function ya(e){let t=n(r=>{let o=String(r||"").trim();if(!o)return null;if(/^\d+$/.test(o))return Number(o);let a=o.match(/^(?:(\d+)h)?(?:(\d+)m)?(?:(\d+)s)?$/i);if(!a)return null;let s=a[1]?Number(a[1]):0,i=a[2]?Number(a[2]):0,c=a[3]?Number(a[3]):0,l=s*3600+i*60+c;return l>0&&Number.isFinite(l)?l:null},"parseChunk");try{let r=new URL(wc(e)),o=r.searchParams.get("t")||r.searchParams.get("start")||"",a=r.hash&&new URLSearchParams(r.hash.replace(/^#/,"")).get("t")||"";return t(o)??t(a)}catch{return null}}n(ya,"parseYouTubeStartSeconds");var Sc="/image/knowgrph/video-frame",_c=4096,bc=720*60,Rc=/^frame-[a-f0-9]+-t\d+\.(?:png|jpg)$/i,Wr={"access-control-allow-origin":"*","access-control-allow-methods":"GET, HEAD, OPTIONS","access-control-allow-headers":"accept, content-type"},Br=n(e=>String(e||"").replace(/\s+/g," ").trim(),"cleanText"),jr=n((e,t=200,r="GET")=>new Response(r==="HEAD"?null:JSON.stringify(e),{status:t,headers:{...Wr,"content-type":"application/json; charset=utf-8","cache-control":"no-store"}}),"jsonResponse"),Gr=n((e,t=200,r="GET")=>new Response(r==="HEAD"?null:e,{status:t,headers:{...Wr,"content-type":"text/plain; charset=utf-8","cache-control":"no-store"}}),"textResponse"),Ac=n((e,t)=>e===t||e.endsWith(`.${t}`),"hostMatches"),Pc=n(e=>{let t=Br(e?.KG_VIDEO_FRAME_ALLOWED_HOSTS);return t?t.split(",").map(r=>Br(r).toLowerCase()).filter(Boolean):["youtube.com","youtu.be","youtube-nocookie.com","bilibili.com","b23.tv"]},"readAllowedHosts"),kc=n(e=>Br(e).replace(/^<|>$/g,"").trim(),"unwrapUrlInput"),xc=n((e,t)=>{try{let r=new URL(e);if(r.protocol!=="https:"&&r.protocol!=="http:")return!1;let o=r.hostname.toLowerCase();return Pc(t).some(a=>Ac(o,a))}catch{return!1}},"isAllowedSourceUrl"),Ec=n((e,t)=>{let r=new URL(e.url),o=kc(r.searchParams.get("url")||"");if(!o)return{error:"Missing url parameter"};if(o.length>_c)return{error:"Video URL is too long"};if(!xc(o,t))return{error:"Video frame extraction is limited to supported remote video hosts"};let a=wt(r.searchParams.get("time"))??ya(o);if(a==null)return{error:"Missing time parameter"};let s=Math.min(bc,Math.max(0,a)),i=Jt(r.searchParams.get("format")||"png"),c=fa({sourceUrl:o,timeSeconds:s,format:i});if(!Rc.test(c))return{error:"Invalid frame cache key"};let l=`${Sc}/${c}`;return{sourceUrl:o,timeSeconds:s,format:i,fileName:c,publicUrl:l,semanticKey:Hr({sourceUrl:o,timeSeconds:s,format:i})}},"readFrameRequest"),Cc=n(async(e,t,r)=>{let o=new URL(t,e.request.url),a=new Request(o.toString(),{method:r});return typeof e.env?.ASSETS?.fetch=="function"?await e.env.ASSETS.fetch(a):await fetch(a)},"fetchStaticAsset"),Tc=n(e=>`Frame has not been generated yet. Run the local video-frame extractor and publish ${e.publicUrl}.`,"missingFrameMessage"),vc=n((e,t)=>{let r=new Headers;r.set("content-type",t.format==="jpg"?"image/jpeg":"image/png"),r.set("cache-control","public, max-age=31536000, immutable"),r.set("access-control-allow-origin","*");let o=e.headers.get("content-length");o&&r.set("content-length",o);let a=e.headers.get("etag");return a&&r.set("etag",a),r},"imageResponseHeaders");async function wa(e){let t=e.request;if(t.method==="OPTIONS")return new Response(null,{status:204,headers:Wr});if(t.method!=="GET"&&t.method!=="HEAD")return Gr("Method not allowed",405,t.method);let r=new URL(t.url).searchParams.get("emit")==="json",o=Ec(t,e.env||{});if("error"in o)return r?jr({ok:!1,error:o.error},400,t.method):Gr(o.error,400,t.method);let a=r&&t.method!=="HEAD"?"GET":r||t.method==="HEAD"?"HEAD":"GET",s=await Cc(e,o.publicUrl,a);if(!s.ok){let i=Tc(o);return r?jr({ok:!1,error:i,publicUrl:o.publicUrl,semanticKey:o.semanticKey},404,t.method):Gr(i,404,t.method)}if(r){let i=Number(s.headers.get("content-length")||0);return(!Number.isFinite(i)||i<=0)&&t.method!=="HEAD"&&(i=(await s.arrayBuffer()).byteLength),jr({ok:!0,imageUrl:o.publicUrl,publicUrl:o.publicUrl,semanticKey:o.semanticKey,cached:!0,bytes:Number.isFinite(i)?Math.max(0,Math.floor(i)):0,timeSeconds:o.timeSeconds,format:o.format},200,t.method)}return new Response(t.method==="HEAD"?null:s.body,{status:200,headers:vc(s,o)})}n(wa,"onRequest");var Sa={"content-type":"application/json; charset=utf-8","cache-control":"no-store","access-control-allow-origin":"*","access-control-allow-methods":"GET, HEAD, POST, OPTIONS","access-control-allow-headers":"content-type"},Xt=n((e,t=200,r="GET")=>new Response(r==="HEAD"?null:JSON.stringify(e),{status:t,headers:Sa}),"jsonResponse"),re=n(e=>String(e||"").replace(/\s+/g," ").trim(),"cleanText"),Oc=n(e=>{try{let t=new URL(String(e||"").trim());if(/youtu\.be$/i.test(t.hostname))return re(t.pathname.split("/").filter(Boolean)[0]);if(/youtube\.com$/i.test(t.hostname)||/youtube-nocookie\.com$/i.test(t.hostname)){let r=re(t.searchParams.get("v"));if(r)return r;let o=t.pathname.split("/").filter(Boolean),a=o.findIndex(s=>["embed","shorts","live"].includes(s));if(a>=0)return re(o[a+1])}}catch{}return""},"readVideoId"),Ic=n((e,t)=>{let r=e.indexOf(t);if(r<0)return null;let o=e.indexOf("{",r);if(o<0)return null;let a=0,s=!1,i=!1;for(let c=o;c<e.length;c+=1){let l=e[c];if(s){i?i=!1:l==="\\"?i=!0:l==='"'&&(s=!1);continue}if(l==='"')s=!0;else if(l==="{")a+=1;else if(l==="}"&&(a-=1,a===0))return e.slice(o,c+1)}return null},"extractJsonAfter"),Mc=n(e=>{for(let t of["ytInitialPlayerResponse =","ytInitialPlayerResponse="]){let r=Ic(e,t);if(r)try{return JSON.parse(r)}catch{}}return null},"parsePlayerResponse"),Nc=n((e,t)=>{let r=re(t||"en").toLowerCase();return e.find(o=>re(o.languageCode).toLowerCase()===r)||e.find(o=>re(o.languageCode).toLowerCase().startsWith(r.split("-")[0]))||e.find(o=>re(o.kind)!=="asr")||e[0]||null},"pickCaptionTrack"),Uc=n(e=>{let t=new URL(e);return t.searchParams.set("fmt","json3"),t.toString()},"withJsonCaptionFormat"),Lc=n(e=>(Array.isArray(e?.events)?e.events:[]).map(r=>{let o=Array.isArray(r.segs)?re(r.segs.map(i=>i?.utf8||"").join("")):"",a=Number(r.tStartMs)/1e3,s=Number(r.dDurationMs||0)/1e3;return o&&Number.isFinite(a)?{text:o,start:a,duration:Number.isFinite(s)?s:0}:null}).filter(Boolean),"parseCaptionJson3"),Kc=n(e=>String(e||"").replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&quot;/g,'"').replace(/&#39;|&apos;/g,"'"),"decodeXmlText"),$c=n(e=>{let t=[],r=/<text\b([^>]*)>([\s\S]*?)<\/text>/gi,o=null;for(;o=r.exec(String(e||""));){let a=o[1]||"",s=Number(a.match(/\bstart="([^"]+)"/i)?.[1]),i=Number(a.match(/\bdur="([^"]+)"/i)?.[1]||0),c=re(Kc(o[2]||""));c&&Number.isFinite(s)&&t.push({text:c,start:s,duration:Number.isFinite(i)?i:0})}return t},"parseCaptionXml"),Dc=n((e,t)=>{let r=String(e||"").trim();if(!r)return[];if(String(t||"").toLowerCase().includes("json")||r.startsWith("{")||r.startsWith("["))try{return Lc(JSON.parse(r))}catch{return[]}return $c(r)},"parseCaptionResponseText"),Hc=n(e=>{let t=Math.max(0,Math.floor(Number(e)||0)),r=Math.floor(t/60),o=String(t%60).padStart(2,"0");return`${r}:${o}`},"formatTimestamp"),jc=n((e,t)=>{let r=new URL(e);return r.searchParams.set("t",`${Math.max(0,Math.floor(Number(t)||0))}s`),r.toString()},"timestampUrl"),Gc=n(({title:e,sourceUrl:t,videoId:r,authorName:o,thumbnailUrl:a,segments:s})=>[`# ${e||`YouTube ${r}`}`,"",`Video ID: ${r}`,o?`Author: ${o}`:"",`Source: [${t}](${t})`,a?`[![${e||r}](${a})](${t})`:"","",s.length>0?"## Transcript":"## Video Source","",...s.length>0?s.map(i=>`[${Hc(i.start)}](${jc(t,i.start)}) ${i.text}`):["Captions were not available from the source at import time.","The source URL, title, author, and thumbnail remain available for downstream storyboard reconstruction."],""].filter(i=>i!=="").join(`
`),"buildMarkdown"),Fr=n(({videoId:e,sourceUrl:t,title:r,authorName:o,thumbnailUrl:a,lang:s,languageCode:i,segments:c,captionStatus:l})=>{let p={type:"rag:YouTubeTranscript",video_id:e,source_url:t,title:r,author_name:o,thumbnail_url:a,language_code:re(i)||s,caption_status:l,segment_count:c.length,duration:c.reduce((m,f)=>Math.max(m,f.start+f.duration),0),segments:c};return{ok:!0,name:`youtube-${e.toLowerCase()}.md`,markdown:Gc({title:r,sourceUrl:t,videoId:e,authorName:o,thumbnailUrl:a,segments:c}),transcript:p}},"buildPayload");async function Bc({sourceUrl:e,lang:t="en",fetchImpl:r=fetch}){let o=Oc(e);if(!o)return{ok:!1,error:"unsupported_youtube_url"};let a=`https://www.youtube.com/watch?v=${encodeURIComponent(o)}`,[s,i]=await Promise.all([r(`https://www.youtube.com/oembed?url=${encodeURIComponent(a)}&format=json`,{headers:{accept:"application/json"}}).catch(()=>null),r(a,{headers:{accept:"text/html,application/xhtml+xml","accept-language":"en-US,en;q=0.9","user-agent":"Mozilla/5.0 Knowgrph YouTube transcript importer"}})]),c=s?.ok?await s.json().catch(()=>({})):{},l=i.ok?Mc(await i.text()):null,p=re(c.title)||re(l?.videoDetails?.title)||`YouTube ${o}`,m=re(c.author_name)||re(l?.videoDetails?.author),f=re(c.thumbnail_url)||`https://i.ytimg.com/vi/${o}/hqdefault.jpg`;if(!i.ok)return Fr({videoId:o,sourceUrl:a,title:p,authorName:m,thumbnailUrl:f,lang:t,languageCode:t,segments:[],captionStatus:`watch-fetch-${i.status}`});let A=l?.captions?.playerCaptionsTracklistRenderer?.captionTracks||[],S=Nc(Array.isArray(A)?A:[],t);if(!S?.baseUrl)return Fr({videoId:o,sourceUrl:a,title:p,authorName:m,thumbnailUrl:f,lang:t,languageCode:t,segments:[],captionStatus:"captions-unavailable"});let O=await r(Uc(S.baseUrl),{headers:{accept:"application/json,text/xml,text/plain,*/*","user-agent":"Mozilla/5.0 Knowgrph YouTube transcript importer"}}).catch(()=>null),$=O?await O.text().catch(()=>""):"",N=O?.ok?Dc($,O.headers.get("content-type")):[],W=N.length>0?"available":O?.ok?"captions-empty":`captions-fetch-${O?.status||"failed"}`;return Fr({videoId:o,sourceUrl:a,title:p,authorName:m,thumbnailUrl:f,lang:t,languageCode:S.languageCode,segments:N,captionStatus:W})}n(Bc,"buildYouTubeTranscriptPayload");async function _a(e){let t=e.request,r=String(t.method||"GET").toUpperCase();if(r==="OPTIONS")return new Response(null,{status:204,headers:Sa});if(r!=="GET"&&r!=="HEAD"&&r!=="POST")return Xt({ok:!1,error:"unsupported_method"},405,r);let o=new URL(t.url),a=re(o.searchParams.get("url")),s=re(o.searchParams.get("lang"))||"en";if(!a)return Xt({ok:!1,error:"missing_url"},400,r);try{let i=await Bc({sourceUrl:a,lang:s});return Xt(i,i.ok?200:502,r)}catch(i){let c=i&&typeof i=="object"&&"message"in i?re(i.message):"";return Xt({ok:!1,error:c||"youtube_conversion_failed"},502,r)}}n(_a,"onRequest");async function ba(e){let{request:t}=e,r=String(t.method||"GET").toUpperCase();if(r==="OPTIONS")return new Response(null,{status:204,headers:{...ce(t),"access-control-allow-methods":"GET, HEAD, OPTIONS","access-control-allow-headers":"*","access-control-max-age":"86400"}});if(r!=="GET"&&r!=="HEAD")return new Response(JSON.stringify({ok:!1,error:"unsupported_method"}),{status:405,headers:{"content-type":"application/json; charset=utf-8","cache-control":"no-store",...ce(t)}});let o={ok:!0,service:"singabldr-pages",ts:new Date().toISOString()},a={"content-type":"application/json; charset=utf-8","cache-control":"no-store",...ce(t)};return r==="HEAD"?new Response(null,{status:200,headers:a}):new Response(JSON.stringify(o),{status:200,headers:a})}n(ba,"onRequest");var Le="https://airvio.co";var ae="/knowgrph",Ue=`${Le}${ae}/`,Ra=`${Le}/`;var Pa=`${ae}/health`,Aa=`${Le}${Pa}`,ka="/.well-known/agent-card.json",um=`${ae}/.well-known/agent-card.json`,Wc=`${Le}${ka}`,Fc=`${Le}/api/storage/source-files`,zc=`${Le}/api/storage/doc-default/{canonicalPath}`,qc=`${Le}/api/storage/doc/{workspaceId}/{canonicalPath}`,Vc=`${Le}/api/storage/blob/{workspaceId}/{canonicalPath}`;var zr="root-agent-ready-pages",xa=['</.well-known/api-catalog>; rel="api-catalog"; type="application/linkset+json"',`<${ae}/.well-known/openapi.json>; rel="service-desc"; type="application/vnd.oai.openapi+json;version=3.1"`,`<${ae}/llms.txt>; rel="service-doc"; type="text/plain"`,'</auth.md>; rel="service-doc"; type="text/markdown"',`<${Pa}>; rel="status"; type="application/health+json"`,`<${ae}/.well-known/mcp/server-card.json>; rel="mcp-server-card"; type="application/json"`,`<${ka}>; rel="describedby"; type="application/json"`].join(", "),Ea=`# Knowgrph
...
- Auth.md registration instructions: ${Ra}auth.md
- Health: ${Aa}
...
- Live Canvas Hero discovery markdown: ${Ra}knowgrph-live-canvas-hero.md
...
- Default Source File documents: ${zc}
- Workspace Source File documents: ${qc}
- Workspace binary artifacts: ${Vc}
...
- The View initiates the MCP Apps \`ui/initialize\` handshake, sends \`ui/notifications/initialized\` and \`ui/notifications/size-changed\`, handles host context/tool input/result/cancel notifications, and calls the originating server through \`tools/call\`.
- \`inspect_agent_surface.structuredContent.mcpAppsServerReadiness\` exposes the native server-readiness model used by the View: app tool/resource binding, prompt discovery, resource-template discovery, output-schema and structured-content readiness, sandbox/security metadata, widget accessibility, Streamable HTTP JSON-RPC transport, local stdio transport, and read-only search/fetch retrieval.
`,Ca=n(e=>new Response(e,{status:200,headers:{"content-type":"text/markdown; charset=utf-8","cache-control":"public, max-age=3600","access-control-allow-origin":"*",vary:"Accept","x-markdown-tokens":String(Math.ceil(String(e||"").length/4))}}),"markdownResponse"),Ta=n(e=>(e.headers.get("accept")||"").toLowerCase().split(",").some(r=>r.trim().startsWith("text/markdown")),"wantsMarkdown"),qr=n((e,t)=>{let r=new Response(e.body,e),o=String(t?.owner||"").trim(),a=String(t?.tag||"").trim();return o&&r.headers.set("x-knowgrph-route-owner",o),a&&r.headers.set("x-knowgrph-route-tag",a),r},"withAgentReadyRouteHeaders");var Yr="Agent-actionable chat-to-canvas knowledge graph workspace",va='<main id="root"></main>',Yc=/<(?:main|div)\s+id=["']root["']\s*><\/(?:main|div)>/i,Jc=n(e=>{let t=/<script>([\s\S]*?)<\/script>/g;for(let r of String(e||"").matchAll(t)){let o=r[1]||"";if(o.includes("createWebMcpLifecycleController")&&o.includes("toolDefinitions"))return o}return""},"extractWebMcpScript"),Oa=n(()=>({"content-type":"text/html; charset=utf-8","cache-control":"no-store, no-cache, no-transform, must-revalidate, max-age=0","access-control-allow-origin":"*",link:xa}),"rootHtmlHeaders"),Xc=n(()=>`<noscript><a href="${ae}/">Enter Knowgrph</a></noscript>`,"rootNoscriptFallbackMarkup"),Vr=n((e,t)=>String(e||"").includes("</head>")?String(e||"").replace("</head>",`${t}</head>`):`${String(e||"")}${t}`,"injectIntoHead"),Qc=n(e=>{let t=String(e||"").replace(Yc,va);return/<meta\s+name=["']description["'][^>]*>/i.test(t)?t=t.replace(/<meta\s+name=["']description["'][^>]*>/i,`<meta name="description" content="${Yr}" />`):t=Vr(t,`    <meta name="description" content="${Yr}" />
...
`)),t},"rewriteRootAppHtml"),Zc=n(async e=>{let t=new URL(`${ae}/?agentReadyRootWebMcp=1`,e.url),r=await fetch(t,{headers:{accept:"text/html"}});return r.ok?Jc(await r.text()):""},"loadWebMcpScript"),el=n(async e=>{let t=new URL(`${ae}/?agentReadyRootAlias=1`,e.url),r=await fetch(t,{headers:{accept:"text/html"}});if(!r.ok)return null;let o=Qc(await r.text());return!o.includes(va)||!o.includes(`${ae}/assets/`)?null:new Response(o,{status:200,headers:Oa()})},"loadKnowgrphAppShell"),tl=n((e="")=>new Response(`<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
...
</html>`,{status:200,headers:Oa()}),"rootHtmlResponse");async function Ia(e){let{request:t}=e,r=String(t.method||"GET").toUpperCase();if(r!=="GET"&&r!=="HEAD")return e.next();if(Ta(t)){let s=qr(Ca(Ea),{owner:zr,tag:"root-homepage-markdown"});return r==="HEAD"?new Response(null,s):s}let o=r==="HEAD"?null:await el(t),a=qr(o||tl(r==="HEAD"?"":await Zc(t)),{owner:zr,tag:"root-homepage-html"});return r==="HEAD"?new Response(null,a):a}n(Ia,"onRequest");var _=[{routePath:"/api/llm/chat/completions",mountPath:"/api/llm/chat",method:"",middlewares:[],modules:[Zr]},{routePath:"/api/payments/commerce/x402",mountPath:"/api/payments/commerce",method:"",middlewares:[],modules:[Ro]},{routePath:"/api/llm/models",mountPath:"/api/llm",method:"",middlewares:[],modules:[Ao]},{routePath:"/api/llm/responses",mountPath:"/api/llm",method:"",middlewares:[],modules:[Po]},{routePath:"/knowgrph/doc-default/:path*",mountPath:"/knowgrph/doc-default",method:"",middlewares:[],modules:[zn]},{routePath:"/knowgrph/doc/:path*",mountPath:"/knowgrph/doc",method:"",middlewares:[],modules:[qn]},{routePath:"/knowgrph/share/:path*",mountPath:"/knowgrph/share",method:"",middlewares:[],modules:[Vn]},{routePath:"/api/link-preview",mountPath:"/api",method:"GET",middlewares:[],modules:[Jn]},{routePath:"/api/link-proxy",mountPath:"/api",method:"GET",middlewares:[],modules:[Qn]},{routePath:"/api/graph",mountPath:"/api",method:"",middlewares:[],modules:[ca]},{routePath:"/api/oembed",mountPath:"/api",method:"",middlewares:[],modules:[ua]},{routePath:"/__chat_proxy/:path*",mountPath:"/__chat_proxy",method:"",middlewares:[],modules:[ma]},{routePath:"/knowgrph/:path*",mountPath:"/knowgrph",method:"",middlewares:[],modules:[He]},{routePath:"/__video_frame",mountPath:"/",method:"",middlewares:[],modules:[wa]},{routePath:"/__youtube_transcript",mountPath:"/",method:"",middlewares:[],modules:[_a]},{routePath:"/health",mountPath:"/",method:"",middlewares:[],modules:[ba]},{routePath:"/",mountPath:"/",method:"",middlewares:[],modules:[Ia]}];function rl(e){for(var t=[],r=0;r<e.length;){var o=e[r];if(o==="*"||o==="+"||o==="?"){t.push({type:"MODIFIER",index:r,value:e[r++]});continue}if(o==="\\"){t.push({type:"ESCAPED_CHAR",index:r++,value:e[r++]});continue}if(o==="{"){t.push({type:"OPEN",index:r,value:e[r++]});continue}if(o==="}"){t.push({type:"CLOSE",index:r,value:e[r++]});continue}if(o===":"){for(var a="",s=r+1;s<e.length;){var i=e.charCodeAt(s);if(i>=48&&i<=57||i>=65&&i<=90||i>=97&&i<=122||i===95){a+=e[s++];continue}break}if(!a)throw new TypeError("Missing parameter name at ".concat(r));t.push({type:"NAME",index:r,value:a}),r=s;continue}if(o==="("){var c=1,l="",s=r+1;if(e[s]==="?")throw new TypeError('Pattern cannot start with "?" at '.concat(s));for(;s<e.length;){if(e[s]==="\\"){l+=e[s++]+e[s++];continue}if(e[s]===")"){if(c--,c===0){s++;break}}else if(e[s]==="("&&(c++,e[s+1]!=="?"))throw new TypeError("Capturing groups are not allowed at ".concat(s));l+=e[s++]}if(c)throw new TypeError("Unbalanced pattern at ".concat(r));if(!l)throw new TypeError("Missing pattern at ".concat(r));t.push({type:"PATTERN",index:r,value:l}),r=s;continue}t.push({type:"CHAR",index:r,value:e[r++]})}return t.push({type:"END",index:r,value:""}),t}n(rl,"lexer");function ol(e,t){t===void 0&&(t={});for(var r=rl(e),o=t.prefixes,a=o===void 0?"./":o,s=t.delimiter,i=s===void 0?"/#?":s,c=[],l=0,p=0,m="",f=n(function(U){if(p<r.length&&r[p].type===U)return r[p++].value},"tryConsume"),A=n(function(U){var L=f(U);if(L!==void 0)return L;var V=r[p],se=V.type,Se=V.index;throw new TypeError("Unexpected ".concat(se," at ").concat(Se,", expected ").concat(U))},"mustConsume"),S=n(function(){for(var U="",L;L=f("CHAR")||f("ESCAPED_CHAR");)U+=L;return U},"consumeText"),O=n(function(U){for(var L=0,V=i;L<V.length;L++){var se=V[L];if(U.indexOf(se)>-1)return!0}return!1},"isSafe"),$=n(function(U){var L=c[c.length-1],V=U||(L&&typeof L=="string"?L:"");if(L&&!V)throw new TypeError('Must have text between two parameters, missing text after "'.concat(L.name,'"'));return!V||O(V)?"[^".concat(je(i),"]+?"):"(?:(?!".concat(je(V),")[^").concat(je(i),"])+?")},"safePattern");p<r.length;){var N=f("CHAR"),W=f("NAME"),Q=f("PATTERN");if(W||Q){var z=N||"";a.indexOf(z)===-1&&(m+=z,z=""),m&&(c.push(m),m=""),c.push({name:W||l++,prefix:z,suffix:"",pattern:Q||$(z),modifier:f("MODIFIER")||""});continue}var x=N||f("ESCAPED_CHAR");if(x){m+=x;continue}m&&(c.push(m),m="");var T=f("OPEN");if(T){var z=S(),te=f("NAME")||"",G=f("PATTERN")||"",le=S();A("CLOSE"),c.push({name:te||(G?l++:""),pattern:te&&!G?$(z):G,prefix:z,suffix:le,modifier:f("MODIFIER")||""});continue}A("END")}return c}n(ol,"parse");function St(e,t){var r=[],o=Na(e,r,t);return nl(o,r,t)}n(St,"match");function nl(e,t,r){r===void 0&&(r={});var o=r.decode,a=o===void 0?function(s){return s}:o;return function(s){var i=e.exec(s);if(!i)return!1;for(var c=i[0],l=i.index,p=Object.create(null),m=n(function(A){if(i[A]===void 0)return"continue";var S=t[A-1];S.modifier==="*"||S.modifier==="+"?p[S.name]=i[A].split(S.prefix+S.suffix).map(function(O){return a(O,S)}):p[S.name]=a(i[A],S)},"_loop_1"),f=1;f<i.length;f++)m(f);return{path:c,index:l,params:p}}}n(nl,"regexpToFunction");function je(e){return e.replace(/([.+*?=^!:${}()[\]|/\\])/g,"\\$1")}n(je,"escapeString");function Ma(e){return e&&e.sensitive?"":"i"}n(Ma,"flags");function al(e,t){if(!t)return e;for(var r=/\((?:\?<(.*?)>)?(?!\?)/g,o=0,a=r.exec(e.source);a;)t.push({name:a[1]||o++,prefix:"",suffix:"",modifier:"",pattern:""}),a=r.exec(e.source);return e}n(al,"regexpToRegexp");function sl(e,t,r){var o=e.map(function(a){return Na(a,t,r).source});return new RegExp("(?:".concat(o.join("|"),")"),Ma(r))}n(sl,"arrayToRegexp");function il(e,t,r){return cl(ol(e,r),t,r)}n(il,"stringToRegexp");function cl(e,t,r){r===void 0&&(r={});for(var o=r.strict,a=o===void 0?!1:o,s=r.start,i=s===void 0?!0:s,c=r.end,l=c===void 0?!0:c,p=r.encode,m=p===void 0?function(L){return L}:p,f=r.delimiter,A=f===void 0?"/#?":f,S=r.endsWith,O=S===void 0?"":S,$="[".concat(je(O),"]|$"),N="[".concat(je(A),"]"),W=i?"^":"",Q=0,z=e;Q<z.length;Q++){var x=z[Q];if(typeof x=="string")W+=je(m(x));else{var T=je(m(x.prefix)),te=je(m(x.suffix));if(x.pattern)if(t&&t.push(x),T||te)if(x.modifier==="+"||x.modifier==="*"){var G=x.modifier==="*"?"?":"";W+="(?:".concat(T,"((?:").concat(x.pattern,")(?:").concat(te).concat(T,"(?:").concat(x.pattern,"))*)").concat(te,")").concat(G)}else W+="(?:".concat(T,"(").concat(x.pattern,")").concat(te,")").concat(x.modifier);else{if(x.modifier==="+"||x.modifier==="*")throw new TypeError('Can not repeat "'.concat(x.name,'" without a prefix and suffix'));W+="(".concat(x.pattern,")").concat(x.modifier)}else W+="(?:".concat(T).concat(te,")").concat(x.modifier)}}if(l)a||(W+="".concat(N,"?")),W+=r.endsWith?"(?=".concat($,")"):"$";else{var le=e[e.length-1],U=typeof le=="string"?N.indexOf(le[le.length-1])>-1:le===void 0;a||(W+="(?:".concat(N,"(?=").concat($,"))?")),U||(W+="(?=".concat(N,"|").concat($,")"))}return new RegExp(W,Ma(r))}n(cl,"tokensToRegexp");function Na(e,t,r){return e instanceof RegExp?al(e,t):Array.isArray(e)?sl(e,t,r):il(e,t,r)}n(Na,"pathToRegexp");var Qt=/[.+?^${}()|[\]\\]/g;function*ll(e){let t=new URL(e.url).pathname;for(let r of[..._].reverse()){if(r.method&&r.method!==e.method)continue;let o=St(r.routePath.replace(Qt,"\\$&"),{end:!1}),a=St(r.mountPath.replace(Qt,"\\$&"),{end:!1}),s=o(t),i=a(t);if(s&&i)for(let c of r.middlewares.flat())yield{handler:c,params:s.params,path:i.path}}for(let r of _){if(r.method&&r.method!==e.method)continue;let o=St(r.routePath.replace(Qt,"\\$&"),{end:!0}),a=St(r.mountPath.replace(Qt,"\\$&"),{end:!1}),s=o(t),i=a(t);if(s&&i&&r.modules.length){for(let c of r.modules.flat())yield{handler:c,params:s.params,path:s.path};break}}}n(ll,"executeRequest");var jm={async fetch(e,t,r){let o=e,a=ll(o),s={},i=!1,c=n(async(l,p)=>{if(l!==void 0){let f=l;typeof l=="string"&&(f=new URL(l,o.url).toString()),o=new Request(f,p)}let m=a.next();if(m.done===!1){let{handler:f,params:A,path:S}=m.value,O={request:new Request(o.clone()),functionPath:S,next:c,params:A,get data(){return s},set data(N){if(typeof N!="object"||N===null)throw new Error("context.data must be an object");s=N},env:t,waitUntil:r.waitUntil.bind(r),passThroughOnException:n(()=>{i=!0},"passThroughOnException")},$=await f(O);if(!($ instanceof Response))throw new Error("Your Pages function should return a Response");return Jr($)}else{let f=await t.ASSETS.fetch(o);return Jr(f)}},"next");try{return await c()}catch(l){if(i){let p=await t.ASSETS.fetch(o);return Jr(p)}throw l}}},Jr=n(e=>new Response([101,204,205,304].includes(e.status)?null:e.body,e),"cloneResponse");export{jm as default};
