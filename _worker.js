...
}`;var $e={push:"/api/storage/push",pull:"/api/storage/pull",exportPrefix:"/api/storage/export/",docPrefix:"/api/storage/doc/",defaultDocPrefix:"/api/storage/doc-default/",sourceFilesIndex:"/api/storage/source-files",sourceFilesIndexPrefix:"/api/storage/source-files/",sourceFilesLlms:"/api/storage/llms.txt"};var ln=r((e,t)=>`${$e.docPrefix}${encodeURIComponent(String(e||"").trim())}/${encodeURIComponent(String(t||"").trim())}`,"buildKnowgrphStorageDocPath"),pn=r(e=>`${$e.defaultDocPrefix}${encodeURIComponent(String(e||"").trim())}`,"buildKnowgrphStorageDefaultDocPath"),un=r(e=>{let t=String(e||"").trim();return t?`${$e.sourceFilesIndexPrefix}${encodeURIComponent(t)}`:$e.sourceFilesIndex},"buildKnowgrphStorageSourceFilesIndexPath");var T="https://airvio.co",Re="https://knowgrph-storage.huijoohwee.workers.dev",_="/knowgrph",P=`${T}${_}/`,dn=`${T}/`,Ae="kgws:canonical-docs",Se="2026-05-23",_e=`${_}/health`,ye=`${T}${_e}`,mn="/.well-known/agent-card.json",ct=`${_}/.well-known/agent-card.json`,je=`${T}${mn}`,lt=`${T}/api/storage/source-files`,Wo=`${T}/api/storage/doc-default/{canonicalPath}`,Go=`${T}/api/storage/doc/{workspaceId}/{canonicalPath}`,hn="knowgrph-agent-ready-pages";var gn=['</.well-known/api-catalog>; rel="api-catalog"; type="application/linkset+json"',`<${_}/.well-known/openapi.json>; rel="service-desc"; type="application/vnd.oai.openapi+json;version=3.1"`,`<${_}/llms.txt>; rel="service-doc"; type="text/plain"`,'</auth.md>; rel="service-doc"; type="text/markdown"',`<${_e}>; rel="status"; type="application/health+json"`,`<${_}/.well-known/mcp/server-card.json>; rel="mcp-server-card"; type="application/json"`,`<${mn}>; rel="describedby"; type="application/json"`].join(", "),fn=`# Knowgrph

Knowgrph is an Agent-actionable chat-to-canvas knowledge graph workspace served at ${P}.
...
- Auth.md registration instructions: ${dn}auth.md
- Health: ${ye}
...
- Default Source File documents: ${Wo}
- Workspace Source File documents: ${Go}
...
`,wn=r(e=>new Response(e,{status:200,headers:{"content-type":"text/markdown; charset=utf-8","cache-control":"public, max-age=3600","access-control-allow-origin":"*",vary:"Accept","x-markdown-tokens":String(Math.ceil(String(e||"").length/4))}}),"markdownResponse"),be=r(e=>(e.headers.get("accept")||"").toLowerCase().split(",").some(n=>n.trim().startsWith("text/markdown")),"wantsMarkdown"),yn=r((e,t)=>{let n=new Response(e.body,e),o=String(t?.owner||"").trim(),a=String(t?.tag||"").trim();return o&&n.headers.set("x-knowgrph-route-owner",o),a&&n.headers.set("x-knowgrph-route-tag",a),n},"withAgentReadyRouteHeaders");var Ke=Yt({defaultWorkspaceId:Ae}),Pn=r((e,t="")=>{let n=String(e||"").trim(),o=String(t||"").trim();return o?ln(o,n):pn(n)},"buildStorageDocPath"),kn=r(e=>String(e||"").trim(),"normalizeToolString");var j=r((e,t="application/json; charset=utf-8")=>new Response(JSON.stringify(e,null,2),{status:200,headers:{"content-type":t,"cache-control":"public, max-age=3600","access-control-allow-origin":"*"}}),"jsonResponse"),xn=r((e,t)=>new Response(JSON.stringify(t,null,2),{status:e,headers:{"content-type":"application/json; charset=utf-8","cache-control":"no-store","access-control-allow-origin":"*"}}),"jsonStatusResponse"),Ee=r((e,t)=>new Response(e,{status:200,headers:{"content-type":t,"cache-control":"public, max-age=3600","access-control-allow-origin":"*"}}),"textResponse"),Fo=r(e=>new Response(JSON.stringify(e,null,2),{status:200,headers:{"content-type":"application/health+json; charset=utf-8","cache-control":"no-store","access-control-allow-origin":"*"}}),"healthResponse"),qo=r(e=>`User-agent: *
Allow: /knowgrph/
...
Sitemap: ${e}
`,"buildRobotsTxt"),zo=r(e=>`<?xml version="1.0" encoding="UTF-8"?>
...
`,"buildSitemapXml"),Yo=qo(`${P}sitemap.xml`),Jo=zo(P),Rn={linkset:[{anchor:P,"service-desc":[{href:`${P}.well-known/openapi.json`,type:"application/vnd.oai.openapi+json;version=3.1"}],"service-doc":[{href:`${P}llms.txt`,type:"text/plain"}],status:[{href:ye,type:"application/health+json"}],"service-meta":[{href:`${P}.well-known/mcp/server-card.json`,type:"application/json"},{href:je,type:"application/json"}]}]},An={openapi:"3.1.0",info:{title:"Knowgrph API",version:"0.1.0",description:"Agent discovery surface for the Knowgrph Cloudflare deployment."},servers:[{url:T,description:"Knowgrph Cloudflare deployment"}],paths:en({appBasePath:_,appA2aAgentCardPath:ct,healthPath:_e})},Te={resource:P,resource_name:"Knowgrph",authorization_servers:[T],scopes_supported:["knowgrph:read","knowgrph:source-files:read"],bearer_methods_supported:["header"],resource_documentation:`${P}llms.txt`},pt=`${T}/cdn-cgi/access`,J={skill:`${T}/auth.md`,register_uri:`${P}agent/auth`,claim_uri:`${P}agent/auth/claim`,revocation_uri:`${P}agent/auth/revoke`,identity_types_supported:["anonymous","identity_assertion"],anonymous:{credential_types_supported:["api_key"]},identity_assertion:{assertion_types_supported:["urn:ietf:params:oauth:token-type:id-jag","verified_email"],credential_types_supported:["access_token","api_key"]},events_supported:["https://schemas.workos.com/events/agent/auth/identity/assertion/revoked"],registration_status:"metadata_published_runtime_user_mediated"},Sn={issuer:T,resource:Te.resource,resource_name:Te.resource_name,authorization_servers:Te.authorization_servers,cloudflare_access_issuer:pt,authorization_endpoint:`${pt}/login`,token_endpoint:`${pt}/token`,jwks_uri:`${P}.well-known/http-message-signatures-directory`,response_types_supported:["code"],grant_types_supported:["authorization_code","client_credentials"],token_endpoint_auth_methods_supported:["client_secret_basic","private_key_jwt"],scopes_supported:Te.scopes_supported,agent_auth:J},Vo=`# Knowgrph auth.md
...
- Pipeline rule: agents must not bypass MainPanel -> FloatingPanel Chat -> KGC -> Canvas for user-mediated graph work; published HTTP MCP tools remain read-only until mutation auth and conflict semantics are implemented.`,bn={name:"Knowgrph Agent",description:"Agent-readable discovery, published-document retrieval, and WebMCP-ready metadata surface for Knowgrph.",version:"0.1.0",provider:{organization:"airvio / joohwee",url:P},url:`${P}mcp`,preferredTransport:"JSONRPC",supportedInterfaces:[{url:`${P}mcp`,protocolBinding:"JSONRPC",transportProtocol:"JSONRPC",description:"Primary machine interface for read-only discovery and source-file document access."},{url:lt,protocolBinding:"HTTP+JSON/REST",transportProtocol:"HTTP+JSON/REST",description:"Published source-files index and storage-backed document read surface."}],capabilities:{streaming:!1,pushNotifications:!1,stateTransitionHistory:!1,extendedAgentCard:!1},defaultInputModes:["text/plain","text/markdown","application/json"],defaultOutputModes:["text/plain","text/markdown","application/json"],skills:Zt(Ke)},Q={serverInfo:{name:"knowgrph",version:"0.1.0"},transport:{type:"http",url:`${P}mcp`},capabilities:{tools:Ke.map(e=>({name:e.name,description:e.description,inputSchema:e.inputSchema}))},links:{apiCatalog:`${P}.well-known/api-catalog`,skills:`${P}.well-known/agent-skills/index.json`,status:ye,agentCard:je}},mt=Ke.map(e=>({name:e.webName,title:e.title,description:e.description,inputSchema:e.inputSchema,annotations:e.annotations})),Ce=r(e=>kn(Ke.find(t=>t.name===e)?.webName),"findWebMcpToolName"),Xo=Ce(u.listSourceFiles),Zo=Ce(u.readSourceFile),Qo=Ce(u.readSharedDocument),er=Ce(u.inspectSharedDocumentStructure),tr=Ce(u.inspectAgentSurface),nr=`(() => {
  ...
  const createPublishedDocIdentityResolver = ${cn};
  ...
  const toolExecutors = createPublishedAgentReadyToolExecutors({
    toolNames: {
      listSourceFiles: ${JSON.stringify(Xo)},
      readSourceFile: ${JSON.stringify(Zo)},
      readSharedDocument: ${JSON.stringify(Qo)},
      inspectSharedDocumentStructure: ${JSON.stringify(er)},
      inspectAgentSurface: ${JSON.stringify(tr)},
    },
    defaultWorkspaceId,
...
})();`,or=r(async e=>{if(!(e.headers.get("content-type")||"").toLowerCase().includes("text/html"))return e;let n=await e.text();if(mt.every(i=>n.includes(i.name)))return new Response(n,e);let o=`<script>${nr}<\/script>`,a=n.includes("</head>")?n.replace("</head>",`${o}</head>`):`${n}${o}`,s=new Response(a,e);return s.headers.delete("content-length"),s},"injectWebMcpScript"),En=`# Knowgrph Published Documents Skill
...
`,Tn=`# Knowgrph WebMCP Readiness Skill
...
`,rr={listSourceFiles:u.listSourceFiles,readSourceFile:u.readSourceFile,readSharedDocument:u.readSharedDocument,inspectSharedDocumentStructure:u.inspectSharedDocumentStructure,inspectAgentSurface:u.inspectAgentSurface},Cn=r(async e=>{let t=new TextEncoder().encode(e),n=await crypto.subtle.digest("SHA-256",t);return[...new Uint8Array(n)].map(o=>o.toString(16).padStart(2,"0")).join("")},"sha256Hex"),ar=Cn(En),sr=Cn(Tn),ir={[we[0].name]:ar,[we[1].name]:sr},In=r(async()=>Qt({appUrl:P,updatedAt:Se,sha256ByName:ir}),"agentSkillsIndex"),cr={keys:[{kty:"OKP",crv:"Ed25519",kid:"knowgrph-agent-ready-2026-05-21",use:"sig",alg:"EdDSA",x:"11qYAYdkVKxA4G0wV47IxPtYfFVH_H7zmC2Di2PcvLU"}]},lr={protocolVersion:"2025-06-18",capabilities:{tools:{}},serverInfo:Q.serverInfo},pr=Q.capabilities.tools.map(e=>({name:e.name,description:e.description,inputSchema:e.inputSchema})),vn=r(()=>({status:"pass",service:"knowgrph-agent-ready-pages",homepage:P,health:ye,updatedAt:Se,checks:{linkHeaders:!0,markdownNegotiation:!0,httpMcp:!0,webMcp:!0,commerce:{acp:!0,ucp:!0,mpp:!0,x402:!0},defaultWorkspaceId:Ae}}),"buildHealthStatusBody"),ur=r(async()=>Jt({baseUrl:P,health:vn(),apiCatalog:Rn,openApi:An,mcpServerCard:Q,agentCard:bn,agentSkills:await In(),commerce:ot({origin:T})}),"buildAgentSurfaceInspection"),dr=Vt({toolNames:rr,defaultWorkspaceId:Ae,buildStorageDocPath:Pn,fetchSourceFilesIndexResponse:r(()=>fetch(`${Re}${un()}`,{headers:{accept:"text/markdown"}}),"fetchSourceFilesIndexResponse"),fetchStorageMarkdownResponse:r(e=>fetch(`${Re}${e}`,{headers:{accept:"text/markdown"}}),"fetchStorageMarkdownResponse"),resolveSharedDocumentInput:r((e={})=>Le({shareToken:e?.shareToken,shareUrl:e?.shareUrl,appBasePath:_,baseUrl:T}),"resolveSharedDocumentInput"),inspectSharedDocumentStructure:Xt,buildAgentSurfaceInspection:ur}),On=r(e=>{try{let t=new URL(e,T);return Le({shareUrl:`${t.pathname}${t.search}`,baseUrl:T,appBasePath:_})}catch{return null}},"resolvePublishedDocRequestIdentity"),mr=r(e=>Le({shareUrl:String(e||""),baseUrl:T,appBasePath:_}),"resolvePublishedDocPathIdentity"),hr=r(async(e,t)=>{let n=new URL(Pn(t.canonicalPath,t.workspaceId),Re),o=await fetch(n,{method:"GET",headers:{accept:"text/markdown, text/plain;q=0.9, */*;q=0.1"}}),a=new Headers(o.headers),s=String(a.get("vary")||"");return a.set("vary",s?`${s}, Accept`:"Accept"),new Response(String(e.method||"").toUpperCase()==="HEAD"?null:o.body,{status:o.status,statusText:o.statusText,headers:a})},"proxyPublishedDocMarkdownResponse"),gr=r(async e=>{try{let t=await e.json();return t&&typeof t=="object"?t:null}catch{return null}},"readJsonRpcRequest"),He=r((e,t)=>j({jsonrpc:"2.0",id:e??null,result:t}),"jsonRpcResult"),ut=r((e,t,n)=>j({jsonrpc:"2.0",id:e??null,error:{code:t,message:n}}),"jsonRpcError"),fr=r(async(e,t)=>{let n=dr[e];if(typeof n!="function")throw new Error(`unknown tool: ${e}`);return n(t)},"executeMcpTool"),wr=r(async e=>{let t=String(e.method||"GET").toUpperCase();if(t==="GET"||t==="HEAD")return j({ok:!0,transport:Q.transport,serverInfo:Q.serverInfo,capabilities:Q.capabilities});if(t!=="POST")return xn(405,{ok:!1,error:"unsupported_method"});let n=await gr(e);if(!n)return ut(null,-32700,"Parse error");switch(n.method){case"initialize":return He(n.id,lr);case"tools/list":return He(n.id,{tools:pr});case"tools/call":{let o=kn(n.params?.name),a=n.params?.arguments&&typeof n.params.arguments=="object"?n.params.arguments:{};if(!o)return ut(n.id,-32602,"Tool name is required");try{let s=await fr(o,a);return He(n.id,{content:[{type:"text",text:typeof s?.markdown=="string"?s.markdown:JSON.stringify(s,null,2)}],structuredContent:s,isError:!1})}catch(s){return He(n.id,{content:[{type:"text",text:s instanceof Error?s.message:String(s)}],isError:!0})}}default:return ut(n.id,-32601,"Method not found")}},"handleMcpTransport");var ht=r(e=>e===_||e===`${_}/`,"handlesKnowgrphRoot"),yr=r(e=>ht(e)||!!mr(e),"handlesKnowgrphHtmlSurface"),Sr=r(e=>{let t=new URL(e.url),n=t.pathname.replace(/\/+$/,"")||"/",o=On(e.url);return n===_e?"health":n===`${_}/mcp`?"mcp":n===`${_}/robots.txt`?"robots":n===`${_}/sitemap.xml`?"sitemap":n===`${_}/auth.md`||n==="/auth.md"?"auth-md":n.startsWith(`${_}/.well-known/`)?"well-known":o?be(e)?"shared-doc-markdown":"shared-doc-html":ht(t.pathname)?be(e)?"homepage-markdown":"homepage-html":"app-surface"},"resolveAgentReadyRouteTag"),dt=r((e,t)=>yn(t,{owner:hn,tag:Sr(e)}),"withKnowgrphRouteHeaders"),_n=r(async e=>{let t=new URL(e.url),n=t.pathname.replace(/\/+$/,"")||"/",o=On(e.url);if(o&&be(e))return hr(e,o);if(ht(t.pathname)&&be(e))return wn(fn);switch(n){case _e:return Fo(vn());case`${_}/mcp`:return wr(e);case`${_}/robots.txt`:return Ee(Yo,"text/plain; charset=utf-8");case`${_}/sitemap.xml`:return Ee(Jo,"application/xml; charset=utf-8");case`${_}/auth.md`:case"/auth.md":return Ee(Vo,"text/markdown; charset=utf-8");case`${_}/.well-known/api-catalog`:return j(Rn,"application/linkset+json; charset=utf-8");case`${_}/.well-known/openapi.json`:return j(An,"application/vnd.oai.openapi+json; charset=utf-8");case ct:return j(bn);case`${_}/.well-known/oauth-protected-resource`:return j(Te);case`${_}/.well-known/oauth-authorization-server`:return j(Sn);case`${_}/.well-known/openid-configuration`:return j(Sn);case`${_}/.well-known/mcp/server-card.json`:return j(Q);case`${_}/.well-known/mcp.json`:return j(Q);case`${_}/.well-known/agent-skills/index.json`:return j(await In());case`${_}/.well-known/agent-skills/knowgrph-source-files.md`:return Ee(En,"text/markdown; charset=utf-8");case`${_}/.well-known/agent-skills/knowgrph-webmcp-readiness.md`:return Ee(Tn,"text/markdown; charset=utf-8");case`${_}/.well-known/http-message-signatures-directory`:return j(cr);default:return null}},"routeResponse");async function ee(e){let{env:t,request:n}=e,o=String(n.method||"GET").toUpperCase(),a=new URL(n.url);if(o==="OPTIONS")return new Response(null,{status:204,headers:{"access-control-allow-origin":"*","access-control-allow-methods":"GET, HEAD, OPTIONS","access-control-allow-headers":"*","access-control-max-age":"86400"}});if(o==="POST"&&a.pathname.replace(/\/+$/,"")===`${_}/mcp`)return dt(n,await _n(n));if(o!=="GET"&&o!=="HEAD")return xn(405,{ok:!1,error:"unsupported_method"});let s=await _n(n);if(s){let p=dt(n,s);return o==="HEAD"?new Response(null,p):p}let i=await e.next();if(!yr(a.pathname))return i;let c=o==="HEAD"?i:await or(i),l=new Response(o==="HEAD"?null:c.body,c);return l.headers.set("link",gn),dt(n,l)}r(ee,"onRequest");async function Un(e){return ee(e)}r(Un,"onRequest");async function Dn(e){return ee(e)}r(Dn,"onRequest");async function Nn(e){return ee(e)}r(Nn,"onRequest");var _r=Object.freeze(new Set(["","80","443"])),Pr=Object.freeze([".local",".localhost",".internal"]),kr=Object.freeze(new Set(["localhost"]));function ae(e){return String(e||"").trim().toLowerCase()}r(ae,"normalizeHostname");function xr(e){let t=ae(e);if(!/^\d{1,3}(\.\d{1,3}){3}$/.test(t))return!1;let n=t.split(".").map(o=>Number(o));return n.length!==4?!1:n.every(o=>Number.isInteger(o)&&o>=0&&o<=255)}r(xr,"isIpv4Literal");function Mn(e){let[t,n,o,a]=e.split(".").map(s=>Number(s));return(t<<24|n<<16|o<<8|a)>>>0}r(Mn,"ipv4ToInt");function Rr(e,t,n){if(!Number.isInteger(n)||n<0||n>32)return!1;if(n===0)return!0;let o=4294967295<<32-n>>>0;return(e&o)===(t&o)}r(Rr,"inIpv4Cidr");function Ar(e){let t=ae(e);return!t||!t.includes(":")?!1:/^[0-9a-f:]+$/i.test(t)}r(Ar,"isIpv6Literal");function br(e){let t=ae(e);return!!(!t||t==="::1"||t==="0:0:0:0:0:0:0:1"||t.startsWith("fc")||t.startsWith("fd")||/^fe[89ab]/i.test(t))}r(br,"isBlockedIpv6");function Er(e,{blockedExact:t,blockedSuffixes:n}={}){let o=ae(e);if(!o)return!0;let a=t||kr;if(a instanceof Set&&a.has(o))return!0;let s=n||Pr;if(Array.isArray(s))for(let i of s){let c=ae(i);if(c&&(o===c||o.endsWith(c)))return!0}return!1}r(Er,"isBlockedHostname");function Tr(e){let t=ae(e);if(!t)return!0;if(xr(t)){let n=Mn(t),o=[{base:"0.0.0.0",bits:8},{base:"10.0.0.0",bits:8},{base:"127.0.0.0",bits:8},{base:"169.254.0.0",bits:16},{base:"172.16.0.0",bits:12},{base:"192.168.0.0",bits:16},{base:"100.64.0.0",bits:10}];for(let a of o){let s=Mn(a.base);if(Rr(n,s,a.bits))return!0}return!1}return Ar(t)?br(t):!1}r(Tr,"isBlockedIpLiteral");function Be(e,{allowedPorts:t}={}){let n=String(e||"").trim();if(!n)throw new Error("invalid_url");let o;try{o=new URL(n)}catch{throw new Error("invalid_url")}if(o.protocol!=="http:"&&o.protocol!=="https:")throw new Error("invalid_url");if(o.username||o.password)throw new Error("invalid_url");let a=t||_r,s=String(o.port||"");if(a instanceof Set&&!a.has(s))throw new Error("port_not_allowed");let i=ae(o.hostname);if(!i)throw new Error("invalid_url");if(Er(i))throw new Error("blocked_host");if(Tr(i))throw new Error("blocked_host");return o}r(Be,"parseAndValidateExternalUrl");function We(e){return String(e.headers.get("sec-fetch-site")||"").trim().toLowerCase()==="cross-site"}r(We,"shouldRejectCrossSiteFetch");var Cr={"content-type":"application/json; charset=utf-8","cache-control":"public, max-age=600"};function se(e,t={}){return new Response(JSON.stringify(e),{...t,headers:{...Cr,...t.headers||{}}})}r(se,"json");function Ge(...e){for(let t of e){if(!t)continue;let n=String(t).trim();if(n)return n}return null}r(Ge,"pickFirst");function Ir(e){let t=e.slice(0,8e4),n=t.match(/<title[^>]*>([^<]*)<\/title>/i),o=t.match(/<meta[^>]+property=["']og:title["'][^>]*content=["']([^"']+)["'][^>]*>/i),a=t.match(/<meta[^>]+property=["']og:description["'][^>]*content=["']([^"']+)["'][^>]*>/i),s=t.match(/<meta[^>]+name=["']description["'][^>]*content=["']([^"']+)["'][^>]*>/i),i=t.match(/<meta[^>]+property=["']og:image["'][^>]*content=["']([^"']+)["'][^>]*>/i),c=t.match(/<meta[^>]+property=["']og:site_name["'][^>]*content=["']([^"']+)["'][^>]*>/i);return{title:Ge(o?.[1],n?.[1]),description:Ge(a?.[1],s?.[1]),image:Ge(i?.[1]),siteName:Ge(c?.[1])}}r(Ir,"extractMeta");async function Ln(e){let t=e.request.url,n=new URL(t);if(n.searchParams.get("ping")==="1")return se({ok:!0,ping:!0});let o=n.searchParams.get("url")||"";if(We(e.request))return se({ok:!1,error:"forbidden"},{status:403,headers:{"cache-control":"no-store"}});let a;try{a=Be(o)}catch{return se({ok:!1,error:"invalid_url"},{status:400,headers:{"cache-control":"no-store"}})}try{let s=await fetch(a.toString(),{headers:{"user-agent":"Mozilla/5.0 (compatible; HackaMapLinkPreview/1.0)",accept:"text/html,application/xhtml+xml"},redirect:"follow",cf:{cacheTtl:600,cacheEverything:!0}}),i=s.headers.get("content-type")||"";if(!s.ok)return se({ok:!1,error:"fetch_failed",status:s.status,url:a.toString()},{status:200,headers:{"cache-control":"no-store"}});if(!i.includes("text/html"))return se({ok:!0,url:a.toString(),domain:a.host,contentType:i,title:null,description:null,image:null,siteName:null});let c=await s.text(),l=Ir(c);return se({ok:!0,url:a.toString(),domain:a.host,contentType:i,...l})}catch(s){return se({ok:!1,error:"exception",message:s?.message||String(s),url:a.toString()},{status:200,headers:{"cache-control":"no-store"}})}}r(Ln,"onRequestGet");var $n=35e4;function vr(e){let t=e;return t=t.replace(/<script\b[\s\S]*?<\/script>/gi,""),t=t.replace(/<iframe\b[\s\S]*?<\/iframe>/gi,""),t=t.replace(/<object\b[\s\S]*?<\/object>/gi,""),t=t.replace(/<embed\b[\s\S]*?>/gi,""),t=t.replace(/<noscript\b[\s\S]*?<\/noscript>/gi,""),t=t.replace(/\son[a-z]+\s*=\s*"[^"]*"/gi,""),t=t.replace(/\son[a-z]+\s*=\s*'[^']*'/gi,""),t}r(vr,"stripActiveContent");function Or({url:e,title:t,innerHtml:n}){let o=t?String(t).slice(0,140):"Preview",a=String(e).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;");return`<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
...
</html>`}r(Or,"buildWrapper");async function jn(e){let n=new URL(e.request.url).searchParams.get("url")||"";if(We(e.request))return new Response("Forbidden",{status:403,headers:{"cache-control":"no-store"}});let o;try{o=Be(n)}catch(a){let s=a instanceof Error?a.message:"invalid_url";return new Response(s,{status:400,headers:{"cache-control":"no-store"}})}try{let a=await fetch(o.toString(),{headers:{"user-agent":"Mozilla/5.0 (compatible; HackaMapLinkProxy/1.0)",accept:"text/html,application/xhtml+xml"},redirect:"follow",cf:{cacheTtl:600,cacheEverything:!0}}),s=a.headers.get("content-type")||"";if(!a.ok)return new Response(`Fetch failed (${a.status})`,{status:200,headers:{"content-type":"text/plain; charset=utf-8","cache-control":"no-store"}});if(!s.includes("text/html"))return new Response(`Unsupported content-type: ${s}`,{status:200,headers:{"content-type":"text/plain; charset=utf-8","cache-control":"public, max-age=600"}});let i=await a.text();i.length>$n&&(i=i.slice(0,$n));let l=i.match(/<title[^>]*>([^<]*)<\/title>/i)?.[1]?.trim()||o.host;i=vr(i),/<base\s/i.test(i)||(i=i.replace(/<head([^>]*)>/i,`<head$1><base href="${o.origin}/">`));let f=Or({url:o.toString(),title:l,innerHtml:i});return new Response(f,{status:200,headers:{"content-type":"text/html; charset=utf-8","cache-control":"public, max-age=600","content-security-policy":"default-src 'none'; img-src https: data:; style-src 'unsafe-inline' https:; font-src https: data:; frame-ancestors 'self';"}})}catch(a){return new Response(`Exception: ${a?.message||String(a)}`,{status:200,headers:{"content-type":"text/plain; charset=utf-8","cache-control":"no-store"}})}}r(jn,"onRequestGet");var gt="api.openai.com",Fe="api.miromind.ai",qe="apihub.agnes-ai.com",ze="ark.ap-southeast.bytepluses.com",ft="ark.eu-west.bytepluses.com",Kn=new Set(["localhost","127.0.0.1","0.0.0.0"]),z=r(e=>String(e||"").trim().toLowerCase(),"normalizeHost"),q=r((e,t)=>String(e.get(t)||"").trim(),"readHeader"),Bn=r(e=>Kn.has(z(e)),"isLocalHost"),Hn=r(e=>{let t=String(e||"").trim();if(!t)return new Set;let n=new Set;return t.split(",").map(o=>z(o)).filter(Boolean).forEach(o=>n.add(o)),n},"parseCsvSet"),Wn=r((e,{includeOpenAi:t=!1,includeMiroMind:n=!1,includeAgnes:o=!1,includeBytePlus:a=!1}={})=>{let s=Hn(e.KNOWGRPH_INTEGRATION_ALLOWED_HOSTS),i=Hn(e.KNOWGRPH_CHAT_PROXY_ALLOWED_HOSTS),c=s.size?s:i,l=c.size?c:new Set([...Kn]);return t&&l.add(gt),n&&l.add(Fe),o&&l.add(qe),a&&(l.add(ze),l.add(ft)),l},"parseAllowedHosts"),M=r(e=>{let t=q(e.headers,"origin");if(!t)return{};let n="";try{n=z(new URL(t).host)}catch{return{}}let o=z(new URL(e.url).host);return n===o||n.startsWith("localhost:")||n.startsWith("127.0.0.1:")?{"access-control-allow-origin":t,vary:"Origin"}:{}},"corsHeaders"),B=r((e,t,n)=>new Response(JSON.stringify(t),{status:n,headers:{"content-type":"application/json; charset=utf-8","cache-control":"no-store",...M(e)}}),"jsonResponse");var Ye={"content-type":"application/json; charset=utf-8","cache-control":"no-store"};function Ie(e,t,n=200){return new Response(JSON.stringify(t),{status:n,headers:{...Ye,...M(e)}})}r(Ie,"jsonResponse");async function Ur(e){let t=new URL("/knowgrph/imports/hackamap/hackamap-graph.json",e.url),n=await fetch(t.toString(),{redirect:"follow"});return n.ok?await n.json():null}r(Ur,"fetchHackamapGraphJson");async function ie(e,t){let n=new URL(t,e.url),o=await fetch(n.toString(),{redirect:"follow"});return o.ok?await o.json():null}r(ie,"fetchHackamapJson");async function Dr(e){let t=await ie(e,"/knowgrph/imports/hackamap/hackamap_api_graph.json");return zn(t)?t:null}r(Dr,"fetchHackamapApiGraphJson");async function Nr(e){let t=await ie(e,"/knowgrph/imports/hackamap/hackamap_pipeline.json");return t&&typeof t=="object"&&!Array.isArray(t)?t:{}}r(Nr,"fetchHackamapPipelineJson");async function Fn(e){let t=await ie(e,"/knowgrph/imports/hackamap/hackamap_query_presets.json");return Array.isArray(t)?t.filter(Boolean):[]}r(Fn,"fetchHackamapQueryPresetsJson");async function qn(e){let t=await ie(e,"/knowgrph/imports/hackamap/query-outputs/query-runs.manifest.json");return t&&typeof t=="object"&&!Array.isArray(t)?t:{}}r(qn,"fetchHackamapQueryRunsManifestJson");function zn(e){return!e||typeof e!="object"||Array.isArray(e)?!1:Array.isArray(e.nodes)&&Array.isArray(e.edges)}r(zn,"isApiGraphPayload");function Yn(e,t){let n=String(e&&e.output&&e.output.per_table_prefix||e?.id||t?.preset||"").trim(),o=String(t?.output_suffix||"").trim();return o?`${n}-${o}`:n}r(Yn,"buildHackamapTablePrefix");function wt(e,t){if(!Array.isArray(e))return[];let n=[];for(let o of e){if(!o||typeof o!="object"||Array.isArray(o))continue;let a=String(o[t]||"").trim();a&&n.push(a)}return n}r(wt,"collectRowIds");async function Mr(e,t){let n=await ie(e,t);return Array.isArray(n)?n.length:0}r(Mr,"countHackamapQueryRows");async function Lr(e,t,n){let o=Yn(t,n);if(!o)return{};let a=["events","demos","sources","organizer","team","techstack"],s=await Promise.all(a.map(async i=>[i,await Mr(e,`/knowgrph/imports/hackamap/query-outputs/${i}.${o}.query.json`)]));return Object.fromEntries(s.filter(([,i])=>i>0))}r(Lr,"readHackamapRunTableCounts");function yt(e){return Array.isArray(e)?e.map(yt):!e||typeof e!="object"?e:Object.fromEntries(Object.entries(e).sort(([t],[n])=>String(t).localeCompare(String(n))).map(([t,n])=>[t,yt(n)]))}r(yt,"sortObjectKeys");function $r(e){try{return JSON.stringify(yt(e))}catch{return""}}r($r,"stableParamSignature");function jr(e){return typeof e=="string"?{value:e,label:e}:{value:e,label:JSON.stringify(e)}}r(jr,"toBuilderOption");function Hr(e,t){return e.map(n=>{let o=String(n?.id||"").trim();if(!o)return null;let a=n?.params&&typeof n.params=="object"&&!Array.isArray(n.params)?n.params:{},s=t.filter(l=>String(l?.preset||"").trim()===o),i=Array.from(new Set([...Object.keys(a),...s.flatMap(l=>l?.params&&typeof l.params=="object"&&!Array.isArray(l.params)?Object.keys(l.params):[])])).sort((l,p)=>String(l).localeCompare(String(p))),c=Object.fromEntries(i.map(l=>{let p=new Set,f=[],d=[a[l],...s.map(k=>k?.params&&typeof k.params=="object"&&!Array.isArray(k.params)?k.params[l]:void 0)];for(let k of d){if(typeof k>"u")continue;let g=$r(k);!g||p.has(g)||(p.add(g),f.push(jr(k)))}return[l,f]}));return{id:o,title:String(n?.title||o).trim(),params:a,param_keys:i,published_param_options:c}}).filter(Boolean)}r(Hr,"buildHackamapPresetRuntimeEntries");async function Kr(e){let[t,n,o]=await Promise.all([Nr(e),Fn(e),qn(e)]),a=t&&typeof t=="object"?t.runtime||{}:{},s=String(a?.query_selection?.default_run_id||"").trim()||"enhanced",i=Array.isArray(o?.runs)?o.runs:[],c=(await Promise.all(i.map(async l=>{let p=String(l?.id||"").trim(),f=String(l?.preset||"").trim();if(!p)return null;let d=n.find(g=>String(g?.id||"").trim()===f),k=await Lr(e,d,l);return{id:p,preset:f,title:String(l?.title||l?.id||"").trim(),params:l?.params&&typeof l.params=="object"&&!Array.isArray(l.params)?l.params:{},output_suffix:String(l?.output_suffix||"").trim(),is_default:p===s,table_counts:k}}))).filter(l=>l?.id);return{ok:!0,runtime:{...a&&typeof a=="object"?a:{},presets:Hr(n,c),runs:c}}}r(Kr,"buildHackamapRuntimeMeta");async function Br(e,t){let n=String(t||"").trim();if(!n)return null;let[o,a]=await Promise.all([Fn(e),qn(e)]),i=(Array.isArray(a?.runs)?a.runs:[]).find(R=>String(R?.id||"").trim()===n);if(!i)return null;let c=o.find(R=>String(R?.id||"").trim()===String(i?.preset||"").trim()),l=Yn(c,i);if(!l)return null;let[p,f]=await Promise.all([ie(e,`/knowgrph/imports/hackamap/query-outputs/events.${l}.query.json`),ie(e,`/knowgrph/imports/hackamap/query-outputs/demos.${l}.query.json`)]),d=new Set(wt(p,"id")),k=new Set(wt(f,"id")),g=wt(f,"event_id");for(let R of g)d.add(R);return{eventIds:d,demoIds:k}}r(Br,"readHackamapQueryRunSelection");function Gn(e,t,n){if(!n||!zn(e))return e;if(n.eventIds.size===0&&n.demoIds.size===0)return{...e,meta:{...e?.meta&&typeof e.meta=="object"?e.meta:{},selected_run_id:t,selected_run_filter_skipped:"no-event-demo-rows"}};let o=new Set;n.eventIds.forEach(c=>o.add(`Event:${c}`)),n.demoIds.forEach(c=>o.add(`Demo:${c}`));let a=Array.isArray(e.nodes)?e.nodes.filter(c=>o.has(String(c?.id||"").trim())):[],s=new Set(a.map(c=>String(c?.id||"").trim()).filter(Boolean)),i=Array.isArray(e.edges)?e.edges.filter(c=>s.has(String(c?.source||"").trim())&&s.has(String(c?.target||"").trim())):[];return{...e,nodes:a,edges:i,meta:{...e?.meta&&typeof e.meta=="object"?e.meta:{},selected_run_id:t,selected_event_count:n.eventIds.size,selected_demo_count:n.demoIds.size,total_problems:a.filter(c=>String(c?.type||"").trim()==="problem").length,total_solutions:a.filter(c=>String(c?.type||"").trim()==="solution").length}}}r(Gn,"filterHackamapApiGraphPayloadByRun");function Wr(e){let t=Array.isArray(e?.nodes)?e.nodes:[],n=Array.isArray(e?.links)?e.links:[],o=[],a=new Set;for(let i of t){let c=String(i?.id||"").trim(),l=String(i?.type||"").trim(),p=String(i?.label||"").trim();if(!(!c||!l||!p)){if(l==="Event"){o.push({id:c,type:"problem",label:p,cluster:"Event"}),a.add(c);continue}l==="Demo"&&(o.push({id:c,type:"solution",label:p,cluster:"Demo"}),a.add(c))}}let s=[];for(let i of n){let c=String(i?.source||"").trim(),l=String(i?.target||"").trim(),p=String(i?.type||"").trim();!c||!l||p==="has_demo"&&(!a.has(c)||!a.has(l)||s.push({source:c,target:l,type:"has_demo",strength:.35}))}return{nodes:o,edges:s,meta:{source:"hackamap-graph.json:fallback",total_problems:o.filter(i=>i.type==="problem").length,total_solutions:o.filter(i=>i.type==="solution").length,...e?.content_signature?{content_signature:String(e.content_signature)}:{}}}}r(Wr,"toBipartiteApiPayload");async function Jn(e){let{request:t}=e,n=String(t.method||"GET").toUpperCase(),o=new URL(t.url);if(n==="OPTIONS")return new Response(null,{status:204,headers:{...M(t),"access-control-allow-methods":"GET, HEAD, OPTIONS","access-control-allow-headers":"*","access-control-max-age":"86400"}});if(n!=="GET"&&n!=="HEAD")return Ie(t,{ok:!1,error:"unsupported_method"},405);if(String(o.searchParams.get("view")||"").trim().toLowerCase()==="meta"){let f=await Kr(t);return n==="HEAD"?new Response(null,{status:200,headers:{...Ye,...M(t)}}):Ie(t,f,200)}let a=String(o.searchParams.get("run")||"").trim(),s=await Br(t,a),i=await Dr(t);if(i){let f=Gn(i,a,s);return n==="HEAD"?new Response(null,{status:200,headers:{...Ye,...M(t)}}):Ie(t,f,200)}let c=await Ur(t);if(!c)return Ie(t,{ok:!1,error:"missing_hackamap_graph",hint:"/knowgrph/imports/hackamap/{hackamap_api_graph.json,hackamap-graph.json} not found"},404);let l=Wr(c),p=Gn(l,a,s);return n==="HEAD"?new Response(null,{status:200,headers:{...Ye,...M(t)}}):Ie(t,p,200)}r(Jn,"onRequest");var Gr=!0,Vn=600,Xn={"content-type":"application/json; charset=utf-8","cache-control":`public, max-age=${Vn}`};function ce(e,t,n={}){return new Response(JSON.stringify(t),{...n,headers:{...Xn,...n.headers||{},...M(e)}})}r(ce,"jsonResponse");function Fr(e){try{let t=new URL(String(e));return t.protocol==="http:"||t.protocol==="https:"}catch{return!1}}r(Fr,"isHttpUrl");function ve(e){return String(e||"").trim().toLowerCase()}r(ve,"normalizeHost");function St(e,{exact:t,suffixes:n}){let o=ve(e);return o?!!(Array.isArray(t)&&t.some(a=>o===ve(a))||Array.isArray(n)&&n.some(a=>o===ve(a)||o.endsWith(`.${ve(a)}`))):!1}r(St,"isHostMatch");function qr(e){let t=ve(e.hostname),n=e.toString();return St(t,{suffixes:["linkedin.com"]})?new URL(`https://www.linkedin.com/embeds/oembed.json?url=${encodeURIComponent(n)}`):St(t,{exact:["twitter.com","x.com"],suffixes:["twitter.com","x.com"]})?new URL(`https://publish.twitter.com/oembed?omit_script=1&url=${encodeURIComponent(n)}`):St(t,{exact:["reddit.com"],suffixes:["reddit.com"]})?new URL(`https://www.reddit.com/oembed?url=${encodeURIComponent(n)}`):null}r(qr,"buildOembedUpstreamUrl");async function zr({upstreamUrl:e}){return await fetch(e.toString(),{headers:{"user-agent":"Mozilla/5.0 (compatible; OEmbedProxy/1.0)",accept:"application/json,text/json;q=0.9,*/*;q=0.1"},redirect:"follow",cf:{cacheTtl:Vn,cacheEverything:!0}})}r(zr,"fetchJsonUpstream");async function Zn(e){let{request:t}=e,n=String(t.method||"GET").toUpperCase(),o=new URL(t.url);if(n==="OPTIONS")return new Response(null,{status:204,headers:{...M(t),"access-control-allow-methods":"GET, HEAD, OPTIONS","access-control-allow-headers":"*","access-control-max-age":"86400"}});if(!["GET","HEAD"].includes(n))return ce(t,{ok:!1,error:"unsupported_method"},{status:405});if(o.searchParams.get("ping")==="1")return ce(t,{ok:!0,ping:!0});if(Gr)return ce(t,{ok:!1,error:"disabled_by_policy"},{status:200,headers:{"cache-control":"no-store"}});let a=o.searchParams.get("url")||"";if(!Fr(a))return ce(t,{ok:!1,error:"invalid_url"},{status:400,headers:{"cache-control":"no-store"}});let s;try{s=new URL(a)}catch{return ce(t,{ok:!1,error:"invalid_url"},{status:400,headers:{"cache-control":"no-store"}})}let i=qr(s);if(!i)return ce(t,{ok:!1,error:"unsupported_provider"},{status:400,headers:{"cache-control":"no-store"}});let c=await zr({upstreamUrl:i}),l=new Headers(c.headers);l.delete("content-length"),l.set("cache-control",c.ok?Xn["cache-control"]:"no-store");for(let[f,d]of Object.entries(M(t)))l.set(f,d);if(n==="HEAD")return new Response(null,{status:c.status,headers:l});let p=await c.text();try{JSON.parse(p)}catch{return ce(t,{ok:!1,error:"invalid_upstream_json",status:c.status},{status:502,headers:{"cache-control":"no-store"}})}return l.set("content-type","application/json; charset=utf-8"),new Response(p,{status:c.status,headers:l})}r(Zn,"onRequest");var Qn="/__chat_proxy",Je="agnes-ai",Ve="byteplus-modelark",Xe="miromind",Yr=r(e=>{let t=z(e);return t==="openai"?"openai":t===Ve||t==="byteplus"?Ve:t===Xe||t==="miromind-api"?Xe:t===Je||t==="agnes"||t==="agnes-ai-api"?Je:t},"normalizeProviderId"),Jr=r(e=>z(e)===qe,"isAgnesHost"),Vr=r(e=>{let t=z(e);return t===ze||t===ft},"isBytePlusHost"),Xr=r(e=>z(e)===Fe,"isMiroMindHost"),Zr=r(({provider:e,requestedUpstream:t,env:n})=>e==="openai"?"https://api.openai.com":e===Xe?t||`https://${Fe}`:e===Je?t||`https://${qe}`:e===Ve?t||String(n.KNOWGRPH_CHAT_PROXY_UPSTREAM||"").trim()||`https://${ze}`:t||String(n.KNOWGRPH_CHAT_PROXY_UPSTREAM||"").trim(),"pickUpstreamBase");async function eo(e){let{request:t,env:n}=e,o=String(t.method||"GET").toUpperCase(),a=new URL(t.url);if(o==="OPTIONS")return new Response(null,{status:204,headers:{"access-control-allow-origin":q(t.headers,"origin")||"*","access-control-allow-methods":"GET, HEAD, POST, OPTIONS","access-control-allow-headers":"*","access-control-max-age":"86400"}});if(!["GET","HEAD","POST"].includes(o))return B(t,{ok:!1,error:"Unsupported method"},405);let s=Yr(q(t.headers,"x-kg-chat-provider")),i=Zr({provider:s,requestedUpstream:q(t.headers,"x-kg-chat-upstream"),env:n});if(!i)return B(t,{ok:!1,error:"Missing chat proxy upstream configuration"},500);let c;try{c=new URL(i)}catch{return B(t,{ok:!1,error:"Invalid chat proxy upstream configuration"},500)}let l=Wn(n,{includeOpenAi:!0,includeMiroMind:!0,includeAgnes:!0,includeBytePlus:!0}),p=z(c.hostname);if(!l.has(p))return B(t,{ok:!1,error:"Chat proxy upstream host is not allowed"},403);if(!Bn(p)&&c.protocol!=="https:")return B(t,{ok:!1,error:"Chat proxy requires HTTPS for non-local upstream hosts"},403);let f=s==="openai"||p===gt,d=s===Xe||Xr(p),k=s===Je||Jr(p),g=s===Ve||Vr(p),R=q(t.headers,"x-kg-chat-api-key"),C=String(n.KNOWGRPH_CHAT_PROXY_OPENAI_API_KEY||n.OPENAI_API_KEY||"").trim(),A=String(n.KNOWGRPH_CHAT_PROXY_MIROMIND_API_KEY||n.MIROMIND_API_KEY||"").trim(),I=String(n.KNOWGRPH_CHAT_PROXY_AGNES_API_KEY||n.AGNES_API_KEY||"").trim(),v=String(n.KNOWGRPH_CHAT_PROXY_BYTEPLUS_API_KEY||n.BYTEPLUS_API_KEY||"").trim(),O=(R||C).slice(0,512),E=(R||A).slice(0,512),G=(R||I).slice(0,512),$=(R||v).slice(0,512),w=g?$:k?G:d?E:O;if(f&&!O)return B(t,{ok:!1,error:"Missing OpenAI API key for chat proxy upstream (set KNOWGRPH_CHAT_PROXY_OPENAI_API_KEY or OPENAI_API_KEY)"},401);if(d&&!w)return B(t,{ok:!1,error:"Missing MiroMind API key for chat proxy upstream (set KNOWGRPH_CHAT_PROXY_MIROMIND_API_KEY or MIROMIND_API_KEY)"},401);if(k&&!w)return B(t,{ok:!1,error:"Missing Agnes API key for chat proxy upstream (set KNOWGRPH_CHAT_PROXY_AGNES_API_KEY or AGNES_API_KEY)"},401);if(g&&!w)return B(t,{ok:!1,error:"Missing BytePlus API key for chat proxy upstream (set KNOWGRPH_CHAT_PROXY_BYTEPLUS_API_KEY or BYTEPLUS_API_KEY)"},401);if(o==="POST"&&!q(t.headers,"content-type").toLowerCase().includes("application/json"))return B(t,{ok:!1,error:"Chat proxy expects application/json payloads"},415);let y=a.pathname.startsWith(Qn)&&a.pathname.slice(Qn.length)||"/v1/chat/completions",m=y.startsWith("/")?y:`/${y}`,h=new URL(`${m}${a.search||""}`,c),b=new Headers,Y=q(t.headers,"content-type"),oe=q(t.headers,"accept");Y&&b.set("content-type",Y),oe&&b.set("accept",oe),(f||d||k||g)&&b.set("authorization",`Bearer ${w}`);let le=q(t.headers,"x-client-request-id").slice(0,512);le&&b.set("x-client-request-id",le);let pe=new AbortController,ue=Number(n.KNOWGRPH_CHAT_PROXY_TIMEOUT_MS),Pe=Number.isFinite(ue)?Math.max(5e3,Math.min(18e4,Math.floor(ue))):9e4,de=setTimeout(()=>pe.abort(),Pe);try{let L=await fetch(h.toString(),{method:o,headers:b,body:o==="GET"||o==="HEAD"?void 0:t.body,signal:pe.signal,redirect:"follow"}),H=new Headers(L.headers);H.delete("content-length"),H.delete("www-authenticate"),H.set("cache-control","no-store");let Ue=q(t.headers,"origin");return Ue&&(H.set("access-control-allow-origin",Ue),H.set("vary","Origin")),o==="HEAD"?new Response(null,{status:L.status,statusText:L.statusText,headers:H}):new Response(L.body,{status:L.status,statusText:L.statusText,headers:H})}catch(L){let H=L&&typeof L=="object"&&"message"in L?String(L.message||""):"",Ue=pe.signal.aborted||/aborted|timeout/i.test(H);return B(t,{ok:!1,error:H||"Failed to reach chat upstream"},Ue?504:502)}finally{clearTimeout(de)}}r(eo,"onRequest");async function to(e){let{request:t}=e,n=String(t.method||"GET").toUpperCase();if(n==="OPTIONS")return new Response(null,{status:204,headers:{...M(t),"access-control-allow-methods":"GET, HEAD, OPTIONS","access-control-allow-headers":"*","access-control-max-age":"86400"}});if(n!=="GET"&&n!=="HEAD")return new Response(JSON.stringify({ok:!1,error:"unsupported_method"}),{status:405,headers:{"content-type":"application/json; charset=utf-8","cache-control":"no-store",...M(t)}});let o={ok:!0,service:"singabldr-pages",ts:new Date().toISOString()},a={"content-type":"application/json; charset=utf-8","cache-control":"no-store",...M(t)};return n==="HEAD"?new Response(null,{status:200,headers:a}):new Response(JSON.stringify(o),{status:200,headers:a})}r(to,"onRequest");var te="https://airvio.co";var W="/knowgrph",V=`${te}${W}/`,Qr=`${te}/`;var oo=`${W}/health`,no=`${te}${oo}`,ro="/.well-known/agent-card.json",Ki=`${W}/.well-known/agent-card.json`,ea=`${te}${ro}`,ta=`${te}/api/storage/source-files`,na=`${te}/api/storage/doc-default/{canonicalPath}`,oa=`${te}/api/storage/doc/{workspaceId}/{canonicalPath}`;var _t="root-agent-ready-pages",ao=['</.well-known/api-catalog>; rel="api-catalog"; type="application/linkset+json"',`<${W}/.well-known/openapi.json>; rel="service-desc"; type="application/vnd.oai.openapi+json;version=3.1"`,`<${W}/llms.txt>; rel="service-doc"; type="text/plain"`,'</auth.md>; rel="service-doc"; type="text/markdown"',`<${oo}>; rel="status"; type="application/health+json"`,`<${W}/.well-known/mcp/server-card.json>; rel="mcp-server-card"; type="application/json"`,`<${ro}>; rel="describedby"; type="application/json"`].join(", "),so=`# Knowgrph
...
- Auth.md registration instructions: ${Qr}auth.md
- Health: ${no}
...
- Agent-ready status: ${no}
- HTTP MCP: ${V}mcp
- Storage API: ${te}/api/storage/
- Source Files index: ${ta}
- Default Source File documents: ${na}
- Workspace Source File documents: ${oa}
...
`,io=r(e=>new Response(e,{status:200,headers:{"content-type":"text/markdown; charset=utf-8","cache-control":"public, max-age=3600","access-control-allow-origin":"*",vary:"Accept","x-markdown-tokens":String(Math.ceil(String(e||"").length/4))}}),"markdownResponse"),co=r(e=>(e.headers.get("accept")||"").toLowerCase().split(",").some(n=>n.trim().startsWith("text/markdown")),"wantsMarkdown"),Pt=r((e,t)=>{let n=new Response(e.body,e),o=String(t?.owner||"").trim(),a=String(t?.tag||"").trim();return o&&n.headers.set("x-knowgrph-route-owner",o),a&&n.headers.set("x-knowgrph-route-tag",a),n},"withAgentReadyRouteHeaders");var Ze="Agent-actionable chat-to-canvas knowledge graph workspace",ra=new RegExp(["Agent-readable","knowledge","graph","workspace"].join("\\s+")+"\\.?","g"),aa=r(e=>{let t=/<script>([\s\S]*?)<\/script>/g;for(let n of String(e||"").matchAll(t)){let o=n[1]||"";if(o.includes("createWebMcpLifecycleController")&&o.includes("toolDefinitions"))return o}return""},"extractWebMcpScript"),lo=r(()=>({"content-type":"text/html; charset=utf-8","cache-control":"no-store, no-cache, no-transform, must-revalidate, max-age=0","access-control-allow-origin":"*",link:ao}),"rootHtmlHeaders"),kt=r((e,t)=>String(e||"").includes("</head>")?String(e||"").replace("</head>",`${t}</head>`):`${String(e||"")}${t}`,"injectIntoHead"),sa=r(e=>{let t=String(e||"").replace(ra,Ze);return/<meta\s+name=["']description["'][^>]*>/i.test(t)?t=t.replace(/<meta\s+name=["']description["'][^>]*>/i,`<meta name="description" content="${Ze}" />`):t=kt(t,`    <meta name="description" content="${Ze}" />
`),/<link\s+rel=["']canonical["'][^>]*>/i.test(t)||(t=kt(t,`    <link rel="canonical" href="${W}/" />
`)),/<meta\s+name=["']x-knowgrph-root-alias["'][^>]*>/i.test(t)||(t=kt(t,`    <meta name="x-knowgrph-root-alias" content="${W}/" />
`)),t},"rewriteRootAppHtml"),ia=r(async e=>{let t=new URL(`${W}/?agentReadyRootWebMcp=1`,e.url),n=await fetch(t,{headers:{accept:"text/html"}});return n.ok?aa(await n.text()):""},"loadWebMcpScript"),ca=r(async e=>{let t=new URL(`${W}/?agentReadyRootAlias=1`,e.url),n=await fetch(t,{headers:{accept:"text/html"}});if(!n.ok)return null;let o=sa(await n.text());return!o.includes('<div id="root"></div>')||!o.includes(`${W}/assets/`)?null:new Response(o,{status:200,headers:lo()})},"loadKnowgrphAppShell"),la=r((e="")=>new Response(`<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
...
</html>`,{status:200,headers:lo()}),"rootHtmlResponse");async function po(e){let{request:t}=e,n=String(t.method||"GET").toUpperCase();if(n!=="GET"&&n!=="HEAD")return e.next();if(co(t)){let s=Pt(io(so),{owner:_t,tag:"root-homepage-markdown"});return n==="HEAD"?new Response(null,s):s}let o=n==="HEAD"?null:await ca(t),a=Pt(o||la(n==="HEAD"?"":await ia(t)),{owner:_t,tag:"root-homepage-html"});return n==="HEAD"?new Response(null,a):a}r(po,"onRequest");var S=[{routePath:"/api/llm/chat/completions",mountPath:"/api/llm/chat",method:"",middlewares:[],modules:[At]},{routePath:"/api/payments/commerce/x402",mountPath:"/api/payments/commerce",method:"",middlewares:[],modules:[Ft]},{routePath:"/api/llm/models",mountPath:"/api/llm",method:"",middlewares:[],modules:[qt]},{routePath:"/api/llm/responses",mountPath:"/api/llm",method:"",middlewares:[],modules:[zt]},{routePath:"/knowgrph/doc-default/:path*",mountPath:"/knowgrph/doc-default",method:"",middlewares:[],modules:[Un]},{routePath:"/knowgrph/doc/:path*",mountPath:"/knowgrph/doc",method:"",middlewares:[],modules:[Dn]},{routePath:"/knowgrph/share/:path*",mountPath:"/knowgrph/share",method:"",middlewares:[],modules:[Nn]},{routePath:"/api/link-preview",mountPath:"/api",method:"GET",middlewares:[],modules:[Ln]},{routePath:"/api/link-proxy",mountPath:"/api",method:"GET",middlewares:[],modules:[jn]},{routePath:"/api/graph",mountPath:"/api",method:"",middlewares:[],modules:[Jn]},{routePath:"/api/oembed",mountPath:"/api",method:"",middlewares:[],modules:[Zn]},{routePath:"/__chat_proxy/:path*",mountPath:"/__chat_proxy",method:"",middlewares:[],modules:[eo]},{routePath:"/knowgrph/:path*",mountPath:"/knowgrph",method:"",middlewares:[],modules:[ee]},{routePath:"/health",mountPath:"/",method:"",middlewares:[],modules:[to]},{routePath:"/",mountPath:"/",method:"",middlewares:[],modules:[po]}];function pa(e){for(var t=[],n=0;n<e.length;){var o=e[n];if(o==="*"||o==="+"||o==="?"){t.push({type:"MODIFIER",index:n,value:e[n++]});continue}if(o==="\\"){t.push({type:"ESCAPED_CHAR",index:n++,value:e[n++]});continue}if(o==="{"){t.push({type:"OPEN",index:n,value:e[n++]});continue}if(o==="}"){t.push({type:"CLOSE",index:n,value:e[n++]});continue}if(o===":"){for(var a="",s=n+1;s<e.length;){var i=e.charCodeAt(s);if(i>=48&&i<=57||i>=65&&i<=90||i>=97&&i<=122||i===95){a+=e[s++];continue}break}if(!a)throw new TypeError("Missing parameter name at ".concat(n));t.push({type:"NAME",index:n,value:a}),n=s;continue}if(o==="("){var c=1,l="",s=n+1;if(e[s]==="?")throw new TypeError('Pattern cannot start with "?" at '.concat(s));for(;s<e.length;){if(e[s]==="\\"){l+=e[s++]+e[s++];continue}if(e[s]===")"){if(c--,c===0){s++;break}}else if(e[s]==="("&&(c++,e[s+1]!=="?"))throw new TypeError("Capturing groups are not allowed at ".concat(s));l+=e[s++]}if(c)throw new TypeError("Unbalanced pattern at ".concat(n));if(!l)throw new TypeError("Missing pattern at ".concat(n));t.push({type:"PATTERN",index:n,value:l}),n=s;continue}t.push({type:"CHAR",index:n,value:e[n++]})}return t.push({type:"END",index:n,value:""}),t}r(pa,"lexer");function ua(e,t){t===void 0&&(t={});for(var n=pa(e),o=t.prefixes,a=o===void 0?"./":o,s=t.delimiter,i=s===void 0?"/#?":s,c=[],l=0,p=0,f="",d=r(function(m){if(p<n.length&&n[p].type===m)return n[p++].value},"tryConsume"),k=r(function(m){var h=d(m);if(h!==void 0)return h;var b=n[p],Y=b.type,oe=b.index;throw new TypeError("Unexpected ".concat(Y," at ").concat(oe,", expected ").concat(m))},"mustConsume"),g=r(function(){for(var m="",h;h=d("CHAR")||d("ESCAPED_CHAR");)m+=h;return m},"consumeText"),R=r(function(m){for(var h=0,b=i;h<b.length;h++){var Y=b[h];if(m.indexOf(Y)>-1)return!0}return!1},"isSafe"),C=r(function(m){var h=c[c.length-1],b=m||(h&&typeof h=="string"?h:"");if(h&&!b)throw new TypeError('Must have text between two parameters, missing text after "'.concat(h.name,'"'));return!b||R(b)?"[^".concat(ne(i),"]+?"):"(?:(?!".concat(ne(b),")[^").concat(ne(i),"])+?")},"safePattern");p<n.length;){var A=d("CHAR"),I=d("NAME"),v=d("PATTERN");if(I||v){var O=A||"";a.indexOf(O)===-1&&(f+=O,O=""),f&&(c.push(f),f=""),c.push({name:I||l++,prefix:O,suffix:"",pattern:v||C(O),modifier:d("MODIFIER")||""});continue}var E=A||d("ESCAPED_CHAR");if(E){f+=E;continue}f&&(c.push(f),f="");var G=d("OPEN");if(G){var O=g(),$=d("NAME")||"",w=d("PATTERN")||"",y=g();k("CLOSE"),c.push({name:$||(w?l++:""),pattern:$&&!w?C(O):w,prefix:O,suffix:y,modifier:d("MODIFIER")||""});continue}k("END")}return c}r(ua,"parse");function Oe(e,t){var n=[],o=mo(e,n,t);return da(o,n,t)}r(Oe,"match");function da(e,t,n){n===void 0&&(n={});var o=n.decode,a=o===void 0?function(s){return s}:o;return function(s){var i=e.exec(s);if(!i)return!1;for(var c=i[0],l=i.index,p=Object.create(null),f=r(function(k){if(i[k]===void 0)return"continue";var g=t[k-1];g.modifier==="*"||g.modifier==="+"?p[g.name]=i[k].split(g.prefix+g.suffix).map(function(R){return a(R,g)}):p[g.name]=a(i[k],g)},"_loop_1"),d=1;d<i.length;d++)f(d);return{path:c,index:l,params:p}}}r(da,"regexpToFunction");function ne(e){return e.replace(/([.+*?=^!:${}()[\]|/\\])/g,"\\$1")}r(ne,"escapeString");function uo(e){return e&&e.sensitive?"":"i"}r(uo,"flags");function ma(e,t){if(!t)return e;for(var n=/\((?:\?<(.*?)>)?(?!\?)/g,o=0,a=n.exec(e.source);a;)t.push({name:a[1]||o++,prefix:"",suffix:"",modifier:"",pattern:""}),a=n.exec(e.source);return e}r(ma,"regexpToRegexp");function ha(e,t,n){var o=e.map(function(a){return mo(a,t,n).source});return new RegExp("(?:".concat(o.join("|"),")"),uo(n))}r(ha,"arrayToRegexp");function ga(e,t,n){return fa(ua(e,n),t,n)}r(ga,"stringToRegexp");function fa(e,t,n){n===void 0&&(n={});for(var o=n.strict,a=o===void 0?!1:o,s=n.start,i=s===void 0?!0:s,c=n.end,l=c===void 0?!0:c,p=n.encode,f=p===void 0?function(h){return h}:p,d=n.delimiter,k=d===void 0?"/#?":d,g=n.endsWith,R=g===void 0?"":g,C="[".concat(ne(R),"]|$"),A="[".concat(ne(k),"]"),I=i?"^":"",v=0,O=e;v<O.length;v++){var E=O[v];if(typeof E=="string")I+=ne(f(E));else{var G=ne(f(E.prefix)),$=ne(f(E.suffix));if(E.pattern)if(t&&t.push(E),G||$)if(E.modifier==="+"||E.modifier==="*"){var w=E.modifier==="*"?"?":"";I+="(?:".concat(G,"((?:").concat(E.pattern,")(?:").concat($).concat(G,"(?:").concat(E.pattern,"))*)").concat($,")").concat(w)}else I+="(?:".concat(G,"(").concat(E.pattern,")").concat($,")").concat(E.modifier);else{if(E.modifier==="+"||E.modifier==="*")throw new TypeError('Can not repeat "'.concat(E.name,'" without a prefix and suffix'));I+="(".concat(E.pattern,")").concat(E.modifier)}else I+="(?:".concat(G).concat($,")").concat(E.modifier)}}if(l)a||(I+="".concat(A,"?")),I+=n.endsWith?"(?=".concat(C,")"):"$";else{var y=e[e.length-1],m=typeof y=="string"?A.indexOf(y[y.length-1])>-1:y===void 0;a||(I+="(?:".concat(A,"(?=").concat(C,"))?")),m||(I+="(?=".concat(A,"|").concat(C,")"))}return new RegExp(I,uo(n))}r(fa,"tokensToRegexp");function mo(e,t,n){return e instanceof RegExp?ma(e,t):Array.isArray(e)?ha(e,t,n):ga(e,t,n)}r(mo,"pathToRegexp");var Qe=/[.+?^${}()|[\]\\]/g;function*wa(e){let t=new URL(e.url).pathname;for(let n of[...S].reverse()){if(n.method&&n.method!==e.method)continue;let o=Oe(n.routePath.replace(Qe,"\\$&"),{end:!1}),a=Oe(n.mountPath.replace(Qe,"\\$&"),{end:!1}),s=o(t),i=a(t);if(s&&i)for(let c of n.middlewares.flat())yield{handler:c,params:s.params,path:i.path}}for(let n of S){if(n.method&&n.method!==e.method)continue;let o=Oe(n.routePath.replace(Qe,"\\$&"),{end:!0}),a=Oe(n.mountPath.replace(Qe,"\\$&"),{end:!1}),s=o(t),i=a(t);if(s&&i&&n.modules.length){for(let c of n.modules.flat())yield{handler:c,params:s.params,path:s.path};break}}}r(wa,"executeRequest");var gc={async fetch(e,t,n){let o=e,a=wa(o),s={},i=!1,c=r(async(l,p)=>{if(l!==void 0){let d=l;typeof l=="string"&&(d=new URL(l,o.url).toString()),o=new Request(d,p)}let f=a.next();if(f.done===!1){let{handler:d,params:k,path:g}=f.value,R={request:new Request(o.clone()),functionPath:g,next:c,params:k,get data(){return s},set data(A){if(typeof A!="object"||A===null)throw new Error("context.data must be an object");s=A},env:t,waitUntil:n.waitUntil.bind(n),passThroughOnException:r(()=>{i=!0},"passThroughOnException")},C=await d(R);if(!(C instanceof Response))throw new Error("Your Pages function should return a Response");return xt(C)}else{let d=await t.ASSETS.fetch(o);return xt(d)}},"next");try{return await c()}catch(l){if(i){let p=await t.ASSETS.fetch(o);return xt(p)}throw l}}},xt=r(e=>new Response([101,204,205,304].includes(e.status)?null:e.body,e),"cloneResponse");export{gc as default};
