var pa=Object.defineProperty;var n=(e,t)=>pa(e,"name",{value:t,configurable:!0});var ua="https://api.openai.com/v1";var zt=Object.freeze(["gpt-5.4-nano","gpt-4o-mini"]);function qt(e){return String(e||"").trim()}n(qt,"normalizeOrigin");function da(e){let t=qt(e);return t?t.startsWith("http://localhost:")||t.startsWith("http://127.0.0.1:")||t.startsWith("http://0.0.0.0:"):!1}n(da,"isAllowedOrigin");function Kr(e){let t=qt(e);return da(t)?{"access-control-allow-origin":t,vary:"Origin","access-control-allow-methods":"GET, POST, OPTIONS","access-control-allow-headers":"content-type, x-flowinfish-session","access-control-max-age":"86400"}:{}}n(Kr,"corsHeaders");function me(e,{status:t=200,origin:r=""}={}){return new Response(JSON.stringify(e),{status:t,headers:{"content-type":"application/json; charset=utf-8","cache-control":"no-store",...Kr(r)}})}n(me,"json");async function mt(e,{maxBytes:t=1e6}={}){let r=await e.arrayBuffer();if(r.byteLength>t)throw new Error("Request too large");let o=new TextDecoder().decode(r);try{return o?JSON.parse(o):{}}catch{throw new Error("Invalid JSON body")}}n(mt,"readJsonBody");function ma(e){let t=String(e?.model||"").trim();if(!t)throw new Error("Missing model");if(!zt.includes(t))throw new Error(`Model not allowed: ${t}`);return t}n(ma,"enforceAllowedModel");function ha(e){let t=String(e.OPENAI_API_KEY||"").trim();if(!t)throw new Error("Missing server OPENAI_API_KEY");return t}n(ha,"requireOpenAiKey");async function ht({request:e,env:t,pathname:r,payload:o}){let a=ha(t);ma(o);let i=`${qt(t.OPENAI_API_BASE)||ua}${r}`,c=await fetch(i,{method:"POST",headers:{authorization:`Bearer ${a}`,"content-type":"application/json"},body:JSON.stringify(o)}),l=new Headers(c.headers);return l.delete("content-length"),l.set("cache-control","no-store"),new Response(c.body,{status:c.status,headers:l})}n(ht,"proxyToOpenAi");function Be(e){let t=e.headers.get("origin")||"";return new Response(null,{status:204,headers:{...Kr(t)}})}n(Be,"handleOptions");async function Dr(e){let{request:t,env:r}=e,o=String(t.method||"GET").toUpperCase(),a=t.headers.get("origin")||"";if(o==="OPTIONS")return Be(t);if(o!=="POST")return me({ok:!1,error:"Method not allowed"},{status:405,origin:a});try{if(!String(t.headers.get("content-type")||"").toLowerCase().includes("application/json"))return me({ok:!1,error:"Expected application/json"},{status:415,origin:a});let i=await mt(t);return await ht({request:t,env:r,pathname:"/chat/completions",payload:i})}catch(s){let i=s instanceof Error?s.message:String(s||"Unknown error");return me({ok:!1,error:i},{status:400,origin:a})}}n(Dr,"onRequest");var gt={checkoutSession:"/api/payments/stripe/checkout/session",webhook:"/api/payments/stripe/webhook"};var pe={restrictedKey:"STRIPE_RESTRICTED_KEY",secretKey:"STRIPE_SECRET_KEY",webhookSecret:"STRIPE_WEBHOOK_SECRET",checkoutPriceId:"STRIPE_CHECKOUT_PRICE_ID",checkoutCurrency:"STRIPE_CHECKOUT_CURRENCY",checkoutUnitAmount:"STRIPE_CHECKOUT_UNIT_AMOUNT",checkoutProductName:"STRIPE_CHECKOUT_PRODUCT_NAME",checkoutMode:"STRIPE_CHECKOUT_MODE",checkoutReturnOrigin:"STRIPE_CHECKOUT_RETURN_ORIGIN"},kc=[pe.restrictedKey,pe.secretKey,pe.webhookSecret];var Ve={configure:"npm run payment:stripe:configure",d1MigrateRemote:"npm run payment:d1:migrate:remote",readiness:"npm run payment:stripe:readiness",x402Configure:"npm run payment:x402:configure",x402Readiness:"npm run payment:x402:readiness",paymentReadiness:"npm run payment:readiness",applyConfirmation:"apply-stripe-payment-worker-config",writeVisibleVarsFlag:"--write-visible-vars",deployVisibleVarsFlag:"--deploy-visible-vars"};var Ec=[`Configure Stripe secrets on the server runtime that owns ${gt.checkoutSession}.`,"Cloudflare Pages project variables are available to Pages builds/functions, but they are not read by separate Worker routes.","Stripe Projects can provision and sync credentials locally; copy only required server secret names into the payment server runtime."].join(" "),Cc=[`Payment server runtime for ${gt.checkoutSession}`,"not Cloudflare Pages project variables"].join("; "),ga=[pe.restrictedKey,pe.secretKey].join(" or "),Tc=[pe.checkoutPriceId,`${pe.checkoutCurrency} + ${pe.checkoutUnitAmount} + ${pe.checkoutProductName}`].join(" or "),vc=[`${pe.checkoutMode}=payment`,`${pe.checkoutMode}=subscription with ${pe.checkoutPriceId}`].join(" or "),Oc=["Worker secret names","visible Worker [vars]","remote D1 payment tables","required webhook-processing columns/constraints","bounded optional hosted Checkout create-and-expire smoke"].join(" + "),Ic=[Ve.configure,`write visible Worker [vars] with ${Ve.writeVisibleVarsFlag}`,`deploy visible Worker [vars] with ${Ve.deployVisibleVarsFlag}`,`apply with -- --apply --yes --confirm=${Ve.applyConfirmation}`,Ve.readiness].join(" -> "),Mc=[`Missing server-managed Stripe key. Set ${ga} on the payment server runtime.`,"Pages project variables alone do not satisfy separate Worker routes."].join(" ");var fa=n(e=>{let t=2166136261;for(let r=0;r<e.length;r+=1)t^=e.charCodeAt(r),t=Math.imul(t,16777619);return t>>>0},"fnv1a32");function Hr(e){return fa(String(e??""))}n(Hr,"hashString32");function Ye(e){return Hr(e).toString(16).padStart(8,"0")}n(Ye,"hashStringToHex");var ya=n(e=>e==null?"":typeof e=="boolean"?e?"1":"0":typeof e=="number"?Number.isFinite(e)?String(e):"":String(e),"normalizePrimitive"),wa=n(e=>e.map(ya).join("|"),"buildSignatureText"),ft=n(e=>Ye(wa(e)),"hashSignatureParts");var we=n((e,t)=>ft(["agentic-commerce",e,...t]),"buildAgenticCommerceSemanticKey");var jr="solana_pay",Br="/api/payments/commerce/solana-pay/settle";var Je="2026-01-30",Gr="1000",Wr="USDC",Vt="https://x402.org/facilitator",zr="eip155:84532",Sa="$0.001",qr="x402-payment-required",_a="0x0000000000000000000000000000000000000000",Fe="2026-04-08",Fr="https://ucp.dev/2026-04-08/specification/overview/",ba=["checkout"],Pa=["rest"];var v={acpDiscovery:"/.well-known/acp.json",acpConfig:"/.well-known/acp-config",ucpProfile:"/.well-known/ucp",mppOpenApi:"/openapi.json",x402ApiRoot:"/api",x402ApiV1:"/api/v1",checkoutSessions:"/checkout/sessions",x402PaymentRequired:"/api/payments/commerce/x402",commerceWebhook:"/api/payments/commerce/webhook",commerceProofArtifact:"/api/payments/commerce/harness-proof.json",commerceTraceArtifact:"/api/payments/commerce/trace.jsonl",openboxIngest:"/api/payments/commerce/openbox/ingest",web3Settle:"/api/payments/commerce/web3/settle",solanaPaySettle:Br},tl=[v.x402ApiRoot,v.x402ApiV1,v.x402PaymentRequired],Ce={sellerId:"SELLER_ID",checkoutBaseUrl:"CHECKOUT_BASE_URL",web3Enabled:"WEB3_ENABLED",web3DepositAddress:"WEB3_DEPOSIT_ADDRESS",baseRpcUrl:"BASE_RPC_URL",baseConfirmationBlocks:"BASE_CONFIRMATION_BLOCKS",easAttestUrl:"EAS_ATTEST_URL",openboxApiUrl:"OPENBOX_API_URL",openboxIngestUrl:"OPENBOX_INGEST_URL",openboxApiKey:"OPENBOX_API_KEY",stripeDelegatePaymentUrl:"STRIPE_DELEGATE_PAYMENT_URL",acpBearerToken:"ACP_BEARER_TOKEN",x402PayToAddress:"X402_PAY_TO_ADDRESS",x402Network:"X402_NETWORK",x402Asset:"X402_ASSET",x402Amount:"X402_AMOUNT",x402FacilitatorUrl:"X402_FACILITATOR_URL",x402Price:"X402_PRICE"},Te=n((e,t)=>String(e[t]||"").trim(),"readEnvString"),Vr=n((e,t)=>{let r=Te(e,Ce.sellerId);if(r)return r;try{return new URL(t).host}catch{return"knowgrph-seller"}},"readAgenticCommerceSellerId");var Yr=n(e=>{let t=Te(e,Ce.web3Enabled).toLowerCase();return t?t==="0"||t==="false"||t==="no"?!1:t==="1"||t==="true"||t==="yes":!0},"isAgenticCommerceWeb3Enabled");var Xe=n(e=>String(e||"").trim().replace(/\/+$/g,""),"normalizeAgenticCommerceBaseUrl"),se=n((e,t)=>`${Xe(e)}${t}`,"buildAgenticCommerceUrl"),ee=n((e,t,r,o,a=o.startsWith("/")?o:null)=>({id:t,label:r,value:o,path:a,semanticKey:we("mainpanel-commerce-readiness-row",[e,t,r,o,a||""])}),"buildAgenticCommerceMainPanelReadinessRow"),Ge=n((e,t,r)=>({id:e,title:t,rows:r}),"buildAgenticCommerceMainPanelReadinessSection"),Ra=n(()=>{let e=[Ge("overview","Overview",[ee("overview","acp-discovery","ACP discovery",`GET ${v.acpDiscovery}`,v.acpDiscovery),ee("overview","acp-config","ACP config",`GET ${v.acpConfig}`,v.acpConfig),ee("overview","api-version","API version",Je,null)]),Ge("discovery","Discovery",[ee("discovery","ucp-profile","UCP profile",v.ucpProfile),ee("discovery","mpp-openapi","MPP OpenAPI",v.mppOpenApi),ee("discovery","x402-payment-required","x402 payment required",v.x402PaymentRequired),ee("discovery","x402-api-root","x402 API root",v.x402ApiRoot)]),Ge("sessions","Sessions",[ee("sessions","checkout-sessions","Checkout sessions",v.checkoutSessions),ee("sessions","stripe-webhook","Stripe webhook",gt.webhook)]),Ge("web3","Web3",[ee("web3","settle","Settle",v.web3Settle),ee("web3","solana-pay-settle","Solana Pay settle",v.solanaPaySettle),ee("web3","signals","Signals","Base RPC + Solana RPC confirmation",null)]),Ge("governance","Governance",[ee("governance","openbox-ingest","OpenBOX ingest",v.openboxIngest),ee("governance","risk-source","Risk source","OpenBOX risk signal",null)]),Ge("proofs","Proofs",[ee("proofs","harness-proof","Harness proof",v.commerceProofArtifact),ee("proofs","trace-artifact","Trace artifact",v.commerceTraceArtifact)])],t=e.flatMap(a=>a.rows),r=t.map(a=>a.path||"").filter(a=>a.length>0),o=t.filter(a=>!a.path).map(a=>`${a.label}: ${a.value}`);return{surface:"mainpanel-commerce",semanticKey:we("mainpanel-commerce-readiness",[Je,...t.map(a=>a.semanticKey)]),sections:e,routePaths:r,routeCount:r.length,signals:o}},"buildAgenticCommerceMainPanelReadiness"),rl=Ra(),Jr=n((e,t)=>{let r=Te(e,Ce.web3DepositAddress);if(/^0x[0-9a-fA-F]{40}$/.test(r))return r;let o=we("deposit-address",[t,"0"]),a=we("deposit-address",[t,"1"]),s=we("deposit-address",[t,"2"]),i=we("deposit-address",[t,"3"]),c=we("deposit-address",[t,"4"]);return`0x${o}${a}${s}${i}${c}`.slice(0,42)},"buildAgenticCommerceDepositAddress");var Xr=n((e,t=qr)=>{let r=Te(e,Ce.x402PayToAddress);return/^0x[0-9a-fA-F]{40}$/.test(r)&&r.toLowerCase()!==_a?r:Jr(e,t)},"readAgenticCommerceX402PayToAddress"),ol=Jr({},qr),Aa=/^[a-z0-9]{3,8}:[-_a-zA-Z0-9]{1,64}$/,Qr=n(e=>{let t=Te(e,Ce.x402Network);return Aa.test(t)?t:zr},"readAgenticCommerceX402Network"),Zr=n(e=>Te(e,Ce.x402Asset)||Wr,"readAgenticCommerceX402Asset"),eo=n(e=>{let t=Te(e,Ce.x402Amount);return/^[1-9][0-9]*$/.test(t)?t:Gr},"readAgenticCommerceX402Amount");var to=n(e=>{let t=Te(e,Ce.x402FacilitatorUrl);try{let r=new URL(t||Vt);return r.protocol==="https:"||r.protocol==="http:"?r.toString().replace(/\/+$/g,""):Vt}catch{return Vt}},"readAgenticCommerceX402FacilitatorUrl"),ro=n(e=>{let t=Xe(e.baseUrl);return{protocol:{name:"acp",version:Je,supported_versions:[Je],documentation_url:"https://agenticcommerce.dev"},api_base_url:t,transports:[...Pa],capabilities:{services:[...ba],...e.web3Enabled?{extensions:[{name:"x-web3"}]}:{}},links:{config:se(t,v.acpConfig),ucp:se(t,v.ucpProfile),mpp:se(t,v.mppOpenApi),x402:se(t,v.x402PaymentRequired)}}},"buildAgenticCommerceAcpDiscovery"),oo=n(e=>{let t=Xe(e.baseUrl),r={acp:se(t,v.acpDiscovery),api:se(t,v.x402ApiRoot),checkout_sessions:se(t,v.checkoutSessions),mpp_openapi:se(t,v.mppOpenApi),proof:se(t,v.commerceProofArtifact),trace:se(t,v.commerceTraceArtifact),x402_payment_required:se(t,v.x402PaymentRequired),solana_pay_settle:se(t,v.solanaPaySettle)},o={checkout_sessions:!0,content_payments:!0,proof_artifacts:!0,risk_signals:!0,web3_settlement:e.web3Enabled,solana_pay:e.web3Enabled},a={"dev.ucp.shopping":[{version:Fe,spec:Fr,transport:"rest",endpoint:r.api,schema:"https://ucp.dev/2026-04-08/services/shopping/rest.openapi.json"}]};return{ucp:{version:Fe,protocol_version:Fe,services:a,capabilities:{"dev.ucp.shopping.checkout":[{version:Fe,spec:"https://ucp.dev/2026-04-08/specification/checkout/",schema:"https://ucp.dev/2026-04-08/schemas/shopping/checkout.json"}]},payment_handlers:{},endpoints:r},protocol_version:Fe,protocol:{name:"ucp",version:Fe},seller:{id:e.sellerId},services:[{id:"knowgrph-content-payments",type:"content-payments",endpoints:{x402:r.x402_payment_required,checkout_sessions:r.checkout_sessions,solana_pay_settle:r.solana_pay_settle,proof:r.proof,trace:r.trace}}],capabilities:o,endpoints:r,spec_urls:[Fr],schema_urls:["https://ucp.dev/2026-04-08/services/shopping/rest.openapi.json","https://ucp.dev/2026-04-08/schemas/shopping/checkout.json"]}},"buildAgenticCommerceUcpProfile"),no=n(e=>{let t=Xe(e.baseUrl);return{openapi:"3.1.0",info:{title:"Knowgrph Machine Payment Protocol",version:Je,description:"Machine-readable payable-operation discovery for Knowgrph commerce routes."},servers:[{url:t}],paths:{[v.x402PaymentRequired]:{get:{operationId:"getKnowgrphX402PaymentRequirement",summary:"Return x402 payment requirements for an agent-readable paid resource.","x-payment-info":{intent:"charge",method:"x402",amount:Sa,currency:"usdc"},responses:{402:{description:"Payment Required"}}}},[v.checkoutSessions]:{post:{operationId:"createKnowgrphCommerceCheckoutSession",summary:"Create an agentic commerce checkout session.","x-payment-info":{intent:"session",method:"stripe",amount:"dynamic",currency:"request.currency"},responses:{201:{description:"Checkout session created"}}}},[v.solanaPaySettle]:{post:{operationId:"settleKnowgrphSolanaPayCheckoutSession",summary:"Settle an agentic commerce checkout session from a verified Solana Pay transaction signature.","x-payment-info":{intent:"settlement",method:jr,amount:"dynamic",currency:"request.currency"},responses:{200:{description:"Solana Pay session settled"},409:{description:"Solana Pay transaction is not confirmed yet"},422:{description:"Solana Pay transaction does not match the session"}}}}}}},"buildAgenticCommerceMppOpenApi"),ao=n(e=>{let t=Xe(e.baseUrl),r=se(t,v.x402PaymentRequired),o=String(e.amount||Gr);return{x402Version:2,error:"Payment required",resource:{url:r,description:"Knowgrph agentic commerce paid-resource readiness probe",mimeType:"application/json"},accepts:[{scheme:"exact",network:String(e.network||zr),amount:o,maxAmountRequired:o,asset:String(e.asset||Wr),resource:r,mimeType:"application/json",payTo:e.payTo,maxTimeoutSeconds:300,extra:{name:"USDC",version:"2",resourceUrl:r,...e.facilitatorUrl?{facilitatorUrl:e.facilitatorUrl}:{}}}]}},"buildAgenticCommerceX402PaymentRequired");var xa=n(e=>JSON.stringify(e,null,2),"jsonBody"),ka=n(e=>String(e||"").trim().replace(/\/+$/g,""),"trimOrigin"),Ea=n(e=>typeof btoa=="function"?btoa(e):typeof Buffer<"u"?Buffer.from(e).toString("base64"):"","encodeBase64"),Ca=n((e,t)=>{try{return new URL(e).origin}catch{return ka(t)}},"rootOriginFromRequest"),Yt=n((e={})=>{let t=Ca(e.requestUrl,e.origin),r=e.env||{},o=Vr(r,`${t}/`),a=Yr(r),s=ao({baseUrl:t,payTo:Xr(r),network:Qr(r),asset:Zr(r),amount:eo(r),facilitatorUrl:to(r)});return{acpDiscovery:ro({sellerId:o,baseUrl:t,web3Enabled:a}),ucpProfile:oo({sellerId:o,baseUrl:t,web3Enabled:a}),mppOpenApi:no({baseUrl:t}),x402PaymentRequired:s}},"buildKnowgrphCommerceDiscovery");var so=n((e,t={})=>{let r=Yt({requestUrl:e?.url,env:t}).x402PaymentRequired,o=Ea(JSON.stringify(r));return new Response(xa(r),{status:402,headers:{"content-type":"application/json; charset=utf-8","cache-control":"no-store","access-control-allow-origin":"*",...o?{"payment-required":o}:{}}})},"buildKnowgrphX402PaymentRequiredResponse");async function io(e){return so(e.request,e.env||{})}n(io,"onRequest");async function co(e){let{request:t}=e,r=String(t.method||"GET").toUpperCase(),o=t.headers.get("origin")||"";return r==="OPTIONS"?Be(t):r!=="GET"&&r!=="HEAD"?me({ok:!1,error:"Method not allowed"},{status:405,origin:o}):me({ok:!0,models:zt.map(a=>({model:a,display_name:a}))},{status:200,origin:o})}n(co,"onRequest");async function lo(e){let{request:t,env:r}=e,o=String(t.method||"GET").toUpperCase(),a=t.headers.get("origin")||"";if(o==="OPTIONS")return Be(t);if(o!=="POST")return me({ok:!1,error:"Method not allowed"},{status:405,origin:a});try{if(!String(t.headers.get("content-type")||"").toLowerCase().includes("application/json"))return me({ok:!1,error:"Expected application/json"},{status:415,origin:a});let i=await mt(t);return await ht({request:t,env:r,pathname:"/responses",payload:i})}catch(s){let i=s instanceof Error?s.message:String(s||"Unknown error");return me({ok:!1,error:i},{status:400,origin:a})}}n(lo,"onRequest");var We=Object.freeze({researchSourceFiles:"knowgrph_research_source_files",inspectAgentSurface:"knowgrph_inspect_agent_surface"}),Jt=n(e=>String(e||"").trim(),"normalizeString"),Ta=n(e=>({...e,arguments:Array.isArray(e.arguments)?e.arguments.map(t=>({...t})):void 0,_meta:e._meta&&typeof e._meta=="object"?{...e._meta,tools:Array.isArray(e._meta.tools)?[...e._meta.tools]:void 0}:void 0}),"clonePrompt"),uo=Object.freeze([Object.freeze({name:We.researchSourceFiles,title:"Research Knowgrph Source Files",description:"Guide an MCP host through read-only Knowgrph Source Files research using search and fetch with citation-ready URLs.",arguments:Object.freeze([Object.freeze({name:"query",description:"Research question or topic to pass to the read-only search tool.",required:!0}),Object.freeze({name:"limit",description:"Optional decimal string for the maximum search results to inspect.",required:!1}),Object.freeze({name:"focus",description:"Optional aspect to prioritize when reading fetched Source Files.",required:!1})]),_meta:Object.freeze({readOnly:!0,tools:Object.freeze(["search","fetch"])})}),Object.freeze({name:We.inspectAgentSurface,title:"Inspect Knowgrph Agent Surface",description:"Guide an MCP host through read-only inspection of Knowgrph agent, MCP, and MCP Apps readiness metadata.",arguments:Object.freeze([Object.freeze({name:"focus",description:"Optional readiness area to emphasize, such as transport, tools, resources, prompts, retrieval, or app metadata.",required:!1})]),_meta:Object.freeze({readOnly:!0,tools:Object.freeze(["inspect_agent_surface"])})})]),mo=n(()=>uo.map(Ta),"buildKnowgrphAgentReadyPromptContracts"),va=n(e=>uo.find(t=>t.name===Jt(e))||null,"findPromptContract"),yt=n((e,t)=>!e||typeof e!="object"?"":Jt(e[t]),"readPromptArg"),Oa=n((e,t)=>{let r=yt(e,t);if(!r)throw new Error(`Missing required prompt argument: ${t}`);return r},"readRequiredPromptArg"),po=n(e=>({role:"user",content:{type:"text",text:e}}),"buildPromptMessage"),Ia=n((e={})=>{let t=Oa(e,"query"),r=yt(e,"limit"),o=yt(e,"focus");return[`Research Knowgrph Source Files for: ${t}`,"","Use the MCP server read-only retrieval path:",`1. Call search with query=${JSON.stringify(t)}${r?` and limit=${JSON.stringify(r)}`:""}.`,"2. Select the most relevant returned ids and call fetch for each id before answering.","3. Ground the answer in fetched markdown content and cite the returned result URLs when summarizing.",o?`4. Prioritize this focus: ${o}.`:"","","Do not mutate graph, canvas, workspace, storage, or browser-local state for this research prompt."].filter(Boolean).join(`
`)},"buildSourceFilesResearchPromptText"),Ma=n((e={})=>{let t=yt(e,"focus");return["Inspect the Knowgrph agent-ready surface through the read-only inspect_agent_surface tool.","","Review health, API catalog, MCP server card, A2A card, agent skills, commerce discovery, and mcpAppsServerReadiness.","For MCP Apps readiness, verify tool/resource linkage, output schema, text fallback, structured content, sandbox/security metadata, no-auth security-scheme mirroring, widget accessibility, prompts, search/fetch retrieval, Streamable HTTP, and local stdio support.",t?`Emphasize this readiness area: ${t}.`:"","","Report checklist ids and evidence from structuredContent. Do not infer readiness from prose alone."].filter(Boolean).join(`
`)},"buildAgentSurfaceInspectionPromptText"),ho=n((e,t={})=>{let r=va(e);if(!r)throw new Error(`Unknown Knowgrph MCP prompt: ${Jt(e)}`);if(r.name===We.researchSourceFiles)return{description:r.description,messages:[po(Ia(t))]};if(r.name===We.inspectAgentSurface)return{description:r.description,messages:[po(Ma(t))]};throw new Error(`Unhandled Knowgrph MCP prompt: ${r.name}`)},"getKnowgrphAgentReadyPrompt");var Na=Object.freeze({sourceFileById:"knowgrph_source_file_by_id"}),wt="kgdoc://source-file/{id}",go="kgdoc://source-file/",fo="text/markdown",Qe=n(e=>String(e||"").trim(),"normalizeString"),yo=n(()=>[{uriTemplate:wt,name:Na.sourceFileById,title:"Knowgrph Source File By ID",description:"Read a complete published Knowgrph Source File markdown document using a stable kgdoc id returned by search.",mimeType:fo,annotations:{audience:["user","assistant"],priority:.8},_meta:{readOnly:!0,source:"knowgrph-source-files",tool:"fetch"}}],"buildKnowgrphAgentReadyResourceTemplateContracts");var wo=n(e=>{let t=Qe(e);if(!t.startsWith(go))return"";let r=t.slice(go.length);if(!r)return"";try{return decodeURIComponent(r)}catch{return r}},"parseKnowgrphSourceFileResourceUri"),So=n(({uri:e,sourceFile:t}={})=>{let r=typeof t?.content=="string"?t.content:String(t?.text||"");return{contents:[{uri:Qe(e),mimeType:fo,text:r,_meta:{id:Qe(t?.id),title:Qe(t?.title),url:Qe(t?.url),metadata:t?.metadata&&typeof t.metadata=="object"?{...t.metadata}:{}}}]}},"buildKnowgrphSourceFileResourceReadResult");var _t="io.modelcontextprotocol/ui",Ne="text/html;profile=mcp-app",Ao="2026-01-26",Ua="knowgrph-mcp-apps-server-readiness/v0.1",ie="ui://knowgrph/agent-ready",Zt="knowgrph-agent-ready",Ue="inspect_agent_surface",he=Object.freeze(["search","fetch"]),Xt=Object.freeze({search:Object.freeze(["ids"]),fetch:Object.freeze(["id","title","content","text"])}),_o=Object.freeze(Object.values(We)),Pe="streamable-http",La=Object.freeze([Object.freeze({type:"noauth"})]),ne=Object.freeze({openAiApps:"openai-apps",claude:"claude-mcp-connector",qwenCode:"qwen-code",kimiCli:"kimi-cli",bytePlusModelArk:"byteplus-modelark",generic:"generic-mcp"}),D=n(e=>String(e||"").trim(),"normalizeString"),St=n(e=>D(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),"escapeHtml"),$a=n(e=>JSON.stringify(e).replace(/</g,"\\u003c"),"safeJsonForInlineScript"),Ka=n(e=>{let t=D(e);if(!t)return"";try{return new URL(t).origin}catch{return""}},"readUrlOrigin"),er=n(()=>({extensions:{[_t]:{mimeTypes:[Ne]}}}),"buildKnowgrphMcpAppsCapabilities"),te=n(e=>Array.isArray(e)?e:[],"arrayFrom"),tr=n(()=>La.map(e=>({...e})),"buildKnowgrphMcpNoauthSecuritySchemes"),xo=n(e=>(Array.isArray(e)&&e.length?e:tr()).filter(r=>r&&typeof r=="object").map(r=>({...r})),"normalizeSecuritySchemes"),bo=n(e=>te(e).some(t=>t?.type==="noauth"),"hasNoauthSecurityScheme"),Po=n(e=>Array.isArray(e)?xo(e):[],"readSecuritySchemes"),Da=n(e=>{let t=D(e);return t.includes("window.openai")&&t.includes("openai:set_globals")&&t.includes("toolInput")&&t.includes("toolOutput")&&t.includes("callTool")&&t.includes("request('ui/initialize'")},"hasOpenAiWidgetBridgeHtml"),Ro=n((e,t=[])=>e?.outputSchema?.type==="object"&&t.every(r=>te(e.outputSchema?.required).includes(r)),"hasToolOutputSchemaFields"),Qt=n(e=>e?.annotations?.readOnlyHint===!0&&e?.annotations?.destructiveHint===!1&&e?.annotations?.openWorldHint===!1&&e?.annotations?.idempotentHint===!0,"hasReadOnlyToolAnnotations"),W=n((e,t,r,o=[])=>({id:e,label:t,ok:r===!0,evidence:te(o).map(D).filter(Boolean)}),"booleanCheck"),rr=n((e={})=>{let t=D(e.baseUrl).replace(/\/+$/,""),r=D(e.serverName)||"knowgrph",o=D(e.mcpUrl)||(t?`${t}/mcp`:"");return{[ne.openAiApps]:{id:ne.openAiApps,label:"OpenAI Apps / ChatGPT",transport:Pe,url:o,appResourceUri:ie,appToolName:Ue,requiredMetadata:["openai/outputTemplate","openai/widgetAccessible","openai/widgetCSP","openai/widgetDomain"],requiredTools:[Ue,...he]},[ne.claude]:{id:ne.claude,label:"Claude MCP connector",transport:Pe,url:o,beta:"mcp-client-2025-11-20",mcp_servers:[{type:"url",url:o,name:r}],tools:[{type:"mcp_toolset",mcp_server_name:r}],requiredTools:he},[ne.qwenCode]:{id:ne.qwenCode,label:"Qwen Code",transport:"http",url:o,command:`qwen mcp add --transport http ${r} ${o}`,settingsJson:{mcpServers:{[r]:{httpUrl:o,timeout:3e4,trust:!1,includeTools:["search","fetch",Ue]}}},requiredTools:he,primaryFlow:"Call search with a natural-language query, then call fetch with the returned kgdoc id."},[ne.kimiCli]:{id:ne.kimiCli,label:"Kimi CLI",transport:"http",url:o,command:`kimi mcp add --transport http ${r} ${o}`,configFile:"~/.kimi/mcp.json",mcpJson:{mcpServers:{[r]:{url:o,transport:"http"}}},requiredTools:he,primaryFlow:"Call search with a natural-language query, then call fetch with the returned kgdoc id."},[ne.bytePlusModelArk]:{id:ne.bytePlusModelArk,label:"BytePlus ModelArk Responses API",transport:Pe,url:o,apiBaseUrl:"https://ark.ap-southeast.bytepluses.com/api/v3",endpoint:"/responses",requiredHeaders:{"ark-beta-mcp":"true"},tools:[{type:"mcp",server_label:r,server_url:o,require_approval:"never"}],openAiCompatible:{base_url:"https://ark.ap-southeast.bytepluses.com/api/v3",default_headers:{"ark-beta-mcp":"true"},responsesCreate:{model:"<MODELARK_MODEL_OR_ENDPOINT_ID>",tools:[{type:"mcp",server_label:r,server_url:o,require_approval:"never"}]}},invocationScope:"ModelArk Responses API with MCP service and model permissions enabled.",requiredTools:he,primaryFlow:"Use ModelArk Responses API with the Knowgrph MCP tool entry, then ask the model to call search and fetch."},[ne.generic]:{id:ne.generic,label:"Generic MCP clients",transport:Pe,url:o,initialize:{method:"initialize",accept:["application/json","text/event-stream"]},requiredMethods:["initialize","notifications/initialized","tools/list","tools/call"],optionalMethods:["prompts/list","prompts/get","resources/list","resources/templates/list","resources/read"],requiredTools:he}}},"buildKnowgrphMcpClientSetups"),ko=n((e={})=>{let t=D(e.baseUrl).replace(/\/+$/,""),r=D(e.updatedAt),o=e.mcpServerCard&&typeof e.mcpServerCard=="object"?e.mcpServerCard:{},a=o.capabilities&&typeof o.capabilities=="object"?o.capabilities:{},s=te(e.tools).length?te(e.tools):te(a.tools),i=te(e.resources).length?te(e.resources):[bt({appUrl:t,updatedAt:r})],c=te(e.prompts).length?te(e.prompts):te(o.prompts),l=te(e.resourceTemplates).length?te(e.resourceTemplates):te(o.resourceTemplates),d=s.filter(w=>w?._meta?.ui?.resourceUri===ie),h=d.find(w=>w?.name===Ue)||d[0]||null,f=i.find(w=>w?.uri===ie)||null,R=a.extensions?.[_t],_=D(o.transport?.url)||(t?`${t}/mcp`:""),x=D(o.transport?.type)||Pe,H=D(e.appResourceHtml)||To({appUrl:t,updatedAt:r,toolName:h?.name||Ue}),U=e.clientSetups&&typeof e.clientSetups=="object"?e.clientSetups:rr({baseUrl:t,mcpUrl:_,serverName:o.serverInfo?.name}),K=h?.outputSchema&&typeof h.outputSchema=="object",re=!!h?.name,F=K,C=h?._meta?.["openai/outputTemplate"]===ie,O=Da(H),Y=bo(h?.securitySchemes)&&bo(h?._meta?.securitySchemes),L=Qt(h),J=h?._meta?.["openai/widgetAccessible"]===!0,I=c.map(w=>D(w?.name)).filter(Boolean),M=o.capabilities?.prompts&&typeof o.capabilities.prompts=="object",j=_o.every(w=>I.includes(w)),oe=l.map(w=>D(w?.uriTemplate)).filter(Boolean),le=oe.includes(wt),ye=Object.fromEntries(he.map(w=>[w,s.find(E=>E?.name===w)||null])),P=he.every(w=>{let E=ye[w];return Qt(E)&&Ro(E,Xt[w])}),y=U[ne.qwenCode],S=y?.transport==="http"&&y?.url===_&&y?.settingsJson?.mcpServers?.[o.serverInfo?.name||"knowgrph"]?.httpUrl===_&&String(y?.command||"").includes("--transport http")&&String(y?.command||"").includes(_),u=U[ne.kimiCli],m=u?.transport==="http"&&u?.url===_&&u?.mcpJson?.mcpServers?.[o.serverInfo?.name||"knowgrph"]?.url===_&&u?.mcpJson?.mcpServers?.[o.serverInfo?.name||"knowgrph"]?.transport==="http"&&String(u?.command||"").includes("kimi mcp add --transport http")&&String(u?.command||"").includes(_),g=U[ne.bytePlusModelArk],b=g?.transport===Pe&&g?.url===_&&g?.endpoint==="/responses"&&g?.requiredHeaders?.["ark-beta-mcp"]==="true"&&te(g?.tools).some(w=>w?.type==="mcp"&&w?.server_label===(o.serverInfo?.name||"knowgrph")&&w?.server_url===_&&w?.require_approval==="never")&&g?.openAiCompatible?.responsesCreate?.tools?.some(w=>w?.type==="mcp"&&w?.server_label===(o.serverInfo?.name||"knowgrph")&&w?.server_url===_&&w?.require_approval==="never"),N=[W("app-tool-resource-link","App tool is linked to the UI resource",d.length>0,d.map(w=>w.name)),W("output-schema","App tool exposes an output schema",K,[h?.name]),W("text-fallback","Tool result keeps a text fallback for non-UI hosts",re,[h?.name]),W("structured-content","Tool result returns structured content for the View",F,[h?.name]),W("resource-descriptor","MCP resource descriptor uses the MCP Apps MIME type",f?.mimeType===Ne,[f?.uri]),W("resource-security-meta","Resource declares UI sandbox metadata",f?._meta?.ui?.prefersBorder===!0&&!!f?._meta?.ui?.csp,[f?.uri]),W("openai-output-template","App tool exposes the OpenAI output template metadata key",C,[h?.name]),W("openai-widget-bridge","App resource supports the OpenAI Apps widget bridge",O,["window.openai","openai:set_globals"]),W("tool-security-schemes","App tool exposes no-auth securitySchemes and mirrors them in _meta",Y,[h?.name]),W("tool-impact-annotations","App tool exposes complete read-only impact annotations",L,[h?.name]),W("widget-accessible","App tool allows the widget bridge to call tools",J,[h?.name]),W("prompt-discovery","Server exposes MCP prompt templates for multi-host guidance",M&&j,I),W("source-file-resource-template","Server exposes a dynamic Source Files resource template",le,oe),W("deep-research-search-fetch","Server exposes read-only search and fetch tools",P,he),W("qwen-code-http-client-setup","Server advertises Qwen Code HTTP MCP setup",S,[y?.command]),W("kimi-cli-http-client-setup","Server advertises Kimi CLI HTTP MCP setup",m,[u?.command]),W("byteplus-modelark-responses-mcp-setup","Server advertises BytePlus ModelArk Responses API MCP setup",b,[g?.apiBaseUrl,g?.endpoint]),W("extension-capability","Server advertises the MCP Apps extension capability",R?.mimeTypes?.includes(Ne),[_t]),W("streamable-http-transport","Server exposes a stateless Streamable HTTP JSON-RPC transport",!!_&&x===Pe,[_,x]),W("stdio-transport","Repo-local MCP server supports stdio host configuration",e.localStdio!==!1,["node mcp/server.js"])],G=N.every(w=>w.ok);return{schemaVersion:Ua,ready:G,updatedAt:r,app:{name:Zt,protocolVersion:Ao,resourceUri:ie,resourceMimeType:Ne,extensionId:_t},tool:{name:h?.name||Ue,title:h?.title||"Inspect Agent Surface",resourceUri:h?._meta?.ui?.resourceUri||ie,visibility:te(h?._meta?.ui?.visibility).length?h._meta.ui.visibility:["model","app"],readOnly:h?.annotations?.readOnlyHint===!0,destructive:h?.annotations?.destructiveHint===!0,openWorld:h?.annotations?.openWorldHint===!0,idempotent:h?.annotations?.idempotentHint===!0,annotationsReady:L,hasOutputSchema:!!K,textFallback:re,structuredContent:F,openAiOutputTemplate:C,openAiWidgetBridge:O,securitySchemes:Po(h?.securitySchemes),mirroredSecuritySchemes:Po(h?._meta?.securitySchemes),widgetAccessible:J},resource:{uri:f?.uri||ie,name:f?.name||Zt,mimeType:f?.mimeType||Ne,prefersBorder:f?._meta?.ui?.prefersBorder===!0,domain:D(f?._meta?.ui?.domain),csp:f?._meta?.ui?.csp||{},openAiWidgetBridge:O},retrieval:{mode:"deep-research-search-fetch",requiredTools:he,tools:he.map(w=>{let E=ye[w];return{name:w,readOnly:E?.annotations?.readOnlyHint===!0,destructive:E?.annotations?.destructiveHint===!0,openWorld:E?.annotations?.openWorldHint===!0,idempotent:E?.annotations?.idempotentHint===!0,annotationsReady:Qt(E),requiredOutputFields:Xt[w],outputSchemaReady:Ro(E,Xt[w])}})},prompts:{requiredPrompts:_o,names:I,capability:!!M,ready:M&&j},resourceTemplates:{requiredTemplates:[wt],uriTemplates:oe,ready:le},clients:U,transports:[{id:"pages-http-jsonrpc",type:x,url:_,stateless:!0,serverFactory:!0},{id:"local-stdio-jsonrpc",type:"stdio",command:"node mcp/server.js",stateless:!1,serverFactory:!0}],dataModel:{source:"inspect_agent_surface.structuredContent",categories:[{id:"discovery",label:"Discovery metadata",count:["health","apiCatalog","openApi","mcpServerCard","agentCard","agentSkills"].length},{id:"commerce",label:"Commerce discovery",count:["acpDiscovery","ucpProfile","mppOpenApi"].length},{id:"mcp-apps",label:"MCP Apps server bindings",count:N.length}],renderMode:"structured-summary-with-json-fallback"},checklist:N}},"buildKnowgrphMcpAppsServerReadiness"),Eo=n((e={})=>{let t=D(e.resourceUri)||ie;return{securitySchemes:xo(e.securitySchemes),ui:{resourceUri:t,visibility:Array.isArray(e.visibility)&&e.visibility.length?e.visibility:["model","app"]},"openai/outputTemplate":t,"openai/widgetAccessible":e.widgetAccessible!==!1,"openai/toolInvocation/invoking":D(e.invoking)||"Inspecting Knowgrph.","openai/toolInvocation/invoked":D(e.invoked)||"Knowgrph is ready."}},"buildKnowgrphMcpAppsToolMeta"),Co=Object.freeze({type:"object",additionalProperties:!0,required:["baseUrl","healthUrl","mcpUrl"],properties:{baseUrl:{type:"string"},healthUrl:{type:"string"},mcpUrl:{type:"string"},apiCatalogUrl:{type:"string"},openApiUrl:{type:"string"},mcpServerCardUrl:{type:"string"},agentCardUrl:{type:"string"},agentSkillsUrl:{type:"string"},commerceUrls:{type:"object",additionalProperties:{type:"string"}},health:{type:"object",additionalProperties:!0},apiCatalog:{type:"object",additionalProperties:!0},openApi:{type:"object",additionalProperties:!0},mcpServerCard:{type:"object",additionalProperties:!0},agentCard:{type:"object",additionalProperties:!0},agentSkills:{type:"object",additionalProperties:!0},commerce:{type:"object",additionalProperties:!0},mcpAppsServerReadiness:{type:"object",additionalProperties:!0}}}),bt=n((e={})=>{let t=D(e.appUrl),r=D(e.updatedAt),o=D(e.domain)||Ka(t),a={connectDomains:[],resourceDomains:[],frameDomains:[],baseUriDomains:[]};return{uri:ie,name:Zt,description:["Interactive MCP Apps view for the existing Knowgrph agent-ready surface.",t?`App URL: ${t}`:"",r?`Updated: ${r}`:""].filter(Boolean).join(" "),mimeType:Ne,_meta:{ui:{csp:a,...o?{domain:o}:{},prefersBorder:!0},"openai/widgetDescription":"Interactive Knowgrph agent-ready server-readiness view.","openai/widgetPrefersBorder":!0,...o?{"openai/widgetDomain":o}:{},"openai/widgetCSP":{connect_domains:a.connectDomains,resource_domains:a.resourceDomains,frame_domains:a.frameDomains}}}},"buildKnowgrphMcpAppsResourceDescriptor"),To=n((e={})=>{let t=D(e.appUrl),r=D(e.updatedAt),o=D(e.toolName)||Ue,a=Array.isArray(e.toolNames)?e.toolNames.map(D).filter(Boolean):[o],s={appUrl:t,updatedAt:r,resourceUri:ie,toolName:o,toolNames:a,protocolVersion:Ao};return`<!doctype html>
<html lang="en">
<head>
  <meta charset="utf-8">
...
}`;var Rt={push:"/api/storage/push",pull:"/api/storage/pull",collabSave:"/api/storage/collab/save",exportPrefix:"/api/storage/export/",docPrefix:"/api/storage/doc/",defaultDocPrefix:"/api/storage/doc-default/",blobPrefix:"/api/storage/blob/",sourceFilesIndex:"/api/storage/source-files",sourceFilesIndexPrefix:"/api/storage/source-files/",sourceFilesLlms:"/api/storage/llms.txt"};var Yo=n((e,t)=>`${Rt.docPrefix}${encodeURIComponent(String(e||"").trim())}/${encodeURIComponent(String(t||"").trim())}`,"buildKnowgrphStorageDocPath"),Jo=n(e=>`${Rt.defaultDocPrefix}${encodeURIComponent(String(e||"").trim())}`,"buildKnowgrphStorageDefaultDocPath");var Xo=n(e=>{let t=String(e||"").trim();return t?`${Rt.sourceFilesIndexPrefix}${encodeURIComponent(t)}`:Rt.sourceFilesIndex},"buildKnowgrphStorageSourceFilesIndexPath");var B="https://airvio.co",At="https://knowgrph-storage.huijoohwee.workers.dev",T="/knowgrph",k=`${B}${T}/`,Qo=`${B}/`,et="kgws:canonical-docs",Re="2026-06-05",qe=`${T}/health`,ze=`${B}${qe}`,Zo="/.well-known/agent-card.json",dr=`${T}/.well-known/agent-card.json`,xt=`${B}${Zo}`,mr=`${B}/api/storage/source-files`,ss=`${B}/api/storage/doc-default/{canonicalPath}`,is=`${B}/api/storage/doc/{workspaceId}/{canonicalPath}`,cs=`${B}/api/storage/blob/{workspaceId}/{canonicalPath}`,en="knowgrph-agent-ready-pages";var tn=['</.well-known/api-catalog>; rel="api-catalog"; type="application/linkset+json"',`<${T}/.well-known/openapi.json>; rel="service-desc"; type="application/vnd.oai.openapi+json;version=3.1"`,`<${T}/llms.txt>; rel="service-doc"; type="text/plain"`,'</auth.md>; rel="service-doc"; type="text/markdown"',`<${qe}>; rel="status"; type="application/health+json"`,`<${T}/.well-known/mcp/server-card.json>; rel="mcp-server-card"; type="application/json"`,`<${Zo}>; rel="describedby"; type="application/json"`].join(", "),rn=`# Knowgrph
...
- Auth.md registration instructions: ${Qo}auth.md
- Health: ${ze}
...
Sitemap: ${e}
`,"buildRobotsTxt"),ds=n(e=>`<?xml version="1.0" encoding="UTF-8"?>
...
`,"buildSitemapXml"),ms=us(`${k}sitemap.xml`),hs=ds(k),mn={linkset:[{anchor:k,"service-desc":[{href:`${k}.well-known/openapi.json`,type:"application/vnd.oai.openapi+json;version=3.1"}],"service-doc":[{href:`${k}llms.txt`,type:"text/plain"}],status:[{href:ze,type:"application/health+json"}],"service-meta":[{href:`${k}.well-known/mcp/server-card.json`,type:"application/json"},{href:xt,type:"application/json"}]}]},hn={openapi:"3.1.0",info:{title:"Knowgrph API",version:"0.1.0",description:"Agent discovery surface for the Knowgrph Cloudflare deployment."},servers:[{url:B,description:"Knowgrph Cloudflare deployment"}],paths:Ho({appBasePath:T,appA2aAgentCardPath:dr,healthPath:qe})},ot={resource:k,resource_name:"Knowgrph",authorization_servers:[B],scopes_supported:["knowgrph:read","knowgrph:source-files:read"],bearer_methods_supported:["header"],resource_documentation:`${k}llms.txt`},hr=`${B}/cdn-cgi/access`,xe={skill:`${B}/auth.md`,register_uri:`${k}agent/auth`,claim_uri:`${k}agent/auth/claim`,revocation_uri:`${k}agent/auth/revoke`,identity_types_supported:["anonymous","identity_assertion"],anonymous:{credential_types_supported:["api_key"]},identity_assertion:{assertion_types_supported:["urn:ietf:params:oauth:token-type:id-jag","verified_email"],credential_types_supported:["access_token","api_key"]},events_supported:["https://schemas.workos.com/events/agent/auth/identity/assertion/revoked"],registration_status:"metadata_published_runtime_user_mediated"},sn={issuer:B,resource:ot.resource,resource_name:ot.resource_name,authorization_servers:ot.authorization_servers,cloudflare_access_issuer:hr,authorization_endpoint:`${hr}/login`,token_endpoint:`${hr}/token`,jwks_uri:`${k}.well-known/http-message-signatures-directory`,response_types_supported:["code"],grant_types_supported:["authorization_code","client_credentials"],token_endpoint_auth_methods_supported:["client_secret_basic","private_key_jwt"],scopes_supported:ot.scopes_supported,agent_auth:xe},gs=`# Knowgrph auth.md
...
- Pipeline rule: agents must not bypass MainPanel -> FloatingPanel Chat -> KGC -> Canvas for user-mediated graph work; published HTTP MCP tools remain read-only until mutation auth and conflict semantics are implemented.`,gn={name:"Knowgrph Agent",description:"Agent-readable discovery, published-document retrieval, and WebMCP-ready metadata surface for Knowgrph.",version:"0.1.0",provider:{organization:"airvio / joohwee",url:k},url:`${k}mcp`,preferredTransport:"JSONRPC",supportedInterfaces:[{url:`${k}mcp`,protocolBinding:"JSONRPC",transportProtocol:"JSONRPC",description:"Primary machine interface for read-only discovery and source-file document access."},{url:mr,protocolBinding:"HTTP+JSON/REST",transportProtocol:"HTTP+JSON/REST",description:"Published source-files index and storage-backed document read surface."}],capabilities:{streaming:!1,pushNotifications:!1,stateTransitionHistory:!1,extendedAgentCard:!1},defaultInputModes:["text/plain","text/markdown","application/json"],defaultOutputModes:["text/plain","text/markdown","application/json"],skills:Ko(kt)},Oe={serverInfo:{name:"knowgrph",version:"0.1.0"},transport:{type:Pe,url:`${k}mcp`,stateless:!0},capabilities:{tools:kt.map(e=>({name:e.name,title:e.title,description:e.description,inputSchema:e.inputSchema,outputSchema:e.outputSchema,securitySchemes:e.securitySchemes,annotations:e.annotations,_meta:e._meta})),resources:{listChanged:!1},prompts:{listChanged:!1},...er()},prompts:pn,resourceTemplates:un,clientSetups:rr({baseUrl:k,mcpUrl:`${k}mcp`,serverName:"knowgrph"}),links:{apiCatalog:`${k}.well-known/api-catalog`,skills:`${k}.well-known/agent-skills/index.json`,status:ze,agentCard:xt}},fs=bt({appUrl:k,updatedAt:Re}),yr=kt.map(e=>({name:e.webName,title:e.title,description:e.description,inputSchema:e.inputSchema,outputSchema:e.outputSchema,securitySchemes:e.securitySchemes,annotations:e.annotations,_meta:e._meta})),$e=n(e=>nt(kt.find(t=>t.name===e)?.webName),"findWebMcpToolName"),ys=$e(p.search),ws=$e(p.fetch),Ss=$e(p.listSourceFiles),_s=$e(p.readSourceFile),bs=$e(p.readSharedDocument),Ps=$e(p.inspectSharedDocumentStructure),Rs=$e(p.inspectAgentSurface),As=`(() => {
  ...
  const createPublishedAgentReadyToolExecutors = ${Oo};
  ...
  const toolExecutors = createPublishedAgentReadyToolExecutors({
    toolNames: {
      ...
      fetch: ${JSON.stringify(ws)},
      listSourceFiles: ${JSON.stringify(Ss)},
      readSourceFile: ${JSON.stringify(_s)},
      readSharedDocument: ${JSON.stringify(bs)},
      inspectSharedDocumentStructure: ${JSON.stringify(Ps)},
      inspectAgentSurface: ${JSON.stringify(Rs)},
    },
    defaultWorkspaceId,
...
})();`,xs=n(async e=>{if(!(e.headers.get("content-type")||"").toLowerCase().includes("text/html"))return e;let r=await e.text();if(yr.every(i=>r.includes(i.name)))return new Response(r,e);let o=`<script>${As}<\/script>`,a=r.includes("</head>")?r.replace("</head>",`${o}</head>`):`${r}${o}`,s=new Response(a,e);return s.headers.delete("content-length"),s},"injectWebMcpScript"),ks={search:p.search,fetch:p.fetch,listSourceFiles:p.listSourceFiles,readSourceFile:p.readSourceFile,readSharedDocument:p.readSharedDocument,inspectSharedDocumentStructure:p.inspectSharedDocumentStructure,inspectAgentSurface:p.inspectAgentSurface},Es=n(async e=>{let t=new TextEncoder().encode(e),r=await crypto.subtle.digest("SHA-256",t);return[...new Uint8Array(r)].map(o=>o.toString(16).padStart(2,"0")).join("")},"sha256Hex"),fn=$o(),Cs=Object.fromEntries(Ze.map(e=>[e.name,Es(fn[e.name]||"")])),cn=new Map(Ze.map(e=>[`${T}${e.path}`.replace(/\/+$/,""),fn[e.name]||""]));var yn=n(async()=>Do({appUrl:k,updatedAt:Re,sha256ByName:Cs}),"agentSkillsIndex"),Ts={keys:[{kty:"OKP",crv:"Ed25519",kid:"knowgrph-agent-ready-2026-05-21",use:"sig",alg:"EdDSA",x:"11qYAYdkVKxA4G0wV47IxPtYfFVH_H7zmC2Di2PcvLU"}]},vs={protocolVersion:"2025-06-18",capabilities:{tools:{},resources:{},prompts:{listChanged:!1},...er()},serverInfo:Oe.serverInfo},wr=Oe.capabilities.tools,Os=[fs],Is=pn,Ms=un,wn=n(()=>({status:"pass",service:"knowgrph-agent-ready-pages",homepage:k,health:ze,updatedAt:Re,checks:{linkHeaders:!0,markdownNegotiation:!0,httpMcp:!0,webMcp:!0,mcpApps:!0,commerce:{acp:!0,ucp:!0,mpp:!0,x402:!0},defaultWorkspaceId:et}}),"buildHealthStatusBody"),Ns=n(async()=>vo({baseUrl:k,health:wn(),apiCatalog:mn,openApi:hn,mcpServerCard:Oe,agentCard:gn,agentSkills:await yn(),commerce:Yt({origin:B})}),"buildAgentSurfaceInspection"),Us=ar({toolNames:ks,defaultWorkspaceId:et,publicBaseUrl:B,buildStorageDocPath:dn,fetchSourceFilesIndexResponse:n(()=>fetch(`${At}${Xo()}`,{headers:{accept:"text/markdown"}}),"fetchSourceFilesIndexResponse"),fetchStorageMarkdownResponse:n(e=>fetch(`${At}${e}`,{headers:{accept:"text/markdown"}}),"fetchStorageMarkdownResponse"),resolveSharedDocumentInput:n((e={})=>Pt({shareToken:e?.shareToken,shareUrl:e?.shareUrl,appBasePath:T,baseUrl:B}),"resolveSharedDocumentInput"),inspectSharedDocumentStructure:Io,buildAgentSurfaceInspection:Ns}),Sr=n(e=>{try{let t=new URL(e,B);return Pt({shareUrl:`${t.pathname}${t.search}`,baseUrl:B,appBasePath:T})}catch{return null}},"resolvePublishedDocRequestIdentity"),Ls=n(e=>Pt({shareUrl:String(e||""),baseUrl:B,appBasePath:T}),"resolvePublishedDocPathIdentity"),$s=n(async(e,t)=>{let r=new URL(dn(t.canonicalPath,t.workspaceId),At),o=await fetch(r,{method:"GET",headers:{accept:"text/markdown, text/plain;q=0.9, */*;q=0.1"}}),a=new Headers(o.headers),s=String(a.get("vary")||"");return a.set("vary",s?`${s}, Accept`:"Accept"),new Response(String(e.method||"").toUpperCase()==="HEAD"?null:o.body,{status:o.status,statusText:o.statusText,headers:a})},"proxyPublishedDocMarkdownResponse"),Ks=n(async e=>{try{let t=await e.json();return t&&typeof t=="object"?t:null}catch{return null}},"readJsonRpcRequest"),Ae=n((e,t)=>Et(200,{jsonrpc:"2.0",id:e??null,result:t}),"jsonRpcResult"),ve=n((e,t,r)=>Et(200,{jsonrpc:"2.0",id:e??null,error:{code:t,message:r}}),"jsonRpcError"),Ds=n(e=>String(e.headers.get("accept")||"").toLowerCase().split(",").some(t=>t.trim().startsWith("text/event-stream")),"requestAcceptsEventStream"),gr=n((e,t)=>Object.prototype.hasOwnProperty.call(e,t),"hasOwnProperty"),Sn=n(e=>{if(Array.isArray(e))return e.length>0&&e.every(Sn);if(!e||typeof e!="object"||String(e.jsonrpc||"")!=="2.0")return!1;let t=typeof e.method=="string"&&e.method.length>0,r=gr(e,"id"),o=gr(e,"result")||gr(e,"error");return t&&!r||!t&&o},"isJsonRpcNotificationOrResponse"),_n=n(async(e,t)=>{let r=Us[e];if(typeof r!="function")throw new Error(`unknown tool: ${e}`);return r(t)},"executeMcpTool"),Hs=n(async e=>{let t=nt(e);if(t===ie)return or({appUrl:k,updatedAt:Re,toolNames:wr.map(o=>o.name)});let r=wo(t);if(r){let o=await _n(p.fetch,{id:r});return So({uri:t,sourceFile:o})}throw new Error(`unknown resource: ${e}`)},"readMcpResource"),js=n(async e=>{let t=String(e.method||"GET").toUpperCase();if(t==="GET"||t==="HEAD")return Ds(e)?an(405,{allow:"POST"}):ge({ok:!0,transport:Oe.transport,serverInfo:Oe.serverInfo,capabilities:Oe.capabilities});if(t!=="POST")return Et(405,{ok:!1,error:"unsupported_method"});let r=await Ks(e);if(!r)return ve(null,-32700,"Parse error");if(Sn(r))return an(202);if(Array.isArray(r))return ve(null,-32600,"Batch JSON-RPC requests are not supported");switch(r.method){case"initialize":return Ae(r.id,vs);case"tools/list":return Ae(r.id,{tools:wr});case"prompts/list":return Ae(r.id,{prompts:Is});case"resources/templates/list":return Ae(r.id,{resourceTemplates:Ms});case"prompts/get":{let o=nt(r.params?.name),a=r.params?.arguments&&typeof r.params.arguments=="object"?r.params.arguments:{};if(!o)return ve(r.id,-32602,"Prompt name is required");try{return Ae(r.id,ho(o,a))}catch(s){return ve(r.id,-32602,s instanceof Error?s.message:String(s))}}case"resources/list":return Ae(r.id,{resources:Os});case"resources/read":{let o=nt(r.params?.uri);if(!o)return ve(r.id,-32602,"Resource URI is required");try{return Ae(r.id,await Hs(o))}catch(a){return ve(r.id,-32602,a instanceof Error?a.message:String(a))}}case"tools/call":{let o=nt(r.params?.name),a=r.params?.arguments&&typeof r.params.arguments=="object"?r.params.arguments:{};if(!o)return ve(r.id,-32602,"Tool name is required");try{let s=await _n(o,a);return Ae(r.id,{content:[{type:"text",text:typeof s?.markdown=="string"?s.markdown:JSON.stringify(s,null,2)}],structuredContent:s,isError:!1})}catch(s){return Ae(r.id,{content:[{type:"text",text:s instanceof Error?s.message:String(s)}],isError:!0})}}default:return ve(r.id,-32601,"Method not found")}},"handleMcpTransport"),Bs=n(()=>or({appUrl:k,updatedAt:Re,toolNames:wr.map(e=>e.name)}).contents[0].text,"buildKnowgrphMcpAppHtmlBody");var _r=n(e=>e===T||e===`${T}/`,"handlesKnowgrphRoot"),Fs=n(e=>_r(e)||!!Ls(e),"handlesKnowgrphHtmlSurface"),Gs=n(e=>{let t=new URL(e.url),r=t.pathname.replace(/\/+$/,"")||"/",o=Sr(e.url);return r===qe?"health":r===`${T}/mcp`?"mcp":r===`${T}/robots.txt`?"robots":r===`${T}/sitemap.xml`?"sitemap":r===`${T}/auth.md`||r==="/auth.md"?"auth-md":r.startsWith(`${T}/.well-known/`)?"well-known":o?tt(e)?"shared-doc-markdown":"shared-doc-html":_r(t.pathname)?tt(e)?"homepage-markdown":"homepage-html":"app-surface"},"resolveAgentReadyRouteTag"),fr=n((e,t)=>nn(t,{owner:en,tag:Gs(e)}),"withKnowgrphRouteHeaders"),ln=n(async e=>{let t=new URL(e.url),r=t.pathname.replace(/\/+$/,"")||"/",o=Sr(e.url);if(o&&tt(e))return $s(e,o);if(_r(t.pathname)&&tt(e))return on(rn);switch(r){case qe:return ps(wn());case`${T}/mcp`:return js(e);case`${T}/robots.txt`:return rt(ms,"text/plain; charset=utf-8");case`${T}/sitemap.xml`:return rt(hs,"application/xml; charset=utf-8");case`${T}/auth.md`:case"/auth.md":return rt(gs,"text/markdown; charset=utf-8");case`${T}/.well-known/api-catalog`:return ge(mn,"application/linkset+json; charset=utf-8");case`${T}/.well-known/openapi.json`:return ge(hn,"application/vnd.oai.openapi+json; charset=utf-8");case dr:return ge(gn);case`${T}/.well-known/oauth-protected-resource`:return ge(ot);case`${T}/.well-known/oauth-authorization-server`:return ge(sn);case`${T}/.well-known/openid-configuration`:return ge(sn);case`${T}/.well-known/mcp/server-card.json`:return ge(Oe);case`${T}/.well-known/mcp/apps/knowgrph-agent-ready.html`:return ls(Bs());case`${T}/.well-known/mcp.json`:return ge(Oe);case`${T}/.well-known/agent-skills/index.json`:return ge(await yn());case`${T}/.well-known/http-message-signatures-directory`:return ge(Ts);default:return cn.has(r)?rt(cn.get(r),"text/markdown; charset=utf-8"):null}},"routeResponse");async function Ie(e){let{env:t,request:r}=e,o=String(r.method||"GET").toUpperCase(),a=new URL(r.url);if(o==="OPTIONS")return new Response(null,{status:204,headers:{"access-control-allow-origin":"*","access-control-allow-methods":"GET, HEAD, POST, OPTIONS","access-control-allow-headers":"*","access-control-max-age":"86400"}});if(o==="POST"&&a.pathname.replace(/\/+$/,"")===`${T}/mcp`)return fr(r,await ln(r));if(o!=="GET"&&o!=="HEAD")return Et(405,{ok:!1,error:"unsupported_method"});let s=await ln(r);if(s){let d=fr(r,s);return o==="HEAD"?new Response(null,d):d}let i=Sr(r.url)?await jo(e,T):await e.next();if(!Fs(a.pathname))return i;let c=o==="HEAD"?i:await xs(i),l=new Response(o==="HEAD"?null:c.body,c);return l.headers.set("link",tn),fr(r,l)}n(Ie,"onRequest");async function bn(e){return Ie(e)}n(bn,"onRequest");async function Pn(e){return Ie(e)}n(Pn,"onRequest");async function Rn(e){return Ie(e)}n(Rn,"onRequest");var Ws=Object.freeze(new Set(["","80","443"])),zs=Object.freeze([".local",".localhost",".internal"]),qs=Object.freeze(new Set(["localhost"]));function Ke(e){return String(e||"").trim().toLowerCase()}n(Ke,"normalizeHostname");function Vs(e){let t=Ke(e);if(!/^\d{1,3}(\.\d{1,3}){3}$/.test(t))return!1;let r=t.split(".").map(o=>Number(o));return r.length!==4?!1:r.every(o=>Number.isInteger(o)&&o>=0&&o<=255)}n(Vs,"isIpv4Literal");function An(e){let[t,r,o,a]=e.split(".").map(s=>Number(s));return(t<<24|r<<16|o<<8|a)>>>0}n(An,"ipv4ToInt");function Ys(e,t,r){if(!Number.isInteger(r)||r<0||r>32)return!1;if(r===0)return!0;let o=4294967295<<32-r>>>0;return(e&o)===(t&o)}n(Ys,"inIpv4Cidr");function Js(e){let t=Ke(e);return!t||!t.includes(":")?!1:/^[0-9a-f:]+$/i.test(t)}n(Js,"isIpv6Literal");function Xs(e){let t=Ke(e);return!!(!t||t==="::1"||t==="0:0:0:0:0:0:0:1"||t.startsWith("fc")||t.startsWith("fd")||/^fe[89ab]/i.test(t))}n(Xs,"isBlockedIpv6");function Qs(e,{blockedExact:t,blockedSuffixes:r}={}){let o=Ke(e);if(!o)return!0;let a=t||qs;if(a instanceof Set&&a.has(o))return!0;let s=r||zs;if(Array.isArray(s))for(let i of s){let c=Ke(i);if(c&&(o===c||o.endsWith(c)))return!0}return!1}n(Qs,"isBlockedHostname");function Zs(e){let t=Ke(e);if(!t)return!0;if(Vs(t)){let r=An(t),o=[{base:"0.0.0.0",bits:8},{base:"10.0.0.0",bits:8},{base:"127.0.0.0",bits:8},{base:"169.254.0.0",bits:16},{base:"172.16.0.0",bits:12},{base:"192.168.0.0",bits:16},{base:"100.64.0.0",bits:10}];for(let a of o){let s=An(a.base);if(Ys(r,s,a.bits))return!0}return!1}return Js(t)?Xs(t):!1}n(Zs,"isBlockedIpLiteral");function Ct(e,{allowedPorts:t}={}){let r=String(e||"").trim();if(!r)throw new Error("invalid_url");let o;try{o=new URL(r)}catch{throw new Error("invalid_url")}if(o.protocol!=="http:"&&o.protocol!=="https:")throw new Error("invalid_url");if(o.username||o.password)throw new Error("invalid_url");let a=t||Ws,s=String(o.port||"");if(a instanceof Set&&!a.has(s))throw new Error("port_not_allowed");let i=Ke(o.hostname);if(!i)throw new Error("invalid_url");if(Qs(i))throw new Error("blocked_host");if(Zs(i))throw new Error("blocked_host");return o}n(Ct,"parseAndValidateExternalUrl");function Tt(e){return String(e.headers.get("sec-fetch-site")||"").trim().toLowerCase()==="cross-site"}n(Tt,"shouldRejectCrossSiteFetch");var ei={"content-type":"application/json; charset=utf-8","cache-control":"public, max-age=600"};function De(e,t={}){return new Response(JSON.stringify(e),{...t,headers:{...ei,...t.headers||{}}})}n(De,"json");function vt(...e){for(let t of e){if(!t)continue;let r=String(t).trim();if(r)return r}return null}n(vt,"pickFirst");function ti(e){let t=e.slice(0,8e4),r=t.match(/<title[^>]*>([^<]*)<\/title>/i),o=t.match(/<meta[^>]+property=["']og:title["'][^>]*content=["']([^"']+)["'][^>]*>/i),a=t.match(/<meta[^>]+property=["']og:description["'][^>]*content=["']([^"']+)["'][^>]*>/i),s=t.match(/<meta[^>]+name=["']description["'][^>]*content=["']([^"']+)["'][^>]*>/i),i=t.match(/<meta[^>]+property=["']og:image["'][^>]*content=["']([^"']+)["'][^>]*>/i),c=t.match(/<meta[^>]+property=["']og:site_name["'][^>]*content=["']([^"']+)["'][^>]*>/i);return{title:vt(o?.[1],r?.[1]),description:vt(a?.[1],s?.[1]),image:vt(i?.[1]),siteName:vt(c?.[1])}}n(ti,"extractMeta");async function xn(e){let t=e.request.url,r=new URL(t);if(r.searchParams.get("ping")==="1")return De({ok:!0,ping:!0});let o=r.searchParams.get("url")||"";if(Tt(e.request))return De({ok:!1,error:"forbidden"},{status:403,headers:{"cache-control":"no-store"}});let a;try{a=Ct(o)}catch{return De({ok:!1,error:"invalid_url"},{status:400,headers:{"cache-control":"no-store"}})}try{let s=await fetch(a.toString(),{headers:{"user-agent":"Mozilla/5.0 (compatible; HackaMapLinkPreview/1.0)",accept:"text/html,application/xhtml+xml"},redirect:"follow",cf:{cacheTtl:600,cacheEverything:!0}}),i=s.headers.get("content-type")||"";if(!s.ok)return De({ok:!1,error:"fetch_failed",status:s.status,url:a.toString()},{status:200,headers:{"cache-control":"no-store"}});if(!i.includes("text/html"))return De({ok:!0,url:a.toString(),domain:a.host,contentType:i,title:null,description:null,image:null,siteName:null});let c=await s.text(),l=ti(c);return De({ok:!0,url:a.toString(),domain:a.host,contentType:i,...l})}catch(s){return De({ok:!1,error:"exception",message:s?.message||String(s),url:a.toString()},{status:200,headers:{"cache-control":"no-store"}})}}n(xn,"onRequestGet");var kn=35e4;function ri(e){let t=e;return t=t.replace(/<script\b[\s\S]*?<\/script>/gi,""),t=t.replace(/<iframe\b[\s\S]*?<\/iframe>/gi,""),t=t.replace(/<object\b[\s\S]*?<\/object>/gi,""),t=t.replace(/<embed\b[\s\S]*?>/gi,""),t=t.replace(/<noscript\b[\s\S]*?<\/noscript>/gi,""),t=t.replace(/\son[a-z]+\s*=\s*"[^"]*"/gi,""),t=t.replace(/\son[a-z]+\s*=\s*'[^']*'/gi,""),t}n(ri,"stripActiveContent");function oi({url:e,title:t,innerHtml:r}){let o=t?String(t).slice(0,140):"Preview",a=String(e).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;");return`<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
...
</html>`}n(oi,"buildWrapper");async function En(e){let r=new URL(e.request.url).searchParams.get("url")||"";if(Tt(e.request))return new Response("Forbidden",{status:403,headers:{"cache-control":"no-store"}});let o;try{o=Ct(r)}catch(a){let s=a instanceof Error?a.message:"invalid_url";return new Response(s,{status:400,headers:{"cache-control":"no-store"}})}try{let a=await fetch(o.toString(),{headers:{"user-agent":"Mozilla/5.0 (compatible; HackaMapLinkProxy/1.0)",accept:"text/html,application/xhtml+xml"},redirect:"follow",cf:{cacheTtl:600,cacheEverything:!0}}),s=a.headers.get("content-type")||"";if(!a.ok)return new Response(`Fetch failed (${a.status})`,{status:200,headers:{"content-type":"text/plain; charset=utf-8","cache-control":"no-store"}});if(!s.includes("text/html"))return new Response(`Unsupported content-type: ${s}`,{status:200,headers:{"content-type":"text/plain; charset=utf-8","cache-control":"public, max-age=600"}});let i=await a.text();i.length>kn&&(i=i.slice(0,kn));let l=i.match(/<title[^>]*>([^<]*)<\/title>/i)?.[1]?.trim()||o.host;i=ri(i),/<base\s/i.test(i)||(i=i.replace(/<head([^>]*)>/i,`<head$1><base href="${o.origin}/">`));let h=oi({url:o.toString(),title:l,innerHtml:i});return new Response(h,{status:200,headers:{"content-type":"text/html; charset=utf-8","cache-control":"public, max-age=600","content-security-policy":"default-src 'none'; img-src https: data:; style-src 'unsafe-inline' https:; font-src https: data:; frame-ancestors 'self';"}})}catch(a){return new Response(`Exception: ${a?.message||String(a)}`,{status:200,headers:{"content-type":"text/plain; charset=utf-8","cache-control":"no-store"}})}}n(En,"onRequestGet");var br="api.openai.com",Ot="api.miromind.ai",It="apihub.agnes-ai.com",Mt="ark.ap-southeast.bytepluses.com",Pr="ark.eu-west.bytepluses.com",Tn=new Set(["localhost","127.0.0.1","0.0.0.0"]),_e=n(e=>String(e||"").trim().toLowerCase(),"normalizeHost"),fe=n((e,t)=>String(e.get(t)||"").trim(),"readHeader"),vn=n(e=>Tn.has(_e(e)),"isLocalHost"),Cn=n(e=>{let t=String(e||"").trim();if(!t)return new Set;let r=new Set;return t.split(",").map(o=>_e(o)).filter(Boolean).forEach(o=>r.add(o)),r},"parseCsvSet"),On=n((e,{includeOpenAi:t=!1,includeMiroMind:r=!1,includeAgnes:o=!1,includeBytePlus:a=!1}={})=>{let s=Cn(e.KNOWGRPH_INTEGRATION_ALLOWED_HOSTS),i=Cn(e.KNOWGRPH_CHAT_PROXY_ALLOWED_HOSTS),c=s.size?s:i,l=c.size?c:new Set([...Tn]);return t&&l.add(br),r&&l.add(Ot),o&&l.add(It),a&&(l.add(Mt),l.add(Pr)),l},"parseAllowedHosts"),ae=n(e=>{let t=fe(e.headers,"origin");if(!t)return{};let r="";try{r=_e(new URL(t).host)}catch{return{}}let o=_e(new URL(e.url).host);return r===o||r.startsWith("localhost:")||r.startsWith("127.0.0.1:")?{"access-control-allow-origin":t,vary:"Origin"}:{}},"corsHeaders"),de=n((e,t,r)=>new Response(JSON.stringify(t),{status:r,headers:{"content-type":"application/json; charset=utf-8","cache-control":"no-store",...ae(e)}}),"jsonResponse");var Nt={"content-type":"application/json; charset=utf-8","cache-control":"no-store"};function at(e,t,r=200){return new Response(JSON.stringify(t),{status:r,headers:{...Nt,...ae(e)}})}n(at,"jsonResponse");async function ni(e){let t=new URL("/knowgrph/imports/hackamap/hackamap-graph.json",e.url),r=await fetch(t.toString(),{redirect:"follow"});return r.ok?await r.json():null}n(ni,"fetchHackamapGraphJson");async function He(e,t){let r=new URL(t,e.url),o=await fetch(r.toString(),{redirect:"follow"});return o.ok?await o.json():null}n(He,"fetchHackamapJson");async function ai(e){let t=await He(e,"/knowgrph/imports/hackamap/hackamap_api_graph.json");return Un(t)?t:null}n(ai,"fetchHackamapApiGraphJson");async function si(e){let t=await He(e,"/knowgrph/imports/hackamap/hackamap_pipeline.json");return t&&typeof t=="object"&&!Array.isArray(t)?t:{}}n(si,"fetchHackamapPipelineJson");async function Mn(e){let t=await He(e,"/knowgrph/imports/hackamap/hackamap_query_presets.json");return Array.isArray(t)?t.filter(Boolean):[]}n(Mn,"fetchHackamapQueryPresetsJson");async function Nn(e){let t=await He(e,"/knowgrph/imports/hackamap/query-outputs/query-runs.manifest.json");return t&&typeof t=="object"&&!Array.isArray(t)?t:{}}n(Nn,"fetchHackamapQueryRunsManifestJson");function Un(e){return!e||typeof e!="object"||Array.isArray(e)?!1:Array.isArray(e.nodes)&&Array.isArray(e.edges)}n(Un,"isApiGraphPayload");function Ln(e,t){let r=String(e&&e.output&&e.output.per_table_prefix||e?.id||t?.preset||"").trim(),o=String(t?.output_suffix||"").trim();return o?`${r}-${o}`:r}n(Ln,"buildHackamapTablePrefix");function Rr(e,t){if(!Array.isArray(e))return[];let r=[];for(let o of e){if(!o||typeof o!="object"||Array.isArray(o))continue;let a=String(o[t]||"").trim();a&&r.push(a)}return r}n(Rr,"collectRowIds");async function ii(e,t){let r=await He(e,t);return Array.isArray(r)?r.length:0}n(ii,"countHackamapQueryRows");async function ci(e,t,r){let o=Ln(t,r);if(!o)return{};let a=["events","demos","sources","organizer","team","techstack"],s=await Promise.all(a.map(async i=>[i,await ii(e,`/knowgrph/imports/hackamap/query-outputs/${i}.${o}.query.json`)]));return Object.fromEntries(s.filter(([,i])=>i>0))}n(ci,"readHackamapRunTableCounts");function Ar(e){return Array.isArray(e)?e.map(Ar):!e||typeof e!="object"?e:Object.fromEntries(Object.entries(e).sort(([t],[r])=>String(t).localeCompare(String(r))).map(([t,r])=>[t,Ar(r)]))}n(Ar,"sortObjectKeys");function li(e){try{return JSON.stringify(Ar(e))}catch{return""}}n(li,"stableParamSignature");function pi(e){return typeof e=="string"?{value:e,label:e}:{value:e,label:JSON.stringify(e)}}n(pi,"toBuilderOption");function ui(e,t){return e.map(r=>{let o=String(r?.id||"").trim();if(!o)return null;let a=r?.params&&typeof r.params=="object"&&!Array.isArray(r.params)?r.params:{},s=t.filter(l=>String(l?.preset||"").trim()===o),i=Array.from(new Set([...Object.keys(a),...s.flatMap(l=>l?.params&&typeof l.params=="object"&&!Array.isArray(l.params)?Object.keys(l.params):[])])).sort((l,d)=>String(l).localeCompare(String(d))),c=Object.fromEntries(i.map(l=>{let d=new Set,h=[],f=[a[l],...s.map(R=>R?.params&&typeof R.params=="object"&&!Array.isArray(R.params)?R.params[l]:void 0)];for(let R of f){if(typeof R>"u")continue;let _=li(R);!_||d.has(_)||(d.add(_),h.push(pi(R)))}return[l,h]}));return{id:o,title:String(r?.title||o).trim(),params:a,param_keys:i,published_param_options:c}}).filter(Boolean)}n(ui,"buildHackamapPresetRuntimeEntries");async function di(e){let[t,r,o]=await Promise.all([si(e),Mn(e),Nn(e)]),a=t&&typeof t=="object"?t.runtime||{}:{},s=String(a?.query_selection?.default_run_id||"").trim()||"enhanced",i=Array.isArray(o?.runs)?o.runs:[],c=(await Promise.all(i.map(async l=>{let d=String(l?.id||"").trim(),h=String(l?.preset||"").trim();if(!d)return null;let f=r.find(_=>String(_?.id||"").trim()===h),R=await ci(e,f,l);return{id:d,preset:h,title:String(l?.title||l?.id||"").trim(),params:l?.params&&typeof l.params=="object"&&!Array.isArray(l.params)?l.params:{},output_suffix:String(l?.output_suffix||"").trim(),is_default:d===s,table_counts:R}}))).filter(l=>l?.id);return{ok:!0,runtime:{...a&&typeof a=="object"?a:{},presets:ui(r,c),runs:c}}}n(di,"buildHackamapRuntimeMeta");async function mi(e,t){let r=String(t||"").trim();if(!r)return null;let[o,a]=await Promise.all([Mn(e),Nn(e)]),i=(Array.isArray(a?.runs)?a.runs:[]).find(x=>String(x?.id||"").trim()===r);if(!i)return null;let c=o.find(x=>String(x?.id||"").trim()===String(i?.preset||"").trim()),l=Ln(c,i);if(!l)return null;let[d,h]=await Promise.all([He(e,`/knowgrph/imports/hackamap/query-outputs/events.${l}.query.json`),He(e,`/knowgrph/imports/hackamap/query-outputs/demos.${l}.query.json`)]),f=new Set(Rr(d,"id")),R=new Set(Rr(h,"id")),_=Rr(h,"event_id");for(let x of _)f.add(x);return{eventIds:f,demoIds:R}}n(mi,"readHackamapQueryRunSelection");function In(e,t,r){if(!r||!Un(e))return e;if(r.eventIds.size===0&&r.demoIds.size===0)return{...e,meta:{...e?.meta&&typeof e.meta=="object"?e.meta:{},selected_run_id:t,selected_run_filter_skipped:"no-event-demo-rows"}};let o=new Set;r.eventIds.forEach(c=>o.add(`Event:${c}`)),r.demoIds.forEach(c=>o.add(`Demo:${c}`));let a=Array.isArray(e.nodes)?e.nodes.filter(c=>o.has(String(c?.id||"").trim())):[],s=new Set(a.map(c=>String(c?.id||"").trim()).filter(Boolean)),i=Array.isArray(e.edges)?e.edges.filter(c=>s.has(String(c?.source||"").trim())&&s.has(String(c?.target||"").trim())):[];return{...e,nodes:a,edges:i,meta:{...e?.meta&&typeof e.meta=="object"?e.meta:{},selected_run_id:t,selected_event_count:r.eventIds.size,selected_demo_count:r.demoIds.size,total_problems:a.filter(c=>String(c?.type||"").trim()==="problem").length,total_solutions:a.filter(c=>String(c?.type||"").trim()==="solution").length}}}n(In,"filterHackamapApiGraphPayloadByRun");function hi(e){let t=Array.isArray(e?.nodes)?e.nodes:[],r=Array.isArray(e?.links)?e.links:[],o=[],a=new Set;for(let i of t){let c=String(i?.id||"").trim(),l=String(i?.type||"").trim(),d=String(i?.label||"").trim();if(!(!c||!l||!d)){if(l==="Event"){o.push({id:c,type:"problem",label:d,cluster:"Event"}),a.add(c);continue}l==="Demo"&&(o.push({id:c,type:"solution",label:d,cluster:"Demo"}),a.add(c))}}let s=[];for(let i of r){let c=String(i?.source||"").trim(),l=String(i?.target||"").trim(),d=String(i?.type||"").trim();!c||!l||d==="has_demo"&&(!a.has(c)||!a.has(l)||s.push({source:c,target:l,type:"has_demo",strength:.35}))}return{nodes:o,edges:s,meta:{source:"hackamap-graph.json:fallback",total_problems:o.filter(i=>i.type==="problem").length,total_solutions:o.filter(i=>i.type==="solution").length,...e?.content_signature?{content_signature:String(e.content_signature)}:{}}}}n(hi,"toBipartiteApiPayload");async function $n(e){let{request:t}=e,r=String(t.method||"GET").toUpperCase(),o=new URL(t.url);if(r==="OPTIONS")return new Response(null,{status:204,headers:{...ae(t),"access-control-allow-methods":"GET, HEAD, OPTIONS","access-control-allow-headers":"*","access-control-max-age":"86400"}});if(r!=="GET"&&r!=="HEAD")return at(t,{ok:!1,error:"unsupported_method"},405);if(String(o.searchParams.get("view")||"").trim().toLowerCase()==="meta"){let h=await di(t);return r==="HEAD"?new Response(null,{status:200,headers:{...Nt,...ae(t)}}):at(t,h,200)}let a=String(o.searchParams.get("run")||"").trim(),s=await mi(t,a),i=await ai(t);if(i){let h=In(i,a,s);return r==="HEAD"?new Response(null,{status:200,headers:{...Nt,...ae(t)}}):at(t,h,200)}let c=await ni(t);if(!c)return at(t,{ok:!1,error:"missing_hackamap_graph",hint:"/knowgrph/imports/hackamap/{hackamap_api_graph.json,hackamap-graph.json} not found"},404);let l=hi(c),d=In(l,a,s);return r==="HEAD"?new Response(null,{status:200,headers:{...Nt,...ae(t)}}):at(t,d,200)}n($n,"onRequest");var gi=!0,Kn=600,Dn={"content-type":"application/json; charset=utf-8","cache-control":`public, max-age=${Kn}`};function je(e,t,r={}){return new Response(JSON.stringify(t),{...r,headers:{...Dn,...r.headers||{},...ae(e)}})}n(je,"jsonResponse");function fi(e){try{let t=new URL(String(e));return t.protocol==="http:"||t.protocol==="https:"}catch{return!1}}n(fi,"isHttpUrl");function st(e){return String(e||"").trim().toLowerCase()}n(st,"normalizeHost");function xr(e,{exact:t,suffixes:r}){let o=st(e);return o?!!(Array.isArray(t)&&t.some(a=>o===st(a))||Array.isArray(r)&&r.some(a=>o===st(a)||o.endsWith(`.${st(a)}`))):!1}n(xr,"isHostMatch");function yi(e){let t=st(e.hostname),r=e.toString();return xr(t,{suffixes:["linkedin.com"]})?new URL(`https://www.linkedin.com/embeds/oembed.json?url=${encodeURIComponent(r)}`):xr(t,{exact:["twitter.com","x.com"],suffixes:["twitter.com","x.com"]})?new URL(`https://publish.twitter.com/oembed?omit_script=1&url=${encodeURIComponent(r)}`):xr(t,{exact:["reddit.com"],suffixes:["reddit.com"]})?new URL(`https://www.reddit.com/oembed?url=${encodeURIComponent(r)}`):null}n(yi,"buildOembedUpstreamUrl");async function wi({upstreamUrl:e}){return await fetch(e.toString(),{headers:{"user-agent":"Mozilla/5.0 (compatible; OEmbedProxy/1.0)",accept:"application/json,text/json;q=0.9,*/*;q=0.1"},redirect:"follow",cf:{cacheTtl:Kn,cacheEverything:!0}})}n(wi,"fetchJsonUpstream");async function Hn(e){let{request:t}=e,r=String(t.method||"GET").toUpperCase(),o=new URL(t.url);if(r==="OPTIONS")return new Response(null,{status:204,headers:{...ae(t),"access-control-allow-methods":"GET, HEAD, OPTIONS","access-control-allow-headers":"*","access-control-max-age":"86400"}});if(!["GET","HEAD"].includes(r))return je(t,{ok:!1,error:"unsupported_method"},{status:405});if(o.searchParams.get("ping")==="1")return je(t,{ok:!0,ping:!0});if(gi)return je(t,{ok:!1,error:"disabled_by_policy"},{status:200,headers:{"cache-control":"no-store"}});let a=o.searchParams.get("url")||"";if(!fi(a))return je(t,{ok:!1,error:"invalid_url"},{status:400,headers:{"cache-control":"no-store"}});let s;try{s=new URL(a)}catch{return je(t,{ok:!1,error:"invalid_url"},{status:400,headers:{"cache-control":"no-store"}})}let i=yi(s);if(!i)return je(t,{ok:!1,error:"unsupported_provider"},{status:400,headers:{"cache-control":"no-store"}});let c=await wi({upstreamUrl:i}),l=new Headers(c.headers);l.delete("content-length"),l.set("cache-control",c.ok?Dn["cache-control"]:"no-store");for(let[h,f]of Object.entries(ae(t)))l.set(h,f);if(r==="HEAD")return new Response(null,{status:c.status,headers:l});let d=await c.text();try{JSON.parse(d)}catch{return je(t,{ok:!1,error:"invalid_upstream_json",status:c.status},{status:502,headers:{"cache-control":"no-store"}})}return l.set("content-type","application/json; charset=utf-8"),new Response(d,{status:c.status,headers:l})}n(Hn,"onRequest");var jn="/__chat_proxy",Ut="agnes-ai",Lt="byteplus-modelark",$t="miromind",Si=n(e=>{let t=_e(e);return t==="openai"?"openai":t===Lt||t==="byteplus"?Lt:t===$t||t==="miromind-api"?$t:t===Ut||t==="agnes"||t==="agnes-ai-api"?Ut:t},"normalizeProviderId"),_i=n(e=>_e(e)===It,"isAgnesHost"),bi=n(e=>{let t=_e(e);return t===Mt||t===Pr},"isBytePlusHost"),Pi=n(e=>_e(e)===Ot,"isMiroMindHost"),Ri=n(({provider:e,requestedUpstream:t,env:r})=>e==="openai"?"https://api.openai.com":e===$t?t||`https://${Ot}`:e===Ut?t||`https://${It}`:e===Lt?t||String(r.KNOWGRPH_CHAT_PROXY_UPSTREAM||"").trim()||`https://${Mt}`:t||String(r.KNOWGRPH_CHAT_PROXY_UPSTREAM||"").trim(),"pickUpstreamBase");async function Bn(e){let{request:t,env:r}=e,o=String(t.method||"GET").toUpperCase(),a=new URL(t.url);if(o==="OPTIONS")return new Response(null,{status:204,headers:{"access-control-allow-origin":fe(t.headers,"origin")||"*","access-control-allow-methods":"GET, HEAD, POST, OPTIONS","access-control-allow-headers":"*","access-control-max-age":"86400"}});if(!["GET","HEAD","POST"].includes(o))return de(t,{ok:!1,error:"Unsupported method"},405);let s=Si(fe(t.headers,"x-kg-chat-provider")),i=Ri({provider:s,requestedUpstream:fe(t.headers,"x-kg-chat-upstream"),env:r});if(!i)return de(t,{ok:!1,error:"Missing chat proxy upstream configuration"},500);let c;try{c=new URL(i)}catch{return de(t,{ok:!1,error:"Invalid chat proxy upstream configuration"},500)}let l=On(r,{includeOpenAi:!0,includeMiroMind:!0,includeAgnes:!0,includeBytePlus:!0}),d=_e(c.hostname);if(!l.has(d))return de(t,{ok:!1,error:"Chat proxy upstream host is not allowed"},403);if(!vn(d)&&c.protocol!=="https:")return de(t,{ok:!1,error:"Chat proxy requires HTTPS for non-local upstream hosts"},403);let h=s==="openai"||d===br,f=s===$t||Pi(d),R=s===Ut||_i(d),_=s===Lt||bi(d),x=fe(t.headers,"x-kg-chat-api-key"),H=String(r.KNOWGRPH_CHAT_PROXY_OPENAI_API_KEY||r.OPENAI_API_KEY||"").trim(),U=String(r.KNOWGRPH_CHAT_PROXY_MIROMIND_API_KEY||r.MIROMIND_API_KEY||"").trim(),K=String(r.KNOWGRPH_CHAT_PROXY_AGNES_API_KEY||r.AGNES_API_KEY||"").trim(),re=String(r.KNOWGRPH_CHAT_PROXY_BYTEPLUS_API_KEY||r.BYTEPLUS_API_KEY||"").trim(),F=(x||H).slice(0,512),C=(x||U).slice(0,512),O=(x||K).slice(0,512),Y=(x||re).slice(0,512),L=_?Y:R?O:f?C:F;if(h&&!F)return de(t,{ok:!1,error:"Missing OpenAI API key for chat proxy upstream (set KNOWGRPH_CHAT_PROXY_OPENAI_API_KEY or OPENAI_API_KEY)"},401);if(f&&!L)return de(t,{ok:!1,error:"Missing MiroMind API key for chat proxy upstream (set KNOWGRPH_CHAT_PROXY_MIROMIND_API_KEY or MIROMIND_API_KEY)"},401);if(R&&!L)return de(t,{ok:!1,error:"Missing Agnes API key for chat proxy upstream (set KNOWGRPH_CHAT_PROXY_AGNES_API_KEY or AGNES_API_KEY)"},401);if(_&&!L)return de(t,{ok:!1,error:"Missing BytePlus API key for chat proxy upstream (set KNOWGRPH_CHAT_PROXY_BYTEPLUS_API_KEY or BYTEPLUS_API_KEY)"},401);if(o==="POST"&&!fe(t.headers,"content-type").toLowerCase().includes("application/json"))return de(t,{ok:!1,error:"Chat proxy expects application/json payloads"},415);let J=a.pathname.startsWith(jn)&&a.pathname.slice(jn.length)||"/v1/chat/completions",I=J.startsWith("/")?J:`/${J}`,M=new URL(`${I}${a.search||""}`,c),j=new Headers,oe=fe(t.headers,"content-type"),le=fe(t.headers,"accept");oe&&j.set("content-type",oe),le&&j.set("accept",le),(h||f||R||_)&&j.set("authorization",`Bearer ${L}`);let ye=fe(t.headers,"x-client-request-id").slice(0,512);ye&&j.set("x-client-request-id",ye);let P=new AbortController,y=Number(r.KNOWGRPH_CHAT_PROXY_TIMEOUT_MS),S=Number.isFinite(y)?Math.max(5e3,Math.min(18e4,Math.floor(y))):9e4,u=setTimeout(()=>P.abort(),S);try{let m=await fetch(M.toString(),{method:o,headers:j,body:o==="GET"||o==="HEAD"?void 0:t.body,signal:P.signal,redirect:"follow"}),g=new Headers(m.headers);g.delete("content-length"),g.delete("www-authenticate"),g.set("cache-control","no-store");let b=fe(t.headers,"origin");return b&&(g.set("access-control-allow-origin",b),g.set("vary","Origin")),o==="HEAD"?new Response(null,{status:m.status,statusText:m.statusText,headers:g}):new Response(m.body,{status:m.status,statusText:m.statusText,headers:g})}catch(m){let g=m&&typeof m=="object"&&"message"in m?String(m.message||""):"",b=P.signal.aborted||/aborted|timeout/i.test(g);return de(t,{ok:!1,error:g||"Failed to reach chat upstream"},b?504:502)}finally{clearTimeout(u)}}n(Bn,"onRequest");function Ai(e){let t=e.map(r=>r==null?"":typeof r=="boolean"?r?"1":"0":typeof r=="number"?Number.isFinite(r)?String(r):"":String(r)).join("|");return`rich-media-preview:${Ye(t)}`}n(Ai,"buildRichMediaPreviewSemanticKey");var Gn="png";function Dt(e){let t=typeof e=="number"?e:Number(String(e??"").trim());if(!Number.isFinite(t))return null;let r=Math.max(0,Math.floor(t));return Number.isFinite(r)?r:null}n(Dt,"normalizeRemoteVideoFrameSeconds");function Ht(e){let t=String(e||"").trim().toLowerCase();return t==="jpg"||t==="jpeg"?"jpg":"png"}n(Ht,"normalizeRemoteVideoFrameFormat");function kr(e){let t=String(e.sourceUrl||"").trim(),r=Dt(e.timeSeconds)??0,o=Ht(e.format||Gn);return Ai(["remote-video-frame",t,r,o])}n(kr,"buildRemoteVideoFrameSemanticKey");function Wn(e){let t=Dt(e.timeSeconds)??0,r=Ht(e.format||Gn),o=kr({...e,timeSeconds:t,format:r});return`frame-${o.split(":").pop()||Ye(o)}-t${t}.${r}`}n(Wn,"buildRemoteVideoFrameFileName");var Kt=n(e=>{let t=String(e||"").trim();return t&&/^[A-Za-z0-9_-]{6,128}$/.test(t)?t:null},"normalizeYouTubeIdLikeValue"),Fn=n(e=>{try{let t=new URL(String(e||"").trim()),r=String(t.hostname||"").toLowerCase();if(r==="youtu.be"||r.endsWith(".youtu.be")){let o=t.pathname.replace(/^\/+/,"").split("/")[0]?.trim()||"";return Kt(o)}if(r==="youtube.com"||r.endsWith(".youtube.com")||r==="youtube-nocookie.com"||r.endsWith(".youtube-nocookie.com")){let o=String(t.searchParams.get("v")||"").trim();if(o)return Kt(o);let a=t.pathname.split("/").filter(Boolean),s=a[0]||"",i=a[1]||"";if((s==="embed"||s==="shorts"||s==="live")&&i)return Kt(i);if(s==="watch"){let c=String(t.searchParams.get("v")||"").trim();return Kt(c)}}}catch{return null}return null},"readYouTubeIdFromUrl");function xi(e){let t=String(e||"").trim().replace(/^<|>$/g,"").trim();for(;/[),.;:!?]$/.test(t);){let r=t.slice(0,-1).trim();if(!r)break;let o=Fn(t),a=Fn(r);if(!a||o&&o!==a)break;t=r}return t}n(xi,"stripYouTubeUrlTrailingPunctuation");function zn(e){let t=n(r=>{let o=String(r||"").trim();if(!o)return null;if(/^\d+$/.test(o))return Number(o);let a=o.match(/^(?:(\d+)h)?(?:(\d+)m)?(?:(\d+)s)?$/i);if(!a)return null;let s=a[1]?Number(a[1]):0,i=a[2]?Number(a[2]):0,c=a[3]?Number(a[3]):0,l=s*3600+i*60+c;return l>0&&Number.isFinite(l)?l:null},"parseChunk");try{let r=new URL(xi(e)),o=r.searchParams.get("t")||r.searchParams.get("start")||"",a=r.hash&&new URLSearchParams(r.hash.replace(/^#/,"")).get("t")||"";return t(o)??t(a)}catch{return null}}n(zn,"parseYouTubeStartSeconds");var ki="/image/knowgrph/video-frame",Ei=4096,Ci=720*60,Ti=/^frame-[a-f0-9]+-t\d+\.(?:png|jpg)$/i,vr={"access-control-allow-origin":"*","access-control-allow-methods":"GET, HEAD, OPTIONS","access-control-allow-headers":"accept, content-type"},Tr=n(e=>String(e||"").replace(/\s+/g," ").trim(),"cleanText"),Er=n((e,t=200,r="GET")=>new Response(r==="HEAD"?null:JSON.stringify(e),{status:t,headers:{...vr,"content-type":"application/json; charset=utf-8","cache-control":"no-store"}}),"jsonResponse"),Cr=n((e,t=200,r="GET")=>new Response(r==="HEAD"?null:e,{status:t,headers:{...vr,"content-type":"text/plain; charset=utf-8","cache-control":"no-store"}}),"textResponse"),vi=n((e,t)=>e===t||e.endsWith(`.${t}`),"hostMatches"),Oi=n(e=>{let t=Tr(e?.KG_VIDEO_FRAME_ALLOWED_HOSTS);return t?t.split(",").map(r=>Tr(r).toLowerCase()).filter(Boolean):["youtube.com","youtu.be","youtube-nocookie.com","bilibili.com","b23.tv"]},"readAllowedHosts"),Ii=n(e=>Tr(e).replace(/^<|>$/g,"").trim(),"unwrapUrlInput"),Mi=n((e,t)=>{try{let r=new URL(e);if(r.protocol!=="https:"&&r.protocol!=="http:")return!1;let o=r.hostname.toLowerCase();return Oi(t).some(a=>vi(o,a))}catch{return!1}},"isAllowedSourceUrl"),Ni=n((e,t)=>{let r=new URL(e.url),o=Ii(r.searchParams.get("url")||"");if(!o)return{error:"Missing url parameter"};if(o.length>Ei)return{error:"Video URL is too long"};if(!Mi(o,t))return{error:"Video frame extraction is limited to supported remote video hosts"};let a=Dt(r.searchParams.get("time"))??zn(o);if(a==null)return{error:"Missing time parameter"};let s=Math.min(Ci,Math.max(0,a)),i=Ht(r.searchParams.get("format")||"png"),c=Wn({sourceUrl:o,timeSeconds:s,format:i});if(!Ti.test(c))return{error:"Invalid frame cache key"};let l=`${ki}/${c}`;return{sourceUrl:o,timeSeconds:s,format:i,fileName:c,publicUrl:l,semanticKey:kr({sourceUrl:o,timeSeconds:s,format:i})}},"readFrameRequest"),Ui=n(async(e,t,r)=>{let o=new URL(t,e.request.url),a=new Request(o.toString(),{method:r});return typeof e.env?.ASSETS?.fetch=="function"?await e.env.ASSETS.fetch(a):await fetch(a)},"fetchStaticAsset"),Li=n(e=>`Frame has not been generated yet. Run the local video-frame extractor and publish ${e.publicUrl}.`,"missingFrameMessage"),$i=n((e,t)=>{let r=new Headers;r.set("content-type",t.format==="jpg"?"image/jpeg":"image/png"),r.set("cache-control","public, max-age=31536000, immutable"),r.set("access-control-allow-origin","*");let o=e.headers.get("content-length");o&&r.set("content-length",o);let a=e.headers.get("etag");return a&&r.set("etag",a),r},"imageResponseHeaders");async function qn(e){let t=e.request;if(t.method==="OPTIONS")return new Response(null,{status:204,headers:vr});if(t.method!=="GET"&&t.method!=="HEAD")return Cr("Method not allowed",405,t.method);let r=new URL(t.url).searchParams.get("emit")==="json",o=Ni(t,e.env||{});if("error"in o)return r?Er({ok:!1,error:o.error},400,t.method):Cr(o.error,400,t.method);let a=r&&t.method!=="HEAD"?"GET":r||t.method==="HEAD"?"HEAD":"GET",s=await Ui(e,o.publicUrl,a);if(!s.ok){let i=Li(o);return r?Er({ok:!1,error:i,publicUrl:o.publicUrl,semanticKey:o.semanticKey},404,t.method):Cr(i,404,t.method)}if(r){let i=Number(s.headers.get("content-length")||0);return(!Number.isFinite(i)||i<=0)&&t.method!=="HEAD"&&(i=(await s.arrayBuffer()).byteLength),Er({ok:!0,imageUrl:o.publicUrl,publicUrl:o.publicUrl,semanticKey:o.semanticKey,cached:!0,bytes:Number.isFinite(i)?Math.max(0,Math.floor(i)):0,timeSeconds:o.timeSeconds,format:o.format},200,t.method)}return new Response(t.method==="HEAD"?null:s.body,{status:200,headers:$i(s,o)})}n(qn,"onRequest");var Vn={"content-type":"application/json; charset=utf-8","cache-control":"no-store","access-control-allow-origin":"*","access-control-allow-methods":"GET, HEAD, POST, OPTIONS","access-control-allow-headers":"content-type"},jt=n((e,t=200,r="GET")=>new Response(r==="HEAD"?null:JSON.stringify(e),{status:t,headers:Vn}),"jsonResponse"),V=n(e=>String(e||"").replace(/\s+/g," ").trim(),"cleanText"),Ki=n(e=>{try{let t=new URL(String(e||"").trim());if(/youtu\.be$/i.test(t.hostname))return V(t.pathname.split("/").filter(Boolean)[0]);if(/youtube\.com$/i.test(t.hostname)||/youtube-nocookie\.com$/i.test(t.hostname)){let r=V(t.searchParams.get("v"));if(r)return r;let o=t.pathname.split("/").filter(Boolean),a=o.findIndex(s=>["embed","shorts","live"].includes(s));if(a>=0)return V(o[a+1])}}catch{}return""},"readVideoId"),Di=n((e,t)=>{let r=e.indexOf(t);if(r<0)return null;let o=e.indexOf("{",r);if(o<0)return null;let a=0,s=!1,i=!1;for(let c=o;c<e.length;c+=1){let l=e[c];if(s){i?i=!1:l==="\\"?i=!0:l==='"'&&(s=!1);continue}if(l==='"')s=!0;else if(l==="{")a+=1;else if(l==="}"&&(a-=1,a===0))return e.slice(o,c+1)}return null},"extractJsonAfter"),Hi=n(e=>{for(let t of["ytInitialPlayerResponse =","ytInitialPlayerResponse="]){let r=Di(e,t);if(r)try{return JSON.parse(r)}catch{}}return null},"parsePlayerResponse"),ji=n((e,t)=>{let r=V(t||"en").toLowerCase();return e.find(o=>V(o.languageCode).toLowerCase()===r)||e.find(o=>V(o.languageCode).toLowerCase().startsWith(r.split("-")[0]))||e.find(o=>V(o.kind)!=="asr")||e[0]||null},"pickCaptionTrack"),Bi=n(e=>{let t=new URL(e);return t.searchParams.set("fmt","json3"),t.toString()},"withJsonCaptionFormat"),Fi=n(e=>(Array.isArray(e?.events)?e.events:[]).map(r=>{let o=Array.isArray(r.segs)?V(r.segs.map(i=>i?.utf8||"").join("")):"",a=Number(r.tStartMs)/1e3,s=Number(r.dDurationMs||0)/1e3;return o&&Number.isFinite(a)?{text:o,start:a,duration:Number.isFinite(s)?s:0}:null}).filter(Boolean),"parseCaptionJson3"),Gi=n(e=>String(e||"").replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&quot;/g,'"').replace(/&#39;|&apos;/g,"'"),"decodeXmlText"),Wi=n(e=>{let t=[],r=/<text\b([^>]*)>([\s\S]*?)<\/text>/gi,o=null;for(;o=r.exec(String(e||""));){let a=o[1]||"",s=Number(a.match(/\bstart="([^"]+)"/i)?.[1]),i=Number(a.match(/\bdur="([^"]+)"/i)?.[1]||0),c=V(Gi(o[2]||""));c&&Number.isFinite(s)&&t.push({text:c,start:s,duration:Number.isFinite(i)?i:0})}return t},"parseCaptionXml"),zi=n((e,t)=>{let r=String(e||"").trim();if(!r)return[];if(String(t||"").toLowerCase().includes("json")||r.startsWith("{")||r.startsWith("["))try{return Fi(JSON.parse(r))}catch{return[]}return Wi(r)},"parseCaptionResponseText"),qi=n(e=>{let t=Math.max(0,Math.floor(Number(e)||0)),r=Math.floor(t/60),o=String(t%60).padStart(2,"0");return`${r}:${o}`},"formatTimestamp"),Vi=n((e,t)=>{let r=new URL(e);return r.searchParams.set("t",`${Math.max(0,Math.floor(Number(t)||0))}s`),r.toString()},"timestampUrl"),Yi=n(({title:e,sourceUrl:t,videoId:r,authorName:o,thumbnailUrl:a,segments:s})=>[`# ${e||`YouTube ${r}`}`,"",`Video ID: ${r}`,o?`Author: ${o}`:"",`Source: [${t}](${t})`,a?`[![${e||r}](${a})](${t})`:"","",s.length>0?"## Transcript":"## Video Source","",...s.length>0?s.map(i=>`[${qi(i.start)}](${Vi(t,i.start)}) ${i.text}`):["Captions were not available from the source at import time.","The source URL, title, author, and thumbnail remain available for downstream storyboard reconstruction."],""].filter(i=>i!=="").join(`
`),"buildMarkdown"),Or=n(({videoId:e,sourceUrl:t,title:r,authorName:o,thumbnailUrl:a,lang:s,languageCode:i,segments:c,captionStatus:l})=>{let d={type:"rag:YouTubeTranscript",video_id:e,source_url:t,title:r,author_name:o,thumbnail_url:a,language_code:V(i)||s,caption_status:l,segment_count:c.length,duration:c.reduce((h,f)=>Math.max(h,f.start+f.duration),0),segments:c};return{ok:!0,name:`youtube-${e.toLowerCase()}.md`,markdown:Yi({title:r,sourceUrl:t,videoId:e,authorName:o,thumbnailUrl:a,segments:c}),transcript:d}},"buildPayload");async function Ji({sourceUrl:e,lang:t="en",fetchImpl:r=fetch}){let o=Ki(e);if(!o)return{ok:!1,error:"unsupported_youtube_url"};let a=`https://www.youtube.com/watch?v=${encodeURIComponent(o)}`,[s,i]=await Promise.all([r(`https://www.youtube.com/oembed?url=${encodeURIComponent(a)}&format=json`,{headers:{accept:"application/json"}}).catch(()=>null),r(a,{headers:{accept:"text/html,application/xhtml+xml","accept-language":"en-US,en;q=0.9","user-agent":"Mozilla/5.0 Knowgrph YouTube transcript importer"}})]),c=s?.ok?await s.json().catch(()=>({})):{},l=i.ok?Hi(await i.text()):null,d=V(c.title)||V(l?.videoDetails?.title)||`YouTube ${o}`,h=V(c.author_name)||V(l?.videoDetails?.author),f=V(c.thumbnail_url)||`https://i.ytimg.com/vi/${o}/hqdefault.jpg`;if(!i.ok)return Or({videoId:o,sourceUrl:a,title:d,authorName:h,thumbnailUrl:f,lang:t,languageCode:t,segments:[],captionStatus:`watch-fetch-${i.status}`});let R=l?.captions?.playerCaptionsTracklistRenderer?.captionTracks||[],_=ji(Array.isArray(R)?R:[],t);if(!_?.baseUrl)return Or({videoId:o,sourceUrl:a,title:d,authorName:h,thumbnailUrl:f,lang:t,languageCode:t,segments:[],captionStatus:"captions-unavailable"});let x=await r(Bi(_.baseUrl),{headers:{accept:"application/json,text/xml,text/plain,*/*","user-agent":"Mozilla/5.0 Knowgrph YouTube transcript importer"}}).catch(()=>null),H=x?await x.text().catch(()=>""):"",U=x?.ok?zi(H,x.headers.get("content-type")):[],K=U.length>0?"available":x?.ok?"captions-empty":`captions-fetch-${x?.status||"failed"}`;return Or({videoId:o,sourceUrl:a,title:d,authorName:h,thumbnailUrl:f,lang:t,languageCode:_.languageCode,segments:U,captionStatus:K})}n(Ji,"buildYouTubeTranscriptPayload");async function Yn(e){let t=e.request,r=String(t.method||"GET").toUpperCase();if(r==="OPTIONS")return new Response(null,{status:204,headers:Vn});if(r!=="GET"&&r!=="HEAD"&&r!=="POST")return jt({ok:!1,error:"unsupported_method"},405,r);let o=new URL(t.url),a=V(o.searchParams.get("url")),s=V(o.searchParams.get("lang"))||"en";if(!a)return jt({ok:!1,error:"missing_url"},400,r);try{let i=await Ji({sourceUrl:a,lang:s});return jt(i,i.ok?200:502,r)}catch(i){let c=i&&typeof i=="object"&&"message"in i?V(i.message):"";return jt({ok:!1,error:c||"youtube_conversion_failed"},502,r)}}n(Yn,"onRequest");async function Jn(e){let{request:t}=e,r=String(t.method||"GET").toUpperCase();if(r==="OPTIONS")return new Response(null,{status:204,headers:{...ae(t),"access-control-allow-methods":"GET, HEAD, OPTIONS","access-control-allow-headers":"*","access-control-max-age":"86400"}});if(r!=="GET"&&r!=="HEAD")return new Response(JSON.stringify({ok:!1,error:"unsupported_method"}),{status:405,headers:{"content-type":"application/json; charset=utf-8","cache-control":"no-store",...ae(t)}});let o={ok:!0,service:"singabldr-pages",ts:new Date().toISOString()},a={"content-type":"application/json; charset=utf-8","cache-control":"no-store",...ae(t)};return r==="HEAD"?new Response(null,{status:200,headers:a}):new Response(JSON.stringify(o),{status:200,headers:a})}n(Jn,"onRequest");var Ee="https://airvio.co";var ce="/knowgrph",ke=`${Ee}${ce}/`,Xi=`${Ee}/`;var Qn=`${ce}/health`,Xn=`${Ee}${Qn}`,Zn="/.well-known/agent-card.json",ju=`${ce}/.well-known/agent-card.json`,Qi=`${Ee}${Zn}`,Zi=`${Ee}/api/storage/source-files`,ec=`${Ee}/api/storage/doc-default/{canonicalPath}`,tc=`${Ee}/api/storage/doc/{workspaceId}/{canonicalPath}`,rc=`${Ee}/api/storage/blob/{workspaceId}/{canonicalPath}`;var Ir="root-agent-ready-pages",ea=['</.well-known/api-catalog>; rel="api-catalog"; type="application/linkset+json"',`<${ce}/.well-known/openapi.json>; rel="service-desc"; type="application/vnd.oai.openapi+json;version=3.1"`,`<${ce}/llms.txt>; rel="service-doc"; type="text/plain"`,'</auth.md>; rel="service-doc"; type="text/markdown"',`<${Qn}>; rel="status"; type="application/health+json"`,`<${ce}/.well-known/mcp/server-card.json>; rel="mcp-server-card"; type="application/json"`,`<${Zn}>; rel="describedby"; type="application/json"`].join(", "),ta=`# Knowgrph
...
- Auth.md registration instructions: ${Xi}auth.md
- Health: ${Xn}
...
- Agent-ready status: ${Xn}
- HTTP MCP: ${ke}mcp
- Storage API: ${Ee}/api/storage/
- Source Files index: ${Zi}
- Default Source File documents: ${ec}
- Workspace Source File documents: ${tc}
- Workspace binary artifacts: ${rc}
...
- The View initiates the MCP Apps \`ui/initialize\` handshake, sends \`ui/notifications/initialized\` and \`ui/notifications/size-changed\`, handles host context/tool input/result/cancel notifications, and calls the originating server through \`tools/call\`.
- \`inspect_agent_surface.structuredContent.mcpAppsServerReadiness\` exposes the native server-readiness model used by the View: app tool/resource binding, prompt discovery, resource-template discovery, output-schema and structured-content readiness, sandbox/security metadata, widget accessibility, Streamable HTTP JSON-RPC transport, local stdio transport, and read-only search/fetch retrieval.
`,ra=n(e=>new Response(e,{status:200,headers:{"content-type":"text/markdown; charset=utf-8","cache-control":"public, max-age=3600","access-control-allow-origin":"*",vary:"Accept","x-markdown-tokens":String(Math.ceil(String(e||"").length/4))}}),"markdownResponse"),oa=n(e=>(e.headers.get("accept")||"").toLowerCase().split(",").some(r=>r.trim().startsWith("text/markdown")),"wantsMarkdown"),Mr=n((e,t)=>{let r=new Response(e.body,e),o=String(t?.owner||"").trim(),a=String(t?.tag||"").trim();return o&&r.headers.set("x-knowgrph-route-owner",o),a&&r.headers.set("x-knowgrph-route-tag",a),r},"withAgentReadyRouteHeaders");var Ur="Agent-actionable chat-to-canvas knowledge graph workspace",it='<main id="root"></main>',oc=/<(?:main|div)\s+id=["']root["']\s*><\/(?:main|div)>/i,nc=n(e=>{let t=/<script>([\s\S]*?)<\/script>/g;for(let r of String(e||"").matchAll(t)){let o=r[1]||"";if(o.includes("createWebMcpLifecycleController")&&o.includes("toolDefinitions"))return o}return""},"extractWebMcpScript"),na=n(()=>({"content-type":"text/html; charset=utf-8","cache-control":"no-store, no-cache, no-transform, must-revalidate, max-age=0","access-control-allow-origin":"*",link:ea}),"rootHtmlHeaders"),Nr=n((e,t)=>String(e||"").includes("</head>")?String(e||"").replace("</head>",`${t}</head>`):`${String(e||"")}${t}`,"injectIntoHead"),aa=n(e=>String(e||"").replace(oc,it),"canonicalizeRootMount"),Bt=n(()=>`<main id="knowgrph-root-fallback" data-knowgrph-root-fallback="visible" aria-label="Knowgrph root alias" style="position:fixed;inset:0;z-index:2147483000;display:grid;place-content:center;gap:1rem;padding:2rem;box-sizing:border-box;font-family:Inter,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;background:#101820;color:#f4f7fb;text-align:center">
    ...
    <\/script>`,"rootVisibleFallbackMarkup"),ac=n(e=>{let t=aa(e);return/<main\s+id=["']knowgrph-root-fallback["']/i.test(t)?t:t.includes(it)?t.replace(it,`${it}
    ${Bt()}`):t.includes("</body>")?t.replace("</body>",`    ${Bt()}
  </body>`):`${t}
${Bt()}`},"injectRootVisibleFallback"),sc=n(e=>{let t=aa(e);return/<meta\s+name=["']description["'][^>]*>/i.test(t)?t=t.replace(/<meta\s+name=["']description["'][^>]*>/i,`<meta name="description" content="${Ur}" />`):t=Nr(t,`    <meta name="description" content="${Ur}" />
`),/<link\s+rel=["']canonical["'][^>]*>/i.test(t)||(t=Nr(t,`    <link rel="canonical" href="${ce}/" />
`)),/<meta\s+name=["']x-knowgrph-root-alias["'][^>]*>/i.test(t)||(t=Nr(t,`    <meta name="x-knowgrph-root-alias" content="${ce}/" />
`)),ac(t)},"rewriteRootAppHtml"),ic=n(async e=>{let t=new URL(`${ce}/?agentReadyRootWebMcp=1`,e.url),r=await fetch(t,{headers:{accept:"text/html"}});return r.ok?nc(await r.text()):""},"loadWebMcpScript"),cc=n(async e=>{let t=new URL(`${ce}/?agentReadyRootAlias=1`,e.url),r=await fetch(t,{headers:{accept:"text/html"}});if(!r.ok)return null;let o=sc(await r.text());return!o.includes(it)||!o.includes(`${ce}/assets/`)?null:new Response(o,{status:200,headers:na()})},"loadKnowgrphAppShell"),lc=n((e="")=>new Response(`<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
...
</html>`,{status:200,headers:na()}),"rootHtmlResponse");async function sa(e){let{request:t}=e,r=String(t.method||"GET").toUpperCase();if(r!=="GET"&&r!=="HEAD")return e.next();if(oa(t)){let s=Mr(ra(ta),{owner:Ir,tag:"root-homepage-markdown"});return r==="HEAD"?new Response(null,s):s}let o=r==="HEAD"?null:await cc(t),a=Mr(o||lc(r==="HEAD"?"":await ic(t)),{owner:Ir,tag:"root-homepage-html"});return r==="HEAD"?new Response(null,a):a}n(sa,"onRequest");var A=[{routePath:"/api/llm/chat/completions",mountPath:"/api/llm/chat",method:"",middlewares:[],modules:[Dr]},{routePath:"/api/payments/commerce/x402",mountPath:"/api/payments/commerce",method:"",middlewares:[],modules:[io]},{routePath:"/api/llm/models",mountPath:"/api/llm",method:"",middlewares:[],modules:[co]},{routePath:"/api/llm/responses",mountPath:"/api/llm",method:"",middlewares:[],modules:[lo]},{routePath:"/knowgrph/doc-default/:path*",mountPath:"/knowgrph/doc-default",method:"",middlewares:[],modules:[bn]},{routePath:"/knowgrph/doc/:path*",mountPath:"/knowgrph/doc",method:"",middlewares:[],modules:[Pn]},{routePath:"/knowgrph/share/:path*",mountPath:"/knowgrph/share",method:"",middlewares:[],modules:[Rn]},{routePath:"/api/link-preview",mountPath:"/api",method:"GET",middlewares:[],modules:[xn]},{routePath:"/api/link-proxy",mountPath:"/api",method:"GET",middlewares:[],modules:[En]},{routePath:"/api/graph",mountPath:"/api",method:"",middlewares:[],modules:[$n]},{routePath:"/api/oembed",mountPath:"/api",method:"",middlewares:[],modules:[Hn]},{routePath:"/__chat_proxy/:path*",mountPath:"/__chat_proxy",method:"",middlewares:[],modules:[Bn]},{routePath:"/knowgrph/:path*",mountPath:"/knowgrph",method:"",middlewares:[],modules:[Ie]},{routePath:"/__video_frame",mountPath:"/",method:"",middlewares:[],modules:[qn]},{routePath:"/__youtube_transcript",mountPath:"/",method:"",middlewares:[],modules:[Yn]},{routePath:"/health",mountPath:"/",method:"",middlewares:[],modules:[Jn]},{routePath:"/",mountPath:"/",method:"",middlewares:[],modules:[sa]}];function pc(e){for(var t=[],r=0;r<e.length;){var o=e[r];if(o==="*"||o==="+"||o==="?"){t.push({type:"MODIFIER",index:r,value:e[r++]});continue}if(o==="\\"){t.push({type:"ESCAPED_CHAR",index:r++,value:e[r++]});continue}if(o==="{"){t.push({type:"OPEN",index:r,value:e[r++]});continue}if(o==="}"){t.push({type:"CLOSE",index:r,value:e[r++]});continue}if(o===":"){for(var a="",s=r+1;s<e.length;){var i=e.charCodeAt(s);if(i>=48&&i<=57||i>=65&&i<=90||i>=97&&i<=122||i===95){a+=e[s++];continue}break}if(!a)throw new TypeError("Missing parameter name at ".concat(r));t.push({type:"NAME",index:r,value:a}),r=s;continue}if(o==="("){var c=1,l="",s=r+1;if(e[s]==="?")throw new TypeError('Pattern cannot start with "?" at '.concat(s));for(;s<e.length;){if(e[s]==="\\"){l+=e[s++]+e[s++];continue}if(e[s]===")"){if(c--,c===0){s++;break}}else if(e[s]==="("&&(c++,e[s+1]!=="?"))throw new TypeError("Capturing groups are not allowed at ".concat(s));l+=e[s++]}if(c)throw new TypeError("Unbalanced pattern at ".concat(r));if(!l)throw new TypeError("Missing pattern at ".concat(r));t.push({type:"PATTERN",index:r,value:l}),r=s;continue}t.push({type:"CHAR",index:r,value:e[r++]})}return t.push({type:"END",index:r,value:""}),t}n(pc,"lexer");function uc(e,t){t===void 0&&(t={});for(var r=pc(e),o=t.prefixes,a=o===void 0?"./":o,s=t.delimiter,i=s===void 0?"/#?":s,c=[],l=0,d=0,h="",f=n(function(I){if(d<r.length&&r[d].type===I)return r[d++].value},"tryConsume"),R=n(function(I){var M=f(I);if(M!==void 0)return M;var j=r[d],oe=j.type,le=j.index;throw new TypeError("Unexpected ".concat(oe," at ").concat(le,", expected ").concat(I))},"mustConsume"),_=n(function(){for(var I="",M;M=f("CHAR")||f("ESCAPED_CHAR");)I+=M;return I},"consumeText"),x=n(function(I){for(var M=0,j=i;M<j.length;M++){var oe=j[M];if(I.indexOf(oe)>-1)return!0}return!1},"isSafe"),H=n(function(I){var M=c[c.length-1],j=I||(M&&typeof M=="string"?M:"");if(M&&!j)throw new TypeError('Must have text between two parameters, missing text after "'.concat(M.name,'"'));return!j||x(j)?"[^".concat(Me(i),"]+?"):"(?:(?!".concat(Me(j),")[^").concat(Me(i),"])+?")},"safePattern");d<r.length;){var U=f("CHAR"),K=f("NAME"),re=f("PATTERN");if(K||re){var F=U||"";a.indexOf(F)===-1&&(h+=F,F=""),h&&(c.push(h),h=""),c.push({name:K||l++,prefix:F,suffix:"",pattern:re||H(F),modifier:f("MODIFIER")||""});continue}var C=U||f("ESCAPED_CHAR");if(C){h+=C;continue}h&&(c.push(h),h="");var O=f("OPEN");if(O){var F=_(),Y=f("NAME")||"",L=f("PATTERN")||"",J=_();R("CLOSE"),c.push({name:Y||(L?l++:""),pattern:Y&&!L?H(F):L,prefix:F,suffix:J,modifier:f("MODIFIER")||""});continue}R("END")}return c}n(uc,"parse");function ct(e,t){var r=[],o=ca(e,r,t);return dc(o,r,t)}n(ct,"match");function dc(e,t,r){r===void 0&&(r={});var o=r.decode,a=o===void 0?function(s){return s}:o;return function(s){var i=e.exec(s);if(!i)return!1;for(var c=i[0],l=i.index,d=Object.create(null),h=n(function(R){if(i[R]===void 0)return"continue";var _=t[R-1];_.modifier==="*"||_.modifier==="+"?d[_.name]=i[R].split(_.prefix+_.suffix).map(function(x){return a(x,_)}):d[_.name]=a(i[R],_)},"_loop_1"),f=1;f<i.length;f++)h(f);return{path:c,index:l,params:d}}}n(dc,"regexpToFunction");function Me(e){return e.replace(/([.+*?=^!:${}()[\]|/\\])/g,"\\$1")}n(Me,"escapeString");function ia(e){return e&&e.sensitive?"":"i"}n(ia,"flags");function mc(e,t){if(!t)return e;for(var r=/\((?:\?<(.*?)>)?(?!\?)/g,o=0,a=r.exec(e.source);a;)t.push({name:a[1]||o++,prefix:"",suffix:"",modifier:"",pattern:""}),a=r.exec(e.source);return e}n(mc,"regexpToRegexp");function hc(e,t,r){var o=e.map(function(a){return ca(a,t,r).source});return new RegExp("(?:".concat(o.join("|"),")"),ia(r))}n(hc,"arrayToRegexp");function gc(e,t,r){return fc(uc(e,r),t,r)}n(gc,"stringToRegexp");function fc(e,t,r){r===void 0&&(r={});for(var o=r.strict,a=o===void 0?!1:o,s=r.start,i=s===void 0?!0:s,c=r.end,l=c===void 0?!0:c,d=r.encode,h=d===void 0?function(M){return M}:d,f=r.delimiter,R=f===void 0?"/#?":f,_=r.endsWith,x=_===void 0?"":_,H="[".concat(Me(x),"]|$"),U="[".concat(Me(R),"]"),K=i?"^":"",re=0,F=e;re<F.length;re++){var C=F[re];if(typeof C=="string")K+=Me(h(C));else{var O=Me(h(C.prefix)),Y=Me(h(C.suffix));if(C.pattern)if(t&&t.push(C),O||Y)if(C.modifier==="+"||C.modifier==="*"){var L=C.modifier==="*"?"?":"";K+="(?:".concat(O,"((?:").concat(C.pattern,")(?:").concat(Y).concat(O,"(?:").concat(C.pattern,"))*)").concat(Y,")").concat(L)}else K+="(?:".concat(O,"(").concat(C.pattern,")").concat(Y,")").concat(C.modifier);else{if(C.modifier==="+"||C.modifier==="*")throw new TypeError('Can not repeat "'.concat(C.name,'" without a prefix and suffix'));K+="(".concat(C.pattern,")").concat(C.modifier)}else K+="(?:".concat(O).concat(Y,")").concat(C.modifier)}}if(l)a||(K+="".concat(U,"?")),K+=r.endsWith?"(?=".concat(H,")"):"$";else{var J=e[e.length-1],I=typeof J=="string"?U.indexOf(J[J.length-1])>-1:J===void 0;a||(K+="(?:".concat(U,"(?=").concat(H,"))?")),I||(K+="(?=".concat(U,"|").concat(H,")"))}return new RegExp(K,ia(r))}n(fc,"tokensToRegexp");function ca(e,t,r){return e instanceof RegExp?mc(e,t):Array.isArray(e)?hc(e,t,r):gc(e,t,r)}n(ca,"pathToRegexp");var Ft=/[.+?^${}()|[\]\\]/g;function*yc(e){let t=new URL(e.url).pathname;for(let r of[...A].reverse()){if(r.method&&r.method!==e.method)continue;let o=ct(r.routePath.replace(Ft,"\\$&"),{end:!1}),a=ct(r.mountPath.replace(Ft,"\\$&"),{end:!1}),s=o(t),i=a(t);if(s&&i)for(let c of r.middlewares.flat())yield{handler:c,params:s.params,path:i.path}}for(let r of A){if(r.method&&r.method!==e.method)continue;let o=ct(r.routePath.replace(Ft,"\\$&"),{end:!0}),a=ct(r.mountPath.replace(Ft,"\\$&"),{end:!1}),s=o(t),i=a(t);if(s&&i&&r.modules.length){for(let c of r.modules.flat())yield{handler:c,params:s.params,path:s.path};break}}}n(yc,"executeRequest");var yd={async fetch(e,t,r){let o=e,a=yc(o),s={},i=!1,c=n(async(l,d)=>{if(l!==void 0){let f=l;typeof l=="string"&&(f=new URL(l,o.url).toString()),o=new Request(f,d)}let h=a.next();if(h.done===!1){let{handler:f,params:R,path:_}=h.value,x={request:new Request(o.clone()),functionPath:_,next:c,params:R,get data(){return s},set data(U){if(typeof U!="object"||U===null)throw new Error("context.data must be an object");s=U},env:t,waitUntil:r.waitUntil.bind(r),passThroughOnException:n(()=>{i=!0},"passThroughOnException")},H=await f(x);if(!(H instanceof Response))throw new Error("Your Pages function should return a Response");return Lr(H)}else{let f=await t.ASSETS.fetch(o);return Lr(f)}},"next");try{return await c()}catch(l){if(i){let d=await t.ASSETS.fetch(o);return Lr(d)}throw l}}},Lr=n(e=>new Response([101,204,205,304].includes(e.status)?null:e.body,e),"cloneResponse");export{yd as default};
