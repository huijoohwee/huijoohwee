...
${Wt()}`},"injectRootVisibleFallback"),Rc=n(e=>{let t=ma(e);return/<meta\s+name=["']description["'][^>]*>/i.test(t)?t=t.replace(/<meta\s+name=["']description["'][^>]*>/i,`<meta name="description" content="${$r}" />`):t=Lr(t,`    <meta name="description" content="${$r}" />
