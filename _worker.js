...
}`;var Qe={push:"/api/storage/push",pull:"/api/storage/pull",exportPrefix:"/api/storage/export/",docPrefix:"/api/storage/doc/",defaultDocPrefix:"/api/storage/doc-default/",sourceFilesIndex:"/api/storage/source-files",sourceFilesIndexPrefix:"/api/storage/source-files/",sourceFilesLlms:"/api/storage/llms.txt"};var Yo=n((e,t)=>`${Qe.docPrefix}${encodeURIComponent(String(e||"").trim())}/${encodeURIComponent(String(t||"").trim())}`,"buildKnowgrphStorageDocPath"),Jo=n(e=>`${Qe.defaultDocPrefix}${encodeURIComponent(String(e||"").trim())}`,"buildKnowgrphStorageDefaultDocPath"),Xo=n(e=>{let t=String(e||"").trim();return t?`${Qe.sourceFilesIndexPrefix}${encodeURIComponent(t)}`:Qe.sourceFilesIndex},"buildKnowgrphStorageSourceFilesIndexPath");var I="https://airvio.co",et="https://knowgrph-storage.huijoohwee.workers.dev",P="/knowgrph",k=`${I}${P}/`,Zo=`${I}/`,Le="kgws:canonical-docs",se="2026-05-23",Te=`${P}/health`,Ce=`${I}${Te}`,Qo="/.well-known/agent-card.json",Lt=`${P}/.well-known/agent-card.json`,tt=`${I}${Qo}`,$t=`${I}/api/storage/source-files`,Fn=`${I}/api/storage/doc-default/{canonicalPath}`,Wn=`${I}/api/storage/doc/{workspaceId}/{canonicalPath}`,er="knowgrph-agent-ready-pages";var tr=['</.well-known/api-catalog>; rel="api-catalog"; type="application/linkset+json"',`<${P}/.well-known/openapi.json>; rel="service-desc"; type="application/vnd.oai.openapi+json;version=3.1"`,`<${P}/llms.txt>; rel="service-doc"; type="text/plain"`,'</auth.md>; rel="service-doc"; type="text/markdown"',`<${Te}>; rel="status"; type="application/health+json"`,`<${P}/.well-known/mcp/server-card.json>; rel="mcp-server-card"; type="application/json"`,`<${Qo}>; rel="describedby"; type="application/json"`].join(", "),or=`# Knowgrph
...
- Workspace Source File documents: ${Wn}
