...
- Default Source File documents: ${ns}
- Workspace Source File documents: ${as}
...
- Pipeline rule: agents must not bypass MainPanel -> FloatingPanel Chat -> KGC -> Canvas for user-mediated graph work; published HTTP MCP tools remain read-only until mutation auth and conflict semantics are implemented.`,mn={name:"Knowgrph Agent",description:"Agent-readable discovery, published-document retrieval, and WebMCP-ready metadata surface for Knowgrph.",version:"0.1.0",provider:{organization:"airvio / joohwee",url:k},url:`${k}mcp`,preferredTransport:"JSONRPC",supportedInterfaces:[{url:`${k}mcp`,protocolBinding:"JSONRPC",transportProtocol:"JSONRPC",description:"Primary machine interface for read-only discovery and source-file document access."},{url:mr,protocolBinding:"HTTP+JSON/REST",transportProtocol:"HTTP+JSON/REST",description:"Published source-files index and storage-backed document read surface."}],capabilities:{streaming:!1,pushNotifications:!1,stateTransitionHistory:!1,extendedAgentCard:!1},defaultInputModes:["text/plain","text/markdown","application/json"],defaultOutputModes:["text/plain","text/markdown","application/json"],skills:$o(kt)},ve={serverInfo:{name:"knowgrph",version:"0.1.0"},transport:{type:Pe,url:`${k}mcp`,stateless:!0},capabilities:{tools:kt.map(e=>({name:e.name,title:e.title,description:e.description,inputSchema:e.inputSchema,outputSchema:e.outputSchema,securitySchemes:e.securitySchemes,annotations:e.annotations,_meta:e._meta})),resources:{listChanged:!1},prompts:{listChanged:!1},...er()},prompts:cn,resourceTemplates:ln,clientSetups:rr({baseUrl:k,mcpUrl:`${k}mcp`,serverName:"knowgrph"}),links:{apiCatalog:`${k}.well-known/api-catalog`,skills:`${k}.well-known/agent-skills/index.json`,status:ze,agentCard:xt}},ms=bt({appUrl:k,updatedAt:Ae}),yr=kt.map(e=>({name:e.webName,title:e.title,description:e.description,inputSchema:e.inputSchema,outputSchema:e.outputSchema,securitySchemes:e.securitySchemes,annotations:e.annotations,_meta:e._meta})),$e=n(e=>nt(kt.find(t=>t.name===e)?.webName),"findWebMcpToolName"),hs=$e(p.search),gs=$e(p.fetch),fs=$e(p.listSourceFiles),ys=$e(p.readSourceFile),ws=$e(p.readSharedDocument),Ss=$e(p.inspectSharedDocumentStructure),_s=$e(p.inspectAgentSurface),bs=`(() => {
  ...
  const toolExecutors = createPublishedAgentReadyToolExecutors({
    toolNames: {
      ...
      fetch: ${JSON.stringify(gs)},
      listSourceFiles: ${JSON.stringify(fs)},
      readSourceFile: ${JSON.stringify(ys)},
      readSharedDocument: ${JSON.stringify(ws)},
      inspectSharedDocumentStructure: ${JSON.stringify(Ss)},
      inspectAgentSurface: ${JSON.stringify(_s)},
    },
    defaultWorkspaceId,
...
})();`,Ps=n(async e=>{if(!(e.headers.get("content-type")||"").toLowerCase().includes("text/html"))return e;let r=await e.text();if(yr.every(i=>r.includes(i.name)))return new Response(r,e);let o=`<script>${bs}<\/script>`,a=r.includes("</head>")?r.replace("</head>",`${o}</head>`):`${r}${o}`,s=new Response(a,e);return s.headers.delete("content-length"),s},"injectWebMcpScript"),As={search:p.search,fetch:p.fetch,listSourceFiles:p.listSourceFiles,readSourceFile:p.readSourceFile,readSharedDocument:p.readSharedDocument,inspectSharedDocumentStructure:p.inspectSharedDocumentStructure,inspectAgentSurface:p.inspectAgentSurface},Rs=n(async e=>{let t=new TextEncoder().encode(e),r=await crypto.subtle.digest("SHA-256",t);return[...new Uint8Array(r)].map(o=>o.toString(16).padStart(2,"0")).join("")},"sha256Hex"),hn=Lo(),xs=Object.fromEntries(Ze.map(e=>[e.name,Rs(hn[e.name]||"")])),an=new Map(Ze.map(e=>[`${T}${e.path}`.replace(/\/+$/,""),hn[e.name]||""]));var gn=n(async()=>Do({appUrl:k,updatedAt:Ae,sha256ByName:xs}),"agentSkillsIndex"),ks={keys:[{kty:"OKP",crv:"Ed25519",kid:"knowgrph-agent-ready-2026-05-21",use:"sig",alg:"EdDSA",x:"11qYAYdkVKxA4G0wV47IxPtYfFVH_H7zmC2Di2PcvLU"}]},Es={protocolVersion:"2025-06-18",capabilities:{tools:{},resources:{},prompts:{listChanged:!1},...er()},serverInfo:ve.serverInfo},wr=ve.capabilities.tools,Cs=[ms],Ts=cn,vs=ln,fn=n(()=>({status:"pass",service:"knowgrph-agent-ready-pages",homepage:k,health:ze,updatedAt:Ae,checks:{linkHeaders:!0,markdownNegotiation:!0,httpMcp:!0,webMcp:!0,mcpApps:!0,commerce:{acp:!0,ucp:!0,mpp:!0,x402:!0},defaultWorkspaceId:et}}),"buildHealthStatusBody"),Os=n(async()=>To({baseUrl:k,health:fn(),apiCatalog:un,openApi:dn,mcpServerCard:ve,agentCard:mn,agentSkills:await gn(),commerce:Yt({origin:B})}),"buildAgentSurfaceInspection"),Is=ar({toolNames:As,defaultWorkspaceId:et,publicBaseUrl:B,buildStorageDocPath:pn,fetchSourceFilesIndexResponse:n(()=>fetch(`${Rt}${Yo()}`,{headers:{accept:"text/markdown"}}),"fetchSourceFilesIndexResponse"),fetchStorageMarkdownResponse:n(e=>fetch(`${Rt}${e}`,{headers:{accept:"text/markdown"}}),"fetchStorageMarkdownResponse"),resolveSharedDocumentInput:n((e={})=>Pt({shareToken:e?.shareToken,shareUrl:e?.shareUrl,appBasePath:T,baseUrl:B}),"resolveSharedDocumentInput"),inspectSharedDocumentStructure:Oo,buildAgentSurfaceInspection:Os}),yn=n(e=>{try{let t=new URL(e,B);return Pt({shareUrl:`${t.pathname}${t.search}`,baseUrl:B,appBasePath:T})}catch{return null}},"resolvePublishedDocRequestIdentity"),Ms=n(e=>Pt({shareUrl:String(e||""),baseUrl:B,appBasePath:T}),"resolvePublishedDocPathIdentity"),Ns=n(async(e,t)=>{let r=new URL(pn(t.canonicalPath,t.workspaceId),Rt),o=await fetch(r,{method:"GET",headers:{accept:"text/markdown, text/plain;q=0.9, */*;q=0.1"}}),a=new Headers(o.headers),s=String(a.get("vary")||"");return a.set("vary",s?`${s}, Accept`:"Accept"),new Response(String(e.method||"").toUpperCase()==="HEAD"?null:o.body,{status:o.status,statusText:o.statusText,headers:a})},"proxyPublishedDocMarkdownResponse"),Us=n(async e=>{try{let t=await e.json();return t&&typeof t=="object"?t:null}catch{return null}},"readJsonRpcRequest"),Re=n((e,t)=>Et(200,{jsonrpc:"2.0",id:e??null,result:t}),"jsonRpcResult"),Te=n((e,t,r)=>Et(200,{jsonrpc:"2.0",id:e??null,error:{code:t,message:r}}),"jsonRpcError"),Ls=n(e=>String(e.headers.get("accept")||"").toLowerCase().split(",").some(t=>t.trim().startsWith("text/event-stream")),"requestAcceptsEventStream"),gr=n((e,t)=>Object.prototype.hasOwnProperty.call(e,t),"hasOwnProperty"),wn=n(e=>{if(Array.isArray(e))return e.length>0&&e.every(wn);if(!e||typeof e!="object"||String(e.jsonrpc||"")!=="2.0")return!1;let t=typeof e.method=="string"&&e.method.length>0,r=gr(e,"id"),o=gr(e,"result")||gr(e,"error");return t&&!r||!t&&o},"isJsonRpcNotificationOrResponse"),Sn=n(async(e,t)=>{let r=Is[e];if(typeof r!="function")throw new Error(`unknown tool: ${e}`);return r(t)},"executeMcpTool"),$s=n(async e=>{let t=nt(e);if(t===ie)return or({appUrl:k,updatedAt:Ae,toolNames:wr.map(o=>o.name)});let r=yo(t);if(r){let o=await Sn(p.fetch,{id:r});return wo({uri:t,sourceFile:o})}throw new Error(`unknown resource: ${e}`)},"readMcpResource"),Ds=n(async e=>{let t=String(e.method||"GET").toUpperCase();if(t==="GET"||t==="HEAD")return Ls(e)?on(405,{allow:"POST"}):ge({ok:!0,transport:ve.transport,serverInfo:ve.serverInfo,capabilities:ve.capabilities});if(t!=="POST")return Et(405,{ok:!1,error:"unsupported_method"});let r=await Us(e);if(!r)return Te(null,-32700,"Parse error");if(wn(r))return on(202);if(Array.isArray(r))return Te(null,-32600,"Batch JSON-RPC requests are not supported");switch(r.method){case"initialize":return Re(r.id,Es);case"tools/list":return Re(r.id,{tools:wr});case"prompts/list":return Re(r.id,{prompts:Ts});case"resources/templates/list":return Re(r.id,{resourceTemplates:vs});case"prompts/get":{let o=nt(r.params?.name),a=r.params?.arguments&&typeof r.params.arguments=="object"?r.params.arguments:{};if(!o)return Te(r.id,-32602,"Prompt name is required");try{return Re(r.id,mo(o,a))}catch(s){return Te(r.id,-32602,s instanceof Error?s.message:String(s))}}case"resources/list":return Re(r.id,{resources:Cs});case"resources/read":{let o=nt(r.params?.uri);if(!o)return Te(r.id,-32602,"Resource URI is required");try{return Re(r.id,await $s(o))}catch(a){return Te(r.id,-32602,a instanceof Error?a.message:String(a))}}case"tools/call":{let o=nt(r.params?.name),a=r.params?.arguments&&typeof r.params.arguments=="object"?r.params.arguments:{};if(!o)return Te(r.id,-32602,"Tool name is required");try{let s=await Sn(o,a);return Re(r.id,{content:[{type:"text",text:typeof s?.markdown=="string"?s.markdown:JSON.stringify(s,null,2)}],structuredContent:s,isError:!1})}catch(s){return Re(r.id,{content:[{type:"text",text:s instanceof Error?s.message:String(s)}],isError:!0})}}default:return Te(r.id,-32601,"Method not found")}},"handleMcpTransport"),Ks=n(()=>or({appUrl:k,updatedAt:Ae,toolNames:wr.map(e=>e.name)}).contents[0].text,"buildKnowgrphMcpAppHtmlBody");var Sr=n(e=>e===T||e===`${T}/`,"handlesKnowgrphRoot"),Hs=n(e=>Sr(e)||!!Ms(e),"handlesKnowgrphHtmlSurface"),js=n(e=>{let t=new URL(e.url),r=t.pathname.replace(/\/+$/,"")||"/",o=yn(e.url);return r===qe?"health":r===`${T}/mcp`?"mcp":r===`${T}/robots.txt`?"robots":r===`${T}/sitemap.xml`?"sitemap":r===`${T}/auth.md`||r==="/auth.md"?"auth-md":r.startsWith(`${T}/.well-known/`)?"well-known":o?tt(e)?"shared-doc-markdown":"shared-doc-html":Sr(t.pathname)?tt(e)?"homepage-markdown":"homepage-html":"app-surface"},"resolveAgentReadyRouteTag"),fr=n((e,t)=>rn(t,{owner:Qo,tag:js(e)}),"withKnowgrphRouteHeaders"),sn=n(async e=>{let t=new URL(e.url),r=t.pathname.replace(/\/+$/,"")||"/",o=yn(e.url);if(o&&tt(e))return Ns(e,o);if(Sr(t.pathname)&&tt(e))return tn(en);switch(r){case qe:return is(fn());case`${T}/mcp`:return Ds(e);case`${T}/robots.txt`:return rt(ps,"text/plain; charset=utf-8");case`${T}/sitemap.xml`:return rt(us,"application/xml; charset=utf-8");case`${T}/auth.md`:case"/auth.md":return rt(ds,"text/markdown; charset=utf-8");case`${T}/.well-known/api-catalog`:return ge(un,"application/linkset+json; charset=utf-8");case`${T}/.well-known/openapi.json`:return ge(dn,"application/vnd.oai.openapi+json; charset=utf-8");case dr:return ge(mn);case`${T}/.well-known/oauth-protected-resource`:return ge(ot);case`${T}/.well-known/oauth-authorization-server`:return ge(nn);case`${T}/.well-known/openid-configuration`:return ge(nn);case`${T}/.well-known/mcp/server-card.json`:return ge(ve);case`${T}/.well-known/mcp/apps/knowgrph-agent-ready.html`:return ss(Ks());case`${T}/.well-known/mcp.json`:return ge(ve);case`${T}/.well-known/agent-skills/index.json`:return ge(await gn());case`${T}/.well-known/http-message-signatures-directory`:return ge(ks);default:return an.has(r)?rt(an.get(r),"text/markdown; charset=utf-8"):null}},"routeResponse");async function Oe(e){let{env:t,request:r}=e,o=String(r.method||"GET").toUpperCase(),a=new URL(r.url);if(o==="OPTIONS")return new Response(null,{status:204,headers:{"access-control-allow-origin":"*","access-control-allow-methods":"GET, HEAD, POST, OPTIONS","access-control-allow-headers":"*","access-control-max-age":"86400"}});if(o==="POST"&&a.pathname.replace(/\/+$/,"")===`${T}/mcp`)return fr(r,await sn(r));if(o!=="GET"&&o!=="HEAD")return Et(405,{ok:!1,error:"unsupported_method"});let s=await sn(r);if(s){let d=fr(r,s);return o==="HEAD"?new Response(null,d):d}let i=await e.next();if(!Hs(a.pathname))return i;let c=o==="HEAD"?i:await Ps(i),l=new Response(o==="HEAD"?null:c.body,c);return l.headers.set("link",Zo),fr(r,l)}n(Oe,"onRequest");async function _n(e){return Oe(e)}n(_n,"onRequest");async function bn(e){return Oe(e)}n(bn,"onRequest");async function Pn(e){return Oe(e)}n(Pn,"onRequest");var Bs=Object.freeze(new Set(["","80","443"])),Fs=Object.freeze([".local",".localhost",".internal"]),Gs=Object.freeze(new Set(["localhost"]));function De(e){return String(e||"").trim().toLowerCase()}n(De,"normalizeHostname");function Ws(e){let t=De(e);if(!/^\d{1,3}(\.\d{1,3}){3}$/.test(t))return!1;let r=t.split(".").map(o=>Number(o));return r.length!==4?!1:r.every(o=>Number.isInteger(o)&&o>=0&&o<=255)}n(Ws,"isIpv4Literal");function An(e){let[t,r,o,a]=e.split(".").map(s=>Number(s));return(t<<24|r<<16|o<<8|a)>>>0}n(An,"ipv4ToInt");function zs(e,t,r){if(!Number.isInteger(r)||r<0||r>32)return!1;if(r===0)return!0;let o=4294967295<<32-r>>>0;return(e&o)===(t&o)}n(zs,"inIpv4Cidr");function qs(e){let t=De(e);return!t||!t.includes(":")?!1:/^[0-9a-f:]+$/i.test(t)}n(qs,"isIpv6Literal");function Vs(e){let t=De(e);return!!(!t||t==="::1"||t==="0:0:0:0:0:0:0:1"||t.startsWith("fc")||t.startsWith("fd")||/^fe[89ab]/i.test(t))}n(Vs,"isBlockedIpv6");function Ys(e,{blockedExact:t,blockedSuffixes:r}={}){let o=De(e);if(!o)return!0;let a=t||Gs;if(a instanceof Set&&a.has(o))return!0;let s=r||Fs;if(Array.isArray(s))for(let i of s){let c=De(i);if(c&&(o===c||o.endsWith(c)))return!0}return!1}n(Ys,"isBlockedHostname");function Js(e){let t=De(e);if(!t)return!0;if(Ws(t)){let r=An(t),o=[{base:"0.0.0.0",bits:8},{base:"10.0.0.0",bits:8},{base:"127.0.0.0",bits:8},{base:"169.254.0.0",bits:16},{base:"172.16.0.0",bits:12},{base:"192.168.0.0",bits:16},{base:"100.64.0.0",bits:10}];for(let a of o){let s=An(a.base);if(zs(r,s,a.bits))return!0}return!1}return qs(t)?Vs(t):!1}n(Js,"isBlockedIpLiteral");function Ct(e,{allowedPorts:t}={}){let r=String(e||"").trim();if(!r)throw new Error("invalid_url");let o;try{o=new URL(r)}catch{throw new Error("invalid_url")}if(o.protocol!=="http:"&&o.protocol!=="https:")throw new Error("invalid_url");if(o.username||o.password)throw new Error("invalid_url");let a=t||Bs,s=String(o.port||"");if(a instanceof Set&&!a.has(s))throw new Error("port_not_allowed");let i=De(o.hostname);if(!i)throw new Error("invalid_url");if(Ys(i))throw new Error("blocked_host");if(Js(i))throw new Error("blocked_host");return o}n(Ct,"parseAndValidateExternalUrl");function Tt(e){return String(e.headers.get("sec-fetch-site")||"").trim().toLowerCase()==="cross-site"}n(Tt,"shouldRejectCrossSiteFetch");var Xs={"content-type":"application/json; charset=utf-8","cache-control":"public, max-age=600"};function Ke(e,t={}){return new Response(JSON.stringify(e),{...t,headers:{...Xs,...t.headers||{}}})}n(Ke,"json");function vt(...e){for(let t of e){if(!t)continue;let r=String(t).trim();if(r)return r}return null}n(vt,"pickFirst");function Qs(e){let t=e.slice(0,8e4),r=t.match(/<title[^>]*>([^<]*)<\/title>/i),o=t.match(/<meta[^>]+property=["']og:title["'][^>]*content=["']([^"']+)["'][^>]*>/i),a=t.match(/<meta[^>]+property=["']og:description["'][^>]*content=["']([^"']+)["'][^>]*>/i),s=t.match(/<meta[^>]+name=["']description["'][^>]*content=["']([^"']+)["'][^>]*>/i),i=t.match(/<meta[^>]+property=["']og:image["'][^>]*content=["']([^"']+)["'][^>]*>/i),c=t.match(/<meta[^>]+property=["']og:site_name["'][^>]*content=["']([^"']+)["'][^>]*>/i);return{title:vt(o?.[1],r?.[1]),description:vt(a?.[1],s?.[1]),image:vt(i?.[1]),siteName:vt(c?.[1])}}n(Qs,"extractMeta");async function Rn(e){let t=e.request.url,r=new URL(t);if(r.searchParams.get("ping")==="1")return Ke({ok:!0,ping:!0});let o=r.searchParams.get("url")||"";if(Tt(e.request))return Ke({ok:!1,error:"forbidden"},{status:403,headers:{"cache-control":"no-store"}});let a;try{a=Ct(o)}catch{return Ke({ok:!1,error:"invalid_url"},{status:400,headers:{"cache-control":"no-store"}})}try{let s=await fetch(a.toString(),{headers:{"user-agent":"Mozilla/5.0 (compatible; HackaMapLinkPreview/1.0)",accept:"text/html,application/xhtml+xml"},redirect:"follow",cf:{cacheTtl:600,cacheEverything:!0}}),i=s.headers.get("content-type")||"";if(!s.ok)return Ke({ok:!1,error:"fetch_failed",status:s.status,url:a.toString()},{status:200,headers:{"cache-control":"no-store"}});if(!i.includes("text/html"))return Ke({ok:!0,url:a.toString(),domain:a.host,contentType:i,title:null,description:null,image:null,siteName:null});let c=await s.text(),l=Qs(c);return Ke({ok:!0,url:a.toString(),domain:a.host,contentType:i,...l})}catch(s){return Ke({ok:!1,error:"exception",message:s?.message||String(s),url:a.toString()},{status:200,headers:{"cache-control":"no-store"}})}}n(Rn,"onRequestGet");var xn=35e4;function Zs(e){let t=e;return t=t.replace(/<script\b[\s\S]*?<\/script>/gi,""),t=t.replace(/<iframe\b[\s\S]*?<\/iframe>/gi,""),t=t.replace(/<object\b[\s\S]*?<\/object>/gi,""),t=t.replace(/<embed\b[\s\S]*?>/gi,""),t=t.replace(/<noscript\b[\s\S]*?<\/noscript>/gi,""),t=t.replace(/\son[a-z]+\s*=\s*"[^"]*"/gi,""),t=t.replace(/\son[a-z]+\s*=\s*'[^']*'/gi,""),t}n(Zs,"stripActiveContent");function ei({url:e,title:t,innerHtml:r}){let o=t?String(t).slice(0,140):"Preview",a=String(e).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;");return`<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
...
</html>`}n(ei,"buildWrapper");async function kn(e){let r=new URL(e.request.url).searchParams.get("url")||"";if(Tt(e.request))return new Response("Forbidden",{status:403,headers:{"cache-control":"no-store"}});let o;try{o=Ct(r)}catch(a){let s=a instanceof Error?a.message:"invalid_url";return new Response(s,{status:400,headers:{"cache-control":"no-store"}})}try{let a=await fetch(o.toString(),{headers:{"user-agent":"Mozilla/5.0 (compatible; HackaMapLinkProxy/1.0)",accept:"text/html,application/xhtml+xml"},redirect:"follow",cf:{cacheTtl:600,cacheEverything:!0}}),s=a.headers.get("content-type")||"";if(!a.ok)return new Response(`Fetch failed (${a.status})`,{status:200,headers:{"content-type":"text/plain; charset=utf-8","cache-control":"no-store"}});if(!s.includes("text/html"))return new Response(`Unsupported content-type: ${s}`,{status:200,headers:{"content-type":"text/plain; charset=utf-8","cache-control":"public, max-age=600"}});let i=await a.text();i.length>xn&&(i=i.slice(0,xn));let l=i.match(/<title[^>]*>([^<]*)<\/title>/i)?.[1]?.trim()||o.host;i=Zs(i),/<base\s/i.test(i)||(i=i.replace(/<head([^>]*)>/i,`<head$1><base href="${o.origin}/">`));let h=ei({url:o.toString(),title:l,innerHtml:i});return new Response(h,{status:200,headers:{"content-type":"text/html; charset=utf-8","cache-control":"public, max-age=600","content-security-policy":"default-src 'none'; img-src https: data:; style-src 'unsafe-inline' https:; font-src https: data:; frame-ancestors 'self';"}})}catch(a){return new Response(`Exception: ${a?.message||String(a)}`,{status:200,headers:{"content-type":"text/plain; charset=utf-8","cache-control":"no-store"}})}}n(kn,"onRequestGet");var _r="api.openai.com",Ot="api.miromind.ai",It="apihub.agnes-ai.com",Mt="ark.ap-southeast.bytepluses.com",br="ark.eu-west.bytepluses.com",Cn=new Set(["localhost","127.0.0.1","0.0.0.0"]),_e=n(e=>String(e||"").trim().toLowerCase(),"normalizeHost"),fe=n((e,t)=>String(e.get(t)||"").trim(),"readHeader"),Tn=n(e=>Cn.has(_e(e)),"isLocalHost"),En=n(e=>{let t=String(e||"").trim();if(!t)return new Set;let r=new Set;return t.split(",").map(o=>_e(o)).filter(Boolean).forEach(o=>r.add(o)),r},"parseCsvSet"),vn=n((e,{includeOpenAi:t=!1,includeMiroMind:r=!1,includeAgnes:o=!1,includeBytePlus:a=!1}={})=>{let s=En(e.KNOWGRPH_INTEGRATION_ALLOWED_HOSTS),i=En(e.KNOWGRPH_CHAT_PROXY_ALLOWED_HOSTS),c=s.size?s:i,l=c.size?c:new Set([...Cn]);return t&&l.add(_r),r&&l.add(Ot),o&&l.add(It),a&&(l.add(Mt),l.add(br)),l},"parseAllowedHosts"),ae=n(e=>{let t=fe(e.headers,"origin");if(!t)return{};let r="";try{r=_e(new URL(t).host)}catch{return{}}let o=_e(new URL(e.url).host);return r===o||r.startsWith("localhost:")||r.startsWith("127.0.0.1:")?{"access-control-allow-origin":t,vary:"Origin"}:{}},"corsHeaders"),de=n((e,t,r)=>new Response(JSON.stringify(t),{status:r,headers:{"content-type":"application/json; charset=utf-8","cache-control":"no-store",...ae(e)}}),"jsonResponse");var Nt={"content-type":"application/json; charset=utf-8","cache-control":"no-store"};function at(e,t,r=200){return new Response(JSON.stringify(t),{status:r,headers:{...Nt,...ae(e)}})}n(at,"jsonResponse");async function ti(e){let t=new URL("/knowgrph/imports/hackamap/hackamap-graph.json",e.url),r=await fetch(t.toString(),{redirect:"follow"});return r.ok?await r.json():null}n(ti,"fetchHackamapGraphJson");async function He(e,t){let r=new URL(t,e.url),o=await fetch(r.toString(),{redirect:"follow"});return o.ok?await o.json():null}n(He,"fetchHackamapJson");async function ri(e){let t=await He(e,"/knowgrph/imports/hackamap/hackamap_api_graph.json");return Nn(t)?t:null}n(ri,"fetchHackamapApiGraphJson");async function oi(e){let t=await He(e,"/knowgrph/imports/hackamap/hackamap_pipeline.json");return t&&typeof t=="object"&&!Array.isArray(t)?t:{}}n(oi,"fetchHackamapPipelineJson");async function In(e){let t=await He(e,"/knowgrph/imports/hackamap/hackamap_query_presets.json");return Array.isArray(t)?t.filter(Boolean):[]}n(In,"fetchHackamapQueryPresetsJson");async function Mn(e){let t=await He(e,"/knowgrph/imports/hackamap/query-outputs/query-runs.manifest.json");return t&&typeof t=="object"&&!Array.isArray(t)?t:{}}n(Mn,"fetchHackamapQueryRunsManifestJson");function Nn(e){return!e||typeof e!="object"||Array.isArray(e)?!1:Array.isArray(e.nodes)&&Array.isArray(e.edges)}n(Nn,"isApiGraphPayload");function Un(e,t){let r=String(e&&e.output&&e.output.per_table_prefix||e?.id||t?.preset||"").trim(),o=String(t?.output_suffix||"").trim();return o?`${r}-${o}`:r}n(Un,"buildHackamapTablePrefix");function Pr(e,t){if(!Array.isArray(e))return[];let r=[];for(let o of e){if(!o||typeof o!="object"||Array.isArray(o))continue;let a=String(o[t]||"").trim();a&&r.push(a)}return r}n(Pr,"collectRowIds");async function ni(e,t){let r=await He(e,t);return Array.isArray(r)?r.length:0}n(ni,"countHackamapQueryRows");async function ai(e,t,r){let o=Un(t,r);if(!o)return{};let a=["events","demos","sources","organizer","team","techstack"],s=await Promise.all(a.map(async i=>[i,await ni(e,`/knowgrph/imports/hackamap/query-outputs/${i}.${o}.query.json`)]));return Object.fromEntries(s.filter(([,i])=>i>0))}n(ai,"readHackamapRunTableCounts");function Ar(e){return Array.isArray(e)?e.map(Ar):!e||typeof e!="object"?e:Object.fromEntries(Object.entries(e).sort(([t],[r])=>String(t).localeCompare(String(r))).map(([t,r])=>[t,Ar(r)]))}n(Ar,"sortObjectKeys");function si(e){try{return JSON.stringify(Ar(e))}catch{return""}}n(si,"stableParamSignature");function ii(e){return typeof e=="string"?{value:e,label:e}:{value:e,label:JSON.stringify(e)}}n(ii,"toBuilderOption");function ci(e,t){return e.map(r=>{let o=String(r?.id||"").trim();if(!o)return null;let a=r?.params&&typeof r.params=="object"&&!Array.isArray(r.params)?r.params:{},s=t.filter(l=>String(l?.preset||"").trim()===o),i=Array.from(new Set([...Object.keys(a),...s.flatMap(l=>l?.params&&typeof l.params=="object"&&!Array.isArray(l.params)?Object.keys(l.params):[])])).sort((l,d)=>String(l).localeCompare(String(d))),c=Object.fromEntries(i.map(l=>{let d=new Set,h=[],f=[a[l],...s.map(A=>A?.params&&typeof A.params=="object"&&!Array.isArray(A.params)?A.params[l]:void 0)];for(let A of f){if(typeof A>"u")continue;let _=si(A);!_||d.has(_)||(d.add(_),h.push(ii(A)))}return[l,h]}));return{id:o,title:String(r?.title||o).trim(),params:a,param_keys:i,published_param_options:c}}).filter(Boolean)}n(ci,"buildHackamapPresetRuntimeEntries");async function li(e){let[t,r,o]=await Promise.all([oi(e),In(e),Mn(e)]),a=t&&typeof t=="object"?t.runtime||{}:{},s=String(a?.query_selection?.default_run_id||"").trim()||"enhanced",i=Array.isArray(o?.runs)?o.runs:[],c=(await Promise.all(i.map(async l=>{let d=String(l?.id||"").trim(),h=String(l?.preset||"").trim();if(!d)return null;let f=r.find(_=>String(_?.id||"").trim()===h),A=await ai(e,f,l);return{id:d,preset:h,title:String(l?.title||l?.id||"").trim(),params:l?.params&&typeof l.params=="object"&&!Array.isArray(l.params)?l.params:{},output_suffix:String(l?.output_suffix||"").trim(),is_default:d===s,table_counts:A}}))).filter(l=>l?.id);return{ok:!0,runtime:{...a&&typeof a=="object"?a:{},presets:ci(r,c),runs:c}}}n(li,"buildHackamapRuntimeMeta");async function pi(e,t){let r=String(t||"").trim();if(!r)return null;let[o,a]=await Promise.all([In(e),Mn(e)]),i=(Array.isArray(a?.runs)?a.runs:[]).find(x=>String(x?.id||"").trim()===r);if(!i)return null;let c=o.find(x=>String(x?.id||"").trim()===String(i?.preset||"").trim()),l=Un(c,i);if(!l)return null;let[d,h]=await Promise.all([He(e,`/knowgrph/imports/hackamap/query-outputs/events.${l}.query.json`),He(e,`/knowgrph/imports/hackamap/query-outputs/demos.${l}.query.json`)]),f=new Set(Pr(d,"id")),A=new Set(Pr(h,"id")),_=Pr(h,"event_id");for(let x of _)f.add(x);return{eventIds:f,demoIds:A}}n(pi,"readHackamapQueryRunSelection");function On(e,t,r){if(!r||!Nn(e))return e;if(r.eventIds.size===0&&r.demoIds.size===0)return{...e,meta:{...e?.meta&&typeof e.meta=="object"?e.meta:{},selected_run_id:t,selected_run_filter_skipped:"no-event-demo-rows"}};let o=new Set;r.eventIds.forEach(c=>o.add(`Event:${c}`)),r.demoIds.forEach(c=>o.add(`Demo:${c}`));let a=Array.isArray(e.nodes)?e.nodes.filter(c=>o.has(String(c?.id||"").trim())):[],s=new Set(a.map(c=>String(c?.id||"").trim()).filter(Boolean)),i=Array.isArray(e.edges)?e.edges.filter(c=>s.has(String(c?.source||"").trim())&&s.has(String(c?.target||"").trim())):[];return{...e,nodes:a,edges:i,meta:{...e?.meta&&typeof e.meta=="object"?e.meta:{},selected_run_id:t,selected_event_count:r.eventIds.size,selected_demo_count:r.demoIds.size,total_problems:a.filter(c=>String(c?.type||"").trim()==="problem").length,total_solutions:a.filter(c=>String(c?.type||"").trim()==="solution").length}}}n(On,"filterHackamapApiGraphPayloadByRun");function ui(e){let t=Array.isArray(e?.nodes)?e.nodes:[],r=Array.isArray(e?.links)?e.links:[],o=[],a=new Set;for(let i of t){let c=String(i?.id||"").trim(),l=String(i?.type||"").trim(),d=String(i?.label||"").trim();if(!(!c||!l||!d)){if(l==="Event"){o.push({id:c,type:"problem",label:d,cluster:"Event"}),a.add(c);continue}l==="Demo"&&(o.push({id:c,type:"solution",label:d,cluster:"Demo"}),a.add(c))}}let s=[];for(let i of r){let c=String(i?.source||"").trim(),l=String(i?.target||"").trim(),d=String(i?.type||"").trim();!c||!l||d==="has_demo"&&(!a.has(c)||!a.has(l)||s.push({source:c,target:l,type:"has_demo",strength:.35}))}return{nodes:o,edges:s,meta:{source:"hackamap-graph.json:fallback",total_problems:o.filter(i=>i.type==="problem").length,total_solutions:o.filter(i=>i.type==="solution").length,...e?.content_signature?{content_signature:String(e.content_signature)}:{}}}}n(ui,"toBipartiteApiPayload");async function Ln(e){let{request:t}=e,r=String(t.method||"GET").toUpperCase(),o=new URL(t.url);if(r==="OPTIONS")return new Response(null,{status:204,headers:{...ae(t),"access-control-allow-methods":"GET, HEAD, OPTIONS","access-control-allow-headers":"*","access-control-max-age":"86400"}});if(r!=="GET"&&r!=="HEAD")return at(t,{ok:!1,error:"unsupported_method"},405);if(String(o.searchParams.get("view")||"").trim().toLowerCase()==="meta"){let h=await li(t);return r==="HEAD"?new Response(null,{status:200,headers:{...Nt,...ae(t)}}):at(t,h,200)}let a=String(o.searchParams.get("run")||"").trim(),s=await pi(t,a),i=await ri(t);if(i){let h=On(i,a,s);return r==="HEAD"?new Response(null,{status:200,headers:{...Nt,...ae(t)}}):at(t,h,200)}let c=await ti(t);if(!c)return at(t,{ok:!1,error:"missing_hackamap_graph",hint:"/knowgrph/imports/hackamap/{hackamap_api_graph.json,hackamap-graph.json} not found"},404);let l=ui(c),d=On(l,a,s);return r==="HEAD"?new Response(null,{status:200,headers:{...Nt,...ae(t)}}):at(t,d,200)}n(Ln,"onRequest");var di=!0,$n=600,Dn={"content-type":"application/json; charset=utf-8","cache-control":`public, max-age=${$n}`};function je(e,t,r={}){return new Response(JSON.stringify(t),{...r,headers:{...Dn,...r.headers||{},...ae(e)}})}n(je,"jsonResponse");function mi(e){try{let t=new URL(String(e));return t.protocol==="http:"||t.protocol==="https:"}catch{return!1}}n(mi,"isHttpUrl");function st(e){return String(e||"").trim().toLowerCase()}n(st,"normalizeHost");function Rr(e,{exact:t,suffixes:r}){let o=st(e);return o?!!(Array.isArray(t)&&t.some(a=>o===st(a))||Array.isArray(r)&&r.some(a=>o===st(a)||o.endsWith(`.${st(a)}`))):!1}n(Rr,"isHostMatch");function hi(e){let t=st(e.hostname),r=e.toString();return Rr(t,{suffixes:["linkedin.com"]})?new URL(`https://www.linkedin.com/embeds/oembed.json?url=${encodeURIComponent(r)}`):Rr(t,{exact:["twitter.com","x.com"],suffixes:["twitter.com","x.com"]})?new URL(`https://publish.twitter.com/oembed?omit_script=1&url=${encodeURIComponent(r)}`):Rr(t,{exact:["reddit.com"],suffixes:["reddit.com"]})?new URL(`https://www.reddit.com/oembed?url=${encodeURIComponent(r)}`):null}n(hi,"buildOembedUpstreamUrl");async function gi({upstreamUrl:e}){return await fetch(e.toString(),{headers:{"user-agent":"Mozilla/5.0 (compatible; OEmbedProxy/1.0)",accept:"application/json,text/json;q=0.9,*/*;q=0.1"},redirect:"follow",cf:{cacheTtl:$n,cacheEverything:!0}})}n(gi,"fetchJsonUpstream");async function Kn(e){let{request:t}=e,r=String(t.method||"GET").toUpperCase(),o=new URL(t.url);if(r==="OPTIONS")return new Response(null,{status:204,headers:{...ae(t),"access-control-allow-methods":"GET, HEAD, OPTIONS","access-control-allow-headers":"*","access-control-max-age":"86400"}});if(!["GET","HEAD"].includes(r))return je(t,{ok:!1,error:"unsupported_method"},{status:405});if(o.searchParams.get("ping")==="1")return je(t,{ok:!0,ping:!0});if(di)return je(t,{ok:!1,error:"disabled_by_policy"},{status:200,headers:{"cache-control":"no-store"}});let a=o.searchParams.get("url")||"";if(!mi(a))return je(t,{ok:!1,error:"invalid_url"},{status:400,headers:{"cache-control":"no-store"}});let s;try{s=new URL(a)}catch{return je(t,{ok:!1,error:"invalid_url"},{status:400,headers:{"cache-control":"no-store"}})}let i=hi(s);if(!i)return je(t,{ok:!1,error:"unsupported_provider"},{status:400,headers:{"cache-control":"no-store"}});let c=await gi({upstreamUrl:i}),l=new Headers(c.headers);l.delete("content-length"),l.set("cache-control",c.ok?Dn["cache-control"]:"no-store");for(let[h,f]of Object.entries(ae(t)))l.set(h,f);if(r==="HEAD")return new Response(null,{status:c.status,headers:l});let d=await c.text();try{JSON.parse(d)}catch{return je(t,{ok:!1,error:"invalid_upstream_json",status:c.status},{status:502,headers:{"cache-control":"no-store"}})}return l.set("content-type","application/json; charset=utf-8"),new Response(d,{status:c.status,headers:l})}n(Kn,"onRequest");var Hn="/__chat_proxy",Ut="agnes-ai",Lt="byteplus-modelark",$t="miromind",fi=n(e=>{let t=_e(e);return t==="openai"?"openai":t===Lt||t==="byteplus"?Lt:t===$t||t==="miromind-api"?$t:t===Ut||t==="agnes"||t==="agnes-ai-api"?Ut:t},"normalizeProviderId"),yi=n(e=>_e(e)===It,"isAgnesHost"),wi=n(e=>{let t=_e(e);return t===Mt||t===br},"isBytePlusHost"),Si=n(e=>_e(e)===Ot,"isMiroMindHost"),_i=n(({provider:e,requestedUpstream:t,env:r})=>e==="openai"?"https://api.openai.com":e===$t?t||`https://${Ot}`:e===Ut?t||`https://${It}`:e===Lt?t||String(r.KNOWGRPH_CHAT_PROXY_UPSTREAM||"").trim()||`https://${Mt}`:t||String(r.KNOWGRPH_CHAT_PROXY_UPSTREAM||"").trim(),"pickUpstreamBase");async function jn(e){let{request:t,env:r}=e,o=String(t.method||"GET").toUpperCase(),a=new URL(t.url);if(o==="OPTIONS")return new Response(null,{status:204,headers:{"access-control-allow-origin":fe(t.headers,"origin")||"*","access-control-allow-methods":"GET, HEAD, POST, OPTIONS","access-control-allow-headers":"*","access-control-max-age":"86400"}});if(!["GET","HEAD","POST"].includes(o))return de(t,{ok:!1,error:"Unsupported method"},405);let s=fi(fe(t.headers,"x-kg-chat-provider")),i=_i({provider:s,requestedUpstream:fe(t.headers,"x-kg-chat-upstream"),env:r});if(!i)return de(t,{ok:!1,error:"Missing chat proxy upstream configuration"},500);let c;try{c=new URL(i)}catch{return de(t,{ok:!1,error:"Invalid chat proxy upstream configuration"},500)}let l=vn(r,{includeOpenAi:!0,includeMiroMind:!0,includeAgnes:!0,includeBytePlus:!0}),d=_e(c.hostname);if(!l.has(d))return de(t,{ok:!1,error:"Chat proxy upstream host is not allowed"},403);if(!Tn(d)&&c.protocol!=="https:")return de(t,{ok:!1,error:"Chat proxy requires HTTPS for non-local upstream hosts"},403);let h=s==="openai"||d===_r,f=s===$t||Si(d),A=s===Ut||yi(d),_=s===Lt||wi(d),x=fe(t.headers,"x-kg-chat-api-key"),H=String(r.KNOWGRPH_CHAT_PROXY_OPENAI_API_KEY||r.OPENAI_API_KEY||"").trim(),U=String(r.KNOWGRPH_CHAT_PROXY_MIROMIND_API_KEY||r.MIROMIND_API_KEY||"").trim(),D=String(r.KNOWGRPH_CHAT_PROXY_AGNES_API_KEY||r.AGNES_API_KEY||"").trim(),re=String(r.KNOWGRPH_CHAT_PROXY_BYTEPLUS_API_KEY||r.BYTEPLUS_API_KEY||"").trim(),F=(x||H).slice(0,512),C=(x||U).slice(0,512),O=(x||D).slice(0,512),Y=(x||re).slice(0,512),L=_?Y:A?O:f?C:F;if(h&&!F)return de(t,{ok:!1,error:"Missing OpenAI API key for chat proxy upstream (set KNOWGRPH_CHAT_PROXY_OPENAI_API_KEY or OPENAI_API_KEY)"},401);if(f&&!L)return de(t,{ok:!1,error:"Missing MiroMind API key for chat proxy upstream (set KNOWGRPH_CHAT_PROXY_MIROMIND_API_KEY or MIROMIND_API_KEY)"},401);if(A&&!L)return de(t,{ok:!1,error:"Missing Agnes API key for chat proxy upstream (set KNOWGRPH_CHAT_PROXY_AGNES_API_KEY or AGNES_API_KEY)"},401);if(_&&!L)return de(t,{ok:!1,error:"Missing BytePlus API key for chat proxy upstream (set KNOWGRPH_CHAT_PROXY_BYTEPLUS_API_KEY or BYTEPLUS_API_KEY)"},401);if(o==="POST"&&!fe(t.headers,"content-type").toLowerCase().includes("application/json"))return de(t,{ok:!1,error:"Chat proxy expects application/json payloads"},415);let J=a.pathname.startsWith(Hn)&&a.pathname.slice(Hn.length)||"/v1/chat/completions",I=J.startsWith("/")?J:`/${J}`,M=new URL(`${I}${a.search||""}`,c),j=new Headers,oe=fe(t.headers,"content-type"),le=fe(t.headers,"accept");oe&&j.set("content-type",oe),le&&j.set("accept",le),(h||f||A||_)&&j.set("authorization",`Bearer ${L}`);let ye=fe(t.headers,"x-client-request-id").slice(0,512);ye&&j.set("x-client-request-id",ye);let P=new AbortController,y=Number(r.KNOWGRPH_CHAT_PROXY_TIMEOUT_MS),S=Number.isFinite(y)?Math.max(5e3,Math.min(18e4,Math.floor(y))):9e4,u=setTimeout(()=>P.abort(),S);try{let m=await fetch(M.toString(),{method:o,headers:j,body:o==="GET"||o==="HEAD"?void 0:t.body,signal:P.signal,redirect:"follow"}),g=new Headers(m.headers);g.delete("content-length"),g.delete("www-authenticate"),g.set("cache-control","no-store");let b=fe(t.headers,"origin");return b&&(g.set("access-control-allow-origin",b),g.set("vary","Origin")),o==="HEAD"?new Response(null,{status:m.status,statusText:m.statusText,headers:g}):new Response(m.body,{status:m.status,statusText:m.statusText,headers:g})}catch(m){let g=m&&typeof m=="object"&&"message"in m?String(m.message||""):"",b=P.signal.aborted||/aborted|timeout/i.test(g);return de(t,{ok:!1,error:g||"Failed to reach chat upstream"},b?504:502)}finally{clearTimeout(u)}}n(jn,"onRequest");function bi(e){let t=e.map(r=>r==null?"":typeof r=="boolean"?r?"1":"0":typeof r=="number"?Number.isFinite(r)?String(r):"":String(r)).join("|");return`rich-media-preview:${Ye(t)}`}n(bi,"buildRichMediaPreviewSemanticKey");var Fn="png";function Kt(e){let t=typeof e=="number"?e:Number(String(e??"").trim());if(!Number.isFinite(t))return null;let r=Math.max(0,Math.floor(t));return Number.isFinite(r)?r:null}n(Kt,"normalizeRemoteVideoFrameSeconds");function Ht(e){let t=String(e||"").trim().toLowerCase();return t==="jpg"||t==="jpeg"?"jpg":"png"}n(Ht,"normalizeRemoteVideoFrameFormat");function xr(e){let t=String(e.sourceUrl||"").trim(),r=Kt(e.timeSeconds)??0,o=Ht(e.format||Fn);return bi(["remote-video-frame",t,r,o])}n(xr,"buildRemoteVideoFrameSemanticKey");function Gn(e){let t=Kt(e.timeSeconds)??0,r=Ht(e.format||Fn),o=xr({...e,timeSeconds:t,format:r});return`frame-${o.split(":").pop()||Ye(o)}-t${t}.${r}`}n(Gn,"buildRemoteVideoFrameFileName");var Dt=n(e=>{let t=String(e||"").trim();return t&&/^[A-Za-z0-9_-]{6,128}$/.test(t)?t:null},"normalizeYouTubeIdLikeValue"),Bn=n(e=>{try{let t=new URL(String(e||"").trim()),r=String(t.hostname||"").toLowerCase();if(r==="youtu.be"||r.endsWith(".youtu.be")){let o=t.pathname.replace(/^\/+/,"").split("/")[0]?.trim()||"";return Dt(o)}if(r==="youtube.com"||r.endsWith(".youtube.com")||r==="youtube-nocookie.com"||r.endsWith(".youtube-nocookie.com")){let o=String(t.searchParams.get("v")||"").trim();if(o)return Dt(o);let a=t.pathname.split("/").filter(Boolean),s=a[0]||"",i=a[1]||"";if((s==="embed"||s==="shorts"||s==="live")&&i)return Dt(i);if(s==="watch"){let c=String(t.searchParams.get("v")||"").trim();return Dt(c)}}}catch{return null}return null},"readYouTubeIdFromUrl");function Pi(e){let t=String(e||"").trim().replace(/^<|>$/g,"").trim();for(;/[),.;:!?]$/.test(t);){let r=t.slice(0,-1).trim();if(!r)break;let o=Bn(t),a=Bn(r);if(!a||o&&o!==a)break;t=r}return t}n(Pi,"stripYouTubeUrlTrailingPunctuation");function Wn(e){let t=n(r=>{let o=String(r||"").trim();if(!o)return null;if(/^\d+$/.test(o))return Number(o);let a=o.match(/^(?:(\d+)h)?(?:(\d+)m)?(?:(\d+)s)?$/i);if(!a)return null;let s=a[1]?Number(a[1]):0,i=a[2]?Number(a[2]):0,c=a[3]?Number(a[3]):0,l=s*3600+i*60+c;return l>0&&Number.isFinite(l)?l:null},"parseChunk");try{let r=new URL(Pi(e)),o=r.searchParams.get("t")||r.searchParams.get("start")||"",a=r.hash&&new URLSearchParams(r.hash.replace(/^#/,"")).get("t")||"";return t(o)??t(a)}catch{return null}}n(Wn,"parseYouTubeStartSeconds");var Ai="/image/knowgrph/video-frame",Ri=4096,xi=720*60,ki=/^frame-[a-f0-9]+-t\d+\.(?:png|jpg)$/i,Tr={"access-control-allow-origin":"*","access-control-allow-methods":"GET, HEAD, OPTIONS","access-control-allow-headers":"accept, content-type"},Cr=n(e=>String(e||"").replace(/\s+/g," ").trim(),"cleanText"),kr=n((e,t=200,r="GET")=>new Response(r==="HEAD"?null:JSON.stringify(e),{status:t,headers:{...Tr,"content-type":"application/json; charset=utf-8","cache-control":"no-store"}}),"jsonResponse"),Er=n((e,t=200,r="GET")=>new Response(r==="HEAD"?null:e,{status:t,headers:{...Tr,"content-type":"text/plain; charset=utf-8","cache-control":"no-store"}}),"textResponse"),Ei=n((e,t)=>e===t||e.endsWith(`.${t}`),"hostMatches"),Ci=n(e=>{let t=Cr(e?.KG_VIDEO_FRAME_ALLOWED_HOSTS);return t?t.split(",").map(r=>Cr(r).toLowerCase()).filter(Boolean):["youtube.com","youtu.be","youtube-nocookie.com","bilibili.com","b23.tv"]},"readAllowedHosts"),Ti=n(e=>Cr(e).replace(/^<|>$/g,"").trim(),"unwrapUrlInput"),vi=n((e,t)=>{try{let r=new URL(e);if(r.protocol!=="https:"&&r.protocol!=="http:")return!1;let o=r.hostname.toLowerCase();return Ci(t).some(a=>Ei(o,a))}catch{return!1}},"isAllowedSourceUrl"),Oi=n((e,t)=>{let r=new URL(e.url),o=Ti(r.searchParams.get("url")||"");if(!o)return{error:"Missing url parameter"};if(o.length>Ri)return{error:"Video URL is too long"};if(!vi(o,t))return{error:"Video frame extraction is limited to supported remote video hosts"};let a=Kt(r.searchParams.get("time"))??Wn(o);if(a==null)return{error:"Missing time parameter"};let s=Math.min(xi,Math.max(0,a)),i=Ht(r.searchParams.get("format")||"png"),c=Gn({sourceUrl:o,timeSeconds:s,format:i});if(!ki.test(c))return{error:"Invalid frame cache key"};let l=`${Ai}/${c}`;return{sourceUrl:o,timeSeconds:s,format:i,fileName:c,publicUrl:l,semanticKey:xr({sourceUrl:o,timeSeconds:s,format:i})}},"readFrameRequest"),Ii=n(async(e,t,r)=>{let o=new URL(t,e.request.url),a=new Request(o.toString(),{method:r});return typeof e.env?.ASSETS?.fetch=="function"?await e.env.ASSETS.fetch(a):await fetch(a)},"fetchStaticAsset"),Mi=n(e=>`Frame has not been generated yet. Run the local video-frame extractor and publish ${e.publicUrl}.`,"missingFrameMessage"),Ni=n((e,t)=>{let r=new Headers;r.set("content-type",t.format==="jpg"?"image/jpeg":"image/png"),r.set("cache-control","public, max-age=31536000, immutable"),r.set("access-control-allow-origin","*");let o=e.headers.get("content-length");o&&r.set("content-length",o);let a=e.headers.get("etag");return a&&r.set("etag",a),r},"imageResponseHeaders");async function zn(e){let t=e.request;if(t.method==="OPTIONS")return new Response(null,{status:204,headers:Tr});if(t.method!=="GET"&&t.method!=="HEAD")return Er("Method not allowed",405,t.method);let r=new URL(t.url).searchParams.get("emit")==="json",o=Oi(t,e.env||{});if("error"in o)return r?kr({ok:!1,error:o.error},400,t.method):Er(o.error,400,t.method);let a=r&&t.method!=="HEAD"?"GET":r||t.method==="HEAD"?"HEAD":"GET",s=await Ii(e,o.publicUrl,a);if(!s.ok){let i=Mi(o);return r?kr({ok:!1,error:i,publicUrl:o.publicUrl,semanticKey:o.semanticKey},404,t.method):Er(i,404,t.method)}if(r){let i=Number(s.headers.get("content-length")||0);return(!Number.isFinite(i)||i<=0)&&t.method!=="HEAD"&&(i=(await s.arrayBuffer()).byteLength),kr({ok:!0,imageUrl:o.publicUrl,publicUrl:o.publicUrl,semanticKey:o.semanticKey,cached:!0,bytes:Number.isFinite(i)?Math.max(0,Math.floor(i)):0,timeSeconds:o.timeSeconds,format:o.format},200,t.method)}return new Response(t.method==="HEAD"?null:s.body,{status:200,headers:Ni(s,o)})}n(zn,"onRequest");var qn={"content-type":"application/json; charset=utf-8","cache-control":"no-store","access-control-allow-origin":"*","access-control-allow-methods":"GET, HEAD, POST, OPTIONS","access-control-allow-headers":"content-type"},jt=n((e,t=200,r="GET")=>new Response(r==="HEAD"?null:JSON.stringify(e),{status:t,headers:qn}),"jsonResponse"),V=n(e=>String(e||"").replace(/\s+/g," ").trim(),"cleanText"),Ui=n(e=>{try{let t=new URL(String(e||"").trim());if(/youtu\.be$/i.test(t.hostname))return V(t.pathname.split("/").filter(Boolean)[0]);if(/youtube\.com$/i.test(t.hostname)||/youtube-nocookie\.com$/i.test(t.hostname)){let r=V(t.searchParams.get("v"));if(r)return r;let o=t.pathname.split("/").filter(Boolean),a=o.findIndex(s=>["embed","shorts","live"].includes(s));if(a>=0)return V(o[a+1])}}catch{}return""},"readVideoId"),Li=n((e,t)=>{let r=e.indexOf(t);if(r<0)return null;let o=e.indexOf("{",r);if(o<0)return null;let a=0,s=!1,i=!1;for(let c=o;c<e.length;c+=1){let l=e[c];if(s){i?i=!1:l==="\\"?i=!0:l==='"'&&(s=!1);continue}if(l==='"')s=!0;else if(l==="{")a+=1;else if(l==="}"&&(a-=1,a===0))return e.slice(o,c+1)}return null},"extractJsonAfter"),$i=n(e=>{for(let t of["ytInitialPlayerResponse =","ytInitialPlayerResponse="]){let r=Li(e,t);if(r)try{return JSON.parse(r)}catch{}}return null},"parsePlayerResponse"),Di=n((e,t)=>{let r=V(t||"en").toLowerCase();return e.find(o=>V(o.languageCode).toLowerCase()===r)||e.find(o=>V(o.languageCode).toLowerCase().startsWith(r.split("-")[0]))||e.find(o=>V(o.kind)!=="asr")||e[0]||null},"pickCaptionTrack"),Ki=n(e=>{let t=new URL(e);return t.searchParams.set("fmt","json3"),t.toString()},"withJsonCaptionFormat"),Hi=n(e=>(Array.isArray(e?.events)?e.events:[]).map(r=>{let o=Array.isArray(r.segs)?V(r.segs.map(i=>i?.utf8||"").join("")):"",a=Number(r.tStartMs)/1e3,s=Number(r.dDurationMs||0)/1e3;return o&&Number.isFinite(a)?{text:o,start:a,duration:Number.isFinite(s)?s:0}:null}).filter(Boolean),"parseCaptionJson3"),ji=n(e=>String(e||"").replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&quot;/g,'"').replace(/&#39;|&apos;/g,"'"),"decodeXmlText"),Bi=n(e=>{let t=[],r=/<text\b([^>]*)>([\s\S]*?)<\/text>/gi,o=null;for(;o=r.exec(String(e||""));){let a=o[1]||"",s=Number(a.match(/\bstart="([^"]+)"/i)?.[1]),i=Number(a.match(/\bdur="([^"]+)"/i)?.[1]||0),c=V(ji(o[2]||""));c&&Number.isFinite(s)&&t.push({text:c,start:s,duration:Number.isFinite(i)?i:0})}return t},"parseCaptionXml"),Fi=n((e,t)=>{let r=String(e||"").trim();if(!r)return[];if(String(t||"").toLowerCase().includes("json")||r.startsWith("{")||r.startsWith("["))try{return Hi(JSON.parse(r))}catch{return[]}return Bi(r)},"parseCaptionResponseText"),Gi=n(e=>{let t=Math.max(0,Math.floor(Number(e)||0)),r=Math.floor(t/60),o=String(t%60).padStart(2,"0");return`${r}:${o}`},"formatTimestamp"),Wi=n((e,t)=>{let r=new URL(e);return r.searchParams.set("t",`${Math.max(0,Math.floor(Number(t)||0))}s`),r.toString()},"timestampUrl"),zi=n(({title:e,sourceUrl:t,videoId:r,authorName:o,thumbnailUrl:a,segments:s})=>[`# ${e||`YouTube ${r}`}`,"",`Video ID: ${r}`,o?`Author: ${o}`:"",`Source: [${t}](${t})`,a?`[![${e||r}](${a})](${t})`:"","",s.length>0?"## Transcript":"## Video Source","",...s.length>0?s.map(i=>`[${Gi(i.start)}](${Wi(t,i.start)}) ${i.text}`):["Captions were not available from the source at import time.","The source URL, title, author, and thumbnail remain available for downstream storyboard reconstruction."],""].filter(i=>i!=="").join(`
`),"buildMarkdown"),vr=n(({videoId:e,sourceUrl:t,title:r,authorName:o,thumbnailUrl:a,lang:s,languageCode:i,segments:c,captionStatus:l})=>{let d={type:"rag:YouTubeTranscript",video_id:e,source_url:t,title:r,author_name:o,thumbnail_url:a,language_code:V(i)||s,caption_status:l,segment_count:c.length,duration:c.reduce((h,f)=>Math.max(h,f.start+f.duration),0),segments:c};return{ok:!0,name:`youtube-${e.toLowerCase()}.md`,markdown:zi({title:r,sourceUrl:t,videoId:e,authorName:o,thumbnailUrl:a,segments:c}),transcript:d}},"buildPayload");async function qi({sourceUrl:e,lang:t="en",fetchImpl:r=fetch}){let o=Ui(e);if(!o)return{ok:!1,error:"unsupported_youtube_url"};let a=`https://www.youtube.com/watch?v=${encodeURIComponent(o)}`,[s,i]=await Promise.all([r(`https://www.youtube.com/oembed?url=${encodeURIComponent(a)}&format=json`,{headers:{accept:"application/json"}}).catch(()=>null),r(a,{headers:{accept:"text/html,application/xhtml+xml","accept-language":"en-US,en;q=0.9","user-agent":"Mozilla/5.0 Knowgrph YouTube transcript importer"}})]),c=s?.ok?await s.json().catch(()=>({})):{},l=i.ok?$i(await i.text()):null,d=V(c.title)||V(l?.videoDetails?.title)||`YouTube ${o}`,h=V(c.author_name)||V(l?.videoDetails?.author),f=V(c.thumbnail_url)||`https://i.ytimg.com/vi/${o}/hqdefault.jpg`;if(!i.ok)return vr({videoId:o,sourceUrl:a,title:d,authorName:h,thumbnailUrl:f,lang:t,languageCode:t,segments:[],captionStatus:`watch-fetch-${i.status}`});let A=l?.captions?.playerCaptionsTracklistRenderer?.captionTracks||[],_=Di(Array.isArray(A)?A:[],t);if(!_?.baseUrl)return vr({videoId:o,sourceUrl:a,title:d,authorName:h,thumbnailUrl:f,lang:t,languageCode:t,segments:[],captionStatus:"captions-unavailable"});let x=await r(Ki(_.baseUrl),{headers:{accept:"application/json,text/xml,text/plain,*/*","user-agent":"Mozilla/5.0 Knowgrph YouTube transcript importer"}}).catch(()=>null),H=x?await x.text().catch(()=>""):"",U=x?.ok?Fi(H,x.headers.get("content-type")):[],D=U.length>0?"available":x?.ok?"captions-empty":`captions-fetch-${x?.status||"failed"}`;return vr({videoId:o,sourceUrl:a,title:d,authorName:h,thumbnailUrl:f,lang:t,languageCode:_.languageCode,segments:U,captionStatus:D})}n(qi,"buildYouTubeTranscriptPayload");async function Vn(e){let t=e.request,r=String(t.method||"GET").toUpperCase();if(r==="OPTIONS")return new Response(null,{status:204,headers:qn});if(r!=="GET"&&r!=="HEAD"&&r!=="POST")return jt({ok:!1,error:"unsupported_method"},405,r);let o=new URL(t.url),a=V(o.searchParams.get("url")),s=V(o.searchParams.get("lang"))||"en";if(!a)return jt({ok:!1,error:"missing_url"},400,r);try{let i=await qi({sourceUrl:a,lang:s});return jt(i,i.ok?200:502,r)}catch(i){let c=i&&typeof i=="object"&&"message"in i?V(i.message):"";return jt({ok:!1,error:c||"youtube_conversion_failed"},502,r)}}n(Vn,"onRequest");async function Yn(e){let{request:t}=e,r=String(t.method||"GET").toUpperCase();if(r==="OPTIONS")return new Response(null,{status:204,headers:{...ae(t),"access-control-allow-methods":"GET, HEAD, OPTIONS","access-control-allow-headers":"*","access-control-max-age":"86400"}});if(r!=="GET"&&r!=="HEAD")return new Response(JSON.stringify({ok:!1,error:"unsupported_method"}),{status:405,headers:{"content-type":"application/json; charset=utf-8","cache-control":"no-store",...ae(t)}});let o={ok:!0,service:"singabldr-pages",ts:new Date().toISOString()},a={"content-type":"application/json; charset=utf-8","cache-control":"no-store",...ae(t)};return r==="HEAD"?new Response(null,{status:200,headers:a}):new Response(JSON.stringify(o),{status:200,headers:a})}n(Yn,"onRequest");var Ie="https://airvio.co";var ce="/knowgrph",ke=`${Ie}${ce}/`,Vi=`${Ie}/`;var Xn=`${ce}/health`,Jn=`${Ie}${Xn}`,Qn="/.well-known/agent-card.json",Mu=`${ce}/.well-known/agent-card.json`,Yi=`${Ie}${Qn}`,Ji=`${Ie}/api/storage/source-files`,Xi=`${Ie}/api/storage/doc-default/{canonicalPath}`,Qi=`${Ie}/api/storage/doc/{workspaceId}/{canonicalPath}`;var Or="root-agent-ready-pages",Zn=['</.well-known/api-catalog>; rel="api-catalog"; type="application/linkset+json"',`<${ce}/.well-known/openapi.json>; rel="service-desc"; type="application/vnd.oai.openapi+json;version=3.1"`,`<${ce}/llms.txt>; rel="service-doc"; type="text/plain"`,'</auth.md>; rel="service-doc"; type="text/markdown"',`<${Xn}>; rel="status"; type="application/health+json"`,`<${ce}/.well-known/mcp/server-card.json>; rel="mcp-server-card"; type="application/json"`,`<${Qn}>; rel="describedby"; type="application/json"`].join(", "),ea=`# Knowgrph
...
- Auth.md registration instructions: ${Vi}auth.md
- Health: ${Jn}
...
- Source Files index: ${Ji}
- Default Source File documents: ${Xi}
- Workspace Source File documents: ${Qi}
...
`,ta=n(e=>new Response(e,{status:200,headers:{"content-type":"text/markdown; charset=utf-8","cache-control":"public, max-age=3600","access-control-allow-origin":"*",vary:"Accept","x-markdown-tokens":String(Math.ceil(String(e||"").length/4))}}),"markdownResponse"),ra=n(e=>(e.headers.get("accept")||"").toLowerCase().split(",").some(r=>r.trim().startsWith("text/markdown")),"wantsMarkdown"),Ir=n((e,t)=>{let r=new Response(e.body,e),o=String(t?.owner||"").trim(),a=String(t?.tag||"").trim();return o&&r.headers.set("x-knowgrph-route-owner",o),a&&r.headers.set("x-knowgrph-route-tag",a),r},"withAgentReadyRouteHeaders");var Nr="Agent-actionable chat-to-canvas knowledge graph workspace",it='<main id="root"></main>',Zi=/<(?:main|div)\s+id=["']root["']\s*><\/(?:main|div)>/i,ec=n(e=>{let t=/<script>([\s\S]*?)<\/script>/g;for(let r of String(e||"").matchAll(t)){let o=r[1]||"";if(o.includes("createWebMcpLifecycleController")&&o.includes("toolDefinitions"))return o}return""},"extractWebMcpScript"),oa=n(()=>({"content-type":"text/html; charset=utf-8","cache-control":"no-store, no-cache, no-transform, must-revalidate, max-age=0","access-control-allow-origin":"*",link:Zn}),"rootHtmlHeaders"),Mr=n((e,t)=>String(e||"").includes("</head>")?String(e||"").replace("</head>",`${t}</head>`):`${String(e||"")}${t}`,"injectIntoHead"),na=n(e=>String(e||"").replace(Zi,it),"canonicalizeRootMount"),Bt=n(()=>`<main id="knowgrph-root-fallback" data-knowgrph-root-fallback="visible" aria-label="Knowgrph root alias" style="position:fixed;inset:0;z-index:2147483000;display:grid;place-content:center;gap:1rem;padding:2rem;box-sizing:border-box;font-family:Inter,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;background:#101820;color:#f4f7fb;text-align:center">
    ...
    <\/script>`,"rootVisibleFallbackMarkup"),tc=n(e=>{let t=na(e);return/<main\s+id=["']knowgrph-root-fallback["']/i.test(t)?t:t.includes(it)?t.replace(it,`${it}
    ${Bt()}`):t.includes("</body>")?t.replace("</body>",`    ${Bt()}
  </body>`):`${t}
${Bt()}`},"injectRootVisibleFallback"),rc=n(e=>{let t=na(e);return/<meta\s+name=["']description["'][^>]*>/i.test(t)?t=t.replace(/<meta\s+name=["']description["'][^>]*>/i,`<meta name="description" content="${Nr}" />`):t=Mr(t,`    <meta name="description" content="${Nr}" />
...
`)),tc(t)},"rewriteRootAppHtml"),oc=n(async e=>{let t=new URL(`${ce}/?agentReadyRootWebMcp=1`,e.url),r=await fetch(t,{headers:{accept:"text/html"}});return r.ok?ec(await r.text()):""},"loadWebMcpScript"),nc=n(async e=>{let t=new URL(`${ce}/?agentReadyRootAlias=1`,e.url),r=await fetch(t,{headers:{accept:"text/html"}});if(!r.ok)return null;let o=rc(await r.text());return!o.includes(it)||!o.includes(`${ce}/assets/`)?null:new Response(o,{status:200,headers:oa()})},"loadKnowgrphAppShell"),ac=n((e="")=>new Response(`<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
