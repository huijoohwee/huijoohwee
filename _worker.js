var Aa=Object.defineProperty;var n=(e,t)=>Aa(e,"name",{value:t,configurable:!0});var ka="https://api.openai.com/v1";var Jt=Object.freeze(["gpt-5.4-nano","gpt-4o-mini"]);function Xt(e){return String(e||"").trim()}n(Xt,"normalizeOrigin");function xa(e){let t=Xt(e);return t?t.startsWith("http://localhost:")||t.startsWith("http://127.0.0.1:")||t.startsWith("http://0.0.0.0:"):!1}n(xa,"isAllowedOrigin");function Gr(e){let t=Xt(e);return xa(t)?{"access-control-allow-origin":t,vary:"Origin","access-control-allow-methods":"GET, POST, OPTIONS","access-control-allow-headers":"content-type, x-flowinfish-session","access-control-max-age":"86400"}:{}}n(Gr,"corsHeaders");function ge(e,{status:t=200,origin:r=""}={}){return new Response(JSON.stringify(e),{status:t,headers:{"content-type":"application/json; charset=utf-8","cache-control":"no-store",...Gr(r)}})}n(ge,"json");async function ft(e,{maxBytes:t=1e6}={}){let r=await e.arrayBuffer();if(r.byteLength>t)throw new Error("Request too large");let o=new TextDecoder().decode(r);try{return o?JSON.parse(o):{}}catch{throw new Error("Invalid JSON body")}}n(ft,"readJsonBody");function Ea(e){let t=String(e?.model||"").trim();if(!t)throw new Error("Missing model");if(!Jt.includes(t))throw new Error(`Model not allowed: ${t}`);return t}n(Ea,"enforceAllowedModel");function Ca(e){let t=String(e.OPENAI_API_KEY||"").trim();if(!t)throw new Error("Missing server OPENAI_API_KEY");return t}n(Ca,"requireOpenAiKey");async function yt({request:e,env:t,pathname:r,payload:o}){let a=Ca(t);Ea(o);let i=`${Xt(t.OPENAI_API_BASE)||ka}${r}`,c=await fetch(i,{method:"POST",headers:{authorization:`Bearer ${a}`,"content-type":"application/json"},body:JSON.stringify(o)}),l=new Headers(c.headers);return l.delete("content-length"),l.set("cache-control","no-store"),new Response(c.body,{status:c.status,headers:l})}n(yt,"proxyToOpenAi");function Ge(e){let t=e.headers.get("origin")||"";return new Response(null,{status:204,headers:{...Gr(t)}})}n(Ge,"handleOptions");async function Wr(e){let{request:t,env:r}=e,o=String(t.method||"GET").toUpperCase(),a=t.headers.get("origin")||"";if(o==="OPTIONS")return Ge(t);if(o!=="POST")return ge({ok:!1,error:"Method not allowed"},{status:405,origin:a});try{if(!String(t.headers.get("content-type")||"").toLowerCase().includes("application/json"))return ge({ok:!1,error:"Expected application/json"},{status:415,origin:a});let i=await ft(t);return await yt({request:t,env:r,pathname:"/chat/completions",payload:i})}catch(s){let i=s instanceof Error?s.message:String(s||"Unknown error");return ge({ok:!1,error:i},{status:400,origin:a})}}n(Wr,"onRequest");var wt={checkoutSession:"/api/payments/stripe/checkout/session",webhook:"/api/payments/stripe/webhook"};var ue={restrictedKey:"STRIPE_RESTRICTED_KEY",secretKey:"STRIPE_SECRET_KEY",webhookSecret:"STRIPE_WEBHOOK_SECRET",checkoutPriceId:"STRIPE_CHECKOUT_PRICE_ID",checkoutCurrency:"STRIPE_CHECKOUT_CURRENCY",checkoutUnitAmount:"STRIPE_CHECKOUT_UNIT_AMOUNT",checkoutProductName:"STRIPE_CHECKOUT_PRODUCT_NAME",checkoutMode:"STRIPE_CHECKOUT_MODE",checkoutReturnOrigin:"STRIPE_CHECKOUT_RETURN_ORIGIN"},Jc=[ue.restrictedKey,ue.secretKey,ue.webhookSecret];var Je={configure:"npm run payment:stripe:configure",d1MigrateRemote:"npm run payment:d1:migrate:remote",readiness:"npm run payment:stripe:readiness",x402Configure:"npm run payment:x402:configure",x402Readiness:"npm run payment:x402:readiness",paymentReadiness:"npm run payment:readiness",applyConfirmation:"apply-stripe-payment-worker-config",writeVisibleVarsFlag:"--write-visible-vars",deployVisibleVarsFlag:"--deploy-visible-vars"};var Xc=[`Configure Stripe secrets on the server runtime that owns ${wt.checkoutSession}.`,"Cloudflare Pages project variables are available to Pages builds/functions, but they are not read by separate Worker routes.","Stripe Projects can provision and sync credentials locally; copy only required server secret names into the payment server runtime."].join(" "),Qc=[`Payment server runtime for ${wt.checkoutSession}`,"not Cloudflare Pages project variables"].join("; "),Ta=[ue.restrictedKey,ue.secretKey].join(" or "),Zc=[ue.checkoutPriceId,`${ue.checkoutCurrency} + ${ue.checkoutUnitAmount} + ${ue.checkoutProductName}`].join(" or "),el=[`${ue.checkoutMode}=payment`,`${ue.checkoutMode}=subscription with ${ue.checkoutPriceId}`].join(" or "),tl=["Worker secret names","visible Worker [vars]","remote D1 payment tables","required webhook-processing columns/constraints","bounded optional hosted Checkout create-and-expire smoke"].join(" + "),rl=[Je.configure,`write visible Worker [vars] with ${Je.writeVisibleVarsFlag}`,`deploy visible Worker [vars] with ${Je.deployVisibleVarsFlag}`,`apply with -- --apply --yes --confirm=${Je.applyConfirmation}`,Je.readiness].join(" -> "),ol=[`Missing server-managed Stripe key. Set ${Ta} on the payment server runtime.`,"Pages project variables alone do not satisfy separate Worker routes."].join(" ");var va=n(e=>{let t=2166136261;for(let r=0;r<e.length;r+=1)t^=e.charCodeAt(r),t=Math.imul(t,16777619);return t>>>0},"fnv1a32");function Fr(e){return va(String(e??""))}n(Fr,"hashString32");function Xe(e){return Fr(e).toString(16).padStart(8,"0")}n(Xe,"hashStringToHex");var Oa=n(e=>e==null?"":typeof e=="boolean"?e?"1":"0":typeof e=="number"?Number.isFinite(e)?String(e):"":String(e),"normalizePrimitive"),Ia=n(e=>e.map(Oa).join("|"),"buildSignatureText"),St=n(e=>Xe(Ia(e)),"hashSignatureParts");var _e=n((e,t)=>St(["agentic-commerce",e,...t]),"buildAgenticCommerceSemanticKey");var zr="solana_pay",qr="/api/payments/commerce/solana-pay/settle";var Qe="2026-01-30",Yr="1000",Jr="USDC",Qt="https://x402.org/facilitator",Xr="eip155:84532",Ma="$0.001",Qr="x402-payment-required",Na="0x0000000000000000000000000000000000000000",We="2026-04-08",Vr="https://ucp.dev/2026-04-08/specification/overview/",Ua=["checkout"],La=["rest"];var v={acpDiscovery:"/.well-known/acp.json",acpConfig:"/.well-known/acp-config",ucpProfile:"/.well-known/ucp",mppOpenApi:"/openapi.json",x402ApiRoot:"/api",x402ApiV1:"/api/v1",checkoutSessions:"/checkout/sessions",x402PaymentRequired:"/api/payments/commerce/x402",commerceWebhook:"/api/payments/commerce/webhook",commerceProofArtifact:"/api/payments/commerce/harness-proof.json",commerceTraceArtifact:"/api/payments/commerce/trace.jsonl",openboxIngest:"/api/payments/commerce/openbox/ingest",web3Settle:"/api/payments/commerce/web3/settle",solanaPaySettle:qr},kl=[v.x402ApiRoot,v.x402ApiV1,v.x402PaymentRequired],Oe={sellerId:"SELLER_ID",checkoutBaseUrl:"CHECKOUT_BASE_URL",web3Enabled:"WEB3_ENABLED",web3DepositAddress:"WEB3_DEPOSIT_ADDRESS",baseRpcUrl:"BASE_RPC_URL",baseConfirmationBlocks:"BASE_CONFIRMATION_BLOCKS",easAttestUrl:"EAS_ATTEST_URL",openboxApiUrl:"OPENBOX_API_URL",openboxIngestUrl:"OPENBOX_INGEST_URL",openboxApiKey:"OPENBOX_API_KEY",stripeDelegatePaymentUrl:"STRIPE_DELEGATE_PAYMENT_URL",acpBearerToken:"ACP_BEARER_TOKEN",x402PayToAddress:"X402_PAY_TO_ADDRESS",x402Network:"X402_NETWORK",x402Asset:"X402_ASSET",x402Amount:"X402_AMOUNT",x402FacilitatorUrl:"X402_FACILITATOR_URL",x402Price:"X402_PRICE"},Ie=n((e,t)=>String(e[t]||"").trim(),"readEnvString"),Zr=n((e,t)=>{let r=Ie(e,Oe.sellerId);if(r)return r;try{return new URL(t).host}catch{return"knowgrph-seller"}},"readAgenticCommerceSellerId");var eo=n(e=>{let t=Ie(e,Oe.web3Enabled).toLowerCase();return t?t==="0"||t==="false"||t==="no"?!1:t==="1"||t==="true"||t==="yes":!0},"isAgenticCommerceWeb3Enabled");var Ze=n(e=>String(e||"").trim().replace(/\/+$/g,""),"normalizeAgenticCommerceBaseUrl"),se=n((e,t)=>`${Ze(e)}${t}`,"buildAgenticCommerceUrl"),ee=n((e,t,r,o,a=o.startsWith("/")?o:null)=>({id:t,label:r,value:o,path:a,semanticKey:_e("mainpanel-commerce-readiness-row",[e,t,r,o,a||""])}),"buildAgenticCommerceMainPanelReadinessRow"),Fe=n((e,t,r)=>({id:e,title:t,rows:r}),"buildAgenticCommerceMainPanelReadinessSection"),Ka=n(()=>{let e=[Fe("overview","Overview",[ee("overview","acp-discovery","ACP discovery",`GET ${v.acpDiscovery}`,v.acpDiscovery),ee("overview","acp-config","ACP config",`GET ${v.acpConfig}`,v.acpConfig),ee("overview","api-version","API version",Qe,null)]),Fe("discovery","Discovery",[ee("discovery","ucp-profile","UCP profile",v.ucpProfile),ee("discovery","mpp-openapi","MPP OpenAPI",v.mppOpenApi),ee("discovery","x402-payment-required","x402 payment required",v.x402PaymentRequired),ee("discovery","x402-api-root","x402 API root",v.x402ApiRoot)]),Fe("sessions","Sessions",[ee("sessions","checkout-sessions","Checkout sessions",v.checkoutSessions),ee("sessions","stripe-webhook","Stripe webhook",wt.webhook)]),Fe("web3","Web3",[ee("web3","settle","Settle",v.web3Settle),ee("web3","solana-pay-settle","Solana Pay settle",v.solanaPaySettle),ee("web3","signals","Signals","Base RPC + Solana RPC confirmation",null)]),Fe("governance","Governance",[ee("governance","openbox-ingest","OpenBOX ingest",v.openboxIngest),ee("governance","risk-source","Risk source","OpenBOX risk signal",null)]),Fe("proofs","Proofs",[ee("proofs","harness-proof","Harness proof",v.commerceProofArtifact),ee("proofs","trace-artifact","Trace artifact",v.commerceTraceArtifact)])],t=e.flatMap(a=>a.rows),r=t.map(a=>a.path||"").filter(a=>a.length>0),o=t.filter(a=>!a.path).map(a=>`${a.label}: ${a.value}`);return{surface:"mainpanel-commerce",semanticKey:_e("mainpanel-commerce-readiness",[Qe,...t.map(a=>a.semanticKey)]),sections:e,routePaths:r,routeCount:r.length,signals:o}},"buildAgenticCommerceMainPanelReadiness"),xl=Ka(),to=n((e,t)=>{let r=Ie(e,Oe.web3DepositAddress);if(/^0x[0-9a-fA-F]{40}$/.test(r))return r;let o=_e("deposit-address",[t,"0"]),a=_e("deposit-address",[t,"1"]),s=_e("deposit-address",[t,"2"]),i=_e("deposit-address",[t,"3"]),c=_e("deposit-address",[t,"4"]);return`0x${o}${a}${s}${i}${c}`.slice(0,42)},"buildAgenticCommerceDepositAddress");var ro=n((e,t=Qr)=>{let r=Ie(e,Oe.x402PayToAddress);return/^0x[0-9a-fA-F]{40}$/.test(r)&&r.toLowerCase()!==Na?r:to(e,t)},"readAgenticCommerceX402PayToAddress"),El=to({},Qr),$a=/^[a-z0-9]{3,8}:[-_a-zA-Z0-9]{1,64}$/,oo=n(e=>{let t=Ie(e,Oe.x402Network);return $a.test(t)?t:Xr},"readAgenticCommerceX402Network"),no=n(e=>Ie(e,Oe.x402Asset)||Jr,"readAgenticCommerceX402Asset"),ao=n(e=>{let t=Ie(e,Oe.x402Amount);return/^[1-9][0-9]*$/.test(t)?t:Yr},"readAgenticCommerceX402Amount");var so=n(e=>{let t=Ie(e,Oe.x402FacilitatorUrl);try{let r=new URL(t||Qt);return r.protocol==="https:"||r.protocol==="http:"?r.toString().replace(/\/+$/g,""):Qt}catch{return Qt}},"readAgenticCommerceX402FacilitatorUrl"),io=n(e=>{let t=Ze(e.baseUrl);return{protocol:{name:"acp",version:Qe,supported_versions:[Qe],documentation_url:"https://agenticcommerce.dev"},api_base_url:t,transports:[...La],capabilities:{services:[...Ua],...e.web3Enabled?{extensions:[{name:"x-web3"}]}:{}},links:{config:se(t,v.acpConfig),ucp:se(t,v.ucpProfile),mpp:se(t,v.mppOpenApi),x402:se(t,v.x402PaymentRequired)}}},"buildAgenticCommerceAcpDiscovery"),co=n(e=>{let t=Ze(e.baseUrl),r={acp:se(t,v.acpDiscovery),api:se(t,v.x402ApiRoot),checkout_sessions:se(t,v.checkoutSessions),mpp_openapi:se(t,v.mppOpenApi),proof:se(t,v.commerceProofArtifact),trace:se(t,v.commerceTraceArtifact),x402_payment_required:se(t,v.x402PaymentRequired),solana_pay_settle:se(t,v.solanaPaySettle)},o={checkout_sessions:!0,content_payments:!0,proof_artifacts:!0,risk_signals:!0,web3_settlement:e.web3Enabled,solana_pay:e.web3Enabled},a={"dev.ucp.shopping":[{version:We,spec:Vr,transport:"rest",endpoint:r.api,schema:"https://ucp.dev/2026-04-08/services/shopping/rest.openapi.json"}]};return{ucp:{version:We,protocol_version:We,services:a,capabilities:{"dev.ucp.shopping.checkout":[{version:We,spec:"https://ucp.dev/2026-04-08/specification/checkout/",schema:"https://ucp.dev/2026-04-08/schemas/shopping/checkout.json"}]},payment_handlers:{},endpoints:r},protocol_version:We,protocol:{name:"ucp",version:We},seller:{id:e.sellerId},services:[{id:"knowgrph-content-payments",type:"content-payments",endpoints:{x402:r.x402_payment_required,checkout_sessions:r.checkout_sessions,solana_pay_settle:r.solana_pay_settle,proof:r.proof,trace:r.trace}}],capabilities:o,endpoints:r,spec_urls:[Vr],schema_urls:["https://ucp.dev/2026-04-08/services/shopping/rest.openapi.json","https://ucp.dev/2026-04-08/schemas/shopping/checkout.json"]}},"buildAgenticCommerceUcpProfile"),lo=n(e=>{let t=Ze(e.baseUrl);return{openapi:"3.1.0",info:{title:"Knowgrph Machine Payment Protocol",version:Qe,description:"Machine-readable payable-operation discovery for Knowgrph commerce routes."},servers:[{url:t}],paths:{[v.x402PaymentRequired]:{get:{operationId:"getKnowgrphX402PaymentRequirement",summary:"Return x402 payment requirements for an agent-readable paid resource.","x-payment-info":{intent:"charge",method:"x402",amount:Ma,currency:"usdc"},responses:{402:{description:"Payment Required"}}}},[v.checkoutSessions]:{post:{operationId:"createKnowgrphCommerceCheckoutSession",summary:"Create an agentic commerce checkout session.","x-payment-info":{intent:"session",method:"stripe",amount:"dynamic",currency:"request.currency"},responses:{201:{description:"Checkout session created"}}}},[v.solanaPaySettle]:{post:{operationId:"settleKnowgrphSolanaPayCheckoutSession",summary:"Settle an agentic commerce checkout session from a verified Solana Pay transaction signature.","x-payment-info":{intent:"settlement",method:zr,amount:"dynamic",currency:"request.currency"},responses:{200:{description:"Solana Pay session settled"},409:{description:"Solana Pay transaction is not confirmed yet"},422:{description:"Solana Pay transaction does not match the session"}}}}}}},"buildAgenticCommerceMppOpenApi"),po=n(e=>{let t=Ze(e.baseUrl),r=se(t,v.x402PaymentRequired),o=String(e.amount||Yr);return{x402Version:2,error:"Payment required",resource:{url:r,description:"Knowgrph agentic commerce paid-resource readiness probe",mimeType:"application/json"},accepts:[{scheme:"exact",network:String(e.network||Xr),amount:o,maxAmountRequired:o,asset:String(e.asset||Jr),resource:r,mimeType:"application/json",payTo:e.payTo,maxTimeoutSeconds:300,extra:{name:"USDC",version:"2",resourceUrl:r,...e.facilitatorUrl?{facilitatorUrl:e.facilitatorUrl}:{}}}]}},"buildAgenticCommerceX402PaymentRequired");var Da=n(e=>JSON.stringify(e,null,2),"jsonBody"),Ha=n(e=>String(e||"").trim().replace(/\/+$/g,""),"trimOrigin"),ja=n(e=>typeof btoa=="function"?btoa(e):typeof Buffer<"u"?Buffer.from(e).toString("base64"):"","encodeBase64"),Ba=n((e,t)=>{try{return new URL(e).origin}catch{return Ha(t)}},"rootOriginFromRequest"),Zt=n((e={})=>{let t=Ba(e.requestUrl,e.origin),r=e.env||{},o=Zr(r,`${t}/`),a=eo(r),s=po({baseUrl:t,payTo:ro(r),network:oo(r),asset:no(r),amount:ao(r),facilitatorUrl:so(r)});return{acpDiscovery:io({sellerId:o,baseUrl:t,web3Enabled:a}),ucpProfile:co({sellerId:o,baseUrl:t,web3Enabled:a}),mppOpenApi:lo({baseUrl:t}),x402PaymentRequired:s}},"buildKnowgrphCommerceDiscovery");var uo=n((e,t={})=>{let r=Zt({requestUrl:e?.url,env:t}).x402PaymentRequired,o=ja(JSON.stringify(r));return new Response(Da(r),{status:402,headers:{"content-type":"application/json; charset=utf-8","cache-control":"no-store","access-control-allow-origin":"*",...o?{"payment-required":o}:{}}})},"buildKnowgrphX402PaymentRequiredResponse");async function mo(e){return uo(e.request,e.env||{})}n(mo,"onRequest");async function ho(e){let{request:t}=e,r=String(t.method||"GET").toUpperCase(),o=t.headers.get("origin")||"";return r==="OPTIONS"?Ge(t):r!=="GET"&&r!=="HEAD"?ge({ok:!1,error:"Method not allowed"},{status:405,origin:o}):ge({ok:!0,models:Jt.map(a=>({model:a,display_name:a}))},{status:200,origin:o})}n(ho,"onRequest");async function go(e){let{request:t,env:r}=e,o=String(t.method||"GET").toUpperCase(),a=t.headers.get("origin")||"";if(o==="OPTIONS")return Ge(t);if(o!=="POST")return ge({ok:!1,error:"Method not allowed"},{status:405,origin:a});try{if(!String(t.headers.get("content-type")||"").toLowerCase().includes("application/json"))return ge({ok:!1,error:"Expected application/json"},{status:415,origin:a});let i=await ft(t);return await yt({request:t,env:r,pathname:"/responses",payload:i})}catch(s){let i=s instanceof Error?s.message:String(s||"Unknown error");return ge({ok:!1,error:i},{status:400,origin:a})}}n(go,"onRequest");var ze=Object.freeze({researchSourceFiles:"knowgrph_research_source_files",inspectAgentSurface:"knowgrph_inspect_agent_surface"}),er=n(e=>String(e||"").trim(),"normalizeString"),Ga=n(e=>({...e,arguments:Array.isArray(e.arguments)?e.arguments.map(t=>({...t})):void 0,_meta:e._meta&&typeof e._meta=="object"?{...e._meta,tools:Array.isArray(e._meta.tools)?[...e._meta.tools]:void 0}:void 0}),"clonePrompt"),yo=Object.freeze([Object.freeze({name:ze.researchSourceFiles,title:"Research Knowgrph Source Files",description:"Guide an MCP host through read-only Knowgrph Source Files research using search and fetch with citation-ready URLs.",arguments:Object.freeze([Object.freeze({name:"query",description:"Research question or topic to pass to the read-only search tool.",required:!0}),Object.freeze({name:"limit",description:"Optional decimal string for the maximum search results to inspect.",required:!1}),Object.freeze({name:"focus",description:"Optional aspect to prioritize when reading fetched Source Files.",required:!1})]),_meta:Object.freeze({readOnly:!0,tools:Object.freeze(["search","fetch"])})}),Object.freeze({name:ze.inspectAgentSurface,title:"Inspect Knowgrph Agent Surface",description:"Guide an MCP host through read-only inspection of Knowgrph agent, MCP, and MCP Apps readiness metadata.",arguments:Object.freeze([Object.freeze({name:"focus",description:"Optional readiness area to emphasize, such as transport, tools, resources, prompts, retrieval, or app metadata.",required:!1})]),_meta:Object.freeze({readOnly:!0,tools:Object.freeze(["inspect_agent_surface"])})})]),wo=n(()=>yo.map(Ga),"buildKnowgrphAgentReadyPromptContracts"),Wa=n(e=>yo.find(t=>t.name===er(e))||null,"findPromptContract"),_t=n((e,t)=>!e||typeof e!="object"?"":er(e[t]),"readPromptArg"),Fa=n((e,t)=>{let r=_t(e,t);if(!r)throw new Error(`Missing required prompt argument: ${t}`);return r},"readRequiredPromptArg"),fo=n(e=>({role:"user",content:{type:"text",text:e}}),"buildPromptMessage"),za=n((e={})=>{let t=Fa(e,"query"),r=_t(e,"limit"),o=_t(e,"focus");return[`Research Knowgrph Source Files for: ${t}`,"","Use the MCP server read-only retrieval path:",`1. Call search with query=${JSON.stringify(t)}${r?` and limit=${JSON.stringify(r)}`:""}.`,"2. Select the most relevant returned ids and call fetch for each id before answering.","3. Ground the answer in fetched markdown content and cite the returned result URLs when summarizing.",o?`4. Prioritize this focus: ${o}.`:"","","Do not mutate graph, canvas, workspace, storage, or browser-local state for this research prompt."].filter(Boolean).join(`
`)},"buildSourceFilesResearchPromptText"),qa=n((e={})=>{let t=_t(e,"focus");return["Inspect the Knowgrph agent-ready surface through the read-only inspect_agent_surface tool.","","Review health, API catalog, MCP server card, A2A card, agent skills, commerce discovery, and mcpAppsServerReadiness.","For MCP Apps readiness, verify tool/resource linkage, output schema, text fallback, structured content, sandbox/security metadata, no-auth security-scheme mirroring, widget accessibility, prompts, search/fetch retrieval, Streamable HTTP, and local stdio support.",t?`Emphasize this readiness area: ${t}.`:"","","Report checklist ids and evidence from structuredContent. Do not infer readiness from prose alone."].filter(Boolean).join(`
`)},"buildAgentSurfaceInspectionPromptText"),So=n((e,t={})=>{let r=Wa(e);if(!r)throw new Error(`Unknown Knowgrph MCP prompt: ${er(e)}`);if(r.name===ze.researchSourceFiles)return{description:r.description,messages:[fo(za(t))]};if(r.name===ze.inspectAgentSurface)return{description:r.description,messages:[fo(qa(t))]};throw new Error(`Unhandled Knowgrph MCP prompt: ${r.name}`)},"getKnowgrphAgentReadyPrompt");var Va=Object.freeze({sourceFileById:"knowgrph_source_file_by_id"}),bt="kgdoc://source-file/{id}",_o="kgdoc://source-file/",bo="text/markdown",et=n(e=>String(e||"").trim(),"normalizeString"),Ro=n(()=>[{uriTemplate:bt,name:Va.sourceFileById,title:"Knowgrph Source File By ID",description:"Read a complete published Knowgrph Source File markdown document using a stable kgdoc id returned by search.",mimeType:bo,annotations:{audience:["user","assistant"],priority:.8},_meta:{readOnly:!0,source:"knowgrph-source-files",tool:"fetch"}}],"buildKnowgrphAgentReadyResourceTemplateContracts");var Po=n(e=>{let t=et(e);if(!t.startsWith(_o))return"";let r=t.slice(_o.length);if(!r)return"";try{return decodeURIComponent(r)}catch{return r}},"parseKnowgrphSourceFileResourceUri"),Ao=n(({uri:e,sourceFile:t}={})=>{let r=typeof t?.content=="string"?t.content:String(t?.text||"");return{contents:[{uri:et(e),mimeType:bo,text:r,_meta:{id:et(t?.id),title:et(t?.title),url:et(t?.url),metadata:t?.metadata&&typeof t.metadata=="object"?{...t.metadata}:{}}}]}},"buildKnowgrphSourceFileResourceReadResult");var Pt="io.modelcontextprotocol/ui",Le="text/html;profile=mcp-app",To="2026-01-26",Ya="knowgrph-mcp-apps-server-readiness/v0.1",ie="ui://knowgrph/agent-ready",or="knowgrph-agent-ready",Ke="inspect_agent_surface",fe=Object.freeze(["search","fetch"]),tr=Object.freeze({search:Object.freeze(["ids"]),fetch:Object.freeze(["id","title","content","text"])}),ko=Object.freeze(Object.values(ze)),ke="streamable-http",Ja=Object.freeze([Object.freeze({type:"noauth"})]),ne=Object.freeze({openAiApps:"openai-apps",claude:"claude-mcp-connector",qwenCode:"qwen-code",kimiCli:"kimi-cli",bytePlusModelArk:"byteplus-modelark",generic:"generic-mcp"}),H=n(e=>String(e||"").trim(),"normalizeString"),Rt=n(e=>H(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),"escapeHtml"),Xa=n(e=>JSON.stringify(e).replace(/</g,"\\u003c"),"safeJsonForInlineScript"),Qa=n(e=>{let t=H(e);if(!t)return"";try{return new URL(t).origin}catch{return""}},"readUrlOrigin"),nr=n(()=>({extensions:{[Pt]:{mimeTypes:[Le]}}}),"buildKnowgrphMcpAppsCapabilities"),te=n(e=>Array.isArray(e)?e:[],"arrayFrom"),ar=n(()=>Ja.map(e=>({...e})),"buildKnowgrphMcpNoauthSecuritySchemes"),vo=n(e=>(Array.isArray(e)&&e.length?e:ar()).filter(r=>r&&typeof r=="object").map(r=>({...r})),"normalizeSecuritySchemes"),xo=n(e=>te(e).some(t=>t?.type==="noauth"),"hasNoauthSecurityScheme"),Eo=n(e=>Array.isArray(e)?vo(e):[],"readSecuritySchemes"),Za=n(e=>{let t=H(e);return t.includes("window.openai")&&t.includes("openai:set_globals")&&t.includes("toolInput")&&t.includes("toolOutput")&&t.includes("callTool")&&t.includes("request('ui/initialize'")},"hasOpenAiWidgetBridgeHtml"),Co=n((e,t=[])=>e?.outputSchema?.type==="object"&&t.every(r=>te(e.outputSchema?.required).includes(r)),"hasToolOutputSchemaFields"),rr=n(e=>e?.annotations?.readOnlyHint===!0&&e?.annotations?.destructiveHint===!1&&e?.annotations?.openWorldHint===!1&&e?.annotations?.idempotentHint===!0,"hasReadOnlyToolAnnotations"),z=n((e,t,r,o=[])=>({id:e,label:t,ok:r===!0,evidence:te(o).map(H).filter(Boolean)}),"booleanCheck"),sr=n((e={})=>{let t=H(e.baseUrl).replace(/\/+$/,""),r=H(e.serverName)||"knowgrph",o=H(e.mcpUrl)||(t?`${t}/mcp`:"");return{[ne.openAiApps]:{id:ne.openAiApps,label:"OpenAI Apps / ChatGPT",transport:ke,url:o,appResourceUri:ie,appToolName:Ke,requiredMetadata:["openai/outputTemplate","openai/widgetAccessible","openai/widgetCSP","openai/widgetDomain"],requiredTools:[Ke,...fe]},[ne.claude]:{id:ne.claude,label:"Claude MCP connector",transport:ke,url:o,beta:"mcp-client-2025-11-20",mcp_servers:[{type:"url",url:o,name:r}],tools:[{type:"mcp_toolset",mcp_server_name:r}],requiredTools:fe},[ne.qwenCode]:{id:ne.qwenCode,label:"Qwen Code",transport:"http",url:o,command:`qwen mcp add --transport http ${r} ${o}`,settingsJson:{mcpServers:{[r]:{httpUrl:o,timeout:3e4,trust:!1,includeTools:["search","fetch",Ke]}}},requiredTools:fe,primaryFlow:"Call search with a natural-language query, then call fetch with the returned kgdoc id."},[ne.kimiCli]:{id:ne.kimiCli,label:"Kimi CLI",transport:"http",url:o,command:`kimi mcp add --transport http ${r} ${o}`,configFile:"~/.kimi/mcp.json",mcpJson:{mcpServers:{[r]:{url:o,transport:"http"}}},requiredTools:fe,primaryFlow:"Call search with a natural-language query, then call fetch with the returned kgdoc id."},[ne.bytePlusModelArk]:{id:ne.bytePlusModelArk,label:"BytePlus ModelArk Responses API",transport:ke,url:o,apiBaseUrl:"https://ark.ap-southeast.bytepluses.com/api/v3",endpoint:"/responses",requiredHeaders:{"ark-beta-mcp":"true"},tools:[{type:"mcp",server_label:r,server_url:o,require_approval:"never"}],openAiCompatible:{base_url:"https://ark.ap-southeast.bytepluses.com/api/v3",default_headers:{"ark-beta-mcp":"true"},responsesCreate:{model:"<MODELARK_MODEL_OR_ENDPOINT_ID>",tools:[{type:"mcp",server_label:r,server_url:o,require_approval:"never"}]}},invocationScope:"ModelArk Responses API with MCP service and model permissions enabled.",requiredTools:fe,primaryFlow:"Use ModelArk Responses API with the Knowgrph MCP tool entry, then ask the model to call search and fetch."},[ne.generic]:{id:ne.generic,label:"Generic MCP clients",transport:ke,url:o,initialize:{method:"initialize",accept:["application/json","text/event-stream"]},requiredMethods:["initialize","notifications/initialized","tools/list","tools/call"],optionalMethods:["prompts/list","prompts/get","resources/list","resources/templates/list","resources/read"],requiredTools:fe}}},"buildKnowgrphMcpClientSetups"),Oo=n((e={})=>{let t=H(e.baseUrl).replace(/\/+$/,""),r=H(e.updatedAt),o=e.mcpServerCard&&typeof e.mcpServerCard=="object"?e.mcpServerCard:{},a=o.capabilities&&typeof o.capabilities=="object"?o.capabilities:{},s=te(e.tools).length?te(e.tools):te(a.tools),i=te(e.resources).length?te(e.resources):[At({appUrl:t,updatedAt:r})],c=te(e.prompts).length?te(e.prompts):te(o.prompts),l=te(e.resourceTemplates).length?te(e.resourceTemplates):te(o.resourceTemplates),p=s.filter(w=>w?._meta?.ui?.resourceUri===ie),m=p.find(w=>w?.name===Ke)||p[0]||null,f=i.find(w=>w?.uri===ie)||null,P=a.extensions?.[Pt],_=H(o.transport?.url)||(t?`${t}/mcp`:""),x=H(o.transport?.type)||ke,j=H(e.appResourceHtml)||No({appUrl:t,updatedAt:r,toolName:m?.name||Ke}),L=e.clientSetups&&typeof e.clientSetups=="object"?e.clientSetups:sr({baseUrl:t,mcpUrl:_,serverName:o.serverInfo?.name}),D=m?.outputSchema&&typeof m.outputSchema=="object",re=!!m?.name,W=D,T=m?._meta?.["openai/outputTemplate"]===ie,O=Za(j),J=xo(m?.securitySchemes)&&xo(m?._meta?.securitySchemes),K=rr(m),X=m?._meta?.["openai/widgetAccessible"]===!0,I=c.map(w=>H(w?.name)).filter(Boolean),M=o.capabilities?.prompts&&typeof o.capabilities.prompts=="object",B=ko.every(w=>I.includes(w)),oe=l.map(w=>H(w?.uriTemplate)).filter(Boolean),pe=oe.includes(bt),Se=Object.fromEntries(fe.map(w=>[w,s.find(E=>E?.name===w)||null])),A=fe.every(w=>{let E=Se[w];return rr(E)&&Co(E,tr[w])}),y=L[ne.qwenCode],S=y?.transport==="http"&&y?.url===_&&y?.settingsJson?.mcpServers?.[o.serverInfo?.name||"knowgrph"]?.httpUrl===_&&String(y?.command||"").includes("--transport http")&&String(y?.command||"").includes(_),d=L[ne.kimiCli],h=d?.transport==="http"&&d?.url===_&&d?.mcpJson?.mcpServers?.[o.serverInfo?.name||"knowgrph"]?.url===_&&d?.mcpJson?.mcpServers?.[o.serverInfo?.name||"knowgrph"]?.transport==="http"&&String(d?.command||"").includes("kimi mcp add --transport http")&&String(d?.command||"").includes(_),g=L[ne.bytePlusModelArk],b=g?.transport===ke&&g?.url===_&&g?.endpoint==="/responses"&&g?.requiredHeaders?.["ark-beta-mcp"]==="true"&&te(g?.tools).some(w=>w?.type==="mcp"&&w?.server_label===(o.serverInfo?.name||"knowgrph")&&w?.server_url===_&&w?.require_approval==="never")&&g?.openAiCompatible?.responsesCreate?.tools?.some(w=>w?.type==="mcp"&&w?.server_label===(o.serverInfo?.name||"knowgrph")&&w?.server_url===_&&w?.require_approval==="never"),N=[z("app-tool-resource-link","App tool is linked to the UI resource",p.length>0,p.map(w=>w.name)),z("output-schema","App tool exposes an output schema",D,[m?.name]),z("text-fallback","Tool result keeps a text fallback for non-UI hosts",re,[m?.name]),z("structured-content","Tool result returns structured content for the View",W,[m?.name]),z("resource-descriptor","MCP resource descriptor uses the MCP Apps MIME type",f?.mimeType===Le,[f?.uri]),z("resource-security-meta","Resource declares UI sandbox metadata",f?._meta?.ui?.prefersBorder===!0&&!!f?._meta?.ui?.csp,[f?.uri]),z("openai-output-template","App tool exposes the OpenAI output template metadata key",T,[m?.name]),z("openai-widget-bridge","App resource supports the OpenAI Apps widget bridge",O,["window.openai","openai:set_globals"]),z("tool-security-schemes","App tool exposes no-auth securitySchemes and mirrors them in _meta",J,[m?.name]),z("tool-impact-annotations","App tool exposes complete read-only impact annotations",K,[m?.name]),z("widget-accessible","App tool allows the widget bridge to call tools",X,[m?.name]),z("prompt-discovery","Server exposes MCP prompt templates for multi-host guidance",M&&B,I),z("source-file-resource-template","Server exposes a dynamic Source Files resource template",pe,oe),z("deep-research-search-fetch","Server exposes read-only search and fetch tools",A,fe),z("qwen-code-http-client-setup","Server advertises Qwen Code HTTP MCP setup",S,[y?.command]),z("kimi-cli-http-client-setup","Server advertises Kimi CLI HTTP MCP setup",h,[d?.command]),z("byteplus-modelark-responses-mcp-setup","Server advertises BytePlus ModelArk Responses API MCP setup",b,[g?.apiBaseUrl,g?.endpoint]),z("extension-capability","Server advertises the MCP Apps extension capability",P?.mimeTypes?.includes(Le),[Pt]),z("streamable-http-transport","Server exposes a stateless Streamable HTTP JSON-RPC transport",!!_&&x===ke,[_,x]),z("stdio-transport","Repo-local MCP server supports stdio host configuration",e.localStdio!==!1,["node mcp/server.js"])],F=N.every(w=>w.ok);return{schemaVersion:Ya,ready:F,updatedAt:r,app:{name:or,protocolVersion:To,resourceUri:ie,resourceMimeType:Le,extensionId:Pt},tool:{name:m?.name||Ke,title:m?.title||"Inspect Agent Surface",resourceUri:m?._meta?.ui?.resourceUri||ie,visibility:te(m?._meta?.ui?.visibility).length?m._meta.ui.visibility:["model","app"],readOnly:m?.annotations?.readOnlyHint===!0,destructive:m?.annotations?.destructiveHint===!0,openWorld:m?.annotations?.openWorldHint===!0,idempotent:m?.annotations?.idempotentHint===!0,annotationsReady:K,hasOutputSchema:!!D,textFallback:re,structuredContent:W,openAiOutputTemplate:T,openAiWidgetBridge:O,securitySchemes:Eo(m?.securitySchemes),mirroredSecuritySchemes:Eo(m?._meta?.securitySchemes),widgetAccessible:X},resource:{uri:f?.uri||ie,name:f?.name||or,mimeType:f?.mimeType||Le,prefersBorder:f?._meta?.ui?.prefersBorder===!0,domain:H(f?._meta?.ui?.domain),csp:f?._meta?.ui?.csp||{},openAiWidgetBridge:O},retrieval:{mode:"deep-research-search-fetch",requiredTools:fe,tools:fe.map(w=>{let E=Se[w];return{name:w,readOnly:E?.annotations?.readOnlyHint===!0,destructive:E?.annotations?.destructiveHint===!0,openWorld:E?.annotations?.openWorldHint===!0,idempotent:E?.annotations?.idempotentHint===!0,annotationsReady:rr(E),requiredOutputFields:tr[w],outputSchemaReady:Co(E,tr[w])}})},prompts:{requiredPrompts:ko,names:I,capability:!!M,ready:M&&B},resourceTemplates:{requiredTemplates:[bt],uriTemplates:oe,ready:pe},clients:L,transports:[{id:"pages-http-jsonrpc",type:x,url:_,stateless:!0,serverFactory:!0},{id:"local-stdio-jsonrpc",type:"stdio",command:"node mcp/server.js",stateless:!1,serverFactory:!0}],dataModel:{source:"inspect_agent_surface.structuredContent",categories:[{id:"discovery",label:"Discovery metadata",count:["health","apiCatalog","openApi","mcpServerCard","agentCard","agentSkills"].length},{id:"commerce",label:"Commerce discovery",count:["acpDiscovery","ucpProfile","mppOpenApi"].length},{id:"mcp-apps",label:"MCP Apps server bindings",count:N.length}],renderMode:"structured-summary-with-json-fallback"},checklist:N}},"buildKnowgrphMcpAppsServerReadiness"),Io=n((e={})=>{let t=H(e.resourceUri)||ie;return{securitySchemes:vo(e.securitySchemes),ui:{resourceUri:t,visibility:Array.isArray(e.visibility)&&e.visibility.length?e.visibility:["model","app"]},"openai/outputTemplate":t,"openai/widgetAccessible":e.widgetAccessible!==!1,"openai/toolInvocation/invoking":H(e.invoking)||"Inspecting Knowgrph.","openai/toolInvocation/invoked":H(e.invoked)||"Knowgrph is ready."}},"buildKnowgrphMcpAppsToolMeta"),Mo=Object.freeze({type:"object",additionalProperties:!0,required:["baseUrl","healthUrl","mcpUrl"],properties:{baseUrl:{type:"string"},healthUrl:{type:"string"},mcpUrl:{type:"string"},apiCatalogUrl:{type:"string"},openApiUrl:{type:"string"},mcpServerCardUrl:{type:"string"},agentCardUrl:{type:"string"},agentSkillsUrl:{type:"string"},commerceUrls:{type:"object",additionalProperties:{type:"string"}},health:{type:"object",additionalProperties:!0},apiCatalog:{type:"object",additionalProperties:!0},openApi:{type:"object",additionalProperties:!0},mcpServerCard:{type:"object",additionalProperties:!0},agentCard:{type:"object",additionalProperties:!0},agentSkills:{type:"object",additionalProperties:!0},commerce:{type:"object",additionalProperties:!0},mcpAppsServerReadiness:{type:"object",additionalProperties:!0}}}),At=n((e={})=>{let t=H(e.appUrl),r=H(e.updatedAt),o=H(e.domain)||Qa(t),a={connectDomains:[],resourceDomains:[],frameDomains:[],baseUriDomains:[]};return{uri:ie,name:or,description:["Interactive MCP Apps view for the existing Knowgrph agent-ready surface.",t?`App URL: ${t}`:"",r?`Updated: ${r}`:""].filter(Boolean).join(" "),mimeType:Le,_meta:{ui:{csp:a,...o?{domain:o}:{},prefersBorder:!0},"openai/widgetDescription":"Interactive Knowgrph agent-ready server-readiness view.","openai/widgetPrefersBorder":!0,...o?{"openai/widgetDomain":o}:{},"openai/widgetCSP":{connect_domains:a.connectDomains,resource_domains:a.resourceDomains,frame_domains:a.frameDomains}}}},"buildKnowgrphMcpAppsResourceDescriptor"),No=n((e={})=>{let t=H(e.appUrl),r=H(e.updatedAt),o=H(e.toolName)||Ke,a=Array.isArray(e.toolNames)?e.toolNames.map(H).filter(Boolean):[o],s={appUrl:t,updatedAt:r,resourceUri:ie,toolName:o,toolNames:a,protocolVersion:To};return`<!doctype html>
<html lang="en">
<head>
  <meta charset="utf-8">
...
}`;var Ct={push:"/api/storage/push",pull:"/api/storage/pull",collabSave:"/api/storage/collab/save",chatSession:"/api/storage/chat/session",chatRelay:"/api/storage/chat/relay",chatPoliciesPrefix:"/api/storage/chat/policies/",chatAuditPrefix:"/api/storage/chat/audit/",exportPrefix:"/api/storage/export/",docPrefix:"/api/storage/doc/",defaultDocPrefix:"/api/storage/doc-default/",blobPrefix:"/api/storage/blob/",mediaAssetPersist:"/api/storage/media/assets",mediaAssetPrefix:"/api/storage/media/assets/",mediaPrefix:"/api/storage/media/",sourceFilesIndex:"/api/storage/source-files",sourceFilesIndexPrefix:"/api/storage/source-files/",sourceFilesLlms:"/api/storage/llms.txt"};var on=n((e,t)=>`${Ct.docPrefix}${encodeURIComponent(String(e||"").trim())}/${encodeURIComponent(String(t||"").trim())}`,"buildKnowgrphStorageDocPath"),nn=n(e=>`${Ct.defaultDocPrefix}${encodeURIComponent(String(e||"").trim())}`,"buildKnowgrphStorageDefaultDocPath");var an=n(e=>{let t=String(e||"").trim();return t?`${Ct.sourceFilesIndexPrefix}${encodeURIComponent(t)}`:Ct.sourceFilesIndex},"buildKnowgrphStorageSourceFilesIndexPath");var G="https://airvio.co",Tt="https://knowgrph-storage.huijoohwee.workers.dev",C="/knowgrph",k=`${G}${C}/`,sn=`${G}/`,rt="kgws:canonical-docs",xe="2026-06-05",Ve=`${C}/health`,qe=`${G}${Ve}`,cn="/.well-known/agent-card.json",yr=`${C}/.well-known/agent-card.json`,vt=`${G}${cn}`,wr=`${G}/api/storage/source-files`,_s=`${G}/api/storage/doc-default/{canonicalPath}`,bs=`${G}/api/storage/doc/{workspaceId}/{canonicalPath}`,Rs=`${G}/api/storage/blob/{workspaceId}/{canonicalPath}`,ln="knowgrph-agent-ready-pages";var pn=['</.well-known/api-catalog>; rel="api-catalog"; type="application/linkset+json"',`<${C}/.well-known/openapi.json>; rel="service-desc"; type="application/vnd.oai.openapi+json;version=3.1"`,`<${C}/llms.txt>; rel="service-doc"; type="text/plain"`,'</auth.md>; rel="service-doc"; type="text/markdown"',`<${Ve}>; rel="status"; type="application/health+json"`,`<${C}/.well-known/mcp/server-card.json>; rel="mcp-server-card"; type="application/json"`,`<${cn}>; rel="describedby"; type="application/json"`].join(", "),un=`# Knowgrph
...
- Auth.md registration instructions: ${sn}auth.md
- Health: ${qe}
...
`,"buildSitemapXml"),Ls=Ns(`${k}sitemap.xml`),Ks=Us(k),En={linkset:[{anchor:k,"service-desc":[{href:`${k}.well-known/openapi.json`,type:"application/vnd.oai.openapi+json;version=3.1"}],"service-doc":[{href:`${k}llms.txt`,type:"text/plain"}],status:[{href:qe,type:"application/health+json"}],"service-meta":[{href:`${k}.well-known/mcp/server-card.json`,type:"application/json"},{href:vt,type:"application/json"}]}]},Cn={openapi:"3.1.0",info:{title:"Knowgrph API",version:"0.1.0",description:"Agent discovery surface for the Knowgrph Cloudflare deployment."},servers:[{url:G,description:"Knowgrph Cloudflare deployment"}],paths:Vo({appBasePath:C,appA2aAgentCardPath:yr,healthPath:Ve})},at={resource:k,resource_name:"Knowgrph",authorization_servers:[G],scopes_supported:["knowgrph:read","knowgrph:source-files:read"],bearer_methods_supported:["header"],resource_documentation:`${k}llms.txt`},_r=`${G}/cdn-cgi/access`,Ce={skill:`${G}/auth.md`,register_uri:`${k}agent/auth`,claim_uri:`${k}agent/auth/claim`,revocation_uri:`${k}agent/auth/revoke`,identity_types_supported:["anonymous","identity_assertion"],anonymous:{credential_types_supported:["api_key"]},identity_assertion:{assertion_types_supported:["urn:ietf:params:oauth:token-type:id-jag","verified_email"],credential_types_supported:["access_token","api_key"]},events_supported:["https://schemas.workos.com/events/agent/auth/identity/assertion/revoked"],registration_status:"metadata_published_runtime_user_mediated"},yn={issuer:G,resource:at.resource,resource_name:at.resource_name,authorization_servers:at.authorization_servers,cloudflare_access_issuer:_r,authorization_endpoint:`${_r}/login`,token_endpoint:`${_r}/token`,jwks_uri:`${k}.well-known/http-message-signatures-directory`,response_types_supported:["code"],grant_types_supported:["authorization_code","client_credentials"],token_endpoint_auth_methods_supported:["client_secret_basic","private_key_jwt"],scopes_supported:at.scopes_supported,agent_auth:Ce},$s=`# Knowgrph auth.md
...
- Pipeline rule: agents must not bypass MainPanel -> FloatingPanel Chat -> KGC -> Canvas for user-mediated graph work; published HTTP MCP tools remain read-only until mutation auth and conflict semantics are implemented.`,Tn={name:"Knowgrph Agent",description:"Agent-readable discovery, published-document retrieval, and WebMCP-ready metadata surface for Knowgrph.",version:"0.1.0",provider:{organization:"airvio / joohwee",url:k},url:`${k}mcp`,preferredTransport:"JSONRPC",supportedInterfaces:[{url:`${k}mcp`,protocolBinding:"JSONRPC",transportProtocol:"JSONRPC",description:"Primary machine interface for read-only discovery and source-file document access."},{url:wr,protocolBinding:"HTTP+JSON/REST",transportProtocol:"HTTP+JSON/REST",description:"Published source-files index and storage-backed document read surface."}],capabilities:{streaming:!1,pushNotifications:!1,stateTransitionHistory:!1,extendedAgentCard:!1},defaultInputModes:["text/plain","text/markdown","application/json"],defaultOutputModes:["text/plain","text/markdown","application/json"],skills:zo(It)},Re={serverInfo:{name:"knowgrph",version:"0.1.0"},transport:{type:ke,url:`${k}mcp`,stateless:!0},capabilities:{tools:It.map(e=>({name:e.name,title:e.title,description:e.description,inputSchema:e.inputSchema,outputSchema:e.outputSchema,securitySchemes:e.securitySchemes,annotations:e.annotations,_meta:e._meta})),resources:{listChanged:!1},prompts:{listChanged:!1},...nr()},prompts:_n,resourceTemplates:bn,clientSetups:sr({baseUrl:k,mcpUrl:`${k}mcp`,serverName:"knowgrph"}),surfaceRoles:{publicReadMcpUrl:`${k}mcp`,publicReadMcpScope:"Canonical public install and discovery endpoint for read-only retrieval, prompt discovery, resource discovery, and inspection.",controlPlaneMcpUrl:`${k}control-plane/mcp`,controlPlaneMcpScope:"Approval-gated orchestration endpoint for control-plane tools and spend-bearing workflows where deployed.",remoteGrammarInvokePublic:!1,remoteGrammarInvokeToolName:"knowgrph.agentic_canvas_os.docs.invoke",remoteGrammarInvokeStatus:"planned-public-enhancement"},links:{apiCatalog:`${k}.well-known/api-catalog`,skills:`${k}.well-known/agent-skills/index.json`,status:qe,agentCard:vt,controlPlaneMcp:`${k}control-plane/mcp`}},Ds=At({appUrl:k,updatedAt:xe}),Rr=It.map(e=>({name:e.webName,title:e.title,description:e.description,inputSchema:e.inputSchema,outputSchema:e.outputSchema,securitySchemes:e.securitySchemes,annotations:e.annotations,_meta:e._meta})),$e=n(e=>st(It.find(t=>t.name===e)?.webName),"findWebMcpToolName"),Hs=$e(u.search),js=$e(u.fetch),Bs=$e(u.listSourceFiles),Gs=$e(u.readSourceFile),Ws=$e(u.readSharedDocument),Fs=$e(u.inspectSharedDocumentStructure),zs=$e(u.inspectAgentSurface),qs=`(() => {
  ...
  const createPublishedDocIdentityResolver = ${rn};
  ...
  const createPublishedAgentReadyToolExecutors = ${Lo};
...
})();`,Vs=n(async e=>{if(!(e.headers.get("content-type")||"").toLowerCase().includes("text/html"))return e;let r=await e.text();if(Rr.every(i=>r.includes(i.name)))return new Response(r,e);let o=`<script>${qs}<\/script>`,a=r.includes("</head>")?r.replace("</head>",`${o}</head>`):`${r}${o}`,s=new Response(a,e);return s.headers.delete("content-length"),s},"injectWebMcpScript"),Ys={search:u.search,fetch:u.fetch,listSourceFiles:u.listSourceFiles,readSourceFile:u.readSourceFile,readSharedDocument:u.readSharedDocument,inspectSharedDocumentStructure:u.inspectSharedDocumentStructure,inspectAgentSurface:u.inspectAgentSurface},Js=n(async e=>{let t=new TextEncoder().encode(e),r=await crypto.subtle.digest("SHA-256",t);return[...new Uint8Array(r)].map(o=>o.toString(16).padStart(2,"0")).join("")},"sha256Hex"),vn=Fo(),Xs=Object.fromEntries(tt.map(e=>[e.name,Js(vn[e.name]||"")])),wn=new Map(tt.map(e=>[`${C}${e.path}`.replace(/\/+$/,""),vn[e.name]||""]));var On=n(async()=>qo({appUrl:k,updatedAt:xe,sha256ByName:Xs}),"agentSkillsIndex"),Qs={keys:[{kty:"OKP",crv:"Ed25519",kid:"knowgrph-agent-ready-2026-05-21",use:"sig",alg:"EdDSA",x:"11qYAYdkVKxA4G0wV47IxPtYfFVH_H7zmC2Di2PcvLU"}]},Zs={protocolVersion:"2025-06-18",capabilities:{tools:{},resources:{},prompts:{listChanged:!1},...nr()},serverInfo:Re.serverInfo},Pr=Re.capabilities.tools,ei=[Ds],ti=_n,ri=bn,In=n(()=>({status:"pass",service:"knowgrph-agent-ready-pages",homepage:k,health:qe,updatedAt:xe,checks:{linkHeaders:!0,markdownNegotiation:!0,httpMcp:!0,webMcp:!0,mcpApps:!0,commerce:{acp:!0,ucp:!0,mpp:!0,x402:!0},defaultWorkspaceId:rt}}),"buildHealthStatusBody"),oi=n(async()=>Uo({baseUrl:k,health:In(),apiCatalog:En,openApi:Cn,mcpServerCard:Re,agentCard:Tn,agentSkills:await On(),commerce:Zt({origin:G})}),"buildAgentSurfaceInspection"),ni=lr({toolNames:Ys,defaultWorkspaceId:rt,publicBaseUrl:G,buildStorageDocPath:Rn,fetchSourceFilesIndexResponse:n(()=>fetch(`${Tt}${an()}`,{headers:{accept:"text/markdown"}}),"fetchSourceFilesIndexResponse"),fetchStorageMarkdownResponse:n(e=>fetch(`${Tt}${e}`,{headers:{accept:"text/markdown"}}),"fetchStorageMarkdownResponse"),resolveSharedDocumentInput:n((e={})=>Et({shareToken:e?.shareToken,shareUrl:e?.shareUrl,appBasePath:C,baseUrl:G}),"resolveSharedDocumentInput"),inspectSharedDocumentStructure:Ko,buildAgentSurfaceInspection:oi}),Ar=n(e=>{try{let t=new URL(e,G);return Et({shareUrl:`${t.pathname}${t.search}`,baseUrl:G,appBasePath:C})}catch{return null}},"resolvePublishedDocRequestIdentity"),ai=n(e=>Et({shareUrl:String(e||""),baseUrl:G,appBasePath:C}),"resolvePublishedDocPathIdentity"),si=n(async(e,t)=>{let r=new URL(Rn(t.canonicalPath,t.workspaceId),Tt),o=await fetch(r,{method:"GET",headers:{accept:"text/markdown, text/plain;q=0.9, */*;q=0.1"}}),a=new Headers(o.headers),s=String(a.get("vary")||"");return a.set("vary",s?`${s}, Accept`:"Accept"),new Response(String(e.method||"").toUpperCase()==="HEAD"?null:o.body,{status:o.status,statusText:o.statusText,headers:a})},"proxyPublishedDocMarkdownResponse"),ii=n(async e=>{try{let t=await e.json();return t&&typeof t=="object"?t:null}catch{return null}},"readJsonRpcRequest"),Ee=n((e,t)=>ce(200,{jsonrpc:"2.0",id:e??null,result:t}),"jsonRpcResult"),Me=n((e,t,r)=>ce(200,{jsonrpc:"2.0",id:e??null,error:{code:t,message:r}}),"jsonRpcError"),ci=n(e=>String(e.headers.get("accept")||"").toLowerCase().split(",").some(t=>t.trim().startsWith("text/event-stream")),"requestAcceptsEventStream"),br=n((e,t)=>Object.prototype.hasOwnProperty.call(e,t),"hasOwnProperty"),Mn=n(e=>{if(Array.isArray(e))return e.length>0&&e.every(Mn);if(!e||typeof e!="object"||String(e.jsonrpc||"")!=="2.0")return!1;let t=typeof e.method=="string"&&e.method.length>0,r=br(e,"id"),o=br(e,"result")||br(e,"error");return t&&!r||!t&&o},"isJsonRpcNotificationOrResponse"),Nn=n(async(e,t)=>{let r=ni[e];if(typeof r!="function")throw new Error(`unknown tool: ${e}`);return r(t)},"executeMcpTool"),li=n(async e=>{let t=st(e);if(t===ie)return ir({appUrl:k,updatedAt:xe,toolNames:Pr.map(o=>o.name)});let r=Po(t);if(r){let o=await Nn(u.fetch,{id:r});return Ao({uri:t,sourceFile:o})}throw new Error(`unknown resource: ${e}`)},"readMcpResource"),pi=n(async e=>{let t=String(e.method||"GET").toUpperCase();if(t==="GET"||t==="HEAD")return ci(e)?hn(405,{allow:"POST"}):ye({ok:!0,transport:Re.transport,serverInfo:Re.serverInfo,capabilities:Re.capabilities,links:Re.links,surfaceRoles:Re.surfaceRoles});if(t!=="POST")return ce(405,{ok:!1,error:"unsupported_method"});let r=await ii(e);if(!r)return Me(null,-32700,"Parse error");if(Mn(r))return hn(202);if(Array.isArray(r))return Me(null,-32600,"Batch JSON-RPC requests are not supported");switch(r.method){case"initialize":return Ee(r.id,Zs);case"tools/list":return Ee(r.id,{tools:Pr});case"prompts/list":return Ee(r.id,{prompts:ti});case"resources/templates/list":return Ee(r.id,{resourceTemplates:ri});case"prompts/get":{let o=st(r.params?.name),a=r.params?.arguments&&typeof r.params.arguments=="object"?r.params.arguments:{};if(!o)return Me(r.id,-32602,"Prompt name is required");try{return Ee(r.id,So(o,a))}catch(s){return Me(r.id,-32602,s instanceof Error?s.message:String(s))}}case"resources/list":return Ee(r.id,{resources:ei});case"resources/read":{let o=st(r.params?.uri);if(!o)return Me(r.id,-32602,"Resource URI is required");try{return Ee(r.id,await li(o))}catch(a){return Me(r.id,-32602,a instanceof Error?a.message:String(a))}}case"tools/call":{let o=st(r.params?.name),a=r.params?.arguments&&typeof r.params.arguments=="object"?r.params.arguments:{};if(!o)return Me(r.id,-32602,"Tool name is required");try{let s=await Nn(o,a);return Ee(r.id,{content:[{type:"text",text:typeof s?.markdown=="string"?s.markdown:JSON.stringify(s,null,2)}],structuredContent:s,isError:!1})}catch(s){return Ee(r.id,{content:[{type:"text",text:s instanceof Error?s.message:String(s)}],isError:!0})}}default:return Me(r.id,-32601,"Method not found")}},"handleMcpTransport"),ui=n(()=>ir({appUrl:k,updatedAt:xe,toolNames:Pr.map(e=>e.name)}).contents[0].text,"buildKnowgrphMcpAppHtmlBody");var kr=n(e=>e===C||e===`${C}/`,"handlesKnowgrphRoot"),di=n(e=>kr(e)||!!ai(e),"handlesKnowgrphHtmlSurface"),mi=n(e=>{let t=new URL(e.url),r=t.pathname.replace(/\/+$/,"")||"/",o=Ar(e.url);return r===Ve?"health":r===`${C}/mcp`?"mcp":xn(r)?"github-workspace-write":r===`${C}/robots.txt`?"robots":r===`${C}/sitemap.xml`?"sitemap":r===`${C}/auth.md`||r==="/auth.md"?"auth-md":r.startsWith(`${C}/.well-known/`)?"well-known":o?ot(e)?"shared-doc-markdown":"shared-doc-html":kr(t.pathname)?ot(e)?"homepage-markdown":"homepage-html":"app-surface"},"resolveAgentReadyRouteTag"),Ot=n((e,t)=>mn(t,{owner:ln,tag:mi(e)}),"withKnowgrphRouteHeaders"),Sn=n(async e=>{let t=new URL(e.url),r=t.pathname.replace(/\/+$/,"")||"/",o=Ar(e.url);if(o&&ot(e))return si(e,o);if(kr(t.pathname)&&ot(e))return dn(un);switch(r){case Ve:return As(In());case`${C}/mcp`:return pi(e);case`${C}/robots.txt`:return nt(Ls,"text/plain; charset=utf-8");case`${C}/sitemap.xml`:return nt(Ks,"application/xml; charset=utf-8");case`${C}/auth.md`:case"/auth.md":return nt($s,"text/markdown; charset=utf-8");case`${C}/.well-known/api-catalog`:return ye(En,"application/linkset+json; charset=utf-8");case`${C}/.well-known/openapi.json`:return ye(Cn,"application/vnd.oai.openapi+json; charset=utf-8");case yr:return ye(Tn);case`${C}/.well-known/oauth-protected-resource`:return ye(at);case`${C}/.well-known/oauth-authorization-server`:return ye(yn);case`${C}/.well-known/openid-configuration`:return ye(yn);case`${C}/.well-known/mcp/server-card.json`:return ye(Re);case`${C}/.well-known/mcp/apps/knowgrph-agent-ready.html`:return Ps(ui());case`${C}/.well-known/mcp.json`:return ye(Re);case`${C}/.well-known/agent-skills/index.json`:return ye(await On());case`${C}/.well-known/http-message-signatures-directory`:return ye(Qs);default:return wn.has(r)?nt(wn.get(r),"text/markdown; charset=utf-8"):null}},"routeResponse");async function Ne(e){let{env:t,request:r}=e,o=String(r.method||"GET").toUpperCase(),a=new URL(r.url);if(o==="OPTIONS")return new Response(null,{status:204,headers:{"access-control-allow-origin":"*","access-control-allow-methods":"GET, HEAD, POST, OPTIONS","access-control-allow-headers":"*","access-control-max-age":"86400"}});if(o==="POST"&&a.pathname.replace(/\/+$/,"")===`${C}/mcp`)return Ot(r,await Sn(r));if(o==="POST"&&xn(a.pathname))return Ot(r,await Ms(r,t));if(o!=="GET"&&o!=="HEAD")return ce(405,{ok:!1,error:"unsupported_method"});let s=await Sn(r);if(s){let p=Ot(r,s);return o==="HEAD"?new Response(null,p):p}let i=Ar(r.url)?await Yo(e,C):await e.next();if(!di(a.pathname))return i;let c=o==="HEAD"?i:await Vs(i),l=new Response(o==="HEAD"?null:c.body,c);return l.headers.set("link",pn),Ot(r,l)}n(Ne,"onRequest");async function Un(e){return Ne(e)}n(Un,"onRequest");async function Ln(e){return Ne(e)}n(Ln,"onRequest");async function Kn(e){return Ne(e)}n(Kn,"onRequest");var hi=Object.freeze(new Set(["","80","443"])),gi=Object.freeze([".local",".localhost",".internal"]),fi=Object.freeze(new Set(["localhost"]));function De(e){return String(e||"").trim().toLowerCase()}n(De,"normalizeHostname");function yi(e){let t=De(e);if(!/^\d{1,3}(\.\d{1,3}){3}$/.test(t))return!1;let r=t.split(".").map(o=>Number(o));return r.length!==4?!1:r.every(o=>Number.isInteger(o)&&o>=0&&o<=255)}n(yi,"isIpv4Literal");function $n(e){let[t,r,o,a]=e.split(".").map(s=>Number(s));return(t<<24|r<<16|o<<8|a)>>>0}n($n,"ipv4ToInt");function wi(e,t,r){if(!Number.isInteger(r)||r<0||r>32)return!1;if(r===0)return!0;let o=4294967295<<32-r>>>0;return(e&o)===(t&o)}n(wi,"inIpv4Cidr");function Si(e){let t=De(e);return!t||!t.includes(":")?!1:/^[0-9a-f:]+$/i.test(t)}n(Si,"isIpv6Literal");function _i(e){let t=De(e);return!!(!t||t==="::1"||t==="0:0:0:0:0:0:0:1"||t.startsWith("fc")||t.startsWith("fd")||/^fe[89ab]/i.test(t))}n(_i,"isBlockedIpv6");function bi(e,{blockedExact:t,blockedSuffixes:r}={}){let o=De(e);if(!o)return!0;let a=t||fi;if(a instanceof Set&&a.has(o))return!0;let s=r||gi;if(Array.isArray(s))for(let i of s){let c=De(i);if(c&&(o===c||o.endsWith(c)))return!0}return!1}n(bi,"isBlockedHostname");function Ri(e){let t=De(e);if(!t)return!0;if(yi(t)){let r=$n(t),o=[{base:"0.0.0.0",bits:8},{base:"10.0.0.0",bits:8},{base:"127.0.0.0",bits:8},{base:"169.254.0.0",bits:16},{base:"172.16.0.0",bits:12},{base:"192.168.0.0",bits:16},{base:"100.64.0.0",bits:10}];for(let a of o){let s=$n(a.base);if(wi(r,s,a.bits))return!0}return!1}return Si(t)?_i(t):!1}n(Ri,"isBlockedIpLiteral");function Mt(e,{allowedPorts:t}={}){let r=String(e||"").trim();if(!r)throw new Error("invalid_url");let o;try{o=new URL(r)}catch{throw new Error("invalid_url")}if(o.protocol!=="http:"&&o.protocol!=="https:")throw new Error("invalid_url");if(o.username||o.password)throw new Error("invalid_url");let a=t||hi,s=String(o.port||"");if(a instanceof Set&&!a.has(s))throw new Error("port_not_allowed");let i=De(o.hostname);if(!i)throw new Error("invalid_url");if(bi(i))throw new Error("blocked_host");if(Ri(i))throw new Error("blocked_host");return o}n(Mt,"parseAndValidateExternalUrl");function Nt(e){return String(e.headers.get("sec-fetch-site")||"").trim().toLowerCase()==="cross-site"}n(Nt,"shouldRejectCrossSiteFetch");var Pi={"content-type":"application/json; charset=utf-8","cache-control":"public, max-age=600"};function He(e,t={}){return new Response(JSON.stringify(e),{...t,headers:{...Pi,...t.headers||{}}})}n(He,"json");function Ut(...e){for(let t of e){if(!t)continue;let r=String(t).trim();if(r)return r}return null}n(Ut,"pickFirst");function Ai(e){let t=e.slice(0,8e4),r=t.match(/<title[^>]*>([^<]*)<\/title>/i),o=t.match(/<meta[^>]+property=["']og:title["'][^>]*content=["']([^"']+)["'][^>]*>/i),a=t.match(/<meta[^>]+property=["']og:description["'][^>]*content=["']([^"']+)["'][^>]*>/i),s=t.match(/<meta[^>]+name=["']description["'][^>]*content=["']([^"']+)["'][^>]*>/i),i=t.match(/<meta[^>]+property=["']og:image["'][^>]*content=["']([^"']+)["'][^>]*>/i),c=t.match(/<meta[^>]+property=["']og:site_name["'][^>]*content=["']([^"']+)["'][^>]*>/i);return{title:Ut(o?.[1],r?.[1]),description:Ut(a?.[1],s?.[1]),image:Ut(i?.[1]),siteName:Ut(c?.[1])}}n(Ai,"extractMeta");async function Dn(e){let t=e.request.url,r=new URL(t);if(r.searchParams.get("ping")==="1")return He({ok:!0,ping:!0});let o=r.searchParams.get("url")||"";if(Nt(e.request))return He({ok:!1,error:"forbidden"},{status:403,headers:{"cache-control":"no-store"}});let a;try{a=Mt(o)}catch{return He({ok:!1,error:"invalid_url"},{status:400,headers:{"cache-control":"no-store"}})}try{let s=await fetch(a.toString(),{headers:{"user-agent":"Mozilla/5.0 (compatible; HackaMapLinkPreview/1.0)",accept:"text/html,application/xhtml+xml"},redirect:"follow",cf:{cacheTtl:600,cacheEverything:!0}}),i=s.headers.get("content-type")||"";if(!s.ok)return He({ok:!1,error:"fetch_failed",status:s.status,url:a.toString()},{status:200,headers:{"cache-control":"no-store"}});if(!i.includes("text/html"))return He({ok:!0,url:a.toString(),domain:a.host,contentType:i,title:null,description:null,image:null,siteName:null});let c=await s.text(),l=Ai(c);return He({ok:!0,url:a.toString(),domain:a.host,contentType:i,...l})}catch(s){return He({ok:!1,error:"exception",message:s?.message||String(s),url:a.toString()},{status:200,headers:{"cache-control":"no-store"}})}}n(Dn,"onRequestGet");var Hn=35e4;function ki(e){let t=e;return t=t.replace(/<script\b[\s\S]*?<\/script>/gi,""),t=t.replace(/<iframe\b[\s\S]*?<\/iframe>/gi,""),t=t.replace(/<object\b[\s\S]*?<\/object>/gi,""),t=t.replace(/<embed\b[\s\S]*?>/gi,""),t=t.replace(/<noscript\b[\s\S]*?<\/noscript>/gi,""),t=t.replace(/\son[a-z]+\s*=\s*"[^"]*"/gi,""),t=t.replace(/\son[a-z]+\s*=\s*'[^']*'/gi,""),t}n(ki,"stripActiveContent");function xi({url:e,title:t,innerHtml:r}){let o=t?String(t).slice(0,140):"Preview",a=String(e).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;");return`<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
...
</html>`}n(xi,"buildWrapper");async function jn(e){let r=new URL(e.request.url).searchParams.get("url")||"";if(Nt(e.request))return new Response("Forbidden",{status:403,headers:{"cache-control":"no-store"}});let o;try{o=Mt(r)}catch(a){let s=a instanceof Error?a.message:"invalid_url";return new Response(s,{status:400,headers:{"cache-control":"no-store"}})}try{let a=await fetch(o.toString(),{headers:{"user-agent":"Mozilla/5.0 (compatible; HackaMapLinkProxy/1.0)",accept:"text/html,application/xhtml+xml"},redirect:"follow",cf:{cacheTtl:600,cacheEverything:!0}}),s=a.headers.get("content-type")||"";if(!a.ok)return new Response(`Fetch failed (${a.status})`,{status:200,headers:{"content-type":"text/plain; charset=utf-8","cache-control":"no-store"}});if(!s.includes("text/html"))return new Response(`Unsupported content-type: ${s}`,{status:200,headers:{"content-type":"text/plain; charset=utf-8","cache-control":"public, max-age=600"}});let i=await a.text();i.length>Hn&&(i=i.slice(0,Hn));let l=i.match(/<title[^>]*>([^<]*)<\/title>/i)?.[1]?.trim()||o.host;i=ki(i),/<base\s/i.test(i)||(i=i.replace(/<head([^>]*)>/i,`<head$1><base href="${o.origin}/">`));let m=xi({url:o.toString(),title:l,innerHtml:i});return new Response(m,{status:200,headers:{"content-type":"text/html; charset=utf-8","cache-control":"public, max-age=600","content-security-policy":"default-src 'none'; img-src https: data:; style-src 'unsafe-inline' https:; font-src https: data:; frame-ancestors 'self';"}})}catch(a){return new Response(`Exception: ${a?.message||String(a)}`,{status:200,headers:{"content-type":"text/plain; charset=utf-8","cache-control":"no-store"}})}}n(jn,"onRequestGet");var xr="api.openai.com",Lt="api.miromind.ai",Kt="apihub.agnes-ai.com",$t="ark.ap-southeast.bytepluses.com",Er="ark.eu-west.bytepluses.com",Gn=new Set(["localhost","127.0.0.1","0.0.0.0"]),Pe=n(e=>String(e||"").trim().toLowerCase(),"normalizeHost"),we=n((e,t)=>String(e.get(t)||"").trim(),"readHeader"),Wn=n(e=>Gn.has(Pe(e)),"isLocalHost"),Bn=n(e=>{let t=String(e||"").trim();if(!t)return new Set;let r=new Set;return t.split(",").map(o=>Pe(o)).filter(Boolean).forEach(o=>r.add(o)),r},"parseCsvSet"),Fn=n((e,{includeOpenAi:t=!1,includeMiroMind:r=!1,includeAgnes:o=!1,includeBytePlus:a=!1}={})=>{let s=Bn(e.KNOWGRPH_INTEGRATION_ALLOWED_HOSTS),i=Bn(e.KNOWGRPH_CHAT_PROXY_ALLOWED_HOSTS),c=s.size?s:i,l=c.size?c:new Set([...Gn]);return t&&l.add(xr),r&&l.add(Lt),o&&l.add(Kt),a&&(l.add($t),l.add(Er)),l},"parseAllowedHosts"),ae=n(e=>{let t=we(e.headers,"origin");if(!t)return{};let r="";try{r=Pe(new URL(t).host)}catch{return{}}let o=Pe(new URL(e.url).host);return r===o||r.startsWith("localhost:")||r.startsWith("127.0.0.1:")?{"access-control-allow-origin":t,vary:"Origin"}:{}},"corsHeaders"),he=n((e,t,r)=>new Response(JSON.stringify(t),{status:r,headers:{"content-type":"application/json; charset=utf-8","cache-control":"no-store",...ae(e)}}),"jsonResponse");var Dt={"content-type":"application/json; charset=utf-8","cache-control":"no-store"};function it(e,t,r=200){return new Response(JSON.stringify(t),{status:r,headers:{...Dt,...ae(e)}})}n(it,"jsonResponse");async function Ei(e){let t=new URL("/knowgrph/imports/hackamap/hackamap-graph.json",e.url),r=await fetch(t.toString(),{redirect:"follow"});return r.ok?await r.json():null}n(Ei,"fetchHackamapGraphJson");async function je(e,t){let r=new URL(t,e.url),o=await fetch(r.toString(),{redirect:"follow"});return o.ok?await o.json():null}n(je,"fetchHackamapJson");async function Ci(e){let t=await je(e,"/knowgrph/imports/hackamap/hackamap_api_graph.json");return Yn(t)?t:null}n(Ci,"fetchHackamapApiGraphJson");async function Ti(e){let t=await je(e,"/knowgrph/imports/hackamap/hackamap_pipeline.json");return t&&typeof t=="object"&&!Array.isArray(t)?t:{}}n(Ti,"fetchHackamapPipelineJson");async function qn(e){let t=await je(e,"/knowgrph/imports/hackamap/hackamap_query_presets.json");return Array.isArray(t)?t.filter(Boolean):[]}n(qn,"fetchHackamapQueryPresetsJson");async function Vn(e){let t=await je(e,"/knowgrph/imports/hackamap/query-outputs/query-runs.manifest.json");return t&&typeof t=="object"&&!Array.isArray(t)?t:{}}n(Vn,"fetchHackamapQueryRunsManifestJson");function Yn(e){return!e||typeof e!="object"||Array.isArray(e)?!1:Array.isArray(e.nodes)&&Array.isArray(e.edges)}n(Yn,"isApiGraphPayload");function Jn(e,t){let r=String(e&&e.output&&e.output.per_table_prefix||e?.id||t?.preset||"").trim(),o=String(t?.output_suffix||"").trim();return o?`${r}-${o}`:r}n(Jn,"buildHackamapTablePrefix");function Cr(e,t){if(!Array.isArray(e))return[];let r=[];for(let o of e){if(!o||typeof o!="object"||Array.isArray(o))continue;let a=String(o[t]||"").trim();a&&r.push(a)}return r}n(Cr,"collectRowIds");async function vi(e,t){let r=await je(e,t);return Array.isArray(r)?r.length:0}n(vi,"countHackamapQueryRows");async function Oi(e,t,r){let o=Jn(t,r);if(!o)return{};let a=["events","demos","sources","organizer","team","techstack"],s=await Promise.all(a.map(async i=>[i,await vi(e,`/knowgrph/imports/hackamap/query-outputs/${i}.${o}.query.json`)]));return Object.fromEntries(s.filter(([,i])=>i>0))}n(Oi,"readHackamapRunTableCounts");function Tr(e){return Array.isArray(e)?e.map(Tr):!e||typeof e!="object"?e:Object.fromEntries(Object.entries(e).sort(([t],[r])=>String(t).localeCompare(String(r))).map(([t,r])=>[t,Tr(r)]))}n(Tr,"sortObjectKeys");function Ii(e){try{return JSON.stringify(Tr(e))}catch{return""}}n(Ii,"stableParamSignature");function Mi(e){return typeof e=="string"?{value:e,label:e}:{value:e,label:JSON.stringify(e)}}n(Mi,"toBuilderOption");function Ni(e,t){return e.map(r=>{let o=String(r?.id||"").trim();if(!o)return null;let a=r?.params&&typeof r.params=="object"&&!Array.isArray(r.params)?r.params:{},s=t.filter(l=>String(l?.preset||"").trim()===o),i=Array.from(new Set([...Object.keys(a),...s.flatMap(l=>l?.params&&typeof l.params=="object"&&!Array.isArray(l.params)?Object.keys(l.params):[])])).sort((l,p)=>String(l).localeCompare(String(p))),c=Object.fromEntries(i.map(l=>{let p=new Set,m=[],f=[a[l],...s.map(P=>P?.params&&typeof P.params=="object"&&!Array.isArray(P.params)?P.params[l]:void 0)];for(let P of f){if(typeof P>"u")continue;let _=Ii(P);!_||p.has(_)||(p.add(_),m.push(Mi(P)))}return[l,m]}));return{id:o,title:String(r?.title||o).trim(),params:a,param_keys:i,published_param_options:c}}).filter(Boolean)}n(Ni,"buildHackamapPresetRuntimeEntries");async function Ui(e){let[t,r,o]=await Promise.all([Ti(e),qn(e),Vn(e)]),a=t&&typeof t=="object"?t.runtime||{}:{},s=String(a?.query_selection?.default_run_id||"").trim()||"enhanced",i=Array.isArray(o?.runs)?o.runs:[],c=(await Promise.all(i.map(async l=>{let p=String(l?.id||"").trim(),m=String(l?.preset||"").trim();if(!p)return null;let f=r.find(_=>String(_?.id||"").trim()===m),P=await Oi(e,f,l);return{id:p,preset:m,title:String(l?.title||l?.id||"").trim(),params:l?.params&&typeof l.params=="object"&&!Array.isArray(l.params)?l.params:{},output_suffix:String(l?.output_suffix||"").trim(),is_default:p===s,table_counts:P}}))).filter(l=>l?.id);return{ok:!0,runtime:{...a&&typeof a=="object"?a:{},presets:Ni(r,c),runs:c}}}n(Ui,"buildHackamapRuntimeMeta");async function Li(e,t){let r=String(t||"").trim();if(!r)return null;let[o,a]=await Promise.all([qn(e),Vn(e)]),i=(Array.isArray(a?.runs)?a.runs:[]).find(x=>String(x?.id||"").trim()===r);if(!i)return null;let c=o.find(x=>String(x?.id||"").trim()===String(i?.preset||"").trim()),l=Jn(c,i);if(!l)return null;let[p,m]=await Promise.all([je(e,`/knowgrph/imports/hackamap/query-outputs/events.${l}.query.json`),je(e,`/knowgrph/imports/hackamap/query-outputs/demos.${l}.query.json`)]),f=new Set(Cr(p,"id")),P=new Set(Cr(m,"id")),_=Cr(m,"event_id");for(let x of _)f.add(x);return{eventIds:f,demoIds:P}}n(Li,"readHackamapQueryRunSelection");function zn(e,t,r){if(!r||!Yn(e))return e;if(r.eventIds.size===0&&r.demoIds.size===0)return{...e,meta:{...e?.meta&&typeof e.meta=="object"?e.meta:{},selected_run_id:t,selected_run_filter_skipped:"no-event-demo-rows"}};let o=new Set;r.eventIds.forEach(c=>o.add(`Event:${c}`)),r.demoIds.forEach(c=>o.add(`Demo:${c}`));let a=Array.isArray(e.nodes)?e.nodes.filter(c=>o.has(String(c?.id||"").trim())):[],s=new Set(a.map(c=>String(c?.id||"").trim()).filter(Boolean)),i=Array.isArray(e.edges)?e.edges.filter(c=>s.has(String(c?.source||"").trim())&&s.has(String(c?.target||"").trim())):[];return{...e,nodes:a,edges:i,meta:{...e?.meta&&typeof e.meta=="object"?e.meta:{},selected_run_id:t,selected_event_count:r.eventIds.size,selected_demo_count:r.demoIds.size,total_problems:a.filter(c=>String(c?.type||"").trim()==="problem").length,total_solutions:a.filter(c=>String(c?.type||"").trim()==="solution").length}}}n(zn,"filterHackamapApiGraphPayloadByRun");function Ki(e){let t=Array.isArray(e?.nodes)?e.nodes:[],r=Array.isArray(e?.links)?e.links:[],o=[],a=new Set;for(let i of t){let c=String(i?.id||"").trim(),l=String(i?.type||"").trim(),p=String(i?.label||"").trim();if(!(!c||!l||!p)){if(l==="Event"){o.push({id:c,type:"problem",label:p,cluster:"Event"}),a.add(c);continue}l==="Demo"&&(o.push({id:c,type:"solution",label:p,cluster:"Demo"}),a.add(c))}}let s=[];for(let i of r){let c=String(i?.source||"").trim(),l=String(i?.target||"").trim(),p=String(i?.type||"").trim();!c||!l||p==="has_demo"&&(!a.has(c)||!a.has(l)||s.push({source:c,target:l,type:"has_demo",strength:.35}))}return{nodes:o,edges:s,meta:{source:"hackamap-graph.json:fallback",total_problems:o.filter(i=>i.type==="problem").length,total_solutions:o.filter(i=>i.type==="solution").length,...e?.content_signature?{content_signature:String(e.content_signature)}:{}}}}n(Ki,"toBipartiteApiPayload");async function Xn(e){let{request:t}=e,r=String(t.method||"GET").toUpperCase(),o=new URL(t.url);if(r==="OPTIONS")return new Response(null,{status:204,headers:{...ae(t),"access-control-allow-methods":"GET, HEAD, OPTIONS","access-control-allow-headers":"*","access-control-max-age":"86400"}});if(r!=="GET"&&r!=="HEAD")return it(t,{ok:!1,error:"unsupported_method"},405);if(String(o.searchParams.get("view")||"").trim().toLowerCase()==="meta"){let m=await Ui(t);return r==="HEAD"?new Response(null,{status:200,headers:{...Dt,...ae(t)}}):it(t,m,200)}let a=String(o.searchParams.get("run")||"").trim(),s=await Li(t,a),i=await Ci(t);if(i){let m=zn(i,a,s);return r==="HEAD"?new Response(null,{status:200,headers:{...Dt,...ae(t)}}):it(t,m,200)}let c=await Ei(t);if(!c)return it(t,{ok:!1,error:"missing_hackamap_graph",hint:"/knowgrph/imports/hackamap/{hackamap_api_graph.json,hackamap-graph.json} not found"},404);let l=Ki(c),p=zn(l,a,s);return r==="HEAD"?new Response(null,{status:200,headers:{...Dt,...ae(t)}}):it(t,p,200)}n(Xn,"onRequest");var $i=!0,Qn=600,Zn={"content-type":"application/json; charset=utf-8","cache-control":`public, max-age=${Qn}`};function Be(e,t,r={}){return new Response(JSON.stringify(t),{...r,headers:{...Zn,...r.headers||{},...ae(e)}})}n(Be,"jsonResponse");function Di(e){try{let t=new URL(String(e));return t.protocol==="http:"||t.protocol==="https:"}catch{return!1}}n(Di,"isHttpUrl");function ct(e){return String(e||"").trim().toLowerCase()}n(ct,"normalizeHost");function vr(e,{exact:t,suffixes:r}){let o=ct(e);return o?!!(Array.isArray(t)&&t.some(a=>o===ct(a))||Array.isArray(r)&&r.some(a=>o===ct(a)||o.endsWith(`.${ct(a)}`))):!1}n(vr,"isHostMatch");function Hi(e){let t=ct(e.hostname),r=e.toString();return vr(t,{suffixes:["linkedin.com"]})?new URL(`https://www.linkedin.com/embeds/oembed.json?url=${encodeURIComponent(r)}`):vr(t,{exact:["twitter.com","x.com"],suffixes:["twitter.com","x.com"]})?new URL(`https://publish.twitter.com/oembed?omit_script=1&url=${encodeURIComponent(r)}`):vr(t,{exact:["reddit.com"],suffixes:["reddit.com"]})?new URL(`https://www.reddit.com/oembed?url=${encodeURIComponent(r)}`):null}n(Hi,"buildOembedUpstreamUrl");async function ji({upstreamUrl:e}){return await fetch(e.toString(),{headers:{"user-agent":"Mozilla/5.0 (compatible; OEmbedProxy/1.0)",accept:"application/json,text/json;q=0.9,*/*;q=0.1"},redirect:"follow",cf:{cacheTtl:Qn,cacheEverything:!0}})}n(ji,"fetchJsonUpstream");async function ea(e){let{request:t}=e,r=String(t.method||"GET").toUpperCase(),o=new URL(t.url);if(r==="OPTIONS")return new Response(null,{status:204,headers:{...ae(t),"access-control-allow-methods":"GET, HEAD, OPTIONS","access-control-allow-headers":"*","access-control-max-age":"86400"}});if(!["GET","HEAD"].includes(r))return Be(t,{ok:!1,error:"unsupported_method"},{status:405});if(o.searchParams.get("ping")==="1")return Be(t,{ok:!0,ping:!0});if($i)return Be(t,{ok:!1,error:"disabled_by_policy"},{status:200,headers:{"cache-control":"no-store"}});let a=o.searchParams.get("url")||"";if(!Di(a))return Be(t,{ok:!1,error:"invalid_url"},{status:400,headers:{"cache-control":"no-store"}});let s;try{s=new URL(a)}catch{return Be(t,{ok:!1,error:"invalid_url"},{status:400,headers:{"cache-control":"no-store"}})}let i=Hi(s);if(!i)return Be(t,{ok:!1,error:"unsupported_provider"},{status:400,headers:{"cache-control":"no-store"}});let c=await ji({upstreamUrl:i}),l=new Headers(c.headers);l.delete("content-length"),l.set("cache-control",c.ok?Zn["cache-control"]:"no-store");for(let[m,f]of Object.entries(ae(t)))l.set(m,f);if(r==="HEAD")return new Response(null,{status:c.status,headers:l});let p=await c.text();try{JSON.parse(p)}catch{return Be(t,{ok:!1,error:"invalid_upstream_json",status:c.status},{status:502,headers:{"cache-control":"no-store"}})}return l.set("content-type","application/json; charset=utf-8"),new Response(p,{status:c.status,headers:l})}n(ea,"onRequest");var ta="/__chat_proxy",Ht="agnes-ai",jt="byteplus-modelark",Bt="miromind",Bi=n(e=>{let t=Pe(e);return t==="openai"?"openai":t===jt||t==="byteplus"?jt:t===Bt||t==="miromind-api"?Bt:t===Ht||t==="agnes"||t==="agnes-ai-api"?Ht:t},"normalizeProviderId"),Gi=n(e=>Pe(e)===Kt,"isAgnesHost"),Wi=n(e=>{let t=Pe(e);return t===$t||t===Er},"isBytePlusHost"),Fi=n(e=>Pe(e)===Lt,"isMiroMindHost"),zi=n(({provider:e,requestedUpstream:t,env:r})=>e==="openai"?"https://api.openai.com":e===Bt?t||`https://${Lt}`:e===Ht?t||`https://${Kt}`:e===jt?t||String(r.KNOWGRPH_CHAT_PROXY_UPSTREAM||"").trim()||`https://${$t}`:t||String(r.KNOWGRPH_CHAT_PROXY_UPSTREAM||"").trim(),"pickUpstreamBase");async function ra(e){let{request:t,env:r}=e,o=String(t.method||"GET").toUpperCase(),a=new URL(t.url);if(o==="OPTIONS")return new Response(null,{status:204,headers:{"access-control-allow-origin":we(t.headers,"origin")||"*","access-control-allow-methods":"GET, HEAD, POST, OPTIONS","access-control-allow-headers":"*","access-control-max-age":"86400"}});if(!["GET","HEAD","POST"].includes(o))return he(t,{ok:!1,error:"Unsupported method"},405);let s=Bi(we(t.headers,"x-kg-chat-provider")),i=zi({provider:s,requestedUpstream:we(t.headers,"x-kg-chat-upstream"),env:r});if(!i)return he(t,{ok:!1,error:"Missing chat proxy upstream configuration"},500);let c;try{c=new URL(i)}catch{return he(t,{ok:!1,error:"Invalid chat proxy upstream configuration"},500)}let l=Fn(r,{includeOpenAi:!0,includeMiroMind:!0,includeAgnes:!0,includeBytePlus:!0}),p=Pe(c.hostname);if(!l.has(p))return he(t,{ok:!1,error:"Chat proxy upstream host is not allowed"},403);if(!Wn(p)&&c.protocol!=="https:")return he(t,{ok:!1,error:"Chat proxy requires HTTPS for non-local upstream hosts"},403);let m=s==="openai"||p===xr,f=s===Bt||Fi(p),P=s===Ht||Gi(p),_=s===jt||Wi(p),x=we(t.headers,"x-kg-chat-api-key"),j=String(r.KNOWGRPH_CHAT_PROXY_OPENAI_API_KEY||r.OPENAI_API_KEY||"").trim(),L=String(r.KNOWGRPH_CHAT_PROXY_MIROMIND_API_KEY||r.MIROMIND_API_KEY||"").trim(),D=String(r.KNOWGRPH_CHAT_PROXY_AGNES_API_KEY||r.AGNES_API_KEY||"").trim(),re=String(r.KNOWGRPH_CHAT_PROXY_BYTEPLUS_API_KEY||r.BYTEPLUS_API_KEY||"").trim(),W=(x||j).slice(0,512),T=(x||L).slice(0,512),O=(x||D).slice(0,512),J=(x||re).slice(0,512),K=_?J:P?O:f?T:W;if(m&&!W)return he(t,{ok:!1,error:"Missing OpenAI API key for chat proxy upstream (set KNOWGRPH_CHAT_PROXY_OPENAI_API_KEY or OPENAI_API_KEY)"},401);if(f&&!K)return he(t,{ok:!1,error:"Missing MiroMind API key for chat proxy upstream (set KNOWGRPH_CHAT_PROXY_MIROMIND_API_KEY or MIROMIND_API_KEY)"},401);if(P&&!K)return he(t,{ok:!1,error:"Missing Agnes API key for chat proxy upstream (set KNOWGRPH_CHAT_PROXY_AGNES_API_KEY or AGNES_API_KEY)"},401);if(_&&!K)return he(t,{ok:!1,error:"Missing BytePlus API key for chat proxy upstream (set KNOWGRPH_CHAT_PROXY_BYTEPLUS_API_KEY or BYTEPLUS_API_KEY)"},401);if(o==="POST"&&!we(t.headers,"content-type").toLowerCase().includes("application/json"))return he(t,{ok:!1,error:"Chat proxy expects application/json payloads"},415);let X=a.pathname.startsWith(ta)&&a.pathname.slice(ta.length)||"/v1/chat/completions",I=X.startsWith("/")?X:`/${X}`,M=new URL(`${I}${a.search||""}`,c),B=new Headers,oe=we(t.headers,"content-type"),pe=we(t.headers,"accept");oe&&B.set("content-type",oe),pe&&B.set("accept",pe),(m||f||P||_)&&B.set("authorization",`Bearer ${K}`);let Se=we(t.headers,"x-client-request-id").slice(0,512);Se&&B.set("x-client-request-id",Se);let A=new AbortController,y=Number(r.KNOWGRPH_CHAT_PROXY_TIMEOUT_MS),S=Number.isFinite(y)?Math.max(5e3,Math.min(18e4,Math.floor(y))):9e4,d=setTimeout(()=>A.abort(),S);try{let h=await fetch(M.toString(),{method:o,headers:B,body:o==="GET"||o==="HEAD"?void 0:t.body,signal:A.signal,redirect:"follow"}),g=new Headers(h.headers);g.delete("content-length"),g.delete("www-authenticate"),g.set("cache-control","no-store");let b=we(t.headers,"origin");return b&&(g.set("access-control-allow-origin",b),g.set("vary","Origin")),o==="HEAD"?new Response(null,{status:h.status,statusText:h.statusText,headers:g}):new Response(h.body,{status:h.status,statusText:h.statusText,headers:g})}catch(h){let g=h&&typeof h=="object"&&"message"in h?String(h.message||""):"",b=A.signal.aborted||/aborted|timeout/i.test(g);return he(t,{ok:!1,error:g||"Failed to reach chat upstream"},b?504:502)}finally{clearTimeout(d)}}n(ra,"onRequest");function qi(e){let t=e.map(r=>r==null?"":typeof r=="boolean"?r?"1":"0":typeof r=="number"?Number.isFinite(r)?String(r):"":String(r)).join("|");return`rich-media-preview:${Xe(t)}`}n(qi,"buildRichMediaPreviewSemanticKey");var na="png";function lt(e){let t=typeof e=="number"?e:Number(String(e??"").trim());if(!Number.isFinite(t))return null;let r=Math.max(0,Number(t.toFixed(3)));return Number.isFinite(r)?r:null}n(lt,"normalizeRemoteVideoFrameSeconds");function Vi(e){return String(lt(e)??0).replace(/\./g,"_")}n(Vi,"formatRemoteVideoFrameSecondsForFileName");function Wt(e){let t=String(e||"").trim().toLowerCase();return t==="jpg"||t==="jpeg"?"jpg":"png"}n(Wt,"normalizeRemoteVideoFrameFormat");function Or(e){let t=String(e.sourceUrl||"").trim(),r=lt(e.timeSeconds)??0,o=Wt(e.format||na);return qi(["remote-video-frame",t,r,o])}n(Or,"buildRemoteVideoFrameSemanticKey");function aa(e){let t=lt(e.timeSeconds)??0,r=Wt(e.format||na),o=Or({...e,timeSeconds:t,format:r});return`frame-${o.split(":").pop()||Xe(o)}-t${Vi(t)}.${r}`}n(aa,"buildRemoteVideoFrameFileName");var Gt=n(e=>{let t=String(e||"").trim();return t&&/^[A-Za-z0-9_-]{6,128}$/.test(t)?t:null},"normalizeYouTubeIdLikeValue"),oa=n(e=>{try{let t=new URL(String(e||"").trim()),r=String(t.hostname||"").toLowerCase();if(r==="youtu.be"||r.endsWith(".youtu.be")){let o=t.pathname.replace(/^\/+/,"").split("/")[0]?.trim()||"";return Gt(o)}if(r==="youtube.com"||r.endsWith(".youtube.com")||r==="youtube-nocookie.com"||r.endsWith(".youtube-nocookie.com")){let o=String(t.searchParams.get("v")||"").trim();if(o)return Gt(o);let a=t.pathname.split("/").filter(Boolean),s=a[0]||"",i=a[1]||"";if((s==="embed"||s==="shorts"||s==="live")&&i)return Gt(i);if(s==="watch"){let c=String(t.searchParams.get("v")||"").trim();return Gt(c)}}}catch{return null}return null},"readYouTubeIdFromUrl");function Yi(e){let t=String(e||"").trim().replace(/^<|>$/g,"").trim();for(;/[),.;:!?]$/.test(t);){let r=t.slice(0,-1).trim();if(!r)break;let o=oa(t),a=oa(r);if(!a||o&&o!==a)break;t=r}return t}n(Yi,"stripYouTubeUrlTrailingPunctuation");function sa(e){let t=n(r=>{let o=String(r||"").trim();if(!o)return null;if(/^\d+$/.test(o))return Number(o);let a=o.match(/^(?:(\d+)h)?(?:(\d+)m)?(?:(\d+)s)?$/i);if(!a)return null;let s=a[1]?Number(a[1]):0,i=a[2]?Number(a[2]):0,c=a[3]?Number(a[3]):0,l=s*3600+i*60+c;return l>0&&Number.isFinite(l)?l:null},"parseChunk");try{let r=new URL(Yi(e)),o=r.searchParams.get("t")||r.searchParams.get("start")||"",a=r.hash&&new URLSearchParams(r.hash.replace(/^#/,"")).get("t")||"";return t(o)??t(a)}catch{return null}}n(sa,"parseYouTubeStartSeconds");var Ji="/image/knowgrph/video-frame",Xi=4096,Qi=720*60,Zi=/^frame-[a-f0-9]+-t\d+\.(?:png|jpg)$/i,Ur={"access-control-allow-origin":"*","access-control-allow-methods":"GET, HEAD, OPTIONS","access-control-allow-headers":"accept, content-type"},Nr=n(e=>String(e||"").replace(/\s+/g," ").trim(),"cleanText"),Ir=n((e,t=200,r="GET")=>new Response(r==="HEAD"?null:JSON.stringify(e),{status:t,headers:{...Ur,"content-type":"application/json; charset=utf-8","cache-control":"no-store"}}),"jsonResponse"),Mr=n((e,t=200,r="GET")=>new Response(r==="HEAD"?null:e,{status:t,headers:{...Ur,"content-type":"text/plain; charset=utf-8","cache-control":"no-store"}}),"textResponse"),ec=n((e,t)=>e===t||e.endsWith(`.${t}`),"hostMatches"),tc=n(e=>{let t=Nr(e?.KG_VIDEO_FRAME_ALLOWED_HOSTS);return t?t.split(",").map(r=>Nr(r).toLowerCase()).filter(Boolean):["youtube.com","youtu.be","youtube-nocookie.com","bilibili.com","b23.tv"]},"readAllowedHosts"),rc=n(e=>Nr(e).replace(/^<|>$/g,"").trim(),"unwrapUrlInput"),oc=n((e,t)=>{try{let r=new URL(e);if(r.protocol!=="https:"&&r.protocol!=="http:")return!1;let o=r.hostname.toLowerCase();return tc(t).some(a=>ec(o,a))}catch{return!1}},"isAllowedSourceUrl"),nc=n((e,t)=>{let r=new URL(e.url),o=rc(r.searchParams.get("url")||"");if(!o)return{error:"Missing url parameter"};if(o.length>Xi)return{error:"Video URL is too long"};if(!oc(o,t))return{error:"Video frame extraction is limited to supported remote video hosts"};let a=lt(r.searchParams.get("time"))??sa(o);if(a==null)return{error:"Missing time parameter"};let s=Math.min(Qi,Math.max(0,a)),i=Wt(r.searchParams.get("format")||"png"),c=aa({sourceUrl:o,timeSeconds:s,format:i});if(!Zi.test(c))return{error:"Invalid frame cache key"};let l=`${Ji}/${c}`;return{sourceUrl:o,timeSeconds:s,format:i,fileName:c,publicUrl:l,semanticKey:Or({sourceUrl:o,timeSeconds:s,format:i})}},"readFrameRequest"),ac=n(async(e,t,r)=>{let o=new URL(t,e.request.url),a=new Request(o.toString(),{method:r});return typeof e.env?.ASSETS?.fetch=="function"?await e.env.ASSETS.fetch(a):await fetch(a)},"fetchStaticAsset"),sc=n(e=>`Frame has not been generated yet. Run the local video-frame extractor and publish ${e.publicUrl}.`,"missingFrameMessage"),ic=n((e,t)=>{let r=new Headers;r.set("content-type",t.format==="jpg"?"image/jpeg":"image/png"),r.set("cache-control","public, max-age=31536000, immutable"),r.set("access-control-allow-origin","*");let o=e.headers.get("content-length");o&&r.set("content-length",o);let a=e.headers.get("etag");return a&&r.set("etag",a),r},"imageResponseHeaders");async function ia(e){let t=e.request;if(t.method==="OPTIONS")return new Response(null,{status:204,headers:Ur});if(t.method!=="GET"&&t.method!=="HEAD")return Mr("Method not allowed",405,t.method);let r=new URL(t.url).searchParams.get("emit")==="json",o=nc(t,e.env||{});if("error"in o)return r?Ir({ok:!1,error:o.error},400,t.method):Mr(o.error,400,t.method);let a=r&&t.method!=="HEAD"?"GET":r||t.method==="HEAD"?"HEAD":"GET",s=await ac(e,o.publicUrl,a);if(!s.ok){let i=sc(o);return r?Ir({ok:!1,error:i,publicUrl:o.publicUrl,semanticKey:o.semanticKey},404,t.method):Mr(i,404,t.method)}if(r){let i=Number(s.headers.get("content-length")||0);return(!Number.isFinite(i)||i<=0)&&t.method!=="HEAD"&&(i=(await s.arrayBuffer()).byteLength),Ir({ok:!0,imageUrl:o.publicUrl,publicUrl:o.publicUrl,semanticKey:o.semanticKey,cached:!0,bytes:Number.isFinite(i)?Math.max(0,Math.floor(i)):0,timeSeconds:o.timeSeconds,format:o.format},200,t.method)}return new Response(t.method==="HEAD"?null:s.body,{status:200,headers:ic(s,o)})}n(ia,"onRequest");var ca={"content-type":"application/json; charset=utf-8","cache-control":"no-store","access-control-allow-origin":"*","access-control-allow-methods":"GET, HEAD, POST, OPTIONS","access-control-allow-headers":"content-type"},Ft=n((e,t=200,r="GET")=>new Response(r==="HEAD"?null:JSON.stringify(e),{status:t,headers:ca}),"jsonResponse"),Y=n(e=>String(e||"").replace(/\s+/g," ").trim(),"cleanText"),cc=n(e=>{try{let t=new URL(String(e||"").trim());if(/youtu\.be$/i.test(t.hostname))return Y(t.pathname.split("/").filter(Boolean)[0]);if(/youtube\.com$/i.test(t.hostname)||/youtube-nocookie\.com$/i.test(t.hostname)){let r=Y(t.searchParams.get("v"));if(r)return r;let o=t.pathname.split("/").filter(Boolean),a=o.findIndex(s=>["embed","shorts","live"].includes(s));if(a>=0)return Y(o[a+1])}}catch{}return""},"readVideoId"),lc=n((e,t)=>{let r=e.indexOf(t);if(r<0)return null;let o=e.indexOf("{",r);if(o<0)return null;let a=0,s=!1,i=!1;for(let c=o;c<e.length;c+=1){let l=e[c];if(s){i?i=!1:l==="\\"?i=!0:l==='"'&&(s=!1);continue}if(l==='"')s=!0;else if(l==="{")a+=1;else if(l==="}"&&(a-=1,a===0))return e.slice(o,c+1)}return null},"extractJsonAfter"),pc=n(e=>{for(let t of["ytInitialPlayerResponse =","ytInitialPlayerResponse="]){let r=lc(e,t);if(r)try{return JSON.parse(r)}catch{}}return null},"parsePlayerResponse"),uc=n((e,t)=>{let r=Y(t||"en").toLowerCase();return e.find(o=>Y(o.languageCode).toLowerCase()===r)||e.find(o=>Y(o.languageCode).toLowerCase().startsWith(r.split("-")[0]))||e.find(o=>Y(o.kind)!=="asr")||e[0]||null},"pickCaptionTrack"),dc=n(e=>{let t=new URL(e);return t.searchParams.set("fmt","json3"),t.toString()},"withJsonCaptionFormat"),mc=n(e=>(Array.isArray(e?.events)?e.events:[]).map(r=>{let o=Array.isArray(r.segs)?Y(r.segs.map(i=>i?.utf8||"").join("")):"",a=Number(r.tStartMs)/1e3,s=Number(r.dDurationMs||0)/1e3;return o&&Number.isFinite(a)?{text:o,start:a,duration:Number.isFinite(s)?s:0}:null}).filter(Boolean),"parseCaptionJson3"),hc=n(e=>String(e||"").replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&quot;/g,'"').replace(/&#39;|&apos;/g,"'"),"decodeXmlText"),gc=n(e=>{let t=[],r=/<text\b([^>]*)>([\s\S]*?)<\/text>/gi,o=null;for(;o=r.exec(String(e||""));){let a=o[1]||"",s=Number(a.match(/\bstart="([^"]+)"/i)?.[1]),i=Number(a.match(/\bdur="([^"]+)"/i)?.[1]||0),c=Y(hc(o[2]||""));c&&Number.isFinite(s)&&t.push({text:c,start:s,duration:Number.isFinite(i)?i:0})}return t},"parseCaptionXml"),fc=n((e,t)=>{let r=String(e||"").trim();if(!r)return[];if(String(t||"").toLowerCase().includes("json")||r.startsWith("{")||r.startsWith("["))try{return mc(JSON.parse(r))}catch{return[]}return gc(r)},"parseCaptionResponseText"),yc=n(e=>{let t=Math.max(0,Math.floor(Number(e)||0)),r=Math.floor(t/60),o=String(t%60).padStart(2,"0");return`${r}:${o}`},"formatTimestamp"),wc=n((e,t)=>{let r=new URL(e);return r.searchParams.set("t",`${Math.max(0,Math.floor(Number(t)||0))}s`),r.toString()},"timestampUrl"),Sc=n(({title:e,sourceUrl:t,videoId:r,authorName:o,thumbnailUrl:a,segments:s})=>[`# ${e||`YouTube ${r}`}`,"",`Video ID: ${r}`,o?`Author: ${o}`:"",`Source: [${t}](${t})`,a?`[![${e||r}](${a})](${t})`:"","",s.length>0?"## Transcript":"## Video Source","",...s.length>0?s.map(i=>`[${yc(i.start)}](${wc(t,i.start)}) ${i.text}`):["Captions were not available from the source at import time.","The source URL, title, author, and thumbnail remain available for downstream storyboard reconstruction."],""].filter(i=>i!=="").join(`
`),"buildMarkdown"),Lr=n(({videoId:e,sourceUrl:t,title:r,authorName:o,thumbnailUrl:a,lang:s,languageCode:i,segments:c,captionStatus:l})=>{let p={type:"rag:YouTubeTranscript",video_id:e,source_url:t,title:r,author_name:o,thumbnail_url:a,language_code:Y(i)||s,caption_status:l,segment_count:c.length,duration:c.reduce((m,f)=>Math.max(m,f.start+f.duration),0),segments:c};return{ok:!0,name:`youtube-${e.toLowerCase()}.md`,markdown:Sc({title:r,sourceUrl:t,videoId:e,authorName:o,thumbnailUrl:a,segments:c}),transcript:p}},"buildPayload");async function _c({sourceUrl:e,lang:t="en",fetchImpl:r=fetch}){let o=cc(e);if(!o)return{ok:!1,error:"unsupported_youtube_url"};let a=`https://www.youtube.com/watch?v=${encodeURIComponent(o)}`,[s,i]=await Promise.all([r(`https://www.youtube.com/oembed?url=${encodeURIComponent(a)}&format=json`,{headers:{accept:"application/json"}}).catch(()=>null),r(a,{headers:{accept:"text/html,application/xhtml+xml","accept-language":"en-US,en;q=0.9","user-agent":"Mozilla/5.0 Knowgrph YouTube transcript importer"}})]),c=s?.ok?await s.json().catch(()=>({})):{},l=i.ok?pc(await i.text()):null,p=Y(c.title)||Y(l?.videoDetails?.title)||`YouTube ${o}`,m=Y(c.author_name)||Y(l?.videoDetails?.author),f=Y(c.thumbnail_url)||`https://i.ytimg.com/vi/${o}/hqdefault.jpg`;if(!i.ok)return Lr({videoId:o,sourceUrl:a,title:p,authorName:m,thumbnailUrl:f,lang:t,languageCode:t,segments:[],captionStatus:`watch-fetch-${i.status}`});let P=l?.captions?.playerCaptionsTracklistRenderer?.captionTracks||[],_=uc(Array.isArray(P)?P:[],t);if(!_?.baseUrl)return Lr({videoId:o,sourceUrl:a,title:p,authorName:m,thumbnailUrl:f,lang:t,languageCode:t,segments:[],captionStatus:"captions-unavailable"});let x=await r(dc(_.baseUrl),{headers:{accept:"application/json,text/xml,text/plain,*/*","user-agent":"Mozilla/5.0 Knowgrph YouTube transcript importer"}}).catch(()=>null),j=x?await x.text().catch(()=>""):"",L=x?.ok?fc(j,x.headers.get("content-type")):[],D=L.length>0?"available":x?.ok?"captions-empty":`captions-fetch-${x?.status||"failed"}`;return Lr({videoId:o,sourceUrl:a,title:p,authorName:m,thumbnailUrl:f,lang:t,languageCode:_.languageCode,segments:L,captionStatus:D})}n(_c,"buildYouTubeTranscriptPayload");async function la(e){let t=e.request,r=String(t.method||"GET").toUpperCase();if(r==="OPTIONS")return new Response(null,{status:204,headers:ca});if(r!=="GET"&&r!=="HEAD"&&r!=="POST")return Ft({ok:!1,error:"unsupported_method"},405,r);let o=new URL(t.url),a=Y(o.searchParams.get("url")),s=Y(o.searchParams.get("lang"))||"en";if(!a)return Ft({ok:!1,error:"missing_url"},400,r);try{let i=await _c({sourceUrl:a,lang:s});return Ft(i,i.ok?200:502,r)}catch(i){let c=i&&typeof i=="object"&&"message"in i?Y(i.message):"";return Ft({ok:!1,error:c||"youtube_conversion_failed"},502,r)}}n(la,"onRequest");async function pa(e){let{request:t}=e,r=String(t.method||"GET").toUpperCase();if(r==="OPTIONS")return new Response(null,{status:204,headers:{...ae(t),"access-control-allow-methods":"GET, HEAD, OPTIONS","access-control-allow-headers":"*","access-control-max-age":"86400"}});if(r!=="GET"&&r!=="HEAD")return new Response(JSON.stringify({ok:!1,error:"unsupported_method"}),{status:405,headers:{"content-type":"application/json; charset=utf-8","cache-control":"no-store",...ae(t)}});let o={ok:!0,service:"singabldr-pages",ts:new Date().toISOString()},a={"content-type":"application/json; charset=utf-8","cache-control":"no-store",...ae(t)};return r==="HEAD"?new Response(null,{status:200,headers:a}):new Response(JSON.stringify(o),{status:200,headers:a})}n(pa,"onRequest");var ve="https://airvio.co";var le="/knowgrph",Te=`${ve}${le}/`,bc=`${ve}/`;var da=`${le}/health`,ua=`${ve}${da}`,ma="/.well-known/agent-card.json",Od=`${le}/.well-known/agent-card.json`,Rc=`${ve}${ma}`,Pc=`${ve}/api/storage/source-files`,Ac=`${ve}/api/storage/doc-default/{canonicalPath}`,kc=`${ve}/api/storage/doc/{workspaceId}/{canonicalPath}`,xc=`${ve}/api/storage/blob/{workspaceId}/{canonicalPath}`;var Kr="root-agent-ready-pages",ha=['</.well-known/api-catalog>; rel="api-catalog"; type="application/linkset+json"',`<${le}/.well-known/openapi.json>; rel="service-desc"; type="application/vnd.oai.openapi+json;version=3.1"`,`<${le}/llms.txt>; rel="service-doc"; type="text/plain"`,'</auth.md>; rel="service-doc"; type="text/markdown"',`<${da}>; rel="status"; type="application/health+json"`,`<${le}/.well-known/mcp/server-card.json>; rel="mcp-server-card"; type="application/json"`,`<${ma}>; rel="describedby"; type="application/json"`].join(", "),ga=`# Knowgrph

Knowgrph is an Agent-actionable chat-to-canvas knowledge graph workspace served at ${Te}.

## Discovery

- Crawl policy: ${Te}robots.txt
- Sitemap: ${Te}sitemap.xml
- API catalog: ${Te}.well-known/api-catalog
- Auth.md registration instructions: ${bc}auth.md
- Health: ${ua}
- MCP server card: ${Te}.well-known/mcp/server-card.json
- A2A Agent Card: ${Rc}
- Agent skills: ${Te}.well-known/agent-skills/index.json
- LLM reference: ${Te}llms.txt
...
- HTTP MCP and local stdio expose Source Files resource templates through \`resources/templates/list\`; \`kgdoc://source-file/{id}\` reads reuse the existing \`fetch\` executor.
- Full app runtime additionally exposes browser-local inspect tools for the active workspace document, canvas topology, canvas snapshot, 3d camera pose, 3d layout positions, 2d zoom viewport, and Source Files snapshot.
- Deployed HTML fallback injects the shared seven-tool WebMCP surface on \`${Te}\` HTML routes.
...
`,fa=n(e=>new Response(e,{status:200,headers:{"content-type":"text/markdown; charset=utf-8","cache-control":"public, max-age=3600","access-control-allow-origin":"*",vary:"Accept","x-markdown-tokens":String(Math.ceil(String(e||"").length/4))}}),"markdownResponse"),ya=n(e=>(e.headers.get("accept")||"").toLowerCase().split(",").some(r=>r.trim().startsWith("text/markdown")),"wantsMarkdown"),$r=n((e,t)=>{let r=new Response(e.body,e),o=String(t?.owner||"").trim(),a=String(t?.tag||"").trim();return o&&r.headers.set("x-knowgrph-route-owner",o),a&&r.headers.set("x-knowgrph-route-tag",a),r},"withAgentReadyRouteHeaders");var Hr="Agent-actionable chat-to-canvas knowledge graph workspace",pt='<main id="root"></main>',Ec=/<(?:main|div)\s+id=["']root["']\s*><\/(?:main|div)>/i,Cc=n(e=>{let t=/<script>([\s\S]*?)<\/script>/g;for(let r of String(e||"").matchAll(t)){let o=r[1]||"";if(o.includes("createWebMcpLifecycleController")&&o.includes("toolDefinitions"))return o}return""},"extractWebMcpScript"),wa=n(()=>({"content-type":"text/html; charset=utf-8","cache-control":"no-store, no-cache, no-transform, must-revalidate, max-age=0","access-control-allow-origin":"*",link:ha}),"rootHtmlHeaders"),Dr=n((e,t)=>String(e||"").includes("</head>")?String(e||"").replace("</head>",`${t}</head>`):`${String(e||"")}${t}`,"injectIntoHead"),Sa=n(e=>String(e||"").replace(Ec,pt),"canonicalizeRootMount"),zt=n(()=>`<main id="knowgrph-root-fallback" data-knowgrph-root-fallback="visible" aria-label="Knowgrph root alias" style="position:fixed;inset:0;z-index:2147483000;display:grid;place-content:center;gap:1rem;padding:2rem;box-sizing:border-box;font-family:Inter,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;background:#101820;color:#f4f7fb;text-align:center">
    ...
    <\/script>`,"rootVisibleFallbackMarkup"),Tc=n(e=>{let t=Sa(e);return/<main\s+id=["']knowgrph-root-fallback["']/i.test(t)?t:t.includes(pt)?t.replace(pt,`${pt}
    ${zt()}`):t.includes("</body>")?t.replace("</body>",`    ${zt()}
  </body>`):`${t}
${zt()}`},"injectRootVisibleFallback"),vc=n(e=>{let t=Sa(e);return/<meta\s+name=["']description["'][^>]*>/i.test(t)?t=t.replace(/<meta\s+name=["']description["'][^>]*>/i,`<meta name="description" content="${Hr}" />`):t=Dr(t,`    <meta name="description" content="${Hr}" />
...
</html>`,{status:200,headers:wa()}),"rootHtmlResponse");async function _a(e){let{request:t}=e,r=String(t.method||"GET").toUpperCase();if(r!=="GET"&&r!=="HEAD")return e.next();if(ya(t)){let s=$r(fa(ga),{owner:Kr,tag:"root-homepage-markdown"});return r==="HEAD"?new Response(null,s):s}let o=r==="HEAD"?null:await Ic(t),a=$r(o||Mc(r==="HEAD"?"":await Oc(t)),{owner:Kr,tag:"root-homepage-html"});return r==="HEAD"?new Response(null,a):a}n(_a,"onRequest");var R=[{routePath:"/api/llm/chat/completions",mountPath:"/api/llm/chat",method:"",middlewares:[],modules:[Wr]},{routePath:"/api/payments/commerce/x402",mountPath:"/api/payments/commerce",method:"",middlewares:[],modules:[mo]},{routePath:"/api/llm/models",mountPath:"/api/llm",method:"",middlewares:[],modules:[ho]},{routePath:"/api/llm/responses",mountPath:"/api/llm",method:"",middlewares:[],modules:[go]},{routePath:"/knowgrph/doc-default/:path*",mountPath:"/knowgrph/doc-default",method:"",middlewares:[],modules:[Un]},{routePath:"/knowgrph/doc/:path*",mountPath:"/knowgrph/doc",method:"",middlewares:[],modules:[Ln]},{routePath:"/knowgrph/share/:path*",mountPath:"/knowgrph/share",method:"",middlewares:[],modules:[Kn]},{routePath:"/api/link-preview",mountPath:"/api",method:"GET",middlewares:[],modules:[Dn]},{routePath:"/api/link-proxy",mountPath:"/api",method:"GET",middlewares:[],modules:[jn]},{routePath:"/api/graph",mountPath:"/api",method:"",middlewares:[],modules:[Xn]},{routePath:"/api/oembed",mountPath:"/api",method:"",middlewares:[],modules:[ea]},{routePath:"/__chat_proxy/:path*",mountPath:"/__chat_proxy",method:"",middlewares:[],modules:[ra]},{routePath:"/knowgrph/:path*",mountPath:"/knowgrph",method:"",middlewares:[],modules:[Ne]},{routePath:"/__video_frame",mountPath:"/",method:"",middlewares:[],modules:[ia]},{routePath:"/__youtube_transcript",mountPath:"/",method:"",middlewares:[],modules:[la]},{routePath:"/health",mountPath:"/",method:"",middlewares:[],modules:[pa]},{routePath:"/",mountPath:"/",method:"",middlewares:[],modules:[_a]}];function Nc(e){for(var t=[],r=0;r<e.length;){var o=e[r];if(o==="*"||o==="+"||o==="?"){t.push({type:"MODIFIER",index:r,value:e[r++]});continue}if(o==="\\"){t.push({type:"ESCAPED_CHAR",index:r++,value:e[r++]});continue}if(o==="{"){t.push({type:"OPEN",index:r,value:e[r++]});continue}if(o==="}"){t.push({type:"CLOSE",index:r,value:e[r++]});continue}if(o===":"){for(var a="",s=r+1;s<e.length;){var i=e.charCodeAt(s);if(i>=48&&i<=57||i>=65&&i<=90||i>=97&&i<=122||i===95){a+=e[s++];continue}break}if(!a)throw new TypeError("Missing parameter name at ".concat(r));t.push({type:"NAME",index:r,value:a}),r=s;continue}if(o==="("){var c=1,l="",s=r+1;if(e[s]==="?")throw new TypeError('Pattern cannot start with "?" at '.concat(s));for(;s<e.length;){if(e[s]==="\\"){l+=e[s++]+e[s++];continue}if(e[s]===")"){if(c--,c===0){s++;break}}else if(e[s]==="("&&(c++,e[s+1]!=="?"))throw new TypeError("Capturing groups are not allowed at ".concat(s));l+=e[s++]}if(c)throw new TypeError("Unbalanced pattern at ".concat(r));if(!l)throw new TypeError("Missing pattern at ".concat(r));t.push({type:"PATTERN",index:r,value:l}),r=s;continue}t.push({type:"CHAR",index:r,value:e[r++]})}return t.push({type:"END",index:r,value:""}),t}n(Nc,"lexer");function Uc(e,t){t===void 0&&(t={});for(var r=Nc(e),o=t.prefixes,a=o===void 0?"./":o,s=t.delimiter,i=s===void 0?"/#?":s,c=[],l=0,p=0,m="",f=n(function(I){if(p<r.length&&r[p].type===I)return r[p++].value},"tryConsume"),P=n(function(I){var M=f(I);if(M!==void 0)return M;var B=r[p],oe=B.type,pe=B.index;throw new TypeError("Unexpected ".concat(oe," at ").concat(pe,", expected ").concat(I))},"mustConsume"),_=n(function(){for(var I="",M;M=f("CHAR")||f("ESCAPED_CHAR");)I+=M;return I},"consumeText"),x=n(function(I){for(var M=0,B=i;M<B.length;M++){var oe=B[M];if(I.indexOf(oe)>-1)return!0}return!1},"isSafe"),j=n(function(I){var M=c[c.length-1],B=I||(M&&typeof M=="string"?M:"");if(M&&!B)throw new TypeError('Must have text between two parameters, missing text after "'.concat(M.name,'"'));return!B||x(B)?"[^".concat(Ue(i),"]+?"):"(?:(?!".concat(Ue(B),")[^").concat(Ue(i),"])+?")},"safePattern");p<r.length;){var L=f("CHAR"),D=f("NAME"),re=f("PATTERN");if(D||re){var W=L||"";a.indexOf(W)===-1&&(m+=W,W=""),m&&(c.push(m),m=""),c.push({name:D||l++,prefix:W,suffix:"",pattern:re||j(W),modifier:f("MODIFIER")||""});continue}var T=L||f("ESCAPED_CHAR");if(T){m+=T;continue}m&&(c.push(m),m="");var O=f("OPEN");if(O){var W=_(),J=f("NAME")||"",K=f("PATTERN")||"",X=_();P("CLOSE"),c.push({name:J||(K?l++:""),pattern:J&&!K?j(W):K,prefix:W,suffix:X,modifier:f("MODIFIER")||""});continue}P("END")}return c}n(Uc,"parse");function ut(e,t){var r=[],o=Ra(e,r,t);return Lc(o,r,t)}n(ut,"match");function Lc(e,t,r){r===void 0&&(r={});var o=r.decode,a=o===void 0?function(s){return s}:o;return function(s){var i=e.exec(s);if(!i)return!1;for(var c=i[0],l=i.index,p=Object.create(null),m=n(function(P){if(i[P]===void 0)return"continue";var _=t[P-1];_.modifier==="*"||_.modifier==="+"?p[_.name]=i[P].split(_.prefix+_.suffix).map(function(x){return a(x,_)}):p[_.name]=a(i[P],_)},"_loop_1"),f=1;f<i.length;f++)m(f);return{path:c,index:l,params:p}}}n(Lc,"regexpToFunction");function Ue(e){return e.replace(/([.+*?=^!:${}()[\]|/\\])/g,"\\$1")}n(Ue,"escapeString");function ba(e){return e&&e.sensitive?"":"i"}n(ba,"flags");function Kc(e,t){if(!t)return e;for(var r=/\((?:\?<(.*?)>)?(?!\?)/g,o=0,a=r.exec(e.source);a;)t.push({name:a[1]||o++,prefix:"",suffix:"",modifier:"",pattern:""}),a=r.exec(e.source);return e}n(Kc,"regexpToRegexp");function $c(e,t,r){var o=e.map(function(a){return Ra(a,t,r).source});return new RegExp("(?:".concat(o.join("|"),")"),ba(r))}n($c,"arrayToRegexp");function Dc(e,t,r){return Hc(Uc(e,r),t,r)}n(Dc,"stringToRegexp");function Hc(e,t,r){r===void 0&&(r={});for(var o=r.strict,a=o===void 0?!1:o,s=r.start,i=s===void 0?!0:s,c=r.end,l=c===void 0?!0:c,p=r.encode,m=p===void 0?function(M){return M}:p,f=r.delimiter,P=f===void 0?"/#?":f,_=r.endsWith,x=_===void 0?"":_,j="[".concat(Ue(x),"]|$"),L="[".concat(Ue(P),"]"),D=i?"^":"",re=0,W=e;re<W.length;re++){var T=W[re];if(typeof T=="string")D+=Ue(m(T));else{var O=Ue(m(T.prefix)),J=Ue(m(T.suffix));if(T.pattern)if(t&&t.push(T),O||J)if(T.modifier==="+"||T.modifier==="*"){var K=T.modifier==="*"?"?":"";D+="(?:".concat(O,"((?:").concat(T.pattern,")(?:").concat(J).concat(O,"(?:").concat(T.pattern,"))*)").concat(J,")").concat(K)}else D+="(?:".concat(O,"(").concat(T.pattern,")").concat(J,")").concat(T.modifier);else{if(T.modifier==="+"||T.modifier==="*")throw new TypeError('Can not repeat "'.concat(T.name,'" without a prefix and suffix'));D+="(".concat(T.pattern,")").concat(T.modifier)}else D+="(?:".concat(O).concat(J,")").concat(T.modifier)}}if(l)a||(D+="".concat(L,"?")),D+=r.endsWith?"(?=".concat(j,")"):"$";else{var X=e[e.length-1],I=typeof X=="string"?L.indexOf(X[X.length-1])>-1:X===void 0;a||(D+="(?:".concat(L,"(?=").concat(j,"))?")),I||(D+="(?=".concat(L,"|").concat(j,")"))}return new RegExp(D,ba(r))}n(Hc,"tokensToRegexp");function Ra(e,t,r){return e instanceof RegExp?Kc(e,t):Array.isArray(e)?$c(e,t,r):Dc(e,t,r)}n(Ra,"pathToRegexp");var qt=/[.+?^${}()|[\]\\]/g;function*jc(e){let t=new URL(e.url).pathname;for(let r of[...R].reverse()){if(r.method&&r.method!==e.method)continue;let o=ut(r.routePath.replace(qt,"\\$&"),{end:!1}),a=ut(r.mountPath.replace(qt,"\\$&"),{end:!1}),s=o(t),i=a(t);if(s&&i)for(let c of r.middlewares.flat())yield{handler:c,params:s.params,path:i.path}}for(let r of R){if(r.method&&r.method!==e.method)continue;let o=ut(r.routePath.replace(qt,"\\$&"),{end:!0}),a=ut(r.mountPath.replace(qt,"\\$&"),{end:!1}),s=o(t),i=a(t);if(s&&i&&r.modules.length){for(let c of r.modules.flat())yield{handler:c,params:s.params,path:s.path};break}}}n(jc,"executeRequest");var im={async fetch(e,t,r){let o=e,a=jc(o),s={},i=!1,c=n(async(l,p)=>{if(l!==void 0){let f=l;typeof l=="string"&&(f=new URL(l,o.url).toString()),o=new Request(f,p)}let m=a.next();if(m.done===!1){let{handler:f,params:P,path:_}=m.value,x={request:new Request(o.clone()),functionPath:_,next:c,params:P,get data(){return s},set data(L){if(typeof L!="object"||L===null)throw new Error("context.data must be an object");s=L},env:t,waitUntil:r.waitUntil.bind(r),passThroughOnException:n(()=>{i=!0},"passThroughOnException")},j=await f(x);if(!(j instanceof Response))throw new Error("Your Pages function should return a Response");return jr(j)}else{let f=await t.ASSETS.fetch(o);return jr(f)}},"next");try{return await c()}catch(l){if(i){let p=await t.ASSETS.fetch(o);return jr(p)}throw l}}},jr=n(e=>new Response([101,204,205,304].includes(e.status)?null:e.body,e),"cloneResponse");export{im as default};
