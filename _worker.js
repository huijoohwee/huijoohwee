...
`,pa=n(e=>new Response(e,{status:200,headers:{"content-type":"text/markdown; charset=utf-8","cache-control":"public, max-age=3600","access-control-allow-origin":"*",vary:"Accept","x-markdown-tokens":String(Math.ceil(String(e||"").length/4))}}),"markdownResponse"),ua=n(e=>(e.headers.get("accept")||"").toLowerCase().split(",").some(r=>r.trim().startsWith("text/markdown")),"wantsMarkdown"),Ur=n((e,t)=>{let r=new Response(e.body,e),o=String(t?.owner||"").trim(),a=String(t?.tag||"").trim();return o&&r.headers.set("x-knowgrph-route-owner",o),a&&r.headers.set("x-knowgrph-route-tag",a),r},"withAgentReadyRouteHeaders");var Lr="Agent-actionable chat-to-canvas knowledge graph workspace",lt='<main id="root"></main>',_c=/<(?:main|div)\s+id=["']root["']\s*><\/(?:main|div)>/i,bc=n(e=>{let t=/<script>([\s\S]*?)<\/script>/g;for(let r of String(e||"").matchAll(t)){let o=r[1]||"";if(o.includes("createWebMcpLifecycleController")&&o.includes("toolDefinitions"))return o}return""},"extractWebMcpScript"),da=n(()=>({"content-type":"text/html; charset=utf-8","cache-control":"no-store, no-cache, no-transform, must-revalidate, max-age=0","access-control-allow-origin":"*",link:ca}),"rootHtmlHeaders"),Kr=n((e,t)=>String(e||"").includes("</head>")?String(e||"").replace("</head>",`${t}</head>`):`${String(e||"")}${t}`,"injectIntoHead"),ma=n(e=>String(e||"").replace(_c,lt),"canonicalizeRootMount"),Wt=n(()=>`<main id="knowgrph-root-fallback" data-knowgrph-root-fallback="visible" aria-label="Knowgrph root alias" style="position:fixed;inset:0;z-index:2147483000;display:grid;place-content:center;gap:1rem;padding:2rem;box-sizing:border-box;font-family:Inter,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;background:#101820;color:#f4f7fb;text-align:center">
    ...
    <\/script>`,"rootVisibleFallbackMarkup"),Rc=n(e=>{let t=ma(e);return/<main\s+id=["']knowgrph-root-fallback["']/i.test(t)?t:t.includes(lt)?t.replace(lt,`${lt}
    ${Wt()}`):t.includes("</body>")?t.replace("</body>",`    ${Wt()}
  </body>`):`${t}
${Wt()}`},"injectRootVisibleFallback"),Pc=n(e=>{let t=ma(e);return/<meta\s+name=["']description["'][^>]*>/i.test(t)?t=t.replace(/<meta\s+name=["']description["'][^>]*>/i,`<meta name="description" content="${Lr}" />`):t=Kr(t,`    <meta name="description" content="${Lr}" />
...
</html>`,{status:200,headers:da()}),"rootHtmlResponse");async function ha(e){let{request:t}=e,r=String(t.method||"GET").toUpperCase();if(r!=="GET"&&r!=="HEAD")return e.next();if(ua(t)){let s=Ur(pa(la),{owner:Nr,tag:"root-homepage-markdown"});return r==="HEAD"?new Response(null,s):s}let o=r==="HEAD"?null:await kc(t),a=Ur(o||xc(r==="HEAD"?"":await Ac(t)),{owner:Nr,tag:"root-homepage-html"});return r==="HEAD"?new Response(null,a):a}n(ha,"onRequest");var A=[{routePath:"/api/llm/chat/completions",mountPath:"/api/llm/chat",method:"",middlewares:[],modules:[jr]},{routePath:"/api/payments/commerce/x402",mountPath:"/api/payments/commerce",method:"",middlewares:[],modules:[lo]},{routePath:"/api/llm/models",mountPath:"/api/llm",method:"",middlewares:[],modules:[po]},{routePath:"/api/llm/responses",mountPath:"/api/llm",method:"",middlewares:[],modules:[uo]},{routePath:"/knowgrph/doc-default/:path*",mountPath:"/knowgrph/doc-default",method:"",middlewares:[],modules:[Tn]},{routePath:"/knowgrph/doc/:path*",mountPath:"/knowgrph/doc",method:"",middlewares:[],modules:[vn]},{routePath:"/knowgrph/share/:path*",mountPath:"/knowgrph/share",method:"",middlewares:[],modules:[On]},{routePath:"/api/link-preview",mountPath:"/api",method:"GET",middlewares:[],modules:[Mn]},{routePath:"/api/link-proxy",mountPath:"/api",method:"GET",middlewares:[],modules:[Un]},{routePath:"/api/graph",mountPath:"/api",method:"",middlewares:[],modules:[Fn]},{routePath:"/api/oembed",mountPath:"/api",method:"",middlewares:[],modules:[Vn]},{routePath:"/__chat_proxy/:path*",mountPath:"/__chat_proxy",method:"",middlewares:[],modules:[Jn]},{routePath:"/knowgrph/:path*",mountPath:"/knowgrph",method:"",middlewares:[],modules:[Ne]},{routePath:"/__video_frame",mountPath:"/",method:"",middlewares:[],modules:[ta]},{routePath:"/__youtube_transcript",mountPath:"/",method:"",middlewares:[],modules:[oa]},{routePath:"/health",mountPath:"/",method:"",middlewares:[],modules:[na]},{routePath:"/",mountPath:"/",method:"",middlewares:[],modules:[ha]}];function Ec(e){for(var t=[],r=0;r<e.length;){var o=e[r];if(o==="*"||o==="+"||o==="?"){t.push({type:"MODIFIER",index:r,value:e[r++]});continue}if(o==="\\"){t.push({type:"ESCAPED_CHAR",index:r++,value:e[r++]});continue}if(o==="{"){t.push({type:"OPEN",index:r,value:e[r++]});continue}if(o==="}"){t.push({type:"CLOSE",index:r,value:e[r++]});continue}if(o===":"){for(var a="",s=r+1;s<e.length;){var i=e.charCodeAt(s);if(i>=48&&i<=57||i>=65&&i<=90||i>=97&&i<=122||i===95){a+=e[s++];continue}break}if(!a)throw new TypeError("Missing parameter name at ".concat(r));t.push({type:"NAME",index:r,value:a}),r=s;continue}if(o==="("){var c=1,l="",s=r+1;if(e[s]==="?")throw new TypeError('Pattern cannot start with "?" at '.concat(s));for(;s<e.length;){if(e[s]==="\\"){l+=e[s++]+e[s++];continue}if(e[s]===")"){if(c--,c===0){s++;break}}else if(e[s]==="("&&(c++,e[s+1]!=="?"))throw new TypeError("Capturing groups are not allowed at ".concat(s));l+=e[s++]}if(c)throw new TypeError("Unbalanced pattern at ".concat(r));if(!l)throw new TypeError("Missing pattern at ".concat(r));t.push({type:"PATTERN",index:r,value:l}),r=s;continue}t.push({type:"CHAR",index:r,value:e[r++]})}return t.push({type:"END",index:r,value:""}),t}n(Ec,"lexer");function Cc(e,t){t===void 0&&(t={});for(var r=Ec(e),o=t.prefixes,a=o===void 0?"./":o,s=t.delimiter,i=s===void 0?"/#?":s,c=[],l=0,p=0,m="",f=n(function(M){if(p<r.length&&r[p].type===M)return r[p++].value},"tryConsume"),R=n(function(M){var N=f(M);if(N!==void 0)return N;var B=r[p],oe=B.type,pe=B.index;throw new TypeError("Unexpected ".concat(oe," at ").concat(pe,", expected ").concat(M))},"mustConsume"),_=n(function(){for(var M="",N;N=f("CHAR")||f("ESCAPED_CHAR");)M+=N;return M},"consumeText"),k=n(function(M){for(var N=0,B=i;N<B.length;N++){var oe=B[N];if(M.indexOf(oe)>-1)return!0}return!1},"isSafe"),j=n(function(M){var N=c[c.length-1],B=M||(N&&typeof N=="string"?N:"");if(N&&!B)throw new TypeError('Must have text between two parameters, missing text after "'.concat(N.name,'"'));return!B||k(B)?"[^".concat(Ue(i),"]+?"):"(?:(?!".concat(Ue(B),")[^").concat(Ue(i),"])+?")},"safePattern");p<r.length;){var K=f("CHAR"),D=f("NAME"),re=f("PATTERN");if(D||re){var W=K||"";a.indexOf(W)===-1&&(m+=W,W=""),m&&(c.push(m),m=""),c.push({name:D||l++,prefix:W,suffix:"",pattern:re||j(W),modifier:f("MODIFIER")||""});continue}var v=K||f("ESCAPED_CHAR");if(v){m+=v;continue}m&&(c.push(m),m="");var I=f("OPEN");if(I){var W=_(),J=f("NAME")||"",L=f("PATTERN")||"",X=_();R("CLOSE"),c.push({name:J||(L?l++:""),pattern:J&&!L?j(W):L,prefix:W,suffix:X,modifier:f("MODIFIER")||""});continue}R("END")}return c}n(Cc,"parse");function pt(e,t){var r=[],o=fa(e,r,t);return Tc(o,r,t)}n(pt,"match");function Tc(e,t,r){r===void 0&&(r={});var o=r.decode,a=o===void 0?function(s){return s}:o;return function(s){var i=e.exec(s);if(!i)return!1;for(var c=i[0],l=i.index,p=Object.create(null),m=n(function(R){if(i[R]===void 0)return"continue";var _=t[R-1];_.modifier==="*"||_.modifier==="+"?p[_.name]=i[R].split(_.prefix+_.suffix).map(function(k){return a(k,_)}):p[_.name]=a(i[R],_)},"_loop_1"),f=1;f<i.length;f++)m(f);return{path:c,index:l,params:p}}}n(Tc,"regexpToFunction");function Ue(e){return e.replace(/([.+*?=^!:${}()[\]|/\\])/g,"\\$1")}n(Ue,"escapeString");function ga(e){return e&&e.sensitive?"":"i"}n(ga,"flags");function vc(e,t){if(!t)return e;for(var r=/\((?:\?<(.*?)>)?(?!\?)/g,o=0,a=r.exec(e.source);a;)t.push({name:a[1]||o++,prefix:"",suffix:"",modifier:"",pattern:""}),a=r.exec(e.source);return e}n(vc,"regexpToRegexp");function Oc(e,t,r){var o=e.map(function(a){return fa(a,t,r).source});return new RegExp("(?:".concat(o.join("|"),")"),ga(r))}n(Oc,"arrayToRegexp");function Ic(e,t,r){return Mc(Cc(e,r),t,r)}n(Ic,"stringToRegexp");function Mc(e,t,r){r===void 0&&(r={});for(var o=r.strict,a=o===void 0?!1:o,s=r.start,i=s===void 0?!0:s,c=r.end,l=c===void 0?!0:c,p=r.encode,m=p===void 0?function(N){return N}:p,f=r.delimiter,R=f===void 0?"/#?":f,_=r.endsWith,k=_===void 0?"":_,j="[".concat(Ue(k),"]|$"),K="[".concat(Ue(R),"]"),D=i?"^":"",re=0,W=e;re<W.length;re++){var v=W[re];if(typeof v=="string")D+=Ue(m(v));else{var I=Ue(m(v.prefix)),J=Ue(m(v.suffix));if(v.pattern)if(t&&t.push(v),I||J)if(v.modifier==="+"||v.modifier==="*"){var L=v.modifier==="*"?"?":"";D+="(?:".concat(I,"((?:").concat(v.pattern,")(?:").concat(J).concat(I,"(?:").concat(v.pattern,"))*)").concat(J,")").concat(L)}else D+="(?:".concat(I,"(").concat(v.pattern,")").concat(J,")").concat(v.modifier);else{if(v.modifier==="+"||v.modifier==="*")throw new TypeError('Can not repeat "'.concat(v.name,'" without a prefix and suffix'));D+="(".concat(v.pattern,")").concat(v.modifier)}else D+="(?:".concat(I).concat(J,")").concat(v.modifier)}}if(l)a||(D+="".concat(K,"?")),D+=r.endsWith?"(?=".concat(j,")"):"$";else{var X=e[e.length-1],M=typeof X=="string"?K.indexOf(X[X.length-1])>-1:X===void 0;a||(D+="(?:".concat(K,"(?=").concat(j,"))?")),M||(D+="(?=".concat(K,"|").concat(j,")"))}return new RegExp(D,ga(r))}n(Mc,"tokensToRegexp");function fa(e,t,r){return e instanceof RegExp?vc(e,t):Array.isArray(e)?Oc(e,t,r):Ic(e,t,r)}n(fa,"pathToRegexp");var Ft=/[.+?^${}()|[\]\\]/g;function*Nc(e){let t=new URL(e.url).pathname;for(let r of[...A].reverse()){if(r.method&&r.method!==e.method)continue;let o=pt(r.routePath.replace(Ft,"\\$&"),{end:!1}),a=pt(r.mountPath.replace(Ft,"\\$&"),{end:!1}),s=o(t),i=a(t);if(s&&i)for(let c of r.middlewares.flat())yield{handler:c,params:s.params,path:i.path}}for(let r of A){if(r.method&&r.method!==e.method)continue;let o=pt(r.routePath.replace(Ft,"\\$&"),{end:!0}),a=pt(r.mountPath.replace(Ft,"\\$&"),{end:!1}),s=o(t),i=a(t);if(s&&i&&r.modules.length){for(let c of r.modules.flat())yield{handler:c,params:s.params,path:s.path};break}}}n(Nc,"executeRequest");var Nd={async fetch(e,t,r){let o=e,a=Nc(o),s={},i=!1,c=n(async(l,p)=>{if(l!==void 0){let f=l;typeof l=="string"&&(f=new URL(l,o.url).toString()),o=new Request(f,p)}let m=a.next();if(m.done===!1){let{handler:f,params:R,path:_}=m.value,k={request:new Request(o.clone()),functionPath:_,next:c,params:R,get data(){return s},set data(K){if(typeof K!="object"||K===null)throw new Error("context.data must be an object");s=K},env:t,waitUntil:r.waitUntil.bind(r),passThroughOnException:n(()=>{i=!0},"passThroughOnException")},j=await f(k);if(!(j instanceof Response))throw new Error("Your Pages function should return a Response");return $r(j)}else{let f=await t.ASSETS.fetch(o);return $r(f)}},"next");try{return await c()}catch(l){if(i){let p=await t.ASSETS.fetch(o);return $r(p)}throw l}}},$r=n(e=>new Response([101,204,205,304].includes(e.status)?null:e.body,e),"cloneResponse");export{Nd as default};
