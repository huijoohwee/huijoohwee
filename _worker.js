...
</html>`,{status:200,headers:ds()}),"rootHtmlResponse");async function hs(e){let{request:t}=e,r=String(t.method||"GET").toUpperCase();if(r!=="GET"&&r!=="HEAD")return e.next();if(us(t)){let a=Ur(ps(ls),{owner:Nr,tag:"root-homepage-markdown"});return r==="HEAD"?new Response(null,a):a}let o=r==="HEAD"?null:await kc(t),s=Ur(o||xc(r==="HEAD"?"":await Ac(t)),{owner:Nr,tag:"root-homepage-html"});return r==="HEAD"?new Response(null,s):s}n(hs,"onRequest");var A=[{routePath:"/api/llm/chat/completions",mountPath:"/api/llm/chat",method:"",middlewares:[],modules:[jr]},{routePath:"/api/payments/commerce/x402",mountPath:"/api/payments/commerce",method:"",middlewares:[],modules:[lo]},{routePath:"/api/llm/models",mountPath:"/api/llm",method:"",middlewares:[],modules:[po]},{routePath:"/api/llm/responses",mountPath:"/api/llm",method:"",middlewares:[],modules:[uo]},{routePath:"/knowgrph/doc-default/:path*",mountPath:"/knowgrph/doc-default",method:"",middlewares:[],modules:[Tn]},{routePath:"/knowgrph/doc/:path*",mountPath:"/knowgrph/doc",method:"",middlewares:[],modules:[On]},{routePath:"/knowgrph/share/:path*",mountPath:"/knowgrph/share",method:"",middlewares:[],modules:[vn]},{routePath:"/api/link-preview",mountPath:"/api",method:"GET",middlewares:[],modules:[Mn]},{routePath:"/api/link-proxy",mountPath:"/api",method:"GET",middlewares:[],modules:[Un]},{routePath:"/api/graph",mountPath:"/api",method:"",middlewares:[],modules:[Fn]},{routePath:"/api/oembed",mountPath:"/api",method:"",middlewares:[],modules:[Vn]},{routePath:"/__chat_proxy/:path*",mountPath:"/__chat_proxy",method:"",middlewares:[],modules:[Jn]},{routePath:"/knowgrph/:path*",mountPath:"/knowgrph",method:"",middlewares:[],modules:[Ne]},{routePath:"/__video_frame",mountPath:"/",method:"",middlewares:[],modules:[ts]},{routePath:"/__youtube_transcript",mountPath:"/",method:"",middlewares:[],modules:[os]},{routePath:"/health",mountPath:"/",method:"",middlewares:[],modules:[ns]},{routePath:"/",mountPath:"/",method:"",middlewares:[],modules:[hs]}];function Ec(e){for(var t=[],r=0;r<e.length;){var o=e[r];if(o==="*"||o==="+"||o==="?"){t.push({type:"MODIFIER",index:r,value:e[r++]});continue}if(o==="\\"){t.push({type:"ESCAPED_CHAR",index:r++,value:e[r++]});continue}if(o==="{"){t.push({type:"OPEN",index:r,value:e[r++]});continue}if(o==="}"){t.push({type:"CLOSE",index:r,value:e[r++]});continue}if(o===":"){for(var s="",a=r+1;a<e.length;){var i=e.charCodeAt(a);if(i>=48&&i<=57||i>=65&&i<=90||i>=97&&i<=122||i===95){s+=e[a++];continue}break}if(!s)throw new TypeError("Missing parameter name at ".concat(r));t.push({type:"NAME",index:r,value:s}),r=a;continue}if(o==="("){var c=1,l="",a=r+1;if(e[a]==="?")throw new TypeError('Pattern cannot start with "?" at '.concat(a));for(;a<e.length;){if(e[a]==="\\"){l+=e[a++]+e[a++];continue}if(e[a]===")"){if(c--,c===0){a++;break}}else if(e[a]==="("&&(c++,e[a+1]!=="?"))throw new TypeError("Capturing groups are not allowed at ".concat(a));l+=e[a++]}if(c)throw new TypeError("Unbalanced pattern at ".concat(r));if(!l)throw new TypeError("Missing pattern at ".concat(r));t.push({type:"PATTERN",index:r,value:l}),r=a;continue}t.push({type:"CHAR",index:r,value:e[r++]})}return t.push({type:"END",index:r,value:""}),t}n(Ec,"lexer");function Cc(e,t){t===void 0&&(t={});for(var r=Ec(e),o=t.prefixes,s=o===void 0?"./":o,a=t.delimiter,i=a===void 0?"/#?":a,c=[],l=0,p=0,m="",f=n(function(I){if(p<r.length&&r[p].type===I)return r[p++].value},"tryConsume"),R=n(function(I){var M=f(I);if(M!==void 0)return M;var B=r[p],oe=B.type,pe=B.index;throw new TypeError("Unexpected ".concat(oe," at ").concat(pe,", expected ").concat(I))},"mustConsume"),_=n(function(){for(var I="",M;M=f("CHAR")||f("ESCAPED_CHAR");)I+=M;return I},"consumeText"),k=n(function(I){for(var M=0,B=i;M<B.length;M++){var oe=B[M];if(I.indexOf(oe)>-1)return!0}return!1},"isSafe"),j=n(function(I){var M=c[c.length-1],B=I||(M&&typeof M=="string"?M:"");if(M&&!B)throw new TypeError('Must have text between two parameters, missing text after "'.concat(M.name,'"'));return!B||k(B)?"[^".concat(Ue(i),"]+?"):"(?:(?!".concat(Ue(B),")[^").concat(Ue(i),"])+?")},"safePattern");p<r.length;){var K=f("CHAR"),D=f("NAME"),re=f("PATTERN");if(D||re){var W=K||"";s.indexOf(W)===-1&&(m+=W,W=""),m&&(c.push(m),m=""),c.push({name:D||l++,prefix:W,suffix:"",pattern:re||j(W),modifier:f("MODIFIER")||""});continue}var T=K||f("ESCAPED_CHAR");if(T){m+=T;continue}m&&(c.push(m),m="");var v=f("OPEN");if(v){var W=_(),J=f("NAME")||"",L=f("PATTERN")||"",X=_();R("CLOSE"),c.push({name:J||(L?l++:""),pattern:J&&!L?j(W):L,prefix:W,suffix:X,modifier:f("MODIFIER")||""});continue}R("END")}return c}n(Cc,"parse");function pt(e,t){var r=[],o=fs(e,r,t);return Tc(o,r,t)}n(pt,"match");function Tc(e,t,r){r===void 0&&(r={});var o=r.decode,s=o===void 0?function(a){return a}:o;return function(a){var i=e.exec(a);if(!i)return!1;for(var c=i[0],l=i.index,p=Object.create(null),m=n(function(R){if(i[R]===void 0)return"continue";var _=t[R-1];_.modifier==="*"||_.modifier==="+"?p[_.name]=i[R].split(_.prefix+_.suffix).map(function(k){return s(k,_)}):p[_.name]=s(i[R],_)},"_loop_1"),f=1;f<i.length;f++)m(f);return{path:c,index:l,params:p}}}n(Tc,"regexpToFunction");function Ue(e){return e.replace(/([.+*?=^!:${}()[\]|/\\])/g,"\\$1")}n(Ue,"escapeString");function gs(e){return e&&e.sensitive?"":"i"}n(gs,"flags");function Oc(e,t){if(!t)return e;for(var r=/\((?:\?<(.*?)>)?(?!\?)/g,o=0,s=r.exec(e.source);s;)t.push({name:s[1]||o++,prefix:"",suffix:"",modifier:"",pattern:""}),s=r.exec(e.source);return e}n(Oc,"regexpToRegexp");function vc(e,t,r){var o=e.map(function(s){return fs(s,t,r).source});return new RegExp("(?:".concat(o.join("|"),")"),gs(r))}n(vc,"arrayToRegexp");function Ic(e,t,r){return Mc(Cc(e,r),t,r)}n(Ic,"stringToRegexp");function Mc(e,t,r){r===void 0&&(r={});for(var o=r.strict,s=o===void 0?!1:o,a=r.start,i=a===void 0?!0:a,c=r.end,l=c===void 0?!0:c,p=r.encode,m=p===void 0?function(M){return M}:p,f=r.delimiter,R=f===void 0?"/#?":f,_=r.endsWith,k=_===void 0?"":_,j="[".concat(Ue(k),"]|$"),K="[".concat(Ue(R),"]"),D=i?"^":"",re=0,W=e;re<W.length;re++){var T=W[re];if(typeof T=="string")D+=Ue(m(T));else{var v=Ue(m(T.prefix)),J=Ue(m(T.suffix));if(T.pattern)if(t&&t.push(T),v||J)if(T.modifier==="+"||T.modifier==="*"){var L=T.modifier==="*"?"?":"";D+="(?:".concat(v,"((?:").concat(T.pattern,")(?:").concat(J).concat(v,"(?:").concat(T.pattern,"))*)").concat(J,")").concat(L)}else D+="(?:".concat(v,"(").concat(T.pattern,")").concat(J,")").concat(T.modifier);else{if(T.modifier==="+"||T.modifier==="*")throw new TypeError('Can not repeat "'.concat(T.name,'" without a prefix and suffix'));D+="(".concat(T.pattern,")").concat(T.modifier)}else D+="(?:".concat(v).concat(J,")").concat(T.modifier)}}if(l)s||(D+="".concat(K,"?")),D+=r.endsWith?"(?=".concat(j,")"):"$";else{var X=e[e.length-1],I=typeof X=="string"?K.indexOf(X[X.length-1])>-1:X===void 0;s||(D+="(?:".concat(K,"(?=").concat(j,"))?")),I||(D+="(?=".concat(K,"|").concat(j,")"))}return new RegExp(D,gs(r))}n(Mc,"tokensToRegexp");function fs(e,t,r){return e instanceof RegExp?Oc(e,t):Array.isArray(e)?vc(e,t,r):Ic(e,t,r)}n(fs,"pathToRegexp");var Ft=/[.+?^${}()|[\]\\]/g;function*Nc(e){let t=new URL(e.url).pathname;for(let r of[...A].reverse()){if(r.method&&r.method!==e.method)continue;let o=pt(r.routePath.replace(Ft,"\\$&"),{end:!1}),s=pt(r.mountPath.replace(Ft,"\\$&"),{end:!1}),a=o(t),i=s(t);if(a&&i)for(let c of r.middlewares.flat())yield{handler:c,params:a.params,path:i.path}}for(let r of A){if(r.method&&r.method!==e.method)continue;let o=pt(r.routePath.replace(Ft,"\\$&"),{end:!0}),s=pt(r.mountPath.replace(Ft,"\\$&"),{end:!1}),a=o(t),i=s(t);if(a&&i&&r.modules.length){for(let c of r.modules.flat())yield{handler:c,params:a.params,path:a.path};break}}}n(Nc,"executeRequest");var Nd={async fetch(e,t,r){let o=e,s=Nc(o),a={},i=!1,c=n(async(l,p)=>{if(l!==void 0){let f=l;typeof l=="string"&&(f=new URL(l,o.url).toString()),o=new Request(f,p)}let m=s.next();if(m.done===!1){let{handler:f,params:R,path:_}=m.value,k={request:new Request(o.clone()),functionPath:_,next:c,params:R,get data(){return a},set data(K){if(typeof K!="object"||K===null)throw new Error("context.data must be an object");a=K},env:t,waitUntil:r.waitUntil.bind(r),passThroughOnException:n(()=>{i=!0},"passThroughOnException")},j=await f(k);if(!(j instanceof Response))throw new Error("Your Pages function should return a Response");return $r(j)}else{let f=await t.ASSETS.fetch(o);return $r(f)}},"next");try{return await c()}catch(l){if(i){let p=await t.ASSETS.fetch(o);return $r(p)}throw l}}},$r=n(e=>new Response([101,204,205,304].includes(e.status)?null:e.body,e),"cloneResponse");export{Nd as default};
