var ka=Object.defineProperty;var n=(e,t)=>ka(e,"name",{value:t,configurable:!0});var xa="https://api.openai.com/v1";var Xt=Object.freeze(["gpt-5.4-nano","gpt-4o-mini"]);function Qt(e){return String(e||"").trim()}n(Qt,"normalizeOrigin");function Ea(e){let t=Qt(e);return t?t.startsWith("http://localhost:")||t.startsWith("http://127.0.0.1:")||t.startsWith("http://0.0.0.0:"):!1}n(Ea,"isAllowedOrigin");function Wr(e){let t=Qt(e);return Ea(t)?{"access-control-allow-origin":t,vary:"Origin","access-control-allow-methods":"GET, POST, OPTIONS","access-control-allow-headers":"content-type, x-flowinfish-session","access-control-max-age":"86400"}:{}}n(Wr,"corsHeaders");function we(e,{status:t=200,origin:r=""}={}){return new Response(JSON.stringify(e),{status:t,headers:{"content-type":"application/json; charset=utf-8","cache-control":"no-store",...Wr(r)}})}n(we,"json");async function wt(e,{maxBytes:t=1e6}={}){let r=await e.arrayBuffer();if(r.byteLength>t)throw new Error("Request too large");let o=new TextDecoder().decode(r);try{return o?JSON.parse(o):{}}catch{throw new Error("Invalid JSON body")}}n(wt,"readJsonBody");function Ca(e){let t=String(e?.model||"").trim();if(!t)throw new Error("Missing model");if(!Xt.includes(t))throw new Error(`Model not allowed: ${t}`);return t}n(Ca,"enforceAllowedModel");function Ta(e){let t=String(e.OPENAI_API_KEY||"").trim();if(!t)throw new Error("Missing server OPENAI_API_KEY");return t}n(Ta,"requireOpenAiKey");async function St({request:e,env:t,pathname:r,payload:o}){let a=Ta(t);Ca(o);let i=`${Qt(t.OPENAI_API_BASE)||xa}${r}`,c=await fetch(i,{method:"POST",headers:{authorization:`Bearer ${a}`,"content-type":"application/json"},body:JSON.stringify(o)}),l=new Headers(c.headers);return l.delete("content-length"),l.set("cache-control","no-store"),new Response(c.body,{status:c.status,headers:l})}n(St,"proxyToOpenAi");function We(e){let t=e.headers.get("origin")||"";return new Response(null,{status:204,headers:{...Wr(t)}})}n(We,"handleOptions");async function Fr(e){let{request:t,env:r}=e,o=String(t.method||"GET").toUpperCase(),a=t.headers.get("origin")||"";if(o==="OPTIONS")return We(t);if(o!=="POST")return we({ok:!1,error:"Method not allowed"},{status:405,origin:a});try{if(!String(t.headers.get("content-type")||"").toLowerCase().includes("application/json"))return we({ok:!1,error:"Expected application/json"},{status:415,origin:a});let i=await wt(t);return await St({request:t,env:r,pathname:"/chat/completions",payload:i})}catch(s){let i=s instanceof Error?s.message:String(s||"Unknown error");return we({ok:!1,error:i},{status:400,origin:a})}}n(Fr,"onRequest");var _t={checkoutSession:"/api/payments/stripe/checkout/session",webhook:"/api/payments/stripe/webhook"};var me={restrictedKey:"STRIPE_RESTRICTED_KEY",secretKey:"STRIPE_SECRET_KEY",webhookSecret:"STRIPE_WEBHOOK_SECRET",checkoutPriceId:"STRIPE_CHECKOUT_PRICE_ID",checkoutCurrency:"STRIPE_CHECKOUT_CURRENCY",checkoutUnitAmount:"STRIPE_CHECKOUT_UNIT_AMOUNT",checkoutProductName:"STRIPE_CHECKOUT_PRODUCT_NAME",checkoutMode:"STRIPE_CHECKOUT_MODE",checkoutReturnOrigin:"STRIPE_CHECKOUT_RETURN_ORIGIN"},Xc=[me.restrictedKey,me.secretKey,me.webhookSecret];var Qe={configure:"npm run payment:stripe:configure",d1MigrateRemote:"npm run payment:d1:migrate:remote",readiness:"npm run payment:stripe:readiness",x402Configure:"npm run payment:x402:configure",x402Readiness:"npm run payment:x402:readiness",paymentReadiness:"npm run payment:readiness",applyConfirmation:"apply-stripe-payment-worker-config",writeVisibleVarsFlag:"--write-visible-vars",deployVisibleVarsFlag:"--deploy-visible-vars"};var Qc=[`Configure Stripe secrets on the server runtime that owns ${_t.checkoutSession}.`,"Cloudflare Pages project variables are available to Pages builds/functions, but they are not read by separate Worker routes.","Stripe Projects can provision and sync credentials locally; copy only required server secret names into the payment server runtime."].join(" "),Zc=[`Payment server runtime for ${_t.checkoutSession}`,"not Cloudflare Pages project variables"].join("; "),va=[me.restrictedKey,me.secretKey].join(" or "),el=[me.checkoutPriceId,`${me.checkoutCurrency} + ${me.checkoutUnitAmount} + ${me.checkoutProductName}`].join(" or "),tl=[`${me.checkoutMode}=payment`,`${me.checkoutMode}=subscription with ${me.checkoutPriceId}`].join(" or "),rl=["Worker secret names","visible Worker [vars]","remote D1 payment tables","required webhook-processing columns/constraints","bounded optional hosted Checkout create-and-expire smoke"].join(" + "),ol=[Qe.configure,`write visible Worker [vars] with ${Qe.writeVisibleVarsFlag}`,`deploy visible Worker [vars] with ${Qe.deployVisibleVarsFlag}`,`apply with -- --apply --yes --confirm=${Qe.applyConfirmation}`,Qe.readiness].join(" -> "),nl=[`Missing server-managed Stripe key. Set ${va} on the payment server runtime.`,"Pages project variables alone do not satisfy separate Worker routes."].join(" ");var Oa=n(e=>{let t=2166136261;for(let r=0;r<e.length;r+=1)t^=e.charCodeAt(r),t=Math.imul(t,16777619);return t>>>0},"fnv1a32");function zr(e){return Oa(String(e??""))}n(zr,"hashString32");function Ze(e){return zr(e).toString(16).padStart(8,"0")}n(Ze,"hashStringToHex");var Ia=n(e=>e==null?"":typeof e=="boolean"?e?"1":"0":typeof e=="number"?Number.isFinite(e)?String(e):"":String(e),"normalizePrimitive"),Ma=n(e=>e.map(Ia).join("|"),"buildSignatureText"),bt=n(e=>Ze(Ma(e)),"hashSignatureParts");var Pe=n((e,t)=>bt(["agentic-commerce",e,...t]),"buildAgenticCommerceSemanticKey");var qr="solana_pay",Vr="/api/payments/commerce/solana-pay/settle";var Ie={recipient:"SOLANA_PAY_RECIPIENT",splToken:"SOLANA_PAY_SPL_TOKEN",label:"SOLANA_PAY_LABEL",rpcUrl:"SOLANA_PAY_RPC_URL",amountScale:"SOLANA_PAY_AMOUNT_SCALE",network:"SOLANA_PAY_NETWORK",commitment:"SOLANA_PAY_COMMITMENT"};var et="2026-01-30",Jr="1000",Xr="USDC",Zt="https://x402.org/facilitator",Qr="eip155:84532",Na="$0.001",Zr="x402-payment-required",Ua="0x0000000000000000000000000000000000000000",Fe="2026-04-08",Yr="https://ucp.dev/2026-04-08/specification/overview/",La=["checkout"],Ka=["rest"];var v={acpDiscovery:"/.well-known/acp.json",acpConfig:"/.well-known/acp-config",ucpProfile:"/.well-known/ucp",mppOpenApi:"/openapi.json",x402ApiRoot:"/api",x402ApiV1:"/api/v1",checkoutSessions:"/checkout/sessions",x402PaymentRequired:"/api/payments/commerce/x402",commerceWebhook:"/api/payments/commerce/webhook",commerceProofArtifact:"/api/payments/commerce/harness-proof.json",commerceTraceArtifact:"/api/payments/commerce/trace.jsonl",openboxIngest:"/api/payments/commerce/openbox/ingest",web3Settle:"/api/payments/commerce/web3/settle",solanaPaySettle:Vr},xl=[v.x402ApiRoot,v.x402ApiV1,v.x402PaymentRequired],G={sellerId:"SELLER_ID",checkoutBaseUrl:"CHECKOUT_BASE_URL",web3Enabled:"WEB3_ENABLED",web3DepositAddress:"WEB3_DEPOSIT_ADDRESS",baseRpcUrl:"BASE_RPC_URL",baseConfirmationBlocks:"BASE_CONFIRMATION_BLOCKS",easAttestUrl:"EAS_ATTEST_URL",openboxApiUrl:"OPENBOX_API_URL",openboxIngestUrl:"OPENBOX_INGEST_URL",openboxApiKey:"OPENBOX_API_KEY",stripeDelegatePaymentUrl:"STRIPE_DELEGATE_PAYMENT_URL",acpBearerToken:"ACP_BEARER_TOKEN",x402PayToAddress:"X402_PAY_TO_ADDRESS",x402Network:"X402_NETWORK",x402Asset:"X402_ASSET",x402Amount:"X402_AMOUNT",x402FacilitatorUrl:"X402_FACILITATOR_URL",x402Price:"X402_PRICE"},El=[G.sellerId,G.checkoutBaseUrl,G.web3Enabled,G.web3DepositAddress,G.baseRpcUrl,G.baseConfirmationBlocks,G.easAttestUrl,G.openboxApiUrl,G.openboxIngestUrl,G.stripeDelegatePaymentUrl,G.x402Network,G.x402Asset,G.x402Amount,G.x402FacilitatorUrl,G.x402Price,Ie.recipient,Ie.rpcUrl],Cl=[Ie.splToken,Ie.label,Ie.amountScale,Ie.network,Ie.commitment],Tl=[G.acpBearerToken,G.openboxApiKey],vl=["Visible Worker [vars] for ACP, Web3, x402, OpenBOX, and Solana Pay.","Worker secrets for ACP bearer auth and OpenBOX API access."].join(" "),Me=n((e,t)=>String(e[t]||"").trim(),"readEnvString"),eo=n((e,t)=>{let r=Me(e,G.sellerId);if(r)return r;try{return new URL(t).host}catch{return"knowgrph-seller"}},"readAgenticCommerceSellerId");var to=n(e=>{let t=Me(e,G.web3Enabled).toLowerCase();return t?t==="0"||t==="false"||t==="no"?!1:t==="1"||t==="true"||t==="yes":!0},"isAgenticCommerceWeb3Enabled");var tt=n(e=>String(e||"").trim().replace(/\/+$/g,""),"normalizeAgenticCommerceBaseUrl"),ce=n((e,t)=>`${tt(e)}${t}`,"buildAgenticCommerceUrl"),oe=n((e,t,r,o,a=o.startsWith("/")?o:null)=>({id:t,label:r,value:o,path:a,semanticKey:Pe("mainpanel-commerce-readiness-row",[e,t,r,o,a||""])}),"buildAgenticCommerceMainPanelReadinessRow"),ze=n((e,t,r)=>({id:e,title:t,rows:r}),"buildAgenticCommerceMainPanelReadinessSection"),Da=n(()=>{let e=[ze("overview","Overview",[oe("overview","acp-discovery","ACP discovery",`GET ${v.acpDiscovery}`,v.acpDiscovery),oe("overview","acp-config","ACP config",`GET ${v.acpConfig}`,v.acpConfig),oe("overview","api-version","API version",et,null)]),ze("discovery","Discovery",[oe("discovery","ucp-profile","UCP profile",v.ucpProfile),oe("discovery","mpp-openapi","MPP OpenAPI",v.mppOpenApi),oe("discovery","x402-payment-required","x402 payment required",v.x402PaymentRequired),oe("discovery","x402-api-root","x402 API root",v.x402ApiRoot)]),ze("sessions","Sessions",[oe("sessions","checkout-sessions","Checkout sessions",v.checkoutSessions),oe("sessions","stripe-webhook","Stripe webhook",_t.webhook)]),ze("web3","Web3",[oe("web3","settle","Settle",v.web3Settle),oe("web3","solana-pay-settle","Solana Pay settle",v.solanaPaySettle),oe("web3","signals","Signals","Base RPC + Solana RPC confirmation",null)]),ze("governance","Governance",[oe("governance","openbox-ingest","OpenBOX ingest",v.openboxIngest),oe("governance","risk-source","Risk source","OpenBOX risk signal",null)]),ze("proofs","Proofs",[oe("proofs","harness-proof","Harness proof",v.commerceProofArtifact),oe("proofs","trace-artifact","Trace artifact",v.commerceTraceArtifact)])],t=e.flatMap(a=>a.rows),r=t.map(a=>a.path||"").filter(a=>a.length>0),o=t.filter(a=>!a.path).map(a=>`${a.label}: ${a.value}`);return{surface:"mainpanel-commerce",semanticKey:Pe("mainpanel-commerce-readiness",[et,...t.map(a=>a.semanticKey)]),sections:e,routePaths:r,routeCount:r.length,signals:o}},"buildAgenticCommerceMainPanelReadiness"),Ol=Da(),ro=n((e,t)=>{let r=Me(e,G.web3DepositAddress);if(/^0x[0-9a-fA-F]{40}$/.test(r))return r;let o=Pe("deposit-address",[t,"0"]),a=Pe("deposit-address",[t,"1"]),s=Pe("deposit-address",[t,"2"]),i=Pe("deposit-address",[t,"3"]),c=Pe("deposit-address",[t,"4"]);return`0x${o}${a}${s}${i}${c}`.slice(0,42)},"buildAgenticCommerceDepositAddress");var oo=n((e,t=Zr)=>{let r=Me(e,G.x402PayToAddress);return/^0x[0-9a-fA-F]{40}$/.test(r)&&r.toLowerCase()!==Ua?r:ro(e,t)},"readAgenticCommerceX402PayToAddress"),Il=ro({},Zr),$a=/^[a-z0-9]{3,8}:[-_a-zA-Z0-9]{1,64}$/,no=n(e=>{let t=Me(e,G.x402Network);return $a.test(t)?t:Qr},"readAgenticCommerceX402Network"),ao=n(e=>Me(e,G.x402Asset)||Xr,"readAgenticCommerceX402Asset"),so=n(e=>{let t=Me(e,G.x402Amount);return/^[1-9][0-9]*$/.test(t)?t:Jr},"readAgenticCommerceX402Amount");var io=n(e=>{let t=Me(e,G.x402FacilitatorUrl);try{let r=new URL(t||Zt);return r.protocol==="https:"||r.protocol==="http:"?r.toString().replace(/\/+$/g,""):Zt}catch{return Zt}},"readAgenticCommerceX402FacilitatorUrl"),co=n(e=>{let t=tt(e.baseUrl);return{protocol:{name:"acp",version:et,supported_versions:[et],documentation_url:"https://agenticcommerce.dev"},api_base_url:t,transports:[...Ka],capabilities:{services:[...La],...e.web3Enabled?{extensions:[{name:"x-web3"}]}:{}},links:{config:ce(t,v.acpConfig),ucp:ce(t,v.ucpProfile),mpp:ce(t,v.mppOpenApi),x402:ce(t,v.x402PaymentRequired)}}},"buildAgenticCommerceAcpDiscovery"),lo=n(e=>{let t=tt(e.baseUrl),r={acp:ce(t,v.acpDiscovery),api:ce(t,v.x402ApiRoot),checkout_sessions:ce(t,v.checkoutSessions),mpp_openapi:ce(t,v.mppOpenApi),proof:ce(t,v.commerceProofArtifact),trace:ce(t,v.commerceTraceArtifact),x402_payment_required:ce(t,v.x402PaymentRequired),solana_pay_settle:ce(t,v.solanaPaySettle)},o={checkout_sessions:!0,content_payments:!0,proof_artifacts:!0,risk_signals:!0,web3_settlement:e.web3Enabled,solana_pay:e.web3Enabled},a={"dev.ucp.shopping":[{version:Fe,spec:Yr,transport:"rest",endpoint:r.api,schema:"https://ucp.dev/2026-04-08/services/shopping/rest.openapi.json"}]};return{ucp:{version:Fe,protocol_version:Fe,services:a,capabilities:{"dev.ucp.shopping.checkout":[{version:Fe,spec:"https://ucp.dev/2026-04-08/specification/checkout/",schema:"https://ucp.dev/2026-04-08/schemas/shopping/checkout.json"}]},payment_handlers:{},endpoints:r},protocol_version:Fe,protocol:{name:"ucp",version:Fe},seller:{id:e.sellerId},services:[{id:"knowgrph-content-payments",type:"content-payments",endpoints:{x402:r.x402_payment_required,checkout_sessions:r.checkout_sessions,solana_pay_settle:r.solana_pay_settle,proof:r.proof,trace:r.trace}}],capabilities:o,endpoints:r,spec_urls:[Yr],schema_urls:["https://ucp.dev/2026-04-08/services/shopping/rest.openapi.json","https://ucp.dev/2026-04-08/schemas/shopping/checkout.json"]}},"buildAgenticCommerceUcpProfile"),po=n(e=>{let t=tt(e.baseUrl);return{openapi:"3.1.0",info:{title:"Knowgrph Machine Payment Protocol",version:et,description:"Machine-readable payable-operation discovery for Knowgrph commerce routes."},servers:[{url:t}],paths:{[v.x402PaymentRequired]:{get:{operationId:"getKnowgrphX402PaymentRequirement",summary:"Return x402 payment requirements for an agent-readable paid resource.","x-payment-info":{intent:"charge",method:"x402",amount:Na,currency:"usdc"},responses:{402:{description:"Payment Required"}}}},[v.checkoutSessions]:{post:{operationId:"createKnowgrphCommerceCheckoutSession",summary:"Create an agentic commerce checkout session.","x-payment-info":{intent:"session",method:"stripe",amount:"dynamic",currency:"request.currency"},responses:{201:{description:"Checkout session created"}}}},[v.solanaPaySettle]:{post:{operationId:"settleKnowgrphSolanaPayCheckoutSession",summary:"Settle an agentic commerce checkout session from a verified Solana Pay transaction signature.","x-payment-info":{intent:"settlement",method:qr,amount:"dynamic",currency:"request.currency"},responses:{200:{description:"Solana Pay session settled"},409:{description:"Solana Pay transaction is not confirmed yet"},422:{description:"Solana Pay transaction does not match the session"}}}}}}},"buildAgenticCommerceMppOpenApi"),uo=n(e=>{let t=tt(e.baseUrl),r=ce(t,v.x402PaymentRequired),o=String(e.amount||Jr);return{x402Version:2,error:"Payment required",resource:{url:r,description:"Knowgrph agentic commerce paid-resource readiness probe",mimeType:"application/json"},accepts:[{scheme:"exact",network:String(e.network||Qr),amount:o,maxAmountRequired:o,asset:String(e.asset||Xr),resource:r,mimeType:"application/json",payTo:e.payTo,maxTimeoutSeconds:300,extra:{name:"USDC",version:"2",resourceUrl:r,...e.facilitatorUrl?{facilitatorUrl:e.facilitatorUrl}:{}}}]}},"buildAgenticCommerceX402PaymentRequired");var Ha=n(e=>JSON.stringify(e,null,2),"jsonBody"),ja=n(e=>String(e||"").trim().replace(/\/+$/g,""),"trimOrigin"),Ba=n(e=>typeof btoa=="function"?btoa(e):typeof Buffer<"u"?Buffer.from(e).toString("base64"):"","encodeBase64"),Ga=n((e,t)=>{try{return new URL(e).origin}catch{return ja(t)}},"rootOriginFromRequest"),er=n((e={})=>{let t=Ga(e.requestUrl,e.origin),r=e.env||{},o=eo(r,`${t}/`),a=to(r),s=uo({baseUrl:t,payTo:oo(r),network:no(r),asset:ao(r),amount:so(r),facilitatorUrl:io(r)});return{acpDiscovery:co({sellerId:o,baseUrl:t,web3Enabled:a}),ucpProfile:lo({sellerId:o,baseUrl:t,web3Enabled:a}),mppOpenApi:po({baseUrl:t}),x402PaymentRequired:s}},"buildKnowgrphCommerceDiscovery");var mo=n((e,t={})=>{let r=er({requestUrl:e?.url,env:t}).x402PaymentRequired,o=Ba(JSON.stringify(r));return new Response(Ha(r),{status:402,headers:{"content-type":"application/json; charset=utf-8","cache-control":"no-store","access-control-allow-origin":"*",...o?{"payment-required":o}:{}}})},"buildKnowgrphX402PaymentRequiredResponse");async function ho(e){return mo(e.request,e.env||{})}n(ho,"onRequest");async function go(e){let{request:t}=e,r=String(t.method||"GET").toUpperCase(),o=t.headers.get("origin")||"";return r==="OPTIONS"?We(t):r!=="GET"&&r!=="HEAD"?we({ok:!1,error:"Method not allowed"},{status:405,origin:o}):we({ok:!0,models:Xt.map(a=>({model:a,display_name:a}))},{status:200,origin:o})}n(go,"onRequest");async function fo(e){let{request:t,env:r}=e,o=String(t.method||"GET").toUpperCase(),a=t.headers.get("origin")||"";if(o==="OPTIONS")return We(t);if(o!=="POST")return we({ok:!1,error:"Method not allowed"},{status:405,origin:a});try{if(!String(t.headers.get("content-type")||"").toLowerCase().includes("application/json"))return we({ok:!1,error:"Expected application/json"},{status:415,origin:a});let i=await wt(t);return await St({request:t,env:r,pathname:"/responses",payload:i})}catch(s){let i=s instanceof Error?s.message:String(s||"Unknown error");return we({ok:!1,error:i},{status:400,origin:a})}}n(fo,"onRequest");var qe=Object.freeze({researchSourceFiles:"knowgrph_research_source_files",inspectAgentSurface:"knowgrph_inspect_agent_surface"}),tr=n(e=>String(e||"").trim(),"normalizeString"),Wa=n(e=>({...e,arguments:Array.isArray(e.arguments)?e.arguments.map(t=>({...t})):void 0,_meta:e._meta&&typeof e._meta=="object"?{...e._meta,tools:Array.isArray(e._meta.tools)?[...e._meta.tools]:void 0}:void 0}),"clonePrompt"),wo=Object.freeze([Object.freeze({name:qe.researchSourceFiles,title:"Research Knowgrph Source Files",description:"Guide an MCP host through read-only Knowgrph Source Files research using search and fetch with citation-ready URLs.",arguments:Object.freeze([Object.freeze({name:"query",description:"Research question or topic to pass to the read-only search tool.",required:!0}),Object.freeze({name:"limit",description:"Optional decimal string for the maximum search results to inspect.",required:!1}),Object.freeze({name:"focus",description:"Optional aspect to prioritize when reading fetched Source Files.",required:!1})]),_meta:Object.freeze({readOnly:!0,tools:Object.freeze(["search","fetch"])})}),Object.freeze({name:qe.inspectAgentSurface,title:"Inspect Knowgrph Agent Surface",description:"Guide an MCP host through read-only inspection of Knowgrph agent, MCP, and MCP Apps readiness metadata.",arguments:Object.freeze([Object.freeze({name:"focus",description:"Optional readiness area to emphasize, such as transport, tools, resources, prompts, retrieval, or app metadata.",required:!1})]),_meta:Object.freeze({readOnly:!0,tools:Object.freeze(["inspect_agent_surface"])})})]),So=n(()=>wo.map(Wa),"buildKnowgrphAgentReadyPromptContracts"),Fa=n(e=>wo.find(t=>t.name===tr(e))||null,"findPromptContract"),Pt=n((e,t)=>!e||typeof e!="object"?"":tr(e[t]),"readPromptArg"),za=n((e,t)=>{let r=Pt(e,t);if(!r)throw new Error(`Missing required prompt argument: ${t}`);return r},"readRequiredPromptArg"),yo=n(e=>({role:"user",content:{type:"text",text:e}}),"buildPromptMessage"),qa=n((e={})=>{let t=za(e,"query"),r=Pt(e,"limit"),o=Pt(e,"focus");return[`Research Knowgrph Source Files for: ${t}`,"","Use the MCP server read-only retrieval path:",`1. Call search with query=${JSON.stringify(t)}${r?` and limit=${JSON.stringify(r)}`:""}.`,"2. Select the most relevant returned ids and call fetch for each id before answering.","3. Ground the answer in fetched markdown content and cite the returned result URLs when summarizing.",o?`4. Prioritize this focus: ${o}.`:"","","Do not mutate graph, canvas, workspace, storage, or browser-local state for this research prompt."].filter(Boolean).join(`
`)},"buildSourceFilesResearchPromptText"),Va=n((e={})=>{let t=Pt(e,"focus");return["Inspect the Knowgrph agent-ready surface through the read-only inspect_agent_surface tool.","","Review health, API catalog, MCP server card, A2A card, agent skills, commerce discovery, and mcpAppsServerReadiness.","For MCP Apps readiness, verify tool/resource linkage, output schema, text fallback, structured content, sandbox/security metadata, no-auth security-scheme mirroring, widget accessibility, prompts, search/fetch retrieval, Streamable HTTP, and local stdio support.",t?`Emphasize this readiness area: ${t}.`:"","","Report checklist ids and evidence from structuredContent. Do not infer readiness from prose alone."].filter(Boolean).join(`
`)},"buildAgentSurfaceInspectionPromptText"),_o=n((e,t={})=>{let r=Fa(e);if(!r)throw new Error(`Unknown Knowgrph MCP prompt: ${tr(e)}`);if(r.name===qe.researchSourceFiles)return{description:r.description,messages:[yo(qa(t))]};if(r.name===qe.inspectAgentSurface)return{description:r.description,messages:[yo(Va(t))]};throw new Error(`Unhandled Knowgrph MCP prompt: ${r.name}`)},"getKnowgrphAgentReadyPrompt");var Ya=Object.freeze({sourceFileById:"knowgrph_source_file_by_id"}),Rt="kgdoc://source-file/{id}",bo="kgdoc://source-file/",Po="text/markdown",rt=n(e=>String(e||"").trim(),"normalizeString"),Ro=n(()=>[{uriTemplate:Rt,name:Ya.sourceFileById,title:"Knowgrph Source File By ID",description:"Read a complete published Knowgrph Source File markdown document using a stable kgdoc id returned by search.",mimeType:Po,annotations:{audience:["user","assistant"],priority:.8},_meta:{readOnly:!0,source:"knowgrph-source-files",tool:"fetch"}}],"buildKnowgrphAgentReadyResourceTemplateContracts");var Ao=n(e=>{let t=rt(e);if(!t.startsWith(bo))return"";let r=t.slice(bo.length);if(!r)return"";try{return decodeURIComponent(r)}catch{return r}},"parseKnowgrphSourceFileResourceUri"),ko=n(({uri:e,sourceFile:t}={})=>{let r=typeof t?.content=="string"?t.content:String(t?.text||"");return{contents:[{uri:rt(e),mimeType:Po,text:r,_meta:{id:rt(t?.id),title:rt(t?.title),url:rt(t?.url),metadata:t?.metadata&&typeof t.metadata=="object"?{...t.metadata}:{}}}]}},"buildKnowgrphSourceFileResourceReadResult");var At="io.modelcontextprotocol/ui",Ke="text/html;profile=mcp-app",vo="2026-01-26",Ja="knowgrph-mcp-apps-server-readiness/v0.1",le="ui://knowgrph/agent-ready",nr="knowgrph-agent-ready",De="inspect_agent_surface",Se=Object.freeze(["search","fetch"]),rr=Object.freeze({search:Object.freeze(["ids"]),fetch:Object.freeze(["id","title","content","text"])}),xo=Object.freeze(Object.values(qe)),xe="streamable-http",Xa=Object.freeze([Object.freeze({type:"noauth"})]),se=Object.freeze({openAiApps:"openai-apps",claude:"claude-mcp-connector",qwenCode:"qwen-code",kimiCli:"kimi-cli",bytePlusModelArk:"byteplus-modelark",generic:"generic-mcp"}),D=n(e=>String(e||"").trim(),"normalizeString"),Ve=n(e=>D(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),"escapeHtml"),Qa=n(e=>JSON.stringify(e).replace(/</g,"\\u003c"),"safeJsonForInlineScript"),Za=n(e=>{let t=D(e);if(!t)return"";try{return new URL(t).origin}catch{return""}},"readUrlOrigin"),ar=n(()=>({extensions:{[At]:{mimeTypes:[Ke]}}}),"buildKnowgrphMcpAppsCapabilities"),ne=n(e=>Array.isArray(e)?e:[],"arrayFrom"),sr=n(()=>Xa.map(e=>({...e})),"buildKnowgrphMcpNoauthSecuritySchemes"),Oo=n(e=>(Array.isArray(e)&&e.length?e:sr()).filter(r=>r&&typeof r=="object").map(r=>({...r})),"normalizeSecuritySchemes"),Eo=n(e=>ne(e).some(t=>t?.type==="noauth"),"hasNoauthSecurityScheme"),Co=n(e=>Array.isArray(e)?Oo(e):[],"readSecuritySchemes"),es=n(e=>{let t=D(e);return t.includes("window.openai")&&t.includes("openai:set_globals")&&t.includes("toolInput")&&t.includes("toolOutput")&&t.includes("callTool")&&t.includes("request('ui/initialize'")},"hasOpenAiWidgetBridgeHtml"),To=n((e,t=[])=>e?.outputSchema?.type==="object"&&t.every(r=>ne(e.outputSchema?.required).includes(r)),"hasToolOutputSchemaFields"),or=n(e=>e?.annotations?.readOnlyHint===!0&&e?.annotations?.destructiveHint===!1&&e?.annotations?.openWorldHint===!1&&e?.annotations?.idempotentHint===!0,"hasReadOnlyToolAnnotations"),Y=n((e,t,r,o=[])=>({id:e,label:t,ok:r===!0,evidence:ne(o).map(D).filter(Boolean)}),"booleanCheck"),ir=n((e={})=>{let t=D(e.baseUrl).replace(/\/+$/,""),r=D(e.serverName)||"knowgrph",o=D(e.mcpUrl)||(t?`${t}/mcp`:"");return{[se.openAiApps]:{id:se.openAiApps,label:"OpenAI Apps / ChatGPT",transport:xe,url:o,appResourceUri:le,appToolName:De,requiredMetadata:["openai/outputTemplate","openai/widgetAccessible","openai/widgetCSP","openai/widgetDomain"],requiredTools:[De,...Se]},[se.claude]:{id:se.claude,label:"Claude MCP connector",transport:xe,url:o,beta:"mcp-client-2025-11-20",mcp_servers:[{type:"url",url:o,name:r}],tools:[{type:"mcp_toolset",mcp_server_name:r}],requiredTools:Se},[se.qwenCode]:{id:se.qwenCode,label:"Qwen Code",transport:"http",url:o,command:`qwen mcp add --transport http ${r} ${o}`,settingsJson:{mcpServers:{[r]:{httpUrl:o,timeout:3e4,trust:!1,includeTools:["search","fetch",De]}}},requiredTools:Se,primaryFlow:"Call search with a natural-language query, then call fetch with the returned kgdoc id."},[se.kimiCli]:{id:se.kimiCli,label:"Kimi CLI",transport:"http",url:o,command:`kimi mcp add --transport http ${r} ${o}`,configFile:"~/.kimi/mcp.json",mcpJson:{mcpServers:{[r]:{url:o,transport:"http"}}},requiredTools:Se,primaryFlow:"Call search with a natural-language query, then call fetch with the returned kgdoc id."},[se.bytePlusModelArk]:{id:se.bytePlusModelArk,label:"BytePlus ModelArk Responses API",transport:xe,url:o,apiBaseUrl:"https://ark.ap-southeast.bytepluses.com/api/v3",endpoint:"/responses",requiredHeaders:{"ark-beta-mcp":"true"},tools:[{type:"mcp",server_label:r,server_url:o,require_approval:"never"}],openAiCompatible:{base_url:"https://ark.ap-southeast.bytepluses.com/api/v3",default_headers:{"ark-beta-mcp":"true"},responsesCreate:{model:"<MODELARK_MODEL_OR_ENDPOINT_ID>",tools:[{type:"mcp",server_label:r,server_url:o,require_approval:"never"}]}},invocationScope:"ModelArk Responses API with MCP service and model permissions enabled.",requiredTools:Se,primaryFlow:"Use ModelArk Responses API with the Knowgrph MCP tool entry, then ask the model to call search and fetch."},[se.generic]:{id:se.generic,label:"Generic MCP clients",transport:xe,url:o,initialize:{method:"initialize",accept:["application/json","text/event-stream"]},requiredMethods:["initialize","notifications/initialized","tools/list","tools/call"],optionalMethods:["prompts/list","prompts/get","resources/list","resources/templates/list","resources/read"],requiredTools:Se}}},"buildKnowgrphMcpClientSetups"),Io=n((e={})=>{let t=D(e.baseUrl).replace(/\/+$/,""),r=D(e.updatedAt),o=e.mcpServerCard&&typeof e.mcpServerCard=="object"?e.mcpServerCard:{},a=o.capabilities&&typeof o.capabilities=="object"?o.capabilities:{},s=ne(e.tools).length?ne(e.tools):ne(a.tools),i=ne(e.resources).length?ne(e.resources):[kt({appUrl:t,updatedAt:r})],c=ne(e.prompts).length?ne(e.prompts):ne(o.prompts),l=ne(e.resourceTemplates).length?ne(e.resourceTemplates):ne(o.resourceTemplates),p=s.filter(S=>S?._meta?.ui?.resourceUri===le),m=p.find(S=>S?.name===De)||p[0]||null,f=i.find(S=>S?.uri===le)||null,A=a.extensions?.[At],_=D(o.transport?.url)||(t?`${t}/mcp`:""),x=D(o.surfaceRoles?.publicReadMcpUrl)||_,$=D(o.surfaceRoles?.controlPlaneMcpUrl)||(t?`${t}/control-plane/mcp`:""),K=D(o.transport?.type)||xe,F=D(e.appResourceHtml)||Uo({appUrl:t,updatedAt:r,toolName:m?.name||De}),ee=e.clientSetups&&typeof e.clientSetups=="object"?e.clientSetups:ir({baseUrl:t,mcpUrl:_,serverName:o.serverInfo?.name}),z=m?.outputSchema&&typeof m.outputSchema=="object",C=!!m?.name,O=z,Q=m?._meta?.["openai/outputTemplate"]===le,U=es(F),re=Eo(m?.securitySchemes)&&Eo(m?._meta?.securitySchemes),M=or(m),N=m?._meta?.["openai/widgetAccessible"]===!0,B=c.map(S=>D(S?.name)).filter(Boolean),ae=o.capabilities?.prompts&&typeof o.capabilities.prompts=="object",de=xo.every(S=>B.includes(S)),ye=l.map(S=>D(S?.uriTemplate)).filter(Boolean),R=ye.includes(Rt),w=Object.fromEntries(Se.map(S=>[S,s.find(q=>q?.name===S)||null])),y=Se.every(S=>{let q=w[S];return or(q)&&To(q,rr[S])}),d=ee[se.qwenCode],h=d?.transport==="http"&&d?.url===_&&d?.settingsJson?.mcpServers?.[o.serverInfo?.name||"knowgrph"]?.httpUrl===_&&String(d?.command||"").includes("--transport http")&&String(d?.command||"").includes(_),g=ee[se.kimiCli],b=g?.transport==="http"&&g?.url===_&&g?.mcpJson?.mcpServers?.[o.serverInfo?.name||"knowgrph"]?.url===_&&g?.mcpJson?.mcpServers?.[o.serverInfo?.name||"knowgrph"]?.transport==="http"&&String(g?.command||"").includes("kimi mcp add --transport http")&&String(g?.command||"").includes(_),T=ee[se.bytePlusModelArk],V=T?.transport===xe&&T?.url===_&&T?.endpoint==="/responses"&&T?.requiredHeaders?.["ark-beta-mcp"]==="true"&&ne(T?.tools).some(S=>S?.type==="mcp"&&S?.server_label===(o.serverInfo?.name||"knowgrph")&&S?.server_url===_&&S?.require_approval==="never")&&T?.openAiCompatible?.responsesCreate?.tools?.some(S=>S?.type==="mcp"&&S?.server_label===(o.serverInfo?.name||"knowgrph")&&S?.server_url===_&&S?.require_approval==="never"),H=[Y("app-tool-resource-link","App tool is linked to the UI resource",p.length>0,p.map(S=>S.name)),Y("output-schema","App tool exposes an output schema",z,[m?.name]),Y("text-fallback","Tool result keeps a text fallback for non-UI hosts",C,[m?.name]),Y("structured-content","Tool result returns structured content for the View",O,[m?.name]),Y("resource-descriptor","MCP resource descriptor uses the MCP Apps MIME type",f?.mimeType===Ke,[f?.uri]),Y("resource-security-meta","Resource declares UI sandbox metadata",f?._meta?.ui?.prefersBorder===!0&&!!f?._meta?.ui?.csp,[f?.uri]),Y("openai-output-template","App tool exposes the OpenAI output template metadata key",Q,[m?.name]),Y("openai-widget-bridge","App resource supports the OpenAI Apps widget bridge",U,["window.openai","openai:set_globals"]),Y("tool-security-schemes","App tool exposes no-auth securitySchemes and mirrors them in _meta",re,[m?.name]),Y("tool-impact-annotations","App tool exposes complete read-only impact annotations",M,[m?.name]),Y("widget-accessible","App tool allows the widget bridge to call tools",N,[m?.name]),Y("prompt-discovery","Server exposes MCP prompt templates for multi-host guidance",ae&&de,B),Y("source-file-resource-template","Server exposes a dynamic Source Files resource template",R,ye),Y("deep-research-search-fetch","Server exposes read-only search and fetch tools",y,Se),Y("qwen-code-http-client-setup","Server advertises Qwen Code HTTP MCP setup",h,[d?.command]),Y("kimi-cli-http-client-setup","Server advertises Kimi CLI HTTP MCP setup",b,[g?.command]),Y("byteplus-modelark-responses-mcp-setup","Server advertises BytePlus ModelArk Responses API MCP setup",V,[T?.apiBaseUrl,T?.endpoint]),Y("extension-capability","Server advertises the MCP Apps extension capability",A?.mimeTypes?.includes(Ke),[At]),Y("streamable-http-transport","Server exposes a stateless Streamable HTTP JSON-RPC transport",!!_&&K===xe,[_,K]),Y("stdio-transport","Repo-local MCP server supports stdio host configuration",e.localStdio!==!1,["node mcp/server.js"])],L=H.every(S=>S.ok);return{schemaVersion:Ja,ready:L,updatedAt:r,app:{name:nr,protocolVersion:vo,resourceUri:le,resourceMimeType:Ke,extensionId:At},tool:{name:m?.name||De,title:m?.title||"Inspect Agent Surface",resourceUri:m?._meta?.ui?.resourceUri||le,visibility:ne(m?._meta?.ui?.visibility).length?m._meta.ui.visibility:["model","app"],readOnly:m?.annotations?.readOnlyHint===!0,destructive:m?.annotations?.destructiveHint===!0,openWorld:m?.annotations?.openWorldHint===!0,idempotent:m?.annotations?.idempotentHint===!0,annotationsReady:M,hasOutputSchema:!!z,textFallback:C,structuredContent:O,openAiOutputTemplate:Q,openAiWidgetBridge:U,securitySchemes:Co(m?.securitySchemes),mirroredSecuritySchemes:Co(m?._meta?.securitySchemes),widgetAccessible:N},resource:{uri:f?.uri||le,name:f?.name||nr,mimeType:f?.mimeType||Ke,prefersBorder:f?._meta?.ui?.prefersBorder===!0,domain:D(f?._meta?.ui?.domain),csp:f?._meta?.ui?.csp||{},openAiWidgetBridge:U},retrieval:{mode:"deep-research-search-fetch",requiredTools:Se,tools:Se.map(S=>{let q=w[S];return{name:S,readOnly:q?.annotations?.readOnlyHint===!0,destructive:q?.annotations?.destructiveHint===!0,openWorld:q?.annotations?.openWorldHint===!0,idempotent:q?.annotations?.idempotentHint===!0,annotationsReady:or(q),requiredOutputFields:rr[S],outputSchemaReady:To(q,rr[S])}})},prompts:{requiredPrompts:xo,names:B,capability:!!ae,ready:ae&&de},resourceTemplates:{requiredTemplates:[Rt],uriTemplates:ye,ready:R},clients:ee,transports:[{id:"pages-http-jsonrpc",type:K,url:_,stateless:!0,serverFactory:!0},{id:"local-stdio-jsonrpc",type:"stdio",command:"node mcp/server.js",stateless:!1,serverFactory:!0}],dataModel:{source:"inspect_agent_surface.structuredContent",categories:[{id:"discovery",label:"Discovery metadata",count:["health","apiCatalog","openApi","mcpServerCard","agentCard","agentSkills"].length},{id:"commerce",label:"Commerce discovery",count:["acpDiscovery","ucpProfile","mppOpenApi"].length},{id:"mcp-apps",label:"MCP Apps server bindings",count:H.length}],renderMode:"structured-summary-with-json-fallback"},onboarding:{publicReadMcpUrl:x,controlPlaneMcpUrl:$,controlPlaneCondition:"Add the control plane only when the host can preserve MCP session state and needs live /, #, @ grammar lookup.",cheapestProofPath:"Use the source-side README.md quick start or docs/documents/knowgrph-superagent-harness.md in the knowgrph repo before hosted setup.",steps:[{order:1,label:"Install public MCP first",action:x?`Install ${x}.`:"Install the public read-only MCP endpoint first."},{order:2,label:"Add control plane only when session-capable",action:$?`Add ${$} only when the host can preserve MCP session state and needs live /, #, @ grammar lookup.`:"Add the control plane only when the host can preserve MCP session state and needs live /, #, @ grammar lookup."},{order:3,label:"Use the cheapest proof path before hosted setup",action:"Run the source-side README.md quick start or docs/documents/knowgrph-superagent-harness.md first."}]},checklist:H}},"buildKnowgrphMcpAppsServerReadiness"),Mo=n((e={})=>{let t=D(e.resourceUri)||le;return{securitySchemes:Oo(e.securitySchemes),ui:{resourceUri:t,visibility:Array.isArray(e.visibility)&&e.visibility.length?e.visibility:["model","app"]},"openai/outputTemplate":t,"openai/widgetAccessible":e.widgetAccessible!==!1,"openai/toolInvocation/invoking":D(e.invoking)||"Inspecting Knowgrph.","openai/toolInvocation/invoked":D(e.invoked)||"Knowgrph is ready."}},"buildKnowgrphMcpAppsToolMeta"),No=Object.freeze({type:"object",additionalProperties:!0,required:["baseUrl","healthUrl","mcpUrl"],properties:{baseUrl:{type:"string"},healthUrl:{type:"string"},mcpUrl:{type:"string"},apiCatalogUrl:{type:"string"},openApiUrl:{type:"string"},mcpServerCardUrl:{type:"string"},agentCardUrl:{type:"string"},agentSkillsUrl:{type:"string"},commerceUrls:{type:"object",additionalProperties:{type:"string"}},health:{type:"object",additionalProperties:!0},apiCatalog:{type:"object",additionalProperties:!0},openApi:{type:"object",additionalProperties:!0},mcpServerCard:{type:"object",additionalProperties:!0},agentCard:{type:"object",additionalProperties:!0},agentSkills:{type:"object",additionalProperties:!0},commerce:{type:"object",additionalProperties:!0},mcpAppsServerReadiness:{type:"object",additionalProperties:!0}}}),kt=n((e={})=>{let t=D(e.appUrl),r=D(e.updatedAt),o=D(e.domain)||Za(t),a={connectDomains:[],resourceDomains:[],frameDomains:[],baseUriDomains:[]};return{uri:le,name:nr,description:["Interactive MCP Apps view for the existing Knowgrph agent-ready surface.",t?`App URL: ${t}`:"",r?`Updated: ${r}`:""].filter(Boolean).join(" "),mimeType:Ke,_meta:{ui:{csp:a,...o?{domain:o}:{},prefersBorder:!0},"openai/widgetDescription":"Interactive Knowgrph agent-ready server-readiness view.","openai/widgetPrefersBorder":!0,...o?{"openai/widgetDomain":o}:{},"openai/widgetCSP":{connect_domains:a.connectDomains,resource_domains:a.resourceDomains,frame_domains:a.frameDomains}}}},"buildKnowgrphMcpAppsResourceDescriptor"),Uo=n((e={})=>{let t=D(e.appUrl),r=D(e.updatedAt),o=D(e.toolName)||De,a=t?`${t.replace(/\/+$/,"")}/mcp`:"",s=t?`${t.replace(/\/+$/,"")}/control-plane/mcp`:"",i=Array.isArray(e.toolNames)?e.toolNames.map(D).filter(Boolean):[o],c={appUrl:t,updatedAt:r,resourceUri:le,toolName:o,toolNames:i,protocolVersion:vo,onboarding:{publicReadMcpUrl:a,controlPlaneMcpUrl:s,cheapestProofPath:"Use the source-side README.md quick start or docs/documents/knowgrph-superagent-harness.md before hosted setup."}};return`<!doctype html>
<html lang="en">
<head>
  <meta charset="utf-8">
...
}`;var Tt={push:"/api/storage/push",pull:"/api/storage/pull",collabSave:"/api/storage/collab/save",chatSession:"/api/storage/chat/session",chatRelay:"/api/storage/chat/relay",chatPoliciesPrefix:"/api/storage/chat/policies/",chatAuditPrefix:"/api/storage/chat/audit/",exportPrefix:"/api/storage/export/",docPrefix:"/api/storage/doc/",defaultDocPrefix:"/api/storage/doc-default/",blobPrefix:"/api/storage/blob/",mediaAssetPersist:"/api/storage/media/assets",mediaAssetPrefix:"/api/storage/media/assets/",mediaPrefix:"/api/storage/media/",sourceFilesIndex:"/api/storage/source-files",sourceFilesIndexPrefix:"/api/storage/source-files/",sourceFilesLlms:"/api/storage/llms.txt"};var nn=n((e,t)=>`${Tt.docPrefix}${encodeURIComponent(String(e||"").trim())}/${encodeURIComponent(String(t||"").trim())}`,"buildKnowgrphStorageDocPath"),an=n(e=>`${Tt.defaultDocPrefix}${encodeURIComponent(String(e||"").trim())}`,"buildKnowgrphStorageDefaultDocPath");var sn=n(e=>{let t=String(e||"").trim();return t?`${Tt.sourceFilesIndexPrefix}${encodeURIComponent(t)}`:Tt.sourceFilesIndex},"buildKnowgrphStorageSourceFilesIndexPath");var W="https://airvio.co",vt="https://knowgrph-storage.huijoohwee.workers.dev",E="/knowgrph",k=`${W}${E}/`,cn=`${W}/`,nt="kgws:canonical-docs",Ee="2026-06-05",Je=`${E}/health`,Ye=`${W}${Je}`,ln="/.well-known/agent-card.json",wr=`${E}/.well-known/agent-card.json`,Ot=`${W}${ln}`,Sr=`${W}/api/storage/source-files`,bs=`${W}/api/storage/doc-default/{canonicalPath}`,Ps=`${W}/api/storage/doc/{workspaceId}/{canonicalPath}`,Rs=`${W}/api/storage/blob/{workspaceId}/{canonicalPath}`,pn="knowgrph-agent-ready-pages";var un=['</.well-known/api-catalog>; rel="api-catalog"; type="application/linkset+json"',`<${E}/.well-known/openapi.json>; rel="service-desc"; type="application/vnd.oai.openapi+json;version=3.1"`,`<${E}/llms.txt>; rel="service-doc"; type="text/plain"`,'</auth.md>; rel="service-doc"; type="text/markdown"',`<${Je}>; rel="status"; type="application/health+json"`,`<${E}/.well-known/mcp/server-card.json>; rel="mcp-server-card"; type="application/json"`,`<${ln}>; rel="describedby"; type="application/json"`].join(", "),dn=`# Knowgrph
...
- Auth.md registration instructions: ${cn}auth.md
- Health: ${Ye}
...
- Source Files index: ${Sr}
- Default Source File documents: ${bs}
- Workspace Source File documents: ${Ps}
...
`,mn=n(e=>new Response(e,{status:200,headers:{"content-type":"text/markdown; charset=utf-8","cache-control":"public, max-age=3600","access-control-allow-origin":"*",vary:"Accept","x-markdown-tokens":String(Math.ceil(String(e||"").length/4))}}),"markdownResponse"),at=n(e=>(e.headers.get("accept")||"").toLowerCase().split(",").some(r=>r.trim().startsWith("text/markdown")),"wantsMarkdown"),hn=n((e,t)=>{let r=new Response(e.body,e),o=String(t?.owner||"").trim(),a=String(t?.tag||"").trim();return o&&r.headers.set("x-knowgrph-route-owner",o),a&&r.headers.set("x-knowgrph-route-tag",a),r},"withAgentReadyRouteHeaders");var Mt=lr({defaultWorkspaceId:nt}),bn=So(),Pn=Ro(),Rn=n((e,t="")=>{let r=String(e||"").trim(),o=String(t||"").trim();return o?nn(o,r):an(r)},"buildStorageDocPath"),ct=n(e=>String(e||"").trim(),"normalizeToolString");var _e=n((e,t="application/json; charset=utf-8")=>new Response(JSON.stringify(e,null,2),{status:200,headers:{"content-type":t,"cache-control":"public, max-age=3600","access-control-allow-origin":"*"}}),"jsonResponse"),pe=n((e,t)=>new Response(JSON.stringify(t,null,2),{status:e,headers:{"content-type":"application/json; charset=utf-8","cache-control":"no-store","access-control-allow-origin":"*"}}),"jsonStatusResponse"),gn=n((e,t={})=>new Response(null,{status:e,headers:{"cache-control":"no-store","access-control-allow-origin":"*",...t}}),"emptyStatusResponse"),st=n((e,t)=>new Response(e,{status:200,headers:{"content-type":t,"cache-control":"public, max-age=3600","access-control-allow-origin":"*"}}),"textResponse"),As=n(e=>st(e,"text/html;profile=mcp-app; charset=utf-8"),"mcpAppsHtmlResponse"),ks=n(e=>new Response(JSON.stringify(e,null,2),{status:200,headers:{"content-type":"application/health+json; charset=utf-8","cache-control":"no-store","access-control-allow-origin":"*"}}),"healthResponse"),xs=`${E}/api/workspace/github/write`,Es="/api/workspace/github/write",fn=12,yn=9e5,Cs=new Set(["css","html","js","json","md","mdx","mjs","svg","ts","tsx","txt","yaml","yml"]),_r=n((e,t)=>String(e?.[t]||"").trim(),"readEnvString"),Ts=n(e=>{let t=_r(e,"KNOWGRPH_GITHUB_WRITE_REPOSITORY"),r=_r(e,"KNOWGRPH_GITHUB_WRITE_TOKEN"),o=_r(e,"KNOWGRPH_GITHUB_WRITE_BRANCH"),a=[];t||a.push("KNOWGRPH_GITHUB_WRITE_REPOSITORY"),r||a.push("KNOWGRPH_GITHUB_WRITE_TOKEN");let s=t.split("/").map(i=>i.trim()).filter(Boolean);return t&&s.length!==2&&a.push("KNOWGRPH_GITHUB_WRITE_REPOSITORY:owner/repo"),a.length>0?{ok:!1,missing:a}:{ok:!0,owner:s[0],repo:s[1],branch:o,token:r}},"readGitHubWriteConfig"),vs=n(e=>{let t=String(e||"").trim().replace(/^workspace:/i,"").replace(/\\/g,"/").replace(/^\/+/,"");if(!t)return{ok:!1,error:"missing_workspace_path"};if(/[\u0000-\u001f\u007f]/.test(t))return{ok:!1,error:"invalid_workspace_path"};let r=t.split("/").filter(Boolean);if(r.some(s=>s==="."||s===".."))return{ok:!1,error:"path_traversal_forbidden"};if(r[0]!=="chat-log")return{ok:!1,error:"unsupported_workspace_root"};if(r.length<3)return{ok:!1,error:"chat_log_session_file_required"};let o=r[r.length-1]||"",a=o.includes(".")?o.split(".").pop().toLowerCase():"";return!a||!Cs.has(a)?{ok:!1,error:"unsupported_text_extension"}:{ok:!0,path:r.join("/")}},"normalizeGitHubWriteWorkspacePath"),Os=n(e=>{let t=new TextEncoder().encode(String(e||"")),r=32768,o="";for(let a=0;a<t.length;a+=r)o+=String.fromCharCode(...t.slice(a,a+r));return btoa(o)},"encodeBase64Utf8"),Xe=class extends Error{static{n(this,"GitHubWorkspaceWriteError")}constructor(t,r,o){super(t),this.name="GitHubWorkspaceWriteError",this.code=t,this.upstreamStatus=r,this.upstreamMessage=o}},An=n(e=>String(e||"unknown").replace(/[\u0000-\u001f\u007f]/g," ").replace(/\s+/g," ").trim().slice(0,240),"sanitizeGitHubApiMessage"),kn=n((e,t)=>{let r=String(t||"").split("/").map(a=>encodeURIComponent(a)).join("/"),o=new URL(`https://api.github.com/repos/${encodeURIComponent(e.owner)}/${encodeURIComponent(e.repo)}/contents/${r}`);return e.branch&&o.searchParams.set("ref",e.branch),o},"buildGitHubContentsApiUrl"),xn=n(e=>({accept:"application/vnd.github+json",authorization:`Bearer ${e.token}`,"user-agent":"knowgrph-cloudflare-pages","x-github-api-version":"2022-11-28"}),"gitHubApiHeaders"),En=n(e=>{let t=String(e||"").replace(/\/+$/,"")||"/";return t===xs||t===Es},"isGitHubWorkspaceWriteRoutePath"),Is=n(async(e,t)=>{let r=await fetch(kn(e,t),{method:"GET",headers:xn(e)});if(r.status===404)return null;let o=await r.json().catch(()=>null);if(!r.ok)throw new Xe("github_read_failed",r.status,An(o?.message||r.statusText));if(o?.type&&o.type!=="file")throw new Xe("github_path_not_file",409,t);return String(o?.sha||"").trim()||null},"fetchGitHubExistingFileSha"),Ms=n(async(e,t,r)=>{let o=await Is(e,t.repositoryPath),a={message:r,content:Os(t.text),...e.branch?{branch:e.branch}:{},...o?{sha:o}:{}},s=await fetch(kn(e,t.repositoryPath),{method:"PUT",headers:{...xn(e),"content-type":"application/json; charset=utf-8"},body:JSON.stringify(a)}),i=await s.json().catch(()=>null);if(!s.ok)throw new Xe("github_write_failed",s.status,An(i?.message||s.statusText));return{workspacePath:t.workspacePath,repositoryPath:t.repositoryPath,action:o?"updated":"created",commitSha:String(i?.commit?.sha||""),contentSha:String(i?.content?.sha||""),htmlUrl:String(i?.content?.html_url||"")}},"putGitHubWorkspaceFile"),Ns=n(async(e,t)=>{let r=Ts(t);if(!r.ok)return pe(503,{ok:!1,status:"skipped",error:"github_write_not_configured",missing:r.missing});let o=await e.json().catch(()=>null),a=Array.isArray(o?.files)?o.files:[];if(a.length<1)return pe(400,{ok:!1,status:"failed",error:"files_required"});if(a.length>fn)return pe(413,{ok:!1,status:"failed",error:"too_many_files",maxFiles:fn});let s=[],i=new Set;for(let p of a){let m=vs(p?.workspacePath||p?.path);if(!m.ok)return pe(400,{ok:!1,status:"failed",error:m.error,workspacePath:String(p?.workspacePath||p?.path||"")});if(i.has(m.path))continue;i.add(m.path);let f=String(p?.text??"");if(new TextEncoder().encode(f).length>yn)return pe(413,{ok:!1,status:"failed",error:"file_too_large",workspacePath:`/${m.path}`,maxTextBytes:yn});s.push({workspacePath:`/${m.path}`,repositoryPath:m.path,text:f})}if(s.length<1)return pe(400,{ok:!1,status:"failed",error:"files_required"});let c=String(o?.message||"").trim(),l=c&&c.length<=160?c:`Knowgrph chat artifact ${s[0].repositoryPath}`;if(o?.dryRun===!0)return pe(200,{ok:!0,status:"dry_run",repository:`${r.owner}/${r.repo}`,branch:r.branch||null,files:s.map(p=>({workspacePath:p.workspacePath,repositoryPath:p.repositoryPath,textBytes:new TextEncoder().encode(p.text).length}))});try{let p=[];for(let m of s)p.push(await Ms(r,m,l));return pe(200,{ok:!0,status:"applied",repository:`${r.owner}/${r.repo}`,branch:r.branch||null,files:p})}catch(p){let m=p instanceof Xe;return pe(m?424:500,{ok:!1,status:"failed",error:m?p.code:p instanceof Error?p.message:String(p||"github_write_failed"),...m?{upstreamStatus:p.upstreamStatus,upstreamMessage:p.upstreamMessage}:{}})}},"handleGitHubWorkspaceWrite"),Us=n(e=>`User-agent: *
Allow: /knowgrph/
...
Sitemap: ${e}
`,"buildRobotsTxt"),Ls=n(e=>`<?xml version="1.0" encoding="UTF-8"?>
...
`,"buildSitemapXml"),Ks=Us(`${k}sitemap.xml`),Ds=Ls(k),Cn={linkset:[{anchor:k,"service-desc":[{href:`${k}.well-known/openapi.json`,type:"application/vnd.oai.openapi+json;version=3.1"}],"service-doc":[{href:`${k}llms.txt`,type:"text/plain"}],status:[{href:Ye,type:"application/health+json"}],"service-meta":[{href:`${k}.well-known/mcp/server-card.json`,type:"application/json"},{href:Ot,type:"application/json"}]}]},Tn={openapi:"3.1.0",info:{title:"Knowgrph API",version:"0.1.0",description:"Agent discovery surface for the Knowgrph Cloudflare deployment."},servers:[{url:W,description:"Knowgrph Cloudflare deployment"}],paths:Yo({appBasePath:E,appA2aAgentCardPath:wr,healthPath:Je})},it={resource:k,resource_name:"Knowgrph",authorization_servers:[W],scopes_supported:["knowgrph:read","knowgrph:source-files:read"],bearer_methods_supported:["header"],resource_documentation:`${k}llms.txt`},br=`${W}/cdn-cgi/access`,Te={skill:`${W}/auth.md`,register_uri:`${k}agent/auth`,claim_uri:`${k}agent/auth/claim`,revocation_uri:`${k}agent/auth/revoke`,identity_types_supported:["anonymous","identity_assertion"],anonymous:{credential_types_supported:["api_key"]},identity_assertion:{assertion_types_supported:["urn:ietf:params:oauth:token-type:id-jag","verified_email"],credential_types_supported:["access_token","api_key"]},events_supported:["https://schemas.workos.com/events/agent/auth/identity/assertion/revoked"],registration_status:"metadata_published_runtime_user_mediated"},wn={issuer:W,resource:it.resource,resource_name:it.resource_name,authorization_servers:it.authorization_servers,cloudflare_access_issuer:br,authorization_endpoint:`${br}/login`,token_endpoint:`${br}/token`,jwks_uri:`${k}.well-known/http-message-signatures-directory`,response_types_supported:["code"],grant_types_supported:["authorization_code","client_credentials"],token_endpoint_auth_methods_supported:["client_secret_basic","private_key_jwt"],scopes_supported:it.scopes_supported,agent_auth:Te},$s=`# Knowgrph auth.md
...
- Pipeline rule: agents must not bypass MainPanel -> FloatingPanel Chat -> KGC -> Canvas for user-mediated graph work; published HTTP MCP tools remain read-only until mutation auth and conflict semantics are implemented.`,vn={name:"Knowgrph Agent",description:"Agent-readable discovery, published-document retrieval, and WebMCP-ready metadata surface for Knowgrph.",version:"0.1.0",provider:{organization:"airvio / joohwee",url:k},url:`${k}mcp`,preferredTransport:"JSONRPC",supportedInterfaces:[{url:`${k}mcp`,protocolBinding:"JSONRPC",transportProtocol:"JSONRPC",description:"Primary machine interface for read-only discovery and source-file document access."},{url:Sr,protocolBinding:"HTTP+JSON/REST",transportProtocol:"HTTP+JSON/REST",description:"Published source-files index and storage-backed document read surface."}],capabilities:{streaming:!1,pushNotifications:!1,stateTransitionHistory:!1,extendedAgentCard:!1},defaultInputModes:["text/plain","text/markdown","application/json"],defaultOutputModes:["text/plain","text/markdown","application/json"],skills:qo(Mt)},Ae={serverInfo:{name:"knowgrph",version:"0.1.0"},transport:{type:xe,url:`${k}mcp`,stateless:!0},capabilities:{tools:Mt.map(e=>({name:e.name,title:e.title,description:e.description,inputSchema:e.inputSchema,outputSchema:e.outputSchema,securitySchemes:e.securitySchemes,annotations:e.annotations,_meta:e._meta})),resources:{listChanged:!1},prompts:{listChanged:!1},...ar()},prompts:bn,resourceTemplates:Pn,clientSetups:ir({baseUrl:k,mcpUrl:`${k}mcp`,serverName:"knowgrph"}),surfaceRoles:{publicReadMcpUrl:`${k}mcp`,publicReadMcpScope:"Canonical public install and discovery endpoint for read-only retrieval, prompt discovery, resource discovery, and inspection.",controlPlaneMcpUrl:`${k}control-plane/mcp`,controlPlaneMcpScope:"Approval-gated orchestration endpoint for control-plane tools, remote Agentic Canvas OS docs invocation, and spend-bearing workflows where deployed.",remoteGrammarInvokePublic:!0,remoteGrammarInvokeToolName:"knowgrph.agentic_canvas_os.docs.invoke",remoteGrammarInvokeStatus:"live-control-plane"},links:{apiCatalog:`${k}.well-known/api-catalog`,skills:`${k}.well-known/agent-skills/index.json`,status:Ye,agentCard:Ot,controlPlaneMcp:`${k}control-plane/mcp`}},Hs=kt({appUrl:k,updatedAt:Ee}),Rr=Mt.map(e=>({name:e.webName,title:e.title,description:e.description,inputSchema:e.inputSchema,outputSchema:e.outputSchema,securitySchemes:e.securitySchemes,annotations:e.annotations,_meta:e._meta})),$e=n(e=>ct(Mt.find(t=>t.name===e)?.webName),"findWebMcpToolName"),js=$e(u.search),Bs=$e(u.fetch),Gs=$e(u.listSourceFiles),Ws=$e(u.readSourceFile),Fs=$e(u.readSharedDocument),zs=$e(u.inspectSharedDocumentStructure),qs=$e(u.inspectAgentSurface),Vs=`(() => {
  ...
  const createPublishedDocIdentityResolver = ${on};
  ...
  const createPublishedAgentReadyToolExecutors = ${Ko};
  ...
  const toolExecutors = createPublishedAgentReadyToolExecutors({
    toolNames: {
      search: ${JSON.stringify(js)},
      fetch: ${JSON.stringify(Bs)},
      listSourceFiles: ${JSON.stringify(Gs)},
      readSourceFile: ${JSON.stringify(Ws)},
      readSharedDocument: ${JSON.stringify(Fs)},
      inspectSharedDocumentStructure: ${JSON.stringify(zs)},
      inspectAgentSurface: ${JSON.stringify(qs)},
    },
    defaultWorkspaceId,
...
})();`,Ys=n(async e=>{if(!(e.headers.get("content-type")||"").toLowerCase().includes("text/html"))return e;let r=await e.text();if(Rr.every(i=>r.includes(i.name)))return new Response(r,e);let o=`<script>${Vs}<\/script>`,a=r.includes("</head>")?r.replace("</head>",`${o}</head>`):`${r}${o}`,s=new Response(a,e);return s.headers.delete("content-length"),s},"injectWebMcpScript"),Js={search:u.search,fetch:u.fetch,listSourceFiles:u.listSourceFiles,readSourceFile:u.readSourceFile,readSharedDocument:u.readSharedDocument,inspectSharedDocumentStructure:u.inspectSharedDocumentStructure,inspectAgentSurface:u.inspectAgentSurface},Xs=n(async e=>{let t=new TextEncoder().encode(e),r=await crypto.subtle.digest("SHA-256",t);return[...new Uint8Array(r)].map(o=>o.toString(16).padStart(2,"0")).join("")},"sha256Hex"),On=zo(),Qs=Object.fromEntries(ot.map(e=>[e.name,Xs(On[e.name]||"")])),Sn=new Map(ot.map(e=>[`${E}${e.path}`.replace(/\/+$/,""),On[e.name]||""]));var In=n(async()=>Vo({appUrl:k,updatedAt:Ee,sha256ByName:Qs}),"agentSkillsIndex"),Zs={keys:[{kty:"OKP",crv:"Ed25519",kid:"knowgrph-agent-ready-2026-05-21",use:"sig",alg:"EdDSA",x:"11qYAYdkVKxA4G0wV47IxPtYfFVH_H7zmC2Di2PcvLU"}]},ei={protocolVersion:"2025-06-18",capabilities:{tools:{},resources:{},prompts:{listChanged:!1},...ar()},serverInfo:Ae.serverInfo},Ar=Ae.capabilities.tools,ti=[Hs],ri=bn,oi=Pn,Mn=n(()=>({status:"pass",service:"knowgrph-agent-ready-pages",homepage:k,health:Ye,updatedAt:Ee,checks:{linkHeaders:!0,markdownNegotiation:!0,httpMcp:!0,webMcp:!0,mcpApps:!0,commerce:{acp:!0,ucp:!0,mpp:!0,x402:!0},defaultWorkspaceId:nt}}),"buildHealthStatusBody"),ni=n(async()=>Lo({baseUrl:k,health:Mn(),apiCatalog:Cn,openApi:Tn,mcpServerCard:Ae,agentCard:vn,agentSkills:await In(),commerce:er({origin:W})}),"buildAgentSurfaceInspection"),ai=pr({toolNames:Js,defaultWorkspaceId:nt,publicBaseUrl:W,buildStorageDocPath:Rn,fetchSourceFilesIndexResponse:n(()=>fetch(`${vt}${sn()}`,{headers:{accept:"text/markdown"}}),"fetchSourceFilesIndexResponse"),fetchStorageMarkdownResponse:n(e=>fetch(`${vt}${e}`,{headers:{accept:"text/markdown"}}),"fetchStorageMarkdownResponse"),resolveSharedDocumentInput:n((e={})=>Ct({shareToken:e?.shareToken,shareUrl:e?.shareUrl,appBasePath:E,baseUrl:W}),"resolveSharedDocumentInput"),inspectSharedDocumentStructure:Do,buildAgentSurfaceInspection:ni}),kr=n(e=>{try{let t=new URL(e,W);return Ct({shareUrl:`${t.pathname}${t.search}`,baseUrl:W,appBasePath:E})}catch{return null}},"resolvePublishedDocRequestIdentity"),si=n(e=>Ct({shareUrl:String(e||""),baseUrl:W,appBasePath:E}),"resolvePublishedDocPathIdentity"),ii=n(async(e,t)=>{let r=new URL(Rn(t.canonicalPath,t.workspaceId),vt),o=await fetch(r,{method:"GET",headers:{accept:"text/markdown, text/plain;q=0.9, */*;q=0.1"}}),a=new Headers(o.headers),s=String(a.get("vary")||"");return a.set("vary",s?`${s}, Accept`:"Accept"),new Response(String(e.method||"").toUpperCase()==="HEAD"?null:o.body,{status:o.status,statusText:o.statusText,headers:a})},"proxyPublishedDocMarkdownResponse"),ci=n(async e=>{try{let t=await e.json();return t&&typeof t=="object"?t:null}catch{return null}},"readJsonRpcRequest"),Ce=n((e,t)=>pe(200,{jsonrpc:"2.0",id:e??null,result:t}),"jsonRpcResult"),Ne=n((e,t,r)=>pe(200,{jsonrpc:"2.0",id:e??null,error:{code:t,message:r}}),"jsonRpcError"),li=n(e=>String(e.headers.get("accept")||"").toLowerCase().split(",").some(t=>t.trim().startsWith("text/event-stream")),"requestAcceptsEventStream"),Pr=n((e,t)=>Object.prototype.hasOwnProperty.call(e,t),"hasOwnProperty"),Nn=n(e=>{if(Array.isArray(e))return e.length>0&&e.every(Nn);if(!e||typeof e!="object"||String(e.jsonrpc||"")!=="2.0")return!1;let t=typeof e.method=="string"&&e.method.length>0,r=Pr(e,"id"),o=Pr(e,"result")||Pr(e,"error");return t&&!r||!t&&o},"isJsonRpcNotificationOrResponse"),Un=n(async(e,t)=>{let r=ai[e];if(typeof r!="function")throw new Error(`unknown tool: ${e}`);return r(t)},"executeMcpTool"),pi=n(async e=>{let t=ct(e);if(t===le)return cr({appUrl:k,updatedAt:Ee,toolNames:Ar.map(o=>o.name)});let r=Ao(t);if(r){let o=await Un(u.fetch,{id:r});return ko({uri:t,sourceFile:o})}throw new Error(`unknown resource: ${e}`)},"readMcpResource"),ui=n(async e=>{let t=String(e.method||"GET").toUpperCase();if(t==="GET"||t==="HEAD")return li(e)?gn(405,{allow:"POST"}):_e({ok:!0,transport:Ae.transport,serverInfo:Ae.serverInfo,capabilities:Ae.capabilities,links:Ae.links,surfaceRoles:Ae.surfaceRoles});if(t!=="POST")return pe(405,{ok:!1,error:"unsupported_method"});let r=await ci(e);if(!r)return Ne(null,-32700,"Parse error");if(Nn(r))return gn(202);if(Array.isArray(r))return Ne(null,-32600,"Batch JSON-RPC requests are not supported");switch(r.method){case"initialize":return Ce(r.id,ei);case"tools/list":return Ce(r.id,{tools:Ar});case"prompts/list":return Ce(r.id,{prompts:ri});case"resources/templates/list":return Ce(r.id,{resourceTemplates:oi});case"prompts/get":{let o=ct(r.params?.name),a=r.params?.arguments&&typeof r.params.arguments=="object"?r.params.arguments:{};if(!o)return Ne(r.id,-32602,"Prompt name is required");try{return Ce(r.id,_o(o,a))}catch(s){return Ne(r.id,-32602,s instanceof Error?s.message:String(s))}}case"resources/list":return Ce(r.id,{resources:ti});case"resources/read":{let o=ct(r.params?.uri);if(!o)return Ne(r.id,-32602,"Resource URI is required");try{return Ce(r.id,await pi(o))}catch(a){return Ne(r.id,-32602,a instanceof Error?a.message:String(a))}}case"tools/call":{let o=ct(r.params?.name),a=r.params?.arguments&&typeof r.params.arguments=="object"?r.params.arguments:{};if(!o)return Ne(r.id,-32602,"Tool name is required");try{let s=await Un(o,a);return Ce(r.id,{content:[{type:"text",text:typeof s?.markdown=="string"?s.markdown:JSON.stringify(s,null,2)}],structuredContent:s,isError:!1})}catch(s){return Ce(r.id,{content:[{type:"text",text:s instanceof Error?s.message:String(s)}],isError:!0})}}default:return Ne(r.id,-32601,"Method not found")}},"handleMcpTransport"),di=n(()=>cr({appUrl:k,updatedAt:Ee,toolNames:Ar.map(e=>e.name)}).contents[0].text,"buildKnowgrphMcpAppHtmlBody");var xr=n(e=>e===E||e===`${E}/`,"handlesKnowgrphRoot"),mi=n(e=>xr(e)||!!si(e),"handlesKnowgrphHtmlSurface"),hi=n(e=>{let t=new URL(e.url),r=t.pathname.replace(/\/+$/,"")||"/",o=kr(e.url);return r===Je?"health":r===`${E}/mcp`?"mcp":En(r)?"github-workspace-write":r===`${E}/robots.txt`?"robots":r===`${E}/sitemap.xml`?"sitemap":r===`${E}/auth.md`||r==="/auth.md"?"auth-md":r.startsWith(`${E}/.well-known/`)?"well-known":o?at(e)?"shared-doc-markdown":"shared-doc-html":xr(t.pathname)?at(e)?"homepage-markdown":"homepage-html":"app-surface"},"resolveAgentReadyRouteTag"),It=n((e,t)=>hn(t,{owner:pn,tag:hi(e)}),"withKnowgrphRouteHeaders"),_n=n(async e=>{let t=new URL(e.url),r=t.pathname.replace(/\/+$/,"")||"/",o=kr(e.url);if(o&&at(e))return ii(e,o);if(xr(t.pathname)&&at(e))return mn(dn);switch(r){case Je:return ks(Mn());case`${E}/mcp`:return ui(e);case`${E}/robots.txt`:return st(Ks,"text/plain; charset=utf-8");case`${E}/sitemap.xml`:return st(Ds,"application/xml; charset=utf-8");case`${E}/auth.md`:case"/auth.md":return st($s,"text/markdown; charset=utf-8");case`${E}/.well-known/api-catalog`:return _e(Cn,"application/linkset+json; charset=utf-8");case`${E}/.well-known/openapi.json`:return _e(Tn,"application/vnd.oai.openapi+json; charset=utf-8");case wr:return _e(vn);case`${E}/.well-known/oauth-protected-resource`:return _e(it);case`${E}/.well-known/oauth-authorization-server`:return _e(wn);case`${E}/.well-known/openid-configuration`:return _e(wn);case`${E}/.well-known/mcp/server-card.json`:return _e(Ae);case`${E}/.well-known/mcp/apps/knowgrph-agent-ready.html`:return As(di());case`${E}/.well-known/mcp.json`:return _e(Ae);case`${E}/.well-known/agent-skills/index.json`:return _e(await In());case`${E}/.well-known/http-message-signatures-directory`:return _e(Zs);default:return Sn.has(r)?st(Sn.get(r),"text/markdown; charset=utf-8"):null}},"routeResponse");async function Ue(e){let{env:t,request:r}=e,o=String(r.method||"GET").toUpperCase(),a=new URL(r.url);if(o==="OPTIONS")return new Response(null,{status:204,headers:{"access-control-allow-origin":"*","access-control-allow-methods":"GET, HEAD, POST, OPTIONS","access-control-allow-headers":"*","access-control-max-age":"86400"}});if(o==="POST"&&a.pathname.replace(/\/+$/,"")===`${E}/mcp`)return It(r,await _n(r));if(o==="POST"&&En(a.pathname))return It(r,await Ns(r,t));if(o!=="GET"&&o!=="HEAD")return pe(405,{ok:!1,error:"unsupported_method"});let s=await _n(r);if(s){let p=It(r,s);return o==="HEAD"?new Response(null,p):p}let i=kr(r.url)?await Jo(e,E):await e.next();if(!mi(a.pathname))return i;let c=o==="HEAD"?i:await Ys(i),l=new Response(o==="HEAD"?null:c.body,c);return l.headers.set("link",un),It(r,l)}n(Ue,"onRequest");async function Ln(e){return Ue(e)}n(Ln,"onRequest");async function Kn(e){return Ue(e)}n(Kn,"onRequest");async function Dn(e){return Ue(e)}n(Dn,"onRequest");var gi=Object.freeze(new Set(["","80","443"])),fi=Object.freeze([".local",".localhost",".internal"]),yi=Object.freeze(new Set(["localhost"]));function He(e){return String(e||"").trim().toLowerCase()}n(He,"normalizeHostname");function wi(e){let t=He(e);if(!/^\d{1,3}(\.\d{1,3}){3}$/.test(t))return!1;let r=t.split(".").map(o=>Number(o));return r.length!==4?!1:r.every(o=>Number.isInteger(o)&&o>=0&&o<=255)}n(wi,"isIpv4Literal");function $n(e){let[t,r,o,a]=e.split(".").map(s=>Number(s));return(t<<24|r<<16|o<<8|a)>>>0}n($n,"ipv4ToInt");function Si(e,t,r){if(!Number.isInteger(r)||r<0||r>32)return!1;if(r===0)return!0;let o=4294967295<<32-r>>>0;return(e&o)===(t&o)}n(Si,"inIpv4Cidr");function _i(e){let t=He(e);return!t||!t.includes(":")?!1:/^[0-9a-f:]+$/i.test(t)}n(_i,"isIpv6Literal");function bi(e){let t=He(e);return!!(!t||t==="::1"||t==="0:0:0:0:0:0:0:1"||t.startsWith("fc")||t.startsWith("fd")||/^fe[89ab]/i.test(t))}n(bi,"isBlockedIpv6");function Pi(e,{blockedExact:t,blockedSuffixes:r}={}){let o=He(e);if(!o)return!0;let a=t||yi;if(a instanceof Set&&a.has(o))return!0;let s=r||fi;if(Array.isArray(s))for(let i of s){let c=He(i);if(c&&(o===c||o.endsWith(c)))return!0}return!1}n(Pi,"isBlockedHostname");function Ri(e){let t=He(e);if(!t)return!0;if(wi(t)){let r=$n(t),o=[{base:"0.0.0.0",bits:8},{base:"10.0.0.0",bits:8},{base:"127.0.0.0",bits:8},{base:"169.254.0.0",bits:16},{base:"172.16.0.0",bits:12},{base:"192.168.0.0",bits:16},{base:"100.64.0.0",bits:10}];for(let a of o){let s=$n(a.base);if(Si(r,s,a.bits))return!0}return!1}return _i(t)?bi(t):!1}n(Ri,"isBlockedIpLiteral");function Nt(e,{allowedPorts:t}={}){let r=String(e||"").trim();if(!r)throw new Error("invalid_url");let o;try{o=new URL(r)}catch{throw new Error("invalid_url")}if(o.protocol!=="http:"&&o.protocol!=="https:")throw new Error("invalid_url");if(o.username||o.password)throw new Error("invalid_url");let a=t||gi,s=String(o.port||"");if(a instanceof Set&&!a.has(s))throw new Error("port_not_allowed");let i=He(o.hostname);if(!i)throw new Error("invalid_url");if(Pi(i))throw new Error("blocked_host");if(Ri(i))throw new Error("blocked_host");return o}n(Nt,"parseAndValidateExternalUrl");function Ut(e){return String(e.headers.get("sec-fetch-site")||"").trim().toLowerCase()==="cross-site"}n(Ut,"shouldRejectCrossSiteFetch");var Ai={"content-type":"application/json; charset=utf-8","cache-control":"public, max-age=600"};function je(e,t={}){return new Response(JSON.stringify(e),{...t,headers:{...Ai,...t.headers||{}}})}n(je,"json");function Lt(...e){for(let t of e){if(!t)continue;let r=String(t).trim();if(r)return r}return null}n(Lt,"pickFirst");function ki(e){let t=e.slice(0,8e4),r=t.match(/<title[^>]*>([^<]*)<\/title>/i),o=t.match(/<meta[^>]+property=["']og:title["'][^>]*content=["']([^"']+)["'][^>]*>/i),a=t.match(/<meta[^>]+property=["']og:description["'][^>]*content=["']([^"']+)["'][^>]*>/i),s=t.match(/<meta[^>]+name=["']description["'][^>]*content=["']([^"']+)["'][^>]*>/i),i=t.match(/<meta[^>]+property=["']og:image["'][^>]*content=["']([^"']+)["'][^>]*>/i),c=t.match(/<meta[^>]+property=["']og:site_name["'][^>]*content=["']([^"']+)["'][^>]*>/i);return{title:Lt(o?.[1],r?.[1]),description:Lt(a?.[1],s?.[1]),image:Lt(i?.[1]),siteName:Lt(c?.[1])}}n(ki,"extractMeta");async function Hn(e){let t=e.request.url,r=new URL(t);if(r.searchParams.get("ping")==="1")return je({ok:!0,ping:!0});let o=r.searchParams.get("url")||"";if(Ut(e.request))return je({ok:!1,error:"forbidden"},{status:403,headers:{"cache-control":"no-store"}});let a;try{a=Nt(o)}catch{return je({ok:!1,error:"invalid_url"},{status:400,headers:{"cache-control":"no-store"}})}try{let s=await fetch(a.toString(),{headers:{"user-agent":"Mozilla/5.0 (compatible; HackaMapLinkPreview/1.0)",accept:"text/html,application/xhtml+xml"},redirect:"follow",cf:{cacheTtl:600,cacheEverything:!0}}),i=s.headers.get("content-type")||"";if(!s.ok)return je({ok:!1,error:"fetch_failed",status:s.status,url:a.toString()},{status:200,headers:{"cache-control":"no-store"}});if(!i.includes("text/html"))return je({ok:!0,url:a.toString(),domain:a.host,contentType:i,title:null,description:null,image:null,siteName:null});let c=await s.text(),l=ki(c);return je({ok:!0,url:a.toString(),domain:a.host,contentType:i,...l})}catch(s){return je({ok:!1,error:"exception",message:s?.message||String(s),url:a.toString()},{status:200,headers:{"cache-control":"no-store"}})}}n(Hn,"onRequestGet");var jn=35e4;function xi(e){let t=e;return t=t.replace(/<script\b[\s\S]*?<\/script>/gi,""),t=t.replace(/<iframe\b[\s\S]*?<\/iframe>/gi,""),t=t.replace(/<object\b[\s\S]*?<\/object>/gi,""),t=t.replace(/<embed\b[\s\S]*?>/gi,""),t=t.replace(/<noscript\b[\s\S]*?<\/noscript>/gi,""),t=t.replace(/\son[a-z]+\s*=\s*"[^"]*"/gi,""),t=t.replace(/\son[a-z]+\s*=\s*'[^']*'/gi,""),t}n(xi,"stripActiveContent");function Ei({url:e,title:t,innerHtml:r}){let o=t?String(t).slice(0,140):"Preview",a=String(e).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;");return`<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
...
</html>`}n(Ei,"buildWrapper");async function Bn(e){let r=new URL(e.request.url).searchParams.get("url")||"";if(Ut(e.request))return new Response("Forbidden",{status:403,headers:{"cache-control":"no-store"}});let o;try{o=Nt(r)}catch(a){let s=a instanceof Error?a.message:"invalid_url";return new Response(s,{status:400,headers:{"cache-control":"no-store"}})}try{let a=await fetch(o.toString(),{headers:{"user-agent":"Mozilla/5.0 (compatible; HackaMapLinkProxy/1.0)",accept:"text/html,application/xhtml+xml"},redirect:"follow",cf:{cacheTtl:600,cacheEverything:!0}}),s=a.headers.get("content-type")||"";if(!a.ok)return new Response(`Fetch failed (${a.status})`,{status:200,headers:{"content-type":"text/plain; charset=utf-8","cache-control":"no-store"}});if(!s.includes("text/html"))return new Response(`Unsupported content-type: ${s}`,{status:200,headers:{"content-type":"text/plain; charset=utf-8","cache-control":"public, max-age=600"}});let i=await a.text();i.length>jn&&(i=i.slice(0,jn));let l=i.match(/<title[^>]*>([^<]*)<\/title>/i)?.[1]?.trim()||o.host;i=xi(i),/<base\s/i.test(i)||(i=i.replace(/<head([^>]*)>/i,`<head$1><base href="${o.origin}/">`));let m=Ei({url:o.toString(),title:l,innerHtml:i});return new Response(m,{status:200,headers:{"content-type":"text/html; charset=utf-8","cache-control":"public, max-age=600","content-security-policy":"default-src 'none'; img-src https: data:; style-src 'unsafe-inline' https:; font-src https: data:; frame-ancestors 'self';"}})}catch(a){return new Response(`Exception: ${a?.message||String(a)}`,{status:200,headers:{"content-type":"text/plain; charset=utf-8","cache-control":"no-store"}})}}n(Bn,"onRequestGet");var Er="api.openai.com",Kt="api.miromind.ai",Dt="apihub.agnes-ai.com",$t="ark.ap-southeast.bytepluses.com",Cr="ark.eu-west.bytepluses.com",Wn=new Set(["localhost","127.0.0.1","0.0.0.0"]),ke=n(e=>String(e||"").trim().toLowerCase(),"normalizeHost"),be=n((e,t)=>String(e.get(t)||"").trim(),"readHeader"),Fn=n(e=>Wn.has(ke(e)),"isLocalHost"),Gn=n(e=>{let t=String(e||"").trim();if(!t)return new Set;let r=new Set;return t.split(",").map(o=>ke(o)).filter(Boolean).forEach(o=>r.add(o)),r},"parseCsvSet"),zn=n((e,{includeOpenAi:t=!1,includeMiroMind:r=!1,includeAgnes:o=!1,includeBytePlus:a=!1}={})=>{let s=Gn(e.KNOWGRPH_INTEGRATION_ALLOWED_HOSTS),i=Gn(e.KNOWGRPH_CHAT_PROXY_ALLOWED_HOSTS),c=s.size?s:i,l=c.size?c:new Set([...Wn]);return t&&l.add(Er),r&&l.add(Kt),o&&l.add(Dt),a&&(l.add($t),l.add(Cr)),l},"parseAllowedHosts"),ie=n(e=>{let t=be(e.headers,"origin");if(!t)return{};let r="";try{r=ke(new URL(t).host)}catch{return{}}let o=ke(new URL(e.url).host);return r===o||r.startsWith("localhost:")||r.startsWith("127.0.0.1:")?{"access-control-allow-origin":t,vary:"Origin"}:{}},"corsHeaders"),fe=n((e,t,r)=>new Response(JSON.stringify(t),{status:r,headers:{"content-type":"application/json; charset=utf-8","cache-control":"no-store",...ie(e)}}),"jsonResponse");var Ht={"content-type":"application/json; charset=utf-8","cache-control":"no-store"};function lt(e,t,r=200){return new Response(JSON.stringify(t),{status:r,headers:{...Ht,...ie(e)}})}n(lt,"jsonResponse");async function Ci(e){let t=new URL("/knowgrph/imports/hackamap/hackamap-graph.json",e.url),r=await fetch(t.toString(),{redirect:"follow"});return r.ok?await r.json():null}n(Ci,"fetchHackamapGraphJson");async function Be(e,t){let r=new URL(t,e.url),o=await fetch(r.toString(),{redirect:"follow"});return o.ok?await o.json():null}n(Be,"fetchHackamapJson");async function Ti(e){let t=await Be(e,"/knowgrph/imports/hackamap/hackamap_api_graph.json");return Jn(t)?t:null}n(Ti,"fetchHackamapApiGraphJson");async function vi(e){let t=await Be(e,"/knowgrph/imports/hackamap/hackamap_pipeline.json");return t&&typeof t=="object"&&!Array.isArray(t)?t:{}}n(vi,"fetchHackamapPipelineJson");async function Vn(e){let t=await Be(e,"/knowgrph/imports/hackamap/hackamap_query_presets.json");return Array.isArray(t)?t.filter(Boolean):[]}n(Vn,"fetchHackamapQueryPresetsJson");async function Yn(e){let t=await Be(e,"/knowgrph/imports/hackamap/query-outputs/query-runs.manifest.json");return t&&typeof t=="object"&&!Array.isArray(t)?t:{}}n(Yn,"fetchHackamapQueryRunsManifestJson");function Jn(e){return!e||typeof e!="object"||Array.isArray(e)?!1:Array.isArray(e.nodes)&&Array.isArray(e.edges)}n(Jn,"isApiGraphPayload");function Xn(e,t){let r=String(e&&e.output&&e.output.per_table_prefix||e?.id||t?.preset||"").trim(),o=String(t?.output_suffix||"").trim();return o?`${r}-${o}`:r}n(Xn,"buildHackamapTablePrefix");function Tr(e,t){if(!Array.isArray(e))return[];let r=[];for(let o of e){if(!o||typeof o!="object"||Array.isArray(o))continue;let a=String(o[t]||"").trim();a&&r.push(a)}return r}n(Tr,"collectRowIds");async function Oi(e,t){let r=await Be(e,t);return Array.isArray(r)?r.length:0}n(Oi,"countHackamapQueryRows");async function Ii(e,t,r){let o=Xn(t,r);if(!o)return{};let a=["events","demos","sources","organizer","team","techstack"],s=await Promise.all(a.map(async i=>[i,await Oi(e,`/knowgrph/imports/hackamap/query-outputs/${i}.${o}.query.json`)]));return Object.fromEntries(s.filter(([,i])=>i>0))}n(Ii,"readHackamapRunTableCounts");function vr(e){return Array.isArray(e)?e.map(vr):!e||typeof e!="object"?e:Object.fromEntries(Object.entries(e).sort(([t],[r])=>String(t).localeCompare(String(r))).map(([t,r])=>[t,vr(r)]))}n(vr,"sortObjectKeys");function Mi(e){try{return JSON.stringify(vr(e))}catch{return""}}n(Mi,"stableParamSignature");function Ni(e){return typeof e=="string"?{value:e,label:e}:{value:e,label:JSON.stringify(e)}}n(Ni,"toBuilderOption");function Ui(e,t){return e.map(r=>{let o=String(r?.id||"").trim();if(!o)return null;let a=r?.params&&typeof r.params=="object"&&!Array.isArray(r.params)?r.params:{},s=t.filter(l=>String(l?.preset||"").trim()===o),i=Array.from(new Set([...Object.keys(a),...s.flatMap(l=>l?.params&&typeof l.params=="object"&&!Array.isArray(l.params)?Object.keys(l.params):[])])).sort((l,p)=>String(l).localeCompare(String(p))),c=Object.fromEntries(i.map(l=>{let p=new Set,m=[],f=[a[l],...s.map(A=>A?.params&&typeof A.params=="object"&&!Array.isArray(A.params)?A.params[l]:void 0)];for(let A of f){if(typeof A>"u")continue;let _=Mi(A);!_||p.has(_)||(p.add(_),m.push(Ni(A)))}return[l,m]}));return{id:o,title:String(r?.title||o).trim(),params:a,param_keys:i,published_param_options:c}}).filter(Boolean)}n(Ui,"buildHackamapPresetRuntimeEntries");async function Li(e){let[t,r,o]=await Promise.all([vi(e),Vn(e),Yn(e)]),a=t&&typeof t=="object"?t.runtime||{}:{},s=String(a?.query_selection?.default_run_id||"").trim()||"enhanced",i=Array.isArray(o?.runs)?o.runs:[],c=(await Promise.all(i.map(async l=>{let p=String(l?.id||"").trim(),m=String(l?.preset||"").trim();if(!p)return null;let f=r.find(_=>String(_?.id||"").trim()===m),A=await Ii(e,f,l);return{id:p,preset:m,title:String(l?.title||l?.id||"").trim(),params:l?.params&&typeof l.params=="object"&&!Array.isArray(l.params)?l.params:{},output_suffix:String(l?.output_suffix||"").trim(),is_default:p===s,table_counts:A}}))).filter(l=>l?.id);return{ok:!0,runtime:{...a&&typeof a=="object"?a:{},presets:Ui(r,c),runs:c}}}n(Li,"buildHackamapRuntimeMeta");async function Ki(e,t){let r=String(t||"").trim();if(!r)return null;let[o,a]=await Promise.all([Vn(e),Yn(e)]),i=(Array.isArray(a?.runs)?a.runs:[]).find(x=>String(x?.id||"").trim()===r);if(!i)return null;let c=o.find(x=>String(x?.id||"").trim()===String(i?.preset||"").trim()),l=Xn(c,i);if(!l)return null;let[p,m]=await Promise.all([Be(e,`/knowgrph/imports/hackamap/query-outputs/events.${l}.query.json`),Be(e,`/knowgrph/imports/hackamap/query-outputs/demos.${l}.query.json`)]),f=new Set(Tr(p,"id")),A=new Set(Tr(m,"id")),_=Tr(m,"event_id");for(let x of _)f.add(x);return{eventIds:f,demoIds:A}}n(Ki,"readHackamapQueryRunSelection");function qn(e,t,r){if(!r||!Jn(e))return e;if(r.eventIds.size===0&&r.demoIds.size===0)return{...e,meta:{...e?.meta&&typeof e.meta=="object"?e.meta:{},selected_run_id:t,selected_run_filter_skipped:"no-event-demo-rows"}};let o=new Set;r.eventIds.forEach(c=>o.add(`Event:${c}`)),r.demoIds.forEach(c=>o.add(`Demo:${c}`));let a=Array.isArray(e.nodes)?e.nodes.filter(c=>o.has(String(c?.id||"").trim())):[],s=new Set(a.map(c=>String(c?.id||"").trim()).filter(Boolean)),i=Array.isArray(e.edges)?e.edges.filter(c=>s.has(String(c?.source||"").trim())&&s.has(String(c?.target||"").trim())):[];return{...e,nodes:a,edges:i,meta:{...e?.meta&&typeof e.meta=="object"?e.meta:{},selected_run_id:t,selected_event_count:r.eventIds.size,selected_demo_count:r.demoIds.size,total_problems:a.filter(c=>String(c?.type||"").trim()==="problem").length,total_solutions:a.filter(c=>String(c?.type||"").trim()==="solution").length}}}n(qn,"filterHackamapApiGraphPayloadByRun");function Di(e){let t=Array.isArray(e?.nodes)?e.nodes:[],r=Array.isArray(e?.links)?e.links:[],o=[],a=new Set;for(let i of t){let c=String(i?.id||"").trim(),l=String(i?.type||"").trim(),p=String(i?.label||"").trim();if(!(!c||!l||!p)){if(l==="Event"){o.push({id:c,type:"problem",label:p,cluster:"Event"}),a.add(c);continue}l==="Demo"&&(o.push({id:c,type:"solution",label:p,cluster:"Demo"}),a.add(c))}}let s=[];for(let i of r){let c=String(i?.source||"").trim(),l=String(i?.target||"").trim(),p=String(i?.type||"").trim();!c||!l||p==="has_demo"&&(!a.has(c)||!a.has(l)||s.push({source:c,target:l,type:"has_demo",strength:.35}))}return{nodes:o,edges:s,meta:{source:"hackamap-graph.json:fallback",total_problems:o.filter(i=>i.type==="problem").length,total_solutions:o.filter(i=>i.type==="solution").length,...e?.content_signature?{content_signature:String(e.content_signature)}:{}}}}n(Di,"toBipartiteApiPayload");async function Qn(e){let{request:t}=e,r=String(t.method||"GET").toUpperCase(),o=new URL(t.url);if(r==="OPTIONS")return new Response(null,{status:204,headers:{...ie(t),"access-control-allow-methods":"GET, HEAD, OPTIONS","access-control-allow-headers":"*","access-control-max-age":"86400"}});if(r!=="GET"&&r!=="HEAD")return lt(t,{ok:!1,error:"unsupported_method"},405);if(String(o.searchParams.get("view")||"").trim().toLowerCase()==="meta"){let m=await Li(t);return r==="HEAD"?new Response(null,{status:200,headers:{...Ht,...ie(t)}}):lt(t,m,200)}let a=String(o.searchParams.get("run")||"").trim(),s=await Ki(t,a),i=await Ti(t);if(i){let m=qn(i,a,s);return r==="HEAD"?new Response(null,{status:200,headers:{...Ht,...ie(t)}}):lt(t,m,200)}let c=await Ci(t);if(!c)return lt(t,{ok:!1,error:"missing_hackamap_graph",hint:"/knowgrph/imports/hackamap/{hackamap_api_graph.json,hackamap-graph.json} not found"},404);let l=Di(c),p=qn(l,a,s);return r==="HEAD"?new Response(null,{status:200,headers:{...Ht,...ie(t)}}):lt(t,p,200)}n(Qn,"onRequest");var $i=!0,Zn=600,ea={"content-type":"application/json; charset=utf-8","cache-control":`public, max-age=${Zn}`};function Ge(e,t,r={}){return new Response(JSON.stringify(t),{...r,headers:{...ea,...r.headers||{},...ie(e)}})}n(Ge,"jsonResponse");function Hi(e){try{let t=new URL(String(e));return t.protocol==="http:"||t.protocol==="https:"}catch{return!1}}n(Hi,"isHttpUrl");function pt(e){return String(e||"").trim().toLowerCase()}n(pt,"normalizeHost");function Or(e,{exact:t,suffixes:r}){let o=pt(e);return o?!!(Array.isArray(t)&&t.some(a=>o===pt(a))||Array.isArray(r)&&r.some(a=>o===pt(a)||o.endsWith(`.${pt(a)}`))):!1}n(Or,"isHostMatch");function ji(e){let t=pt(e.hostname),r=e.toString();return Or(t,{suffixes:["linkedin.com"]})?new URL(`https://www.linkedin.com/embeds/oembed.json?url=${encodeURIComponent(r)}`):Or(t,{exact:["twitter.com","x.com"],suffixes:["twitter.com","x.com"]})?new URL(`https://publish.twitter.com/oembed?omit_script=1&url=${encodeURIComponent(r)}`):Or(t,{exact:["reddit.com"],suffixes:["reddit.com"]})?new URL(`https://www.reddit.com/oembed?url=${encodeURIComponent(r)}`):null}n(ji,"buildOembedUpstreamUrl");async function Bi({upstreamUrl:e}){return await fetch(e.toString(),{headers:{"user-agent":"Mozilla/5.0 (compatible; OEmbedProxy/1.0)",accept:"application/json,text/json;q=0.9,*/*;q=0.1"},redirect:"follow",cf:{cacheTtl:Zn,cacheEverything:!0}})}n(Bi,"fetchJsonUpstream");async function ta(e){let{request:t}=e,r=String(t.method||"GET").toUpperCase(),o=new URL(t.url);if(r==="OPTIONS")return new Response(null,{status:204,headers:{...ie(t),"access-control-allow-methods":"GET, HEAD, OPTIONS","access-control-allow-headers":"*","access-control-max-age":"86400"}});if(!["GET","HEAD"].includes(r))return Ge(t,{ok:!1,error:"unsupported_method"},{status:405});if(o.searchParams.get("ping")==="1")return Ge(t,{ok:!0,ping:!0});if($i)return Ge(t,{ok:!1,error:"disabled_by_policy"},{status:200,headers:{"cache-control":"no-store"}});let a=o.searchParams.get("url")||"";if(!Hi(a))return Ge(t,{ok:!1,error:"invalid_url"},{status:400,headers:{"cache-control":"no-store"}});let s;try{s=new URL(a)}catch{return Ge(t,{ok:!1,error:"invalid_url"},{status:400,headers:{"cache-control":"no-store"}})}let i=ji(s);if(!i)return Ge(t,{ok:!1,error:"unsupported_provider"},{status:400,headers:{"cache-control":"no-store"}});let c=await Bi({upstreamUrl:i}),l=new Headers(c.headers);l.delete("content-length"),l.set("cache-control",c.ok?ea["cache-control"]:"no-store");for(let[m,f]of Object.entries(ie(t)))l.set(m,f);if(r==="HEAD")return new Response(null,{status:c.status,headers:l});let p=await c.text();try{JSON.parse(p)}catch{return Ge(t,{ok:!1,error:"invalid_upstream_json",status:c.status},{status:502,headers:{"cache-control":"no-store"}})}return l.set("content-type","application/json; charset=utf-8"),new Response(p,{status:c.status,headers:l})}n(ta,"onRequest");var ra="/__chat_proxy",jt="agnes-ai",Bt="byteplus-modelark",Gt="miromind",Gi=n(e=>{let t=ke(e);return t==="openai"?"openai":t===Bt||t==="byteplus"?Bt:t===Gt||t==="miromind-api"?Gt:t===jt||t==="agnes"||t==="agnes-ai-api"?jt:t},"normalizeProviderId"),Wi=n(e=>ke(e)===Dt,"isAgnesHost"),Fi=n(e=>{let t=ke(e);return t===$t||t===Cr},"isBytePlusHost"),zi=n(e=>ke(e)===Kt,"isMiroMindHost"),qi=n(({provider:e,requestedUpstream:t,env:r})=>e==="openai"?"https://api.openai.com":e===Gt?t||`https://${Kt}`:e===jt?t||`https://${Dt}`:e===Bt?t||String(r.KNOWGRPH_CHAT_PROXY_UPSTREAM||"").trim()||`https://${$t}`:t||String(r.KNOWGRPH_CHAT_PROXY_UPSTREAM||"").trim(),"pickUpstreamBase");async function oa(e){let{request:t,env:r}=e,o=String(t.method||"GET").toUpperCase(),a=new URL(t.url);if(o==="OPTIONS")return new Response(null,{status:204,headers:{"access-control-allow-origin":be(t.headers,"origin")||"*","access-control-allow-methods":"GET, HEAD, POST, OPTIONS","access-control-allow-headers":"*","access-control-max-age":"86400"}});if(!["GET","HEAD","POST"].includes(o))return fe(t,{ok:!1,error:"Unsupported method"},405);let s=Gi(be(t.headers,"x-kg-chat-provider")),i=qi({provider:s,requestedUpstream:be(t.headers,"x-kg-chat-upstream"),env:r});if(!i)return fe(t,{ok:!1,error:"Missing chat proxy upstream configuration"},500);let c;try{c=new URL(i)}catch{return fe(t,{ok:!1,error:"Invalid chat proxy upstream configuration"},500)}let l=zn(r,{includeOpenAi:!0,includeMiroMind:!0,includeAgnes:!0,includeBytePlus:!0}),p=ke(c.hostname);if(!l.has(p))return fe(t,{ok:!1,error:"Chat proxy upstream host is not allowed"},403);if(!Fn(p)&&c.protocol!=="https:")return fe(t,{ok:!1,error:"Chat proxy requires HTTPS for non-local upstream hosts"},403);let m=s==="openai"||p===Er,f=s===Gt||zi(p),A=s===jt||Wi(p),_=s===Bt||Fi(p),x=be(t.headers,"x-kg-chat-api-key"),$=String(r.KNOWGRPH_CHAT_PROXY_OPENAI_API_KEY||r.OPENAI_API_KEY||"").trim(),K=String(r.KNOWGRPH_CHAT_PROXY_MIROMIND_API_KEY||r.MIROMIND_API_KEY||"").trim(),F=String(r.KNOWGRPH_CHAT_PROXY_AGNES_API_KEY||r.AGNES_API_KEY||"").trim(),ee=String(r.KNOWGRPH_CHAT_PROXY_BYTEPLUS_API_KEY||r.BYTEPLUS_API_KEY||"").trim(),z=(x||$).slice(0,512),C=(x||K).slice(0,512),O=(x||F).slice(0,512),Q=(x||ee).slice(0,512),U=_?Q:A?O:f?C:z;if(m&&!z)return fe(t,{ok:!1,error:"Missing OpenAI API key for chat proxy upstream (set KNOWGRPH_CHAT_PROXY_OPENAI_API_KEY or OPENAI_API_KEY)"},401);if(f&&!U)return fe(t,{ok:!1,error:"Missing MiroMind API key for chat proxy upstream (set KNOWGRPH_CHAT_PROXY_MIROMIND_API_KEY or MIROMIND_API_KEY)"},401);if(A&&!U)return fe(t,{ok:!1,error:"Missing Agnes API key for chat proxy upstream (set KNOWGRPH_CHAT_PROXY_AGNES_API_KEY or AGNES_API_KEY)"},401);if(_&&!U)return fe(t,{ok:!1,error:"Missing BytePlus API key for chat proxy upstream (set KNOWGRPH_CHAT_PROXY_BYTEPLUS_API_KEY or BYTEPLUS_API_KEY)"},401);if(o==="POST"&&!be(t.headers,"content-type").toLowerCase().includes("application/json"))return fe(t,{ok:!1,error:"Chat proxy expects application/json payloads"},415);let re=a.pathname.startsWith(ra)&&a.pathname.slice(ra.length)||"/v1/chat/completions",M=re.startsWith("/")?re:`/${re}`,N=new URL(`${M}${a.search||""}`,c),B=new Headers,ae=be(t.headers,"content-type"),de=be(t.headers,"accept");ae&&B.set("content-type",ae),de&&B.set("accept",de),(m||f||A||_)&&B.set("authorization",`Bearer ${U}`);let ye=be(t.headers,"x-client-request-id").slice(0,512);ye&&B.set("x-client-request-id",ye);let R=new AbortController,w=Number(r.KNOWGRPH_CHAT_PROXY_TIMEOUT_MS),y=Number.isFinite(w)?Math.max(5e3,Math.min(18e4,Math.floor(w))):9e4,d=setTimeout(()=>R.abort(),y);try{let h=await fetch(N.toString(),{method:o,headers:B,body:o==="GET"||o==="HEAD"?void 0:t.body,signal:R.signal,redirect:"follow"}),g=new Headers(h.headers);g.delete("content-length"),g.delete("www-authenticate"),g.set("cache-control","no-store");let b=be(t.headers,"origin");return b&&(g.set("access-control-allow-origin",b),g.set("vary","Origin")),o==="HEAD"?new Response(null,{status:h.status,statusText:h.statusText,headers:g}):new Response(h.body,{status:h.status,statusText:h.statusText,headers:g})}catch(h){let g=h&&typeof h=="object"&&"message"in h?String(h.message||""):"",b=R.signal.aborted||/aborted|timeout/i.test(g);return fe(t,{ok:!1,error:g||"Failed to reach chat upstream"},b?504:502)}finally{clearTimeout(d)}}n(oa,"onRequest");function Vi(e){let t=e.map(r=>r==null?"":typeof r=="boolean"?r?"1":"0":typeof r=="number"?Number.isFinite(r)?String(r):"":String(r)).join("|");return`rich-media-preview:${Ze(t)}`}n(Vi,"buildRichMediaPreviewSemanticKey");var aa="png";function ut(e){let t=typeof e=="number"?e:Number(String(e??"").trim());if(!Number.isFinite(t))return null;let r=Math.max(0,Number(t.toFixed(3)));return Number.isFinite(r)?r:null}n(ut,"normalizeRemoteVideoFrameSeconds");function Yi(e){return String(ut(e)??0).replace(/\./g,"_")}n(Yi,"formatRemoteVideoFrameSecondsForFileName");function Ft(e){let t=String(e||"").trim().toLowerCase();return t==="jpg"||t==="jpeg"?"jpg":"png"}n(Ft,"normalizeRemoteVideoFrameFormat");function Ir(e){let t=String(e.sourceUrl||"").trim(),r=ut(e.timeSeconds)??0,o=Ft(e.format||aa);return Vi(["remote-video-frame",t,r,o])}n(Ir,"buildRemoteVideoFrameSemanticKey");function sa(e){let t=ut(e.timeSeconds)??0,r=Ft(e.format||aa),o=Ir({...e,timeSeconds:t,format:r});return`frame-${o.split(":").pop()||Ze(o)}-t${Yi(t)}.${r}`}n(sa,"buildRemoteVideoFrameFileName");var Wt=n(e=>{let t=String(e||"").trim();return t&&/^[A-Za-z0-9_-]{6,128}$/.test(t)?t:null},"normalizeYouTubeIdLikeValue"),na=n(e=>{try{let t=new URL(String(e||"").trim()),r=String(t.hostname||"").toLowerCase();if(r==="youtu.be"||r.endsWith(".youtu.be")){let o=t.pathname.replace(/^\/+/,"").split("/")[0]?.trim()||"";return Wt(o)}if(r==="youtube.com"||r.endsWith(".youtube.com")||r==="youtube-nocookie.com"||r.endsWith(".youtube-nocookie.com")){let o=String(t.searchParams.get("v")||"").trim();if(o)return Wt(o);let a=t.pathname.split("/").filter(Boolean),s=a[0]||"",i=a[1]||"";if((s==="embed"||s==="shorts"||s==="live")&&i)return Wt(i);if(s==="watch"){let c=String(t.searchParams.get("v")||"").trim();return Wt(c)}}}catch{return null}return null},"readYouTubeIdFromUrl");function Ji(e){let t=String(e||"").trim().replace(/^<|>$/g,"").trim();for(;/[),.;:!?]$/.test(t);){let r=t.slice(0,-1).trim();if(!r)break;let o=na(t),a=na(r);if(!a||o&&o!==a)break;t=r}return t}n(Ji,"stripYouTubeUrlTrailingPunctuation");function ia(e){let t=n(r=>{let o=String(r||"").trim();if(!o)return null;if(/^\d+$/.test(o))return Number(o);let a=o.match(/^(?:(\d+)h)?(?:(\d+)m)?(?:(\d+)s)?$/i);if(!a)return null;let s=a[1]?Number(a[1]):0,i=a[2]?Number(a[2]):0,c=a[3]?Number(a[3]):0,l=s*3600+i*60+c;return l>0&&Number.isFinite(l)?l:null},"parseChunk");try{let r=new URL(Ji(e)),o=r.searchParams.get("t")||r.searchParams.get("start")||"",a=r.hash&&new URLSearchParams(r.hash.replace(/^#/,"")).get("t")||"";return t(o)??t(a)}catch{return null}}n(ia,"parseYouTubeStartSeconds");var Xi="/image/knowgrph/video-frame",Qi=4096,Zi=720*60,ec=/^frame-[a-f0-9]+-t\d+\.(?:png|jpg)$/i,Lr={"access-control-allow-origin":"*","access-control-allow-methods":"GET, HEAD, OPTIONS","access-control-allow-headers":"accept, content-type"},Ur=n(e=>String(e||"").replace(/\s+/g," ").trim(),"cleanText"),Mr=n((e,t=200,r="GET")=>new Response(r==="HEAD"?null:JSON.stringify(e),{status:t,headers:{...Lr,"content-type":"application/json; charset=utf-8","cache-control":"no-store"}}),"jsonResponse"),Nr=n((e,t=200,r="GET")=>new Response(r==="HEAD"?null:e,{status:t,headers:{...Lr,"content-type":"text/plain; charset=utf-8","cache-control":"no-store"}}),"textResponse"),tc=n((e,t)=>e===t||e.endsWith(`.${t}`),"hostMatches"),rc=n(e=>{let t=Ur(e?.KG_VIDEO_FRAME_ALLOWED_HOSTS);return t?t.split(",").map(r=>Ur(r).toLowerCase()).filter(Boolean):["youtube.com","youtu.be","youtube-nocookie.com","bilibili.com","b23.tv"]},"readAllowedHosts"),oc=n(e=>Ur(e).replace(/^<|>$/g,"").trim(),"unwrapUrlInput"),nc=n((e,t)=>{try{let r=new URL(e);if(r.protocol!=="https:"&&r.protocol!=="http:")return!1;let o=r.hostname.toLowerCase();return rc(t).some(a=>tc(o,a))}catch{return!1}},"isAllowedSourceUrl"),ac=n((e,t)=>{let r=new URL(e.url),o=oc(r.searchParams.get("url")||"");if(!o)return{error:"Missing url parameter"};if(o.length>Qi)return{error:"Video URL is too long"};if(!nc(o,t))return{error:"Video frame extraction is limited to supported remote video hosts"};let a=ut(r.searchParams.get("time"))??ia(o);if(a==null)return{error:"Missing time parameter"};let s=Math.min(Zi,Math.max(0,a)),i=Ft(r.searchParams.get("format")||"png"),c=sa({sourceUrl:o,timeSeconds:s,format:i});if(!ec.test(c))return{error:"Invalid frame cache key"};let l=`${Xi}/${c}`;return{sourceUrl:o,timeSeconds:s,format:i,fileName:c,publicUrl:l,semanticKey:Ir({sourceUrl:o,timeSeconds:s,format:i})}},"readFrameRequest"),sc=n(async(e,t,r)=>{let o=new URL(t,e.request.url),a=new Request(o.toString(),{method:r});return typeof e.env?.ASSETS?.fetch=="function"?await e.env.ASSETS.fetch(a):await fetch(a)},"fetchStaticAsset"),ic=n(e=>`Frame has not been generated yet. Run the local video-frame extractor and publish ${e.publicUrl}.`,"missingFrameMessage"),cc=n((e,t)=>{let r=new Headers;r.set("content-type",t.format==="jpg"?"image/jpeg":"image/png"),r.set("cache-control","public, max-age=31536000, immutable"),r.set("access-control-allow-origin","*");let o=e.headers.get("content-length");o&&r.set("content-length",o);let a=e.headers.get("etag");return a&&r.set("etag",a),r},"imageResponseHeaders");async function ca(e){let t=e.request;if(t.method==="OPTIONS")return new Response(null,{status:204,headers:Lr});if(t.method!=="GET"&&t.method!=="HEAD")return Nr("Method not allowed",405,t.method);let r=new URL(t.url).searchParams.get("emit")==="json",o=ac(t,e.env||{});if("error"in o)return r?Mr({ok:!1,error:o.error},400,t.method):Nr(o.error,400,t.method);let a=r&&t.method!=="HEAD"?"GET":r||t.method==="HEAD"?"HEAD":"GET",s=await sc(e,o.publicUrl,a);if(!s.ok){let i=ic(o);return r?Mr({ok:!1,error:i,publicUrl:o.publicUrl,semanticKey:o.semanticKey},404,t.method):Nr(i,404,t.method)}if(r){let i=Number(s.headers.get("content-length")||0);return(!Number.isFinite(i)||i<=0)&&t.method!=="HEAD"&&(i=(await s.arrayBuffer()).byteLength),Mr({ok:!0,imageUrl:o.publicUrl,publicUrl:o.publicUrl,semanticKey:o.semanticKey,cached:!0,bytes:Number.isFinite(i)?Math.max(0,Math.floor(i)):0,timeSeconds:o.timeSeconds,format:o.format},200,t.method)}return new Response(t.method==="HEAD"?null:s.body,{status:200,headers:cc(s,o)})}n(ca,"onRequest");var la={"content-type":"application/json; charset=utf-8","cache-control":"no-store","access-control-allow-origin":"*","access-control-allow-methods":"GET, HEAD, POST, OPTIONS","access-control-allow-headers":"content-type"},zt=n((e,t=200,r="GET")=>new Response(r==="HEAD"?null:JSON.stringify(e),{status:t,headers:la}),"jsonResponse"),Z=n(e=>String(e||"").replace(/\s+/g," ").trim(),"cleanText"),lc=n(e=>{try{let t=new URL(String(e||"").trim());if(/youtu\.be$/i.test(t.hostname))return Z(t.pathname.split("/").filter(Boolean)[0]);if(/youtube\.com$/i.test(t.hostname)||/youtube-nocookie\.com$/i.test(t.hostname)){let r=Z(t.searchParams.get("v"));if(r)return r;let o=t.pathname.split("/").filter(Boolean),a=o.findIndex(s=>["embed","shorts","live"].includes(s));if(a>=0)return Z(o[a+1])}}catch{}return""},"readVideoId"),pc=n((e,t)=>{let r=e.indexOf(t);if(r<0)return null;let o=e.indexOf("{",r);if(o<0)return null;let a=0,s=!1,i=!1;for(let c=o;c<e.length;c+=1){let l=e[c];if(s){i?i=!1:l==="\\"?i=!0:l==='"'&&(s=!1);continue}if(l==='"')s=!0;else if(l==="{")a+=1;else if(l==="}"&&(a-=1,a===0))return e.slice(o,c+1)}return null},"extractJsonAfter"),uc=n(e=>{for(let t of["ytInitialPlayerResponse =","ytInitialPlayerResponse="]){let r=pc(e,t);if(r)try{return JSON.parse(r)}catch{}}return null},"parsePlayerResponse"),dc=n((e,t)=>{let r=Z(t||"en").toLowerCase();return e.find(o=>Z(o.languageCode).toLowerCase()===r)||e.find(o=>Z(o.languageCode).toLowerCase().startsWith(r.split("-")[0]))||e.find(o=>Z(o.kind)!=="asr")||e[0]||null},"pickCaptionTrack"),mc=n(e=>{let t=new URL(e);return t.searchParams.set("fmt","json3"),t.toString()},"withJsonCaptionFormat"),hc=n(e=>(Array.isArray(e?.events)?e.events:[]).map(r=>{let o=Array.isArray(r.segs)?Z(r.segs.map(i=>i?.utf8||"").join("")):"",a=Number(r.tStartMs)/1e3,s=Number(r.dDurationMs||0)/1e3;return o&&Number.isFinite(a)?{text:o,start:a,duration:Number.isFinite(s)?s:0}:null}).filter(Boolean),"parseCaptionJson3"),gc=n(e=>String(e||"").replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&quot;/g,'"').replace(/&#39;|&apos;/g,"'"),"decodeXmlText"),fc=n(e=>{let t=[],r=/<text\b([^>]*)>([\s\S]*?)<\/text>/gi,o=null;for(;o=r.exec(String(e||""));){let a=o[1]||"",s=Number(a.match(/\bstart="([^"]+)"/i)?.[1]),i=Number(a.match(/\bdur="([^"]+)"/i)?.[1]||0),c=Z(gc(o[2]||""));c&&Number.isFinite(s)&&t.push({text:c,start:s,duration:Number.isFinite(i)?i:0})}return t},"parseCaptionXml"),yc=n((e,t)=>{let r=String(e||"").trim();if(!r)return[];if(String(t||"").toLowerCase().includes("json")||r.startsWith("{")||r.startsWith("["))try{return hc(JSON.parse(r))}catch{return[]}return fc(r)},"parseCaptionResponseText"),wc=n(e=>{let t=Math.max(0,Math.floor(Number(e)||0)),r=Math.floor(t/60),o=String(t%60).padStart(2,"0");return`${r}:${o}`},"formatTimestamp"),Sc=n((e,t)=>{let r=new URL(e);return r.searchParams.set("t",`${Math.max(0,Math.floor(Number(t)||0))}s`),r.toString()},"timestampUrl"),_c=n(({title:e,sourceUrl:t,videoId:r,authorName:o,thumbnailUrl:a,segments:s})=>[`# ${e||`YouTube ${r}`}`,"",`Video ID: ${r}`,o?`Author: ${o}`:"",`Source: [${t}](${t})`,a?`[![${e||r}](${a})](${t})`:"","",s.length>0?"## Transcript":"## Video Source","",...s.length>0?s.map(i=>`[${wc(i.start)}](${Sc(t,i.start)}) ${i.text}`):["Captions were not available from the source at import time.","The source URL, title, author, and thumbnail remain available for downstream storyboard reconstruction."],""].filter(i=>i!=="").join(`
`),"buildMarkdown"),Kr=n(({videoId:e,sourceUrl:t,title:r,authorName:o,thumbnailUrl:a,lang:s,languageCode:i,segments:c,captionStatus:l})=>{let p={type:"rag:YouTubeTranscript",video_id:e,source_url:t,title:r,author_name:o,thumbnail_url:a,language_code:Z(i)||s,caption_status:l,segment_count:c.length,duration:c.reduce((m,f)=>Math.max(m,f.start+f.duration),0),segments:c};return{ok:!0,name:`youtube-${e.toLowerCase()}.md`,markdown:_c({title:r,sourceUrl:t,videoId:e,authorName:o,thumbnailUrl:a,segments:c}),transcript:p}},"buildPayload");async function bc({sourceUrl:e,lang:t="en",fetchImpl:r=fetch}){let o=lc(e);if(!o)return{ok:!1,error:"unsupported_youtube_url"};let a=`https://www.youtube.com/watch?v=${encodeURIComponent(o)}`,[s,i]=await Promise.all([r(`https://www.youtube.com/oembed?url=${encodeURIComponent(a)}&format=json`,{headers:{accept:"application/json"}}).catch(()=>null),r(a,{headers:{accept:"text/html,application/xhtml+xml","accept-language":"en-US,en;q=0.9","user-agent":"Mozilla/5.0 Knowgrph YouTube transcript importer"}})]),c=s?.ok?await s.json().catch(()=>({})):{},l=i.ok?uc(await i.text()):null,p=Z(c.title)||Z(l?.videoDetails?.title)||`YouTube ${o}`,m=Z(c.author_name)||Z(l?.videoDetails?.author),f=Z(c.thumbnail_url)||`https://i.ytimg.com/vi/${o}/hqdefault.jpg`;if(!i.ok)return Kr({videoId:o,sourceUrl:a,title:p,authorName:m,thumbnailUrl:f,lang:t,languageCode:t,segments:[],captionStatus:`watch-fetch-${i.status}`});let A=l?.captions?.playerCaptionsTracklistRenderer?.captionTracks||[],_=dc(Array.isArray(A)?A:[],t);if(!_?.baseUrl)return Kr({videoId:o,sourceUrl:a,title:p,authorName:m,thumbnailUrl:f,lang:t,languageCode:t,segments:[],captionStatus:"captions-unavailable"});let x=await r(mc(_.baseUrl),{headers:{accept:"application/json,text/xml,text/plain,*/*","user-agent":"Mozilla/5.0 Knowgrph YouTube transcript importer"}}).catch(()=>null),$=x?await x.text().catch(()=>""):"",K=x?.ok?yc($,x.headers.get("content-type")):[],F=K.length>0?"available":x?.ok?"captions-empty":`captions-fetch-${x?.status||"failed"}`;return Kr({videoId:o,sourceUrl:a,title:p,authorName:m,thumbnailUrl:f,lang:t,languageCode:_.languageCode,segments:K,captionStatus:F})}n(bc,"buildYouTubeTranscriptPayload");async function pa(e){let t=e.request,r=String(t.method||"GET").toUpperCase();if(r==="OPTIONS")return new Response(null,{status:204,headers:la});if(r!=="GET"&&r!=="HEAD"&&r!=="POST")return zt({ok:!1,error:"unsupported_method"},405,r);let o=new URL(t.url),a=Z(o.searchParams.get("url")),s=Z(o.searchParams.get("lang"))||"en";if(!a)return zt({ok:!1,error:"missing_url"},400,r);try{let i=await bc({sourceUrl:a,lang:s});return zt(i,i.ok?200:502,r)}catch(i){let c=i&&typeof i=="object"&&"message"in i?Z(i.message):"";return zt({ok:!1,error:c||"youtube_conversion_failed"},502,r)}}n(pa,"onRequest");async function ua(e){let{request:t}=e,r=String(t.method||"GET").toUpperCase();if(r==="OPTIONS")return new Response(null,{status:204,headers:{...ie(t),"access-control-allow-methods":"GET, HEAD, OPTIONS","access-control-allow-headers":"*","access-control-max-age":"86400"}});if(r!=="GET"&&r!=="HEAD")return new Response(JSON.stringify({ok:!1,error:"unsupported_method"}),{status:405,headers:{"content-type":"application/json; charset=utf-8","cache-control":"no-store",...ie(t)}});let o={ok:!0,service:"singabldr-pages",ts:new Date().toISOString()},a={"content-type":"application/json; charset=utf-8","cache-control":"no-store",...ie(t)};return r==="HEAD"?new Response(null,{status:200,headers:a}):new Response(JSON.stringify(o),{status:200,headers:a})}n(ua,"onRequest");var Oe="https://airvio.co";var ue="/knowgrph",ve=`${Oe}${ue}/`,Pc=`${Oe}/`;var ma=`${ue}/health`,da=`${Oe}${ma}`,ha="/.well-known/agent-card.json",Ld=`${ue}/.well-known/agent-card.json`,Rc=`${Oe}${ha}`,Ac=`${Oe}/api/storage/source-files`,kc=`${Oe}/api/storage/doc-default/{canonicalPath}`,xc=`${Oe}/api/storage/doc/{workspaceId}/{canonicalPath}`,Ec=`${Oe}/api/storage/blob/{workspaceId}/{canonicalPath}`;var Dr="root-agent-ready-pages",ga=['</.well-known/api-catalog>; rel="api-catalog"; type="application/linkset+json"',`<${ue}/.well-known/openapi.json>; rel="service-desc"; type="application/vnd.oai.openapi+json;version=3.1"`,`<${ue}/llms.txt>; rel="service-doc"; type="text/plain"`,'</auth.md>; rel="service-doc"; type="text/markdown"',`<${ma}>; rel="status"; type="application/health+json"`,`<${ue}/.well-known/mcp/server-card.json>; rel="mcp-server-card"; type="application/json"`,`<${ha}>; rel="describedby"; type="application/json"`].join(", "),fa=`# Knowgrph
...
- Auth.md registration instructions: ${Pc}auth.md
- Health: ${da}
...
- The View initiates the MCP Apps \`ui/initialize\` handshake, sends \`ui/notifications/initialized\` and \`ui/notifications/size-changed\`, handles host context/tool input/result/cancel notifications, and calls the originating server through \`tools/call\`.
- \`inspect_agent_surface.structuredContent.mcpAppsServerReadiness\` exposes the native server-readiness model used by the View: app tool/resource binding, prompt discovery, resource-template discovery, output-schema and structured-content readiness, sandbox/security metadata, widget accessibility, Streamable HTTP JSON-RPC transport, local stdio transport, and read-only search/fetch retrieval.
`,ya=n(e=>new Response(e,{status:200,headers:{"content-type":"text/markdown; charset=utf-8","cache-control":"public, max-age=3600","access-control-allow-origin":"*",vary:"Accept","x-markdown-tokens":String(Math.ceil(String(e||"").length/4))}}),"markdownResponse"),wa=n(e=>(e.headers.get("accept")||"").toLowerCase().split(",").some(r=>r.trim().startsWith("text/markdown")),"wantsMarkdown"),$r=n((e,t)=>{let r=new Response(e.body,e),o=String(t?.owner||"").trim(),a=String(t?.tag||"").trim();return o&&r.headers.set("x-knowgrph-route-owner",o),a&&r.headers.set("x-knowgrph-route-tag",a),r},"withAgentReadyRouteHeaders");var jr="Agent-actionable chat-to-canvas knowledge graph workspace",dt='<main id="root"></main>',Cc=/<(?:main|div)\s+id=["']root["']\s*><\/(?:main|div)>/i,Tc=n(e=>{let t=/<script>([\s\S]*?)<\/script>/g;for(let r of String(e||"").matchAll(t)){let o=r[1]||"";if(o.includes("createWebMcpLifecycleController")&&o.includes("toolDefinitions"))return o}return""},"extractWebMcpScript"),Sa=n(()=>({"content-type":"text/html; charset=utf-8","cache-control":"no-store, no-cache, no-transform, must-revalidate, max-age=0","access-control-allow-origin":"*",link:ga}),"rootHtmlHeaders"),Hr=n((e,t)=>String(e||"").includes("</head>")?String(e||"").replace("</head>",`${t}</head>`):`${String(e||"")}${t}`,"injectIntoHead"),_a=n(e=>String(e||"").replace(Cc,dt),"canonicalizeRootMount"),qt=n(()=>`<main id="knowgrph-root-fallback" data-knowgrph-root-fallback="visible" aria-label="Knowgrph root alias" style="position:fixed;inset:0;z-index:2147483000;display:grid;place-content:center;gap:1rem;padding:2rem;box-sizing:border-box;font-family:Inter,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;background:#101820;color:#f4f7fb;text-align:center">
      <h1 style="margin:0;font-size:clamp(2.25rem,8vw,5.5rem);line-height:1;font-weight:760">Knowgrph</h1>
      <p style="margin:0 auto;max-width:42rem;font-size:clamp(1rem,2.2vw,1.35rem);line-height:1.55;color:#d6e1ea">${jr}</p>
    ...
    <\/script>`,"rootVisibleFallbackMarkup"),vc=n(e=>{let t=_a(e);return/<main\s+id=["']knowgrph-root-fallback["']/i.test(t)?t:t.includes(dt)?t.replace(dt,`${dt}
    ${qt()}`):t.includes("</body>")?t.replace("</body>",`    ${qt()}
  </body>`):`${t}
${qt()}`},"injectRootVisibleFallback"),Oc=n(e=>{let t=_a(e);return/<meta\s+name=["']description["'][^>]*>/i.test(t)?t=t.replace(/<meta\s+name=["']description["'][^>]*>/i,`<meta name="description" content="${jr}" />`):t=Hr(t,`    <meta name="description" content="${jr}" />
`),/<link\s+rel=["']canonical["'][^>]*>/i.test(t)||(t=Hr(t,`    <link rel="canonical" href="${ue}/" />
`)),/<meta\s+name=["']x-knowgrph-root-alias["'][^>]*>/i.test(t)||(t=Hr(t,`    <meta name="x-knowgrph-root-alias" content="${ue}/" />
`)),vc(t)},"rewriteRootAppHtml"),Ic=n(async e=>{let t=new URL(`${ue}/?agentReadyRootWebMcp=1`,e.url),r=await fetch(t,{headers:{accept:"text/html"}});return r.ok?Tc(await r.text()):""},"loadWebMcpScript"),Mc=n(async e=>{let t=new URL(`${ue}/?agentReadyRootAlias=1`,e.url),r=await fetch(t,{headers:{accept:"text/html"}});if(!r.ok)return null;let o=Oc(await r.text());return!o.includes(dt)||!o.includes(`${ue}/assets/`)?null:new Response(o,{status:200,headers:Sa()})},"loadKnowgrphAppShell"),Nc=n((e="")=>new Response(`<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
...
</html>`,{status:200,headers:Sa()}),"rootHtmlResponse");async function ba(e){let{request:t}=e,r=String(t.method||"GET").toUpperCase();if(r!=="GET"&&r!=="HEAD")return e.next();if(wa(t)){let s=$r(ya(fa),{owner:Dr,tag:"root-homepage-markdown"});return r==="HEAD"?new Response(null,s):s}let o=r==="HEAD"?null:await Mc(t),a=$r(o||Nc(r==="HEAD"?"":await Ic(t)),{owner:Dr,tag:"root-homepage-html"});return r==="HEAD"?new Response(null,a):a}n(ba,"onRequest");var P=[{routePath:"/api/llm/chat/completions",mountPath:"/api/llm/chat",method:"",middlewares:[],modules:[Fr]},{routePath:"/api/payments/commerce/x402",mountPath:"/api/payments/commerce",method:"",middlewares:[],modules:[ho]},{routePath:"/api/llm/models",mountPath:"/api/llm",method:"",middlewares:[],modules:[go]},{routePath:"/api/llm/responses",mountPath:"/api/llm",method:"",middlewares:[],modules:[fo]},{routePath:"/knowgrph/doc-default/:path*",mountPath:"/knowgrph/doc-default",method:"",middlewares:[],modules:[Ln]},{routePath:"/knowgrph/doc/:path*",mountPath:"/knowgrph/doc",method:"",middlewares:[],modules:[Kn]},{routePath:"/knowgrph/share/:path*",mountPath:"/knowgrph/share",method:"",middlewares:[],modules:[Dn]},{routePath:"/api/link-preview",mountPath:"/api",method:"GET",middlewares:[],modules:[Hn]},{routePath:"/api/link-proxy",mountPath:"/api",method:"GET",middlewares:[],modules:[Bn]},{routePath:"/api/graph",mountPath:"/api",method:"",middlewares:[],modules:[Qn]},{routePath:"/api/oembed",mountPath:"/api",method:"",middlewares:[],modules:[ta]},{routePath:"/__chat_proxy/:path*",mountPath:"/__chat_proxy",method:"",middlewares:[],modules:[oa]},{routePath:"/knowgrph/:path*",mountPath:"/knowgrph",method:"",middlewares:[],modules:[Ue]},{routePath:"/__video_frame",mountPath:"/",method:"",middlewares:[],modules:[ca]},{routePath:"/__youtube_transcript",mountPath:"/",method:"",middlewares:[],modules:[pa]},{routePath:"/health",mountPath:"/",method:"",middlewares:[],modules:[ua]},{routePath:"/",mountPath:"/",method:"",middlewares:[],modules:[ba]}];function Uc(e){for(var t=[],r=0;r<e.length;){var o=e[r];if(o==="*"||o==="+"||o==="?"){t.push({type:"MODIFIER",index:r,value:e[r++]});continue}if(o==="\\"){t.push({type:"ESCAPED_CHAR",index:r++,value:e[r++]});continue}if(o==="{"){t.push({type:"OPEN",index:r,value:e[r++]});continue}if(o==="}"){t.push({type:"CLOSE",index:r,value:e[r++]});continue}if(o===":"){for(var a="",s=r+1;s<e.length;){var i=e.charCodeAt(s);if(i>=48&&i<=57||i>=65&&i<=90||i>=97&&i<=122||i===95){a+=e[s++];continue}break}if(!a)throw new TypeError("Missing parameter name at ".concat(r));t.push({type:"NAME",index:r,value:a}),r=s;continue}if(o==="("){var c=1,l="",s=r+1;if(e[s]==="?")throw new TypeError('Pattern cannot start with "?" at '.concat(s));for(;s<e.length;){if(e[s]==="\\"){l+=e[s++]+e[s++];continue}if(e[s]===")"){if(c--,c===0){s++;break}}else if(e[s]==="("&&(c++,e[s+1]!=="?"))throw new TypeError("Capturing groups are not allowed at ".concat(s));l+=e[s++]}if(c)throw new TypeError("Unbalanced pattern at ".concat(r));if(!l)throw new TypeError("Missing pattern at ".concat(r));t.push({type:"PATTERN",index:r,value:l}),r=s;continue}t.push({type:"CHAR",index:r,value:e[r++]})}return t.push({type:"END",index:r,value:""}),t}n(Uc,"lexer");function Lc(e,t){t===void 0&&(t={});for(var r=Uc(e),o=t.prefixes,a=o===void 0?"./":o,s=t.delimiter,i=s===void 0?"/#?":s,c=[],l=0,p=0,m="",f=n(function(M){if(p<r.length&&r[p].type===M)return r[p++].value},"tryConsume"),A=n(function(M){var N=f(M);if(N!==void 0)return N;var B=r[p],ae=B.type,de=B.index;throw new TypeError("Unexpected ".concat(ae," at ").concat(de,", expected ").concat(M))},"mustConsume"),_=n(function(){for(var M="",N;N=f("CHAR")||f("ESCAPED_CHAR");)M+=N;return M},"consumeText"),x=n(function(M){for(var N=0,B=i;N<B.length;N++){var ae=B[N];if(M.indexOf(ae)>-1)return!0}return!1},"isSafe"),$=n(function(M){var N=c[c.length-1],B=M||(N&&typeof N=="string"?N:"");if(N&&!B)throw new TypeError('Must have text between two parameters, missing text after "'.concat(N.name,'"'));return!B||x(B)?"[^".concat(Le(i),"]+?"):"(?:(?!".concat(Le(B),")[^").concat(Le(i),"])+?")},"safePattern");p<r.length;){var K=f("CHAR"),F=f("NAME"),ee=f("PATTERN");if(F||ee){var z=K||"";a.indexOf(z)===-1&&(m+=z,z=""),m&&(c.push(m),m=""),c.push({name:F||l++,prefix:z,suffix:"",pattern:ee||$(z),modifier:f("MODIFIER")||""});continue}var C=K||f("ESCAPED_CHAR");if(C){m+=C;continue}m&&(c.push(m),m="");var O=f("OPEN");if(O){var z=_(),Q=f("NAME")||"",U=f("PATTERN")||"",re=_();A("CLOSE"),c.push({name:Q||(U?l++:""),pattern:Q&&!U?$(z):U,prefix:z,suffix:re,modifier:f("MODIFIER")||""});continue}A("END")}return c}n(Lc,"parse");function mt(e,t){var r=[],o=Ra(e,r,t);return Kc(o,r,t)}n(mt,"match");function Kc(e,t,r){r===void 0&&(r={});var o=r.decode,a=o===void 0?function(s){return s}:o;return function(s){var i=e.exec(s);if(!i)return!1;for(var c=i[0],l=i.index,p=Object.create(null),m=n(function(A){if(i[A]===void 0)return"continue";var _=t[A-1];_.modifier==="*"||_.modifier==="+"?p[_.name]=i[A].split(_.prefix+_.suffix).map(function(x){return a(x,_)}):p[_.name]=a(i[A],_)},"_loop_1"),f=1;f<i.length;f++)m(f);return{path:c,index:l,params:p}}}n(Kc,"regexpToFunction");function Le(e){return e.replace(/([.+*?=^!:${}()[\]|/\\])/g,"\\$1")}n(Le,"escapeString");function Pa(e){return e&&e.sensitive?"":"i"}n(Pa,"flags");function Dc(e,t){if(!t)return e;for(var r=/\((?:\?<(.*?)>)?(?!\?)/g,o=0,a=r.exec(e.source);a;)t.push({name:a[1]||o++,prefix:"",suffix:"",modifier:"",pattern:""}),a=r.exec(e.source);return e}n(Dc,"regexpToRegexp");function $c(e,t,r){var o=e.map(function(a){return Ra(a,t,r).source});return new RegExp("(?:".concat(o.join("|"),")"),Pa(r))}n($c,"arrayToRegexp");function Hc(e,t,r){return jc(Lc(e,r),t,r)}n(Hc,"stringToRegexp");function jc(e,t,r){r===void 0&&(r={});for(var o=r.strict,a=o===void 0?!1:o,s=r.start,i=s===void 0?!0:s,c=r.end,l=c===void 0?!0:c,p=r.encode,m=p===void 0?function(N){return N}:p,f=r.delimiter,A=f===void 0?"/#?":f,_=r.endsWith,x=_===void 0?"":_,$="[".concat(Le(x),"]|$"),K="[".concat(Le(A),"]"),F=i?"^":"",ee=0,z=e;ee<z.length;ee++){var C=z[ee];if(typeof C=="string")F+=Le(m(C));else{var O=Le(m(C.prefix)),Q=Le(m(C.suffix));if(C.pattern)if(t&&t.push(C),O||Q)if(C.modifier==="+"||C.modifier==="*"){var U=C.modifier==="*"?"?":"";F+="(?:".concat(O,"((?:").concat(C.pattern,")(?:").concat(Q).concat(O,"(?:").concat(C.pattern,"))*)").concat(Q,")").concat(U)}else F+="(?:".concat(O,"(").concat(C.pattern,")").concat(Q,")").concat(C.modifier);else{if(C.modifier==="+"||C.modifier==="*")throw new TypeError('Can not repeat "'.concat(C.name,'" without a prefix and suffix'));F+="(".concat(C.pattern,")").concat(C.modifier)}else F+="(?:".concat(O).concat(Q,")").concat(C.modifier)}}if(l)a||(F+="".concat(K,"?")),F+=r.endsWith?"(?=".concat($,")"):"$";else{var re=e[e.length-1],M=typeof re=="string"?K.indexOf(re[re.length-1])>-1:re===void 0;a||(F+="(?:".concat(K,"(?=").concat($,"))?")),M||(F+="(?=".concat(K,"|").concat($,")"))}return new RegExp(F,Pa(r))}n(jc,"tokensToRegexp");function Ra(e,t,r){return e instanceof RegExp?Dc(e,t):Array.isArray(e)?$c(e,t,r):Hc(e,t,r)}n(Ra,"pathToRegexp");var Vt=/[.+?^${}()|[\]\\]/g;function*Bc(e){let t=new URL(e.url).pathname;for(let r of[...P].reverse()){if(r.method&&r.method!==e.method)continue;let o=mt(r.routePath.replace(Vt,"\\$&"),{end:!1}),a=mt(r.mountPath.replace(Vt,"\\$&"),{end:!1}),s=o(t),i=a(t);if(s&&i)for(let c of r.middlewares.flat())yield{handler:c,params:s.params,path:i.path}}for(let r of P){if(r.method&&r.method!==e.method)continue;let o=mt(r.routePath.replace(Vt,"\\$&"),{end:!0}),a=mt(r.mountPath.replace(Vt,"\\$&"),{end:!1}),s=o(t),i=a(t);if(s&&i&&r.modules.length){for(let c of r.modules.flat())yield{handler:c,params:s.params,path:s.path};break}}}n(Bc,"executeRequest");var dm={async fetch(e,t,r){let o=e,a=Bc(o),s={},i=!1,c=n(async(l,p)=>{if(l!==void 0){let f=l;typeof l=="string"&&(f=new URL(l,o.url).toString()),o=new Request(f,p)}let m=a.next();if(m.done===!1){let{handler:f,params:A,path:_}=m.value,x={request:new Request(o.clone()),functionPath:_,next:c,params:A,get data(){return s},set data(K){if(typeof K!="object"||K===null)throw new Error("context.data must be an object");s=K},env:t,waitUntil:r.waitUntil.bind(r),passThroughOnException:n(()=>{i=!0},"passThroughOnException")},$=await f(x);if(!($ instanceof Response))throw new Error("Your Pages function should return a Response");return Br($)}else{let f=await t.ASSETS.fetch(o);return Br(f)}},"next");try{return await c()}catch(l){if(i){let p=await t.ASSETS.fetch(o);return Br(p)}throw l}}},Br=n(e=>new Response([101,204,205,304].includes(e.status)?null:e.body,e),"cloneResponse");export{dm as default};
