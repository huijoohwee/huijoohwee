const e=`# Knowgrph MainPanel Help Icons
...
| --- | --- | --- | --- |
| iconLegend.header | mainPanel.help | Shared icon legend | Shows the semantic icon library used by MainPanel and FloatingPanel Type cells. |
...
| reuse.contract | ktv.type.static | One icon source | MainPanel Collaboration Type icons are the source for shared Type icon semantics across panels. |
| graphDataTable.mapping | mainPanel.workflowManager | Graph Data Table mapping | Graph field icons map node and edge fields to table visibility, scope, origin, and value kinds. |
...
| mainPanel.research | mainPanel.research | Research compiler | MainPanel tab for thesis compilation, source staging, and review surfaces. |
...
| floatingPanel.flowEditor | floatingPanel.flowEditor | Flow graph editing | FloatingPanel view for flow graph editing and runtime wiring. |
...
| floatingPanel.gantt | floatingPanel.gantt | Timeline planning | FloatingPanel view for gantt-style planning and schedule inspection. |
| floatingPanel.timeline | floatingPanel.timeline | Chronology review | FloatingPanel view for chronological timeline review and transport control. |
