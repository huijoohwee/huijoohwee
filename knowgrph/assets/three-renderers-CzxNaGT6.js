import{f as Ln,e as Gi,b as Hi,g as Vi,T as ki}from"./three-textures-pHGJfIIw.js";import{L as Dt,J as Vt,B as dt,i as yt,b5 as dr,K as wn,aZ as qe,s as Wt,aB as Wi,U as Un,aI as Lt,aA as Ct,v as Tt,b6 as Sn,b7 as En,E as Dn,G as sn,b8 as Gt,b9 as ur,ba as zi,H as Pt,bb as Wn,aK as Xi,P as pr,aJ as vt,bc as hr,bd as mr,be as _r,a as gr,bf as vr,bg as Sr,bh as Er,aY as Yi,bi as Mr,bj as Tr,aV as xr,D as St,aO as tn,aX as Ar,bk as Rr,g as yn,bl as br,l as kt,aS as rn,bm as Cr,bn as Pr,aR as Bt,bo as Lr,bp as wr,bq as Ur,br as Dr,bs as yr,bt as Ir,aQ as Nr,bu as Or,bv as Fr,bw as Br,bx as Gr,aP as Hr,by as Vr,bz as kr,bA as Wr,bB as Mn,bC as Tn,bD as xn,bE as An,bF as Rn,bG as bn,bH as Cn,bI as zr,bJ as zn,bK as Xr,bL as Yr,bM as Xn,bN as Yn,b as qn,bO as qr,bP as Kr,M as Zr,C as $r,R as Qr,j as fn,N as Qt,k as Jr,bQ as jr,bR as ea,bS as ta,bT as na,bU as ia,bV as ra,bW as aa,u as Ut,bX as an,bY as In,aC as zt,bZ as Xt,aG as on,z as oa,aE as qi,aD as Ki,az as sa,aH as ca,aF as la,ay as fa,ar as da,ax as ua,aw as pa,av as ha,au as Zi,at as ma,as as $i,aq as Qi,ap as dn,ao as un,an as pn,am as hn,aj as Kn,al as Zn,ai as $n,ak as Qn,ah as Jn,ag as jn,af as ei,ae as ti,ad as ni,ac as ii,ab as ri,aa as ai,a9 as oi,a8 as si,a7 as ci,a6 as li,a5 as fi,a4 as di,a3 as ui,a2 as pi,a1 as hi,a0 as mn,$ as mi,_ as _i,Z as _a,Y as gi,X as vi,W as Si,n as _n,b_ as ga,b$ as va,S as Sa,t as Ea,c0 as Ma,c1 as Ta,c2 as xa,a_ as Aa}from"./three-core-udz-a6cg.js";import{j as je,f as Fe,b as st,C as Ze,V as et,E as Ji,a as It,P as Ra,h as ot,F as ji,R as ba}from"./three-math-BGc6akQJ.js";import{B as er,P as tr}from"./three-geometries-BVx2jXmG.js";import{l as Yt,e as Ca,d as Pa}from"./three-materials-D1uIYTUx.js";import{M as qt,G as Jt}from"./three-objects-D0qBDx0L.js";import{j as La,k as wa,U as Ua,L as Da,B as ya,a as Ia,E as Na}from"./three-scene-core-9OrXBkOE.js";import{P as Ei,m as Mi}from"./three-extras-DT3yFegi.js";class xt extends La{constructor(n=1,t=1,i={}){super(n,t,i),this.isWebGLRenderTarget=!0}}class Cf extends xt{constructor(n=1,t=1,i=1,s={}){super(n,t,s),this.isWebGLArrayRenderTarget=!0,this.depth=i,this.texture=new Ln(null,n,t,i),this.texture.isRenderTargetTexture=!0}}class Pf extends xt{constructor(n=1,t=1,i=1,s={}){super(n,t,s),this.isWebGL3DRenderTarget=!0,this.depth=i,this.texture=new Gi(null,n,t,i),this.texture.isRenderTargetTexture=!0}}function Kt(e){const n={};for(const t in e){n[t]={};for(const i in e[t]){const s=e[t][i];s&&(s.isColor||s.isMatrix3||s.isMatrix4||s.isVector2||s.isVector3||s.isVector4||s.isTexture||s.isQuaternion)?s.isRenderTargetTexture?(console.warn("UniformsUtils: Textures of render targets cannot be cloned via cloneUniforms() or mergeUniforms()."),n[t][i]=null):n[t][i]=s.clone():Array.isArray(s)?n[t][i]=s.slice():n[t][i]=s}}return n}function rt(e){const n={};for(let t=0;t<e.length;t++){const i=Kt(e[t]);for(const s in i)n[s]=i[s]}return n}function Lf(e){const n=[];for(let t=0;t<e.length;t++)n.push(e[t].clone());return n}function nr(e){const n=e.getRenderTarget();return n===null?e.outputColorSpace:n.isXRRenderTarget===!0?n.texture.colorSpace:je.workingColorSpace}const Oa={clone:Kt,merge:rt},wf=`
void main() {
