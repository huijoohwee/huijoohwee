import{R as c,j as t}from"./react-BQOKVxhn.js";import{M as T,b as L,a as P}from"./MarkdownInlineTextEditSurface-aPykURLu.js";import{dd as R,fO as H,bu as M,u as F,de as K}from"./settings-mcp-docs-oN17uqxv.js";import{A as f,G as h,e as w,V,f as g,g as D,s as G,h as q,j as $}from"./chatInvocationRegistry-CCFLVQUd.js";import{C as B,i as Q,r as W}from"./CanvasEmbedImportPanel-DyiNdfAV.js";import{s as z}from"./liveCanvasHeroEmbed-CqhaFWDX.js";import{s as U}from"./CanvasViewport-DXuddIi1.js";import{ap as Z}from"./index-AaPRpmOf.js";import{aL as J,_ as X,aM as Y}from"./ui-DvHfMwYH.js";import"./svgSnapshot-DWtRxWLS.js";import"./cardMarkdownPreviewUtils-CtmE6Nft.js";import"./agenticOsDocInvocations-C2lI5sc7.js";import"./settings-grabmapsMcpApiDocs-XiEQPpH2.js";import"./mermaid-BvyVWJvc.js";import"./d3-W0BRPxKc.js";import"./settings-apiNativeBrowserMcpApiDocs-Bx2mYuJD.js";import"./settings-vdeoxplnMcpApiDocs-EzICHrJ5.js";import"./settings-crawlerAccessMcpApiDocs-BOpJrdkF.js";import"./settings-cloudflareAiGatewayMcpApiDocs-GWDtRw8M.js";import"./settings-openaiMcpApiDocs-CUg0biwm.js";import"./settings-exaMcpApiDocs-BhfyAJRB.js";import"./settings-feishuBaseMcpApiDocs-HFdIwSdV.js";import"./settings-larkAppMcpApiDocs-Ds0KYZFl.js";import"./settings-stripeMcpApiDocs-CRN2Zcbp.js";import"./settings-miromindMcpApiDocs-BuQqEIE6.js";import"./settings-operatorDeployMcpApiDocs-CRQi1O8N.js";import"./CanvasEmbedPanelShell-DXwqPJsw.js";import"./useActiveGraphRenderData.impl-BDMGSnjC.js";import"./forbidBrowserZoom-DaPu-D60.js";import"./HighlightedCode-DicGm4zs.js";import"./highlightjs-DW3kSZ-5.js";import"./canvasEmbedCodePanelEvent-m0ojjNct.js";import"./markdown-it-CqrcgIMp.js";const ee=["视频","video","分镜","逐镜","剧本","script","旁白","audio","shot"],ae=a=>{var n;const e=((n=a.source)==null?void 0:n.kind)==="local"?String(a.source.path||""):"";return e.startsWith("workspace:")?e.slice(10):e||`/${a.name}`};function te(a){return(a||[]).filter(e=>e.enabled!==!1&&/\.md$/i.test(e.name)).map(e=>({name:e.name,workspacePath:ae(e),score:ee.reduce((n,r)=>n+(`${e.name}
${String(e.text||"").slice(0,8e3)}`.toLowerCase().includes(r)?1:0),0)})).filter(e=>e.score>0).sort((e,n)=>n.score-e.score||e.workspacePath.localeCompare(n.workspacePath))[0]||null}function ne(a){const e=te(a),n=e?`[${e.name}](workspace:${encodeURI(e.workspacePath)})`:"";return{source:e,query:[f,h[0].token,...g.map(r=>r.token),w[0].token,V,n,"Generate an end-to-end agentic video canvas from the referenced script. Produce Chinese, Cantonese, and English audio variants with synchronized Chinese/English bilingual subtitles. Persist typed text, image, audio, and video artifacts for playable Cards, Widgets, Rich Media Panels, and BottomPanel Timeline video/FBF/audio lanes. Stop at approval or a missing provider capability."].filter(Boolean).join(" ")}}[f,...h.map(a=>a.token),...w.map(a=>a.token),...g.map(a=>a.token)];[f,h[0].token,...g.map(a=>a.token),w[0].token];function re(a={}){var n,r;const e=ne(a.sourceFiles);return{status:"ready",defaultQuery:e.query,sourceLabel:((n=e.source)==null?void 0:n.name)||null,sourceWorkspacePath:((r=e.source)==null?void 0:r.workspacePath)||null,invocations:[{token:f,group:"Route",label:"Video agent",summary:"Agentic video route.",sourcePath:"canvas/src/features/chat/generationInvocation.ts",keywords:["video","agent"]},...h.map(s=>({...s,group:"Provider",sourcePath:"canvas/src/features/chat/generationInvocation.ts",keywords:["provider"]})),...w.map(s=>({...s,group:"Specification",sourcePath:"canvas/src/features/chat/generationInvocation.ts",keywords:["specification"]})),...g.map(s=>({...s,group:"Outputs",sourcePath:"canvas/src/features/chat/generationInvocation.ts",keywords:["output"]}))]}}const E=(a,e)=>R(a).some(n=>n.kind==="token"&&n.value.toLowerCase()===e.toLowerCase()),oe=(a,e)=>E(a,e)?a.trim():[a.trim(),e].filter(Boolean).join(" "),d={eyebrow:"Knowgrph · Live canvas",headline:["Map intent.","Orchestrate agents.","Prove outcomes."],lede:"A source-backed canvas where `/` routes work, `#` sets meaning, and `@` binds context.",posture:["0 model calls before Run","Frontmatter SSOT","Approval-gated"],markdown:""};function x(a){return String(a||"").trim()}function se(a){if(!Array.isArray(a))return[...d.headline];const e=a.map(n=>x(n)).filter(Boolean).slice(0,3);return e.length!==3?[...d.headline]:[e[0],e[1],e[2]]}function ie(a){if(!Array.isArray(a))return d.posture;const e=a.map(n=>x(n)).filter(Boolean);return e.length>0?e:d.posture}function ce(){if(`---
