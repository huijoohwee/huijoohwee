import{C as m,x as _,p as $,D as S,E,q as C}from"./index-DOq2LMde.js";import{bk as f,b4 as u,H as R,u as w,bl as T}from"./settings-mcp-core-CzvHyRl9.js";import{f as b}from"./workspaceTimestamp-gdXCTS78.js";import{u as P}from"./upsertWorkspaceMarkdownSourceFile-CWtL9_1t.js";const A="codebase-graph",G="codebase-graph",g=2048,k=64,O=`${T}/${A}`,p=`${R}/${A}`;function D(t){return`${G}_${b(t)}.md`}function N(t){const e=Array.from(String(t??"")).filter(a=>{const o=a.charCodeAt(0);return o===9||o===10||o===13||o>=32&&o!==127}).join("");return e.length>g?`${e.slice(0,g)}…`:e}function s(t){return JSON.stringify(N(t))}function l(t){return`[${t.slice(0,k).map(a=>s(a)).join(", ")}]`}function i(t){const e=Number(t);return Number.isFinite(e)?Math.max(0,Math.floor(e)):0}function y(t,e){var c,d,h;const{invocation:a,repositoryUrl:o,result:r}=t,n=r.counts;return`---
