...
id: agenticgraph-live-canvas-hero
version: 1.0.0
status: implemented
created: 2026-07-11
updated: 2026-07-22
...
posture:
  ...
  - Frontmatter SSOT
  - Approval-gated
enter_href: /agenticgraph/
markdown_route: /agenticgraph-live-canvas-hero.md
...
- [Enter AgenticGraph](/agenticgraph/)
- [Read this discovery markdown](/agenticgraph-live-canvas-hero.md)
...
- The apex Home hero retains viewport ownership during persisted workspace document bootstrap; the switching-document placeholder remains exclusive to `/agenticgraph` workspace routes.
...
- Production JavaScript, CSS, and generated assets are emitted under the exact 40-character AgenticGraph source revision. A new protected release therefore uses a new asset namespace and cannot reuse an HTML-poisoned browser cache entry from an older deployment.
