const e=`{
  ...
  "metadata": {
    ...
    "generatedBy": "data/config/schema/agenticgraph-universal-schema-config.jsonld",
    "fixtures": {
      "graphFieldSettings": {
        "graphRAGPath": {
          "@context": {
          ...
          "kg:raciCatalog": "docs/agenticgraph-raci-document.md",
      ...
      "roleActionOutcomes": {
        ...
        "graph-fields-table-mapping-role-action-outcome": {
          ...
          "outcome": "see docs/agenticgraph-schema-document.md for AgenticRAG JSON-LD table mapping examples."
        },
