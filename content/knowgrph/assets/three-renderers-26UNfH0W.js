import{e as Ln,D as Gi,d as Hi,g as Vi,T as ki}from"./three-textures-Cl9vYoVc.js";import{L as Dt,aL as Vt,B as dt,al as yt,s as wn,bL as qe,X as Wt,a7 as Wi,a4 as Un,c2 as Lt,W as Ct,b3 as Tt,U as Sn,V as En,q as Dn,r as sn,af as zi,aN as Pt,Z as Wn,a$ as Xi,P as dr,c9 as vt,y as ur,aH as pr,e as hr,a as mr,n as _r,bF as gr,ao as vr,ap as Yi,c as Sr,az as Er,aB as Mr,D as St,aP as tn,bZ as Tr,aT as xr,an as yn,b2 as Ar,aC as kt,ag as rn,bI as Rr,bW as br,b as Bt,aV as Cr,o as Pr,aW as Lr,p as wr,aX as Ur,aY as Dr,aZ as yr,a_ as Ir,I as Nr,J as Or,bO as Fr,bN as Br,bP as Gr,aU as Hr,ce as Vr,aR as Mn,$ as Tn,a1 as xn,Q as An,ae as Rn,h as bn,aJ as Cn,w as kr,t as zn,u as Wr,x as zr,aA as Xn,bX as Yn,A as qn,ax as Xr,aw as Yr,ay as qr,C as Kr,bG as Zr,am as fn,aF as Qt,aG as $r,aQ as Qr,_ as Jr,a0 as jr,O as ea,ad as ta,g as na,aI as ia,aM as Ut,G as an,F as In,c5 as zt,c3 as Xt,c8 as on,c6 as qi,c7 as Ki,c4 as ra,m as aa,bM as oa,f as sa,br as ca,au as la,at as fa,bD as da,bE as Zi,bB as ua,bC as $i,b4 as Qi,bz as dn,bn as un,bo as pn,bp as hn,by as Kn,bx as Zn,bm as $n,bl as Qn,bv as Jn,bw as jn,bk as ei,bb as ti,bc as ni,bd as ii,be as ri,bf as ai,bg as oi,bh as si,bi as ci,b6 as li,b7 as fi,b8 as di,b5 as ui,b9 as pi,ba as hi,bj as mn,bt as mi,bu as _i,b1 as pa,bK as gi,b0 as vi,bJ as Si,S as ha,R as ma,ca as _a}from"./three-constantsjs-DDkumpQT.js";import{c as je,h as Fe,l as st,C as Ze,V as et,E as Ji,M as It,P as ga,m as ot,F as ji,o as va}from"./three-math-CUfZG_iw.js";import{B as er,P as tr}from"./three-geometries-DOArPI8E.js";import{l as Yt,c as Sa,d as Ea}from"./three-materials-D7LfanzJ.js";import{M as qt,G as Jt}from"./three-objects-_hqkUX5F.js";import{j as Ma,k as Ta,U as xa,L as Aa,B as Ra,a as ba,E as Ca}from"./three-core-BfLkNVRA.js";import{a as Pa,P as _n,A as La}from"./three-cameras-CiAT8VLd.js";import{P as Ei,n as Mi}from"./three-extras-CT2rerCQ.js";import{w as Gt,a as wa,b as Ua,c as Da,t as ya,d as Ia,p as Na}from"./three-utilsjs-Beg64kNY.js";class xt extends Ma{constructor(n=1,t=1,i={}){super(n,t,i),this.isWebGLRenderTarget=!0}}class Lf extends xt{constructor(n=1,t=1,i=1,s={}){super(n,t,s),this.isWebGLArrayRenderTarget=!0,this.depth=i,this.texture=new Ln(null,n,t,i),this.texture.isRenderTargetTexture=!0}}class wf extends xt{constructor(n=1,t=1,i=1,s={}){super(n,t,s),this.isWebGL3DRenderTarget=!0,this.depth=i,this.texture=new Gi(null,n,t,i),this.texture.isRenderTargetTexture=!0}}function Kt(e){const n={};for(const t in e){n[t]={};for(const i in e[t]){const s=e[t][i];s&&(s.isColor||s.isMatrix3||s.isMatrix4||s.isVector2||s.isVector3||s.isVector4||s.isTexture||s.isQuaternion)?s.isRenderTargetTexture?(console.warn("UniformsUtils: Textures of render targets cannot be cloned via cloneUniforms() or mergeUniforms()."),n[t][i]=null):n[t][i]=s.clone():Array.isArray(s)?n[t][i]=s.slice():n[t][i]=s}}return n}function rt(e){const n={};for(let t=0;t<e.length;t++){const i=Kt(e[t]);for(const s in i)n[s]=i[s]}return n}function Uf(e){const n=[];for(let t=0;t<e.length;t++)n.push(e[t].clone());return n}function nr(e){const n=e.getRenderTarget();return n===null?e.outputColorSpace:n.isXRRenderTarget===!0?n.texture.colorSpace:je.workingColorSpace}const Oa={clone:Kt,merge:rt},Df=`
void main() {
