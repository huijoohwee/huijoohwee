import{tA as tt,ee as et,nz as ot}from"./index-Ds3lF5be.js";import{A as st,n as kt,m as St,r as vt,z as xt,h as Mt,b as $t}from"./MarkdownPreview-CW0gdMAE.js";import{p as At}from"./mermaidConfig-DRl5VdCn.js";import{c as Ct,s as Tt}from"./markdownPreviewLex-ywBm8Fo2.js";import{c as ct,R as $}from"./react-D1l5gsU-.js";import{w as lt}from"./exportPdfIntersectionObserver-C4yNPy8D.js";import"./mermaid-B4Y8iRLG.js";import"./d3-CACFq1el.js";import"./ui-B0xZ4qsI.js";import"./markdown-it-DzQ8SBEg.js";import"./useIsomorphicLayoutEffect-DORpU0DC.js";import"./overlay-RSMNhqPD.js";import"./overlayClamp-CgZ9Yyaa.js";import"./overlayPlacement-BTUxcQNo.js";import"./toolbarStyles-bENg82F7.js";import"./SharedWebpageSurface-BU26_Ex-.js";import"./CardInlineTextEditor-CPklPHNP.js";import"./PlainTextInputEditor-C7mRyg2H.js";import"./cardMarkdownPreviewUtils-DosIaaNZ.js";import"./MarkdownSigilText-BhSdOXRI.js";import"./markdownRoundTrip-Cgm-p_sj.js";import"./tableClasses-D6vsi5v1.js";import"./pointerDrag-7kMSqmzQ.js";import"./IconButton-DksHDvMl.js";import"./Tooltip-VoBxRdKd.js";import"./useMarkdownExplorerSectionCollapseState-BdAjoLS7.js";import"./useDocumentVersions-D1M-aLW5.js";import"./ZoomPanViewport-ZasvbBeB.js";import"./rafValueScheduler-BnT9N2Tt.js";import"./useMarkdownPreviewTokens-BG2JDi0h.js";import"./highlightjs-D_0y4Djn.js";import"./PreviewOverlay-DnW1CwaL.js";import"./text-z6OLAJGE.js";import"./lazyStyles-CbsVv0Ng.js";import"./MarkdownDataViewChips-D58dRmIg.js";import"./textLayout-DsCEykWj.js";import"./workspaceDataViewFloatingStore-qHqK0A5o.js";import"./DetailsMenu-DPGJMHsC.js";import"./AnchoredPopover-CZUMDdyV.js";import"./markdownDataViewValueUtils-djUhxXWn.js";import"./markdownTypography-CQogysz0.js";import"./cardParagraphs-C9RS8Q49.js";import"./WorkspaceHeader-BzZpchUh.js";import"./workspaceEditorModePresentation-BZUXHi4_.js";const j=16/9,v={width:1920,height:1080},Pt={portrait:{pageSizeIn:{width:8.2677165354,height:11.6929133858}},landscape:{pageSizeIn:{width:11.6929133858,height:8.2677165354}}},dt=(i,e)=>{const n=tt(i,"pageMarginMm"),r=tt(i,"rootPaddingMm"),t=Number(e==null?void 0:e.horizontalInsetScale),a=Number.isFinite(t)&&t>0?t:1,o=Number(e==null?void 0:e.verticalInsetScale),c=Number.isFinite(o)&&o>0?o:1;return a!==1&&(n.right*=a,n.left*=a,r.right*=a,r.left*=a),c!==1&&(n.top*=c,n.bottom*=c,r.top*=c,r.bottom*=c),{pageMarginMm:n,rootPaddingMm:r}},Et=i=>{const e=Pt[i];return{widthMm:e.pageSizeIn.width*25.4,heightMm:e.pageSizeIn.height*25.4}},It=i=>{const e=i.orientation,n=dt(e,{horizontalInsetScale:i.horizontalInsetScale,verticalInsetScale:i.verticalInsetScale});i.presentationVerticalInsetSymmetry&&(n.pageMarginMm.bottom=n.pageMarginMm.top,n.rootPaddingMm.bottom=n.rootPaddingMm.top);const r=Et(e),t={widthMm:Math.max(1,r.widthMm-n.pageMarginMm.left-n.pageMarginMm.right-n.rootPaddingMm.left-n.rootPaddingMm.right),heightMm:Math.max(1,r.heightMm-n.pageMarginMm.top-n.pageMarginMm.bottom-n.rootPaddingMm.top-n.rootPaddingMm.bottom)},a=t.widthMm/Math.max(1,t.heightMm)>j?t.heightMm*j:t.widthMm,o=a/j;return{pageSizeMm:r,effectiveInsetsMm:n,viewportMm:t,presentationSlideMm:{widthMm:a,heightMm:o}}},qt=i=>{try{if(!i.videoWidth||!i.videoHeight)return null;const e=document.createElement("canvas");e.width=i.videoWidth,e.height=i.videoHeight;const n=e.getContext("2d");if(!n)return null;n.drawImage(i,0,0);try{return e.toDataURL("image/png")}catch{return e.toDataURL("image/jpeg",.92)}}catch{return null}},mt=i=>{try{if(!i.complete||!i.naturalWidth||!i.naturalHeight)return null;const e=String(i.getAttribute("src")||"").trim();if(/\.svg(\?|#|$)/i.test(e))return null;const n=document.createElement("canvas");n.width=i.naturalWidth,n.height=i.naturalHeight;const r=n.getContext("2d");return r?(r.drawImage(i,0,0),i.naturalWidth*i.naturalHeight>12e5?n.toDataURL("image/jpeg",.92):n.toDataURL("image/png")):null}catch{return null}},Rt=/(?:youtube(?:-nocookie)?\.com\/(?:embed\/|watch\?v=|shorts\/|live\/)|youtu\.be\/)([\w-]+)/i,zt=/^\/__(?:media|webpage|webpage_asset)_proxy\?url=(.+)$/i,Lt=/(youtube(?:-nocookie)?\.com|youtu\.be|bilibili\.com|tiktok\.com|douyin\.com|vimeo\.com|twitter\.com|x\.com)/i,_t=i=>{const e=String(i||"").trim().toLowerCase();return e?e.startsWith("data:image/svg+xml")||/\.svg(\?|#|$)/i.test(e)?"svg":e.startsWith("data:image/png")||/\.png(\?|#|$)/i.test(e)||e.startsWith("data:image/webp")||/\.webp(\?|#|$)/i.test(e)||e.startsWith("data:image/avif")||/\.avif(\?|#|$)/i.test(e)?"png":e.startsWith("data:image/jpeg")||e.startsWith("data:image/jpg")||/\.jpe?g(\?|#|$)/i.test(e)?"jpg":"other":"other"},Nt=i=>i==="svg"?3:i==="png"?2:i==="jpg"?1:0,q=i=>{let e=null;const n=new Set;for(let r=0;r<i.length;r+=1){const t=String(i[r]||"").trim();if(!t||n.has(t))continue;n.add(t);const a=Nt(_t(t));(!e||a>e.score)&&(e={src:t,score:a})}return(e==null?void 0:e.src)||null},Ft=(i,e=1200)=>new Promise(n=>{let r=!1;const t=o=>{r||(r=!0,n(o))},a=new Image;a.onload=()=>t(!0),a.onerror=()=>t(!1),a.src=i,setTimeout(()=>t(!1),e)}),P=i=>{const e=i.match(zt);if(!e)return i;try{return decodeURIComponent(e[1])}catch{return i}},W=i=>{const n=P(String(i||"").trim()).match(Rt);return n?n[1]:null},H=i=>{const e=[`https://img.youtube.com/vi/${i}/maxresdefault.png`,`https://img.youtube.com/vi/${i}/sddefault.png`,`https://img.youtube.com/vi/${i}/hqdefault.png`,`https://img.youtube.com/vi/${i}/maxresdefault.jpg`,`https://img.youtube.com/vi/${i}/sddefault.jpg`,`https://img.youtube.com/vi/${i}/hqdefault.jpg`];return new Promise(n=>{(async()=>{for(let t=0;t<e.length;t+=1){const a=e[t];if(await Ft(a)){n(a);return}}n(e[e.length-1])})()})},V=(i,e)=>{const n=document.createElement("img");return n.src=i,n.alt=e,n.style.width="100%",n.style.maxWidth="100%",n.style.height="auto",n.style.display="block",n.style.objectFit="contain",n},Y=i=>{const e=I(i),n=(()=>{try{return new URL(i).hostname.replace(/^www\./,"")}catch{return""}})(),r=a=>a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),t=`
