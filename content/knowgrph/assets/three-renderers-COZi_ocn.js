import{f as Ln,e as Gi,b as Hi,g as Vi,T as ki}from"./three-textures-D4KpcNGc.js";import{L as Dt,r as Vt,B as dt,i as yt,aU as dr,s as wn,aM as qe,aB as Wt,an as Wi,H as Un,au as Lt,am as Ct,b as Tt,aV as Sn,aW as En,n as Dn,o as sn,aX as Gt,aY as ur,aZ as zi,q as Pt,a_ as Wn,aw as Xi,P as pr,av as vt,a$ as hr,b0 as mr,b1 as _r,A as gr,b2 as vr,b3 as Sr,b4 as Er,aL as Yi,b5 as Mr,b6 as Tr,aI as xr,D as St,aA as tn,aK as Ar,b7 as Rr,t as yn,b8 as br,e as kt,aF as rn,b9 as Cr,ba as Pr,aE as Bt,bb as Lr,bc as wr,bd as Ur,be as Dr,bf as yr,bg as Ir,aD as Nr,bh as Or,bi as Fr,bj as Br,bk as Gr,aC as Hr,bl as Vr,bm as kr,bn as Wr,bo as Mn,bp as Tn,bq as xn,br as An,bs as Rn,bt as bn,bu as Cn,bv as zr,bw as zn,bx as Xr,by as Yr,bz as Xn,bA as Yn,a as qn,bB as qr,bC as Kr,k as Zr,C as $r,j as Qr,h as fn,g as Qt,f as Jr,bD as jr,bE as ea,bF as ta,bG as na,bH as ia,bI as ra,bJ as aa,N as Ut,bK as an,bL as In,ao as zt,bM as Xt,as as on,m as oa,aq as qi,ap as Ki,al as sa,at as ca,ar as la,ak as fa,ad as da,aj as ua,ai as pa,ah as ha,ag as Zi,af as ma,ae as $i,ac as Qi,ab as dn,aa as un,a9 as pn,a8 as hn,a5 as Kn,a7 as Zn,a4 as $n,a6 as Qn,a3 as Jn,a2 as jn,a1 as ei,a0 as ti,$ as ni,_ as ii,Z as ri,Y as ai,X as oi,W as si,V as ci,U as li,Q as fi,K as di,J as ui,G as pi,F as hi,E as mn,z as mi,y as _i,x as _a,w as gi,v as vi,u as Si,p as _n,bN as ga,bO as va,S as Sa,R as Ea,bP as Ma,bQ as Ta,bR as xa,aN as Aa}from"./three-core-CI_PzYtU.js";import{j as je,f as Fe,b as st,C as Ze,V as et,E as Ji,a as It,P as Ra,h as ot,F as ji,R as ba}from"./three-math-Cn_OgFNR.js";import{B as er,P as tr}from"./three-geometries-CNb6CxmU.js";import{l as Yt,e as Ca,d as Pa}from"./three-materials-CsgPCM-x.js";import{M as qt,G as Jt}from"./three-objects-yoth8-Fa.js";import{j as La,k as wa,U as Ua,L as Da,B as ya,a as Ia,E as Na}from"./three-scene-core-Dxf37R84.js";import{P as Ei,m as Mi}from"./three-extras-BrFkphqG.js";class xt extends La{constructor(n=1,t=1,i={}){super(n,t,i),this.isWebGLRenderTarget=!0}}class Cf extends xt{constructor(n=1,t=1,i=1,s={}){super(n,t,s),this.isWebGLArrayRenderTarget=!0,this.depth=i,this.texture=new Ln(null,n,t,i),this.texture.isRenderTargetTexture=!0}}class Pf extends xt{constructor(n=1,t=1,i=1,s={}){super(n,t,s),this.isWebGL3DRenderTarget=!0,this.depth=i,this.texture=new Gi(null,n,t,i),this.texture.isRenderTargetTexture=!0}}function Kt(e){const n={};for(const t in e){n[t]={};for(const i in e[t]){const s=e[t][i];s&&(s.isColor||s.isMatrix3||s.isMatrix4||s.isVector2||s.isVector3||s.isVector4||s.isTexture||s.isQuaternion)?s.isRenderTargetTexture?(console.warn("UniformsUtils: Textures of render targets cannot be cloned via cloneUniforms() or mergeUniforms()."),n[t][i]=null):n[t][i]=s.clone():Array.isArray(s)?n[t][i]=s.slice():n[t][i]=s}}return n}function rt(e){const n={};for(let t=0;t<e.length;t++){const i=Kt(e[t]);for(const s in i)n[s]=i[s]}return n}function Lf(e){const n=[];for(let t=0;t<e.length;t++)n.push(e[t].clone());return n}function nr(e){const n=e.getRenderTarget();return n===null?e.outputColorSpace:n.isXRRenderTarget===!0?n.texture.colorSpace:je.workingColorSpace}const Oa={clone:Kt,merge:rt},wf=`
void main() {
