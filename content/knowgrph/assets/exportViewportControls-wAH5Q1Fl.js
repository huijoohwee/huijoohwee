import{l as dt}from"./mediaOverlayPool-BXQUHH2S.js";import{dg as Ee,lR as st,ml as lt,qB as ct,tf as Z,mJ as ut,rO as gt,m1 as pt,ou as vt,j0 as yt,k2 as mt,jw as ft,ls as ht,sk as bt,jF as xt,oy as Me,cK as Be}from"./index-Ds3lF5be.js";import{s as wt}from"./scaleExtent-CDba2b6k.js";import{f as kt}from"./groupVisibility-7_qcxsx3.js";import{r as fe,b as St}from"./overlaySizing2d-BRJWQ0c6.js";import{f as It}from"./markdownPanelOverlayPool-Dqheut76.js";import{g as Et}from"./displayFilter-B5EfcIK9.js";import{d as Mt}from"./positioning-CwqBRmve.js";const Bt=[`(function(){
...
</html>`}const Yt=e=>{const t=String(e||"").toLowerCase();return t==="href"||t==="xlink:href"||t==="src"||t==="poster"},Xt=e=>String(e||"").toLowerCase()==="srcset",Vt=e=>{const t=[],a=e.attributes;for(let r=0;r<a.length;r+=1){const i=a.item(r);if(!i||!Yt(i.name)&&!Xt(i.name)&&String(i.name||"").toLowerCase()!=="style")continue;const d=String(i.value||"").trim();d&&t.push({name:i.name,value:d})}return t},qt=async(e,t)=>{const a=String(e||"").trim();if(!a)return"";const r=a.split(",").map(d=>d.trim()).filter(Boolean);if(r.length===0)return a;const i=[];for(let d=0;d<r.length;d+=1){const o=r[d].split(/\s+/g).filter(Boolean);if(o.length===0)continue;const s=o[0],l=await t(s),v=o.slice(1).join(" ");i.push(v?`${l} ${v}`:l)}return i.join(", ")},Ut=async(e,t)=>{const a=String(e||"");if(!a.trim())return a;const r=/url\(\s*(['"]?)([^'"\)]+)\1\s*\)/g;let i="",d=0;for(;;){const n=r.exec(a);if(!n)break;const o=n[0],s=String(n[2]||"").trim();i+=a.slice(d,n.index),d=n.index+o.length;const l=s&&await t(s),v=n[1]||"";i+=`url(${v}${l}${v})`}return i+=a.slice(d),i};async function cr(e){const t=String(e.svgMarkup||"");if(!t.trim())return"";if(typeof DOMParser!="function"||typeof XMLSerializer!="function")return t;let a=null;try{a=new DOMParser().parseFromString(t,"image/svg+xml")}catch{a=null}if(!a)return t;const r=a.documentElement;if(!r||String(r.tagName||"").toLowerCase()!=="svg")return t;const i=Array.from(r.querySelectorAll("*"));if(i.length===0)return t;const d=typeof e.maxInlineRepoBytes=="number"&&Number.isFinite(e.maxInlineRepoBytes)?Math.max(0,Math.floor(e.maxInlineRepoBytes)):24e5,n=async(o,s)=>{const l=String(o||"").trim();if(!l)return"";const v=se(l);return(e.inlineRemoteAssets===!0&&(s==null?void 0:s.allowRemote)===!0?await De(l,{maxBytes:d,allowRemote:!0}):await ve(v,{maxBytes:d}))||v};for(let o=0;o<i.length;o+=1){const s=i[o],l=Vt(s);if(l.length!==0)for(let v=0;v<l.length;v+=1){const g=l[v],c=g.value,u=String(g.name||"").toLowerCase();if(u==="srcset"){const T=await qt(c,A=>n(A,{allowRemote:!0}));if(!T||T===c)continue;try{s.setAttribute(g.name,T)}catch{}continue}if(u==="style"){const T=await Ut(c,A=>n(A,{allowRemote:!0}));if(!T||T===c)continue;try{s.setAttribute(g.name,T)}catch{}continue}const x=String(s.tagName||"").toLowerCase(),G=await n(c,{allowRemote:u==="src"||u==="poster"||(u==="href"||u==="xlink:href")&&x==="image"});if(!(!G||G===c))try{s.setAttribute(g.name,G)}catch{}}}try{return new XMLSerializer().serializeToString(r)||t}catch{return t}}function ur(e){const t=e.graphData,a=e.schema;if(!t||!a)return null;const r=Et({graphData:t,edges:null}),i=yt(e.collapsedGroupIds),d=mt(a),n=ft(r),o=ht({graphData:r,graphDataRevision:typeof e.graphDataRevision=="number"&&Number.isFinite(e.graphDataRevision)?Math.floor(e.graphDataRevision):0}),s=bt(a),l=String(e.documentSemanticModeKey||"document"),v=xt({schemaLayoutEngineJson:d,frontmatterModeEnabled:e.frontmatterModeEnabled,documentSemanticMode:l,graphMetaKey:n,renderMediaAsNodes:e.renderMediaAsNodes,mediaPanelDensity:String(e.mediaPanelDensity),collapsedGroupIdsKey:i}),g=String(e.canvas2dRenderer||"d3"),x=Mt({datasetKey:o,mode:s,frontmatterMode:e.frontmatterModeEnabled,semanticMode:l,renderMode:"2d",renderVariant:g,layoutVariant:"",viewKey:v,prevViewKey:null,prevDatasetKey:null,prevMode:null,prevFrontmatterMode:null,prevSemanticMode:null,prevRenderMode:null,prevRenderVariant:null,prevLayoutVariant:null,nodes:Array.isArray(r.nodes)?r.nodes:[],layoutPositionCacheByMode:e.layoutPositionCacheByMode??null}).layoutPositionsForMode;return!x||Object.keys(x).length===0?null:x}const Ce=e=>{const t=e;if(!(!t||!t.style))try{t.style.removeProperty("transform"),t.style.removeProperty("transform-origin"),t.style.removeProperty("translate"),t.style.removeProperty("left"),t.style.removeProperty("top"),t.style.removeProperty("right"),t.style.removeProperty("bottom"),t.style.removeProperty("inset"),t.style.removeProperty("position"),t.style.removeProperty("width"),t.style.removeProperty("height"),t.style.removeProperty("z-index")}catch{}},Pe=e=>{const t=e;if(!(!t||!t.style))try{t.style.display="none"}catch{}},Kt=(e,t)=>{const a=e.querySelectorAll("img,video,source,iframe"),r=t.querySelectorAll("img,video,source,iframe"),i=Math.min(a.length,r.length);for(let d=0;d<i;d+=1){const n=a[d],o=r[d],s=String(n.tagName||"").toLowerCase();if(s==="img"){const l=n,v=o,g=String(l.currentSrc||l.src||v.getAttribute("src")||"").trim();if(g)try{v.setAttribute("src",g)}catch{}continue}if(s==="video"||s==="source"){const l=String(n.currentSrc||n.src||o.getAttribute("src")||"").trim();if(l)try{o.setAttribute("src",l)}catch{}continue}if(s==="iframe"){const l=n,v=o,g=typeof l.srcdoc=="string"?l.srcdoc:"";if(g){try{v.removeAttribute("src")}catch{}try{v.setAttribute("srcdoc",g)}catch{}continue}const c=String(l.src||o.getAttribute("src")||"").trim();if(c)try{v.setAttribute("src",c)}catch{}}}},jt=e=>{if(typeof document>"u")return[];const t=[],a=new Set;for(let r=0;r<e.length;r+=1){const i=String(e[r]||"").trim();if(!i)continue;const d=Array.from(document.querySelectorAll(i));for(let n=0;n<d.length;n+=1){const o=d[n];!o||a.has(o)||(a.add(o),t.push(o))}}return t},Re=(e,t)=>e?[e]:jt(t),Se=e=>{try{const t=e,a=getComputedStyle(t);if(a.display==="none"||a.visibility==="hidden")return 0;const r=Number(a.opacity),i=t.getClientRects().length;return i>0&&Number.isFinite(r)&&r>.01?3:i>0?2:1}catch{return 1}},Oe=(e,t,a)=>{if(!t)return;const r=e.get(t);if(!r){e.set(t,a);return}Se(a)>=Se(r)&&e.set(t,a)},Ie=e=>String(e.getAttribute("data-md-id")||"").trim(),Zt=e=>String(e.getAttribute("data-kg-anchor-node-id")||"").trim(),$t=(e,t)=>{try{e.setAttribute("data-md-id",t.id)}catch{}try{t.anchorNodeId?e.setAttribute("data-kg-anchor-node-id",t.anchorNodeId):e.removeAttribute("data-kg-anchor-node-id")}catch{}},Jt=e=>{var t;try{const a=Re(e.overlayRootEl,['section[aria-label="D3 rich media overlay"]','section[aria-label="Flow media overlay"]','section[aria-label="Design media overlay"]','section[aria-label="3D media overlay"]',"#kg-overlay",'[data-kg-rich-media-overlay="1"]','[data-kg-rich-media-panel="1"]']);if(a.length===0)return"";const r=new Map;for(let n=0;n<a.length;n+=1){const o=a[n],s=(t=o.matches)!=null&&t.call(o,'[data-kg-rich-media-panel="1"][data-node-id]')?[o]:Array.from(o.querySelectorAll('[data-kg-rich-media-panel="1"][data-node-id]'));for(let l=0;l<s.length;l+=1){const v=s[l],g=String(v.getAttribute("data-node-id")||"").trim();g&&Oe(r,g,v)}}const i=Array.from(r.values());if(i.length===0)return"";const d=document.createElement("section");for(let n=0;n<i.length;n+=1){const o=i[n],s=o.cloneNode(!0);Me(o,s,Be),Ce(s),Pe(s);try{Kt(o,s)}catch{}d.appendChild(s)}return d.innerHTML}catch{return""}},Qt=e=>{var t;try{const a=Re(e.overlayRootEl,['section[aria-label="Design markdown overlay"]','section[aria-label="Flow media overlay"]',"#kg-overlay",'[data-kg-markdown-design-overlay="1"]',"[data-md-id]"]);if(a.length===0)return"";const r=new Map;for(let n=0;n<a.length;n+=1){const o=a[n],s=(t=o.matches)!=null&&t.call(o,"[data-md-id]")?[o]:Array.from(o.querySelectorAll("[data-md-id]"));for(let l=0;l<s.length;l+=1){const v=s[l],g=Ie(v);g&&Oe(r,g,v)}}const i=Array.from(r.values());if(i.length===0)return"";const d=document.createElement("section");for(let n=0;n<i.length;n+=1){const o=i[n],s=o.cloneNode(!0);Me(o,s,Be),Ce(s),Pe(s);try{const l=Ie(o),v=Zt(o);l&&$t(s,{id:l,anchorNodeId:v})}catch{}d.appendChild(s)}return d.innerHTML}catch{return""}},gr=()=>{try{const e=Jt({overlayRootEl:null}),t=Qt({overlayRootEl:null});return`${e}${t}`}catch{return""}},pr=()=>{var e;try{const t=String(((e=globalThis==null?void 0:globalThis.localStorage)==null?void 0:e.getItem(Ee.viewportControlsPreset))||"").trim();return t==="map"||t==="design"?t:null}catch{return null}};export{ge as a,lr as b,gr as c,cr as d,Pt as e,ur as p,pr as r};
