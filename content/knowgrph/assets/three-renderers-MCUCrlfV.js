import{f as Ln,e as Gi,a as Hi,g as Vi,T as ki}from"./three-textures-CwD3SyZp.js";import{L as Dt,p as Vt,B as dt,g as yt,aT as dr,q as wn,aL as qe,aA as Wt,ak as Wi,H as Un,ar as Lt,aj as Ct,a as Tt,aU as Sn,aV as En,l as Dn,m as sn,aW as Gt,aX as ur,aY as zi,o as Pt,aZ as Wn,au as Xi,as as pr,at as vt,a_ as hr,a$ as mr,b0 as _r,aw as gr,b1 as vr,b2 as Sr,b3 as Er,aK as Yi,b4 as Mr,b5 as Tr,aH as xr,D as St,az as tn,aJ as Ar,b6 as Rr,r as yn,b7 as br,c as kt,aE as rn,b8 as Cr,b9 as Pr,aD as Bt,ba as Lr,bb as wr,bc as Ur,bd as Dr,be as yr,bf as Ir,aC as Nr,bg as Or,bh as Fr,bi as Br,bj as Gr,aB as Hr,bk as Vr,bl as kr,bm as Wr,bn as Mn,bo as Tn,bp as xn,bq as An,br as Rn,bs as bn,bt as Cn,bu as zr,bv as zn,bw as Xr,bx as Yr,by as Xn,bz as Yn,bA as qn,bB as qr,bC as Kr,i as Zr,C as $r,h as Qr,f as fn,e as Qt,d as Jr,bD as jr,bE as ea,bF as ta,bG as na,bH as ia,bI as ra,bJ as aa,N as Ut,bK as an,bL as In,al as zt,bM as Xt,ap as on,k as oa,an as qi,am as Ki,ai as sa,aq as ca,ao as la,ah as fa,aa as da,ag as ua,af as pa,ae as ha,ad as Zi,ac as ma,ab as $i,a9 as Qi,a8 as dn,a7 as un,a6 as pn,a5 as hn,a2 as Kn,a4 as Zn,a1 as $n,a3 as Qn,a0 as Jn,$ as jn,_ as ei,Z as ti,Y as ni,X as ii,W as ri,V as ai,U as oi,Q as si,K as ci,J as li,G as fi,F as di,E as ui,A as pi,z as hi,y as mn,x as mi,w as _i,v as _a,u as gi,t as vi,s as Si,n as _n,bN as ga,bO as va,b as Sa,R as Ea,bP as Ma,bQ as Ta,bR as xa,aM as Aa}from"./three-core-YJ_pwGB0.js";import{i as je,e as Fe,a as st,C as Ze,V as et,E as Ji,M as It,P as Ra,f as ot,F as ji,R as ba}from"./three-math-DifZTZZx.js";import{B as er,P as tr}from"./three-geometries-DMUcSuo3.js";import{S as Yt,e as Ca,d as Pa}from"./three-materials-B69Oc6ic.js";import{M as qt,G as Jt}from"./three-objects-BRpQuzYs.js";import{j as La,k as wa,U as Ua,L as Da,B as ya,a as Ia,E as Na}from"./three-scene-core-BTiTuMh6.js";import{P as Ei,m as Mi}from"./three-extras-pbwMbJWh.js";class xt extends La{constructor(n=1,t=1,i={}){super(n,t,i),this.isWebGLRenderTarget=!0}}class Cf extends xt{constructor(n=1,t=1,i=1,s={}){super(n,t,s),this.isWebGLArrayRenderTarget=!0,this.depth=i,this.texture=new Ln(null,n,t,i),this.texture.isRenderTargetTexture=!0}}class Pf extends xt{constructor(n=1,t=1,i=1,s={}){super(n,t,s),this.isWebGL3DRenderTarget=!0,this.depth=i,this.texture=new Gi(null,n,t,i),this.texture.isRenderTargetTexture=!0}}function Kt(e){const n={};for(const t in e){n[t]={};for(const i in e[t]){const s=e[t][i];s&&(s.isColor||s.isMatrix3||s.isMatrix4||s.isVector2||s.isVector3||s.isVector4||s.isTexture||s.isQuaternion)?s.isRenderTargetTexture?(console.warn("UniformsUtils: Textures of render targets cannot be cloned via cloneUniforms() or mergeUniforms()."),n[t][i]=null):n[t][i]=s.clone():Array.isArray(s)?n[t][i]=s.slice():n[t][i]=s}}return n}function rt(e){const n={};for(let t=0;t<e.length;t++){const i=Kt(e[t]);for(const s in i)n[s]=i[s]}return n}function Lf(e){const n=[];for(let t=0;t<e.length;t++)n.push(e[t].clone());return n}function nr(e){const n=e.getRenderTarget();return n===null?e.outputColorSpace:n.isXRRenderTarget===!0?n.texture.colorSpace:je.workingColorSpace}const Oa={clone:Kt,merge:rt},wf=`
void main() {
