import{bn as r,u as n,bo as s,bh as o,bi as c,bp as i}from"./index-DUYb9_rK.js";const h="/schema",e="/schema/schema.json";async function p(){const a=await c();await a.ensureSeed();try{await a.createFolder({parentPath:i,name:"schema"})}catch{}}async function S(){await p();const a=await c();try{await a.readFileText(e);return}catch{}const t=(()=>{try{return JSON.stringify(n.getState().schema,null,2)}catch{return`{
  "catalog": {
    "nodeTypes": [],
    "edgeLabels": []
  }
